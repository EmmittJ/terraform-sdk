...
public class GoogleHealthcareDicomStoreIamPolicy : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("dicom_store_id")?.Value;
        set => this.WithProperty("dicom_store_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
