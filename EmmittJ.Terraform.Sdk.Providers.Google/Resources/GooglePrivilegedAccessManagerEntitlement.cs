...
public class GooglePrivilegedAccessManagerEntitlement : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("max_request_duration")?.Value;
        set => this.WithProperty("max_request_duration", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
