...
public class GoogleDataprocCluster : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("graceful_decommission_timeout")?.Value;
        set => this.WithProperty("graceful_decommission_timeout", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
