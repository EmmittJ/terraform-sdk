...
public class GoogleComputeRouter : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("encrypted_interconnect_router")?.Value;
        set => this.WithProperty("encrypted_interconnect_router", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
