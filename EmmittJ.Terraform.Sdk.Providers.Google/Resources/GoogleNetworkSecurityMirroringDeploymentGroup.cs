...
public class GoogleNetworkSecurityMirroringDeploymentGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("mirroring_deployment_group_id")?.Value;
        set => this.WithProperty("mirroring_deployment_group_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
