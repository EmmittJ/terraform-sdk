...
public class GoogleIapWebCloudRunServiceIamBinding : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("cloud_run_service_name")?.Value;
        set => this.WithProperty("cloud_run_service_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
