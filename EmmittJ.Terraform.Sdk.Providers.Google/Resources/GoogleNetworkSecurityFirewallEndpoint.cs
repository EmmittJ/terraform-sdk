...
public class GoogleNetworkSecurityFirewallEndpoint : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("billing_project_id")?.Value;
        set => this.WithProperty("billing_project_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
