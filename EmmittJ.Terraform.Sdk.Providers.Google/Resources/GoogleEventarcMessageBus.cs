...
public class GoogleEventarcMessageBus : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("message_bus_id")?.Value;
        set => this.WithProperty("message_bus_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
