...
public class GoogleHealthcareHl7V2Store : TerraformResource
{
    ...
    /// </summary>
    public bool? RejectDuplicateMessage
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("reject_duplicate_message")?.Value;
        set => this.WithProperty("reject_duplicate_message", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
