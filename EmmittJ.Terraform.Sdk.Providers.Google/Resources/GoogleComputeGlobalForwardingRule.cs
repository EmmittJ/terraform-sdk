...
public class GoogleComputeGlobalForwardingRule : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("external_managed_backend_bucket_migration_state")?.Value;
        set => this.WithProperty("external_managed_backend_bucket_migration_state", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("external_managed_backend_bucket_migration_testing_percentage")?.Value;
        set => this.WithProperty("external_managed_backend_bucket_migration_testing_percentage", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
