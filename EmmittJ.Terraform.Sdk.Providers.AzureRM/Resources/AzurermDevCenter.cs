...
public class AzurermDevCenter : TerraformResource
{
    ...
    /// </summary>
    public bool? ProjectCatalogItemSyncEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("project_catalog_item_sync_enabled")?.Value;
        set => this.WithProperty("project_catalog_item_sync_enabled", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
