...
public class AzurermDevCenterProject : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("maximum_dev_boxes_per_user")?.Value;
        set => this.WithProperty("maximum_dev_boxes_per_user", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
