...
public class AzurermLogicAppIntegrationAccountCertificate : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("public_certificate")?.Value;
        set => this.WithProperty("public_certificate", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
