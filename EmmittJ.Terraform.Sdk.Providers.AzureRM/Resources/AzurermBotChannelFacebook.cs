...
public class AzurermBotChannelFacebook : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("facebook_application_id")?.Value;
        set => this.WithProperty("facebook_application_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("facebook_application_secret")?.Value;
        set => this.WithProperty("facebook_application_secret", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
