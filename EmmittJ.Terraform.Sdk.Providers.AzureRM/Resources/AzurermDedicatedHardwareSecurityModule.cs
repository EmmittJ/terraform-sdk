...
public class AzurermDedicatedHardwareSecurityModule : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("stamp_id")?.Value;
        set => this.WithProperty("stamp_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
