...
public class AzurermEventgridDomain : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("auto_create_topic_with_first_subscription")?.Value;
        set => this.WithProperty("auto_create_topic_with_first_subscription", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("auto_delete_topic_with_last_subscription")?.Value;
        set => this.WithProperty("auto_delete_topic_with_last_subscription", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
