...
public class AzurermDataFactoryCustomDataset : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("schema_json")?.Value;
        set => this.WithProperty("schema_json", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
