...
public class AzurermDataFactoryLinkedServiceKusto : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("kusto_endpoint")?.Value;
        set => this.WithProperty("kusto_endpoint", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
