...
public class AzurermAutomationConnection : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("values")?.Value;
        set => this.WithProperty("values", value == null ? null : new TerraformLiteralProperty<Dictionary<string, string>>(value));
    }
