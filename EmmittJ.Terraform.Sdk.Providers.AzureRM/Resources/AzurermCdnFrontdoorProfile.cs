...
public class AzurermCdnFrontdoorProfile : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("response_timeout_seconds")?.Value;
        set => this.WithProperty("response_timeout_seconds", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
