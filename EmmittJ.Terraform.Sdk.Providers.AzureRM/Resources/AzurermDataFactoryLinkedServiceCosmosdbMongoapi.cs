...
public class AzurermDataFactoryLinkedServiceCosmosdbMongoapi : TerraformResource
{
    ...
    /// </summary>
    public bool? ServerVersionIs32OrHigher
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("server_version_is_32_or_higher")?.Value;
        set => this.WithProperty("server_version_is_32_or_higher", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
