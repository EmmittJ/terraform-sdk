...
public class AzurermOracleAutonomousDatabaseCloneFromDatabase : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("refreshable_model")?.Value;
        set => this.WithProperty("refreshable_model", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
