...
public class AzurermCosmosdbGremlinGraph : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("partition_key_path")?.Value;
        set => this.WithProperty("partition_key_path", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
