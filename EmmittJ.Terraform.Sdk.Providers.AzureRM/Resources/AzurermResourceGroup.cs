...
public class AzurermResourceGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("managed_by")?.Value;
        set => this.WithProperty("managed_by", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
