...
public class AzurermAutomationConnectionServicePrincipal : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("certificate_thumbprint")?.Value;
        set => this.WithProperty("certificate_thumbprint", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
