...
public class AwsEbsVolumesDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEbsVolumesDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEbsVolumesDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEbsVolumesDataSourceTimeoutsBlock>("timeouts");
