...
public class AwsEc2TransitGatewayConnectDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("transit_gateway_connect_id")?.Value;
        set => this.WithProperty("transit_gateway_connect_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
