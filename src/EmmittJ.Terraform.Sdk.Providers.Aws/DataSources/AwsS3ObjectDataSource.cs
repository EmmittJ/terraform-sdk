...
public class AwsS3ObjectDataSource : TerraformDataSource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ChecksumMode
    {
        get => GetProperty<TerraformLiteralProperty<string>>("checksum_mode");
    ...
    /// The range attribute.
    /// </summary>
    public TerraformLiteralProperty<string>? Range
    {
        get => GetProperty<TerraformLiteralProperty<string>>("range");
