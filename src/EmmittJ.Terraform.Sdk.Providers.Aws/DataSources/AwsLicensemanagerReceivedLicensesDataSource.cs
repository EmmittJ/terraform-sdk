...
public class AwsLicensemanagerReceivedLicensesDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsLicensemanagerReceivedLicensesDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsLicensemanagerReceivedLicensesDataSourceFilterBlock>>("filter");
