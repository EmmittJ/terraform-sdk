...
public class AwsEc2TransitGatewayVpcAttachmentsDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEc2TransitGatewayVpcAttachmentsDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEc2TransitGatewayVpcAttachmentsDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEc2TransitGatewayVpcAttachmentsDataSourceTimeoutsBlock>("timeouts");
