...
public class AwsQuicksightDataSet : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("import_mode")?.Value;
        set => this.WithProperty("import_mode", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
