...
public class AwsElasticBeanstalkApplicationVersion : TerraformResource
{
    ...
    public bool? Process
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("process")?.Value;
        set => this.WithProperty("process", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
