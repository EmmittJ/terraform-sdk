...
public class AwsCloudwatchQueryDefinition : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? LogGroupNames
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("log_group_names");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? QueryString
    {
        get => GetProperty<TerraformLiteralProperty<string>>("query_string");
