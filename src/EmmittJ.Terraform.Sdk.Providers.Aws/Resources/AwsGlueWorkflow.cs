...
public class AwsGlueWorkflow : TerraformResource
{
    ...
    /// </summary>
    public TerraformProperty<Dictionary<string, string>>? DefaultRunProperties
    {
        get => GetProperty<TerraformProperty<Dictionary<string, string>>>("default_run_properties");
