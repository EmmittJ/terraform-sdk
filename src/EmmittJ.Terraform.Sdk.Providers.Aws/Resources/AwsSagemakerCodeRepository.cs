...
public class AwsSagemakerCodeRepository : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("code_repository_name")?.Value;
        set => this.WithProperty("code_repository_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
