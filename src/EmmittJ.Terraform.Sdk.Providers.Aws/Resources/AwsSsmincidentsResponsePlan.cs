...
public class AwsSsmincidentsResponsePlan : TerraformResource
{
    ...
    /// </summary>
    public TerraformProperty<HashSet<string>>? ChatChannel
    {
        get => GetProperty<TerraformProperty<HashSet<string>>>("chat_channel");
    ...
    /// </summary>
    public TerraformProperty<HashSet<string>>? Engagements
    {
        get => GetProperty<TerraformProperty<HashSet<string>>>("engagements");
