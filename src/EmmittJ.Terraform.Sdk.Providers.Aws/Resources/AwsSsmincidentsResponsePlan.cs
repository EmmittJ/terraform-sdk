...
public class AwsSsmincidentsResponsePlan : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<HashSet<string>>? ChatChannel
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("chat_channel");
    ...
    /// </summary>
    public TerraformLiteralProperty<HashSet<string>>? Engagements
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("engagements");
