...
public class AwsBackupFramework : TerraformResource
{
    ...
    public HashSet<AwsBackupFrameworkControlBlock>? Control
    {
        get => GetProperty<HashSet<AwsBackupFrameworkControlBlock>>("control");
        set => this.WithProperty("control", value);
    }
    ...
    {
        get => GetProperty<AwsBackupFrameworkTimeoutsBlock>("timeouts");
