...
public class AwsRedshiftHsmClientCertificate : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("hsm_client_certificate_identifier")?.Value;
        set => this.WithProperty("hsm_client_certificate_identifier", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
