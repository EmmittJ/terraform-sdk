...
public class AwsRedshiftHsmClientCertificate : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? HsmClientCertificateIdentifier
    {
        get => GetProperty<TerraformLiteralProperty<string>>("hsm_client_certificate_identifier");
