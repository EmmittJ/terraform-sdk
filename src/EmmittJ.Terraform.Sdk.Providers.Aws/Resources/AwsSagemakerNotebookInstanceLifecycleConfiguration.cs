...
public class AwsSagemakerNotebookInstanceLifecycleConfiguration : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? OnCreate
    {
        get => GetProperty<TerraformLiteralProperty<string>>("on_create");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? OnStart
    {
        get => GetProperty<TerraformLiteralProperty<string>>("on_start");
