...
public class AwsIvsRecordingConfiguration : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("recording_reconnect_window_seconds")?.Value;
        set => this.WithProperty("recording_reconnect_window_seconds", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
