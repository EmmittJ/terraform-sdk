...
public class AwsWorkspaceswebUserSettingsAssociation : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("user_settings_arn")?.Value;
        set => this.WithProperty("user_settings_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
