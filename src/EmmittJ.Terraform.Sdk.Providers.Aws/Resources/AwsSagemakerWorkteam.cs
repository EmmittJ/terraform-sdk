...
public class AwsSagemakerWorkteam : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? WorkforceName
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workforce_name");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? WorkteamName
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workteam_name");
