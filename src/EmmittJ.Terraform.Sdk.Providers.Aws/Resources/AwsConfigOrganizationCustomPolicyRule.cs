...
public class AwsConfigOrganizationCustomPolicyRule : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<HashSet<string>>? DebugLogDeliveryAccounts
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("debug_log_delivery_accounts");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PolicyRuntime
    {
        get => GetProperty<TerraformLiteralProperty<string>>("policy_runtime");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PolicyText
    {
        get => GetProperty<TerraformLiteralProperty<string>>("policy_text");
