...
public class AwsS3BucketObjectLockConfiguration : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("object_lock_enabled")?.Value;
        set => this.WithProperty("object_lock_enabled", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
