...
public class AwsIamSamlProvider : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("saml_metadata_document")?.Value;
        set => this.WithProperty("saml_metadata_document", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
