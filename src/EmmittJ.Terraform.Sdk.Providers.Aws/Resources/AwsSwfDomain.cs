...
public class AwsSwfDomain : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? WorkflowExecutionRetentionPeriodInDays
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workflow_execution_retention_period_in_days");
