...
public class AwsTransferAgreement : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? BaseDirectory
    {
        get => GetProperty<TerraformLiteralProperty<string>>("base_directory");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? LocalProfileId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("local_profile_id");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PartnerProfileId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("partner_profile_id");
