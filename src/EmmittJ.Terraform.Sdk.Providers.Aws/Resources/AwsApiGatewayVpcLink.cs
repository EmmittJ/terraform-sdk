...
public class AwsApiGatewayVpcLink : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? TargetArns
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("target_arns");
        set => this.WithProperty("target_arns", value);
    }
