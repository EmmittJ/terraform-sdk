...
public class AwsChimeVoiceConnector : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("require_encryption")?.Value;
        set => this.WithProperty("require_encryption", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
