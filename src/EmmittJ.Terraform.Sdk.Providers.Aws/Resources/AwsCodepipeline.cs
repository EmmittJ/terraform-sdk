...
public class AwsCodepipeline : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ExecutionMode
    {
        get => GetProperty<TerraformLiteralProperty<string>>("execution_mode");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PipelineType
    {
        get => GetProperty<TerraformLiteralProperty<string>>("pipeline_type");
