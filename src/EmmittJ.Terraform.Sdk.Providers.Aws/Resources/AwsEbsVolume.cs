...
public class AwsEbsVolume : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("volume_initialization_rate")?.Value;
        set => this.WithProperty("volume_initialization_rate", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
