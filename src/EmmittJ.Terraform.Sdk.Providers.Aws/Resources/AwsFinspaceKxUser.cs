...
/// </summary>
public class AwsFinspaceKxUser : TerraformResource
{
    public AwsFinspaceKxUser(string name) : base("aws_finspace_kx_user", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AwsFinspaceKxUserTimeoutsBlock>("timeouts");
