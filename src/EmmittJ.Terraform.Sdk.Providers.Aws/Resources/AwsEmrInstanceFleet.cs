...
public class AwsEmrInstanceFleet : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? TargetOnDemandCapacity
    {
        get => GetProperty<TerraformLiteralProperty<double>>("target_on_demand_capacity");
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? TargetSpotCapacity
    {
        get => GetProperty<TerraformLiteralProperty<double>>("target_spot_capacity");
