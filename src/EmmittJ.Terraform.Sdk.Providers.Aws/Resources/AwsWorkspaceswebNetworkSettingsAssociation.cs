...
public class AwsWorkspaceswebNetworkSettingsAssociation : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("network_settings_arn")?.Value;
        set => this.WithProperty("network_settings_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
