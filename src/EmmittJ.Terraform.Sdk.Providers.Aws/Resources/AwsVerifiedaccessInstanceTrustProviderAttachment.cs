...
public class AwsVerifiedaccessInstanceTrustProviderAttachment : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? VerifiedaccessInstanceId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("verifiedaccess_instance_id");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? VerifiedaccessTrustProviderId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("verifiedaccess_trust_provider_id");
