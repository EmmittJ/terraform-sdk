...
public class AwsIotThingGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformProperty<string>>("parent_group_name");
        set => this.WithProperty("parent_group_name", value);
    }
    ...
    {
        get => GetProperty<List<AwsIotThingGroupPropertiesBlock>>("properties");
