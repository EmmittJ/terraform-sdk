...
public class AwsImagebuilderImageRecipe : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("ami_tags")?.Value;
        set => this.WithProperty("ami_tags", value == null ? null : new TerraformLiteralProperty<Dictionary<string, string>>(value));
    }
