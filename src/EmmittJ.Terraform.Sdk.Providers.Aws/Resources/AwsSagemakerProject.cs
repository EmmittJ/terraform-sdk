...
public class AwsSagemakerProject : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("project_description")?.Value;
        set => this.WithProperty("project_description", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
