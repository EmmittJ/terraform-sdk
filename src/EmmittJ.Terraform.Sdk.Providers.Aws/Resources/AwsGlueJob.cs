...
public class AwsGlueJob : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("job_mode")?.Value;
        set => this.WithProperty("job_mode", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
