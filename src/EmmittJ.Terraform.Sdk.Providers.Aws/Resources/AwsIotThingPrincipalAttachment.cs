...
public class AwsIotThingPrincipalAttachment : TerraformResource
{
    ...
    /// The thing attribute.
    /// </summary>
    public TerraformLiteralProperty<string>? Thing
    {
        get => GetProperty<TerraformLiteralProperty<string>>("thing");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ThingPrincipalType
    {
        get => GetProperty<TerraformLiteralProperty<string>>("thing_principal_type");
