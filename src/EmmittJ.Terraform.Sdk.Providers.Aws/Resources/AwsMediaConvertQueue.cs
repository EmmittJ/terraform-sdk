...
public class AwsMediaConvertQueue : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? ConcurrentJobs
    {
        get => GetProperty<TerraformLiteralProperty<double>>("concurrent_jobs");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PricingPlan
    {
        get => GetProperty<TerraformLiteralProperty<string>>("pricing_plan");
