...
public class AwsMediaConvertQueue : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("concurrent_jobs")?.Value;
        set => this.WithProperty("concurrent_jobs", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("pricing_plan")?.Value;
        set => this.WithProperty("pricing_plan", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
