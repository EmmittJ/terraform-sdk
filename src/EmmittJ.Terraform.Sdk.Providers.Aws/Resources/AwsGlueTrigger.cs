...
public class AwsGlueTrigger : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? StartOnCreation
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("start_on_creation");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? WorkflowName
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workflow_name");
