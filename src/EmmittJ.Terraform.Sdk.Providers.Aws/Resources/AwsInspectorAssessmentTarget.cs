...
public class AwsInspectorAssessmentTarget : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ResourceGroupArn
    {
        get => GetProperty<TerraformLiteralProperty<string>>("resource_group_arn");
        set => this.WithProperty("resource_group_arn", value);
    }
