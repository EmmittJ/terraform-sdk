...
public class AwsConnectQueue : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("hours_of_operation_id")?.Value;
        set => this.WithProperty("hours_of_operation_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("max_contacts")?.Value;
        set => this.WithProperty("max_contacts", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
    ...
    /// </summary>
    public HashSet<string>? QuickConnectIds
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("quick_connect_ids")?.Value;
        set => this.WithProperty("quick_connect_ids", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
