...
public class AwsEc2TrafficMirrorSession : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? PacketLength
    {
        get => GetProperty<TerraformLiteralProperty<double>>("packet_length");
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? SessionNumber
    {
        get => GetProperty<TerraformLiteralProperty<double>>("session_number");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? TrafficMirrorTargetId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("traffic_mirror_target_id");
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? VirtualNetworkId
    {
        get => GetProperty<TerraformLiteralProperty<double>>("virtual_network_id");
