...
public class AwsWorkspaceswebDataProtectionSettingsAssociation : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("data_protection_settings_arn")?.Value;
        set => this.WithProperty("data_protection_settings_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
