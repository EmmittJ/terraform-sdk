...
public class AwsConfigOrganizationCustomRule : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("lambda_function_arn")?.Value;
        set => this.WithProperty("lambda_function_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
