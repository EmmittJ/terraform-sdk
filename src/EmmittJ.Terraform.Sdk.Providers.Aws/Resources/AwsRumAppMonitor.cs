...
public class AwsRumAppMonitor : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? CwLogEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("cw_log_enabled");
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? DomainList
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("domain_list");
