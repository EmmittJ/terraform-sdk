...
public class AwsMacie2Member : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? InvitationDisableEmailNotification
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("invitation_disable_email_notification");
