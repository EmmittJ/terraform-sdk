...
public class AwsSagemakerModelPackageGroup : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ModelPackageGroupDescription
    {
        get => GetProperty<TerraformLiteralProperty<string>>("model_package_group_description");
        set => this.WithProperty("model_package_group_description", value);
    }

    /// <summary>
    /// The model_package_group_name attribute.
    /// </summary>
    public TerraformLiteralProperty<string>? ModelPackageGroupName
    {
        get => GetProperty<TerraformLiteralProperty<string>>("model_package_group_name");
