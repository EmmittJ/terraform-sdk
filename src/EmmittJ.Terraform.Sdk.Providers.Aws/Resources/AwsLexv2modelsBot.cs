...
public class AwsLexv2modelsBot : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<Dictionary<string, string>>? TestBotAliasTags
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("test_bot_alias_tags");
