...
public class AwsNotificationsNotificationConfiguration : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("aggregation_duration")?.Value;
        set => this.WithProperty("aggregation_duration", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
