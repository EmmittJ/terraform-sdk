...
public class AwsSagemakerFeatureGroup : TerraformResource
{
    ...
    /// </summary>
    public TerraformProperty<string>? EventTimeFeatureName
    {
    ...
    /// </summary>
    public TerraformProperty<string>? FeatureGroupName
    {
    ...
    /// </summary>
    public TerraformProperty<string>? RecordIdentifierFeatureName
    {
