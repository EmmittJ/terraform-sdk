...
public class AwsLbListener : TerraformResource
{
    ...
    {
        get => GetProperty<List<AwsLbListenerDefaultActionBlock>>("default_action");
    ...
    {
        get => GetProperty<List<AwsLbListenerMutualAuthenticationBlock>>("mutual_authentication");
    ...
    {
        get => GetProperty<AwsLbListenerTimeoutsBlock>("timeouts");
