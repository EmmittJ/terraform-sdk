...
public class AwsFmsPolicy : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("resource_tag_logical_operator")?.Value;
        set => this.WithProperty("resource_tag_logical_operator", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
