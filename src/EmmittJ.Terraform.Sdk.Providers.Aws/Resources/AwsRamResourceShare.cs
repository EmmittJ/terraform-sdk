...
public class AwsRamResourceShare : TerraformResource
{
    ...
    /// </summary>
    public HashSet<TerraformProperty<string>>? PermissionArns
    {
        get => GetProperty<HashSet<TerraformProperty<string>>>("permission_arns");
    ...
    {
        get => GetProperty<AwsRamResourceShareTimeoutsBlock>("timeouts");
