...
public class AwsCodebuildReportGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("delete_reports")?.Value;
        set => this.WithProperty("delete_reports", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
