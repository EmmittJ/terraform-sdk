...
public class AwsWafv2IpSet : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<HashSet<string>>? Addresses
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("addresses");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? IpAddressVersion
    {
        get => GetProperty<TerraformLiteralProperty<string>>("ip_address_version");
