...
public class GoogleContainerClusterDataSource : TerraformDataSource
{
    ...
    {
        this.DeclareOutput("addons_config");
        this.DeclareOutput("allow_net_admin");
        this.DeclareOutput("anonymous_authentication_config");
        this.DeclareOutput("authenticator_groups_config");
        this.DeclareOutput("binary_authorization");
        this.DeclareOutput("cluster_autoscaling");
        this.DeclareOutput("cluster_ipv4_cidr");
        this.DeclareOutput("confidential_nodes");
        this.DeclareOutput("control_plane_endpoints_config");
        this.DeclareOutput("cost_management_config");
        this.DeclareOutput("database_encryption");
        this.DeclareOutput("datapath_provider");
        this.DeclareOutput("default_max_pods_per_node");
        this.DeclareOutput("default_snat_status");
        this.DeclareOutput("deletion_protection");
        this.DeclareOutput("description");
        this.DeclareOutput("disable_l4_lb_firewall_reconciliation");
        this.DeclareOutput("dns_config");
        this.DeclareOutput("effective_labels");
        this.DeclareOutput("enable_autopilot");
        this.DeclareOutput("enable_cilium_clusterwide_network_policy");
        this.DeclareOutput("enable_fqdn_network_policy");
        this.DeclareOutput("enable_intranode_visibility");
        this.DeclareOutput("enable_k8s_beta_apis");
        this.DeclareOutput("enable_kubernetes_alpha");
        this.DeclareOutput("enable_l4_ilb_subsetting");
        this.DeclareOutput("enable_legacy_abac");
        this.DeclareOutput("enable_multi_networking");
        this.DeclareOutput("enable_shielded_nodes");
        this.DeclareOutput("enable_tpu");
        this.DeclareOutput("endpoint");
        this.DeclareOutput("enterprise_config");
        this.DeclareOutput("fleet");
        this.DeclareOutput("gateway_api_config");
        this.DeclareOutput("gke_auto_upgrade_config");
        this.DeclareOutput("identity_service_config");
        this.DeclareOutput("in_transit_encryption_config");
        this.DeclareOutput("initial_node_count");
        this.DeclareOutput("ip_allocation_policy");
        this.DeclareOutput("label_fingerprint");
        this.DeclareOutput("logging_config");
        this.DeclareOutput("logging_service");
        this.DeclareOutput("maintenance_policy");
        this.DeclareOutput("master_auth");
        this.DeclareOutput("master_authorized_networks_config");
        this.DeclareOutput("master_version");
        this.DeclareOutput("mesh_certificates");
        this.DeclareOutput("min_master_version");
        this.DeclareOutput("monitoring_config");
        this.DeclareOutput("monitoring_service");
        this.DeclareOutput("network");
        this.DeclareOutput("network_performance_config");
        this.DeclareOutput("network_policy");
        this.DeclareOutput("networking_mode");
        this.DeclareOutput("node_config");
        this.DeclareOutput("node_locations");
        this.DeclareOutput("node_pool");
        this.DeclareOutput("node_pool_auto_config");
        this.DeclareOutput("node_pool_defaults");
        this.DeclareOutput("node_version");
        this.DeclareOutput("notification_config");
        this.DeclareOutput("operation");
        this.DeclareOutput("pod_autoscaling");
        this.DeclareOutput("private_cluster_config");
        this.DeclareOutput("private_ipv6_google_access");
        this.DeclareOutput("rbac_binding_config");
        this.DeclareOutput("release_channel");
        this.DeclareOutput("remove_default_node_pool");
        this.DeclareOutput("resource_labels");
        this.DeclareOutput("resource_usage_export_config");
        this.DeclareOutput("secret_manager_config");
        this.DeclareOutput("security_posture_config");
        this.DeclareOutput("self_link");
        this.DeclareOutput("service_external_ips_config");
        this.DeclareOutput("services_ipv4_cidr");
        this.DeclareOutput("subnetwork");
        this.DeclareOutput("terraform_labels");
        this.DeclareOutput("tpu_ipv4_cidr_block");
        this.DeclareOutput("user_managed_keys_config");
        this.DeclareOutput("vertical_pod_autoscaling");
