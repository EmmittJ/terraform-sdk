...
public class GooglePubsubSubscriptionIamPolicyDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("subscription")?.Value;
        set => this.WithProperty("subscription", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
