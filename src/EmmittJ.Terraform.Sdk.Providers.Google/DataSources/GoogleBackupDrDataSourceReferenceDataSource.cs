...
public class GoogleBackupDrDataSourceReferenceDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("data_source_reference_id")?.Value;
        set => this.WithProperty("data_source_reference_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
