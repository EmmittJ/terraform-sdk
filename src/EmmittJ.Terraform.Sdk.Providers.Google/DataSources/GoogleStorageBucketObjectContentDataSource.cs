...
public class GoogleStorageBucketObjectContentDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        this.DeclareOutput("content_base64");
        this.DeclareOutput("content_base64sha512");
        this.DeclareOutput("content_disposition");
        this.DeclareOutput("content_encoding");
        this.DeclareOutput("content_hexsha512");
    ...
    /// </summary>
    public TerraformExpression ContentBase64 => this["content_base64"];

    /// <summary>
    /// Base64 encoded SHA512 checksum of object content.
    /// </summary>
    public TerraformExpression ContentBase64sha512 => this["content_base64sha512"];
    ...
    /// </summary>
    public TerraformExpression ContentHexsha512 => this["content_hexsha512"];
