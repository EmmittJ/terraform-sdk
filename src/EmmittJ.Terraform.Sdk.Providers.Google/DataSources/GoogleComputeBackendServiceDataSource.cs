...
/// </summary>
public class GoogleComputeBackendServiceDataSource : TerraformDataSource
{
    public GoogleComputeBackendServiceDataSource(string name) : base("google_compute_backend_service", name)
    {
        InitializeOutputs();
    }
    ...
    private void InitializeOutputs()
    {
        ...
        this.DeclareOutput("custom_request_headers");
        this.DeclareOutput("custom_response_headers");
        this.DeclareOutput("description");
        this.DeclareOutput("edge_security_policy");
        this.DeclareOutput("enable_cdn");
        this.DeclareOutput("external_managed_migration_state");
        this.DeclareOutput("external_managed_migration_testing_percentage");
        ...
        this.DeclareOutput("locality_lb_policies");
        this.DeclareOutput("locality_lb_policy");
        this.DeclareOutput("log_config");
        this.DeclareOutput("max_stream_duration");
    ...
    /// requests.
    /// </summary>
    public TerraformExpression CustomRequestHeaders => this["custom_request_headers"];
    ...
    /// </summary>
    public TerraformExpression ExternalManagedMigrationState => this["external_managed_migration_state"];
    ...
    /// </summary>
    public TerraformExpression ExternalManagedMigrationTestingPercentage => this["external_managed_migration_testing_percentage"];
    ...
    /// </summary>
    public TerraformExpression LocalityLbPolicies => this["locality_lb_policies"];
    ...
    /// </summary>
    public TerraformExpression MaxStreamDuration => this["max_stream_duration"];
    ...
    /// </summary>
    public TerraformExpression SecuritySettings => this["security_settings"];
    ...
    /// </summary>
    public TerraformExpression ServiceLbPolicy => this["service_lb_policy"];
    ...
    /// </summary>
    public TerraformExpression TlsSettings => this["tls_settings"];
