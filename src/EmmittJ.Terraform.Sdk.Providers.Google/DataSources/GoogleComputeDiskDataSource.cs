...
public class GoogleComputeDiskDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        this.DeclareOutput("enable_confidential_compute");
        ...
        this.DeclareOutput("source_image_encryption_key");
        this.DeclareOutput("source_image_id");
        this.DeclareOutput("source_instant_snapshot");
        ...
        this.DeclareOutput("source_storage_object");
        this.DeclareOutput("storage_pool");
