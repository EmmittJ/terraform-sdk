...
public class GoogleDataprocBatch : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("batch_id")?.Value;
        set => this.WithProperty("batch_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
