...
public class GoogleComputeInstantSnapshotIamMember : TerraformResource
{
    ...
    public List<GoogleComputeInstantSnapshotIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleComputeInstantSnapshotIamMemberConditionBlock>>("condition");
