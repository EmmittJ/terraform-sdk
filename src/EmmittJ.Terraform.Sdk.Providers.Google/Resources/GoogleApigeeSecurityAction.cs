...
public class GoogleApigeeSecurityAction : TerraformResource
{
    ...
    /// </summary>
    public List<string>? ApiProxies
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("api_proxies")?.Value;
        set => this.WithProperty("api_proxies", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }
    ...
    /// </summary>
    public string? SecurityActionId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("security_action_id")?.Value;
        set => this.WithProperty("security_action_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
