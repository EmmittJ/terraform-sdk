...
public class GoogleNetworkSecurityTlsInspectionPolicy : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? CustomTlsFeatures
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("custom_tls_features");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? ExcludePublicCaSet
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("exclude_public_ca_set");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? TlsFeatureProfile
    {
        get => GetProperty<TerraformLiteralProperty<string>>("tls_feature_profile");
