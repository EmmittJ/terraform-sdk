...
public class GoogleComputeRegionInstanceGroupManager : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("distribution_policy_target_shape")?.Value;
        set => this.WithProperty("distribution_policy_target_shape", value == null ? null : new TerraformLiteralProperty<string>(value));
    }

    /// <summary>
    /// The distribution policy for this managed instance group. You can specify one or more values.
    /// </summary>
    public HashSet<string>? DistributionPolicyZones
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("distribution_policy_zones")?.Value;
        set => this.WithProperty("distribution_policy_zones", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
