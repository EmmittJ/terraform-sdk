...
public class GoogleSccFolderCustomModule : TerraformResource
{
    ...
    public List<GoogleSccFolderCustomModuleCustomConfigBlock>? CustomConfig
    {
        get => GetProperty<List<GoogleSccFolderCustomModuleCustomConfigBlock>>("custom_config");
    ...
    {
        get => GetProperty<GoogleSccFolderCustomModuleTimeoutsBlock>("timeouts");
