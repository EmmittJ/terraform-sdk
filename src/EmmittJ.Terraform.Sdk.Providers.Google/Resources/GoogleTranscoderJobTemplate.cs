...
public class GoogleTranscoderJobTemplate : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("job_template_id")?.Value;
        set => this.WithProperty("job_template_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
