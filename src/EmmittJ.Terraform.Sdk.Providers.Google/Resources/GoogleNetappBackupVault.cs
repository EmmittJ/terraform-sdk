...
public class GoogleNetappBackupVault : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? BackupRegion
    {
        get => GetProperty<TerraformLiteralProperty<string>>("backup_region");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? BackupVaultType
    {
        get => GetProperty<TerraformLiteralProperty<string>>("backup_vault_type");
