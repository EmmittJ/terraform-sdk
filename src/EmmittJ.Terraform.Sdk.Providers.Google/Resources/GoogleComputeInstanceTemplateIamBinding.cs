...
public class GoogleComputeInstanceTemplateIamBinding : TerraformResource
{
    ...
    public List<GoogleComputeInstanceTemplateIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleComputeInstanceTemplateIamBindingConditionBlock>>("condition");
