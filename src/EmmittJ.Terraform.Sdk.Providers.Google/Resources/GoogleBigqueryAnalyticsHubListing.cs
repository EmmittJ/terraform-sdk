...
public class GoogleBigqueryAnalyticsHubListing : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? AllowOnlyMetadataSharing
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("allow_only_metadata_sharing");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? DeleteCommercial
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("delete_commercial");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? RequestAccess
    {
        get => GetProperty<TerraformLiteralProperty<string>>("request_access");
