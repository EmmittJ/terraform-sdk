...
public class GoogleComputeRegionInstanceTemplate : TerraformResource
{
    ...
    public List<GoogleComputeRegionInstanceTemplateAdvancedMachineFeaturesBlock>? AdvancedMachineFeatures
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateAdvancedMachineFeaturesBlock>>("advanced_machine_features");
    ...
    public List<GoogleComputeRegionInstanceTemplateConfidentialInstanceConfigBlock>? ConfidentialInstanceConfig
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateConfidentialInstanceConfigBlock>>("confidential_instance_config");
    ...
    public List<GoogleComputeRegionInstanceTemplateDiskBlock>? Disk
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateDiskBlock>>("disk");
    ...
    /// Nesting mode: list
    /// </summary>
    public List<GoogleComputeRegionInstanceTemplateGuestAcceleratorBlock>? GuestAccelerator
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateGuestAcceleratorBlock>>("guest_accelerator");
    ...
    /// Nesting mode: list
    /// </summary>
    public List<GoogleComputeRegionInstanceTemplateNetworkInterfaceBlock>? NetworkInterface
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateNetworkInterfaceBlock>>("network_interface");
    ...
    public List<GoogleComputeRegionInstanceTemplateNetworkPerformanceConfigBlock>? NetworkPerformanceConfig
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateNetworkPerformanceConfigBlock>>("network_performance_config");
    ...
    public List<GoogleComputeRegionInstanceTemplateReservationAffinityBlock>? ReservationAffinity
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateReservationAffinityBlock>>("reservation_affinity");
    ...
    public List<GoogleComputeRegionInstanceTemplateSchedulingBlock>? Scheduling
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateSchedulingBlock>>("scheduling");
    ...
    public List<GoogleComputeRegionInstanceTemplateServiceAccountBlock>? ServiceAccount
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateServiceAccountBlock>>("service_account");
    ...
    public List<GoogleComputeRegionInstanceTemplateShieldedInstanceConfigBlock>? ShieldedInstanceConfig
    {
        get => GetProperty<List<GoogleComputeRegionInstanceTemplateShieldedInstanceConfigBlock>>("shielded_instance_config");
    ...
    {
        get => GetProperty<GoogleComputeRegionInstanceTemplateTimeoutsBlock>("timeouts");
