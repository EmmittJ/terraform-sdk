...
public class GoogleSecretManagerRegionalSecretIamBinding : TerraformResource
{
    ...
    public List<GoogleSecretManagerRegionalSecretIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSecretManagerRegionalSecretIamBindingConditionBlock>>("condition");
