...
public class GoogleIapWebRegionBackendServiceIamMember : TerraformResource
{
    ...
    public List<GoogleIapWebRegionBackendServiceIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleIapWebRegionBackendServiceIamMemberConditionBlock>>("condition");
