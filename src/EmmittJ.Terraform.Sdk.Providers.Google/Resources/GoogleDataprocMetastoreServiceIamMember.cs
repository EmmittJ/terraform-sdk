...
public class GoogleDataprocMetastoreServiceIamMember : TerraformResource
{
    ...
    public List<GoogleDataprocMetastoreServiceIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataprocMetastoreServiceIamMemberConditionBlock>>("condition");
