...
public class GoogleGkeonpremBareMetalNodePool : TerraformResource
{
    ...
    /// </summary>
    public string? BareMetalCluster
    {
        get => GetProperty<TerraformLiteralProperty<string>>("bare_metal_cluster")?.Value;
        set => this.WithProperty("bare_metal_cluster", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
