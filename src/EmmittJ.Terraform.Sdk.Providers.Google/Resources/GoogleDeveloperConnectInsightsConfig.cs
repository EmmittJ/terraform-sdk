...
public class GoogleDeveloperConnectInsightsConfig : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("app_hub_application")?.Value;
        set => this.WithProperty("app_hub_application", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("insights_config_id")?.Value;
        set => this.WithProperty("insights_config_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
