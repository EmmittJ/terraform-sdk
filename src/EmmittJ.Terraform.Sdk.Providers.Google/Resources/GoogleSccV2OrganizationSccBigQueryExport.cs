...
/// </summary>
public class GoogleSccV2OrganizationSccBigQueryExport : TerraformResource
{
    public GoogleSccV2OrganizationSccBigQueryExport(string name) : base("google_scc_v2_organization_scc_big_query_export", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock>("timeouts");
