...
public class GoogleIapWebRegionBackendServiceIamBinding : TerraformResource
{
    ...
    public List<GoogleIapWebRegionBackendServiceIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleIapWebRegionBackendServiceIamBindingConditionBlock>>("condition");
