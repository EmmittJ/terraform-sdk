...
public class GoogleCloudfunctionsFunctionIamBinding : TerraformResource
{
    ...
    public List<GoogleCloudfunctionsFunctionIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleCloudfunctionsFunctionIamBindingConditionBlock>>("condition");
