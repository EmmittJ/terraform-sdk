...
public class GoogleColabRuntimeTemplateIamBinding : TerraformResource
{
    ...
    public List<GoogleColabRuntimeTemplateIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleColabRuntimeTemplateIamBindingConditionBlock>>("condition");
