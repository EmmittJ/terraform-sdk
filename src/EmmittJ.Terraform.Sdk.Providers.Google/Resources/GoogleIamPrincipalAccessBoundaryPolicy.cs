...
public class GoogleIamPrincipalAccessBoundaryPolicy : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PrincipalAccessBoundaryPolicyId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("principal_access_boundary_policy_id");
