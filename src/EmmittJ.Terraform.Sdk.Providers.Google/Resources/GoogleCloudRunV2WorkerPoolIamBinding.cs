...
public class GoogleCloudRunV2WorkerPoolIamBinding : TerraformResource
{
    ...
    public List<GoogleCloudRunV2WorkerPoolIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleCloudRunV2WorkerPoolIamBindingConditionBlock>>("condition");
