...
public class GoogleBigqueryDatapolicyv2DataPolicyIamBinding : TerraformResource
{
    ...
    public List<GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock>>("condition");
