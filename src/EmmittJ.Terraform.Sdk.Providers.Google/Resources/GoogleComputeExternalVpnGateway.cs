...
public class GoogleComputeExternalVpnGateway : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("redundancy_type")?.Value;
        set => this.WithProperty("redundancy_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
