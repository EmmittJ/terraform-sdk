...
public class GoogleClouddeployCustomTargetTypeIamBinding : TerraformResource
{
    ...
    public List<GoogleClouddeployCustomTargetTypeIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleClouddeployCustomTargetTypeIamBindingConditionBlock>>("condition");
