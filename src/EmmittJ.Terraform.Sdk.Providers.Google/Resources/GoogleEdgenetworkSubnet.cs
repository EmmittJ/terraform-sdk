...
public class GoogleEdgenetworkSubnet : TerraformResource
{
    ...
    /// </summary>
    public List<string>? Ipv4Cidr
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("ipv4_cidr")?.Value;
        set => this.WithProperty("ipv4_cidr", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }

    /// <summary>
    /// The ranges of ipv6 addresses that are owned by this subnetwork, in CIDR format.
    /// </summary>
    public List<string>? Ipv6Cidr
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("ipv6_cidr")?.Value;
        set => this.WithProperty("ipv6_cidr", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }
