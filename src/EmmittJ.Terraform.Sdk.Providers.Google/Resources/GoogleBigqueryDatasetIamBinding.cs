...
public class GoogleBigqueryDatasetIamBinding : TerraformResource
{
    public GoogleBigqueryDatasetIamBinding(string name) : base("google_bigquery_dataset_iam_binding", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleBigqueryDatasetIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleBigqueryDatasetIamBindingConditionBlock>>("condition");
