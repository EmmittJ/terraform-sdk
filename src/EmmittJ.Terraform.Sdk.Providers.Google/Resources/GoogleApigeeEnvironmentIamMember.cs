...
public class GoogleApigeeEnvironmentIamMember : TerraformResource
{
    ...
    public List<GoogleApigeeEnvironmentIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleApigeeEnvironmentIamMemberConditionBlock>>("condition");
