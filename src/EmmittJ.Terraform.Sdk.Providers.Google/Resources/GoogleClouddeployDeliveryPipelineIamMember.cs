...
public class GoogleClouddeployDeliveryPipelineIamMember : TerraformResource
{
    ...
    public List<GoogleClouddeployDeliveryPipelineIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleClouddeployDeliveryPipelineIamMemberConditionBlock>>("condition");
