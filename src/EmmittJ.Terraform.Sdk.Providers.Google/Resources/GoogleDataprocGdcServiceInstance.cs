...
public class GoogleDataprocGdcServiceInstance : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("service_instance_id")?.Value;
        set => this.WithProperty("service_instance_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
