...
public class GoogleCloudfunctionsFunction : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? AvailableMemoryMb
    {
        get => GetProperty<TerraformLiteralProperty<double>>("available_memory_mb");
    ...
    /// </summary>
    public TerraformLiteralProperty<Dictionary<string, string>>? BuildEnvironmentVariables
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("build_environment_variables");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? BuildServiceAccount
    {
        get => GetProperty<TerraformLiteralProperty<string>>("build_service_account");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? BuildWorkerPool
    {
        get => GetProperty<TerraformLiteralProperty<string>>("build_worker_pool");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? DockerRegistry
    {
        get => GetProperty<TerraformLiteralProperty<string>>("docker_registry");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? DockerRepository
    {
        get => GetProperty<TerraformLiteralProperty<string>>("docker_repository");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? EntryPoint
    {
        get => GetProperty<TerraformLiteralProperty<string>>("entry_point");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? HttpsTriggerSecurityLevel
    {
        get => GetProperty<TerraformLiteralProperty<string>>("https_trigger_security_level");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? HttpsTriggerUrl
    {
        get => GetProperty<TerraformLiteralProperty<string>>("https_trigger_url");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? IngressSettings
    {
        get => GetProperty<TerraformLiteralProperty<string>>("ingress_settings");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ServiceAccountEmail
    {
        get => GetProperty<TerraformLiteralProperty<string>>("service_account_email");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? SourceArchiveBucket
    {
        get => GetProperty<TerraformLiteralProperty<string>>("source_archive_bucket");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? SourceArchiveObject
    {
        get => GetProperty<TerraformLiteralProperty<string>>("source_archive_object");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? TriggerHttp
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("trigger_http");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? VpcConnector
    {
        get => GetProperty<TerraformLiteralProperty<string>>("vpc_connector");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? VpcConnectorEgressSettings
    {
        get => GetProperty<TerraformLiteralProperty<string>>("vpc_connector_egress_settings");
