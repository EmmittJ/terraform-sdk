...
public class GoogleNetworkConnectivityHub : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? ExportPsc
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("export_psc");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PolicyMode
    {
        get => GetProperty<TerraformLiteralProperty<string>>("policy_mode");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PresetTopology
    {
        get => GetProperty<TerraformLiteralProperty<string>>("preset_topology");
