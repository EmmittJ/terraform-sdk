...
public class GoogleColabRuntimeTemplateIamMember : TerraformResource
{
    ...
    public List<GoogleColabRuntimeTemplateIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleColabRuntimeTemplateIamMemberConditionBlock>>("condition");
