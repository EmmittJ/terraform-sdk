...
public class GoogleDataprocAutoscalingPolicyIamMember : TerraformResource
{
    ...
    public List<GoogleDataprocAutoscalingPolicyIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataprocAutoscalingPolicyIamMemberConditionBlock>>("condition");
