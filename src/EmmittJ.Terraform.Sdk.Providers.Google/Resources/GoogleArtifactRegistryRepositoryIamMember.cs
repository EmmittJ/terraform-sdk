...
public class GoogleArtifactRegistryRepositoryIamMember : TerraformResource
{
    ...
    public List<GoogleArtifactRegistryRepositoryIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleArtifactRegistryRepositoryIamMemberConditionBlock>>("condition");
