...
public class GoogleDataprocAutoscalingPolicyIamBinding : TerraformResource
{
    ...
    public List<GoogleDataprocAutoscalingPolicyIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataprocAutoscalingPolicyIamBindingConditionBlock>>("condition");
