...
public class GoogleBigqueryAnalyticsHubDataExchangeIamMember : TerraformResource
{
    ...
    public List<GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock>>("condition");
