...
public class GoogleNetworkServicesLbTrafficExtension : TerraformResource
{
    ...
    public List<GoogleNetworkServicesLbTrafficExtensionExtensionChainsBlock>? ExtensionChains
    {
        get => GetProperty<List<GoogleNetworkServicesLbTrafficExtensionExtensionChainsBlock>>("extension_chains");
    ...
    {
        get => GetProperty<GoogleNetworkServicesLbTrafficExtensionTimeoutsBlock>("timeouts");
