...
public class GoogleDataflowJob : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<HashSet<string>>? AdditionalExperiments
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("additional_experiments");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? EnableStreamingEngine
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("enable_streaming_engine");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? IpConfiguration
    {
        get => GetProperty<TerraformLiteralProperty<string>>("ip_configuration");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? OnDelete
    {
        get => GetProperty<TerraformLiteralProperty<string>>("on_delete");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? SkipWaitOnJobTermination
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("skip_wait_on_job_termination");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? TempGcsLocation
    {
        get => GetProperty<TerraformLiteralProperty<string>>("temp_gcs_location");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? TemplateGcsPath
    {
        get => GetProperty<TerraformLiteralProperty<string>>("template_gcs_path");
    ...
    /// </summary>
    public TerraformLiteralProperty<Dictionary<string, string>>? TransformNameMapping
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("transform_name_mapping");
