...
public class GoogleComputeImageIamBinding : TerraformResource
{
    public GoogleComputeImageIamBinding(string name) : base("google_compute_image_iam_binding", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleComputeImageIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleComputeImageIamBindingConditionBlock>>("condition");
