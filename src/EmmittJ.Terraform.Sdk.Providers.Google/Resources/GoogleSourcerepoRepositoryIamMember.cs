...
public class GoogleSourcerepoRepositoryIamMember : TerraformResource
{
    ...
    public List<GoogleSourcerepoRepositoryIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSourcerepoRepositoryIamMemberConditionBlock>>("condition");
