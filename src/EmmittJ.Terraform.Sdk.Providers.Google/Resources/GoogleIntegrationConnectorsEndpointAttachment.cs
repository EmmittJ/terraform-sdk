...
public class GoogleIntegrationConnectorsEndpointAttachment : TerraformResource
{
    ...
    /// </summary>
    public bool? EndpointGlobalAccess
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("endpoint_global_access")?.Value;
        set => this.WithProperty("endpoint_global_access", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
