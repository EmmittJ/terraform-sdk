...
public class GoogleHealthcareFhirStoreIamBinding : TerraformResource
{
    ...
    public List<GoogleHealthcareFhirStoreIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleHealthcareFhirStoreIamBindingConditionBlock>>("condition");
