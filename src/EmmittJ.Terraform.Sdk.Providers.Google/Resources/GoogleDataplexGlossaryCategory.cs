...
public class GoogleDataplexGlossaryCategory : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("category_id")?.Value;
        set => this.WithProperty("category_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
