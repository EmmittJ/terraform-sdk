...
public class GoogleCloudbuildv2ConnectionIamBinding : TerraformResource
{
    ...
    public List<GoogleCloudbuildv2ConnectionIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleCloudbuildv2ConnectionIamBindingConditionBlock>>("condition");
