...
public class GoogleEndpointsService : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? GrpcConfig
    {
        get => GetProperty<TerraformLiteralProperty<string>>("grpc_config");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? OpenapiConfig
    {
        get => GetProperty<TerraformLiteralProperty<string>>("openapi_config");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ProtocOutputBase64
    {
        get => GetProperty<TerraformLiteralProperty<string>>("protoc_output_base64");
