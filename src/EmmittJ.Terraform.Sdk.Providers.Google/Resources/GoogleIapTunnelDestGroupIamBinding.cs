...
public class GoogleIapTunnelDestGroupIamBinding : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("dest_group")?.Value;
        set => this.WithProperty("dest_group", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
