...
public class GoogleVertexAiFeatureOnlineStoreFeatureview : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("feature_online_store")?.Value;
        set => this.WithProperty("feature_online_store", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
