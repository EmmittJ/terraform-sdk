...
public class GoogleBigqueryTable : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? Clustering
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("clustering");
    ...
    /// </summary>
    public TerraformLiteralProperty<double>? ExpirationTime
    {
        get => GetProperty<TerraformLiteralProperty<double>>("expiration_time");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? IgnoreAutoGeneratedSchema
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("ignore_auto_generated_schema");
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? IgnoreSchemaChanges
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("ignore_schema_changes");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? MaxStaleness
    {
        get => GetProperty<TerraformLiteralProperty<string>>("max_staleness");
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? RequirePartitionFilter
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("require_partition_filter");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? TableMetadataView
    {
        get => GetProperty<TerraformLiteralProperty<string>>("table_metadata_view");
