...
public class GoogleHealthcareDicomStoreIamMember : TerraformResource
{
    ...
    public List<GoogleHealthcareDicomStoreIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleHealthcareDicomStoreIamMemberConditionBlock>>("condition");
