...
public class GoogleIapWebForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public List<GoogleIapWebForwardingRuleServiceIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleIapWebForwardingRuleServiceIamMemberConditionBlock>>("condition");
