...
public class GoogleNetworkSecurityInterceptDeployment : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("intercept_deployment_id")?.Value;
        set => this.WithProperty("intercept_deployment_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
