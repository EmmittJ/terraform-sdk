...
public class GoogleApigeeControlPlaneAccess : TerraformResource
{
    ...
    /// </summary>
    public List<string>? AnalyticsPublisherIdentities
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("analytics_publisher_identities")?.Value;
        set => this.WithProperty("analytics_publisher_identities", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }
    ...
    /// </summary>
    public List<string>? SynchronizerIdentities
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("synchronizer_identities")?.Value;
        set => this.WithProperty("synchronizer_identities", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }
