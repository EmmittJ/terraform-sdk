...
public class GoogleSccProjectNotificationConfig : TerraformResource
{
    ...
    public List<GoogleSccProjectNotificationConfigStreamingConfigBlock>? StreamingConfig
    {
        get => GetProperty<List<GoogleSccProjectNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    {
        get => GetProperty<GoogleSccProjectNotificationConfigTimeoutsBlock>("timeouts");
