...
public class GoogleDataCatalogTagTemplateIamBinding : TerraformResource
{
    ...
    public List<GoogleDataCatalogTagTemplateIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataCatalogTagTemplateIamBindingConditionBlock>>("condition");
