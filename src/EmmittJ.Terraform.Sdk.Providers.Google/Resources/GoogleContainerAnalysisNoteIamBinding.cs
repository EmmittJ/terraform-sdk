...
public class GoogleContainerAnalysisNoteIamBinding : TerraformResource
{
    ...
    public List<GoogleContainerAnalysisNoteIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleContainerAnalysisNoteIamBindingConditionBlock>>("condition");
