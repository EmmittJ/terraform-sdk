...
/// <summary>
/// Represents a random_password Terraform resource.
...
/// </summary>
public partial class RandomPassword(string name) : TerraformResource("random_password", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformValue<string> BcryptHash
        => CreateReference("bcrypt_hash");
