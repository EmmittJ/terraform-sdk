...
/// <summary>
/// Represents a google_bigquery_datapolicy_data_policy_iam_policy Terraform data source.
/// Retrieves information about a google_bigquery_datapolicy_data_policy_iam_policy.
/// </summary>
public partial class GoogleBigqueryDatapolicyDataPolicyIamPolicyDataSource(string name) : TerraformDataSource("google_bigquery_datapolicy_data_policy_iam_policy", name)
{
    /// <summary>
