...
/// <summary>
/// Represents a google_parameter_manager_parameters Terraform data source.
/// Retrieves information about a google_parameter_manager_parameters.
/// </summary>
public partial class GoogleParameterManagerParametersDataSource(string name) : TerraformDataSource("google_parameter_manager_parameters", name)
{
    /// <summary>
