...
/// <summary>
/// Represents a google_secure_source_manager_repository_iam_policy Terraform data source.
/// Retrieves information about a google_secure_source_manager_repository_iam_policy.
/// </summary>
public partial class GoogleSecureSourceManagerRepositoryIamPolicyDataSource(string name) : TerraformDataSource("google_secure_source_manager_repository_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
