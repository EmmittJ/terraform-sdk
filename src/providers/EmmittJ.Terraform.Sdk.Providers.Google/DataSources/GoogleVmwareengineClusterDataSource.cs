...
public partial class GoogleVmwareengineClusterDataSource(string name) : TerraformDataSource("google_vmwareengine_cluster", name)
{
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "autoscaling_settings").ResolveNodes(ctx));
    }
    ...
    {
        get => TerraformSet<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformSet<TerraformMap<object>>>(this, "node_type_configs").ResolveNodes(ctx));
    }
