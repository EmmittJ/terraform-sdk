...
/// </summary>
public partial class GoogleCloudRunV2ServiceDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> DefaultUriDisabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Ingress { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> InvokerIamDisabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> MultiRegionSettings { get; }
