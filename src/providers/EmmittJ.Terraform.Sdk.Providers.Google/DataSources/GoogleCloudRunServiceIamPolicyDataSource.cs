...
/// </summary>
public partial class GoogleCloudRunServiceIamPolicyDataSource : TerraformDataSource
{
    public GoogleCloudRunServiceIamPolicyDataSource(string name) : base("google_cloud_run_service_iam_policy", name)
    {
    }
