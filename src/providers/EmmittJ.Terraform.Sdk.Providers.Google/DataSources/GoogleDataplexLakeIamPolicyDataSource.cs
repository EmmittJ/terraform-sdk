...
/// <summary>
/// Represents a google_dataplex_lake_iam_policy Terraform data source.
/// Retrieves information about a google_dataplex_lake_iam_policy.
/// </summary>
public partial class GoogleDataplexLakeIamPolicyDataSource(string name) : TerraformDataSource("google_dataplex_lake_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
