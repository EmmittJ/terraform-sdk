...
/// <summary>
/// Represents a google_secret_manager_secret Terraform data source.
/// Retrieves information about a google_secret_manager_secret.
/// </summary>
public partial class GoogleSecretManagerSecretDataSource(string name) : TerraformDataSource("google_secret_manager_secret", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "replication").ResolveNodes(ctx));
    }
