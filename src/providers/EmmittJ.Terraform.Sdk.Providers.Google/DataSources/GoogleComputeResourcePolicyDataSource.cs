...
public partial class GoogleComputeResourcePolicyDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DiskConsistencyGroupPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> GroupPlacementPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> InstanceSchedulePolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SnapshotSchedulePolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> WorkloadPolicy { get; }
