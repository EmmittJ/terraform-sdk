...
public partial class GoogleVpcAccessConnectorDataSource(string name) : TerraformDataSource("google_vpc_access_connector", name)
{
    ...
    {
        get => TerraformList<string>.Lazy(ctx => new TerraformReference<TerraformList<string>>(this, "connected_projects").ResolveNodes(ctx));
    }
    ...
    {
        get => new TerraformReference<double>(this, "min_throughput");
    }
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "subnet").ResolveNodes(ctx));
    }
