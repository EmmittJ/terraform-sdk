...
public class GoogleSpannerInstanceDataSource : TerraformDataSource
{
    ...
    /// the instance.
    /// </summary>
    public TerraformExpression AutoscalingConfig => this["autoscaling_config"];
    ...
    /// </summary>
    public TerraformExpression DefaultBackupScheduleType => this["default_backup_schedule_type"];
    ...
    /// </summary>
    public TerraformExpression NumNodes => this["num_nodes"];
    ...
    /// </summary>
    public TerraformExpression ProcessingUnits => this["processing_units"];
