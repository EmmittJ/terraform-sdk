...
public partial class GoogleSpannerInstanceDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> AutoscalingConfig { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> DefaultBackupScheduleType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> NumNodes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ProcessingUnits { get; }
