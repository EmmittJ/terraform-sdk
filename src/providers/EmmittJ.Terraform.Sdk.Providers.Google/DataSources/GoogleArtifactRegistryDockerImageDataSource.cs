...
public partial class GoogleArtifactRegistryDockerImageDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> BuildTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ImageSizeBytes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MediaType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> UploadTime { get; }
