...
/// </summary>
public partial class GoogleDataplexGlossaryIamPolicyDataSource : TerraformDataSource
{
    public GoogleDataplexGlossaryIamPolicyDataSource(string name) : base("google_dataplex_glossary_iam_policy", name)
    {
    }
