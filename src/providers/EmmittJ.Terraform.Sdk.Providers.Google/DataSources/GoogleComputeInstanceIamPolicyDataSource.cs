...
/// <summary>
/// Represents a google_compute_instance_iam_policy Terraform data source.
/// Retrieves information about a google_compute_instance_iam_policy.
/// </summary>
public partial class GoogleComputeInstanceIamPolicyDataSource(string name) : TerraformDataSource("google_compute_instance_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
