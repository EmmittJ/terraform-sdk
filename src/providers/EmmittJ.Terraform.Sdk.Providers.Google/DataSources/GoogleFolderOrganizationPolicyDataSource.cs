...
/// </summary>
public partial class GoogleFolderOrganizationPolicyDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> BooleanPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> ListPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> RestorePolicy { get; }
