...
/// <summary>
/// Represents a google_sourcerepo_repository_iam_policy Terraform data source.
/// Retrieves information about a google_sourcerepo_repository_iam_policy.
/// </summary>
public partial class GoogleSourcerepoRepositoryIamPolicyDataSource(string name) : TerraformDataSource("google_sourcerepo_repository_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
