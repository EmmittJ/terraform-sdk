...
/// <summary>
/// Represents a google_dataplex_entry_type_iam_policy Terraform data source.
/// Retrieves information about a google_dataplex_entry_type_iam_policy.
/// </summary>
public partial class GoogleDataplexEntryTypeIamPolicyDataSource(string name) : TerraformDataSource("google_dataplex_entry_type_iam_policy", name)
{
    /// <summary>
