...
/// <summary>
/// Represents a google_pubsub_topic Terraform data source.
/// Retrieves information about a google_pubsub_topic.
/// </summary>
public partial class GooglePubsubTopicDataSource(string name) : TerraformDataSource("google_pubsub_topic", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
