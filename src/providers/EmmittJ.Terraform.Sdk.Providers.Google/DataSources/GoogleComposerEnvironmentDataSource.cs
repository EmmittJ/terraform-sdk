...
/// </summary>
public partial class GoogleComposerEnvironmentDataSource : TerraformDataSource
{
    public GoogleComposerEnvironmentDataSource(string name) : base("google_composer_environment", name)
    {
    }
