...
/// <summary>
/// Represents a google_gke_hub_feature Terraform data source.
/// Retrieves information about a google_gke_hub_feature.
/// </summary>
public partial class GoogleGkeHubFeatureDataSource(string name) : TerraformDataSource("google_gke_hub_feature", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
