...
/// <summary>
/// Represents a google_spanner_database_iam_policy Terraform data source.
/// Retrieves information about a google_spanner_database_iam_policy.
/// </summary>
public partial class GoogleSpannerDatabaseIamPolicyDataSource(string name) : TerraformDataSource("google_spanner_database_iam_policy", name)
{
    /// <summary>
