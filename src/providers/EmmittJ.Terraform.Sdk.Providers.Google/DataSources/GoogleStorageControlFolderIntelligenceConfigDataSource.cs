...
/// <summary>
/// Represents a google_storage_control_folder_intelligence_config Terraform data source.
/// Retrieves information about a google_storage_control_folder_intelligence_config.
/// </summary>
public partial class GoogleStorageControlFolderIntelligenceConfigDataSource(string name) : TerraformDataSource("google_storage_control_folder_intelligence_config", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
