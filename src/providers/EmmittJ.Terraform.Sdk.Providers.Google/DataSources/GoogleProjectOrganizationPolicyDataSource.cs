...
/// <summary>
/// Represents a google_project_organization_policy Terraform data source.
/// Retrieves information about a google_project_organization_policy.
/// </summary>
public partial class GoogleProjectOrganizationPolicyDataSource(string name) : TerraformDataSource("google_project_organization_policy", name)
{
    /// <summary>
