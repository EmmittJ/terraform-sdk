...
public class GoogleComputeRegionInstanceGroupManagerDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> DistributionPolicyTargetShape => new TerraformReference(this, "distribution_policy_target_shape");
    ...
    // Output-only attribute - read-only reference
    public TerraformSet<string> DistributionPolicyZones => new TerraformReference(this, "distribution_policy_zones");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> InstanceFlexibilityPolicy => new TerraformReference(this, "instance_flexibility_policy");
