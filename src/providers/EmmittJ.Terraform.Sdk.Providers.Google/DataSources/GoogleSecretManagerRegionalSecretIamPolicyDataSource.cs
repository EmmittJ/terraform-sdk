...
/// <summary>
/// Represents a google_secret_manager_regional_secret_iam_policy Terraform data source.
/// Retrieves information about a google_secret_manager_regional_secret_iam_policy.
/// </summary>
public partial class GoogleSecretManagerRegionalSecretIamPolicyDataSource(string name) : TerraformDataSource("google_secret_manager_regional_secret_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
