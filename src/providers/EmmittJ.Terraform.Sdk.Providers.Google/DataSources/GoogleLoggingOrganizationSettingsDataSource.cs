...
/// </summary>
public partial class GoogleLoggingOrganizationSettingsDataSource : TerraformDataSource
{
    public GoogleLoggingOrganizationSettingsDataSource(string name) : base("google_logging_organization_settings", name)
    {
    }
