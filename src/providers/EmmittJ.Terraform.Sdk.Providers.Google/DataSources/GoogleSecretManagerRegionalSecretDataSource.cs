...
/// <summary>
/// Represents a google_secret_manager_regional_secret Terraform data source.
/// Retrieves information about a google_secret_manager_regional_secret.
/// </summary>
public partial class GoogleSecretManagerRegionalSecretDataSource(string name) : TerraformDataSource("google_secret_manager_regional_secret", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
