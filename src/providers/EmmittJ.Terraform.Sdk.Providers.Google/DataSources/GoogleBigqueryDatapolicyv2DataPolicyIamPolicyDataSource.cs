...
/// <summary>
/// Represents a google_bigquery_datapolicyv2_data_policy_iam_policy Terraform data source.
/// Retrieves information about a google_bigquery_datapolicyv2_data_policy_iam_policy.
/// </summary>
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamPolicyDataSource(string name) : TerraformDataSource("google_bigquery_datapolicyv2_data_policy_iam_policy", name)
{
    /// <summary>
