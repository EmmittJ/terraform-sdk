...
/// <summary>
/// Represents a google_tags_tag_value Terraform data source.
/// Retrieves information about a google_tags_tag_value.
/// </summary>
public partial class GoogleTagsTagValueDataSource(string name) : TerraformDataSource("google_tags_tag_value", name)
{
    /// <summary>
