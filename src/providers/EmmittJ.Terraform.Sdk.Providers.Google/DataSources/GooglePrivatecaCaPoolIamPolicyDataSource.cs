...
/// <summary>
/// Represents a google_privateca_ca_pool_iam_policy Terraform data source.
/// Retrieves information about a google_privateca_ca_pool_iam_policy.
/// </summary>
public partial class GooglePrivatecaCaPoolIamPolicyDataSource(string name) : TerraformDataSource("google_privateca_ca_pool_iam_policy", name)
{
    /// <summary>
