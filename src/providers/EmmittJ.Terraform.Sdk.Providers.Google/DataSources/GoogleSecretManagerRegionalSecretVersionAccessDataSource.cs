...
/// <summary>
/// Represents a google_secret_manager_regional_secret_version_access Terraform data source.
/// Retrieves information about a google_secret_manager_regional_secret_version_access.
/// </summary>
public partial class GoogleSecretManagerRegionalSecretVersionAccessDataSource(string name) : TerraformDataSource("google_secret_manager_regional_secret_version_access", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
