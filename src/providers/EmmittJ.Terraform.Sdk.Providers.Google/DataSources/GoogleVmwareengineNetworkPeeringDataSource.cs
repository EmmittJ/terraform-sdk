...
public partial class GoogleVmwareengineNetworkPeeringDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ExportCustomRoutesWithPublicIp { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ImportCustomRoutesWithPublicIp { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PeerNetworkType { get; }
