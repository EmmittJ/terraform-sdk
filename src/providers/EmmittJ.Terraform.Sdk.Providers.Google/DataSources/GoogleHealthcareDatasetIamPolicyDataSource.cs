...
/// <summary>
/// Represents a google_healthcare_dataset_iam_policy Terraform data source.
/// Retrieves information about a google_healthcare_dataset_iam_policy.
/// </summary>
public partial class GoogleHealthcareDatasetIamPolicyDataSource(string name) : TerraformDataSource("google_healthcare_dataset_iam_policy", name)
{
    /// <summary>
