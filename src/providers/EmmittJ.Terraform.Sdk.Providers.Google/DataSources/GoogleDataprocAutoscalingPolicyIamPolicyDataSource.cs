...
/// <summary>
/// Represents a google_dataproc_autoscaling_policy_iam_policy Terraform data source.
/// Retrieves information about a google_dataproc_autoscaling_policy_iam_policy.
/// </summary>
public partial class GoogleDataprocAutoscalingPolicyIamPolicyDataSource(string name) : TerraformDataSource("google_dataproc_autoscaling_policy_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
