...
public partial class GoogleComputeSecurityPolicyDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> AdaptiveProtectionConfig { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> AdvancedOptionsConfig { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> RecaptchaOptionsConfig { get; }
