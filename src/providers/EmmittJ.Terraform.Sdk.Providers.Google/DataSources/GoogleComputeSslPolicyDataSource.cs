...
/// <summary>
/// Represents a google_compute_ssl_policy Terraform data source.
/// Retrieves information about a google_compute_ssl_policy.
/// </summary>
public partial class GoogleComputeSslPolicyDataSource(string name) : TerraformDataSource("google_compute_ssl_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
