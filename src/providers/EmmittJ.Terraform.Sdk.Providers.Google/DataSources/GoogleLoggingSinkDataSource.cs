...
public partial class GoogleLoggingSinkDataSource(string name) : TerraformDataSource("google_logging_sink", name)
{
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "bigquery_options").ResolveNodes(ctx));
    }
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "exclusions").ResolveNodes(ctx));
    }
