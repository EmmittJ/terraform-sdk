...
/// <summary>
/// Represents a google_dataproc_metastore_database_iam_policy Terraform data source.
/// Retrieves information about a google_dataproc_metastore_database_iam_policy.
/// </summary>
public partial class GoogleDataprocMetastoreDatabaseIamPolicyDataSource(string name) : TerraformDataSource("google_dataproc_metastore_database_iam_policy", name)
{
    /// <summary>
