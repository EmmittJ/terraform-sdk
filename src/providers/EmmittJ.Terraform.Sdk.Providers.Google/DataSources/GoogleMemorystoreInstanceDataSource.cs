...
public partial class GoogleMemorystoreInstanceDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CrossInstanceReplicationConfig { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DesiredAutoCreatedEndpoints { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DesiredPscAutoConnections { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformMap<string> EngineConfigs { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PscAttachmentDetails { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PscAutoConnections { get; }
