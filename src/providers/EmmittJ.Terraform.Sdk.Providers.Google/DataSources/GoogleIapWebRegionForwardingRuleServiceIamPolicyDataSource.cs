...
/// <summary>
/// Represents a google_iap_web_region_forwarding_rule_service_iam_policy Terraform data source.
/// Retrieves information about a google_iap_web_region_forwarding_rule_service_iam_policy.
/// </summary>
public partial class GoogleIapWebRegionForwardingRuleServiceIamPolicyDataSource(string name) : TerraformDataSource("google_iap_web_region_forwarding_rule_service_iam_policy", name)
{
    /// <summary>
