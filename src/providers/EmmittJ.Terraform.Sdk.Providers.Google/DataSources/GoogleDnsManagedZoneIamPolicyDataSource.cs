...
/// <summary>
/// Represents a google_dns_managed_zone_iam_policy Terraform data source.
/// Retrieves information about a google_dns_managed_zone_iam_policy.
/// </summary>
public partial class GoogleDnsManagedZoneIamPolicyDataSource(string name) : TerraformDataSource("google_dns_managed_zone_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
