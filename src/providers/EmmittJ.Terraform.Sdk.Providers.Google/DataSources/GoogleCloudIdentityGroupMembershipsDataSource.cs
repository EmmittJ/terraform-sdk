...
/// <summary>
/// Represents a google_cloud_identity_group_memberships Terraform data source.
/// Retrieves information about a google_cloud_identity_group_memberships.
/// </summary>
public partial class GoogleCloudIdentityGroupMembershipsDataSource(string name) : TerraformDataSource("google_cloud_identity_group_memberships", name)
{
    /// <summary>
