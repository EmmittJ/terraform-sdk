...
public partial class GoogleBackupDrDataSourceReferenceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> BackupConfigState { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> BackupCount { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> GcpResourceName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> LastBackupState { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> LastSuccessfulBackupTime { get; }
