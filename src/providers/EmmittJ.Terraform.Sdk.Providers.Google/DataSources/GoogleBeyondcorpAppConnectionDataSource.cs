...
/// <summary>
/// Represents a google_beyondcorp_app_connection Terraform data source.
/// Retrieves information about a google_beyondcorp_app_connection.
/// </summary>
public partial class GoogleBeyondcorpAppConnectionDataSource(string name) : TerraformDataSource("google_beyondcorp_app_connection", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
