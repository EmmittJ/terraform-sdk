...
public class GoogleArtifactRegistryMavenArtifactsDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformPropertyName("maven_artifacts")]
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> MavenArtifacts => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "maven_artifacts");
