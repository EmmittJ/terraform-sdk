...
/// <summary>
/// Represents a google_kms_crypto_key Terraform data source.
/// Retrieves information about a google_kms_crypto_key.
/// </summary>
public partial class GoogleKmsCryptoKeyDataSource(string name) : TerraformDataSource("google_kms_crypto_key", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "version_template").ResolveNodes(ctx));
    }
