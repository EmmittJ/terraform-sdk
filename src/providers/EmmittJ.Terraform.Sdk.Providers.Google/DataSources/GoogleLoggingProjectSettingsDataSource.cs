...
/// <summary>
/// Represents a google_logging_project_settings Terraform data source.
/// Retrieves information about a google_logging_project_settings.
/// </summary>
public partial class GoogleLoggingProjectSettingsDataSource(string name) : TerraformDataSource("google_logging_project_settings", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
