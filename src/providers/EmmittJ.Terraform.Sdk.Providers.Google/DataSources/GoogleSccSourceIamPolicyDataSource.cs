...
/// <summary>
/// Represents a google_scc_source_iam_policy Terraform data source.
/// Retrieves information about a google_scc_source_iam_policy.
/// </summary>
public partial class GoogleSccSourceIamPolicyDataSource(string name) : TerraformDataSource("google_scc_source_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
