...
/// </summary>
public partial class GoogleComputeRegionInstanceTemplateDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> InstanceDescription { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformMap<string> ResourceManagerTags { get; }
