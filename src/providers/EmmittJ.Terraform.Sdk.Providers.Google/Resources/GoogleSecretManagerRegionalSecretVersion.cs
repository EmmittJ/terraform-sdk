...
/// Nesting mode: single
/// </summary>
public partial class GoogleSecretManagerRegionalSecretVersionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleSecretManagerRegionalSecretVersion : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SecretData { get; set; }
    ...
    public GoogleSecretManagerRegionalSecretVersionTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CustomerManagedEncryption { get; }
