...
/// Nesting mode: list
/// </summary>
public class GoogleNetworkServicesHttpRouteRulesBlock : ITerraformBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkServicesHttpRouteTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkServicesHttpRoute : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNetworkServicesHttpRouteRulesBlock>>? Rules { get; set; } = new();
    ...
    public TerraformBlock<GoogleNetworkServicesHttpRouteTimeoutsBlock>? Timeouts { get; set; } = new();
