...
/// <summary>
/// Block type for timeouts in GoogleParameterManagerParameter.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_parameter_manager_parameter Terraform resource.
/// Manages a google_parameter_manager_parameter resource.
/// </summary>
public partial class GoogleParameterManagerParameter(string name) : TerraformResource("google_parameter_manager_parameter", name)
{
    /// <summary>
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "policy_member").ResolveNodes(ctx));
    }
    ...
    {
        get => GetArgument<GoogleParameterManagerParameterTimeoutsBlock>("timeouts");
