...
public class GoogleDataprocMetastoreFederationIamBinding : TerraformResource
{
    ...
    public List<GoogleDataprocMetastoreFederationIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataprocMetastoreFederationIamBindingConditionBlock>>("condition");
