...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocMetastoreFederationIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataprocMetastoreFederationIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocMetastoreFederationIamBindingConditionBlock> Condition { get; set; } = new();
