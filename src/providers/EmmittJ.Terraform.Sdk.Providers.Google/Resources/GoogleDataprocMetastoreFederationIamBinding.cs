...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreFederationIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreFederationIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreFederationIamBindingConditionBlock>>? Condition { get; set; } = new();
