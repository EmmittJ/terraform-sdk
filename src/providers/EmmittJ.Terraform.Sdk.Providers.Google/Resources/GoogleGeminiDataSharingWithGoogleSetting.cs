...
/// Nesting mode: single
/// </summary>
public class GoogleGeminiDataSharingWithGoogleSettingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiDataSharingWithGoogleSetting : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("enable_data_sharing")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EnableDataSharing { get; set; }

    /// <summary>
    /// Whether data sharing should be enabled in Preview products.
    /// </summary>
    [TerraformPropertyName("enable_preview_data_sharing")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EnablePreviewDataSharing { get; set; }
    ...
    public TerraformBlock<GoogleGeminiDataSharingWithGoogleSettingTimeoutsBlock>? Timeouts { get; set; } = new();
