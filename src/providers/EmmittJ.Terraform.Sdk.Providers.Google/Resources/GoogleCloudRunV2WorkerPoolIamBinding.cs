...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2WorkerPoolIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunV2WorkerPoolIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2WorkerPoolIamBindingConditionBlock>>? Condition { get; set; } = new();
