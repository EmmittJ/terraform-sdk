...
/// <summary>
/// Block type for encryption_config in GoogleSpannerDatabase.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleSpannerDatabase.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_spanner_database Terraform resource.
/// Manages a google_spanner_database resource.
/// </summary>
public partial class GoogleSpannerDatabase(string name) : TerraformResource("google_spanner_database", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleSpannerDatabaseEncryptionConfigBlock>? EncryptionConfig
    {
        get => GetArgument<TerraformList<GoogleSpannerDatabaseEncryptionConfigBlock>>("encryption_config");
    ...
    {
        get => GetArgument<GoogleSpannerDatabaseTimeoutsBlock>("timeouts");
