...
public partial class GoogleDiscoveryEngineSearchEngineSearchEngineConfigBlock() : TerraformBlock("search_engine_config")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? SearchAddOns { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SearchTier { get; set; }
...
public partial class GoogleDiscoveryEngineSearchEngine : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformMap<string>? Features { get; set; }
