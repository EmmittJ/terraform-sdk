...
/// Nesting mode: list
/// </summary>
public partial class GoogleSpannerDatabaseIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSpannerDatabaseIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleSpannerDatabaseIamBindingConditionBlock> Condition { get; set; } = new();
