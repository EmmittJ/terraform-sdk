...
/// Nesting mode: list
/// </summary>
public class GoogleSpannerDatabaseIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSpannerDatabaseIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSpannerDatabaseIamBindingConditionBlock>>? Condition { get; set; } = new();
