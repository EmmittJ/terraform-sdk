...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocMetastoreServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataprocMetastoreServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocMetastoreServiceIamMemberConditionBlock> Condition { get; set; } = new();
