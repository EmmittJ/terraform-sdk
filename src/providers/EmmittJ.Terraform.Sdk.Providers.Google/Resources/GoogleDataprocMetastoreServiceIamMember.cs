...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
