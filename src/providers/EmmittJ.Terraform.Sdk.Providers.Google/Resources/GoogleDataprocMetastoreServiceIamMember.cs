...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocMetastoreServiceIamMemberConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleDataprocMetastoreServiceIamMember : TerraformResource
{
    public GoogleDataprocMetastoreServiceIamMember(string name) : base("google_dataproc_metastore_service_iam_member", name)
    {
    }
    ...
    public partial TerraformList<TerraformBlock<GoogleDataprocMetastoreServiceIamMemberConditionBlock>>? Condition { get; set; }
