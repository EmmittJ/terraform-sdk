...
/// Nesting mode: list
/// </summary>
public class GoogleAppEngineApplicationUrlDispatchRulesDispatchRulesBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleAppEngineApplicationUrlDispatchRulesTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleAppEngineApplicationUrlDispatchRules : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleAppEngineApplicationUrlDispatchRulesDispatchRulesBlock>>? DispatchRules { get; set; } = new();
    ...
    public TerraformBlock<GoogleAppEngineApplicationUrlDispatchRulesTimeoutsBlock>? Timeouts { get; set; } = new();
