...
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCertificateTemplateIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePrivatecaCertificateTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePrivatecaCertificateTemplateIamBindingConditionBlock>>? Condition { get; set; } = new();
