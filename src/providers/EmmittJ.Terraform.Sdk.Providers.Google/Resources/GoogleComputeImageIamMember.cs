...
/// Nesting mode: list
/// </summary>
public class GoogleComputeImageIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeImageIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeImageIamMemberConditionBlock>>? Condition { get; set; } = new();
