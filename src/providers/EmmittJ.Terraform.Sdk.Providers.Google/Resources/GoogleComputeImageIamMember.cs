...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeImageIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeImageIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleComputeImageIamMemberConditionBlock> Condition { get; set; } = new();
