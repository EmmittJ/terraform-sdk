...
/// Nesting mode: list
/// </summary>
public partial class GoogleGkeHubMembershipIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleGkeHubMembershipIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleGkeHubMembershipIamBindingConditionBlock> Condition { get; set; } = new();
