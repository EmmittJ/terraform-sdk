...
public class GoogleGkeHubMembershipIamBinding : TerraformResource
{
    public GoogleGkeHubMembershipIamBinding(string name) : base("google_gke_hub_membership_iam_binding", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleGkeHubMembershipIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleGkeHubMembershipIamBindingConditionBlock>>("condition");
