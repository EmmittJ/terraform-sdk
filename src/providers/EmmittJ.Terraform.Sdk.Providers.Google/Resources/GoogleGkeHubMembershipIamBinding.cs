...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubMembershipIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubMembershipIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubMembershipIamBindingConditionBlock>>? Condition { get; set; } = new();
