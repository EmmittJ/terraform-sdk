...
/// <summary>
/// Block type for condition in GoogleGkeHubMembershipIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubMembershipIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gke_hub_membership_iam_binding Terraform resource.
/// Manages a google_gke_hub_membership_iam_binding resource.
/// </summary>
public partial class GoogleGkeHubMembershipIamBinding(string name) : TerraformResource("google_gke_hub_membership_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleGkeHubMembershipIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleGkeHubMembershipIamBindingConditionBlock>>("condition");
