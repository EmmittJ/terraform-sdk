...
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayApplicationIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBeyondcorpSecurityGatewayApplicationIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBeyondcorpSecurityGatewayApplicationIamMemberConditionBlock>>? Condition { get; set; } = new();
