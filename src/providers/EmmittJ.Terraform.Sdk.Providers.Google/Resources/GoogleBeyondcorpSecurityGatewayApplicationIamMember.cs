...
/// Nesting mode: list
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayApplicationIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBeyondcorpSecurityGatewayApplicationIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBeyondcorpSecurityGatewayApplicationIamMemberConditionBlock> Condition { get; set; } = new();
