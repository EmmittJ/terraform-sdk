...
/// Nesting mode: set
/// </summary>
public partial class GoogleProjectIamAuditConfigAuditLogConfigBlock() : TerraformBlock("audit_log_config")
{
    /// <summary>
...
public partial class GoogleProjectIamAuditConfig : TerraformResource
{
    ...
    public required TerraformSet<GoogleProjectIamAuditConfigAuditLogConfigBlock> AuditLogConfig { get; set; } = new();
