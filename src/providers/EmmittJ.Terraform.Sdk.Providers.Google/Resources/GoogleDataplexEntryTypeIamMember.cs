...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexEntryTypeIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexEntryTypeIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexEntryTypeIamMemberConditionBlock> Condition { get; set; } = new();
