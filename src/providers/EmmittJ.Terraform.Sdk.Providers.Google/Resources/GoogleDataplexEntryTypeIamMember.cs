...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryTypeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexEntryTypeIamMember : TerraformResource
{
    public GoogleDataplexEntryTypeIamMember(string name) : base("google_dataplex_entry_type_iam_member", name)
    {
    }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> EntryTypeId { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleDataplexEntryTypeIamMemberConditionBlock>>? Condition { get; set; } = new();
