...
/// <summary>
/// Represents a google_healthcare_dataset_iam_policy Terraform resource.
/// Manages a google_healthcare_dataset_iam_policy resource.
/// </summary>
public partial class GoogleHealthcareDatasetIamPolicy(string name) : TerraformResource("google_healthcare_dataset_iam_policy", name)
{
    /// <summary>
