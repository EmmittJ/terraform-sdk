...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexLakeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexLakeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexLakeIamMemberConditionBlock>>? Condition { get; set; } = new();
