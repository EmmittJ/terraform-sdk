...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexLakeIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexLakeIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexLakeIamMemberConditionBlock> Condition { get; set; } = new();
