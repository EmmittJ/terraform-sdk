...
/// <summary>
/// Block type for condition in GoogleDataplexLakeIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataplex_lake_iam_member Terraform resource.
/// Manages a google_dataplex_lake_iam_member resource.
/// </summary>
public partial class GoogleDataplexLakeIamMember(string name) : TerraformResource("google_dataplex_lake_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataplexLakeIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexLakeIamMemberConditionBlock>>("condition");
