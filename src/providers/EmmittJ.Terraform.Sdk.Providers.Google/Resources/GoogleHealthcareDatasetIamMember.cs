...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareDatasetIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareDatasetIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareDatasetIamMemberConditionBlock> Condition { get; set; } = new();
