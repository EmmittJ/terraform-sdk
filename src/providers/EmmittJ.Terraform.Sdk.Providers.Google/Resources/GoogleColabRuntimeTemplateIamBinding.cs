...
/// Nesting mode: list
/// </summary>
public partial class GoogleColabRuntimeTemplateIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleColabRuntimeTemplateIamBinding : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> RuntimeTemplate { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleColabRuntimeTemplateIamBindingConditionBlock>>? Condition { get; set; }
