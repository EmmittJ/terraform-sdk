...
/// Nesting mode: list
/// </summary>
public partial class GoogleColabRuntimeTemplateIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleColabRuntimeTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleColabRuntimeTemplateIamBindingConditionBlock> Condition { get; set; } = new();
