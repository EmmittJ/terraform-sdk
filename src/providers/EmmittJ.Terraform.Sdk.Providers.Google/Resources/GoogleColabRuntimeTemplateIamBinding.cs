...
/// <summary>
/// Block type for condition in GoogleColabRuntimeTemplateIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleColabRuntimeTemplateIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_colab_runtime_template_iam_binding Terraform resource.
/// Manages a google_colab_runtime_template_iam_binding resource.
/// </summary>
public partial class GoogleColabRuntimeTemplateIamBinding(string name) : TerraformResource("google_colab_runtime_template_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleColabRuntimeTemplateIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleColabRuntimeTemplateIamBindingConditionBlock>>("condition");
