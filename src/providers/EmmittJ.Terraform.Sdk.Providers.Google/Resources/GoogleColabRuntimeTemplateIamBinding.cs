...
/// Nesting mode: list
/// </summary>
public class GoogleColabRuntimeTemplateIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleColabRuntimeTemplateIamBinding : TerraformResource
{
    ...
    [TerraformPropertyName("runtime_template")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> RuntimeTemplate { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleColabRuntimeTemplateIamBindingConditionBlock>>? Condition { get; set; } = new();
