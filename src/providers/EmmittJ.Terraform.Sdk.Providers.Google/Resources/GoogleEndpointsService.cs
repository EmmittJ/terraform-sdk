...
public partial class GoogleEndpointsService : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? GrpcConfig { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? OpenapiConfig { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ProtocOutputBase64 { get; set; }
    ...
    public partial TerraformBlock<GoogleEndpointsServiceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformList<object> Apis { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DnsAddress { get; }
