...
/// Nesting mode: list
/// </summary>
public class GoogleComputeFirewallPolicyRuleMatchBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeFirewallPolicyRuleTargetSecureTagsBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleComputeFirewallPolicyRuleTimeoutsBlock
{
    /// <summary>
...
public class GoogleComputeFirewallPolicyRule : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeFirewallPolicyRuleMatchBlock>>? Match { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeFirewallPolicyRuleTargetSecureTagsBlock>>? TargetSecureTags { get; set; }
    ...
    public TerraformBlock<GoogleComputeFirewallPolicyRuleTimeoutsBlock>? Timeouts { get; set; }
