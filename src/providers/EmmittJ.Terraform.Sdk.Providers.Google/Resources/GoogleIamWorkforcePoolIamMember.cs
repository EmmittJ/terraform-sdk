...
/// Nesting mode: list
/// </summary>
public partial class GoogleIamWorkforcePoolIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIamWorkforcePoolIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIamWorkforcePoolIamMemberConditionBlock> Condition { get; set; } = new();
