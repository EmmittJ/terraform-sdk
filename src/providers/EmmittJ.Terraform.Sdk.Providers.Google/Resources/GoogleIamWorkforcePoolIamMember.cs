...
/// <summary>
/// Block type for condition in GoogleIamWorkforcePoolIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleIamWorkforcePoolIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_iam_workforce_pool_iam_member Terraform resource.
/// Manages a google_iam_workforce_pool_iam_member resource.
/// </summary>
public partial class GoogleIamWorkforcePoolIamMember(string name) : TerraformResource("google_iam_workforce_pool_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleIamWorkforcePoolIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIamWorkforcePoolIamMemberConditionBlock>>("condition");
