...
public partial class GoogleAccessContextManagerGcpUserAccessBindingSessionSettingsBlock() : TerraformBlock("session_settings")
{
    ...
    public partial TerraformValue<string>? MaxInactivity { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SessionLength { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SessionLengthEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SessionReauthMethod { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? UseOidcMaxAge { get; set; }
...
public partial class GoogleAccessContextManagerGcpUserAccessBinding : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? AccessLevels { get; set; }
    ...
    public required partial TerraformValue<string> GroupKey { get; set; }
