...
/// Nesting mode: single
/// </summary>
public class GoogleComputeGlobalNetworkEndpointGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeGlobalNetworkEndpointGroup : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> NetworkEndpointType { get; set; }
    ...
    public TerraformBlock<GoogleComputeGlobalNetworkEndpointGroupTimeoutsBlock>? Timeouts { get; set; } = new();
