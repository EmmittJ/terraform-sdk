...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryAnalyticsHubDataExchangeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryAnalyticsHubDataExchangeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryAnalyticsHubDataExchangeIamBindingConditionBlock>>? Condition { get; set; } = new();
