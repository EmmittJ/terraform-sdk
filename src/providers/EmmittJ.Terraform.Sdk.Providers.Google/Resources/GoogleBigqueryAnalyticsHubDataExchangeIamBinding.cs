...
/// <summary>
/// Block type for condition in GoogleBigqueryAnalyticsHubDataExchangeIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryAnalyticsHubDataExchangeIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_bigquery_analytics_hub_data_exchange_iam_binding Terraform resource.
/// Manages a google_bigquery_analytics_hub_data_exchange_iam_binding resource.
/// </summary>
public partial class GoogleBigqueryAnalyticsHubDataExchangeIamBinding(string name) : TerraformResource("google_bigquery_analytics_hub_data_exchange_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryAnalyticsHubDataExchangeIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryAnalyticsHubDataExchangeIamBindingConditionBlock>>("condition");
