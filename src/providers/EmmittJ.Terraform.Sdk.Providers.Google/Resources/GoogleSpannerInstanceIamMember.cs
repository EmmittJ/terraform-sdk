...
/// Nesting mode: list
/// </summary>
public class GoogleSpannerInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSpannerInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSpannerInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
