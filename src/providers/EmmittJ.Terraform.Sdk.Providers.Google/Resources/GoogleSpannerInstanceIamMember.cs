...
/// Nesting mode: list
/// </summary>
public partial class GoogleSpannerInstanceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSpannerInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSpannerInstanceIamMemberConditionBlock> Condition { get; set; } = new();
