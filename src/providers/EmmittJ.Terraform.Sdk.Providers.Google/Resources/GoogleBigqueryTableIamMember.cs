...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryTableIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryTableIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryTableIamMemberConditionBlock>>? Condition { get; set; } = new();
