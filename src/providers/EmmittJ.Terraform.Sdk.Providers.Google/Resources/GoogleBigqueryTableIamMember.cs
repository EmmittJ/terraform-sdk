...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryTableIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryTableIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryTableIamMemberConditionBlock> Condition { get; set; } = new();
