...
/// Nesting mode: list
/// </summary>
public partial class GoogleCloudfunctionsFunctionIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleCloudfunctionsFunctionIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleCloudfunctionsFunctionIamBindingConditionBlock> Condition { get; set; } = new();
