...
/// <summary>
/// Block type for condition in GoogleCloudfunctionsFunctionIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctionsFunctionIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_cloudfunctions_function_iam_binding Terraform resource.
/// Manages a google_cloudfunctions_function_iam_binding resource.
/// </summary>
public partial class GoogleCloudfunctionsFunctionIamBinding(string name) : TerraformResource("google_cloudfunctions_function_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleCloudfunctionsFunctionIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleCloudfunctionsFunctionIamBindingConditionBlock>>("condition");
