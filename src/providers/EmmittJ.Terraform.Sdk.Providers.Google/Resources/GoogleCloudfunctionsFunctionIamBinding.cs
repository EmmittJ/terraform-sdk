...
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctionsFunctionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudfunctionsFunctionIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudfunctionsFunctionIamBindingConditionBlock>>? Condition { get; set; } = new();
