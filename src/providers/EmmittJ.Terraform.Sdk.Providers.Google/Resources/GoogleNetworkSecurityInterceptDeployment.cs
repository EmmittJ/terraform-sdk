...
/// <summary>
/// Block type for timeouts in GoogleNetworkSecurityInterceptDeployment.
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityInterceptDeploymentTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_network_security_intercept_deployment Terraform resource.
/// Manages a google_network_security_intercept_deployment resource.
/// </summary>
public partial class GoogleNetworkSecurityInterceptDeployment(string name) : TerraformResource("google_network_security_intercept_deployment", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "intercept_deployment_id");
    ...
    {
        get => GetArgument<GoogleNetworkSecurityInterceptDeploymentTimeoutsBlock>("timeouts");
