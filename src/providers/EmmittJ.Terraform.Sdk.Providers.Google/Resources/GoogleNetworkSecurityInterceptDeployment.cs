...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityInterceptDeploymentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityInterceptDeployment : TerraformResource
{
    ...
    [TerraformPropertyName("intercept_deployment_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> InterceptDeploymentId { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityInterceptDeploymentTimeoutsBlock>? Timeouts { get; set; } = new();
