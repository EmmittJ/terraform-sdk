...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapAppEngineServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapAppEngineServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapAppEngineServiceIamBindingConditionBlock> Condition { get; set; } = new();
