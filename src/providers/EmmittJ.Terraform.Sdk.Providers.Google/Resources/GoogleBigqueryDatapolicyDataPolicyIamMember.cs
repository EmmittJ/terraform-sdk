...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatapolicyDataPolicyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatapolicyDataPolicyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatapolicyDataPolicyIamMemberConditionBlock>>? Condition { get; set; } = new();
