...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareDatasetIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareDatasetIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareDatasetIamBindingConditionBlock> Condition { get; set; } = new();
