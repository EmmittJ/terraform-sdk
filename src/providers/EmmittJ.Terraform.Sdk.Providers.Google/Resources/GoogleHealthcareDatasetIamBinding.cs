...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareDatasetIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareDatasetIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareDatasetIamBindingConditionBlock>>? Condition { get; set; } = new();
