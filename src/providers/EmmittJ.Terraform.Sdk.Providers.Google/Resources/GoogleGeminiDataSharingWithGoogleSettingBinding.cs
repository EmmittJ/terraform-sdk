...
/// <summary>
/// Block type for timeouts in GoogleGeminiDataSharingWithGoogleSettingBinding.
/// Nesting mode: single
/// </summary>
public class GoogleGeminiDataSharingWithGoogleSettingBindingTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gemini_data_sharing_with_google_setting_binding Terraform resource.
/// Manages a google_gemini_data_sharing_with_google_setting_binding resource.
/// </summary>
public partial class GoogleGeminiDataSharingWithGoogleSettingBinding(string name) : TerraformResource("google_gemini_data_sharing_with_google_setting_binding", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "data_sharing_with_google_setting_id");
    ...
    /// </summary>
    public GoogleGeminiDataSharingWithGoogleSettingBindingTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleGeminiDataSharingWithGoogleSettingBindingTimeoutsBlock>("timeouts");
