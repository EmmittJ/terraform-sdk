...
/// Nesting mode: list
/// </summary>
public class GoogleSccV2OrganizationSourceIamBindingConditionBlock
{
    /// <summary>
...
public class GoogleSccV2OrganizationSourceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccV2OrganizationSourceIamBindingConditionBlock>>? Condition { get; set; }
