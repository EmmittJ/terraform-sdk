...
public partial class GoogleGeminiCodeToolsSettingEnabledToolBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? AccountConnector { get; set; }
    ...
    public required partial TerraformValue<string> Handle { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Tool { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? UriOverride { get; set; }
