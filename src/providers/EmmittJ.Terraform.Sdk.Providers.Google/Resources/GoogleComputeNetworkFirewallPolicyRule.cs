...
/// Nesting mode: list
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleMatchBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleTargetSecureTagsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeNetworkFirewallPolicyRule : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeNetworkFirewallPolicyRuleMatchBlock>>? Match { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeNetworkFirewallPolicyRuleTargetSecureTagsBlock>>? TargetSecureTags { get; set; } = new();
    ...
    public TerraformBlock<GoogleComputeNetworkFirewallPolicyRuleTimeoutsBlock>? Timeouts { get; set; } = new();
