...
/// <summary>
/// Block type for match in GoogleComputeNetworkFirewallPolicyRule.
/// Nesting mode: list
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleMatchBlock : TerraformBlock
{
    ...
    public required TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlockLayer4ConfigsBlock> Layer4Configs
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlockLayer4ConfigsBlock>>("layer4_configs");
    ...
    /// </summary>
    public TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlockSrcSecureTagsBlock>? SrcSecureTags
    {
        get => GetArgument<TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlockSrcSecureTagsBlock>>("src_secure_tags");
...
/// <summary>
/// Block type for layer4_configs in GoogleComputeNetworkFirewallPolicyRuleMatchBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleMatchBlockLayer4ConfigsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for src_secure_tags in GoogleComputeNetworkFirewallPolicyRuleMatchBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeNetworkFirewallPolicyRuleMatchBlockSrcSecureTagsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for target_secure_tags in GoogleComputeNetworkFirewallPolicyRule.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleComputeNetworkFirewallPolicyRule.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_compute_network_firewall_policy_rule Terraform resource.
/// Manages a google_compute_network_firewall_policy_rule resource.
/// </summary>
public partial class GoogleComputeNetworkFirewallPolicyRule(string name) : TerraformResource("google_compute_network_firewall_policy_rule", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlock> Match
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeNetworkFirewallPolicyRuleMatchBlock>>("match");
    ...
    /// </summary>
    public TerraformList<GoogleComputeNetworkFirewallPolicyRuleTargetSecureTagsBlock>? TargetSecureTags
    {
        get => GetArgument<TerraformList<GoogleComputeNetworkFirewallPolicyRuleTargetSecureTagsBlock>>("target_secure_tags");
    ...
    {
        get => GetArgument<GoogleComputeNetworkFirewallPolicyRuleTimeoutsBlock>("timeouts");
