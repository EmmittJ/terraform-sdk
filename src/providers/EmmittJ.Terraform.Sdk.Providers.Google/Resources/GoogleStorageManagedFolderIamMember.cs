...
public partial class GoogleStorageManagedFolderIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleStorageManagedFolderIamMemberConditionBlock>>? Condition { get; set; }
