...
/// Nesting mode: list
/// </summary>
public class GoogleStorageManagedFolderIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleStorageManagedFolderIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleStorageManagedFolderIamMemberConditionBlock>>? Condition { get; set; } = new();
