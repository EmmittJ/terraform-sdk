...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocClusterIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocClusterIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocClusterIamMemberConditionBlock>>? Condition { get; set; } = new();
