...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocClusterIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataprocClusterIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocClusterIamMemberConditionBlock> Condition { get; set; } = new();
