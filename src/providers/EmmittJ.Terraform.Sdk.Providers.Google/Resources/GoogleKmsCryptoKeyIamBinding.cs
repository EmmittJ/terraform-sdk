...
public partial class GoogleKmsCryptoKeyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleKmsCryptoKeyIamBindingConditionBlock>>? Condition { get; set; }
