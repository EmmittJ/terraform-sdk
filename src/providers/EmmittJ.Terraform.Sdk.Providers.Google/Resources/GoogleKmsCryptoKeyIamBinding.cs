...
/// Nesting mode: list
/// </summary>
public class GoogleKmsCryptoKeyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleKmsCryptoKeyIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> CryptoKeyId { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleKmsCryptoKeyIamBindingConditionBlock>>? Condition { get; set; } = new();
