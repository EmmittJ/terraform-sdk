...
/// Nesting mode: list
/// </summary>
public partial class GoogleBillingAccountIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBillingAccountIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBillingAccountIamMemberConditionBlock> Condition { get; set; } = new();
