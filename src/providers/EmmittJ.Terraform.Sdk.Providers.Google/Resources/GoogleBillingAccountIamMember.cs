...
/// Nesting mode: list
/// </summary>
public class GoogleBillingAccountIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBillingAccountIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBillingAccountIamMemberConditionBlock>>? Condition { get; set; } = new();
