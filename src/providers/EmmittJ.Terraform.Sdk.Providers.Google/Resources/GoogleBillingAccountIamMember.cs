...
/// <summary>
/// Block type for condition in GoogleBillingAccountIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleBillingAccountIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_billing_account_iam_member Terraform resource.
/// Manages a google_billing_account_iam_member resource.
/// </summary>
public partial class GoogleBillingAccountIamMember(string name) : TerraformResource("google_billing_account_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBillingAccountIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBillingAccountIamMemberConditionBlock>>("condition");
