...
/// <summary>
/// Block type for condition in GoogleBigqueryDatapolicyv2DataPolicyIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_bigquery_datapolicyv2_data_policy_iam_member Terraform resource.
/// Manages a google_bigquery_datapolicyv2_data_policy_iam_member resource.
/// </summary>
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamMember(string name) : TerraformResource("google_bigquery_datapolicyv2_data_policy_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock>>("condition");
