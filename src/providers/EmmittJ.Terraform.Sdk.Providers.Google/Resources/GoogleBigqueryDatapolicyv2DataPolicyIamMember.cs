...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatapolicyv2DataPolicyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock>>? Condition { get; set; } = new();
