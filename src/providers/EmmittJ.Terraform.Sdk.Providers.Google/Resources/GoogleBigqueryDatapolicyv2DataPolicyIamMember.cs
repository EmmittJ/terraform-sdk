...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryDatapolicyv2DataPolicyIamMemberConditionBlock> Condition { get; set; } = new();
