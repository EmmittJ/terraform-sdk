...
/// Nesting mode: list
/// </summary>
public class GoogleVertexAiFeaturestoreEntitytypeMonitoringConfigBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class GoogleVertexAiFeaturestoreEntitytypeTimeoutsBlock
{
    /// <summary>
...
public class GoogleVertexAiFeaturestoreEntitytype : TerraformResource
{
    ...
    public required TerraformValue<string> Featurestore { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleVertexAiFeaturestoreEntitytypeMonitoringConfigBlock>>? MonitoringConfig { get; set; }
    ...
    public TerraformBlock<GoogleVertexAiFeaturestoreEntitytypeTimeoutsBlock>? Timeouts { get; set; }
