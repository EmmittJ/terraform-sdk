...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryConnectionIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryConnectionIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryConnectionIamBindingConditionBlock> Condition { get; set; } = new();
