...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryConnectionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryConnectionIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryConnectionIamBindingConditionBlock>>? Condition { get; set; } = new();
