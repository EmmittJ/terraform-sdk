...
/// Nesting mode: single
/// </summary>
public class GoogleVmwareengineExternalAddressTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleVmwareengineExternalAddress : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> InternalIp { get; set; }
    ...
    public TerraformBlock<GoogleVmwareengineExternalAddressTimeoutsBlock>? Timeouts { get; set; } = new();
