...
/// Nesting mode: list
/// </summary>
public class GoogleCloudbuildv2ConnectionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudbuildv2ConnectionIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudbuildv2ConnectionIamBindingConditionBlock>>? Condition { get; set; } = new();
