...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkSecurityMirroringDeploymentGroupTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleNetworkSecurityMirroringDeploymentGroup : TerraformResource
{
    ...
    [TerraformProperty("mirroring_deployment_group_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> MirroringDeploymentGroupId { get; set; }
    ...
    public partial TerraformBlock<GoogleNetworkSecurityMirroringDeploymentGroupTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformList<object> ConnectedEndpointGroups { get; }
