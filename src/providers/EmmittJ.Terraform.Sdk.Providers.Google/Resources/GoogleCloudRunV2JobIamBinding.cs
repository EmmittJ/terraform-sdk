...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2JobIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunV2JobIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2JobIamBindingConditionBlock>>? Condition { get; set; } = new();
