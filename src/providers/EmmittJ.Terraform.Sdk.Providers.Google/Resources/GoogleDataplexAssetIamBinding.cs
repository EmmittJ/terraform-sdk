...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexAssetIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexAssetIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexAssetIamBindingConditionBlock>>? Condition { get; set; } = new();
