...
/// <summary>
/// Block type for condition in GoogleDataplexAssetIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataplex_asset_iam_binding Terraform resource.
/// Manages a google_dataplex_asset_iam_binding resource.
/// </summary>
public partial class GoogleDataplexAssetIamBinding(string name) : TerraformResource("google_dataplex_asset_iam_binding", name)
{
    /// <summary>
    /// The asset attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataplexAssetIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexAssetIamBindingConditionBlock>>("condition");
