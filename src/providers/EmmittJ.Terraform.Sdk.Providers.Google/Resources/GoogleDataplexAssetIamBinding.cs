...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexAssetIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexAssetIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexAssetIamBindingConditionBlock> Condition { get; set; } = new();
