...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployTargetIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployTargetIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployTargetIamBindingConditionBlock>>? Condition { get; set; } = new();
