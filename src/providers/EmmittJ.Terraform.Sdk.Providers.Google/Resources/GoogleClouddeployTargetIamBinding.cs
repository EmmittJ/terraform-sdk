...
/// Nesting mode: list
/// </summary>
public partial class GoogleClouddeployTargetIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleClouddeployTargetIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleClouddeployTargetIamBindingConditionBlock> Condition { get; set; } = new();
