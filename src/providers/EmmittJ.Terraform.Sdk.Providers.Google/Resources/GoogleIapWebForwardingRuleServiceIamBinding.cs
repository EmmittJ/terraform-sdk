...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebForwardingRuleServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebForwardingRuleServiceIamBinding : TerraformResource
{
    public GoogleIapWebForwardingRuleServiceIamBinding(string name) : base("google_iap_web_forwarding_rule_service_iam_binding", name)
    {
    }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ForwardingRuleServiceName { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIapWebForwardingRuleServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
