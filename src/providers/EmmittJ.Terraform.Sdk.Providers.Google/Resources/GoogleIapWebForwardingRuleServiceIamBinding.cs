...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebForwardingRuleServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebForwardingRuleServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebForwardingRuleServiceIamBindingConditionBlock> Condition { get; set; } = new();
