...
/// Nesting mode: single
/// </summary>
public class GoogleComputeTargetTcpProxyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeTargetTcpProxy : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeTargetTcpProxyTimeoutsBlock>? Timeouts { get; set; } = new();
