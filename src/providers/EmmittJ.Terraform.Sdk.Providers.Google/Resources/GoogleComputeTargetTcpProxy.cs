...
/// <summary>
/// Block type for timeouts in GoogleComputeTargetTcpProxy.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_compute_target_tcp_proxy Terraform resource.
/// Manages a google_compute_target_tcp_proxy resource.
/// </summary>
public partial class GoogleComputeTargetTcpProxy(string name) : TerraformResource("google_compute_target_tcp_proxy", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleComputeTargetTcpProxyTimeoutsBlock>("timeouts");
