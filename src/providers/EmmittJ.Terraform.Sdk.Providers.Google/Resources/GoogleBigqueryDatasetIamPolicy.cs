...
/// <summary>
/// Represents a google_bigquery_dataset_iam_policy Terraform resource.
/// Manages a google_bigquery_dataset_iam_policy resource.
/// </summary>
public partial class GoogleBigqueryDatasetIamPolicy(string name) : TerraformResource("google_bigquery_dataset_iam_policy", name)
{
    /// <summary>
