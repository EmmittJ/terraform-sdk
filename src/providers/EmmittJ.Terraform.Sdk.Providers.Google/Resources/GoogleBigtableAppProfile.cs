...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableAppProfileDataBoostIsolationReadOnlyBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableAppProfileSingleClusterRoutingBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableAppProfileStandardIsolationBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleBigtableAppProfileTimeoutsBlock
{
    /// <summary>
