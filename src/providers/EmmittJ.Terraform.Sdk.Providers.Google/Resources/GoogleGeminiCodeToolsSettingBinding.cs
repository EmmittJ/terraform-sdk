...
/// Nesting mode: single
/// </summary>
public class GoogleGeminiCodeToolsSettingBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiCodeToolsSettingBinding : TerraformResource
{
    ...
    public TerraformBlock<GoogleGeminiCodeToolsSettingBindingTimeoutsBlock>? Timeouts { get; set; } = new();
