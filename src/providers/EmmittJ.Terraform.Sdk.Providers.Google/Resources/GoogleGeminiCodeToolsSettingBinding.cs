...
/// <summary>
/// Block type for timeouts in GoogleGeminiCodeToolsSettingBinding.
/// Nesting mode: single
/// </summary>
public class GoogleGeminiCodeToolsSettingBindingTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gemini_code_tools_setting_binding Terraform resource.
/// Manages a google_gemini_code_tools_setting_binding resource.
/// </summary>
public partial class GoogleGeminiCodeToolsSettingBinding(string name) : TerraformResource("google_gemini_code_tools_setting_binding", name)
{
    /// <summary>
    ...
    /// </summary>
    public GoogleGeminiCodeToolsSettingBindingTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleGeminiCodeToolsSettingBindingTimeoutsBlock>("timeouts");
