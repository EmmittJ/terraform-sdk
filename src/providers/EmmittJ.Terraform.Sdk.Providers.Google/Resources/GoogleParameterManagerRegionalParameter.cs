...
/// <summary>
/// Block type for timeouts in GoogleParameterManagerRegionalParameter.
/// Nesting mode: single
/// </summary>
public class GoogleParameterManagerRegionalParameterTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_parameter_manager_regional_parameter Terraform resource.
/// Manages a google_parameter_manager_regional_parameter resource.
/// </summary>
public partial class GoogleParameterManagerRegionalParameter(string name) : TerraformResource("google_parameter_manager_regional_parameter", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleParameterManagerRegionalParameterTimeoutsBlock>("timeouts");
