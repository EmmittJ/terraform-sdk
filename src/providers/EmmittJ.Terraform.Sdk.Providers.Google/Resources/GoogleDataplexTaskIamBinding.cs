...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexTaskIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexTaskIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexTaskIamBindingConditionBlock>>? Condition { get; set; } = new();
