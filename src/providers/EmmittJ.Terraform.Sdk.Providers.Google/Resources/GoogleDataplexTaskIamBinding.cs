...
/// <summary>
/// Block type for condition in GoogleDataplexTaskIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataplex_task_iam_binding Terraform resource.
/// Manages a google_dataplex_task_iam_binding resource.
/// </summary>
public partial class GoogleDataplexTaskIamBinding(string name) : TerraformResource("google_dataplex_task_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataplexTaskIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexTaskIamBindingConditionBlock>>("condition");
