...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexTaskIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexTaskIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexTaskIamBindingConditionBlock> Condition { get; set; } = new();
