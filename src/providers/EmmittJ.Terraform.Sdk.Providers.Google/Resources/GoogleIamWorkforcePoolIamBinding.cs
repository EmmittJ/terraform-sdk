...
/// Nesting mode: list
/// </summary>
public partial class GoogleIamWorkforcePoolIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIamWorkforcePoolIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIamWorkforcePoolIamBindingConditionBlock> Condition { get; set; } = new();
