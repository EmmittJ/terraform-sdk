...
/// Nesting mode: list
/// </summary>
public partial class GoogleLoggingLogViewIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleLoggingLogViewIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleLoggingLogViewIamMemberConditionBlock> Condition { get; set; } = new();
