...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingLogViewIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingLogViewIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingLogViewIamMemberConditionBlock>>? Condition { get; set; } = new();
