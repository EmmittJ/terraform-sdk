...
/// Nesting mode: single
/// </summary>
public partial class GoogleComputeTargetPoolTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleComputeTargetPool : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? BackupPool { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? HealthChecks { get; set; }
    ...
    public GoogleComputeTargetPoolTimeoutsBlock Timeouts { get; set; } = new();
