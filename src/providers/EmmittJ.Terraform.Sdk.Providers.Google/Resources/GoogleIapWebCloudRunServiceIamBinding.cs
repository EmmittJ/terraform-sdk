...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebCloudRunServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebCloudRunServiceIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> CloudRunServiceName { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIapWebCloudRunServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
