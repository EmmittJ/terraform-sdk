...
/// <summary>
/// Block type for condition in GoogleIapWebCloudRunServiceIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_iap_web_cloud_run_service_iam_binding Terraform resource.
/// Manages a google_iap_web_cloud_run_service_iam_binding resource.
/// </summary>
public partial class GoogleIapWebCloudRunServiceIamBinding(string name) : TerraformResource("google_iap_web_cloud_run_service_iam_binding", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "cloud_run_service_name");
    ...
    public TerraformList<GoogleIapWebCloudRunServiceIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapWebCloudRunServiceIamBindingConditionBlock>>("condition");
