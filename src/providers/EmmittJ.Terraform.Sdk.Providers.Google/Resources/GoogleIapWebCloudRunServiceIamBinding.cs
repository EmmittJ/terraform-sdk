...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebCloudRunServiceIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleIapWebCloudRunServiceIamBinding : TerraformResource
{
    public GoogleIapWebCloudRunServiceIamBinding(string name) : base("google_iap_web_cloud_run_service_iam_binding", name)
    {
    }
    ...
    public partial TerraformList<TerraformBlock<GoogleIapWebCloudRunServiceIamBindingConditionBlock>>? Condition { get; set; }
