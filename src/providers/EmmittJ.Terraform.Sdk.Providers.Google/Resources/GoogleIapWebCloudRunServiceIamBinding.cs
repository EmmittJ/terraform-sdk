...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebCloudRunServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebCloudRunServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebCloudRunServiceIamBindingConditionBlock> Condition { get; set; } = new();
