...
/// Nesting mode: list
/// </summary>
public class GoogleNotebooksRuntimeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNotebooksRuntimeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNotebooksRuntimeIamBindingConditionBlock>>? Condition { get; set; } = new();
