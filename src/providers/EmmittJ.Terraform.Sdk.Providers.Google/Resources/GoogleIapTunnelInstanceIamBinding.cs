...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapTunnelInstanceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapTunnelInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapTunnelInstanceIamBindingConditionBlock> Condition { get; set; } = new();
