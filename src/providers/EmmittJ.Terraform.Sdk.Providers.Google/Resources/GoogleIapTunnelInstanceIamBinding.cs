...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
