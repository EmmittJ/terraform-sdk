...
/// Nesting mode: list
/// </summary>
public class GoogleComputeDiskIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeDiskIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeDiskIamMemberConditionBlock>>? Condition { get; set; } = new();
