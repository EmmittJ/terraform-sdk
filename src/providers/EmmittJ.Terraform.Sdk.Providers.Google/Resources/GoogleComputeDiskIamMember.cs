...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeDiskIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeDiskIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleComputeDiskIamMemberConditionBlock> Condition { get; set; } = new();
