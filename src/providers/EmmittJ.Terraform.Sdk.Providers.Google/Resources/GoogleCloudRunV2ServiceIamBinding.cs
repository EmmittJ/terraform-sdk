...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2ServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunV2ServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2ServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
