...
/// Nesting mode: single
/// </summary>
public class GoogleSccV2OrganizationSccBigQueryExportsTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccV2OrganizationSccBigQueryExports : TerraformResource
{
    ...
    public TerraformBlock<GoogleSccV2OrganizationSccBigQueryExportsTimeoutsBlock>? Timeouts { get; set; } = new();
