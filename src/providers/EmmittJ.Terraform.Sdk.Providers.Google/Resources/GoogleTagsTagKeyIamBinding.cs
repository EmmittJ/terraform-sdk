...
/// <summary>
/// Block type for condition in GoogleTagsTagKeyIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagKeyIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_tags_tag_key_iam_binding Terraform resource.
/// Manages a google_tags_tag_key_iam_binding resource.
/// </summary>
public partial class GoogleTagsTagKeyIamBinding(string name) : TerraformResource("google_tags_tag_key_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleTagsTagKeyIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleTagsTagKeyIamBindingConditionBlock>>("condition");
