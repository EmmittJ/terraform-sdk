...
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagKeyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleTagsTagKeyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleTagsTagKeyIamBindingConditionBlock>>? Condition { get; set; } = new();
