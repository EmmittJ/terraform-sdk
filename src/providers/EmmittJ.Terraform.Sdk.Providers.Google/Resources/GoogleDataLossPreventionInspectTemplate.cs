...
public partial class GoogleDataLossPreventionInspectTemplateInspectConfigBlock : TerraformBlockBase
{
    ...
    public partial TerraformList<string>? ContentOptions { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ExcludeInfoTypes { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? IncludeQuote { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MinLikelihood { get; set; }
