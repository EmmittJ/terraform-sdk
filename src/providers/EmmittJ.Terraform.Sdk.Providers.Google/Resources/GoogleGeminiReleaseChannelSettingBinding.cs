...
public partial class GoogleGeminiReleaseChannelSettingBinding : TerraformResource
{
    ...
    public required TerraformValue<string> ReleaseChannelSettingId { get; set; }
    ...
    public TerraformBlock<GoogleGeminiReleaseChannelSettingBindingTimeoutsBlock>? Timeouts { get; set; }
