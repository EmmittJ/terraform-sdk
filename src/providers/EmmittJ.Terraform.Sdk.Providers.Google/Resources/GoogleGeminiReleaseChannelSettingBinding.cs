...
/// Nesting mode: single
/// </summary>
public class GoogleGeminiReleaseChannelSettingBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiReleaseChannelSettingBinding : TerraformResource
{
    ...
    [TerraformPropertyName("release_channel_setting_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ReleaseChannelSettingId { get; set; }
    ...
    public TerraformBlock<GoogleGeminiReleaseChannelSettingBindingTimeoutsBlock>? Timeouts { get; set; } = new();
