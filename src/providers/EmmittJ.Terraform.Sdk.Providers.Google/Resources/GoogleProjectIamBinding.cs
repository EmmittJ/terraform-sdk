...
/// Nesting mode: list
/// </summary>
public class GoogleProjectIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleProjectIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleProjectIamBindingConditionBlock>>? Condition { get; set; } = new();
