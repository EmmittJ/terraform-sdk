...
/// Nesting mode: list
/// </summary>
public partial class GoogleProjectIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleProjectIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleProjectIamBindingConditionBlock> Condition { get; set; } = new();
