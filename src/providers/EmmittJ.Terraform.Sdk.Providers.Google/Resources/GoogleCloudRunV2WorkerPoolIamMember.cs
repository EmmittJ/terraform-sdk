...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2WorkerPoolIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunV2WorkerPoolIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2WorkerPoolIamMemberConditionBlock>>? Condition { get; set; } = new();
