...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexDatascanIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexDatascanIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexDatascanIamMemberConditionBlock> Condition { get; set; } = new();
