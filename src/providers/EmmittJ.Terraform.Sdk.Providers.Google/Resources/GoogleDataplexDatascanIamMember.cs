...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexDatascanIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexDatascanIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexDatascanIamMemberConditionBlock>>? Condition { get; set; } = new();
