...
/// <summary>
/// Block type for condition in GoogleDataplexDatascanIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexDatascanIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_datascan_iam_member Terraform resource.
/// Manages a google_dataplex_datascan_iam_member resource.
/// </summary>
public partial class GoogleDataplexDatascanIamMember(string name) : TerraformResource("google_dataplex_datascan_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexDatascanIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexDatascanIamMemberConditionBlock>>("condition");
