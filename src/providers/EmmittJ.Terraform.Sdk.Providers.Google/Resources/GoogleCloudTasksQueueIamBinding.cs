...
/// Nesting mode: list
/// </summary>
public partial class GoogleCloudTasksQueueIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleCloudTasksQueueIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleCloudTasksQueueIamBindingConditionBlock> Condition { get; set; } = new();
