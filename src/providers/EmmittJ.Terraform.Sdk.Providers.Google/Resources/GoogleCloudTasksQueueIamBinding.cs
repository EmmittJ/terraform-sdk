...
/// Nesting mode: list
/// </summary>
public class GoogleCloudTasksQueueIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudTasksQueueIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudTasksQueueIamBindingConditionBlock>>? Condition { get; set; } = new();
