...
/// Nesting mode: list
/// </summary>
public partial class GoogleKmsEkmConnectionIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleKmsEkmConnectionIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleKmsEkmConnectionIamMemberConditionBlock> Condition { get; set; } = new();
