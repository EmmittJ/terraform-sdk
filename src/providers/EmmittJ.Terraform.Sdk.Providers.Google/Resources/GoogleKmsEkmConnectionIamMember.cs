...
/// Nesting mode: list
/// </summary>
public class GoogleKmsEkmConnectionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleKmsEkmConnectionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleKmsEkmConnectionIamMemberConditionBlock>>? Condition { get; set; } = new();
