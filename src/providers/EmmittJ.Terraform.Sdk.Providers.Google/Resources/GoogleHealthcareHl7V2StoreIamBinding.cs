...
public class GoogleHealthcareHl7V2StoreIamBinding : TerraformResource
{
    ...
    public List<GoogleHealthcareHl7V2StoreIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleHealthcareHl7V2StoreIamBindingConditionBlock>>("condition");
