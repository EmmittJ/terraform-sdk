...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareHl7V2StoreIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareHl7V2StoreIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareHl7V2StoreIamBindingConditionBlock> Condition { get; set; } = new();
