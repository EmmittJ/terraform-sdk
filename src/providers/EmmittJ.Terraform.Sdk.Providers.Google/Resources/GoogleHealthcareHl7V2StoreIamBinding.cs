...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareHl7V2StoreIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareHl7V2StoreIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareHl7V2StoreIamBindingConditionBlock>>? Condition { get; set; } = new();
