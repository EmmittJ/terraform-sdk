...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareDicomStoreIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareDicomStoreIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareDicomStoreIamMemberConditionBlock>>? Condition { get; set; } = new();
