...
/// <summary>
/// Block type for condition in GoogleHealthcareDicomStoreIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareDicomStoreIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_healthcare_dicom_store_iam_member Terraform resource.
/// Manages a google_healthcare_dicom_store_iam_member resource.
/// </summary>
public partial class GoogleHealthcareDicomStoreIamMember(string name) : TerraformResource("google_healthcare_dicom_store_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleHealthcareDicomStoreIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleHealthcareDicomStoreIamMemberConditionBlock>>("condition");
