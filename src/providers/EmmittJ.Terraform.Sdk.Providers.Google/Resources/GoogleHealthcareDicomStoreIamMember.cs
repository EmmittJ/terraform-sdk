...
public partial class GoogleHealthcareDicomStoreIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareDicomStoreIamMemberConditionBlock>>? Condition { get; set; }
