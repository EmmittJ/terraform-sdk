...
/// Nesting mode: list
/// </summary>
public partial class GoogleClouddeployTargetIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleClouddeployTargetIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleClouddeployTargetIamMemberConditionBlock> Condition { get; set; } = new();
