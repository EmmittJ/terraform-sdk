...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployTargetIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployTargetIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployTargetIamMemberConditionBlock>>? Condition { get; set; } = new();
