...
public partial class GoogleEventarcChannel : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? ThirdPartyProvider { get; set; }
    ...
    public TerraformBlock<GoogleEventarcChannelTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> ActivationToken { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> PubsubTopic { get; }
