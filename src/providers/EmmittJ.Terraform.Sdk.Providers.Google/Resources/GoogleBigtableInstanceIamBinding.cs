...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigtableInstanceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigtableInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigtableInstanceIamBindingConditionBlock> Condition { get; set; } = new();
