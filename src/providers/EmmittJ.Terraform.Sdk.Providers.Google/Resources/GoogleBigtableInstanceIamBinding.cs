...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigtableInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigtableInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
