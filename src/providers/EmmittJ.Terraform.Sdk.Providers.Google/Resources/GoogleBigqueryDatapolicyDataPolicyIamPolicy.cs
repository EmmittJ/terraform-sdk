...
/// <summary>
/// Represents a google_bigquery_datapolicy_data_policy_iam_policy Terraform resource.
/// Manages a google_bigquery_datapolicy_data_policy_iam_policy resource.
/// </summary>
public partial class GoogleBigqueryDatapolicyDataPolicyIamPolicy(string name) : TerraformResource("google_bigquery_datapolicy_data_policy_iam_policy", name)
{
    /// <summary>
