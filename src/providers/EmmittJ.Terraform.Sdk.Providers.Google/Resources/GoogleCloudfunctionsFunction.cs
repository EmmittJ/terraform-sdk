...
public partial class GoogleCloudfunctionsFunction : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> BuildServiceAccount { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> DockerRegistry { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> HttpsTriggerSecurityLevel { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> HttpsTriggerUrl { get; set; }
