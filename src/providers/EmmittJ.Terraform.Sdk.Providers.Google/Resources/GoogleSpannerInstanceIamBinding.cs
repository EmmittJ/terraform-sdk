...
/// Nesting mode: list
/// </summary>
public partial class GoogleSpannerInstanceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSpannerInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleSpannerInstanceIamBindingConditionBlock> Condition { get; set; } = new();
