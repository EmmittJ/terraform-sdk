...
/// Nesting mode: list
/// </summary>
public class GoogleSpannerInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSpannerInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSpannerInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
