...
/// <summary>
/// Block type for idp_config in GoogleIdentityPlatformInboundSamlConfig.
/// Nesting mode: list
/// </summary>
public class GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock : TerraformBlock
{
    ...
    public required TerraformList<GoogleIdentityPlatformInboundSamlConfigIdpConfigBlockIdpCertificatesBlock> IdpCertificates
    {
        get => GetRequiredArgument<TerraformList<GoogleIdentityPlatformInboundSamlConfigIdpConfigBlockIdpCertificatesBlock>>("idp_certificates");
...
/// <summary>
/// Block type for idp_certificates in GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock.
/// Nesting mode: list
/// </summary>
public class GoogleIdentityPlatformInboundSamlConfigIdpConfigBlockIdpCertificatesBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for sp_config in GoogleIdentityPlatformInboundSamlConfig.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleIdentityPlatformInboundSamlConfig.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_identity_platform_inbound_saml_config Terraform resource.
/// Manages a google_identity_platform_inbound_saml_config resource.
/// </summary>
public partial class GoogleIdentityPlatformInboundSamlConfig(string name) : TerraformResource("google_identity_platform_inbound_saml_config", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock> IdpConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock>>("idp_config");
    ...
    public required TerraformList<GoogleIdentityPlatformInboundSamlConfigSpConfigBlock> SpConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleIdentityPlatformInboundSamlConfigSpConfigBlock>>("sp_config");
    ...
    {
        get => GetArgument<GoogleIdentityPlatformInboundSamlConfigTimeoutsBlock>("timeouts");
