...
/// Nesting mode: list
/// </summary>
public class GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleIdentityPlatformInboundSamlConfigSpConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? CallbackUri { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? SpEntityId { get; set; }
...
/// Nesting mode: single
/// </summary>
public class GoogleIdentityPlatformInboundSamlConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIdentityPlatformInboundSamlConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIdentityPlatformInboundSamlConfigIdpConfigBlock>>? IdpConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIdentityPlatformInboundSamlConfigSpConfigBlock>>? SpConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleIdentityPlatformInboundSamlConfigTimeoutsBlock>? Timeouts { get; set; } = new();
