...
public class GoogleBinaryAuthorizationPolicyClusterAdmissionRulesBlock : TerraformBlock
{
    ...
    {
        get => new TerraformReference<string>(this, "enforcement_mode");
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "require_attestations_by").ResolveNodes(ctx));
...
public partial class GoogleBinaryAuthorizationPolicy(string name) : TerraformResource("google_binary_authorization_policy", name)
{
    ...
    {
        get => new TerraformReference<string>(this, "global_policy_evaluation_mode");
