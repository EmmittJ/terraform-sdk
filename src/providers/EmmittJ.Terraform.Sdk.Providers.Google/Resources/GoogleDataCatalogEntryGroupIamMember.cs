...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogEntryGroupIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogEntryGroupIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogEntryGroupIamMemberConditionBlock>>? Condition { get; set; } = new();
