...
/// <summary>
/// Block type for condition in GoogleDataCatalogEntryGroupIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogEntryGroupIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_data_catalog_entry_group_iam_member Terraform resource.
/// Manages a google_data_catalog_entry_group_iam_member resource.
/// </summary>
public partial class GoogleDataCatalogEntryGroupIamMember(string name) : TerraformResource("google_data_catalog_entry_group_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataCatalogEntryGroupIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataCatalogEntryGroupIamMemberConditionBlock>>("condition");
