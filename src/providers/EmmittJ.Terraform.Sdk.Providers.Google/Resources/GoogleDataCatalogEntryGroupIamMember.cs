...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogEntryGroupIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogEntryGroupIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogEntryGroupIamMemberConditionBlock> Condition { get; set; } = new();
