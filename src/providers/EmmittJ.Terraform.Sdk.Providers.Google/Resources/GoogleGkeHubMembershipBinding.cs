...
/// <summary>
/// Block type for timeouts in GoogleGkeHubMembershipBinding.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_gke_hub_membership_binding Terraform resource.
/// Manages a google_gke_hub_membership_binding resource.
/// </summary>
public partial class GoogleGkeHubMembershipBinding(string name) : TerraformResource("google_gke_hub_membership_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<GoogleGkeHubMembershipBindingTimeoutsBlock>("timeouts");
