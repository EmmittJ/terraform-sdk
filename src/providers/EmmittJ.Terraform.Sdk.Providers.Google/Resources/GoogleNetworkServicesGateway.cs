...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkServicesGatewayTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleNetworkServicesGateway : TerraformResource
{
    ...
    public partial TerraformList<string> Addresses { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? CertificateUrls { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? DeleteSwgAutogenRouterOnDestroy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EnvoyHeaders { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? GatewaySecurityPolicy { get; set; }
    ...
    public GoogleNetworkServicesGatewayTimeoutsBlock Timeouts { get; set; } = new();
