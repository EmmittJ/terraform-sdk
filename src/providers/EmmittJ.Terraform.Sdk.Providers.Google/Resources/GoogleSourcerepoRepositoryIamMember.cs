...
/// Nesting mode: list
/// </summary>
public partial class GoogleSourcerepoRepositoryIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSourcerepoRepositoryIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSourcerepoRepositoryIamMemberConditionBlock> Condition { get; set; } = new();
