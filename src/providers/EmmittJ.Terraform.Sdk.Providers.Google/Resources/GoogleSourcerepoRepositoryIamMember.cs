...
/// Nesting mode: list
/// </summary>
public class GoogleSourcerepoRepositoryIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSourcerepoRepositoryIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSourcerepoRepositoryIamMemberConditionBlock>>? Condition { get; set; } = new();
