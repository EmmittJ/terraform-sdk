...
/// Nesting mode: list
/// </summary>
public class GoogleNotebooksInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNotebooksInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNotebooksInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
