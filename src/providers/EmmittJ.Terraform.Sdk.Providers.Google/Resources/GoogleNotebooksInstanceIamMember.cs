...
/// Nesting mode: list
/// </summary>
public partial class GoogleNotebooksInstanceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleNotebooksInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleNotebooksInstanceIamMemberConditionBlock> Condition { get; set; } = new();
