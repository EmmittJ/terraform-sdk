...
/// Nesting mode: list
/// </summary>
public partial class GoogleNotebooksInstanceIamMemberConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleNotebooksInstanceIamMember : TerraformResource
{
    public GoogleNotebooksInstanceIamMember(string name) : base("google_notebooks_instance_iam_member", name)
    {
    }
    ...
    public partial TerraformList<TerraformBlock<GoogleNotebooksInstanceIamMemberConditionBlock>>? Condition { get; set; }
