...
/// Nesting mode: list
/// </summary>
public class GoogleIamProjectsPolicyBindingConditionBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleIamProjectsPolicyBindingTargetBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleIamProjectsPolicyBindingTimeoutsBlock
{
    /// <summary>
...
public class GoogleIamProjectsPolicyBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIamProjectsPolicyBindingConditionBlock>>? Condition { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIamProjectsPolicyBindingTargetBlock>>? Target { get; set; }
    ...
    public TerraformBlock<GoogleIamProjectsPolicyBindingTimeoutsBlock>? Timeouts { get; set; }
