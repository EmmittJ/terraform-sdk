...
/// Nesting mode: list
/// </summary>
public class GoogleIamProjectsPolicyBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleIamProjectsPolicyBindingTargetBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleIamProjectsPolicyBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIamProjectsPolicyBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIamProjectsPolicyBindingConditionBlock>>? Condition { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIamProjectsPolicyBindingTargetBlock>>? Target { get; set; } = new();
    ...
    public TerraformBlock<GoogleIamProjectsPolicyBindingTimeoutsBlock>? Timeouts { get; set; } = new();
