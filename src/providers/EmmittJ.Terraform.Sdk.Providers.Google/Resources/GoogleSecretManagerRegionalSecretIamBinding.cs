...
/// Nesting mode: list
/// </summary>
public class GoogleSecretManagerRegionalSecretIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecretManagerRegionalSecretIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecretManagerRegionalSecretIamBindingConditionBlock>>? Condition { get; set; } = new();
