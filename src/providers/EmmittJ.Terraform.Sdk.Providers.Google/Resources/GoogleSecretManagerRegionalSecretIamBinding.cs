...
/// Nesting mode: list
/// </summary>
public partial class GoogleSecretManagerRegionalSecretIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSecretManagerRegionalSecretIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleSecretManagerRegionalSecretIamBindingConditionBlock> Condition { get; set; } = new();
