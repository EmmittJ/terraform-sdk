...
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBeyondcorpSecurityGatewayIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock>>? Condition { get; set; } = new();
