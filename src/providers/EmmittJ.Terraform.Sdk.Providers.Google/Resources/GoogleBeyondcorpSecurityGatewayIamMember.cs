...
/// Nesting mode: list
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBeyondcorpSecurityGatewayIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock> Condition { get; set; } = new();
