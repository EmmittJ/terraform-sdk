...
/// <summary>
/// Block type for condition in GoogleBeyondcorpSecurityGatewayIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_beyondcorp_security_gateway_iam_member Terraform resource.
/// Manages a google_beyondcorp_security_gateway_iam_member resource.
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayIamMember(string name) : TerraformResource("google_beyondcorp_security_gateway_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBeyondcorpSecurityGatewayIamMemberConditionBlock>>("condition");
