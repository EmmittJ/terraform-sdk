...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareHl7V2StoreIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareHl7V2StoreIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareHl7V2StoreIamMemberConditionBlock>>? Condition { get; set; } = new();
