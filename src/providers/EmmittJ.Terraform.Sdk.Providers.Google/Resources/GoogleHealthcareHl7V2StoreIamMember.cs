...
public class GoogleHealthcareHl7V2StoreIamMember : TerraformResource
{
    ...
    public List<GoogleHealthcareHl7V2StoreIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleHealthcareHl7V2StoreIamMemberConditionBlock>>("condition");
