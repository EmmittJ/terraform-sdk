...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocJobIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocJobIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocJobIamMemberConditionBlock>>? Condition { get; set; } = new();
