...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataprocJobIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocJobIamMemberConditionBlock> Condition { get; set; } = new();
