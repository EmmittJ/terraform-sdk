...
public class GoogleDataprocJobIamMember : TerraformResource
{
    public GoogleDataprocJobIamMember(string name) : base("google_dataproc_job_iam_member", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleDataprocJobIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataprocJobIamMemberConditionBlock>>("condition");
