...
/// Nesting mode: single
/// </summary>
public class GoogleDataplexGlossaryCategoryTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexGlossaryCategory : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("category_id")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? CategoryId { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? GlossaryId { get; set; }
    ...
    public TerraformBlock<GoogleDataplexGlossaryCategoryTimeoutsBlock>? Timeouts { get; set; } = new();
