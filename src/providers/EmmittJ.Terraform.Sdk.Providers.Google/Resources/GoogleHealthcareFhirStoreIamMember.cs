...
/// <summary>
/// Block type for condition in GoogleHealthcareFhirStoreIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareFhirStoreIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_healthcare_fhir_store_iam_member Terraform resource.
/// Manages a google_healthcare_fhir_store_iam_member resource.
/// </summary>
public partial class GoogleHealthcareFhirStoreIamMember(string name) : TerraformResource("google_healthcare_fhir_store_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleHealthcareFhirStoreIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleHealthcareFhirStoreIamMemberConditionBlock>>("condition");
