...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareFhirStoreIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareFhirStoreIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareFhirStoreIamMemberConditionBlock> Condition { get; set; } = new();
