...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareFhirStoreIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareFhirStoreIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareFhirStoreIamMemberConditionBlock>>? Condition { get; set; } = new();
