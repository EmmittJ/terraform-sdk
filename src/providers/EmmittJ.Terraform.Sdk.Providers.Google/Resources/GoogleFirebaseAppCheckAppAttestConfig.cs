...
/// Nesting mode: single
/// </summary>
public class GoogleFirebaseAppCheckAppAttestConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleFirebaseAppCheckAppAttestConfig : TerraformResource
{
    ...
    public TerraformBlock<GoogleFirebaseAppCheckAppAttestConfigTimeoutsBlock>? Timeouts { get; set; } = new();
