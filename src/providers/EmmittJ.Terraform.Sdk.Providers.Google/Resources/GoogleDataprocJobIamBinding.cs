...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocJobIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocJobIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocJobIamBindingConditionBlock>>? Condition { get; set; } = new();
