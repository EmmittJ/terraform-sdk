...
public class GoogleGkeHubMembershipIamMember : TerraformResource
{
    public GoogleGkeHubMembershipIamMember(string name) : base("google_gke_hub_membership_iam_member", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleGkeHubMembershipIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleGkeHubMembershipIamMemberConditionBlock>>("condition");
