...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubMembershipIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubMembershipIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubMembershipIamMemberConditionBlock>>? Condition { get; set; } = new();
