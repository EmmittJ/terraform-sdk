...
/// <summary>
/// Block type for condition in GoogleGkeHubMembershipIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubMembershipIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gke_hub_membership_iam_member Terraform resource.
/// Manages a google_gke_hub_membership_iam_member resource.
/// </summary>
public partial class GoogleGkeHubMembershipIamMember(string name) : TerraformResource("google_gke_hub_membership_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleGkeHubMembershipIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleGkeHubMembershipIamMemberConditionBlock>>("condition");
