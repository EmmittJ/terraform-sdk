...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebTypeAppEngineIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebTypeAppEngineIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebTypeAppEngineIamMemberConditionBlock>>? Condition { get; set; } = new();
