...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebTypeAppEngineIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebTypeAppEngineIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebTypeAppEngineIamMemberConditionBlock> Condition { get; set; } = new();
