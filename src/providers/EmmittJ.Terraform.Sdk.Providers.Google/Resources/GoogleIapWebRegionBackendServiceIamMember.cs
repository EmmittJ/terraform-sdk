...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebRegionBackendServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebRegionBackendServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebRegionBackendServiceIamMemberConditionBlock> Condition { get; set; } = new();
