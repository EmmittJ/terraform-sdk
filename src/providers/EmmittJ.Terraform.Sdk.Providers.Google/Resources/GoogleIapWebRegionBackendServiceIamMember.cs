...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionBackendServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebRegionBackendServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebRegionBackendServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
