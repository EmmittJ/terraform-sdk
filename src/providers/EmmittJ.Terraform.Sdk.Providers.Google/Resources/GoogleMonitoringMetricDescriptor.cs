...
/// <summary>
/// Block type for labels in GoogleMonitoringMetricDescriptor.
/// Nesting mode: set
/// </summary>
...
/// <summary>
/// Block type for metadata in GoogleMonitoringMetricDescriptor.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleMonitoringMetricDescriptor.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_monitoring_metric_descriptor Terraform resource.
/// Manages a google_monitoring_metric_descriptor resource.
/// </summary>
public partial class GoogleMonitoringMetricDescriptor(string name) : TerraformResource("google_monitoring_metric_descriptor", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformSet<GoogleMonitoringMetricDescriptorLabelsBlock>? Labels
    {
        get => GetArgument<TerraformSet<GoogleMonitoringMetricDescriptorLabelsBlock>>("labels");
    ...
    public TerraformList<GoogleMonitoringMetricDescriptorMetadataBlock>? Metadata
    {
        get => GetArgument<TerraformList<GoogleMonitoringMetricDescriptorMetadataBlock>>("metadata");
    ...
    {
        get => GetArgument<GoogleMonitoringMetricDescriptorTimeoutsBlock>("timeouts");
