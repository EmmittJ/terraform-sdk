...
/// Nesting mode: list
/// </summary>
public class GoogleSecretManagerSecretIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecretManagerSecretIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecretManagerSecretIamMemberConditionBlock>>? Condition { get; set; } = new();
