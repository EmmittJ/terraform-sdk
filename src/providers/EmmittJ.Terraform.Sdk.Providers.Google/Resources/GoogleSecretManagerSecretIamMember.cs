...
/// Nesting mode: list
/// </summary>
public partial class GoogleSecretManagerSecretIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSecretManagerSecretIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSecretManagerSecretIamMemberConditionBlock> Condition { get; set; } = new();
