...
/// <summary>
/// Block type for timeouts in GoogleComputeSslCertificate.
/// Nesting mode: single
/// </summary>
public class GoogleComputeSslCertificateTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_compute_ssl_certificate Terraform resource.
/// Manages a google_compute_ssl_certificate resource.
/// </summary>
public partial class GoogleComputeSslCertificate(string name) : TerraformResource("google_compute_ssl_certificate", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleComputeSslCertificateTimeoutsBlock>("timeouts");
