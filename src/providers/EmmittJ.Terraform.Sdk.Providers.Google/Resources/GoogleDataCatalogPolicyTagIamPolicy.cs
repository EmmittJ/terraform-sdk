...
/// <summary>
/// Represents a google_data_catalog_policy_tag_iam_policy Terraform resource.
/// Manages a google_data_catalog_policy_tag_iam_policy resource.
/// </summary>
public partial class GoogleDataCatalogPolicyTagIamPolicy(string name) : TerraformResource("google_data_catalog_policy_tag_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
