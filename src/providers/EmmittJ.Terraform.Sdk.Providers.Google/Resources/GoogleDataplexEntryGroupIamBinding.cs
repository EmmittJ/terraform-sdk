...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexEntryGroupIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexEntryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexEntryGroupIamBindingConditionBlock> Condition { get; set; } = new();
