...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryGroupIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexEntryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexEntryGroupIamBindingConditionBlock>>? Condition { get; set; } = new();
