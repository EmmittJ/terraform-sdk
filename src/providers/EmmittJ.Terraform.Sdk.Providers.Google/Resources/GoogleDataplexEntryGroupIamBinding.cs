...
/// <summary>
/// Block type for condition in GoogleDataplexEntryGroupIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryGroupIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_entry_group_iam_binding Terraform resource.
/// Manages a google_dataplex_entry_group_iam_binding resource.
/// </summary>
public partial class GoogleDataplexEntryGroupIamBinding(string name) : TerraformResource("google_dataplex_entry_group_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexEntryGroupIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexEntryGroupIamBindingConditionBlock>>("condition");
