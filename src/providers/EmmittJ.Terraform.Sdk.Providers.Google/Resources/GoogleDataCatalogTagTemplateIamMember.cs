...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogTagTemplateIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogTagTemplateIamMember : TerraformResource
{
    ...
    [TerraformPropertyName("tag_template")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> TagTemplate { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogTagTemplateIamMemberConditionBlock>>? Condition { get; set; } = new();
