...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogTagTemplateIamMemberConditionBlock
{
    /// <summary>
...
public class GoogleDataCatalogTagTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogTagTemplateIamMemberConditionBlock>>? Condition { get; set; }
