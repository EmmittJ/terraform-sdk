...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogTagTemplateIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogTagTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogTagTemplateIamMemberConditionBlock> Condition { get; set; } = new();
