...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigtableTableIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigtableTableIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigtableTableIamBindingConditionBlock> Condition { get; set; } = new();
