...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableTableIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigtableTableIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigtableTableIamBindingConditionBlock>>? Condition { get; set; } = new();
