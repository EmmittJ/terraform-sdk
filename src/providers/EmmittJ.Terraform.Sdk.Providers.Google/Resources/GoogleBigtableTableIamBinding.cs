...
/// <summary>
/// Block type for condition in GoogleBigtableTableIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleBigtableTableIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_bigtable_table_iam_binding Terraform resource.
/// Manages a google_bigtable_table_iam_binding resource.
/// </summary>
public partial class GoogleBigtableTableIamBinding(string name) : TerraformResource("google_bigtable_table_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleBigtableTableIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigtableTableIamBindingConditionBlock>>("condition");
