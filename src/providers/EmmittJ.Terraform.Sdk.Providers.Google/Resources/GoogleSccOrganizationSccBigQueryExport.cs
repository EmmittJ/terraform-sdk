...
/// Nesting mode: single
/// </summary>
public class GoogleSccOrganizationSccBigQueryExportTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class GoogleSccOrganizationSccBigQueryExport : TerraformResource
{
    ...
    public TerraformBlock<GoogleSccOrganizationSccBigQueryExportTimeoutsBlock>? Timeouts { get; set; } = new();
