...
/// Nesting mode: single
/// </summary>
public partial class GoogleSccOrganizationSccBigQueryExportTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleSccOrganizationSccBigQueryExport : TerraformResource
{
    public GoogleSccOrganizationSccBigQueryExport(string name) : base("google_scc_organization_scc_big_query_export", name)
    {
    }
    ...
    public partial TerraformBlock<GoogleSccOrganizationSccBigQueryExportTimeoutsBlock>? Timeouts { get; set; }
