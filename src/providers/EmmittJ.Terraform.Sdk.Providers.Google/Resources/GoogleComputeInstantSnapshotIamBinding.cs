...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstantSnapshotIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstantSnapshotIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstantSnapshotIamBindingConditionBlock>>? Condition { get; set; } = new();
