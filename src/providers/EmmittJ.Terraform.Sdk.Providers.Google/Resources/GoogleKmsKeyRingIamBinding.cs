...
/// Nesting mode: list
/// </summary>
public class GoogleKmsKeyRingIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleKmsKeyRingIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> KeyRingId { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleKmsKeyRingIamBindingConditionBlock>>? Condition { get; set; } = new();
