...
/// Nesting mode: single
/// </summary>
public class GoogleIntegrationConnectorsEndpointAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIntegrationConnectorsEndpointAttachment : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("endpoint_global_access")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EndpointGlobalAccess { get; set; }
    ...
    public TerraformBlock<GoogleIntegrationConnectorsEndpointAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
