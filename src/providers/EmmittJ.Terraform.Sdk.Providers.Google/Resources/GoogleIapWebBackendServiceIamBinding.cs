...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebBackendServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebBackendServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebBackendServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
