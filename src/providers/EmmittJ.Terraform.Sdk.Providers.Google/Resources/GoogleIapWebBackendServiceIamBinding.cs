...
/// <summary>
/// Block type for condition in GoogleIapWebBackendServiceIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_iap_web_backend_service_iam_binding Terraform resource.
/// Manages a google_iap_web_backend_service_iam_binding resource.
/// </summary>
public partial class GoogleIapWebBackendServiceIamBinding(string name) : TerraformResource("google_iap_web_backend_service_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleIapWebBackendServiceIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapWebBackendServiceIamBindingConditionBlock>>("condition");
