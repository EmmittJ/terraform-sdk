...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexAssetDiscoverySpecBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<List<TerraformProperty<string>>>? ExcludePatterns { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? IncludePatterns { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexAssetResourceSpecBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<string>> ReadAccessMode { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "read_access_mode");
...
/// Nesting mode: single
/// </summary>
public class GoogleDataplexAssetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexAsset : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexAssetDiscoverySpecBlock>>? DiscoverySpec { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleDataplexAssetResourceSpecBlock>>? ResourceSpec { get; set; } = new();
    ...
    public TerraformBlock<GoogleDataplexAssetTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> DiscoveryStatus => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "discovery_status");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> SecurityStatus => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "security_status");
