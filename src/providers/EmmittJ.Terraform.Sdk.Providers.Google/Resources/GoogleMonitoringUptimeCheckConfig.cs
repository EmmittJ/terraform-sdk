...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigContentMatchersBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigHttpCheckBlock
{
    /// <summary>
    ...
    public TerraformMap<string> Headers { get; set; } = default!;
...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigMonitoredResourceBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigResourceGroupBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigSyntheticMonitorBlock
{
}
...
/// Nesting mode: list
/// </summary>
public class GoogleMonitoringUptimeCheckConfigTcpCheckBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleMonitoringUptimeCheckConfigTimeoutsBlock
{
    /// <summary>
...
public class GoogleMonitoringUptimeCheckConfig : TerraformResource
{
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> CheckerType { get; set; } = default!;
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> UptimeCheckId => new TerraformReference(this, "uptime_check_id");
