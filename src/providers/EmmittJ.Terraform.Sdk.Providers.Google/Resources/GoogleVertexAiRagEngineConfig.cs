...
/// Nesting mode: list
/// </summary>
public partial class GoogleVertexAiRagEngineConfigRagManagedDbConfigBlock() : TerraformBlock("rag_managed_db_config")
{
}
...
/// Nesting mode: single
/// </summary>
public partial class GoogleVertexAiRagEngineConfigTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleVertexAiRagEngineConfig : TerraformResource
{
    ...
    public required TerraformList<GoogleVertexAiRagEngineConfigRagManagedDbConfigBlock> RagManagedDbConfig { get; set; } = new();
    ...
    public GoogleVertexAiRagEngineConfigTimeoutsBlock Timeouts { get; set; } = new();
