...
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagValueIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleTagsTagValueIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleTagsTagValueIamBindingConditionBlock>>? Condition { get; set; } = new();
