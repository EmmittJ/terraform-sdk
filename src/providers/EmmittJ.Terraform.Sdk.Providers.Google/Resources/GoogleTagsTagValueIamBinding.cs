...
/// Nesting mode: list
/// </summary>
public partial class GoogleTagsTagValueIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleTagsTagValueIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleTagsTagValueIamBindingConditionBlock> Condition { get; set; } = new();
