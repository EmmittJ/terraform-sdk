...
/// <summary>
/// Block type for condition in GoogleTagsTagValueIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagValueIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_tags_tag_value_iam_binding Terraform resource.
/// Manages a google_tags_tag_value_iam_binding resource.
/// </summary>
public partial class GoogleTagsTagValueIamBinding(string name) : TerraformResource("google_tags_tag_value_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleTagsTagValueIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleTagsTagValueIamBindingConditionBlock>>("condition");
