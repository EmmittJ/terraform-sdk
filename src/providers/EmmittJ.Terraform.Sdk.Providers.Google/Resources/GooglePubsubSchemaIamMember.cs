...
/// Nesting mode: list
/// </summary>
public partial class GooglePubsubSchemaIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePubsubSchemaIamMember : TerraformResource
{
    ...
    public TerraformList<GooglePubsubSchemaIamMemberConditionBlock> Condition { get; set; } = new();
