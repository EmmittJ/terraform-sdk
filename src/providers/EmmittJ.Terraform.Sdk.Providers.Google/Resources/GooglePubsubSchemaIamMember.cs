...
/// Nesting mode: list
/// </summary>
public class GooglePubsubSchemaIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubSchemaIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePubsubSchemaIamMemberConditionBlock>>? Condition { get; set; } = new();
