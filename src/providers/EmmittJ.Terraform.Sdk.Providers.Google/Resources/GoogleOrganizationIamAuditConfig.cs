...
/// Nesting mode: set
/// </summary>
public class GoogleOrganizationIamAuditConfigAuditLogConfigBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleOrganizationIamAuditConfig : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<GoogleOrganizationIamAuditConfigAuditLogConfigBlock>>? AuditLogConfig { get; set; } = new();
