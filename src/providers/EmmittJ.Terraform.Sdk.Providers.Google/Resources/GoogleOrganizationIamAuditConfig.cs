...
public partial class GoogleOrganizationIamAuditConfig : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<GoogleOrganizationIamAuditConfigAuditLogConfigBlock>>? AuditLogConfig { get; set; }
