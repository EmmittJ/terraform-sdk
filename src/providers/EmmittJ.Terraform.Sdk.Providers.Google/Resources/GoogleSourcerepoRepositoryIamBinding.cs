...
/// Nesting mode: list
/// </summary>
public class GoogleSourcerepoRepositoryIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSourcerepoRepositoryIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSourcerepoRepositoryIamBindingConditionBlock>>? Condition { get; set; } = new();
