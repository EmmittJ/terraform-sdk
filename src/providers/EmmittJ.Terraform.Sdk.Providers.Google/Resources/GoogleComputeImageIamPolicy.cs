...
/// <summary>
/// Represents a google_compute_image_iam_policy Terraform resource.
/// Manages a google_compute_image_iam_policy resource.
/// </summary>
public partial class GoogleComputeImageIamPolicy(string name) : TerraformResource("google_compute_image_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
