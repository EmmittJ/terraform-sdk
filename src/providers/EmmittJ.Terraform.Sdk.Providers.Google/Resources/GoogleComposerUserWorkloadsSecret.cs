...
/// Nesting mode: single
/// </summary>
public class GoogleComposerUserWorkloadsSecretTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComposerUserWorkloadsSecret : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>>? Data { get; set; }
    ...
    public TerraformBlock<GoogleComposerUserWorkloadsSecretTimeoutsBlock>? Timeouts { get; set; } = new();
