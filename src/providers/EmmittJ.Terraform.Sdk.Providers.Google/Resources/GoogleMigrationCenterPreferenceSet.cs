...
public partial class GoogleMigrationCenterPreferenceSetVirtualMachinePreferencesBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CommitmentPlan { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SizingOptimizationStrategy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TargetProduct { get; set; }
...
public partial class GoogleMigrationCenterPreferenceSet : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PreferenceSetId { get; set; }
