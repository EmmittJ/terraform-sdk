...
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctions2FunctionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudfunctions2FunctionIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudfunctions2FunctionIamBindingConditionBlock>>? Condition { get; set; } = new();
