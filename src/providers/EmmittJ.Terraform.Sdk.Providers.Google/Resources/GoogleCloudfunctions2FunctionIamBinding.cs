...
public class GoogleCloudfunctions2FunctionIamBinding : TerraformResource
{
    ...
    public List<GoogleCloudfunctions2FunctionIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleCloudfunctions2FunctionIamBindingConditionBlock>>("condition");
