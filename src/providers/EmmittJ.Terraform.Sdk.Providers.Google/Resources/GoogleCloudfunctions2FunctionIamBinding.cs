...
/// Nesting mode: list
/// </summary>
public partial class GoogleCloudfunctions2FunctionIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleCloudfunctions2FunctionIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleCloudfunctions2FunctionIamBindingConditionBlock> Condition { get; set; } = new();
