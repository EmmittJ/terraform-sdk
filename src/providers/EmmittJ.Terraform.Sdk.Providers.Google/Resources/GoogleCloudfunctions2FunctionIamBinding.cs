...
/// <summary>
/// Block type for condition in GoogleCloudfunctions2FunctionIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctions2FunctionIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_cloudfunctions2_function_iam_binding Terraform resource.
/// Manages a google_cloudfunctions2_function_iam_binding resource.
/// </summary>
public partial class GoogleCloudfunctions2FunctionIamBinding(string name) : TerraformResource("google_cloudfunctions2_function_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleCloudfunctions2FunctionIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleCloudfunctions2FunctionIamBindingConditionBlock>>("condition");
