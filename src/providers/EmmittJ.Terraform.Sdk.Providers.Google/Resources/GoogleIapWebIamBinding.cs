...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebIamBindingConditionBlock>>? Condition { get; set; } = new();
