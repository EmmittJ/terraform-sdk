...
/// <summary>
/// Block type for enrolled_services in GoogleProjectAccessApprovalSettings.
/// Nesting mode: set
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleProjectAccessApprovalSettings.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_project_access_approval_settings Terraform resource.
/// Manages a google_project_access_approval_settings resource.
/// </summary>
public partial class GoogleProjectAccessApprovalSettings(string name) : TerraformResource("google_project_access_approval_settings", name)
{
    /// <summary>
    ...
    public required TerraformSet<GoogleProjectAccessApprovalSettingsEnrolledServicesBlock> EnrolledServices
    {
        get => GetRequiredArgument<TerraformSet<GoogleProjectAccessApprovalSettingsEnrolledServicesBlock>>("enrolled_services");
    ...
    {
        get => GetArgument<GoogleProjectAccessApprovalSettingsTimeoutsBlock>("timeouts");
