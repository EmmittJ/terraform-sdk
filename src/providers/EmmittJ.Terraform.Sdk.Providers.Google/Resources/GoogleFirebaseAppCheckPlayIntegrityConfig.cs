...
/// Nesting mode: single
/// </summary>
public class GoogleFirebaseAppCheckPlayIntegrityConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleFirebaseAppCheckPlayIntegrityConfig : TerraformResource
{
    ...
    public TerraformBlock<GoogleFirebaseAppCheckPlayIntegrityConfigTimeoutsBlock>? Timeouts { get; set; } = new();
