...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingOrganizationSinkBigqueryOptionsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingOrganizationSinkExclusionsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingOrganizationSink : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingOrganizationSinkBigqueryOptionsBlock>>? BigqueryOptions { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleLoggingOrganizationSinkExclusionsBlock>>? Exclusions { get; set; } = new();
