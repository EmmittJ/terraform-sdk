...
/// Nesting mode: list
/// </summary>
public partial class GoogleLoggingOrganizationSinkBigqueryOptionsBlock() : TerraformBlock("bigquery_options")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleLoggingOrganizationSinkExclusionsBlock() : TerraformBlock("exclusions")
{
    /// <summary>
...
public partial class GoogleLoggingOrganizationSink : TerraformResource
{
    ...
    public TerraformList<GoogleLoggingOrganizationSinkBigqueryOptionsBlock> BigqueryOptions { get; set; } = new();
    ...
    public TerraformList<GoogleLoggingOrganizationSinkExclusionsBlock> Exclusions { get; set; } = new();
