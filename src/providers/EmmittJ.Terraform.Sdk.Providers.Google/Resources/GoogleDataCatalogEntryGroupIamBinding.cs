...
public class GoogleDataCatalogEntryGroupIamBinding : TerraformResource
{
    ...
    public List<GoogleDataCatalogEntryGroupIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataCatalogEntryGroupIamBindingConditionBlock>>("condition");
