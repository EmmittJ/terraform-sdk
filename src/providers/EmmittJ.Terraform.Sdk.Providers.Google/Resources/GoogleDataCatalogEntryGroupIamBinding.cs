...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogEntryGroupIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogEntryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogEntryGroupIamBindingConditionBlock> Condition { get; set; } = new();
