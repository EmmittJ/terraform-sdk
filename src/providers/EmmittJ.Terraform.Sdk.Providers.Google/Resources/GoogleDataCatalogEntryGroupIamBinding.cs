...
/// <summary>
/// Block type for condition in GoogleDataCatalogEntryGroupIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogEntryGroupIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_data_catalog_entry_group_iam_binding Terraform resource.
/// Manages a google_data_catalog_entry_group_iam_binding resource.
/// </summary>
public partial class GoogleDataCatalogEntryGroupIamBinding(string name) : TerraformResource("google_data_catalog_entry_group_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataCatalogEntryGroupIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataCatalogEntryGroupIamBindingConditionBlock>>("condition");
