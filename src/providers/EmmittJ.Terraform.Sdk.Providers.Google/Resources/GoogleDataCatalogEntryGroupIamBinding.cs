...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogEntryGroupIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogEntryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogEntryGroupIamBindingConditionBlock>>? Condition { get; set; } = new();
