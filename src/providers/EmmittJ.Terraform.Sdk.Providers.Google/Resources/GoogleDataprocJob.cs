...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobHadoopConfigBlock() : TerraformBlock("hadoop_config")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobHiveConfigBlock() : TerraformBlock("hive_config")
{
    /// <summary>
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ContinueOnFailure { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? QueryList { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobPigConfigBlock() : TerraformBlock("pig_config")
{
    /// <summary>
    /// Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobPlacementBlock() : TerraformBlock("placement")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobPrestoConfigBlock() : TerraformBlock("presto_config")
{
    /// <summary>
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? ClientTags { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobPysparkConfigBlock() : TerraformBlock("pyspark_config")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobReferenceBlock() : TerraformBlock("reference")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobSchedulingBlock() : TerraformBlock("scheduling")
{
    /// <summary>
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaxFailuresPerHour { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaxFailuresTotal { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobSparkConfigBlock() : TerraformBlock("spark_config")
{
    /// <summary>
    /// HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocJobSparksqlConfigBlock() : TerraformBlock("sparksql_config")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class GoogleDataprocJobTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleDataprocJob : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocJobHadoopConfigBlock> HadoopConfig { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobHiveConfigBlock> HiveConfig { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobPigConfigBlock> PigConfig { get; set; } = new();
    ...
    public required TerraformList<GoogleDataprocJobPlacementBlock> Placement { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobPrestoConfigBlock> PrestoConfig { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobPysparkConfigBlock> PysparkConfig { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobReferenceBlock> Reference { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobSchedulingBlock> Scheduling { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobSparkConfigBlock> SparkConfig { get; set; } = new();
    ...
    public TerraformList<GoogleDataprocJobSparksqlConfigBlock> SparksqlConfig { get; set; } = new();
    ...
    public GoogleDataprocJobTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<string> DriverControlsFilesUri { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DriverOutputResourceUri { get; }
