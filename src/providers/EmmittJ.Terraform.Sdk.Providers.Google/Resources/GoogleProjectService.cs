...
/// Nesting mode: single
/// </summary>
public class GoogleProjectServiceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleProjectService : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? DisableDependentServices { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? DisableOnDestroy { get; set; }
    ...
    public TerraformBlock<GoogleProjectServiceTimeoutsBlock>? Timeouts { get; set; } = new();
