...
/// Nesting mode: single
/// </summary>
public partial class GoogleProjectServiceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class GoogleProjectService : TerraformResource
{
    ...
    public GoogleProjectServiceTimeoutsBlock Timeouts { get; set; } = new();
