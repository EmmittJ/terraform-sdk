...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeSubnetworkIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeSubnetworkIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleComputeSubnetworkIamBindingConditionBlock> Condition { get; set; } = new();
