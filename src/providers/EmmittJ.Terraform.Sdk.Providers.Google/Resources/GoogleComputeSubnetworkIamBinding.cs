...
/// Nesting mode: list
/// </summary>
public class GoogleComputeSubnetworkIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeSubnetworkIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Subnetwork { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeSubnetworkIamBindingConditionBlock>>? Condition { get; set; } = new();
