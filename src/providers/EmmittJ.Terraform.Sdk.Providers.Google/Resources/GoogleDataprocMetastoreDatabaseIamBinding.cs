...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreDatabaseIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreDatabaseIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreDatabaseIamBindingConditionBlock>>? Condition { get; set; } = new();
