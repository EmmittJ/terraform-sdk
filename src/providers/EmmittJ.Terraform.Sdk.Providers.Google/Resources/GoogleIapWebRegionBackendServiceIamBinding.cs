...
/// <summary>
/// Block type for condition in GoogleIapWebRegionBackendServiceIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionBackendServiceIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_iap_web_region_backend_service_iam_binding Terraform resource.
/// Manages a google_iap_web_region_backend_service_iam_binding resource.
/// </summary>
public partial class GoogleIapWebRegionBackendServiceIamBinding(string name) : TerraformResource("google_iap_web_region_backend_service_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleIapWebRegionBackendServiceIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapWebRegionBackendServiceIamBindingConditionBlock>>("condition");
