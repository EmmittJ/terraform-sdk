...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebRegionBackendServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebRegionBackendServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebRegionBackendServiceIamBindingConditionBlock> Condition { get; set; } = new();
