...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionBackendServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebRegionBackendServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebRegionBackendServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
