...
public partial class GoogleCloudRunV2ServiceBuildConfigBlock() : TerraformBlock("build_config")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? BaseImage { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FunctionTarget { get; set; }
...
public partial class GoogleCloudRunV2ServiceScalingBlock() : TerraformBlock("scaling")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? ManualInstanceCount { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ScalingMode { get; set; }
...
public partial class GoogleCloudRunV2ServiceTemplateBlock() : TerraformBlock("template")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ExecutionEnvironment { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? GpuZonalRedundancyDisabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? HealthCheckDisabled { get; set; }
...
public partial class GoogleCloudRunV2ServiceTrafficBlock() : TerraformBlock("traffic")
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> Percent { get; set; }
...
public partial class GoogleCloudRunV2Service : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? CustomAudiences { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? DefaultUriDisabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> Ingress { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? InvokerIamDisabled { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> TrafficStatuses { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> Urls { get; }
