...
/// Nesting mode: list
/// </summary>
public class GoogleProjectIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleProjectIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleProjectIamMemberConditionBlock>>? Condition { get; set; } = new();
