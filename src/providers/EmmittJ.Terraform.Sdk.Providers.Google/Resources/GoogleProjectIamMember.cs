...
/// Nesting mode: list
/// </summary>
public partial class GoogleProjectIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleProjectIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleProjectIamMemberConditionBlock> Condition { get; set; } = new();
