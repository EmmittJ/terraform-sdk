...
public partial class GoogleDataplexZoneResourceSpecBlock() : TerraformBlock("resource_spec")
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> LocationType { get; set; }
...
public partial class GoogleDataplexZone : TerraformResource
{
    ...
    public partial TerraformList<object> AssetStatus { get; }
