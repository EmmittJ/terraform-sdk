...
/// <summary>
/// Represents a google_dataproc_metastore_service_iam_policy Terraform resource.
/// Manages a google_dataproc_metastore_service_iam_policy resource.
/// </summary>
public partial class GoogleDataprocMetastoreServiceIamPolicy(string name) : TerraformResource("google_dataproc_metastore_service_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
