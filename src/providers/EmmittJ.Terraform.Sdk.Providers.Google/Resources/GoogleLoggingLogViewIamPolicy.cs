...
/// </summary>
public partial class GoogleLoggingLogViewIamPolicy : TerraformResource
{
    public GoogleLoggingLogViewIamPolicy(string name) : base("google_logging_log_view_iam_policy", name)
    {
    }
