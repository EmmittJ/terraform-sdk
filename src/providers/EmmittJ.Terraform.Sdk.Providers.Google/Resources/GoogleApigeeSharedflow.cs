...
/// Nesting mode: single
/// </summary>
public partial class GoogleApigeeSharedflowTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleApigeeSharedflow : TerraformResource
{
    ...
    public TerraformValue<string> LatestRevisionId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> Revision { get; }
