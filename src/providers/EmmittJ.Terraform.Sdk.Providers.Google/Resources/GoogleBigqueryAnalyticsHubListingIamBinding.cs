...
/// <summary>
/// Block type for condition in GoogleBigqueryAnalyticsHubListingIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_bigquery_analytics_hub_listing_iam_binding Terraform resource.
/// Manages a google_bigquery_analytics_hub_listing_iam_binding resource.
/// </summary>
public partial class GoogleBigqueryAnalyticsHubListingIamBinding(string name) : TerraformResource("google_bigquery_analytics_hub_listing_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryAnalyticsHubListingIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryAnalyticsHubListingIamBindingConditionBlock>>("condition");
