...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryAnalyticsHubListingIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryAnalyticsHubListingIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryAnalyticsHubListingIamBindingConditionBlock>>? Condition { get; set; } = new();
