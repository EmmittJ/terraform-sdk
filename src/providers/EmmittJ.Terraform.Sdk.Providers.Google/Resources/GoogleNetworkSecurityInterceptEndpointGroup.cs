...
/// <summary>
/// Block type for timeouts in GoogleNetworkSecurityInterceptEndpointGroup.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_network_security_intercept_endpoint_group Terraform resource.
/// Manages a google_network_security_intercept_endpoint_group resource.
/// </summary>
public partial class GoogleNetworkSecurityInterceptEndpointGroup(string name) : TerraformResource("google_network_security_intercept_endpoint_group", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "intercept_deployment_group");
    ...
    public required TerraformValue<string> InterceptEndpointGroupId
    {
        get => new TerraformReference<string>(this, "intercept_endpoint_group_id");
        set => SetArgument("intercept_endpoint_group_id", value);
    }
    ...
    /// </summary>
    public TerraformList<TerraformMap<object>> ConnectedDeploymentGroup
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "connected_deployment_group").ResolveNodes(ctx));
    }
    ...
    {
        get => GetArgument<GoogleNetworkSecurityInterceptEndpointGroupTimeoutsBlock>("timeouts");
