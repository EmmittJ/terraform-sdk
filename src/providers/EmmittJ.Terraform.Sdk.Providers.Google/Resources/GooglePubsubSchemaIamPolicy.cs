...
/// <summary>
/// Represents a google_pubsub_schema_iam_policy Terraform resource.
/// Manages a google_pubsub_schema_iam_policy resource.
/// </summary>
public partial class GooglePubsubSchemaIamPolicy(string name) : TerraformResource("google_pubsub_schema_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
