...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebBackendServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebBackendServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebBackendServiceIamMemberConditionBlock> Condition { get; set; } = new();
