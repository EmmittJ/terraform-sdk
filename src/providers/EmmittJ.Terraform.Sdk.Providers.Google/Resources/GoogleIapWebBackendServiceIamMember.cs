...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebBackendServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebBackendServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebBackendServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
