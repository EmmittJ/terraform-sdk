...
public partial class GoogleGeminiLoggingSetting(string name) : TerraformResource("google_gemini_logging_setting", name)
{
    ...
    {
        get => new TerraformReference<bool>(this, "log_metadata");
    ...
    {
        get => new TerraformReference<bool>(this, "log_prompts_and_responses");
    ...
    {
        get => new TerraformReference<string>(this, "logging_setting_id");
