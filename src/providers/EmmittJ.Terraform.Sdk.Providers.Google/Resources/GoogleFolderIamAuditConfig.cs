...
/// Nesting mode: set
/// </summary>
public partial class GoogleFolderIamAuditConfigAuditLogConfigBlock() : TerraformBlock("audit_log_config")
{
    /// <summary>
...
public partial class GoogleFolderIamAuditConfig : TerraformResource
{
    ...
    public required TerraformSet<GoogleFolderIamAuditConfigAuditLogConfigBlock> AuditLogConfig { get; set; } = new();
