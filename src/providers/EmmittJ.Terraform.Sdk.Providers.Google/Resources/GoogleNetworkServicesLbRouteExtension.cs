...
/// Nesting mode: list
/// </summary>
public partial class GoogleNetworkServicesLbRouteExtensionExtensionChainsBlock() : TerraformBlock("extension_chains")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkServicesLbRouteExtensionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleNetworkServicesLbRouteExtension : TerraformResource
{
    ...
    public required TerraformList<GoogleNetworkServicesLbRouteExtensionExtensionChainsBlock> ExtensionChains { get; set; } = new();
    ...
    public GoogleNetworkServicesLbRouteExtensionTimeoutsBlock Timeouts { get; set; } = new();
