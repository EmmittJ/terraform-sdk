...
/// Nesting mode: list
/// </summary>
public class GoogleNetworkServicesLbRouteExtensionExtensionChainsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkServicesLbRouteExtensionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkServicesLbRouteExtension : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNetworkServicesLbRouteExtensionExtensionChainsBlock>>? ExtensionChains { get; set; } = new();
    ...
    public TerraformBlock<GoogleNetworkServicesLbRouteExtensionTimeoutsBlock>? Timeouts { get; set; } = new();
