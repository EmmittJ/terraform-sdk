...
public partial class GoogleNetworkSecurityMirroringEndpointGroup : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? MirroringDeploymentGroup { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> MirroringEndpointGroupId { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityMirroringEndpointGroupTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<object> ConnectedDeploymentGroups { get; }
