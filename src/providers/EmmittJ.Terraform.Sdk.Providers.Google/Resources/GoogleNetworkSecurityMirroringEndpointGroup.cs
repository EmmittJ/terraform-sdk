...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityMirroringEndpointGroupTimeoutsBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityMirroringEndpointGroup : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformSet<object> ConnectedDeploymentGroups => new TerraformReference(this, "connected_deployment_groups");
