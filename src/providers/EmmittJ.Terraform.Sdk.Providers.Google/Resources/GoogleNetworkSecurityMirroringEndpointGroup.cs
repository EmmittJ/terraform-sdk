...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkSecurityMirroringEndpointGroupTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleNetworkSecurityMirroringEndpointGroup : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MirroringDeploymentGroup { get; set; }
    ...
    [TerraformProperty("mirroring_endpoint_group_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> MirroringEndpointGroupId { get; set; }
    ...
    public partial TerraformBlock<GoogleNetworkSecurityMirroringEndpointGroupTimeoutsBlock>? Timeouts { get; set; }
    ...
    /// group.
    /// </summary>
    [TerraformProperty("connected_deployment_groups")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> ConnectedDeploymentGroups { get; }
