...
/// <summary>
/// Represents a google_iap_tunnel_instance_iam_policy Terraform resource.
/// Manages a google_iap_tunnel_instance_iam_policy resource.
/// </summary>
public partial class GoogleIapTunnelInstanceIamPolicy(string name) : TerraformResource("google_iap_tunnel_instance_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
