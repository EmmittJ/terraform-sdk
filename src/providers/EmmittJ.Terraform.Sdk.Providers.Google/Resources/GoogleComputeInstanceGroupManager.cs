...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerAllInstancesConfigBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerAutoHealingPoliciesBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerInstanceLifecyclePolicyBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class GoogleComputeInstanceGroupManagerNamedPortBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerResourcePoliciesBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? WorkloadPolicy { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerStandbyPolicyBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class GoogleComputeInstanceGroupManagerStatefulDiskBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerStatefulExternalIpBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerStatefulInternalIpBlock
{
    /// <summary>
    /// A value that prescribes what should happen to an associated static Address resource when a VM instance is permanently deleted. The available options are NEVER and ON_PERMANENT_INSTANCE_DELETION. NEVER - detach the IP when the VM is deleted, but do not delete the address resource. ON_PERMANENT_INSTANCE_DELETION will delete the stateful address when the VM is permanently deleted from the instance group. The default is NEVER.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleComputeInstanceGroupManagerTimeoutsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerUpdatePolicyBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceGroupManagerVersionBlock
{
    /// <summary>
...
public class GoogleComputeInstanceGroupManager : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerAllInstancesConfigBlock>>? AllInstancesConfig { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerAutoHealingPoliciesBlock>>? AutoHealingPolicies { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerInstanceLifecyclePolicyBlock>>? InstanceLifecyclePolicy { get; set; }
    ...
    public TerraformSet<TerraformBlock<GoogleComputeInstanceGroupManagerNamedPortBlock>>? NamedPort { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerResourcePoliciesBlock>>? ResourcePolicies { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerStandbyPolicyBlock>>? StandbyPolicy { get; set; }
    ...
    public TerraformSet<TerraformBlock<GoogleComputeInstanceGroupManagerStatefulDiskBlock>>? StatefulDisk { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerStatefulExternalIpBlock>>? StatefulExternalIp { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerStatefulInternalIpBlock>>? StatefulInternalIp { get; set; }
    ...
    public TerraformBlock<GoogleComputeInstanceGroupManagerTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerUpdatePolicyBlock>>? UpdatePolicy { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceGroupManagerVersionBlock>>? Version { get; set; }
