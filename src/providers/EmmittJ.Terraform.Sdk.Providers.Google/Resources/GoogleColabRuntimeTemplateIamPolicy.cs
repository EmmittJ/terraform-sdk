...
/// <summary>
/// Represents a google_colab_runtime_template_iam_policy Terraform resource.
/// Manages a google_colab_runtime_template_iam_policy resource.
/// </summary>
public partial class GoogleColabRuntimeTemplateIamPolicy(string name) : TerraformResource("google_colab_runtime_template_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
