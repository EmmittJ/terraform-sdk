...
public partial class GoogleColabRuntimeNotebookRuntimeTemplateRefBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<string> NotebookRuntimeTemplate { get; set; }
...
public partial class GoogleColabRuntime : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RuntimeUser { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> IsUpgradable { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> NotebookRuntimeType { get; }
