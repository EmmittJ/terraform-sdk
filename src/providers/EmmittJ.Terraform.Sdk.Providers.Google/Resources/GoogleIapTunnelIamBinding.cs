...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelIamBindingConditionBlock>>? Condition { get; set; } = new();
