...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapTunnelIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleIapTunnelIamBinding : TerraformResource
{
    public GoogleIapTunnelIamBinding(string name) : base("google_iap_tunnel_iam_binding", name)
    {
    }
    ...
    public partial TerraformList<TerraformBlock<GoogleIapTunnelIamBindingConditionBlock>>? Condition { get; set; }
