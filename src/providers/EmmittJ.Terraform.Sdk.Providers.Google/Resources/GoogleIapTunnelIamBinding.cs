...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapTunnelIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapTunnelIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapTunnelIamBindingConditionBlock> Condition { get; set; } = new();
