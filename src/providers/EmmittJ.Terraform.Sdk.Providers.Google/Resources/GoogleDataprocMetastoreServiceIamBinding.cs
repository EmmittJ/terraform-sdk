...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
