...
/// Nesting mode: list
/// </summary>
public class GoogleGeminiRepositoryGroupIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiRepositoryGroupIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGeminiRepositoryGroupIamMemberConditionBlock>>? Condition { get; set; } = new();
