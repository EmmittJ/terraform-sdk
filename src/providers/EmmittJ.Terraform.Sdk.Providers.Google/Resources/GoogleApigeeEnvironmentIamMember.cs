...
/// <summary>
/// Block type for condition in GoogleApigeeEnvironmentIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleApigeeEnvironmentIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_apigee_environment_iam_member Terraform resource.
/// Manages a google_apigee_environment_iam_member resource.
/// </summary>
public partial class GoogleApigeeEnvironmentIamMember(string name) : TerraformResource("google_apigee_environment_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleApigeeEnvironmentIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleApigeeEnvironmentIamMemberConditionBlock>>("condition");
