...
/// Nesting mode: list
/// </summary>
public partial class GoogleApigeeEnvironmentIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleApigeeEnvironmentIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleApigeeEnvironmentIamMemberConditionBlock> Condition { get; set; } = new();
