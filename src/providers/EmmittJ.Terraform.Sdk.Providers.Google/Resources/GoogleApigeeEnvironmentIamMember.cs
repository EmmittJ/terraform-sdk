...
/// Nesting mode: list
/// </summary>
public class GoogleApigeeEnvironmentIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleApigeeEnvironmentIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleApigeeEnvironmentIamMemberConditionBlock>>? Condition { get; set; } = new();
