...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogPolicyTagIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogPolicyTagIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogPolicyTagIamBindingConditionBlock> Condition { get; set; } = new();
