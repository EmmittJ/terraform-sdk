...
/// <summary>
/// Block type for condition in GoogleDataCatalogPolicyTagIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_data_catalog_policy_tag_iam_binding Terraform resource.
/// Manages a google_data_catalog_policy_tag_iam_binding resource.
/// </summary>
public partial class GoogleDataCatalogPolicyTagIamBinding(string name) : TerraformResource("google_data_catalog_policy_tag_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataCatalogPolicyTagIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataCatalogPolicyTagIamBindingConditionBlock>>("condition");
