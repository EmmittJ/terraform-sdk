...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogPolicyTagIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogPolicyTagIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogPolicyTagIamBindingConditionBlock>>? Condition { get; set; } = new();
