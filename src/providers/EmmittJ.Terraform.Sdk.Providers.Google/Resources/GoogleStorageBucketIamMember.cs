...
/// Nesting mode: list
/// </summary>
public class GoogleStorageBucketIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleStorageBucketIamMemberTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleStorageBucketIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleStorageBucketIamMemberConditionBlock>>? Condition { get; set; } = new();
    ...
    public TerraformBlock<GoogleStorageBucketIamMemberTimeoutsBlock>? Timeouts { get; set; } = new();
