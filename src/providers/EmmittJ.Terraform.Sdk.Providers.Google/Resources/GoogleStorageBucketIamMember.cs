...
/// Nesting mode: list
/// </summary>
public class GoogleStorageBucketIamMemberConditionBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleStorageBucketIamMemberTimeoutsBlock
{
    /// <summary>
...
public class GoogleStorageBucketIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleStorageBucketIamMemberConditionBlock>>? Condition { get; set; }
    ...
    public TerraformBlock<GoogleStorageBucketIamMemberTimeoutsBlock>? Timeouts { get; set; }
