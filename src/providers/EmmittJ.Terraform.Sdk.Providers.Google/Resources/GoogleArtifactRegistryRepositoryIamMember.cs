...
/// Nesting mode: list
/// </summary>
public class GoogleArtifactRegistryRepositoryIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleArtifactRegistryRepositoryIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleArtifactRegistryRepositoryIamMemberConditionBlock>>? Condition { get; set; } = new();
