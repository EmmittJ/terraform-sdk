...
/// Nesting mode: list
/// </summary>
public partial class GoogleArtifactRegistryRepositoryIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleArtifactRegistryRepositoryIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleArtifactRegistryRepositoryIamMemberConditionBlock> Condition { get; set; } = new();
