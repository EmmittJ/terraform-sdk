...
/// Nesting mode: list
/// </summary>
public class GoogleCloudbuildv2ConnectionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudbuildv2ConnectionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudbuildv2ConnectionIamMemberConditionBlock>>? Condition { get; set; } = new();
