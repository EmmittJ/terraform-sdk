...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryConnectionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryConnectionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryConnectionIamMemberConditionBlock>>? Condition { get; set; } = new();
