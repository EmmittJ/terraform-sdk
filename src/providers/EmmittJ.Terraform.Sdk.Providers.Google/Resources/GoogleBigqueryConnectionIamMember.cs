...
/// <summary>
/// Block type for condition in GoogleBigqueryConnectionIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryConnectionIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_bigquery_connection_iam_member Terraform resource.
/// Manages a google_bigquery_connection_iam_member resource.
/// </summary>
public partial class GoogleBigqueryConnectionIamMember(string name) : TerraformResource("google_bigquery_connection_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryConnectionIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryConnectionIamMemberConditionBlock>>("condition");
