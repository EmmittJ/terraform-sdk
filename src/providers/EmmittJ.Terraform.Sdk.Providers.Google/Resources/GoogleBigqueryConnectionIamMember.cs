...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryConnectionIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryConnectionIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryConnectionIamMemberConditionBlock> Condition { get; set; } = new();
