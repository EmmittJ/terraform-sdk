...
/// <summary>
/// Represents a google_dataplex_entry_type_iam_policy Terraform resource.
/// Manages a google_dataplex_entry_type_iam_policy resource.
/// </summary>
public partial class GoogleDataplexEntryTypeIamPolicy(string name) : TerraformResource("google_dataplex_entry_type_iam_policy", name)
{
    /// <summary>
