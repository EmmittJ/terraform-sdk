...
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterEgressPolicyEgressFromBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleAccessContextManagerServicePerimeterEgressPolicyTimeoutsBlock
{
    /// <summary>
