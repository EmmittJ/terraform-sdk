...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2JobIamMemberConditionBlock
{
    /// <summary>
...
public class GoogleCloudRunV2JobIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2JobIamMemberConditionBlock>>? Condition { get; set; }
