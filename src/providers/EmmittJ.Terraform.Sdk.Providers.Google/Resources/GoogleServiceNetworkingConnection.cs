...
/// Nesting mode: single
/// </summary>
public class GoogleServiceNetworkingConnectionTimeoutsBlock
{
    /// <summary>
...
public class GoogleServiceNetworkingConnection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformList<string>? ReservedPeeringRanges { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<bool>? UpdateOnCreationFail { get; set; }
    ...
    public TerraformBlock<GoogleServiceNetworkingConnectionTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> Peering => new TerraformReference(this, "peering");
