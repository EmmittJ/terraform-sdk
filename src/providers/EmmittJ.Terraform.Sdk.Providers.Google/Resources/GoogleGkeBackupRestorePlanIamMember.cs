...
/// Nesting mode: list
/// </summary>
public partial class GoogleGkeBackupRestorePlanIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleGkeBackupRestorePlanIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleGkeBackupRestorePlanIamMemberConditionBlock> Condition { get; set; } = new();
