...
/// Nesting mode: list
/// </summary>
public class GoogleGkeBackupRestorePlanIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeBackupRestorePlanIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeBackupRestorePlanIamMemberConditionBlock>>? Condition { get; set; } = new();
