...
public class GoogleGkeBackupRestorePlanIamMember : TerraformResource
{
    ...
    public List<GoogleGkeBackupRestorePlanIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleGkeBackupRestorePlanIamMemberConditionBlock>>("condition");
