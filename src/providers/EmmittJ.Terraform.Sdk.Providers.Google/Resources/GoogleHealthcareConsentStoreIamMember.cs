...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareConsentStoreIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareConsentStoreIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareConsentStoreIamMemberConditionBlock> Condition { get; set; } = new();
