...
/// <summary>
/// Represents a google_dataproc_metastore_database_iam_policy Terraform resource.
/// Manages a google_dataproc_metastore_database_iam_policy resource.
/// </summary>
public partial class GoogleDataprocMetastoreDatabaseIamPolicy(string name) : TerraformResource("google_dataproc_metastore_database_iam_policy", name)
{
    /// <summary>
