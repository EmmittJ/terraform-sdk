...
/// <summary>
/// Represents a google_dataproc_cluster_iam_policy Terraform resource.
/// Manages a google_dataproc_cluster_iam_policy resource.
/// </summary>
public partial class GoogleDataprocClusterIamPolicy(string name) : TerraformResource("google_dataproc_cluster_iam_policy", name)
{
    /// <summary>
