...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreFederationIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreFederationIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreFederationIamMemberConditionBlock>>? Condition { get; set; } = new();
