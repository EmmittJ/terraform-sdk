...
/// <summary>
/// Block type for condition in GoogleDataprocMetastoreFederationIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataproc_metastore_federation_iam_member Terraform resource.
/// Manages a google_dataproc_metastore_federation_iam_member resource.
/// </summary>
public partial class GoogleDataprocMetastoreFederationIamMember(string name) : TerraformResource("google_dataproc_metastore_federation_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataprocMetastoreFederationIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataprocMetastoreFederationIamMemberConditionBlock>>("condition");
