...
/// Nesting mode: single
/// </summary>
public class GoogleStorageBucketIamPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleStorageBucketIamPolicy : TerraformResource
{
    ...
    public TerraformBlock<GoogleStorageBucketIamPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
