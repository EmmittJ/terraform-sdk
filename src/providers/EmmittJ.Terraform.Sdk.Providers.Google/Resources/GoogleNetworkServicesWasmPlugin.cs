...
public partial class GoogleNetworkServicesWasmPluginLogConfigBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string> MinLogLevel { get; set; }
...
public partial class GoogleNetworkServicesWasmPluginVersionsBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PluginConfigData { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PluginConfigUri { get; set; }
...
public partial class GoogleNetworkServicesWasmPlugin : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> MainVersionId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> UsedBy { get; }
