...
/// Nesting mode: single
/// </summary>
public class GoogleVertexAiCacheConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleVertexAiCacheConfig : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<bool>> DisableCache { get; set; }
    ...
    public TerraformBlock<GoogleVertexAiCacheConfigTimeoutsBlock>? Timeouts { get; set; } = new();
