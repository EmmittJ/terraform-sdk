...
/// Nesting mode: single
/// </summary>
public class GoogleIntegrationConnectorsManagedZoneTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIntegrationConnectorsManagedZone : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> TargetProject { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> TargetVpc { get; set; }
    ...
    public TerraformBlock<GoogleIntegrationConnectorsManagedZoneTimeoutsBlock>? Timeouts { get; set; } = new();
