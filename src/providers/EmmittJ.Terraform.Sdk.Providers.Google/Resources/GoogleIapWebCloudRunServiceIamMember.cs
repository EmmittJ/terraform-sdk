...
/// <summary>
/// Block type for condition in GoogleIapWebCloudRunServiceIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_iap_web_cloud_run_service_iam_member Terraform resource.
/// Manages a google_iap_web_cloud_run_service_iam_member resource.
/// </summary>
public partial class GoogleIapWebCloudRunServiceIamMember(string name) : TerraformResource("google_iap_web_cloud_run_service_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIapWebCloudRunServiceIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapWebCloudRunServiceIamMemberConditionBlock>>("condition");
