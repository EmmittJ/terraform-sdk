...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebCloudRunServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebCloudRunServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebCloudRunServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
