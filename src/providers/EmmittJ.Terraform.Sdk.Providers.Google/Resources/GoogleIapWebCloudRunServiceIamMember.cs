...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebCloudRunServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebCloudRunServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebCloudRunServiceIamMemberConditionBlock> Condition { get; set; } = new();
