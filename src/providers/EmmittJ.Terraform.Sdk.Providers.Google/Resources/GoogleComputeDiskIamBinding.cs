...
/// Nesting mode: list
/// </summary>
public class GoogleComputeDiskIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeDiskIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeDiskIamBindingConditionBlock>>? Condition { get; set; } = new();
