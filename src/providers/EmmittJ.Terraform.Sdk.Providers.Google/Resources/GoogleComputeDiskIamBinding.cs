...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeDiskIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeDiskIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleComputeDiskIamBindingConditionBlock> Condition { get; set; } = new();
