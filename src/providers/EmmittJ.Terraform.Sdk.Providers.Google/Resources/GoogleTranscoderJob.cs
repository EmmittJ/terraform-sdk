...
/// Nesting mode: list
/// </summary>
public class GoogleTranscoderJobConfigBlock : ITerraformBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class GoogleTranscoderJobTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleTranscoderJob : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleTranscoderJobConfigBlock>>? Config { get; set; } = new();
    ...
    public TerraformBlock<GoogleTranscoderJobTimeoutsBlock>? Timeouts { get; set; } = new();
