...
/// Nesting mode: list
/// </summary>
public class GoogleComputeStoragePoolIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeStoragePoolIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeStoragePoolIamBindingConditionBlock>>? Condition { get; set; } = new();
