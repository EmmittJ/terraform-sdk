...
/// Nesting mode: list
/// </summary>
public class GoogleEventarcTriggerDestinationBlock
{
...
/// Nesting mode: set
/// </summary>
public class GoogleEventarcTriggerMatchingCriteriaBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleEventarcTriggerTimeoutsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleEventarcTriggerTransportBlock
{
}
...
public class GoogleEventarcTrigger : TerraformResource
{
    ...
    public TerraformValue<string> EventDataContentType { get; set; } = default!;
    ...
    public TerraformMap<string> Conditions => new TerraformReference(this, "conditions");
