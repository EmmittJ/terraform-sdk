...
/// <summary>
/// Represents a google_dataplex_entry_group_iam_policy Terraform resource.
/// Manages a google_dataplex_entry_group_iam_policy resource.
/// </summary>
public partial class GoogleDataplexEntryGroupIamPolicy(string name) : TerraformResource("google_dataplex_entry_group_iam_policy", name)
{
    /// <summary>
