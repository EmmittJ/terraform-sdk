...
/// Nesting mode: single
/// </summary>
public partial class GoogleStorageFolderTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleStorageFolder : TerraformResource
{
    ...
    public partial TerraformBlock<GoogleStorageFolderTimeoutsBlock>? Timeouts { get; set; }
    ...
    /// </summary>
    [TerraformProperty("metageneration")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Metageneration { get; }
