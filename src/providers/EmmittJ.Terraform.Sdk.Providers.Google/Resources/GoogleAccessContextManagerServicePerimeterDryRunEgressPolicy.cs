...
/// Nesting mode: list
/// </summary>
public partial class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock() : TerraformBlock("egress_from")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock() : TerraformBlock("egress_to")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy : TerraformResource
{
    ...
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock> EgressFrom { get; set; } = new();
    ...
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock> EgressTo { get; set; } = new();
    ...
    public GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyTimeoutsBlock Timeouts { get; set; } = new();
