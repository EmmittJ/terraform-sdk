...
/// <summary>
/// Block type for egress_from in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy.
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock : TerraformBlock
{
    ...
    /// </summary>
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlockSourcesBlock>? Sources
    {
        get => GetArgument<TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlockSourcesBlock>>("sources");
...
/// <summary>
/// Block type for sources in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock.
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlockSourcesBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for egress_to in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy.
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock : TerraformBlock
{
    ...
    {
        get => TerraformList<string>.Lazy(ctx => new TerraformReference<TerraformList<string>>(this, "external_resources").ResolveNodes(ctx));
    ...
    /// </summary>
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlock>? Operations
    {
        get => GetArgument<TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlock>>("operations");
...
/// <summary>
/// Block type for operations in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock.
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
    ...
    /// </summary>
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlockMethodSelectorsBlock>? MethodSelectors
    {
        get => GetArgument<TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlockMethodSelectorsBlock>>("method_selectors");
...
/// <summary>
/// Block type for method_selectors in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlock.
/// Nesting mode: list
/// </summary>
public class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlockOperationsBlockMethodSelectorsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_access_context_manager_service_perimeter_dry_run_egress_policy Terraform resource.
/// Manages a google_access_context_manager_service_perimeter_dry_run_egress_policy resource.
/// </summary>
public partial class GoogleAccessContextManagerServicePerimeterDryRunEgressPolicy(string name) : TerraformResource("google_access_context_manager_service_perimeter_dry_run_egress_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock>? EgressFrom
    {
        get => GetArgument<TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressFromBlock>>("egress_from");
    ...
    public TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock>? EgressTo
    {
        get => GetArgument<TerraformList<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToBlock>>("egress_to");
    ...
    {
        get => GetArgument<GoogleAccessContextManagerServicePerimeterDryRunEgressPolicyTimeoutsBlock>("timeouts");
