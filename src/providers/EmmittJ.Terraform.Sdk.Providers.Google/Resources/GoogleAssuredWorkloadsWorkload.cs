...
/// Nesting mode: list
/// </summary>
public class GoogleAssuredWorkloadsWorkloadKmsSettingsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleAssuredWorkloadsWorkloadPartnerPermissionsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleAssuredWorkloadsWorkloadResourceSettingsBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleAssuredWorkloadsWorkloadTimeoutsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleAssuredWorkloadsWorkloadWorkloadOptionsBlock
{
    /// <summary>
...
public class GoogleAssuredWorkloadsWorkload : TerraformResource
{
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<bool> ViolationNotificationsEnabled { get; set; } = default!;
    ...
    public TerraformList<object> ComplianceStatus => new TerraformReference(this, "compliance_status");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<string> CompliantButDisallowedServices => new TerraformReference(this, "compliant_but_disallowed_services");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> EkmProvisioningResponse => new TerraformReference(this, "ekm_provisioning_response");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> KajEnrollmentState => new TerraformReference(this, "kaj_enrollment_state");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> SaaEnrollmentResponse => new TerraformReference(this, "saa_enrollment_response");
