...
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctionsFunctionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudfunctionsFunctionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudfunctionsFunctionIamMemberConditionBlock>>? Condition { get; set; } = new();
