...
/// Nesting mode: list
/// </summary>
public partial class GoogleCloudfunctionsFunctionIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleCloudfunctionsFunctionIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleCloudfunctionsFunctionIamMemberConditionBlock> Condition { get; set; } = new();
