...
public class GoogleCloudfunctionsFunctionIamMember : TerraformResource
{
    ...
    public List<GoogleCloudfunctionsFunctionIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleCloudfunctionsFunctionIamMemberConditionBlock>>("condition");
