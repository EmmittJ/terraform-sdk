...
/// Nesting mode: list
/// </summary>
public class GoogleFolderIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleFolderIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleFolderIamMemberConditionBlock>>? Condition { get; set; } = new();
