...
/// Nesting mode: list
/// </summary>
public partial class GoogleFolderIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleFolderIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleFolderIamMemberConditionBlock> Condition { get; set; } = new();
