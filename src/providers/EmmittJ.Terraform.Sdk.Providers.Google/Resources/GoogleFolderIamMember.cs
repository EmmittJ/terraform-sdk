...
/// <summary>
/// Block type for condition in GoogleFolderIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleFolderIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_folder_iam_member Terraform resource.
/// Manages a google_folder_iam_member resource.
/// </summary>
public partial class GoogleFolderIamMember(string name) : TerraformResource("google_folder_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleFolderIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleFolderIamMemberConditionBlock>>("condition");
