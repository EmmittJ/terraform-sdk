...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceSettingsMetadataBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>>? Items { get; set; }
...
/// Nesting mode: single
/// </summary>
public class GoogleComputeInstanceSettingsTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceSettings : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceSettingsMetadataBlock>>? Metadata { get; set; } = new();
    ...
    public TerraformBlock<GoogleComputeInstanceSettingsTimeoutsBlock>? Timeouts { get; set; } = new();
