...
/// Nesting mode: single
/// </summary>
public class GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeRegionDiskResourcePolicyAttachment : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
