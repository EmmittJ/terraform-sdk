...
/// <summary>
/// Represents a google_bigquery_table_iam_policy Terraform resource.
/// Manages a google_bigquery_table_iam_policy resource.
/// </summary>
public partial class GoogleBigqueryTableIamPolicy(string name) : TerraformResource("google_bigquery_table_iam_policy", name)
{
    /// <summary>
