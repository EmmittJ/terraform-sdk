...
/// Nesting mode: list
/// </summary>
public partial class GoogleKmsKeyRingIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleKmsKeyRingIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleKmsKeyRingIamMemberConditionBlock> Condition { get; set; } = new();
