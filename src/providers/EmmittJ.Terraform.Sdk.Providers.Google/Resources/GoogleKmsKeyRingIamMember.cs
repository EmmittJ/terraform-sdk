...
/// <summary>
/// Block type for condition in GoogleKmsKeyRingIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleKmsKeyRingIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_kms_key_ring_iam_member Terraform resource.
/// Manages a google_kms_key_ring_iam_member resource.
/// </summary>
public partial class GoogleKmsKeyRingIamMember(string name) : TerraformResource("google_kms_key_ring_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleKmsKeyRingIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleKmsKeyRingIamMemberConditionBlock>>("condition");
