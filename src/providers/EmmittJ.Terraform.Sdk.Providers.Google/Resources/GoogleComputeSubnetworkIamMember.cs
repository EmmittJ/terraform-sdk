...
/// Nesting mode: list
/// </summary>
public class GoogleComputeSubnetworkIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeSubnetworkIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeSubnetworkIamMemberConditionBlock>>? Condition { get; set; } = new();
