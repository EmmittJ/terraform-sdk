...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeSubnetworkIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeSubnetworkIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleComputeSubnetworkIamMemberConditionBlock> Condition { get; set; } = new();
