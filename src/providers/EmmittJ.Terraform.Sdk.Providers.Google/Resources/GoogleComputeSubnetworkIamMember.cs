...
/// <summary>
/// Block type for condition in GoogleComputeSubnetworkIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleComputeSubnetworkIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_compute_subnetwork_iam_member Terraform resource.
/// Manages a google_compute_subnetwork_iam_member resource.
/// </summary>
public partial class GoogleComputeSubnetworkIamMember(string name) : TerraformResource("google_compute_subnetwork_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleComputeSubnetworkIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleComputeSubnetworkIamMemberConditionBlock>>("condition");
