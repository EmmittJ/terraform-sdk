...
/// Nesting mode: list
/// </summary>
public class GoogleBinaryAuthorizationAttestorIamBindingConditionBlock
{
    /// <summary>
...
public class GoogleBinaryAuthorizationAttestorIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBinaryAuthorizationAttestorIamBindingConditionBlock>>? Condition { get; set; }
