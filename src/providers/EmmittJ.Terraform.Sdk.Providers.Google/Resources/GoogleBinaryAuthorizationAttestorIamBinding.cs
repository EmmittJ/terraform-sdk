...
public class GoogleBinaryAuthorizationAttestorIamBinding : TerraformResource
{
    ...
    public List<GoogleBinaryAuthorizationAttestorIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleBinaryAuthorizationAttestorIamBindingConditionBlock>>("condition");
