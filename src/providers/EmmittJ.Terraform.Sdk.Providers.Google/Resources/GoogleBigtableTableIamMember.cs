...
/// <summary>
/// Block type for condition in GoogleBigtableTableIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleBigtableTableIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_bigtable_table_iam_member Terraform resource.
/// Manages a google_bigtable_table_iam_member resource.
/// </summary>
public partial class GoogleBigtableTableIamMember(string name) : TerraformResource("google_bigtable_table_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleBigtableTableIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigtableTableIamMemberConditionBlock>>("condition");
