...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableTableIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigtableTableIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigtableTableIamMemberConditionBlock>>? Condition { get; set; } = new();
