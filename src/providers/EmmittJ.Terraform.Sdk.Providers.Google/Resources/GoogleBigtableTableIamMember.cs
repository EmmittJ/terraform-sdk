...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigtableTableIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigtableTableIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigtableTableIamMemberConditionBlock> Condition { get; set; } = new();
