...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployCustomTargetTypeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployCustomTargetTypeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployCustomTargetTypeIamMemberConditionBlock>>? Condition { get; set; } = new();
