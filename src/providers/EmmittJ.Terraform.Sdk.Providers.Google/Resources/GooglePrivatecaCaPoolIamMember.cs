...
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCaPoolIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePrivatecaCaPoolIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePrivatecaCaPoolIamMemberConditionBlock>>? Condition { get; set; } = new();
