...
/// <summary>
/// Block type for condition in GooglePrivatecaCaPoolIamMember.
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCaPoolIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_privateca_ca_pool_iam_member Terraform resource.
/// Manages a google_privateca_ca_pool_iam_member resource.
/// </summary>
public partial class GooglePrivatecaCaPoolIamMember(string name) : TerraformResource("google_privateca_ca_pool_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GooglePrivatecaCaPoolIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GooglePrivatecaCaPoolIamMemberConditionBlock>>("condition");
