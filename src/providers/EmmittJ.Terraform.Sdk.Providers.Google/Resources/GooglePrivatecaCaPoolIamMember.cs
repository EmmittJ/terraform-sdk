...
/// Nesting mode: list
/// </summary>
public partial class GooglePrivatecaCaPoolIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePrivatecaCaPoolIamMember : TerraformResource
{
    ...
    public TerraformList<GooglePrivatecaCaPoolIamMemberConditionBlock> Condition { get; set; } = new();
