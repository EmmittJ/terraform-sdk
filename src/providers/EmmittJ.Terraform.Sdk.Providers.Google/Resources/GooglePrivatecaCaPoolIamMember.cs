...
/// Nesting mode: list
/// </summary>
public partial class GooglePrivatecaCaPoolIamMemberConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GooglePrivatecaCaPoolIamMember : TerraformResource
{
    ...
    public partial TerraformList<TerraformBlock<GooglePrivatecaCaPoolIamMemberConditionBlock>>? Condition { get; set; }
