...
public class GoogleNetworkSecurityAddressGroupIamBinding : TerraformResource
{
    ...
    public List<GoogleNetworkSecurityAddressGroupIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleNetworkSecurityAddressGroupIamBindingConditionBlock>>("condition");
