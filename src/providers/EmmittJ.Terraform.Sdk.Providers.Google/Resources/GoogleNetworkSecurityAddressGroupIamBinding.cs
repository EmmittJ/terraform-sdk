...
/// Nesting mode: list
/// </summary>
public partial class GoogleNetworkSecurityAddressGroupIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleNetworkSecurityAddressGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleNetworkSecurityAddressGroupIamBindingConditionBlock> Condition { get; set; } = new();
