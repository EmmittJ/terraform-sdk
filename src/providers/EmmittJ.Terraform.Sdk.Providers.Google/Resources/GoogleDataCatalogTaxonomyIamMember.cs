...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogTaxonomyIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogTaxonomyIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogTaxonomyIamMemberConditionBlock> Condition { get; set; } = new();
