...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogTaxonomyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogTaxonomyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogTaxonomyIamMemberConditionBlock>>? Condition { get; set; } = new();
