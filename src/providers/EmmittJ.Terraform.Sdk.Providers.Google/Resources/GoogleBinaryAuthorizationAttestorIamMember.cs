...
/// Nesting mode: list
/// </summary>
public class GoogleBinaryAuthorizationAttestorIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBinaryAuthorizationAttestorIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBinaryAuthorizationAttestorIamMemberConditionBlock>>? Condition { get; set; } = new();
