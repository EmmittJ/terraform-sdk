...
/// Nesting mode: list
/// </summary>
public partial class GoogleBinaryAuthorizationAttestorIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBinaryAuthorizationAttestorIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBinaryAuthorizationAttestorIamMemberConditionBlock> Condition { get; set; } = new();
