...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexZoneIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexZoneIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexZoneIamBindingConditionBlock>>? Condition { get; set; } = new();
