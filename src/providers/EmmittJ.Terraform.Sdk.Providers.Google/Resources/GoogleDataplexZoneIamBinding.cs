...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexZoneIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexZoneIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexZoneIamBindingConditionBlock> Condition { get; set; } = new();
