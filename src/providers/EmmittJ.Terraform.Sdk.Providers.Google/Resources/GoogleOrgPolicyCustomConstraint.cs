...
/// Nesting mode: single
/// </summary>
public partial class GoogleOrgPolicyCustomConstraintTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleOrgPolicyCustomConstraint : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Condition { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public partial TerraformList<string>? MethodTypes { get; set; }
    ...
    public GoogleOrgPolicyCustomConstraintTimeoutsBlock Timeouts { get; set; } = new();
