...
/// Nesting mode: list
/// </summary>
public partial class GoogleSccSourceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSccSourceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSccSourceIamMemberConditionBlock> Condition { get; set; } = new();
