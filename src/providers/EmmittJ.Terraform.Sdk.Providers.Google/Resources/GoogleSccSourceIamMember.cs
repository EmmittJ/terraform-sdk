...
/// Nesting mode: list
/// </summary>
public class GoogleSccSourceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccSourceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccSourceIamMemberConditionBlock>>? Condition { get; set; } = new();
