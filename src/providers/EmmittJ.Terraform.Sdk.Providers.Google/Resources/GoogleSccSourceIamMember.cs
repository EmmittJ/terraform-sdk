...
/// <summary>
/// Block type for condition in GoogleSccSourceIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_scc_source_iam_member Terraform resource.
/// Manages a google_scc_source_iam_member resource.
/// </summary>
public partial class GoogleSccSourceIamMember(string name) : TerraformResource("google_scc_source_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleSccSourceIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleSccSourceIamMemberConditionBlock>>("condition");
