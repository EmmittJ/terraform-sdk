...
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCertificateTemplateIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePrivatecaCertificateTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePrivatecaCertificateTemplateIamMemberConditionBlock>>? Condition { get; set; } = new();
