...
/// <summary>
/// Block type for condition in GooglePrivatecaCertificateTemplateIamMember.
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCertificateTemplateIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_privateca_certificate_template_iam_member Terraform resource.
/// Manages a google_privateca_certificate_template_iam_member resource.
/// </summary>
public partial class GooglePrivatecaCertificateTemplateIamMember(string name) : TerraformResource("google_privateca_certificate_template_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GooglePrivatecaCertificateTemplateIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GooglePrivatecaCertificateTemplateIamMemberConditionBlock>>("condition");
