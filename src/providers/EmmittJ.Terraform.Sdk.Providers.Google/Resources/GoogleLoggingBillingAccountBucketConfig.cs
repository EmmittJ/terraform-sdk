...
/// <summary>
/// Block type for cmek_settings in GoogleLoggingBillingAccountBucketConfig.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for index_configs in GoogleLoggingBillingAccountBucketConfig.
/// Nesting mode: set
/// </summary>
...
/// <summary>
/// Represents a google_logging_billing_account_bucket_config Terraform resource.
/// Manages a google_logging_billing_account_bucket_config resource.
/// </summary>
public partial class GoogleLoggingBillingAccountBucketConfig(string name) : TerraformResource("google_logging_billing_account_bucket_config", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleLoggingBillingAccountBucketConfigCmekSettingsBlock>? CmekSettings
    {
        get => GetArgument<TerraformList<GoogleLoggingBillingAccountBucketConfigCmekSettingsBlock>>("cmek_settings");
    ...
    public TerraformSet<GoogleLoggingBillingAccountBucketConfigIndexConfigsBlock>? IndexConfigs
    {
        get => GetArgument<TerraformSet<GoogleLoggingBillingAccountBucketConfigIndexConfigsBlock>>("index_configs");
