...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingBillingAccountBucketConfigCmekSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class GoogleLoggingBillingAccountBucketConfigIndexConfigsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingBillingAccountBucketConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingBillingAccountBucketConfigCmekSettingsBlock>>? CmekSettings { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<GoogleLoggingBillingAccountBucketConfigIndexConfigsBlock>>? IndexConfigs { get; set; } = new();
