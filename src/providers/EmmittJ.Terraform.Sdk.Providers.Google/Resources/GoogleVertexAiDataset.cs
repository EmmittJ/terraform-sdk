...
/// Nesting mode: list
/// </summary>
public class GoogleVertexAiDatasetEncryptionSpecBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleVertexAiDatasetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleVertexAiDataset : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MetadataSchemaUri { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleVertexAiDatasetEncryptionSpecBlock>>? EncryptionSpec { get; set; } = new();
    ...
    public TerraformBlock<GoogleVertexAiDatasetTimeoutsBlock>? Timeouts { get; set; } = new();
