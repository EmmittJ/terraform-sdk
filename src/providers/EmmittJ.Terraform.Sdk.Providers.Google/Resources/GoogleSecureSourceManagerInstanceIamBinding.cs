...
/// Nesting mode: list
/// </summary>
public partial class GoogleSecureSourceManagerInstanceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSecureSourceManagerInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleSecureSourceManagerInstanceIamBindingConditionBlock> Condition { get; set; } = new();
