...
public class GoogleSecureSourceManagerInstanceIamBinding : TerraformResource
{
    ...
    public List<GoogleSecureSourceManagerInstanceIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSecureSourceManagerInstanceIamBindingConditionBlock>>("condition");
