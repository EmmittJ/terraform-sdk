...
/// Nesting mode: list
/// </summary>
public class GoogleSecureSourceManagerInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecureSourceManagerInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecureSourceManagerInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
