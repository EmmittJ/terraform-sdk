...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataprocAutoscalingPolicyIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataprocAutoscalingPolicyIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataprocAutoscalingPolicyIamMemberConditionBlock> Condition { get; set; } = new();
