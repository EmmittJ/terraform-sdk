...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocAutoscalingPolicyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocAutoscalingPolicyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocAutoscalingPolicyIamMemberConditionBlock>>? Condition { get; set; } = new();
