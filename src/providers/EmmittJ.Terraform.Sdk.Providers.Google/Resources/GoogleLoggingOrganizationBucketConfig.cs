...
/// <summary>
/// Block type for cmek_settings in GoogleLoggingOrganizationBucketConfig.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for index_configs in GoogleLoggingOrganizationBucketConfig.
/// Nesting mode: set
/// </summary>
...
/// <summary>
/// Represents a google_logging_organization_bucket_config Terraform resource.
/// Manages a google_logging_organization_bucket_config resource.
/// </summary>
public partial class GoogleLoggingOrganizationBucketConfig(string name) : TerraformResource("google_logging_organization_bucket_config", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleLoggingOrganizationBucketConfigCmekSettingsBlock>? CmekSettings
    {
        get => GetArgument<TerraformList<GoogleLoggingOrganizationBucketConfigCmekSettingsBlock>>("cmek_settings");
    ...
    public TerraformSet<GoogleLoggingOrganizationBucketConfigIndexConfigsBlock>? IndexConfigs
    {
        get => GetArgument<TerraformSet<GoogleLoggingOrganizationBucketConfigIndexConfigsBlock>>("index_configs");
