...
public partial class GoogleAlloydbBackup(string name) : TerraformResource("google_alloydb_backup", name)
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("backup_id");
