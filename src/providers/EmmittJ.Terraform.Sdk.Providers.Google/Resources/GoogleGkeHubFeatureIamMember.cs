...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubFeatureIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubFeatureIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubFeatureIamMemberConditionBlock>>? Condition { get; set; } = new();
