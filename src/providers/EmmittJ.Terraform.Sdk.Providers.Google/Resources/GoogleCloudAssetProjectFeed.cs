...
/// Nesting mode: list
/// </summary>
public class GoogleCloudAssetProjectFeedConditionBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleCloudAssetProjectFeedFeedOutputConfigBlock : ITerraformBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class GoogleCloudAssetProjectFeedTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudAssetProjectFeed : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? BillingProject { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleCloudAssetProjectFeedConditionBlock>>? Condition { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleCloudAssetProjectFeedFeedOutputConfigBlock>>? FeedOutputConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleCloudAssetProjectFeedTimeoutsBlock>? Timeouts { get; set; } = new();
