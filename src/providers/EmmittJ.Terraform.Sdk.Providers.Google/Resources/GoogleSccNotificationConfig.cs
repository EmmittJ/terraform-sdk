...
/// <summary>
/// Block type for streaming_config in GoogleSccNotificationConfig.
/// Nesting mode: list
/// </summary>
public class GoogleSccNotificationConfigStreamingConfigBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleSccNotificationConfig.
/// Nesting mode: single
/// </summary>
public class GoogleSccNotificationConfigTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_scc_notification_config Terraform resource.
/// Manages a google_scc_notification_config resource.
/// </summary>
public partial class GoogleSccNotificationConfig(string name) : TerraformResource("google_scc_notification_config", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleSccNotificationConfigStreamingConfigBlock> StreamingConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleSccNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    /// </summary>
    public GoogleSccNotificationConfigTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleSccNotificationConfigTimeoutsBlock>("timeouts");
