...
/// Nesting mode: list
/// </summary>
public class GoogleSccNotificationConfigStreamingConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleSccNotificationConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccNotificationConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccNotificationConfigStreamingConfigBlock>>? StreamingConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleSccNotificationConfigTimeoutsBlock>? Timeouts { get; set; } = new();
