...
/// <summary>
/// Block type for timeouts in GoogleSccFolderSccBigQueryExport.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_folder_scc_big_query_export Terraform resource.
/// Manages a google_scc_folder_scc_big_query_export resource.
/// </summary>
public partial class GoogleSccFolderSccBigQueryExport(string name) : TerraformResource("google_scc_folder_scc_big_query_export", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleSccFolderSccBigQueryExportTimeoutsBlock>("timeouts");
