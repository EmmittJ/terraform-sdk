...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkConnectivityRegionalEndpointTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleNetworkConnectivityRegionalEndpoint : TerraformResource
{
    ...
    public required partial TerraformValue<string> AccessType { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TargetGoogleApi { get; set; }
    ...
    public GoogleNetworkConnectivityRegionalEndpointTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PscForwardingRule { get; }
