...
/// </summary>
public partial class GoogleCloudRunServiceIamPolicy : TerraformResource
{
    public GoogleCloudRunServiceIamPolicy(string name) : base("google_cloud_run_service_iam_policy", name)
    {
    }
