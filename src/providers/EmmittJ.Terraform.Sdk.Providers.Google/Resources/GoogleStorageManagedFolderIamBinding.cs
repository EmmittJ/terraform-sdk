...
/// Nesting mode: list
/// </summary>
public partial class GoogleStorageManagedFolderIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleStorageManagedFolderIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleStorageManagedFolderIamBindingConditionBlock> Condition { get; set; } = new();
