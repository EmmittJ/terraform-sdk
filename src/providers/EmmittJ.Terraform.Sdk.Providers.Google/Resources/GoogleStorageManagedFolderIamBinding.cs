...
/// Nesting mode: list
/// </summary>
public partial class GoogleStorageManagedFolderIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleStorageManagedFolderIamBinding : TerraformResource
{
    ...
    public partial TerraformList<TerraformBlock<GoogleStorageManagedFolderIamBindingConditionBlock>>? Condition { get; set; }
