...
/// Nesting mode: list
/// </summary>
public class GoogleStorageManagedFolderIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleStorageManagedFolderIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleStorageManagedFolderIamBindingConditionBlock>>? Condition { get; set; } = new();
