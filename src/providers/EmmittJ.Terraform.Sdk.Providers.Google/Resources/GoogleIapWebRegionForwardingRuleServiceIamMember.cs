...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock
{
    /// <summary>
...
public class GoogleIapWebRegionForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock>>? Condition { get; set; }
