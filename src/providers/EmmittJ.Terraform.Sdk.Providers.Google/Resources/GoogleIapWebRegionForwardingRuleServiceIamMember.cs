...
public class GoogleIapWebRegionForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public List<GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock>>("condition");
