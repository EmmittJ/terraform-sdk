...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebRegionForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebRegionForwardingRuleServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
