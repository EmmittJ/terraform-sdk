...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetappBackupPolicyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleNetappBackupPolicy : TerraformResource
{
    ...
    public required partial TerraformValue<double> DailyBackupLimit { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MonthlyBackupLimit { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> WeeklyBackupLimit { get; set; }
    ...
    public GoogleNetappBackupPolicyTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<double> AssignedVolumeCount { get; }
