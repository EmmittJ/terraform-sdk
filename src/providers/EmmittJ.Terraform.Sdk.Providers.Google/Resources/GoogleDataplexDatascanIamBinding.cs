...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexDatascanIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexDatascanIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexDatascanIamBindingConditionBlock>>? Condition { get; set; } = new();
