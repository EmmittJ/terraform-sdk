...
/// <summary>
/// Block type for condition in GoogleDataplexDatascanIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexDatascanIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_datascan_iam_binding Terraform resource.
/// Manages a google_dataplex_datascan_iam_binding resource.
/// </summary>
public partial class GoogleDataplexDatascanIamBinding(string name) : TerraformResource("google_dataplex_datascan_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexDatascanIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexDatascanIamBindingConditionBlock>>("condition");
