...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexDatascanIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexDatascanIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexDatascanIamBindingConditionBlock> Condition { get; set; } = new();
