...
/// Nesting mode: list
/// </summary>
public class GoogleGkeBackupBackupPlanIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeBackupBackupPlanIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeBackupBackupPlanIamBindingConditionBlock>>? Condition { get; set; } = new();
