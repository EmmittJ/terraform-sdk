...
/// <summary>
/// Block type for condition in GoogleTagsTagValueIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagValueIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_tags_tag_value_iam_member Terraform resource.
/// Manages a google_tags_tag_value_iam_member resource.
/// </summary>
public partial class GoogleTagsTagValueIamMember(string name) : TerraformResource("google_tags_tag_value_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleTagsTagValueIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleTagsTagValueIamMemberConditionBlock>>("condition");
