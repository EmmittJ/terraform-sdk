...
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagValueIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleTagsTagValueIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleTagsTagValueIamMemberConditionBlock>>? Condition { get; set; } = new();
