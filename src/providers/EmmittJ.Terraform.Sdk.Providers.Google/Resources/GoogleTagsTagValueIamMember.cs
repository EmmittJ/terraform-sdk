...
/// Nesting mode: list
/// </summary>
public partial class GoogleTagsTagValueIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleTagsTagValueIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleTagsTagValueIamMemberConditionBlock> Condition { get; set; } = new();
