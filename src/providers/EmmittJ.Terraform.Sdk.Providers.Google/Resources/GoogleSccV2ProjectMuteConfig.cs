...
/// <summary>
/// Block type for timeouts in GoogleSccV2ProjectMuteConfig.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_v2_project_mute_config Terraform resource.
/// Manages a google_scc_v2_project_mute_config resource.
/// </summary>
public partial class GoogleSccV2ProjectMuteConfig(string name) : TerraformResource("google_scc_v2_project_mute_config", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleSccV2ProjectMuteConfigTimeoutsBlock>("timeouts");
