...
public partial class GoogleDiscoveryEngineLicenseConfigEndDateBlock() : TerraformBlock("end_date")
{
    ...
    public partial TerraformValue<double>? Day { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? Month { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? Year { get; set; }
...
public partial class GoogleDiscoveryEngineLicenseConfig : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? FreeTrial { get; set; }
    ...
    public required partial TerraformValue<string> LicenseConfigId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> LicenseCount { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SubscriptionTerm { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SubscriptionTier { get; set; }
