...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocClusterIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocClusterIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocClusterIamBindingConditionBlock>>? Condition { get; set; } = new();
