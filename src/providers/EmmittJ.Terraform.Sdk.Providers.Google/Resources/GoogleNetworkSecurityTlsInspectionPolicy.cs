...
public class GoogleNetworkSecurityTlsInspectionPolicy : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("ca_pool");
        SetOutput("custom_tls_features");
        SetOutput("description");
        SetOutput("exclude_public_ca_set");
        SetOutput("id");
        SetOutput("location");
        SetOutput("min_tls_version");
        SetOutput("name");
        SetOutput("project");
        SetOutput("tls_feature_profile");
    ...
    {
        get => GetRequiredOutput<List<TerraformProperty<string>>>("custom_tls_features");
        set => SetProperty("custom_tls_features", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<bool>>("exclude_public_ca_set");
        set => SetProperty("exclude_public_ca_set", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("tls_feature_profile");
        set => SetProperty("tls_feature_profile", value);
    }
