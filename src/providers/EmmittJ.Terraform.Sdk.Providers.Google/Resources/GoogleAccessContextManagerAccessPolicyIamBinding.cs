...
/// Nesting mode: list
/// </summary>
public partial class GoogleAccessContextManagerAccessPolicyIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleAccessContextManagerAccessPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleAccessContextManagerAccessPolicyIamBindingConditionBlock> Condition { get; set; } = new();
