...
public class GoogleCloudRunDomainMappingMetadataBlock : TerraformBlock
{
    ...
    {
        get => new TerraformReference<string>(this, "resource_version");
    }
...
public class GoogleCloudRunDomainMappingSpecBlock : TerraformBlock
{
    ...
    {
        get => new TerraformReference<bool>(this, "force_override");
    ...
    {
        get => new TerraformReference<string>(this, "route_name");
