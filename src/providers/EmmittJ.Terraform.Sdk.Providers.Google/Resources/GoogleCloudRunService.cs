...
public class GoogleCloudRunServiceMetadataBlock : TerraformBlock
{
    ...
    public TerraformValue<string> ResourceVersion
        => CreateReference("resource_version");
...
public class GoogleCloudRunServiceTemplateBlockSpecBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<double>>("container_concurrency") ?? CreateReference("container_concurrency");
    ...
    {
        get => GetArgument<TerraformValue<string>>("service_account_name") ?? CreateReference("service_account_name");
