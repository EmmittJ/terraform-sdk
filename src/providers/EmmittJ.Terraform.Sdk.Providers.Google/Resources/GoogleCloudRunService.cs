...
public class GoogleCloudRunServiceTemplateBlockSpecBlock : TerraformBlock
{
    ...
    {
        get => new TerraformReference<double>(this, "container_concurrency");
    ...
    {
        get => TerraformMap<string>.Lazy(ctx => new TerraformReference<TerraformMap<string>>(this, "node_selector").ResolveNodes(ctx));
    ...
    {
        get => new TerraformReference<string>(this, "serving_state");
    }
...
public class GoogleCloudRunServiceTemplateBlockSpecBlockVolumesBlockCsiBlock : TerraformBlock
{
    ...
    {
        get => TerraformMap<string>.Lazy(ctx => new TerraformReference<TerraformMap<string>>(this, "volume_attributes").ResolveNodes(ctx));
...
public class GoogleCloudRunServiceTrafficBlock : TerraformBlock
{
    ...
    {
        get => new TerraformReference<string>(this, "revision_name");
