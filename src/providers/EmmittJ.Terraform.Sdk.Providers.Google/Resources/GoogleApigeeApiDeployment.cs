...
/// Nesting mode: single
/// </summary>
public partial class GoogleApigeeApiDeploymentTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class GoogleApigeeApiDeployment : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ProxyId { get; set; }
    ...
    public GoogleApigeeApiDeploymentTimeoutsBlock Timeouts { get; set; } = new();
