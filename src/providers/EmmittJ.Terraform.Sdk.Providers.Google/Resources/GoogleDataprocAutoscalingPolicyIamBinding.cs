...
public partial class GoogleDataprocAutoscalingPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocAutoscalingPolicyIamBindingConditionBlock>>? Condition { get; set; }
