...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocAutoscalingPolicyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocAutoscalingPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocAutoscalingPolicyIamBindingConditionBlock>>? Condition { get; set; } = new();
