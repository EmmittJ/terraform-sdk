...
/// Nesting mode: single
/// </summary>
public partial class GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class GoogleGeminiGeminiGcpEnablementSettingBinding : TerraformResource
{
    ...
    [TerraformProperty("gemini_gcp_enablement_setting_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> GeminiGcpEnablementSettingId { get; set; }
    ...
    [TerraformProperty("setting_binding_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SettingBindingId { get; set; }
    ...
    public partial TerraformBlock<GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsBlock>? Timeouts { get; set; }
