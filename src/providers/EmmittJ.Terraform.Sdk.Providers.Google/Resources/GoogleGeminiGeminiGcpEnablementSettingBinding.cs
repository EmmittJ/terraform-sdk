...
/// Nesting mode: single
/// </summary>
public class GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class GoogleGeminiGeminiGcpEnablementSettingBinding : TerraformResource
{
    public GoogleGeminiGeminiGcpEnablementSettingBinding(string name) : base("google_gemini_gemini_gcp_enablement_setting_binding", name)
    {
    }
    ...
    public TerraformBlock<GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsBlock>? Timeouts { get; set; } = new();
