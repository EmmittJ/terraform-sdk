...
public partial class GoogleGeminiGeminiGcpEnablementSettingBinding : TerraformResource
{
    ...
    public required TerraformValue<string> GeminiGcpEnablementSettingId { get; set; }
    ...
    public TerraformBlock<GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsBlock>? Timeouts { get; set; }
