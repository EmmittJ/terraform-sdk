...
/// Nesting mode: list
/// </summary>
public class GoogleColabRuntimeTemplateIamMemberConditionBlock
{
    /// <summary>
...
public class GoogleColabRuntimeTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleColabRuntimeTemplateIamMemberConditionBlock>>? Condition { get; set; }
