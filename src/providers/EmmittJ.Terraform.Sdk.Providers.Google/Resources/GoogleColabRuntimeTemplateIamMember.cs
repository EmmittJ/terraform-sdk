...
/// Nesting mode: list
/// </summary>
public class GoogleColabRuntimeTemplateIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleColabRuntimeTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleColabRuntimeTemplateIamMemberConditionBlock>>? Condition { get; set; } = new();
