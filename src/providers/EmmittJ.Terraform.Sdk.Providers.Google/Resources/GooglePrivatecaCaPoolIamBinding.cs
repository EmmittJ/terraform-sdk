...
/// <summary>
/// Block type for condition in GooglePrivatecaCaPoolIamBinding.
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCaPoolIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_privateca_ca_pool_iam_binding Terraform resource.
/// Manages a google_privateca_ca_pool_iam_binding resource.
/// </summary>
public partial class GooglePrivatecaCaPoolIamBinding(string name) : TerraformResource("google_privateca_ca_pool_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GooglePrivatecaCaPoolIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GooglePrivatecaCaPoolIamBindingConditionBlock>>("condition");
