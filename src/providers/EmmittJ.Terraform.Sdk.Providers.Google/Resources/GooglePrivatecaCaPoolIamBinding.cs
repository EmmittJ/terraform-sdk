...
/// Nesting mode: list
/// </summary>
public class GooglePrivatecaCaPoolIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePrivatecaCaPoolIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePrivatecaCaPoolIamBindingConditionBlock>>? Condition { get; set; } = new();
