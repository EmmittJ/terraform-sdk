...
/// Nesting mode: list
/// </summary>
public partial class GooglePrivatecaCaPoolIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePrivatecaCaPoolIamBinding : TerraformResource
{
    ...
    public TerraformList<GooglePrivatecaCaPoolIamBindingConditionBlock> Condition { get; set; } = new();
