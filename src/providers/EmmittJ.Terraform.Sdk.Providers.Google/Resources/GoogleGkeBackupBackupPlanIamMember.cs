...
/// Nesting mode: list
/// </summary>
public class GoogleGkeBackupBackupPlanIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeBackupBackupPlanIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeBackupBackupPlanIamMemberConditionBlock>>? Condition { get; set; } = new();
