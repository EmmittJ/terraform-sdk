...
/// Nesting mode: list
/// </summary>
public class GoogleKmsEkmConnectionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleKmsEkmConnectionIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleKmsEkmConnectionIamBindingConditionBlock>>? Condition { get; set; } = new();
