...
public class GoogleServiceAccountKey : TerraformResource
{
    ...
    public TerraformMap<string>? Keepers { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? PrivateKeyType { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? PublicKeyData { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ValidAfter => new TerraformReference(this, "valid_after");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ValidBefore => new TerraformReference(this, "valid_before");
