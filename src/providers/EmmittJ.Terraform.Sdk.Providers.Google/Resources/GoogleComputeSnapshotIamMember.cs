...
/// Nesting mode: list
/// </summary>
public class GoogleComputeSnapshotIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeSnapshotIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeSnapshotIamMemberConditionBlock>>? Condition { get; set; } = new();
