...
/// <summary>
/// Block type for condition in GoogleIapAppEngineVersionIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_iap_app_engine_version_iam_member Terraform resource.
/// Manages a google_iap_app_engine_version_iam_member resource.
/// </summary>
public partial class GoogleIapAppEngineVersionIamMember(string name) : TerraformResource("google_iap_app_engine_version_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIapAppEngineVersionIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapAppEngineVersionIamMemberConditionBlock>>("condition");
