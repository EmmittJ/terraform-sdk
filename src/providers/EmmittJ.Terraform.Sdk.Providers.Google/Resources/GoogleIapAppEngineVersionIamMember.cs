...
public partial class GoogleIapAppEngineVersionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapAppEngineVersionIamMemberConditionBlock>>? Condition { get; set; }
