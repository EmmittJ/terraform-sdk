...
/// Nesting mode: single
/// </summary>
public partial class GoogleBigtableLogicalViewTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleBigtableLogicalView : TerraformResource
{
    ...
    public required partial TerraformValue<string> LogicalViewId { get; set; }
    ...
    public GoogleBigtableLogicalViewTimeoutsBlock Timeouts { get; set; } = new();
