...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubFeatureIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubFeatureIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubFeatureIamBindingConditionBlock>>? Condition { get; set; } = new();
