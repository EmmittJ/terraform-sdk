...
/// <summary>
/// Block type for condition in GoogleServiceAccountIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleServiceAccountIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_service_account_iam_binding Terraform resource.
/// Manages a google_service_account_iam_binding resource.
/// </summary>
public partial class GoogleServiceAccountIamBinding(string name) : TerraformResource("google_service_account_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleServiceAccountIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleServiceAccountIamBindingConditionBlock>>("condition");
