...
/// Nesting mode: list
/// </summary>
public partial class GoogleServiceAccountIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleServiceAccountIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleServiceAccountIamBindingConditionBlock> Condition { get; set; } = new();
