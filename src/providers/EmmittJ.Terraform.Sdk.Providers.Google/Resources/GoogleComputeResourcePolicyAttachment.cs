...
/// Nesting mode: single
/// </summary>
public class GoogleComputeResourcePolicyAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeResourcePolicyAttachment : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeResourcePolicyAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
