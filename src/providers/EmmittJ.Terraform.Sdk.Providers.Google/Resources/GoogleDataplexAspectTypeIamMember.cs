...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexAspectTypeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexAspectTypeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexAspectTypeIamMemberConditionBlock>>? Condition { get; set; } = new();
