...
/// Nesting mode: list
/// </summary>
public partial class GoogleEndpointsServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleEndpointsServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleEndpointsServiceIamBindingConditionBlock> Condition { get; set; } = new();
