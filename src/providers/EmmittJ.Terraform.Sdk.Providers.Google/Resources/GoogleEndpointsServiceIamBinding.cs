...
/// Nesting mode: list
/// </summary>
public class GoogleEndpointsServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEndpointsServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleEndpointsServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
