...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataFusionInstanceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataFusionInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataFusionInstanceIamMemberConditionBlock> Condition { get; set; } = new();
