...
/// Nesting mode: list
/// </summary>
public class GoogleDataFusionInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataFusionInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataFusionInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
