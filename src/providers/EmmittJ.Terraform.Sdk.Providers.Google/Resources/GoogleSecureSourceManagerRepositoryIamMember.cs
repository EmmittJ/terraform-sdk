...
/// Nesting mode: list
/// </summary>
public class GoogleSecureSourceManagerRepositoryIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecureSourceManagerRepositoryIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecureSourceManagerRepositoryIamMemberConditionBlock>>? Condition { get; set; } = new();
