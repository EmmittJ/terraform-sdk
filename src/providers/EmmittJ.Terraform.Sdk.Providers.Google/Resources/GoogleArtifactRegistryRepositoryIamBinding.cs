...
public class GoogleArtifactRegistryRepositoryIamBinding : TerraformResource
{
    ...
    public List<GoogleArtifactRegistryRepositoryIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleArtifactRegistryRepositoryIamBindingConditionBlock>>("condition");
