...
/// Nesting mode: list
/// </summary>
public class GoogleArtifactRegistryRepositoryIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleArtifactRegistryRepositoryIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleArtifactRegistryRepositoryIamBindingConditionBlock>>? Condition { get; set; } = new();
