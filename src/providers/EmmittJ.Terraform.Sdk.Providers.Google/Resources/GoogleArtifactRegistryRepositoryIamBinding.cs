...
/// Nesting mode: list
/// </summary>
public partial class GoogleArtifactRegistryRepositoryIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleArtifactRegistryRepositoryIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleArtifactRegistryRepositoryIamBindingConditionBlock> Condition { get; set; } = new();
