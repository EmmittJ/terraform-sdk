...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstantSnapshotIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstantSnapshotIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstantSnapshotIamMemberConditionBlock>>? Condition { get; set; } = new();
