...
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctions2FunctionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudfunctions2FunctionIamMember : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> CloudFunction { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleCloudfunctions2FunctionIamMemberConditionBlock>>? Condition { get; set; } = new();
