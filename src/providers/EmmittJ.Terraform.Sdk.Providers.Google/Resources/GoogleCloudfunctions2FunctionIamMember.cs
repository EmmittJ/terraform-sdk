...
/// <summary>
/// Block type for condition in GoogleCloudfunctions2FunctionIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleCloudfunctions2FunctionIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_cloudfunctions2_function_iam_member Terraform resource.
/// Manages a google_cloudfunctions2_function_iam_member resource.
/// </summary>
public partial class GoogleCloudfunctions2FunctionIamMember(string name) : TerraformResource("google_cloudfunctions2_function_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleCloudfunctions2FunctionIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleCloudfunctions2FunctionIamMemberConditionBlock>>("condition");
