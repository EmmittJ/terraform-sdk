...
public partial class GoogleBigqueryConnectionAzureBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<string> CustomerTenantId { get; set; }
    ...
    public partial TerraformValue<string>? FederatedApplicationClientId { get; set; }
...
public partial class GoogleBigqueryConnectionCloudSpannerBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DatabaseRole { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxParallelism { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? UseDataBoost { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? UseParallelism { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? UseServerlessAnalytics { get; set; }
...
public partial class GoogleBigqueryConnection : TerraformResource
{
    ...
    public partial TerraformValue<bool> HasCredential { get; }
