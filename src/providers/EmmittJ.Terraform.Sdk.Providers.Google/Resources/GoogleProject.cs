...
/// Nesting mode: single
/// </summary>
public class GoogleProjectTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleProject : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AutoCreateNetwork { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? FolderId { get; set; }
    ...
    public TerraformBlock<GoogleProjectTimeoutsBlock>? Timeouts { get; set; } = new();
