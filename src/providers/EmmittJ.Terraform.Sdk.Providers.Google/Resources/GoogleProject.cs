...
/// Nesting mode: single
/// </summary>
public partial class GoogleProjectTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class GoogleProject : TerraformResource
{
    ...
    public GoogleProjectTimeoutsBlock Timeouts { get; set; } = new();
