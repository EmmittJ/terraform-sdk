...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateAdvancedMachineFeaturesBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<bool>> EnableNestedVirtualization { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "enable_nested_virtualization");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> EnableUefiNetworking { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "enable_uefi_networking");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> PerformanceMonitoringUnit { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "performance_monitoring_unit");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> TurboMode { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "turbo_mode");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> VisibleCoreCount { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "visible_core_count");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateAttachedDiskBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> DiskEncryptionKeyRaw { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "disk_encryption_key_raw");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> DiskEncryptionKeyRsa { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "disk_encryption_key_rsa");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> DiskEncryptionServiceAccount { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "disk_encryption_service_account");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> ForceAttach { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "force_attach");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateBootDiskBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> AutoDelete { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "auto_delete");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateConfidentialInstanceConfigBlock : ITerraformBlock
{
    /// <summary>
    /// 
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> ConfidentialInstanceType { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "confidential_instance_type");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> EnableConfidentialCompute { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "enable_confidential_compute");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateGuestAcceleratorBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateInstanceEncryptionKeyBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> KmsKeyServiceAccount { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "kms_key_service_account");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateNetworkInterfaceBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> NicType { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "nic_type");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> QueueCount { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "queue_count");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateNetworkPerformanceConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateParamsBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>> ResourceManagerTags { get; set; } = new TerraformReferenceProperty<Dictionary<string, TerraformProperty<string>>>("", "resource_manager_tags");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateReservationAffinityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateSchedulingBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> AutomaticRestart { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "automatic_restart");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> AvailabilityDomain { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "availability_domain");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> InstanceTerminationAction { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "instance_termination_action");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> MinNodeCpus { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "min_node_cpus");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> Preemptible { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "preemptible");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> TerminationTime { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "termination_time");
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateScratchDiskBlock : ITerraformBlock
{
    /// <summary>
    /// Name with which the attached disk is accessible under /dev/disk/by-id/
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateServiceAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceFromTemplateShieldedInstanceConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> EnableIntegrityMonitoring { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "enable_integrity_monitoring");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> EnableVtpm { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>("", "enable_vtpm");
...
/// Nesting mode: single
/// </summary>
public class GoogleComputeInstanceFromTemplateTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceFromTemplate : TerraformResource
{
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> AllowStoppingForUpdate { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "allow_stopping_for_update");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> CanIpForward { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "can_ip_forward");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> DesiredStatus { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "desired_status");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> EnableDisplay { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "enable_display");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> Hostname { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "hostname");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> KeyRevocationActionType { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "key_revocation_action_type");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> MachineType { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "machine_type");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> MetadataStartupScript { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "metadata_startup_script");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<List<TerraformProperty<string>>> ResourcePolicies { get; set; } = new TerraformReferenceProperty<List<TerraformProperty<string>>>(ResourceAddress, "resource_policies");
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SourceInstanceTemplate { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateAdvancedMachineFeaturesBlock>>? AdvancedMachineFeatures { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateAttachedDiskBlock>>? AttachedDisk { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateBootDiskBlock>>? BootDisk { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateConfidentialInstanceConfigBlock>>? ConfidentialInstanceConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateGuestAcceleratorBlock>>? GuestAccelerator { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateInstanceEncryptionKeyBlock>>? InstanceEncryptionKey { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateNetworkInterfaceBlock>>? NetworkInterface { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateNetworkPerformanceConfigBlock>>? NetworkPerformanceConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateParamsBlock>>? Params { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateReservationAffinityBlock>>? ReservationAffinity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateSchedulingBlock>>? Scheduling { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateScratchDiskBlock>>? ScratchDisk { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateServiceAccountBlock>>? ServiceAccount { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceFromTemplateShieldedInstanceConfigBlock>>? ShieldedInstanceConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleComputeInstanceFromTemplateTimeoutsBlock>? Timeouts { get; set; } = new();
