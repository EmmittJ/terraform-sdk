...
public partial class GoogleContainerAwsNodePoolKubeletConfigBlock : TerraformBlockBase
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> CpuCfsQuota { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? PodPidsLimit { get; set; }
...
public partial class GoogleContainerAwsNodePoolMaxPodsConstraintBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaxPodsPerNode { get; set; }
