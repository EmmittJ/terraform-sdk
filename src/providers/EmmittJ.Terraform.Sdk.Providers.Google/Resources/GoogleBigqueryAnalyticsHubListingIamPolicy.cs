...
/// <summary>
/// Represents a google_bigquery_analytics_hub_listing_iam_policy Terraform resource.
/// Manages a google_bigquery_analytics_hub_listing_iam_policy resource.
/// </summary>
public partial class GoogleBigqueryAnalyticsHubListingIamPolicy(string name) : TerraformResource("google_bigquery_analytics_hub_listing_iam_policy", name)
{
    /// <summary>
