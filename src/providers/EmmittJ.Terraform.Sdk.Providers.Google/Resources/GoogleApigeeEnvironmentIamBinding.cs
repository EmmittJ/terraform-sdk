...
/// <summary>
/// Block type for condition in GoogleApigeeEnvironmentIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_apigee_environment_iam_binding Terraform resource.
/// Manages a google_apigee_environment_iam_binding resource.
/// </summary>
public partial class GoogleApigeeEnvironmentIamBinding(string name) : TerraformResource("google_apigee_environment_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleApigeeEnvironmentIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleApigeeEnvironmentIamBindingConditionBlock>>("condition");
