...
/// Nesting mode: list
/// </summary>
public class GoogleApigeeEnvironmentIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleApigeeEnvironmentIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleApigeeEnvironmentIamBindingConditionBlock>>? Condition { get; set; } = new();
