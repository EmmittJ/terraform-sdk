...
/// Nesting mode: list
/// </summary>
public partial class GoogleApigeeEnvironmentIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleApigeeEnvironmentIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleApigeeEnvironmentIamBindingConditionBlock> Condition { get; set; } = new();
