...
/// </summary>
public partial class GoogleDataplexEntryGroup : TerraformResource
{
    ...
    public TerraformBlock<GoogleDataplexEntryGroupTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> TransferStatus { get; }
