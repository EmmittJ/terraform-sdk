...
/// Nesting mode: list
/// </summary>
public partial class GooglePubsubSubscriptionIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePubsubSubscriptionIamMember : TerraformResource
{
    ...
    public TerraformList<GooglePubsubSubscriptionIamMemberConditionBlock> Condition { get; set; } = new();
