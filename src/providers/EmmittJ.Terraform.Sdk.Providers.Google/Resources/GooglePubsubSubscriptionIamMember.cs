...
/// Nesting mode: list
/// </summary>
public class GooglePubsubSubscriptionIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubSubscriptionIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePubsubSubscriptionIamMemberConditionBlock>>? Condition { get; set; } = new();
