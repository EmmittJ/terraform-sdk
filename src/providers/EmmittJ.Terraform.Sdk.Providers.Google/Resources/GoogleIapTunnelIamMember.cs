...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelIamMemberConditionBlock>>? Condition { get; set; } = new();
