...
public class GoogleDataCatalogPolicyTagIamMember : TerraformResource
{
    ...
    public List<GoogleDataCatalogPolicyTagIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataCatalogPolicyTagIamMemberConditionBlock>>("condition");
