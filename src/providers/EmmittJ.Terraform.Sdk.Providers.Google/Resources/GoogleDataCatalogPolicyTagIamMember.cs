...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogPolicyTagIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogPolicyTagIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogPolicyTagIamMemberConditionBlock>>? Condition { get; set; } = new();
