...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkSecurityInterceptDeploymentGroupTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleNetworkSecurityInterceptDeploymentGroup : TerraformResource
{
    ...
    public required partial TerraformValue<string> InterceptDeploymentGroupId { get; set; }
    ...
    public GoogleNetworkSecurityInterceptDeploymentGroupTimeoutsBlock Timeouts { get; set; } = new();
