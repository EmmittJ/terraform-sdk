...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityInterceptDeploymentGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityInterceptDeploymentGroup : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> InterceptDeploymentGroupId { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityInterceptDeploymentGroupTimeoutsBlock>? Timeouts { get; set; } = new();
