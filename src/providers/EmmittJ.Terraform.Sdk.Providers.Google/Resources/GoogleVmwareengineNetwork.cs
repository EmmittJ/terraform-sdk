...
/// Nesting mode: single
/// </summary>
public partial class GoogleVmwareengineNetworkTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class GoogleVmwareengineNetwork : TerraformResource
{
    ...
    public GoogleVmwareengineNetworkTimeoutsBlock Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformProperty("vpc_networks")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> VpcNetworks { get; }
