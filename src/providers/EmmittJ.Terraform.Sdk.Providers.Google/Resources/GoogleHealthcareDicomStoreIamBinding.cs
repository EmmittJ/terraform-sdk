...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareDicomStoreIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareDicomStoreIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareDicomStoreIamBindingConditionBlock>>? Condition { get; set; } = new();
