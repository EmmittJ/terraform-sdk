...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareDicomStoreIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleHealthcareDicomStoreIamBinding : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DicomStoreId { get; set; }
    ...
    public partial TerraformList<TerraformBlock<GoogleHealthcareDicomStoreIamBindingConditionBlock>>? Condition { get; set; }
