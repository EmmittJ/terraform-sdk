...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareDicomStoreIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareDicomStoreIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareDicomStoreIamBindingConditionBlock> Condition { get; set; } = new();
