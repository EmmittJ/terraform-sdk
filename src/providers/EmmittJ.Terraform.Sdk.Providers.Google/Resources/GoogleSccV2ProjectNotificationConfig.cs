...
/// Nesting mode: list
/// </summary>
public partial class GoogleSccV2ProjectNotificationConfigStreamingConfigBlock() : TerraformBlock("streaming_config")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class GoogleSccV2ProjectNotificationConfigTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleSccV2ProjectNotificationConfig : TerraformResource
{
    ...
    public required TerraformList<GoogleSccV2ProjectNotificationConfigStreamingConfigBlock> StreamingConfig { get; set; } = new();
    ...
    public GoogleSccV2ProjectNotificationConfigTimeoutsBlock Timeouts { get; set; } = new();
