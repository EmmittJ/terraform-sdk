...
public class GoogleSccV2ProjectNotificationConfig : TerraformResource
{
    ...
    public List<GoogleSccV2ProjectNotificationConfigStreamingConfigBlock>? StreamingConfig
    {
        get => GetProperty<List<GoogleSccV2ProjectNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    {
        get => GetProperty<GoogleSccV2ProjectNotificationConfigTimeoutsBlock>("timeouts");
