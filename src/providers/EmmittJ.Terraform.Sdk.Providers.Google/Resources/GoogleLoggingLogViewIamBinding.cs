...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingLogViewIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingLogViewIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingLogViewIamBindingConditionBlock>>? Condition { get; set; } = new();
