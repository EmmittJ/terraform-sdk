...
public partial class GoogleLoggingLogViewIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingLogViewIamBindingConditionBlock>>? Condition { get; set; }
