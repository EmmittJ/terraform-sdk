...
/// <summary>
/// Block type for condition in GoogleSccSourceIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_scc_source_iam_binding Terraform resource.
/// Manages a google_scc_source_iam_binding resource.
/// </summary>
public partial class GoogleSccSourceIamBinding(string name) : TerraformResource("google_scc_source_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleSccSourceIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleSccSourceIamBindingConditionBlock>>("condition");
