...
/// Nesting mode: list
/// </summary>
public class GoogleSccSourceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccSourceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccSourceIamBindingConditionBlock>>? Condition { get; set; } = new();
