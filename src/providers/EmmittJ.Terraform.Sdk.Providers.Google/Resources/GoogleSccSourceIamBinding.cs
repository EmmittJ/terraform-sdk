...
/// Nesting mode: list
/// </summary>
public partial class GoogleSccSourceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSccSourceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleSccSourceIamBindingConditionBlock> Condition { get; set; } = new();
