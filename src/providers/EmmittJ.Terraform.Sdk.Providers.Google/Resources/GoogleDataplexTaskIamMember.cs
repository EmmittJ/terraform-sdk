...
/// <summary>
/// Block type for condition in GoogleDataplexTaskIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataplex_task_iam_member Terraform resource.
/// Manages a google_dataplex_task_iam_member resource.
/// </summary>
public partial class GoogleDataplexTaskIamMember(string name) : TerraformResource("google_dataplex_task_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataplexTaskIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexTaskIamMemberConditionBlock>>("condition");
