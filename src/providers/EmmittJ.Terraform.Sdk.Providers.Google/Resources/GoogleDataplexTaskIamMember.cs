...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexTaskIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexTaskIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexTaskIamMemberConditionBlock> Condition { get; set; } = new();
