...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexTaskIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexTaskIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexTaskIamMemberConditionBlock>>? Condition { get; set; } = new();
