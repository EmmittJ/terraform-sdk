...
/// Nesting mode: list
/// </summary>
public class GoogleServiceAccountIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleServiceAccountIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleServiceAccountIamMemberConditionBlock>>? Condition { get; set; } = new();
