...
/// Nesting mode: list
/// </summary>
public partial class GoogleServiceAccountIamMemberConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleServiceAccountIamMember : TerraformResource
{
    ...
    public partial TerraformList<TerraformBlock<GoogleServiceAccountIamMemberConditionBlock>>? Condition { get; set; }
