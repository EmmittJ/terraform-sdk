...
/// Nesting mode: list
/// </summary>
public partial class GoogleServiceAccountIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleServiceAccountIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleServiceAccountIamMemberConditionBlock> Condition { get; set; } = new();
