...
/// <summary>
/// Block type for condition in GoogleDataplexLakeIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexLakeIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_lake_iam_binding Terraform resource.
/// Manages a google_dataplex_lake_iam_binding resource.
/// </summary>
public partial class GoogleDataplexLakeIamBinding(string name) : TerraformResource("google_dataplex_lake_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDataplexLakeIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexLakeIamBindingConditionBlock>>("condition");
