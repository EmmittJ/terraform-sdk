...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexLakeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexLakeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexLakeIamBindingConditionBlock>>? Condition { get; set; } = new();
