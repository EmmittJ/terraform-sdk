...
public class GoogleDataplexLakeIamBinding : TerraformResource
{
    public GoogleDataplexLakeIamBinding(string name) : base("google_dataplex_lake_iam_binding", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleDataplexLakeIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleDataplexLakeIamBindingConditionBlock>>("condition");
