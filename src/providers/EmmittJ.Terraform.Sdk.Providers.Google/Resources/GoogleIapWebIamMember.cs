...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebIamMemberConditionBlock>>? Condition { get; set; } = new();
