...
/// <summary>
/// Represents a google_beyondcorp_security_gateway_application_iam_policy Terraform resource.
/// Manages a google_beyondcorp_security_gateway_application_iam_policy resource.
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayApplicationIamPolicy(string name) : TerraformResource("google_beyondcorp_security_gateway_application_iam_policy", name)
{
    /// <summary>
