...
/// <summary>
/// Block type for streaming_config in GoogleSccV2OrganizationNotificationConfig.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleSccV2OrganizationNotificationConfig.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_v2_organization_notification_config Terraform resource.
/// Manages a google_scc_v2_organization_notification_config resource.
/// </summary>
public partial class GoogleSccV2OrganizationNotificationConfig(string name) : TerraformResource("google_scc_v2_organization_notification_config", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleSccV2OrganizationNotificationConfigStreamingConfigBlock> StreamingConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleSccV2OrganizationNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    {
        get => GetArgument<GoogleSccV2OrganizationNotificationConfigTimeoutsBlock>("timeouts");
