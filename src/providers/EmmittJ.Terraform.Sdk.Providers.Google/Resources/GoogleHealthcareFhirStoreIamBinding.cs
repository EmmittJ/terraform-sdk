...
/// Nesting mode: list
/// </summary>
public partial class GoogleHealthcareFhirStoreIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleHealthcareFhirStoreIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleHealthcareFhirStoreIamBindingConditionBlock> Condition { get; set; } = new();
