...
/// Nesting mode: list
/// </summary>
public class GoogleHealthcareFhirStoreIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleHealthcareFhirStoreIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleHealthcareFhirStoreIamBindingConditionBlock>>? Condition { get; set; } = new();
