...
/// <summary>
/// Block type for timeouts in GoogleSccV2ProjectSccBigQueryExport.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_v2_project_scc_big_query_export Terraform resource.
/// Manages a google_scc_v2_project_scc_big_query_export resource.
/// </summary>
public partial class GoogleSccV2ProjectSccBigQueryExport(string name) : TerraformResource("google_scc_v2_project_scc_big_query_export", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleSccV2ProjectSccBigQueryExportTimeoutsBlock>("timeouts");
