...
/// Nesting mode: single
/// </summary>
public class GoogleOracleDatabaseOdbNetworkTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleOracleDatabaseOdbNetwork : TerraformResource
{
    ...
    public TerraformBlock<GoogleOracleDatabaseOdbNetworkTimeoutsBlock>? Timeouts { get; set; } = new();
