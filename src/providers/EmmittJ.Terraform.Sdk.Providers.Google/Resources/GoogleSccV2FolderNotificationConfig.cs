...
/// <summary>
/// Block type for streaming_config in GoogleSccV2FolderNotificationConfig.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleSccV2FolderNotificationConfig.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_v2_folder_notification_config Terraform resource.
/// Manages a google_scc_v2_folder_notification_config resource.
/// </summary>
public partial class GoogleSccV2FolderNotificationConfig(string name) : TerraformResource("google_scc_v2_folder_notification_config", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleSccV2FolderNotificationConfigStreamingConfigBlock> StreamingConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleSccV2FolderNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    {
        get => GetArgument<GoogleSccV2FolderNotificationConfigTimeoutsBlock>("timeouts");
