...
/// Nesting mode: single
/// </summary>
public class GoogleComputeHttpsHealthCheckTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeHttpsHealthCheck : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeHttpsHealthCheckTimeoutsBlock>? Timeouts { get; set; } = new();
