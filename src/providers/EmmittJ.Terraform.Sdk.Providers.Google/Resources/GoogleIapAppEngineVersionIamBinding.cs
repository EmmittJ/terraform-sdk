...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapAppEngineVersionIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapAppEngineVersionIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapAppEngineVersionIamBindingConditionBlock> Condition { get; set; } = new();
