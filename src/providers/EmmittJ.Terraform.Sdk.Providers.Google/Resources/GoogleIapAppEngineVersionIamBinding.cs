...
/// <summary>
/// Block type for condition in GoogleIapAppEngineVersionIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleIapAppEngineVersionIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_iap_app_engine_version_iam_binding Terraform resource.
/// Manages a google_iap_app_engine_version_iam_binding resource.
/// </summary>
public partial class GoogleIapAppEngineVersionIamBinding(string name) : TerraformResource("google_iap_app_engine_version_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIapAppEngineVersionIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapAppEngineVersionIamBindingConditionBlock>>("condition");
