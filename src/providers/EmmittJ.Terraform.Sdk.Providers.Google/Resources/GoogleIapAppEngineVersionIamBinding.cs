...
public class GoogleIapAppEngineVersionIamBinding : TerraformResource
{
    ...
    public List<GoogleIapAppEngineVersionIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleIapAppEngineVersionIamBindingConditionBlock>>("condition");
