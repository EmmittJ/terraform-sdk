...
/// Nesting mode: list
/// </summary>
public class GoogleIapSettingsAccessSettingsBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<List<TerraformProperty<string>>>? IdentitySources { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleIapSettingsApplicationSettingsBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? CookieDomain { get; set; }
...
/// Nesting mode: single
/// </summary>
public class GoogleIapSettingsTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapSettings : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapSettingsAccessSettingsBlock>>? AccessSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIapSettingsApplicationSettingsBlock>>? ApplicationSettings { get; set; } = new();
    ...
    public TerraformBlock<GoogleIapSettingsTimeoutsBlock>? Timeouts { get; set; } = new();
