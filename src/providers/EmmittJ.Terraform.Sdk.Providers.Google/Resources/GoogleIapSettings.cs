...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapSettingsAccessSettingsBlock() : TerraformBlock("access_settings")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapSettingsApplicationSettingsBlock() : TerraformBlock("application_settings")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class GoogleIapSettingsTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleIapSettings : TerraformResource
{
    ...
    public TerraformList<GoogleIapSettingsAccessSettingsBlock> AccessSettings { get; set; } = new();
    ...
    public TerraformList<GoogleIapSettingsApplicationSettingsBlock> ApplicationSettings { get; set; } = new();
    ...
    public GoogleIapSettingsTimeoutsBlock Timeouts { get; set; } = new();
