...
public partial class GoogleDeveloperConnectGitRepositoryLink(string name) : TerraformResource("google_developer_connect_git_repository_link", name)
{
    ...
    {
        get => new TerraformReference<string>(this, "clone_uri");
    ...
    {
        get => new TerraformReference<string>(this, "git_repository_link_id");
    ...
    {
        get => new TerraformReference<string>(this, "parent_connection");
