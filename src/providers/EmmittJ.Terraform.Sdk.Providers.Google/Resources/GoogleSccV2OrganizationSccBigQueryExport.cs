...
/// <summary>
/// Block type for timeouts in GoogleSccV2OrganizationSccBigQueryExport.
/// Nesting mode: single
/// </summary>
public class GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_scc_v2_organization_scc_big_query_export Terraform resource.
/// Manages a google_scc_v2_organization_scc_big_query_export resource.
/// </summary>
public partial class GoogleSccV2OrganizationSccBigQueryExport(string name) : TerraformResource("google_scc_v2_organization_scc_big_query_export", name)
{
    /// <summary>
    ...
    /// </summary>
    public GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock>("timeouts");
