...
/// Nesting mode: single
/// </summary>
public class GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccV2OrganizationSccBigQueryExport : TerraformResource
{
    ...
    public TerraformBlock<GoogleSccV2OrganizationSccBigQueryExportTimeoutsBlock>? Timeouts { get; set; } = new();
