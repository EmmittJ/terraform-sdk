...
public partial class GoogleDiscoveryEngineChatEngineChatEngineConfigBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<bool>? AllowCrossRegion { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DialogflowAgentToLink { get; set; }
...
public partial class GoogleDiscoveryEngineChatEngine : TerraformResource
{
    ...
    public partial TerraformList<object> ChatEngineMetadata { get; }
