...
/// <summary>
/// Block type for condition in GoogleGkeHubScopeIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubScopeIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gke_hub_scope_iam_member Terraform resource.
/// Manages a google_gke_hub_scope_iam_member resource.
/// </summary>
public partial class GoogleGkeHubScopeIamMember(string name) : TerraformResource("google_gke_hub_scope_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleGkeHubScopeIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleGkeHubScopeIamMemberConditionBlock>>("condition");
