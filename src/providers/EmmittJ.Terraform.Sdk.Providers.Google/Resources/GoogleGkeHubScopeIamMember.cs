...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubScopeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubScopeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubScopeIamMemberConditionBlock>>? Condition { get; set; } = new();
