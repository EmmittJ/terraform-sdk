...
/// <summary>
/// Block type for timeouts in GoogleSccProjectSccBigQueryExport.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_scc_project_scc_big_query_export Terraform resource.
/// Manages a google_scc_project_scc_big_query_export resource.
/// </summary>
public partial class GoogleSccProjectSccBigQueryExport(string name) : TerraformResource("google_scc_project_scc_big_query_export", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<GoogleSccProjectSccBigQueryExportTimeoutsBlock>("timeouts");
