...
/// <summary>
/// Block type for condition in GoogleFolderIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleFolderIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_folder_iam_binding Terraform resource.
/// Manages a google_folder_iam_binding resource.
/// </summary>
public partial class GoogleFolderIamBinding(string name) : TerraformResource("google_folder_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleFolderIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleFolderIamBindingConditionBlock>>("condition");
