...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
