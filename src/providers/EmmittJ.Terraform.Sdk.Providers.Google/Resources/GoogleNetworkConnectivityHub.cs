...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkConnectivityHubTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleNetworkConnectivityHub : TerraformResource
{
    ...
    public TerraformValue<bool> ExportPsc { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> PolicyMode { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> PresetTopology { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> RoutingVpcs { get; }
