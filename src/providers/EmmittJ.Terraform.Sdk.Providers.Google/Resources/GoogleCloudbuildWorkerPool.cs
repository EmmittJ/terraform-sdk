...
/// Nesting mode: list
/// </summary>
public class GoogleCloudbuildWorkerPoolNetworkConfigBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleCloudbuildWorkerPoolPrivateServiceConnectBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleCloudbuildWorkerPoolTimeoutsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleCloudbuildWorkerPoolWorkerConfigBlock
{
    /// <summary>
    ...
    public TerraformValue<bool> NoExternalIp { get; set; } = default!;
