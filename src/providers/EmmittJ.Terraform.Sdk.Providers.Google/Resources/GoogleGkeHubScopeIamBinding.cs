...
/// <summary>
/// Block type for condition in GoogleGkeHubScopeIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubScopeIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_gke_hub_scope_iam_binding Terraform resource.
/// Manages a google_gke_hub_scope_iam_binding resource.
/// </summary>
public partial class GoogleGkeHubScopeIamBinding(string name) : TerraformResource("google_gke_hub_scope_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleGkeHubScopeIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleGkeHubScopeIamBindingConditionBlock>>("condition");
