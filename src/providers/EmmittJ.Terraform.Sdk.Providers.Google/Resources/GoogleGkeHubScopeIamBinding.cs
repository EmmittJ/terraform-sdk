...
/// Nesting mode: list
/// </summary>
public class GoogleGkeHubScopeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeHubScopeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubScopeIamBindingConditionBlock>>? Condition { get; set; } = new();
