...
public partial class GoogleGkeHubScopeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeHubScopeIamBindingConditionBlock>>? Condition { get; set; }
