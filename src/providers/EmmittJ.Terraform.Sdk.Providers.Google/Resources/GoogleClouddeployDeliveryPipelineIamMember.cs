...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployDeliveryPipelineIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployDeliveryPipelineIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployDeliveryPipelineIamMemberConditionBlock>>? Condition { get; set; } = new();
