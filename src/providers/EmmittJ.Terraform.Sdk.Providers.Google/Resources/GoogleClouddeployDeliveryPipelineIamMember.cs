...
/// Nesting mode: list
/// </summary>
public partial class GoogleClouddeployDeliveryPipelineIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleClouddeployDeliveryPipelineIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleClouddeployDeliveryPipelineIamMemberConditionBlock> Condition { get; set; } = new();
