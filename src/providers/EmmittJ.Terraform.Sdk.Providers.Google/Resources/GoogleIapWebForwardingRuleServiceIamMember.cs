...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebForwardingRuleServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebForwardingRuleServiceIamMemberConditionBlock> Condition { get; set; } = new();
