...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebForwardingRuleServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebForwardingRuleServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebForwardingRuleServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
