...
/// Nesting mode: single
/// </summary>
public class GooglePubsubLiteReservationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubLiteReservation : TerraformResource
{
    ...
    public TerraformBlock<GooglePubsubLiteReservationTimeoutsBlock>? Timeouts { get; set; } = new();
