...
/// <summary>
/// Block type for condition in GoogleDataplexZoneIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexZoneIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_zone_iam_member Terraform resource.
/// Manages a google_dataplex_zone_iam_member resource.
/// </summary>
public partial class GoogleDataplexZoneIamMember(string name) : TerraformResource("google_dataplex_zone_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexZoneIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexZoneIamMemberConditionBlock>>("condition");
