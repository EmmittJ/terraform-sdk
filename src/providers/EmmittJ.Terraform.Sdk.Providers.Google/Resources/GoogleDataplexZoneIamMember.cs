...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexZoneIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexZoneIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexZoneIamMemberConditionBlock>>? Condition { get; set; } = new();
