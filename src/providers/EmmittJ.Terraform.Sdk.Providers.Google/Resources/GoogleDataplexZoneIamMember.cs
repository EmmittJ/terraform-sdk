...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexZoneIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexZoneIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexZoneIamMemberConditionBlock> Condition { get; set; } = new();
