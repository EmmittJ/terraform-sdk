...
/// <summary>
/// Block type for condition in GoogleIamOrganizationsPolicyBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for target in GoogleIamOrganizationsPolicyBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleIamOrganizationsPolicyBinding.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_iam_organizations_policy_binding Terraform resource.
/// Manages a google_iam_organizations_policy_binding resource.
/// </summary>
public partial class GoogleIamOrganizationsPolicyBinding(string name) : TerraformResource("google_iam_organizations_policy_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIamOrganizationsPolicyBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIamOrganizationsPolicyBindingConditionBlock>>("condition");
    ...
    public required TerraformList<GoogleIamOrganizationsPolicyBindingTargetBlock> Target
    {
        get => GetRequiredArgument<TerraformList<GoogleIamOrganizationsPolicyBindingTargetBlock>>("target");
    ...
    {
        get => GetArgument<GoogleIamOrganizationsPolicyBindingTimeoutsBlock>("timeouts");
