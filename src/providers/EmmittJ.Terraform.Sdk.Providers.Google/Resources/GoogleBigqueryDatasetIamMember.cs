...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatasetIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatasetIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatasetIamMemberConditionBlock>>? Condition { get; set; } = new();
