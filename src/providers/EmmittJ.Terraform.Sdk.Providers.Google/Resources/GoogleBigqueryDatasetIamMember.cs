...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryDatasetIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryDatasetIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryDatasetIamMemberConditionBlock> Condition { get; set; } = new();
