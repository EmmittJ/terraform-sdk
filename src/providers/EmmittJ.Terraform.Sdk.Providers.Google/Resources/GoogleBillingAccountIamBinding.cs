...
/// <summary>
/// Block type for condition in GoogleBillingAccountIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleBillingAccountIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_billing_account_iam_binding Terraform resource.
/// Manages a google_billing_account_iam_binding resource.
/// </summary>
public partial class GoogleBillingAccountIamBinding(string name) : TerraformResource("google_billing_account_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBillingAccountIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBillingAccountIamBindingConditionBlock>>("condition");
