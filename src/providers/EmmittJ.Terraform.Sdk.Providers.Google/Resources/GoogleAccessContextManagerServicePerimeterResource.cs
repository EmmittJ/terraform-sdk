...
/// <summary>
/// Block type for timeouts in GoogleAccessContextManagerServicePerimeterResource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_access_context_manager_service_perimeter_resource Terraform resource.
/// Manages a google_access_context_manager_service_perimeter_resource resource.
/// </summary>
public partial class GoogleAccessContextManagerServicePerimeterResource(string name) : TerraformResource("google_access_context_manager_service_perimeter_resource", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<GoogleAccessContextManagerServicePerimeterResourceTimeoutsBlock>("timeouts");
