...
/// Nesting mode: single
/// </summary>
public class GoogleAccessContextManagerServicePerimeterResourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleAccessContextManagerServicePerimeterResource : TerraformResource
{
    ...
    public TerraformBlock<GoogleAccessContextManagerServicePerimeterResourceTimeoutsBlock>? Timeouts { get; set; } = new();
