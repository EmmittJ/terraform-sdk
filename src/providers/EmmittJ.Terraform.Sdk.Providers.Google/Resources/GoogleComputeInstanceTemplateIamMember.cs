...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeInstanceTemplateIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeInstanceTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleComputeInstanceTemplateIamMemberConditionBlock> Condition { get; set; } = new();
