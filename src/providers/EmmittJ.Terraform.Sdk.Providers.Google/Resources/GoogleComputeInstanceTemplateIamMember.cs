...
public class GoogleComputeInstanceTemplateIamMember : TerraformResource
{
    ...
    public List<GoogleComputeInstanceTemplateIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleComputeInstanceTemplateIamMemberConditionBlock>>("condition");
