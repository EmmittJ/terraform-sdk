...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceTemplateIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceTemplateIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceTemplateIamMemberConditionBlock>>? Condition { get; set; } = new();
