...
/// Nesting mode: list
/// </summary>
public partial class GoogleSecureSourceManagerInstanceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSecureSourceManagerInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSecureSourceManagerInstanceIamMemberConditionBlock> Condition { get; set; } = new();
