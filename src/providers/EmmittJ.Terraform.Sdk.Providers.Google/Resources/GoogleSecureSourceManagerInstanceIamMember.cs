...
public class GoogleSecureSourceManagerInstanceIamMember : TerraformResource
{
    ...
    public List<GoogleSecureSourceManagerInstanceIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSecureSourceManagerInstanceIamMemberConditionBlock>>("condition");
