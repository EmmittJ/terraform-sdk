...
/// Nesting mode: list
/// </summary>
public class GoogleSecureSourceManagerInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecureSourceManagerInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecureSourceManagerInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
