...
public partial class GoogleSecureSourceManagerBranchRule : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AllowStaleReviews { get; set; }
    ...
    public required partial TerraformValue<string> BranchRuleId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> IncludePattern { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MinimumApprovalsCount { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MinimumReviewsCount { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RequireCommentsResolved { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RequireLinearHistory { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RequirePullRequest { get; set; }
