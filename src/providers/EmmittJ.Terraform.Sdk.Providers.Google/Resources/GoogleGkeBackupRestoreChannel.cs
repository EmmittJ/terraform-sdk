...
public partial class GoogleGkeBackupRestoreChannel : TerraformResource
{
    ...
    public required TerraformValue<string> DestinationProject { get; set; }
    ...
    public TerraformBlock<GoogleGkeBackupRestoreChannelTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> DestinationProjectId { get; }
