...
/// Nesting mode: list
/// </summary>
public class GoogleTagsTagKeyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleTagsTagKeyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleTagsTagKeyIamMemberConditionBlock>>? Condition { get; set; } = new();
