...
/// <summary>
/// Block type for condition in GoogleTagsTagKeyIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_tags_tag_key_iam_member Terraform resource.
/// Manages a google_tags_tag_key_iam_member resource.
/// </summary>
public partial class GoogleTagsTagKeyIamMember(string name) : TerraformResource("google_tags_tag_key_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleTagsTagKeyIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleTagsTagKeyIamMemberConditionBlock>>("condition");
