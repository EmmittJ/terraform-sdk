...
/// <summary>
/// Represents a google_iap_web_backend_service_iam_policy Terraform resource.
/// Manages a google_iap_web_backend_service_iam_policy resource.
/// </summary>
public partial class GoogleIapWebBackendServiceIamPolicy(string name) : TerraformResource("google_iap_web_backend_service_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
