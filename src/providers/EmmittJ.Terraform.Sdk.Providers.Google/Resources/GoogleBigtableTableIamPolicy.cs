...
/// <summary>
/// Represents a google_bigtable_table_iam_policy Terraform resource.
/// Manages a google_bigtable_table_iam_policy resource.
/// </summary>
public partial class GoogleBigtableTableIamPolicy(string name) : TerraformResource("google_bigtable_table_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
