...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexGlossaryIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexGlossaryIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexGlossaryIamMemberConditionBlock>>? Condition { get; set; } = new();
