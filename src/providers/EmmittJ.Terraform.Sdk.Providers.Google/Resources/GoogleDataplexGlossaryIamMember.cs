...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexGlossaryIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexGlossaryIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexGlossaryIamMemberConditionBlock> Condition { get; set; } = new();
