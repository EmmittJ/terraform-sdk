...
/// <summary>
/// Block type for timeouts in GoogleSccV2FolderSccBigQueryExport.
/// Nesting mode: single
/// </summary>
public class GoogleSccV2FolderSccBigQueryExportTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_scc_v2_folder_scc_big_query_export Terraform resource.
/// Manages a google_scc_v2_folder_scc_big_query_export resource.
/// </summary>
public partial class GoogleSccV2FolderSccBigQueryExport(string name) : TerraformResource("google_scc_v2_folder_scc_big_query_export", name)
{
    /// <summary>
    ...
    /// </summary>
    public GoogleSccV2FolderSccBigQueryExportTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleSccV2FolderSccBigQueryExportTimeoutsBlock>("timeouts");
