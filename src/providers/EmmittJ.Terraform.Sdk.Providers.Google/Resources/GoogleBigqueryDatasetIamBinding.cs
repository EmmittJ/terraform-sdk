...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatasetIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatasetIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatasetIamBindingConditionBlock>>? Condition { get; set; } = new();
