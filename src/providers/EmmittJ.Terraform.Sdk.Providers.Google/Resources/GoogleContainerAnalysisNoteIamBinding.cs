...
/// Nesting mode: list
/// </summary>
public partial class GoogleContainerAnalysisNoteIamBindingConditionBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleContainerAnalysisNoteIamBinding : TerraformResource
{
    public GoogleContainerAnalysisNoteIamBinding(string name) : base("google_container_analysis_note_iam_binding", name)
    {
    }
    ...
    public partial TerraformList<TerraformBlock<GoogleContainerAnalysisNoteIamBindingConditionBlock>>? Condition { get; set; }
