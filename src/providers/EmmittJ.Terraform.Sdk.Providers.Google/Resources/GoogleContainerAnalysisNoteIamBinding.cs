...
/// Nesting mode: list
/// </summary>
public class GoogleContainerAnalysisNoteIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleContainerAnalysisNoteIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleContainerAnalysisNoteIamBindingConditionBlock>>? Condition { get; set; } = new();
