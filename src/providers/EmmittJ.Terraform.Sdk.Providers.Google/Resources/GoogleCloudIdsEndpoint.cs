...
/// Nesting mode: single
/// </summary>
public partial class GoogleCloudIdsEndpointTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleCloudIdsEndpoint : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? ThreatExceptions { get; set; }
    ...
    public GoogleCloudIdsEndpointTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EndpointForwardingRule { get; }
