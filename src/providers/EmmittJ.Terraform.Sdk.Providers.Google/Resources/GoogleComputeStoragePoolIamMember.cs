...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeStoragePoolIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeStoragePoolIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleComputeStoragePoolIamMemberConditionBlock> Condition { get; set; } = new();
