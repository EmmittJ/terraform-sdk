...
/// Nesting mode: list
/// </summary>
public class GoogleComputeStoragePoolIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeStoragePoolIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeStoragePoolIamMemberConditionBlock>>? Condition { get; set; } = new();
