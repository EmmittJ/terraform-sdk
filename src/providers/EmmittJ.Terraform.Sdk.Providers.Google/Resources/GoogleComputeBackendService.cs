...
public class GoogleComputeBackendServiceSecuritySettingsBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformList<string>>("subject_alt_names");
...
public class GoogleComputeBackendServiceSecuritySettingsBlockAwsV4AuthenticationBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("access_key_version");
...
public class GoogleComputeBackendServiceTlsSettingsBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("authentication_config");
...
public class GoogleComputeBackendServiceTlsSettingsBlockSubjectAltNamesBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("uniform_resource_identifier");
...
public partial class GoogleComputeBackendService(string name) : TerraformResource("google_compute_backend_service", name)
{
    ...
    {
        get => GetArgument<TerraformSet<string>>("custom_request_headers");
    ...
    {
        get => GetArgument<TerraformSet<string>>("custom_response_headers");
    ...
    {
        get => GetArgument<TerraformValue<string>>("external_managed_migration_state");
    ...
    {
        get => GetArgument<TerraformValue<double>>("external_managed_migration_testing_percentage");
    ...
    {
        get => GetArgument<TerraformValue<string>>("service_lb_policy");
