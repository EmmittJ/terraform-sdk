...
/// Nesting mode: list
/// </summary>
public class GoogleContainerAnalysisNoteIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleContainerAnalysisNoteIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleContainerAnalysisNoteIamMemberConditionBlock>>? Condition { get; set; } = new();
