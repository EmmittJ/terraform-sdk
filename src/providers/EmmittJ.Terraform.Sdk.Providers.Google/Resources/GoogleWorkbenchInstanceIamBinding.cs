...
/// Nesting mode: list
/// </summary>
public class GoogleWorkbenchInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleWorkbenchInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleWorkbenchInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
