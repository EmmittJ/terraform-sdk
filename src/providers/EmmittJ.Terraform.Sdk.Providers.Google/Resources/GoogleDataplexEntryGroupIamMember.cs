...
/// <summary>
/// Block type for condition in GoogleDataplexEntryGroupIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryGroupIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_entry_group_iam_member Terraform resource.
/// Manages a google_dataplex_entry_group_iam_member resource.
/// </summary>
public partial class GoogleDataplexEntryGroupIamMember(string name) : TerraformResource("google_dataplex_entry_group_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexEntryGroupIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexEntryGroupIamMemberConditionBlock>>("condition");
