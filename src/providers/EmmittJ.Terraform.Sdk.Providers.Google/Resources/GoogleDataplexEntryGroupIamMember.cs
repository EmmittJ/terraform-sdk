...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryGroupIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexEntryGroupIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexEntryGroupIamMemberConditionBlock>>? Condition { get; set; } = new();
