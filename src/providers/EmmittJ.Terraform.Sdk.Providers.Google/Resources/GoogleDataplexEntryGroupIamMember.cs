...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataplexEntryGroupIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataplexEntryGroupIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDataplexEntryGroupIamMemberConditionBlock> Condition { get; set; } = new();
