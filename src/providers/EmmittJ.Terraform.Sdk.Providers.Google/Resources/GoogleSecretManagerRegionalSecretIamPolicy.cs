...
/// <summary>
/// Represents a google_secret_manager_regional_secret_iam_policy Terraform resource.
/// Manages a google_secret_manager_regional_secret_iam_policy resource.
/// </summary>
public partial class GoogleSecretManagerRegionalSecretIamPolicy(string name) : TerraformResource("google_secret_manager_regional_secret_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
