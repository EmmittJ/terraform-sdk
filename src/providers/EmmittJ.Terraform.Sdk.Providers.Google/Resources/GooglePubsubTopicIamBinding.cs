...
/// Nesting mode: list
/// </summary>
public partial class GooglePubsubTopicIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePubsubTopicIamBinding : TerraformResource
{
    ...
    public TerraformList<GooglePubsubTopicIamBindingConditionBlock> Condition { get; set; } = new();
