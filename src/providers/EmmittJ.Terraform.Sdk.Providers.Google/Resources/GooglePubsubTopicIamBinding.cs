...
/// Nesting mode: list
/// </summary>
public class GooglePubsubTopicIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubTopicIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePubsubTopicIamBindingConditionBlock>>? Condition { get; set; } = new();
