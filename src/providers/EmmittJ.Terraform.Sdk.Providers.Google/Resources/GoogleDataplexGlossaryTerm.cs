...
/// Nesting mode: single
/// </summary>
public class GoogleDataplexGlossaryTermTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexGlossaryTerm : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("term_id")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? TermId { get; set; }
    ...
    public TerraformBlock<GoogleDataplexGlossaryTermTimeoutsBlock>? Timeouts { get; set; } = new();
