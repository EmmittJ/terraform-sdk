...
/// Nesting mode: list
/// </summary>
public class GoogleGeminiRepositoryGroupIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiRepositoryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGeminiRepositoryGroupIamBindingConditionBlock>>? Condition { get; set; } = new();
