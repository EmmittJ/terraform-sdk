...
/// Nesting mode: list
/// </summary>
public partial class GoogleGeminiRepositoryGroupIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleGeminiRepositoryGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleGeminiRepositoryGroupIamBindingConditionBlock> Condition { get; set; } = new();
