...
/// Nesting mode: single
/// </summary>
public class GoogleMonitoringMonitoredProjectTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleMonitoringMonitoredProject : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> MetricsScope { get; set; }
    ...
    public TerraformBlock<GoogleMonitoringMonitoredProjectTimeoutsBlock>? Timeouts { get; set; } = new();
