...
/// Nesting mode: list
/// </summary>
public class GoogleOrganizationIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleOrganizationIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleOrganizationIamBindingConditionBlock>>? Condition { get; set; } = new();
