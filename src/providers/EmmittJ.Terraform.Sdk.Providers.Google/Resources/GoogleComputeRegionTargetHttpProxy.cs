...
/// Nesting mode: single
/// </summary>
public partial class GoogleComputeRegionTargetHttpProxyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleComputeRegionTargetHttpProxy : TerraformResource
{
    ...
    public GoogleComputeRegionTargetHttpProxyTimeoutsBlock Timeouts { get; set; } = new();
