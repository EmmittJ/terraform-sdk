...
/// Nesting mode: list
/// </summary>
public class GooglePubsubSchemaIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubSchemaIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePubsubSchemaIamBindingConditionBlock>>? Condition { get; set; } = new();
