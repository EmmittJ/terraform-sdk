...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebTypeAppEngineIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebTypeAppEngineIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebTypeAppEngineIamBindingConditionBlock>>? Condition { get; set; } = new();
