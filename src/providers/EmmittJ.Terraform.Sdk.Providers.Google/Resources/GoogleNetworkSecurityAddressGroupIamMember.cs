...
/// Nesting mode: list
/// </summary>
public class GoogleNetworkSecurityAddressGroupIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityAddressGroupIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNetworkSecurityAddressGroupIamMemberConditionBlock>>? Condition { get; set; } = new();
