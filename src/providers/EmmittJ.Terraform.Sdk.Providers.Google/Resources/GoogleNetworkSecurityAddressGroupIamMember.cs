...
/// Nesting mode: list
/// </summary>
public partial class GoogleNetworkSecurityAddressGroupIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleNetworkSecurityAddressGroupIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleNetworkSecurityAddressGroupIamMemberConditionBlock> Condition { get; set; } = new();
