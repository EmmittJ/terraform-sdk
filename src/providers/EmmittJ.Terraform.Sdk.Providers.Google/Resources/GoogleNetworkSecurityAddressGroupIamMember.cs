...
public class GoogleNetworkSecurityAddressGroupIamMember : TerraformResource
{
    ...
    public List<GoogleNetworkSecurityAddressGroupIamMemberConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleNetworkSecurityAddressGroupIamMemberConditionBlock>>("condition");
