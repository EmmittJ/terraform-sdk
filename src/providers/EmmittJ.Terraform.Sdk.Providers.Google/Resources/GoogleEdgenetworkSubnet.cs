...
/// Nesting mode: single
/// </summary>
public class GoogleEdgenetworkSubnetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEdgenetworkSubnet : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? Ipv4Cidr { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? Ipv6Cidr { get; set; }
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> VlanId { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>(ResourceAddress, "vlan_id");
    ...
    public TerraformBlock<GoogleEdgenetworkSubnetTimeoutsBlock>? Timeouts { get; set; } = new();
