...
public partial class GoogleNetappStoragePool : TerraformResource
{
    ...
    public TerraformValue<bool> CustomPerformanceEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> TotalIops { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> TotalThroughputMibps { get; set; }
    ...
    public TerraformValue<double> AvailableThroughputMibps { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ColdTierSizeUsedGib { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> VolumeCapacityGib { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> VolumeCount { get; }
