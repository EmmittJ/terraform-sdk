...
/// Nesting mode: list
/// </summary>
public class GoogleIamAccessBoundaryPolicyRulesBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleIamAccessBoundaryPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIamAccessBoundaryPolicy : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIamAccessBoundaryPolicyRulesBlock>>? Rules { get; set; } = new();
    ...
    public TerraformBlock<GoogleIamAccessBoundaryPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
