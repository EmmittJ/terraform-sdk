...
/// Nesting mode: list
/// </summary>
public class GoogleIamAccessBoundaryPolicyRulesBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleIamAccessBoundaryPolicyTimeoutsBlock
{
    /// <summary>
...
public class GoogleIamAccessBoundaryPolicy : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIamAccessBoundaryPolicyRulesBlock>>? Rules { get; set; }
    ...
    public TerraformBlock<GoogleIamAccessBoundaryPolicyTimeoutsBlock>? Timeouts { get; set; }
