...
/// Nesting mode: list
/// </summary>
public class GoogleKmsCryptoKeyIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleKmsCryptoKeyIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleKmsCryptoKeyIamMemberConditionBlock>>? Condition { get; set; } = new();
