...
/// Nesting mode: list
/// </summary>
public partial class GoogleKmsCryptoKeyIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleKmsCryptoKeyIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleKmsCryptoKeyIamMemberConditionBlock> Condition { get; set; } = new();
