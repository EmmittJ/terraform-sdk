...
/// <summary>
/// Block type for condition in GoogleKmsCryptoKeyIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_kms_crypto_key_iam_member Terraform resource.
/// Manages a google_kms_crypto_key_iam_member resource.
/// </summary>
public partial class GoogleKmsCryptoKeyIamMember(string name) : TerraformResource("google_kms_crypto_key_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleKmsCryptoKeyIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleKmsCryptoKeyIamMemberConditionBlock>>("condition");
