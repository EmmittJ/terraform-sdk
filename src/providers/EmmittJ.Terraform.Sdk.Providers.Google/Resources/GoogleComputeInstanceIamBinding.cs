...
public class GoogleComputeInstanceIamBinding : TerraformResource
{
    public GoogleComputeInstanceIamBinding(string name) : base("google_compute_instance_iam_binding", name)
    {
        InitializeOutputs();
    }
    ...
    public List<GoogleComputeInstanceIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleComputeInstanceIamBindingConditionBlock>>("condition");
