...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeInstanceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleComputeInstanceIamBindingConditionBlock> Condition { get; set; } = new();
