...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
