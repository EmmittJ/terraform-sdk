...
public class GoogleAccessContextManagerServicePerimeterIngressPolicy : TerraformResource
{
    ...
    public List<GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromBlock>? IngressFrom
    {
        get => GetProperty<List<GoogleAccessContextManagerServicePerimeterIngressPolicyIngressFromBlock>>("ingress_from");
    ...
    public List<GoogleAccessContextManagerServicePerimeterIngressPolicyIngressToBlock>? IngressTo
    {
        get => GetProperty<List<GoogleAccessContextManagerServicePerimeterIngressPolicyIngressToBlock>>("ingress_to");
    ...
    {
        get => GetProperty<GoogleAccessContextManagerServicePerimeterIngressPolicyTimeoutsBlock>("timeouts");
