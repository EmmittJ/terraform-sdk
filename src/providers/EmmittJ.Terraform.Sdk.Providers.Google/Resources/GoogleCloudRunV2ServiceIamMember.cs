...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunV2ServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunV2ServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunV2ServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
