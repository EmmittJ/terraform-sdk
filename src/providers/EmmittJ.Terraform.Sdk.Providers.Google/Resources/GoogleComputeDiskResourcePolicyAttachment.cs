...
/// Nesting mode: single
/// </summary>
public class GoogleComputeDiskResourcePolicyAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeDiskResourcePolicyAttachment : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeDiskResourcePolicyAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
