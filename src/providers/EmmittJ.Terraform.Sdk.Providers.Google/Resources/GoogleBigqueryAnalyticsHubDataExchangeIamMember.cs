...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryAnalyticsHubDataExchangeIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock> Condition { get; set; } = new();
