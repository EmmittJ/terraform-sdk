...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryAnalyticsHubDataExchangeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryAnalyticsHubDataExchangeIamMemberConditionBlock>>? Condition { get; set; } = new();
