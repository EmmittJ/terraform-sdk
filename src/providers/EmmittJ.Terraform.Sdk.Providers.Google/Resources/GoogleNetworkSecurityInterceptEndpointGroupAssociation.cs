...
public class GoogleNetworkSecurityInterceptEndpointGroupAssociation : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("id");
        SetOutput("intercept_endpoint_group");
        SetOutput("intercept_endpoint_group_association_id");
        SetOutput("labels");
        SetOutput("location");
        SetOutput("network");
        SetOutput("project");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("intercept_endpoint_group");
    ...
    /// </summary>
    public TerraformProperty<string> InterceptEndpointGroupAssociationId
    {
        get => GetRequiredOutput<TerraformProperty<string>>("intercept_endpoint_group_association_id");
        set => SetProperty("intercept_endpoint_group_association_id", value);
    }
