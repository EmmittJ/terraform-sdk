...
public class GoogleNetworkSecurityInterceptEndpointGroupAssociation : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        this.WithOutput("locations_details");
    ...
    {
        get => GetProperty<TerraformProperty<string>>("intercept_endpoint_group_association_id");
    ...
    {
        get => GetProperty<GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeoutsBlock>("timeouts");
