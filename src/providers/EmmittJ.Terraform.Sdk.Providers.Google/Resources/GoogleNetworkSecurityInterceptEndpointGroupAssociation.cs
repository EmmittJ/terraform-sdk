...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityInterceptEndpointGroupAssociation : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("intercept_endpoint_group_association_id")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? InterceptEndpointGroupAssociationId { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
