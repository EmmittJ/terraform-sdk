...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
