...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexAspectTypeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexAspectTypeIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> AspectTypeId { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleDataplexAspectTypeIamBindingConditionBlock>>? Condition { get; set; } = new();
