...
/// Nesting mode: list
/// </summary>
public class GoogleEventarcMessageBusLoggingConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleEventarcMessageBusTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEventarcMessageBus : TerraformResource
{
    ...
    [TerraformPropertyName("message_bus_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MessageBusId { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleEventarcMessageBusLoggingConfigBlock>>? LoggingConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleEventarcMessageBusTimeoutsBlock>? Timeouts { get; set; } = new();
