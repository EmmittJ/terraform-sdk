...
/// Nesting mode: single
/// </summary>
public partial class GoogleGeminiLoggingSettingBindingTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleGeminiLoggingSettingBinding : TerraformResource
{
    ...
    public GoogleGeminiLoggingSettingBindingTimeoutsBlock Timeouts { get; set; } = new();
