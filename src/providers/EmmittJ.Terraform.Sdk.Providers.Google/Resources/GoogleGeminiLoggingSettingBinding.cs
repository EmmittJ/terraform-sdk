...
/// Nesting mode: single
/// </summary>
public class GoogleGeminiLoggingSettingBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGeminiLoggingSettingBinding : TerraformResource
{
    ...
    [TerraformPropertyName("logging_setting_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> LoggingSettingId { get; set; }
    ...
    public TerraformBlock<GoogleGeminiLoggingSettingBindingTimeoutsBlock>? Timeouts { get; set; } = new();
