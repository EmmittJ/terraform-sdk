...
/// Nesting mode: list
/// </summary>
public partial class GooglePubsubTopicIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePubsubTopicIamMember : TerraformResource
{
    ...
    public TerraformList<GooglePubsubTopicIamMemberConditionBlock> Condition { get; set; } = new();
