...
/// Nesting mode: list
/// </summary>
public class GooglePubsubTopicIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubTopicIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GooglePubsubTopicIamMemberConditionBlock>>? Condition { get; set; } = new();
