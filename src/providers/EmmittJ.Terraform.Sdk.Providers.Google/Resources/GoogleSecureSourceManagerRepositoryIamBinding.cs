...
/// Nesting mode: list
/// </summary>
public class GoogleSecureSourceManagerRepositoryIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecureSourceManagerRepositoryIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecureSourceManagerRepositoryIamBindingConditionBlock>>? Condition { get; set; } = new();
