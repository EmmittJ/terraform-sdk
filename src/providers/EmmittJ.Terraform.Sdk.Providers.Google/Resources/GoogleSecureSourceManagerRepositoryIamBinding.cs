...
public class GoogleSecureSourceManagerRepositoryIamBinding : TerraformResource
{
    ...
    public List<GoogleSecureSourceManagerRepositoryIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSecureSourceManagerRepositoryIamBindingConditionBlock>>("condition");
