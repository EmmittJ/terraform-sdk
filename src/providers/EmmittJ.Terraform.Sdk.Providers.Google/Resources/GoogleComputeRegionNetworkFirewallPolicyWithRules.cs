...
public class GoogleComputeRegionNetworkFirewallPolicyWithRules : TerraformResource
{
    ...
    public List<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock>? Rule
    {
        get => GetProperty<List<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock>>("rule");
    ...
    {
        get => GetProperty<GoogleComputeRegionNetworkFirewallPolicyWithRulesTimeoutsBlock>("timeouts");
