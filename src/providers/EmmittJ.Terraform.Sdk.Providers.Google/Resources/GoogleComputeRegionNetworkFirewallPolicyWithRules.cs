...
/// <summary>
/// Block type for rule in GoogleComputeRegionNetworkFirewallPolicyWithRules.
/// Nesting mode: list
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
    ...
    public required TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlock> Match
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlock>>("match");
    ...
    /// </summary>
    public TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockTargetSecureTagBlock>? TargetSecureTag
    {
        get => GetArgument<TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockTargetSecureTagBlock>>("target_secure_tag");
...
/// <summary>
/// Block type for match in GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
    ...
    public required TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockLayer4ConfigBlock> Layer4Config
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockLayer4ConfigBlock>>("layer4_config");
    ...
    /// </summary>
    public TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockSrcSecureTagBlock>? SrcSecureTag
    {
        get => GetArgument<TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockSrcSecureTagBlock>>("src_secure_tag");
...
/// <summary>
/// Block type for layer4_config in GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockLayer4ConfigBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for src_secure_tag in GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockMatchBlockSrcSecureTagBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for target_secure_tag in GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlockTargetSecureTagBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleComputeRegionNetworkFirewallPolicyWithRules.
/// Nesting mode: single
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyWithRulesTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_compute_region_network_firewall_policy_with_rules Terraform resource.
/// Manages a google_compute_region_network_firewall_policy_with_rules resource.
/// </summary>
public partial class GoogleComputeRegionNetworkFirewallPolicyWithRules(string name) : TerraformResource("google_compute_region_network_firewall_policy_with_rules", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock> Rule
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeRegionNetworkFirewallPolicyWithRulesRuleBlock>>("rule");
    ...
    /// </summary>
    public GoogleComputeRegionNetworkFirewallPolicyWithRulesTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleComputeRegionNetworkFirewallPolicyWithRulesTimeoutsBlock>("timeouts");
