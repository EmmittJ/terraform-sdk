...
/// Nesting mode: list
/// </summary>
public partial class GoogleOrganizationIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleOrganizationIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleOrganizationIamMemberConditionBlock> Condition { get; set; } = new();
