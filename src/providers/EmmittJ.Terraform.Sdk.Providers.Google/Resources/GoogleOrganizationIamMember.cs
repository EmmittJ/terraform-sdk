...
/// Nesting mode: list
/// </summary>
public class GoogleOrganizationIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleOrganizationIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleOrganizationIamMemberConditionBlock>>? Condition { get; set; } = new();
