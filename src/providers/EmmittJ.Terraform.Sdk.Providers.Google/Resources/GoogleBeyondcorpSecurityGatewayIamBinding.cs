...
/// Nesting mode: list
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBeyondcorpSecurityGatewayIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock> Condition { get; set; } = new();
