...
/// <summary>
/// Block type for condition in GoogleBeyondcorpSecurityGatewayIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_beyondcorp_security_gateway_iam_binding Terraform resource.
/// Manages a google_beyondcorp_security_gateway_iam_binding resource.
/// </summary>
public partial class GoogleBeyondcorpSecurityGatewayIamBinding(string name) : TerraformResource("google_beyondcorp_security_gateway_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock>>("condition");
