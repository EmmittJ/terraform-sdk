...
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBeyondcorpSecurityGatewayIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBeyondcorpSecurityGatewayIamBindingConditionBlock>>? Condition { get; set; } = new();
