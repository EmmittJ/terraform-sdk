...
/// <summary>
/// Represents a google_dataplex_zone_iam_policy Terraform resource.
/// Manages a google_dataplex_zone_iam_policy resource.
/// </summary>
public partial class GoogleDataplexZoneIamPolicy(string name) : TerraformResource("google_dataplex_zone_iam_policy", name)
{
    /// <summary>
