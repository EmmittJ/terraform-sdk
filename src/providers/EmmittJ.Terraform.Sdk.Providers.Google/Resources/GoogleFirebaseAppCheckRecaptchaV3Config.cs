...
/// Nesting mode: single
/// </summary>
public partial class GoogleFirebaseAppCheckRecaptchaV3ConfigTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleFirebaseAppCheckRecaptchaV3Config : TerraformResource
{
    ...
    public GoogleFirebaseAppCheckRecaptchaV3ConfigTimeoutsBlock Timeouts { get; set; } = new();
