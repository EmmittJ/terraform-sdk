...
/// <summary>
/// Represents a google_artifact_registry_repository_iam_policy Terraform resource.
/// Manages a google_artifact_registry_repository_iam_policy resource.
/// </summary>
public partial class GoogleArtifactRegistryRepositoryIamPolicy(string name) : TerraformResource("google_artifact_registry_repository_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
