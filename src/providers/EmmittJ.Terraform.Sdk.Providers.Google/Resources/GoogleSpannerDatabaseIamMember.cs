...
/// <summary>
/// Block type for condition in GoogleSpannerDatabaseIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_spanner_database_iam_member Terraform resource.
/// Manages a google_spanner_database_iam_member resource.
/// </summary>
public partial class GoogleSpannerDatabaseIamMember(string name) : TerraformResource("google_spanner_database_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleSpannerDatabaseIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleSpannerDatabaseIamMemberConditionBlock>>("condition");
