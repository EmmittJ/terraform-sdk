...
/// Nesting mode: single
/// </summary>
public class GoogleEssentialContactsContactTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEssentialContactsContact : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> LanguageTag { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformProperty<List<TerraformProperty<string>>>? NotificationCategorySubscriptions { get; set; }
    ...
    public TerraformBlock<GoogleEssentialContactsContactTimeoutsBlock>? Timeouts { get; set; } = new();
