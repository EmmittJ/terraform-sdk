...
/// Nesting mode: list
/// </summary>
public class GoogleSccManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? Recommendation { get; set; }
...
/// Nesting mode: single
/// </summary>
public class GoogleSccManagementFolderSecurityHealthAnalyticsCustomModuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigBlock>>? CustomConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleSccManagementFolderSecurityHealthAnalyticsCustomModuleTimeoutsBlock>? Timeouts { get; set; } = new();
