...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployDeliveryPipelineIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployDeliveryPipelineIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployDeliveryPipelineIamBindingConditionBlock>>? Condition { get; set; } = new();
