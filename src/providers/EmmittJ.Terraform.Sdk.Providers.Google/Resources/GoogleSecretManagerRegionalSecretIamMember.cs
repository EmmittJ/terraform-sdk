...
/// Nesting mode: list
/// </summary>
public partial class GoogleSecretManagerRegionalSecretIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleSecretManagerRegionalSecretIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleSecretManagerRegionalSecretIamMemberConditionBlock> Condition { get; set; } = new();
