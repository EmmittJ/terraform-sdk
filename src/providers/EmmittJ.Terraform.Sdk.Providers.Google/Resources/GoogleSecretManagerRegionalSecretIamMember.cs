...
/// Nesting mode: list
/// </summary>
public class GoogleSecretManagerRegionalSecretIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecretManagerRegionalSecretIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecretManagerRegionalSecretIamMemberConditionBlock>>? Condition { get; set; } = new();
