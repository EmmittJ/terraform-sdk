...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogTagTemplateIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogTagTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogTagTemplateIamBindingConditionBlock>>? Condition { get; set; } = new();
