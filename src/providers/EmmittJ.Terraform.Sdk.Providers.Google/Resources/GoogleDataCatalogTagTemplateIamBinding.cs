...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogTagTemplateIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogTagTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogTagTemplateIamBindingConditionBlock> Condition { get; set; } = new();
