...
/// Nesting mode: list
/// </summary>
public class GoogleGkeBackupRestorePlanIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleGkeBackupRestorePlanIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleGkeBackupRestorePlanIamBindingConditionBlock>>? Condition { get; set; } = new();
