...
/// <summary>
/// Block type for condition in GoogleDnsManagedZoneIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dns_managed_zone_iam_member Terraform resource.
/// Manages a google_dns_managed_zone_iam_member resource.
/// </summary>
public partial class GoogleDnsManagedZoneIamMember(string name) : TerraformResource("google_dns_managed_zone_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDnsManagedZoneIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDnsManagedZoneIamMemberConditionBlock>>("condition");
