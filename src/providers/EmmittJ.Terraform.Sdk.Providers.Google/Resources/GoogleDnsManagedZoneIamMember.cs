...
/// Nesting mode: list
/// </summary>
public class GoogleDnsManagedZoneIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDnsManagedZoneIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDnsManagedZoneIamMemberConditionBlock>>? Condition { get; set; } = new();
