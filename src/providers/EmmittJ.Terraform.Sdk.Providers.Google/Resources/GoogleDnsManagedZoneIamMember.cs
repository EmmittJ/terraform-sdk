...
/// Nesting mode: list
/// </summary>
public partial class GoogleDnsManagedZoneIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDnsManagedZoneIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleDnsManagedZoneIamMemberConditionBlock> Condition { get; set; } = new();
