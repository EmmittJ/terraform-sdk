...
/// Nesting mode: list
/// </summary>
public class GoogleSccProjectNotificationConfigStreamingConfigBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleSccProjectNotificationConfigTimeoutsBlock
{
    /// <summary>
...
public class GoogleSccProjectNotificationConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccProjectNotificationConfigStreamingConfigBlock>>? StreamingConfig { get; set; }
    ...
    public TerraformBlock<GoogleSccProjectNotificationConfigTimeoutsBlock>? Timeouts { get; set; }
