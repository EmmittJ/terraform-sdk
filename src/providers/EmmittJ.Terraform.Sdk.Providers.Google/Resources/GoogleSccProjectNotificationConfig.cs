...
/// Nesting mode: list
/// </summary>
public class GoogleSccProjectNotificationConfigStreamingConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class GoogleSccProjectNotificationConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccProjectNotificationConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccProjectNotificationConfigStreamingConfigBlock>>? StreamingConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleSccProjectNotificationConfigTimeoutsBlock>? Timeouts { get; set; } = new();
