...
/// <summary>
/// Block type for streaming_config in GoogleSccProjectNotificationConfig.
/// Nesting mode: list
/// </summary>
public class GoogleSccProjectNotificationConfigStreamingConfigBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleSccProjectNotificationConfig.
/// Nesting mode: single
/// </summary>
public class GoogleSccProjectNotificationConfigTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_scc_project_notification_config Terraform resource.
/// Manages a google_scc_project_notification_config resource.
/// </summary>
public partial class GoogleSccProjectNotificationConfig(string name) : TerraformResource("google_scc_project_notification_config", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleSccProjectNotificationConfigStreamingConfigBlock> StreamingConfig
    {
        get => GetRequiredArgument<TerraformList<GoogleSccProjectNotificationConfigStreamingConfigBlock>>("streaming_config");
    ...
    /// </summary>
    public GoogleSccProjectNotificationConfigTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleSccProjectNotificationConfigTimeoutsBlock>("timeouts");
