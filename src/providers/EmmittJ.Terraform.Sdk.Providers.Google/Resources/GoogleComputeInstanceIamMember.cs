...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
