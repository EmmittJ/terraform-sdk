...
/// <summary>
/// Block type for condition in GoogleComputeInstanceIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_compute_instance_iam_member Terraform resource.
/// Manages a google_compute_instance_iam_member resource.
/// </summary>
public partial class GoogleComputeInstanceIamMember(string name) : TerraformResource("google_compute_instance_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleComputeInstanceIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleComputeInstanceIamMemberConditionBlock>>("condition");
