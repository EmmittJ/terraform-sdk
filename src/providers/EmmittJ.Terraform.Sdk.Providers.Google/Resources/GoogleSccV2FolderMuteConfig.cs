...
/// Nesting mode: single
/// </summary>
public class GoogleSccV2FolderMuteConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccV2FolderMuteConfig : TerraformResource
{
    ...
    public TerraformBlock<GoogleSccV2FolderMuteConfigTimeoutsBlock>? Timeouts { get; set; } = new();
