...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatapolicyDataPolicyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatapolicyDataPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatapolicyDataPolicyIamBindingConditionBlock>>? Condition { get; set; } = new();
