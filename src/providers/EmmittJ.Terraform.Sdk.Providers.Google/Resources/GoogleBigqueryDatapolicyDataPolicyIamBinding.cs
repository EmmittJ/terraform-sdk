...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryDatapolicyDataPolicyIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryDatapolicyDataPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryDatapolicyDataPolicyIamBindingConditionBlock> Condition { get; set; } = new();
