...
public partial class GoogleIdentityPlatformTenant(string name) : TerraformResource("google_identity_platform_tenant", name)
{
    ...
    {
        get => GetArgument<TerraformValue<bool>>("allow_password_signup");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("disable_auth");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("enable_email_link_signin");
