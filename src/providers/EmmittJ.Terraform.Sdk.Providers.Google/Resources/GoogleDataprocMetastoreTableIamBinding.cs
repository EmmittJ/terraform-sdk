...
/// <summary>
/// Block type for condition in GoogleDataprocMetastoreTableIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_dataproc_metastore_table_iam_binding Terraform resource.
/// Manages a google_dataproc_metastore_table_iam_binding resource.
/// </summary>
public partial class GoogleDataprocMetastoreTableIamBinding(string name) : TerraformResource("google_dataproc_metastore_table_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataprocMetastoreTableIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataprocMetastoreTableIamBindingConditionBlock>>("condition");
