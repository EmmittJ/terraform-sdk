...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreTableIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreTableIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreTableIamBindingConditionBlock>>? Condition { get; set; } = new();
