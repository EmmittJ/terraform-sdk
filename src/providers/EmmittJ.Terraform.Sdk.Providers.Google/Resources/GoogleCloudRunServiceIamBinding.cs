...
/// Nesting mode: list
/// </summary>
public class GoogleCloudRunServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudRunServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudRunServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
