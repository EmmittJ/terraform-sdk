...
/// Nesting mode: list
/// </summary>
public class GoogleEndpointsServiceConsumersIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEndpointsServiceConsumersIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleEndpointsServiceConsumersIamBindingConditionBlock>>? Condition { get; set; } = new();
