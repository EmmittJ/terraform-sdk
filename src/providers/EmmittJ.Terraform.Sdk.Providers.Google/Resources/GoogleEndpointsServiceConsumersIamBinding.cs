...
/// <summary>
/// Block type for condition in GoogleEndpointsServiceConsumersIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_endpoints_service_consumers_iam_binding Terraform resource.
/// Manages a google_endpoints_service_consumers_iam_binding resource.
/// </summary>
public partial class GoogleEndpointsServiceConsumersIamBinding(string name) : TerraformResource("google_endpoints_service_consumers_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleEndpointsServiceConsumersIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleEndpointsServiceConsumersIamBindingConditionBlock>>("condition");
