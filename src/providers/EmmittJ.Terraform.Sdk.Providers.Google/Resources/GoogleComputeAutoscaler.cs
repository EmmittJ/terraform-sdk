...
/// <summary>
/// Block type for autoscaling_policy in GoogleComputeAutoscaler.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlock : TerraformBlock
{
    ...
    public TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockCpuUtilizationBlock>? CpuUtilization
    {
        get => GetArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockCpuUtilizationBlock>>("cpu_utilization");
    ...
    public TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockLoadBalancingUtilizationBlock>? LoadBalancingUtilization
    {
        get => GetArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockLoadBalancingUtilizationBlock>>("load_balancing_utilization");
    ...
    /// </summary>
    public TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockMetricBlock>? Metric
    {
        get => GetArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockMetricBlock>>("metric");
    ...
    public TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlock>? ScaleInControl
    {
        get => GetArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlock>>("scale_in_control");
    ...
    /// </summary>
    public TerraformSet<GoogleComputeAutoscalerAutoscalingPolicyBlockScalingSchedulesBlock>? ScalingSchedules
    {
        get => GetArgument<TerraformSet<GoogleComputeAutoscalerAutoscalingPolicyBlockScalingSchedulesBlock>>("scaling_schedules");
...
/// <summary>
/// Block type for cpu_utilization in GoogleComputeAutoscalerAutoscalingPolicyBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockCpuUtilizationBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for load_balancing_utilization in GoogleComputeAutoscalerAutoscalingPolicyBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockLoadBalancingUtilizationBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for metric in GoogleComputeAutoscalerAutoscalingPolicyBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockMetricBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for scale_in_control in GoogleComputeAutoscalerAutoscalingPolicyBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
    ...
    public TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlockMaxScaledInReplicasBlock>? MaxScaledInReplicas
    {
        get => GetArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlockMaxScaledInReplicasBlock>>("max_scaled_in_replicas");
...
/// <summary>
/// Block type for max_scaled_in_replicas in GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlock.
/// Nesting mode: list
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockScaleInControlBlockMaxScaledInReplicasBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for scaling_schedules in GoogleComputeAutoscalerAutoscalingPolicyBlock.
/// Nesting mode: set
/// </summary>
public class GoogleComputeAutoscalerAutoscalingPolicyBlockScalingSchedulesBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleComputeAutoscaler.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a google_compute_autoscaler Terraform resource.
/// Manages a google_compute_autoscaler resource.
/// </summary>
public partial class GoogleComputeAutoscaler(string name) : TerraformResource("google_compute_autoscaler", name)
{
    /// <summary>
    ...
    public required TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlock> AutoscalingPolicy
    {
        get => GetRequiredArgument<TerraformList<GoogleComputeAutoscalerAutoscalingPolicyBlock>>("autoscaling_policy");
    ...
    {
        get => GetArgument<GoogleComputeAutoscalerTimeoutsBlock>("timeouts");
