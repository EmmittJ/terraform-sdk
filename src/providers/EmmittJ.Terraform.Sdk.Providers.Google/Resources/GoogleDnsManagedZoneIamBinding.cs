...
/// <summary>
/// Block type for condition in GoogleDnsManagedZoneIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDnsManagedZoneIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dns_managed_zone_iam_binding Terraform resource.
/// Manages a google_dns_managed_zone_iam_binding resource.
/// </summary>
public partial class GoogleDnsManagedZoneIamBinding(string name) : TerraformResource("google_dns_managed_zone_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleDnsManagedZoneIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDnsManagedZoneIamBindingConditionBlock>>("condition");
