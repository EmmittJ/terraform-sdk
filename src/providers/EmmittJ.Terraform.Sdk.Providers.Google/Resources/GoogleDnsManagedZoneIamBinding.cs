...
/// Nesting mode: list
/// </summary>
public class GoogleDnsManagedZoneIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDnsManagedZoneIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDnsManagedZoneIamBindingConditionBlock>>? Condition { get; set; } = new();
