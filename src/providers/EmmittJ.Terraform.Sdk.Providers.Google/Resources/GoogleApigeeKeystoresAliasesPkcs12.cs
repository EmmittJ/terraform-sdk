...
/// Nesting mode: single
/// </summary>
public partial class GoogleApigeeKeystoresAliasesPkcs12TimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleApigeeKeystoresAliasesPkcs12 : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> File { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Filehash { get; set; }
    ...
    public GoogleApigeeKeystoresAliasesPkcs12TimeoutsBlock Timeouts { get; set; } = new();
