...
/// Nesting mode: list
/// </summary>
public class GoogleDataCatalogTaxonomyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataCatalogTaxonomyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataCatalogTaxonomyIamBindingConditionBlock>>? Condition { get; set; } = new();
