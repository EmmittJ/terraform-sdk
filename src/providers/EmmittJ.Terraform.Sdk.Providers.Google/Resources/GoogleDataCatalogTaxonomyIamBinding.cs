...
/// Nesting mode: list
/// </summary>
public partial class GoogleDataCatalogTaxonomyIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleDataCatalogTaxonomyIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleDataCatalogTaxonomyIamBindingConditionBlock> Condition { get; set; } = new();
