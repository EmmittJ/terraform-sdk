...
/// Nesting mode: list
/// </summary>
public class GoogleOrgPolicyPolicyDryRunSpecBlock
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<bool>? Reset { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleOrgPolicyPolicySpecBlock
{
...
/// Nesting mode: single
/// </summary>
public class GoogleOrgPolicyPolicyTimeoutsBlock
{
    /// <summary>
...
public class GoogleOrgPolicyPolicy : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleOrgPolicyPolicyDryRunSpecBlock>>? DryRunSpec { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleOrgPolicyPolicySpecBlock>>? Spec { get; set; }
    ...
    public TerraformBlock<GoogleOrgPolicyPolicyTimeoutsBlock>? Timeouts { get; set; }
