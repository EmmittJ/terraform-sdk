...
/// Nesting mode: list
/// </summary>
public partial class GoogleWorkbenchInstanceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleWorkbenchInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleWorkbenchInstanceIamMemberConditionBlock> Condition { get; set; } = new();
