...
/// Nesting mode: list
/// </summary>
public class GoogleWorkbenchInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleWorkbenchInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleWorkbenchInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
