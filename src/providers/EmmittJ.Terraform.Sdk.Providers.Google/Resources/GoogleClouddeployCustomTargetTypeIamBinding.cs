...
/// Nesting mode: list
/// </summary>
public partial class GoogleClouddeployCustomTargetTypeIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleClouddeployCustomTargetTypeIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleClouddeployCustomTargetTypeIamBindingConditionBlock> Condition { get; set; } = new();
