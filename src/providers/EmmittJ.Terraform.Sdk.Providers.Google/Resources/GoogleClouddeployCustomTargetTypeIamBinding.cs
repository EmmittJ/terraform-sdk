...
/// Nesting mode: list
/// </summary>
public class GoogleClouddeployCustomTargetTypeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleClouddeployCustomTargetTypeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleClouddeployCustomTargetTypeIamBindingConditionBlock>>? Condition { get; set; } = new();
