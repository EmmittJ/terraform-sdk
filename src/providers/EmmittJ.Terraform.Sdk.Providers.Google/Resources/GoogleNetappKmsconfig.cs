...
/// Nesting mode: single
/// </summary>
public class GoogleNetappKmsconfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetappKmsconfig : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> CryptoKeyName { get; set; }
    ...
    public TerraformBlock<GoogleNetappKmsconfigTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformPropertyName("instructions")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> Instructions => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "instructions");
