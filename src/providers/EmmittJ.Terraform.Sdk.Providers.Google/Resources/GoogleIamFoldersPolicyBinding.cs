...
/// <summary>
/// Block type for condition in GoogleIamFoldersPolicyBinding.
/// Nesting mode: list
/// </summary>
public class GoogleIamFoldersPolicyBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for target in GoogleIamFoldersPolicyBinding.
/// Nesting mode: list
/// </summary>
public class GoogleIamFoldersPolicyBindingTargetBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in GoogleIamFoldersPolicyBinding.
/// Nesting mode: single
/// </summary>
public class GoogleIamFoldersPolicyBindingTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_iam_folders_policy_binding Terraform resource.
/// Manages a google_iam_folders_policy_binding resource.
/// </summary>
public partial class GoogleIamFoldersPolicyBinding(string name) : TerraformResource("google_iam_folders_policy_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIamFoldersPolicyBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIamFoldersPolicyBindingConditionBlock>>("condition");
    ...
    public required TerraformList<GoogleIamFoldersPolicyBindingTargetBlock> Target
    {
        get => GetRequiredArgument<TerraformList<GoogleIamFoldersPolicyBindingTargetBlock>>("target");
    ...
    /// </summary>
    public GoogleIamFoldersPolicyBindingTimeoutsBlock? Timeouts
    {
        get => GetArgument<GoogleIamFoldersPolicyBindingTimeoutsBlock>("timeouts");
