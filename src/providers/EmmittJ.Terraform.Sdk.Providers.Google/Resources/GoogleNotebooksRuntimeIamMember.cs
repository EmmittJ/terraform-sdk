...
/// Nesting mode: list
/// </summary>
public class GoogleNotebooksRuntimeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNotebooksRuntimeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNotebooksRuntimeIamMemberConditionBlock>>? Condition { get; set; } = new();
