...
/// <summary>
/// Block type for condition in GoogleNotebooksRuntimeIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleNotebooksRuntimeIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_notebooks_runtime_iam_member Terraform resource.
/// Manages a google_notebooks_runtime_iam_member resource.
/// </summary>
public partial class GoogleNotebooksRuntimeIamMember(string name) : TerraformResource("google_notebooks_runtime_iam_member", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GoogleNotebooksRuntimeIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleNotebooksRuntimeIamMemberConditionBlock>>("condition");
