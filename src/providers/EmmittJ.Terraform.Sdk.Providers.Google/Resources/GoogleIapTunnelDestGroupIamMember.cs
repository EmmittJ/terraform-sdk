...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapTunnelDestGroupIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapTunnelDestGroupIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapTunnelDestGroupIamMemberConditionBlock> Condition { get; set; } = new();
