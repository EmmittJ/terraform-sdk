...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelDestGroupIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelDestGroupIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelDestGroupIamMemberConditionBlock>>? Condition { get; set; } = new();
