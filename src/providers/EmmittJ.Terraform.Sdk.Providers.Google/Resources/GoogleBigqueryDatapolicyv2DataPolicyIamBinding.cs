...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryDatapolicyv2DataPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock> Condition { get; set; } = new();
