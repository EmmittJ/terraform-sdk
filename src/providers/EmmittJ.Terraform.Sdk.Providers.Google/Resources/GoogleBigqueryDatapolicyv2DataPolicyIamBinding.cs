...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryDatapolicyv2DataPolicyIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionBlock>>? Condition { get; set; } = new();
