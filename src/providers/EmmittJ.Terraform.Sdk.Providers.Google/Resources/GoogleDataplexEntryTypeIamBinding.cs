...
/// <summary>
/// Block type for condition in GoogleDataplexEntryTypeIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryTypeIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_dataplex_entry_type_iam_binding Terraform resource.
/// Manages a google_dataplex_entry_type_iam_binding resource.
/// </summary>
public partial class GoogleDataplexEntryTypeIamBinding(string name) : TerraformResource("google_dataplex_entry_type_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleDataplexEntryTypeIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleDataplexEntryTypeIamBindingConditionBlock>>("condition");
