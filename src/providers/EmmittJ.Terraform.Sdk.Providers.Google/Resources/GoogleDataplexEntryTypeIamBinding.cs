...
/// Nesting mode: list
/// </summary>
public class GoogleDataplexEntryTypeIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataplexEntryTypeIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataplexEntryTypeIamBindingConditionBlock>>? Condition { get; set; } = new();
