...
/// Nesting mode: list
/// </summary>
public class GoogleComputeInstanceTemplateIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeInstanceTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeInstanceTemplateIamBindingConditionBlock>>? Condition { get; set; } = new();
