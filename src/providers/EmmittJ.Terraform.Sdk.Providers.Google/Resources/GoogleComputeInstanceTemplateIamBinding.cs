...
/// Nesting mode: list
/// </summary>
public partial class GoogleComputeInstanceTemplateIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleComputeInstanceTemplateIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleComputeInstanceTemplateIamBindingConditionBlock> Condition { get; set; } = new();
