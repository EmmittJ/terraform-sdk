...
/// <summary>
/// Block type for condition in GooglePubsubSubscriptionIamBinding.
/// Nesting mode: list
/// </summary>
public class GooglePubsubSubscriptionIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_pubsub_subscription_iam_binding Terraform resource.
/// Manages a google_pubsub_subscription_iam_binding resource.
/// </summary>
public partial class GooglePubsubSubscriptionIamBinding(string name) : TerraformResource("google_pubsub_subscription_iam_binding", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<GooglePubsubSubscriptionIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GooglePubsubSubscriptionIamBindingConditionBlock>>("condition");
