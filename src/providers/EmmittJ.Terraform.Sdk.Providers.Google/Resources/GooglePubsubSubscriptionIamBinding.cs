...
/// Nesting mode: list
/// </summary>
public partial class GooglePubsubSubscriptionIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GooglePubsubSubscriptionIamBinding : TerraformResource
{
    ...
    public TerraformList<GooglePubsubSubscriptionIamBindingConditionBlock> Condition { get; set; } = new();
