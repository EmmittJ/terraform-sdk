...
/// Nesting mode: list
/// </summary>
public class GooglePubsubSubscriptionIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GooglePubsubSubscriptionIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Subscription { get; set; }
    ...
    public TerraformList<TerraformBlock<GooglePubsubSubscriptionIamBindingConditionBlock>>? Condition { get; set; } = new();
