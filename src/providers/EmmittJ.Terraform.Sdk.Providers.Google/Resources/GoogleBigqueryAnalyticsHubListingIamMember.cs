...
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryAnalyticsHubListingIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigqueryAnalyticsHubListingIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigqueryAnalyticsHubListingIamMemberConditionBlock>>? Condition { get; set; } = new();
