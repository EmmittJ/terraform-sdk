...
/// <summary>
/// Block type for condition in GoogleBigqueryAnalyticsHubListingIamMember.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_bigquery_analytics_hub_listing_iam_member Terraform resource.
/// Manages a google_bigquery_analytics_hub_listing_iam_member resource.
/// </summary>
public partial class GoogleBigqueryAnalyticsHubListingIamMember(string name) : TerraformResource("google_bigquery_analytics_hub_listing_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryAnalyticsHubListingIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryAnalyticsHubListingIamMemberConditionBlock>>("condition");
