...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreDatabaseIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreDatabaseIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreDatabaseIamMemberConditionBlock>>? Condition { get; set; } = new();
