...
/// Nesting mode: single
/// </summary>
public class GoogleComputeRegionNetworkFirewallPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeRegionNetworkFirewallPolicy : TerraformResource
{
    ...
    public TerraformBlock<GoogleComputeRegionNetworkFirewallPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> RegionNetworkFirewallPolicyId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "region_network_firewall_policy_id");
