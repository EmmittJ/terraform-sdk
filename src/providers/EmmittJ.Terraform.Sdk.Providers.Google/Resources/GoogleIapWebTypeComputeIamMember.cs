...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebTypeComputeIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebTypeComputeIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapWebTypeComputeIamMemberConditionBlock>>? Condition { get; set; } = new();
