...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebTypeComputeIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebTypeComputeIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebTypeComputeIamMemberConditionBlock> Condition { get; set; } = new();
