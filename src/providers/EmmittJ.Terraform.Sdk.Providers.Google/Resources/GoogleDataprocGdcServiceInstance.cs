...
public partial class GoogleDataprocGdcServiceInstanceGdceClusterBlock() : TerraformBlock("gdce_cluster")
{
    ...
    public required partial TerraformValue<string> GdceCluster { get; set; }
...
public partial class GoogleDataprocGdcServiceInstance : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ServiceInstanceId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EffectiveServiceAccount { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> RequestedState { get; }
