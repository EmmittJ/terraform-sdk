...
/// Nesting mode: list
/// </summary>
public class GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapWebRegionForwardingRuleServiceIamBinding : TerraformResource
{
    ...
    [TerraformPropertyName("forwarding_rule_region_service_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ForwardingRuleRegionServiceName { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock>>? Condition { get; set; } = new();
