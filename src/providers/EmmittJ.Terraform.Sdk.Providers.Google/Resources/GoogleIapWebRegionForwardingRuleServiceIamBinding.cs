...
/// <summary>
/// Block type for condition in GoogleIapWebRegionForwardingRuleServiceIamBinding.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_iap_web_region_forwarding_rule_service_iam_binding Terraform resource.
/// Manages a google_iap_web_region_forwarding_rule_service_iam_binding resource.
/// </summary>
public partial class GoogleIapWebRegionForwardingRuleServiceIamBinding(string name) : TerraformResource("google_iap_web_region_forwarding_rule_service_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock>>("condition");
