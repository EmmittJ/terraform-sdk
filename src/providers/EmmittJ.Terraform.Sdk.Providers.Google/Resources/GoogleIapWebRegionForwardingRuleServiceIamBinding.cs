...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapWebRegionForwardingRuleServiceIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapWebRegionForwardingRuleServiceIamBindingConditionBlock> Condition { get; set; } = new();
