...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkServicesMeshTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkServicesMesh : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? InterceptionPort { get; set; }
    ...
    public TerraformBlock<GoogleNetworkServicesMeshTimeoutsBlock>? Timeouts { get; set; } = new();
