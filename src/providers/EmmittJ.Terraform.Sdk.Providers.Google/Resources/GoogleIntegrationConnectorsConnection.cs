...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionAuthConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<string>>? AuthKey { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionConfigVariableBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? BooleanValue { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? IntegerValue { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionDestinationConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionEventingConfigBlock : ITerraformBlock
{
    /// <summary>
    /// Enrichment Enabled.
    /// </summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EnrichmentEnabled { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionLockConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<bool>> Locked { get; set; }
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionLogConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<string>> Level { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>("", "level");
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionNodeConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> MaxNodeCount { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "max_node_count");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<double>> MinNodeCount { get; set; } = new TerraformReferenceProperty<TerraformProperty<double>>("", "min_node_count");
...
/// Nesting mode: list
/// </summary>
public class GoogleIntegrationConnectorsConnectionSslConfigBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ClientCertType { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ServerCertType { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? TrustModel { get; set; }
...
/// Nesting mode: single
/// </summary>
public class GoogleIntegrationConnectorsConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIntegrationConnectorsConnection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ConnectorVersion { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? EventingEnablementType { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionAuthConfigBlock>>? AuthConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionConfigVariableBlock>>? ConfigVariable { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionDestinationConfigBlock>>? DestinationConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionEventingConfigBlock>>? EventingConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionLockConfigBlock>>? LockConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionLogConfigBlock>>? LogConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionNodeConfigBlock>>? NodeConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<GoogleIntegrationConnectorsConnectionSslConfigBlock>>? SslConfig { get; set; } = new();
    ...
    public TerraformBlock<GoogleIntegrationConnectorsConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<TerraformProperty<string>> ConnectionRevision => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "connection_revision");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> ConnectorVersionInfraConfig => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "connector_version_infra_config");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> ConnectorVersionLaunchStage => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "connector_version_launch_stage");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> EventingRuntimeData => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "eventing_runtime_data");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> ServiceDirectory => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "service_directory");
