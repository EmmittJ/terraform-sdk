...
/// Nesting mode: single
/// </summary>
public partial class GoogleComputeNetworkEndpointTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class GoogleComputeNetworkEndpoint : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> NetworkEndpointGroup { get; set; }
    ...
    public GoogleComputeNetworkEndpointTimeoutsBlock Timeouts { get; set; } = new();
