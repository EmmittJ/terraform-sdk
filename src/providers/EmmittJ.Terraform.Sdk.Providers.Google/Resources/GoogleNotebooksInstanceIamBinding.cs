...
/// Nesting mode: list
/// </summary>
public class GoogleNotebooksInstanceIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNotebooksInstanceIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleNotebooksInstanceIamBindingConditionBlock>>? Condition { get; set; } = new();
