...
/// Nesting mode: list
/// </summary>
public partial class GoogleLoggingFolderBucketConfigCmekSettingsBlock() : TerraformBlock("cmek_settings")
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public partial class GoogleLoggingFolderBucketConfigIndexConfigsBlock() : TerraformBlock("index_configs")
{
    /// <summary>
...
public partial class GoogleLoggingFolderBucketConfig : TerraformResource
{
    ...
    public TerraformList<GoogleLoggingFolderBucketConfigCmekSettingsBlock> CmekSettings { get; set; } = new();
    ...
    public TerraformSet<GoogleLoggingFolderBucketConfigIndexConfigsBlock> IndexConfigs { get; set; } = new();
