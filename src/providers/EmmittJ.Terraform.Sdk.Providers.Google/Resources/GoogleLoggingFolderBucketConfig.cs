...
/// Nesting mode: list
/// </summary>
public class GoogleLoggingFolderBucketConfigCmekSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class GoogleLoggingFolderBucketConfigIndexConfigsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingFolderBucketConfig : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleLoggingFolderBucketConfigCmekSettingsBlock>>? CmekSettings { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<GoogleLoggingFolderBucketConfigIndexConfigsBlock>>? IndexConfigs { get; set; } = new();
