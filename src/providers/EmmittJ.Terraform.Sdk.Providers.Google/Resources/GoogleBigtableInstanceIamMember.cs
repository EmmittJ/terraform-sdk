...
/// Nesting mode: list
/// </summary>
public class GoogleBigtableInstanceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBigtableInstanceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBigtableInstanceIamMemberConditionBlock>>? Condition { get; set; } = new();
