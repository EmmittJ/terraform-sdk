...
/// Nesting mode: list
/// </summary>
public class GoogleEndpointsServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleEndpointsServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleEndpointsServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
