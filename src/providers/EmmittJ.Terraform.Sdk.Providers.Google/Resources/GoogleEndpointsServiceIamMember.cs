...
/// Nesting mode: list
/// </summary>
public partial class GoogleEndpointsServiceIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleEndpointsServiceIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleEndpointsServiceIamMemberConditionBlock> Condition { get; set; } = new();
