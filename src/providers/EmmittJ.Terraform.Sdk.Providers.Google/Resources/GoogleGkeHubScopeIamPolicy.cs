...
/// <summary>
/// Represents a google_gke_hub_scope_iam_policy Terraform resource.
/// Manages a google_gke_hub_scope_iam_policy resource.
/// </summary>
public partial class GoogleGkeHubScopeIamPolicy(string name) : TerraformResource("google_gke_hub_scope_iam_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
