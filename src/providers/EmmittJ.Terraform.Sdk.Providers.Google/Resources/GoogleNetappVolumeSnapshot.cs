...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetappVolumeSnapshotTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleNetappVolumeSnapshot : TerraformResource
{
    ...
    public TerraformBlock<GoogleNetappVolumeSnapshotTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> UsedBytes { get; }
