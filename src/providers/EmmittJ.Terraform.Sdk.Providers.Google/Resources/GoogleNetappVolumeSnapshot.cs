...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetappVolumeSnapshotTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class GoogleNetappVolumeSnapshot : TerraformResource
{
    ...
    public GoogleNetappVolumeSnapshotTimeoutsBlock Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformProperty("used_bytes")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> UsedBytes { get; }
