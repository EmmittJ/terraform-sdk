...
public partial class GoogleDataprocMetastoreTableIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreTableIamMemberConditionBlock>>? Condition { get; set; }
