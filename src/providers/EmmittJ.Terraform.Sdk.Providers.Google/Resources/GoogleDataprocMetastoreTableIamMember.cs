...
/// Nesting mode: list
/// </summary>
public class GoogleDataprocMetastoreTableIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleDataprocMetastoreTableIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleDataprocMetastoreTableIamMemberConditionBlock>>? Condition { get; set; } = new();
