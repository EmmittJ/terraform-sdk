...
public partial class GoogleSecretManagerSecretIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecretManagerSecretIamBindingConditionBlock>>? Condition { get; set; }
