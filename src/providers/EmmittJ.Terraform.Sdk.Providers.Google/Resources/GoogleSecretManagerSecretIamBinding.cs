...
public class GoogleSecretManagerSecretIamBinding : TerraformResource
{
    ...
    public List<GoogleSecretManagerSecretIamBindingConditionBlock>? Condition
    {
        get => GetProperty<List<GoogleSecretManagerSecretIamBindingConditionBlock>>("condition");
