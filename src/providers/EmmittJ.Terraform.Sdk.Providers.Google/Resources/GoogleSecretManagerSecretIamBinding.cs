...
/// Nesting mode: list
/// </summary>
public class GoogleSecretManagerSecretIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSecretManagerSecretIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSecretManagerSecretIamBindingConditionBlock>>? Condition { get; set; } = new();
