...
/// <summary>
/// Represents a google_iap_app_engine_version_iam_policy Terraform resource.
/// Manages a google_iap_app_engine_version_iam_policy resource.
/// </summary>
public partial class GoogleIapAppEngineVersionIamPolicy(string name) : TerraformResource("google_iap_app_engine_version_iam_policy", name)
{
    /// <summary>
