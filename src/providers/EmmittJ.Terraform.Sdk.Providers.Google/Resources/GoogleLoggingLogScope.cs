...
/// Nesting mode: single
/// </summary>
public class GoogleLoggingLogScopeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleLoggingLogScope : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformProperty<List<TerraformProperty<string>>>? ResourceNames { get; set; }
    ...
    public TerraformBlock<GoogleLoggingLogScopeTimeoutsBlock>? Timeouts { get; set; } = new();
