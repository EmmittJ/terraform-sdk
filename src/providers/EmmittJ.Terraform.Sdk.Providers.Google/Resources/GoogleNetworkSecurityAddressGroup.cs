...
/// Nesting mode: single
/// </summary>
public partial class GoogleNetworkSecurityAddressGroupTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class GoogleNetworkSecurityAddressGroup : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformList<string>? Items { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityAddressGroupTimeoutsBlock>? Timeouts { get; set; }
