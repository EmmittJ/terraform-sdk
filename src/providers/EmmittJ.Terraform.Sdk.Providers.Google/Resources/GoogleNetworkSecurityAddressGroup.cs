...
/// Nesting mode: single
/// </summary>
public class GoogleNetworkSecurityAddressGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleNetworkSecurityAddressGroup : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? Items { get; set; }
    ...
    public TerraformBlock<GoogleNetworkSecurityAddressGroupTimeoutsBlock>? Timeouts { get; set; } = new();
