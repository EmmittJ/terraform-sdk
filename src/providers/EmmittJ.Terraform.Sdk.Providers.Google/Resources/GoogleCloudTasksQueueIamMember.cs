...
/// Nesting mode: list
/// </summary>
public partial class GoogleCloudTasksQueueIamMemberConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleCloudTasksQueueIamMember : TerraformResource
{
    ...
    public TerraformList<GoogleCloudTasksQueueIamMemberConditionBlock> Condition { get; set; } = new();
