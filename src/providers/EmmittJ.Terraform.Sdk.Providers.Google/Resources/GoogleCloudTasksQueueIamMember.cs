...
/// Nesting mode: list
/// </summary>
public class GoogleCloudTasksQueueIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleCloudTasksQueueIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleCloudTasksQueueIamMemberConditionBlock>>? Condition { get; set; } = new();
