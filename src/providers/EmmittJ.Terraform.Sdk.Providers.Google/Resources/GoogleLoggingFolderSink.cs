...
/// <summary>
/// Block type for bigquery_options in GoogleLoggingFolderSink.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for exclusions in GoogleLoggingFolderSink.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a google_logging_folder_sink Terraform resource.
/// Manages a google_logging_folder_sink resource.
/// </summary>
public partial class GoogleLoggingFolderSink(string name) : TerraformResource("google_logging_folder_sink", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<bool>(this, "include_children");
    ...
    {
        get => new TerraformReference<bool>(this, "intercept_children");
    ...
    public TerraformList<GoogleLoggingFolderSinkBigqueryOptionsBlock>? BigqueryOptions
    {
        get => GetArgument<TerraformList<GoogleLoggingFolderSinkBigqueryOptionsBlock>>("bigquery_options");
    ...
    /// </summary>
    public TerraformList<GoogleLoggingFolderSinkExclusionsBlock>? Exclusions
    {
        get => GetArgument<TerraformList<GoogleLoggingFolderSinkExclusionsBlock>>("exclusions");
