...
/// Nesting mode: list
/// </summary>
public class GoogleBeyondcorpSecurityGatewayApplicationIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleBeyondcorpSecurityGatewayApplicationIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleBeyondcorpSecurityGatewayApplicationIamBindingConditionBlock>>? Condition { get; set; } = new();
