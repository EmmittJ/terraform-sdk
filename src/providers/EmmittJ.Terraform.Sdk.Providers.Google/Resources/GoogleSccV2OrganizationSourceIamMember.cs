...
/// Nesting mode: list
/// </summary>
public class GoogleSccV2OrganizationSourceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleSccV2OrganizationSourceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleSccV2OrganizationSourceIamMemberConditionBlock>>? Condition { get; set; } = new();
