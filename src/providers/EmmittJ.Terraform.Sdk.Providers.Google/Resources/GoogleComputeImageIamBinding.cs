...
/// Nesting mode: list
/// </summary>
public class GoogleComputeImageIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleComputeImageIamBinding : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleComputeImageIamBindingConditionBlock>>? Condition { get; set; } = new();
