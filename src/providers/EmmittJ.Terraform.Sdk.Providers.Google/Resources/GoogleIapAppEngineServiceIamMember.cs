...
/// Nesting mode: list
/// </summary>
public class GoogleIapAppEngineServiceIamMemberConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapAppEngineServiceIamMember : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<GoogleIapAppEngineServiceIamMemberConditionBlock>>? Condition { get; set; } = new();
