...
/// <summary>
/// Block type for condition in GoogleIapAppEngineServiceIamMember.
/// Nesting mode: list
/// </summary>
public class GoogleIapAppEngineServiceIamMemberConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_iap_app_engine_service_iam_member Terraform resource.
/// Manages a google_iap_app_engine_service_iam_member resource.
/// </summary>
public partial class GoogleIapAppEngineServiceIamMember(string name) : TerraformResource("google_iap_app_engine_service_iam_member", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleIapAppEngineServiceIamMemberConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleIapAppEngineServiceIamMemberConditionBlock>>("condition");
