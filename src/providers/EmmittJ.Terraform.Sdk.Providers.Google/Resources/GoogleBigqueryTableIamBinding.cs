...
/// <summary>
/// Block type for condition in GoogleBigqueryTableIamBinding.
/// Nesting mode: list
/// </summary>
public class GoogleBigqueryTableIamBindingConditionBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a google_bigquery_table_iam_binding Terraform resource.
/// Manages a google_bigquery_table_iam_binding resource.
/// </summary>
public partial class GoogleBigqueryTableIamBinding(string name) : TerraformResource("google_bigquery_table_iam_binding", name)
{
    /// <summary>
    ...
    public TerraformList<GoogleBigqueryTableIamBindingConditionBlock>? Condition
    {
        get => GetArgument<TerraformList<GoogleBigqueryTableIamBindingConditionBlock>>("condition");
