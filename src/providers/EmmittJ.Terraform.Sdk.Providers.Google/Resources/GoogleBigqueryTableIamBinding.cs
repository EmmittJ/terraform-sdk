...
/// Nesting mode: list
/// </summary>
public partial class GoogleBigqueryTableIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleBigqueryTableIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleBigqueryTableIamBindingConditionBlock> Condition { get; set; } = new();
