...
/// Nesting mode: list
/// </summary>
public class GoogleIapTunnelDestGroupIamBindingConditionBlock : ITerraformBlock
{
    /// <summary>
...
public class GoogleIapTunnelDestGroupIamBinding : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> DestGroup { get; set; }
    ...
    public TerraformList<TerraformBlock<GoogleIapTunnelDestGroupIamBindingConditionBlock>>? Condition { get; set; } = new();
