...
/// Nesting mode: list
/// </summary>
public partial class GoogleIapTunnelDestGroupIamBindingConditionBlock() : TerraformBlock("condition")
{
    /// <summary>
...
public partial class GoogleIapTunnelDestGroupIamBinding : TerraformResource
{
    ...
    public TerraformList<GoogleIapTunnelDestGroupIamBindingConditionBlock> Condition { get; set; } = new();
