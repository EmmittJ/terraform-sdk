...
public class AzurermOracleDbSystemShapesDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformArgument("db_system_shapes")]
    public TerraformList<object> DbSystemShapes
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "db_system_shapes").ResolveNodes(ctx));
    }
