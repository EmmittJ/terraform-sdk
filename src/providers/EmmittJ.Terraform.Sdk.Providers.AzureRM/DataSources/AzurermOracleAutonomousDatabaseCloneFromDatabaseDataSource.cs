...
public class AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSource : TerraformDataSource
{
    ...
    {
        this.WithOutput("actual_used_data_storage_size_in_tb");
        this.WithOutput("allocated_storage_size_in_tb");
        this.WithOutput("allowed_ip_addresses");
        ...
        this.WithOutput("private_endpoint_url");
        this.WithOutput("provisionable_cpus");
        this.WithOutput("reconnect_clone_enabled");
        this.WithOutput("refreshable_clone");
        this.WithOutput("refreshable_status");
        this.WithOutput("remote_data_guard_enabled");
        this.WithOutput("service_console_url");
        this.WithOutput("source_autonomous_database_id");
        this.WithOutput("sql_web_developer_url");
        this.WithOutput("subnet_id");
        this.WithOutput("supported_regions_to_clone_to");
        this.WithOutput("tags");
        this.WithOutput("time_created_in_utc");
        this.WithOutput("time_data_guard_role_changed_in_utc");
        this.WithOutput("time_deletion_of_free_autonomous_database_in_utc");
        this.WithOutput("time_local_data_guard_enabled_in_utc");
        this.WithOutput("time_maintenance_begin_in_utc");
        this.WithOutput("time_maintenance_end_in_utc");
        this.WithOutput("time_of_last_failover_in_utc");
        this.WithOutput("time_of_last_refresh_in_utc");
        this.WithOutput("time_of_last_refresh_point_in_utc");
        this.WithOutput("time_of_last_switchover_in_utc");
        this.WithOutput("time_reclamation_of_free_autonomous_database_in_utc");
        this.WithOutput("time_until_reconnect_in_utc");
        this.WithOutput("used_data_storage_size_in_gb");
        this.WithOutput("used_data_storage_size_in_tb");
