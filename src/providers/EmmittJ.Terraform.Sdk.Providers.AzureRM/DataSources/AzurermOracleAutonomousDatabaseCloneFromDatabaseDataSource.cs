...
public class AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformArgument("reconnect_clone_enabled")]
    public TerraformValue<bool> ReconnectCloneEnabled
    {
        get => new TerraformReference<bool>(this, "reconnect_clone_enabled");
    }

    /// <summary>
    /// The refreshable_clone attribute.
    /// </summary>
    [TerraformArgument("refreshable_clone")]
    public TerraformValue<bool> RefreshableClone
    {
        get => new TerraformReference<bool>(this, "refreshable_clone");
    }

    /// <summary>
    /// The refreshable_status attribute.
    /// </summary>
    [TerraformArgument("refreshable_status")]
    public TerraformValue<string> RefreshableStatus
    {
        get => new TerraformReference<string>(this, "refreshable_status");
    }
    ...
    /// </summary>
    [TerraformArgument("time_until_reconnect_in_utc")]
    public TerraformValue<string> TimeUntilReconnectInUtc
    {
        get => new TerraformReference<string>(this, "time_until_reconnect_in_utc");
    }
