...
/// Nesting mode: single
/// </summary>
public class AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformPropertyName("reconnect_clone_enabled")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<bool>> ReconnectCloneEnabled => new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "reconnect_clone_enabled");

    /// <summary>
    /// The refreshable_clone attribute.
    /// </summary>
    [TerraformPropertyName("refreshable_clone")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<bool>> RefreshableClone => new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "refreshable_clone");

    /// <summary>
    /// The refreshable_status attribute.
    /// </summary>
    [TerraformPropertyName("refreshable_status")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> RefreshableStatus => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "refreshable_status");
    ...
    /// </summary>
    [TerraformPropertyName("time_until_reconnect_in_utc")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> TimeUntilReconnectInUtc => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "time_until_reconnect_in_utc");
