...
public partial class AzurermOracleAutonomousDatabaseCloneFromDatabaseDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ReconnectCloneEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> RefreshableClone { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> RefreshableStatus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TimeUntilReconnectInUtc { get; }
