...
/// Nesting mode: single
/// </summary>
public partial class AzurermCommunicationServiceDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermCommunicationServiceDataSource : TerraformDataSource
{
    ...
    public AzurermCommunicationServiceDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<string> DataLocation { get; }
    ...
    /// </summary>
    [TerraformProperty("immutable_resource_id")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ImmutableResourceId { get; }
