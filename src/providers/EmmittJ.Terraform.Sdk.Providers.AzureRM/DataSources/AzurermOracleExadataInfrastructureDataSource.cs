...
public partial class AzurermOracleExadataInfrastructureDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermOracleExadataInfrastructureDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DefinedFileSystemConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> EstimatedPatchingTime { get; }
