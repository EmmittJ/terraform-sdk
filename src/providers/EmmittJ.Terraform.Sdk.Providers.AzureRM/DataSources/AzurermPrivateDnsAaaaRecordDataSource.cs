...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsAaaaRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public class AzurermPrivateDnsAaaaRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermPrivateDnsAaaaRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
