...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerIpamPoolDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermNetworkManagerIpamPoolDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNetworkManagerIpamPoolDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> ParentPoolName => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "parent_pool_name");
