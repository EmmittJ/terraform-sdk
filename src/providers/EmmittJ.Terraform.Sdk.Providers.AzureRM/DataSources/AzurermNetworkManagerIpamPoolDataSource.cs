...
public partial class AzurermNetworkManagerIpamPoolDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermNetworkManagerIpamPoolDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ParentPoolName { get; }
