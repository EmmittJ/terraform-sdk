...
/// Nesting mode: single
/// </summary>
public class AzurermMobileNetworkSiteDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermMobileNetworkSiteDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermMobileNetworkSiteDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<string>>> NetworkFunctionIds => new TerraformReferenceProperty<List<TerraformProperty<string>>>(ResourceAddress, "network_function_ids");
