...
/// Nesting mode: single
/// </summary>
public partial class AzurermContainerRegistryTokenDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermContainerRegistryTokenDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermContainerRegistryTokenDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    /// </summary>
    [TerraformProperty("scope_map_id")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ScopeMapId { get; }
