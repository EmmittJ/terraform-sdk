...
public partial class AzurermSharedImageVersionDataSource : TerraformDataSource
{
    ...
    public TerraformValue<bool> ExcludeFromLatest { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ManagedImageId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> OsDiskImageSizeGb { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> OsDiskSnapshotId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> TargetRegion { get; }
