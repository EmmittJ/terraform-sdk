...
/// Nesting mode: single
/// </summary>
public class AzurermTenantTemplateDeploymentDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermTenantTemplateDeploymentDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermTenantTemplateDeploymentDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
