...
/// Nesting mode: single
/// </summary>
public class AzurermStorageSyncGroupDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermStorageSyncGroupDataSource : TerraformDataSource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> StorageSyncId { get; set; }
    ...
    public TerraformBlock<AzurermStorageSyncGroupDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
