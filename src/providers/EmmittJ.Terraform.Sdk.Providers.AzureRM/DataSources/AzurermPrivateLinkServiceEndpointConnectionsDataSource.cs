...
public class AzurermPrivateLinkServiceEndpointConnectionsDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformArgument("private_endpoint_connections")]
    public TerraformList<object> PrivateEndpointConnections
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "private_endpoint_connections").ResolveNodes(ctx));
    }
