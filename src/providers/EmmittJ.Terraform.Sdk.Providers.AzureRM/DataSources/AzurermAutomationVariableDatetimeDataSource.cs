...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationVariableDatetimeDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public class AzurermAutomationVariableDatetimeDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermAutomationVariableDatetimeDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
