...
/// Nesting mode: single
/// </summary>
public partial class AzurermServicebusQueueAuthorizationRuleDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermServicebusQueueAuthorizationRuleDataSource : TerraformDataSource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? QueueId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? QueueName { get; set; }
    ...
    public partial TerraformBlock<AzurermServicebusQueueAuthorizationRuleDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<bool> Listen { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> Manage { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> Send { get; }
