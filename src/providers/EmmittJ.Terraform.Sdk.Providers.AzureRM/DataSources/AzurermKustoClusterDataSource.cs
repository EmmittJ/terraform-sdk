...
/// Nesting mode: single
/// </summary>
public class AzurermKustoClusterDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermKustoClusterDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermKustoClusterDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
