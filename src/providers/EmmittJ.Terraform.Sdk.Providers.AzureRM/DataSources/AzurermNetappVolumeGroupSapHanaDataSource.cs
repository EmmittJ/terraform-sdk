...
public class AzurermNetappVolumeGroupSapHanaDataSource : TerraformDataSource
{
    ...
    public AzurermNetappVolumeGroupSapHanaDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public TerraformList<object> Volume
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "volume").ResolveNodes(ctx));
    }
