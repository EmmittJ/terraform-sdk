...
/// Nesting mode: single
/// </summary>
public class AzurermSpatialAnchorsAccountDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermSpatialAnchorsAccountDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermSpatialAnchorsAccountDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
