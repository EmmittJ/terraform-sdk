...
/// Nesting mode: single
/// </summary>
public class AzurermCdnFrontdoorRuleSetDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermCdnFrontdoorRuleSetDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermCdnFrontdoorRuleSetDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
