...
/// Nesting mode: single
/// </summary>
public class AzurermDedicatedHostDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDedicatedHostDataSource : TerraformDataSource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> DedicatedHostGroupName { get; set; }
    ...
    public TerraformBlock<AzurermDedicatedHostDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
