...
/// Nesting mode: single
/// </summary>
public class AzurermTrustedSigningAccountDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermTrustedSigningAccountDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermTrustedSigningAccountDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();

    /// <summary>
    /// The account_uri attribute.
    /// </summary>
    [TerraformPropertyName("account_uri")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> AccountUri => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "account_uri");
