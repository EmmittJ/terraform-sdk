...
/// Nesting mode: single
/// </summary>
public class AzurermResourceGroupDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermResourceGroupDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermResourceGroupDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
