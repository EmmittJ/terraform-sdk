...
/// Nesting mode: single
/// </summary>
public class AzurermDataShareAccountDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDataShareAccountDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDataShareAccountDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
