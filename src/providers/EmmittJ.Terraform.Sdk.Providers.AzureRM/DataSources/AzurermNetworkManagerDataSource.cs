...
public class AzurermNetworkManagerDataSource : TerraformDataSource
{
    ...
    public AzurermNetworkManagerDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public TerraformList<object> Scope
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "scope").ResolveNodes(ctx));
    }
