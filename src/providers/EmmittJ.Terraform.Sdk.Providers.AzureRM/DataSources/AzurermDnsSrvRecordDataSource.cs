...
/// Nesting mode: single
/// </summary>
public partial class AzurermDnsSrvRecordDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDnsSrvRecordDataSource : TerraformDataSource
{
    ...
    public AzurermDnsSrvRecordDataSourceTimeoutsBlock Timeouts { get; set; } = new();
