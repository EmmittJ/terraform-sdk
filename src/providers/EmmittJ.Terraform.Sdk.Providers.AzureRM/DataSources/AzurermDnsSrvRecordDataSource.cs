...
/// Nesting mode: single
/// </summary>
public class AzurermDnsSrvRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDnsSrvRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsSrvRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
