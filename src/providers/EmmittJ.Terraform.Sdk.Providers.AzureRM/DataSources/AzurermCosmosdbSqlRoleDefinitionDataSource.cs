...
/// Nesting mode: single
/// </summary>
public partial class AzurermCosmosdbSqlRoleDefinitionDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermCosmosdbSqlRoleDefinitionDataSource : TerraformDataSource
{
    ...
    public AzurermCosmosdbSqlRoleDefinitionDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformSet<string> AssignableScopes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> Permissions { get; }
