...
public class AzurermManagedDisksDataSource : TerraformDataSource
{
    ...
    /// The disk attribute.
    /// </summary>
    [TerraformArgument("disk")]
    public TerraformList<object> Disk
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "disk").ResolveNodes(ctx));
    }
