...
/// Nesting mode: single
/// </summary>
public class AzurermNetappVolumeGroupOracleDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermNetappVolumeGroupOracleDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNetappVolumeGroupOracleDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
