...
public class AzurermMobileNetworkServiceDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> PccRule
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "pcc_rule").ResolveNodes(ctx));
    }
    ...
    public TerraformList<object> ServiceQosPolicy
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "service_qos_policy").ResolveNodes(ctx));
    }
