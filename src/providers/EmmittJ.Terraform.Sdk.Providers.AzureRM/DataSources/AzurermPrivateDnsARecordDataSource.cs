...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsARecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermPrivateDnsARecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermPrivateDnsARecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
