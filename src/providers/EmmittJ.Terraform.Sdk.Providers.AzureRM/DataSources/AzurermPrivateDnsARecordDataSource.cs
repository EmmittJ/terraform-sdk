...
/// </summary>
public class AzurermPrivateDnsARecordDataSource : TerraformDataSource
{
    ...
    public AzurermPrivateDnsARecordDataSourceTimeoutsBlock Timeouts { get; set; } = new();
