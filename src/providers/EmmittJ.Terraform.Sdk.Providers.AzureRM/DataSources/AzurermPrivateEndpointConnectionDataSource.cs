...
/// Nesting mode: single
/// </summary>
public partial class AzurermPrivateEndpointConnectionDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermPrivateEndpointConnectionDataSource : TerraformDataSource
{
    ...
    public AzurermPrivateEndpointConnectionDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PrivateServiceConnection { get; }
