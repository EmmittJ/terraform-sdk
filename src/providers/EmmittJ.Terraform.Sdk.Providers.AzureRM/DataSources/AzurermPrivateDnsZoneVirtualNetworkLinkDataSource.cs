...
/// Nesting mode: single
/// </summary>
public partial class AzurermPrivateDnsZoneVirtualNetworkLinkDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermPrivateDnsZoneVirtualNetworkLinkDataSource : TerraformDataSource
{
    ...
    public AzurermPrivateDnsZoneVirtualNetworkLinkDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<bool> RegistrationEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ResolutionPolicy { get; }
