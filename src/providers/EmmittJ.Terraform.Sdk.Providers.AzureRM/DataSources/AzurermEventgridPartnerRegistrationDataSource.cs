...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridPartnerRegistrationDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermEventgridPartnerRegistrationDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermEventgridPartnerRegistrationDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
