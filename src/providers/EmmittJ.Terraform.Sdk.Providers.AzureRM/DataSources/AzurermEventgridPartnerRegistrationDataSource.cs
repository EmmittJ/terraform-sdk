...
/// <summary>
/// Block type for timeouts in AzurermEventgridPartnerRegistrationDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_eventgrid_partner_registration Terraform data source.
/// Retrieves information about a azurerm_eventgrid_partner_registration.
/// </summary>
public partial class AzurermEventgridPartnerRegistrationDataSource(string name) : TerraformDataSource("azurerm_eventgrid_partner_registration", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermEventgridPartnerRegistrationDataSourceTimeoutsBlock>("timeouts");
