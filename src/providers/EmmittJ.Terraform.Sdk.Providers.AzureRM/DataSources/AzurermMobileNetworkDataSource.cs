...
/// Nesting mode: single
/// </summary>
public partial class AzurermMobileNetworkDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermMobileNetworkDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermMobileNetworkDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MobileCountryCode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MobileNetworkCode { get; }
