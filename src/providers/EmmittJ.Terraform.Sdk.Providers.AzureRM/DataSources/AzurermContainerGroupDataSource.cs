...
/// Nesting mode: single
/// </summary>
public partial class AzurermContainerGroupDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermContainerGroupDataSource : TerraformDataSource
{
    ...
    public AzurermContainerGroupDataSourceTimeoutsBlock Timeouts { get; set; } = new();
