...
/// Nesting mode: single
/// </summary>
public class AzurermOrchestratedVirtualMachineScaleSetDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermOrchestratedVirtualMachineScaleSetDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermOrchestratedVirtualMachineScaleSetDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
