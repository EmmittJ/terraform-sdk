...
/// Nesting mode: single
/// </summary>
public partial class AzurermOrchestratedVirtualMachineScaleSetDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermOrchestratedVirtualMachineScaleSetDataSource : TerraformDataSource
{
    ...
    public AzurermOrchestratedVirtualMachineScaleSetDataSourceTimeoutsBlock Timeouts { get; set; } = new();
