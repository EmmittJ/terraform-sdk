...
/// Nesting mode: single
/// </summary>
public class AzurermDnsAaaaRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDnsAaaaRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsAaaaRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
