...
/// Nesting mode: single
/// </summary>
public partial class AzurermDnsAaaaRecordDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDnsAaaaRecordDataSource : TerraformDataSource
{
    ...
    public AzurermDnsAaaaRecordDataSourceTimeoutsBlock Timeouts { get; set; } = new();
