...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationVariableObjectDataSourceTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermAutomationVariableObjectDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<AzurermAutomationVariableObjectDataSourceTimeoutsBlock>("timeouts");
