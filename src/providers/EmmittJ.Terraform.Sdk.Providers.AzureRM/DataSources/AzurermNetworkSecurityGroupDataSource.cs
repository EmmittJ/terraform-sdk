...
public class AzurermNetworkSecurityGroupDataSource : TerraformDataSource
{
    ...
    public AzurermNetworkSecurityGroupDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public TerraformList<object> SecurityRule
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "security_rule").ResolveNodes(ctx));
    }
