...
/// Nesting mode: single
/// </summary>
public partial class AzurermPrivateDnsCnameRecordDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermPrivateDnsCnameRecordDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermPrivateDnsCnameRecordDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Record { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TargetResourceId { get; }
