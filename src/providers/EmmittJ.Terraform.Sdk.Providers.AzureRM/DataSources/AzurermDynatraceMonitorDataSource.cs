...
/// Nesting mode: single
/// </summary>
public partial class AzurermDynatraceMonitorDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDynatraceMonitorDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> EnvironmentProperties { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> MarketplaceSubscription { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> Plan { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> User { get; }
