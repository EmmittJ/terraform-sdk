...
/// Nesting mode: single
/// </summary>
public class AzurermStackHciStoragePathDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermStackHciStoragePathDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermStackHciStoragePathDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<TerraformProperty<string>> CustomLocationId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "custom_location_id");
