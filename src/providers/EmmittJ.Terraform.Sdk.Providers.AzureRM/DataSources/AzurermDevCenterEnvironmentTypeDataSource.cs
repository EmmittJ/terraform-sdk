...
/// Nesting mode: single
/// </summary>
public class AzurermDevCenterEnvironmentTypeDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDevCenterEnvironmentTypeDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDevCenterEnvironmentTypeDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
