...
public partial class AzurermApiManagementApiDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermApiManagementApiDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> SoapPassThrough { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SubscriptionKeyParameterNames { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> VersionSetId { get; }
