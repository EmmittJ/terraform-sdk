...
/// Nesting mode: single
/// </summary>
public class AzurermDnsMxRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDnsMxRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsMxRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
