...
/// Nesting mode: single
/// </summary>
public class AzurermDiskAccessDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDiskAccessDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDiskAccessDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
