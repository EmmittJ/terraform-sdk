...
/// Nesting mode: single
/// </summary>
public partial class AzurermLinuxWebAppDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermLinuxWebAppDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermLinuxWebAppDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyVaultReferenceIdentityId { get; }
