...
public class AzurermLinuxWebAppDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        this.WithOutput("key_vault_reference_identity_id");
    ...
    {
        get => GetProperty<AzurermLinuxWebAppDataSourceTimeoutsBlock>("timeouts");
