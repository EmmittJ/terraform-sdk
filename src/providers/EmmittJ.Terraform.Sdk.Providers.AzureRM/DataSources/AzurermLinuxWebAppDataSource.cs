...
/// Nesting mode: single
/// </summary>
public class AzurermLinuxWebAppDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermLinuxWebAppDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> KeyVaultReferenceIdentityId => new TerraformReference(this, "key_vault_reference_identity_id");
