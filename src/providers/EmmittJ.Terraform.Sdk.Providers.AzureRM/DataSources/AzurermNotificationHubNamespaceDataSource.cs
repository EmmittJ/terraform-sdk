...
/// Nesting mode: single
/// </summary>
public class AzurermNotificationHubNamespaceDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermNotificationHubNamespaceDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNotificationHubNamespaceDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> NamespaceType => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "namespace_type");
