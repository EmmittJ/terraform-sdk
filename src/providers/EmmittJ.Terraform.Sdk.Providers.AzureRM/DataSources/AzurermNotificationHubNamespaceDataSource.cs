...
/// Nesting mode: single
/// </summary>
public partial class AzurermNotificationHubNamespaceDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermNotificationHubNamespaceDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNotificationHubNamespaceDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> NamespaceType { get; }
