...
/// Nesting mode: single
/// </summary>
public class AzurermNotificationHubNamespaceDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermNotificationHubNamespaceDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> NamespaceType => new TerraformReference(this, "namespace_type");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ServicebusEndpoint => new TerraformReference(this, "servicebus_endpoint");
