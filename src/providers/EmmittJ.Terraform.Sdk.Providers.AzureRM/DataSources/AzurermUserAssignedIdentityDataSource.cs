...
/// Nesting mode: single
/// </summary>
public class AzurermUserAssignedIdentityDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermUserAssignedIdentityDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermUserAssignedIdentityDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
