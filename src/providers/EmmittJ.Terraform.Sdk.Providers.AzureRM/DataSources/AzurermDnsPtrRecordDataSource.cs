...
/// Nesting mode: single
/// </summary>
public partial class AzurermDnsPtrRecordDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDnsPtrRecordDataSource : TerraformDataSource
{
    ...
    public AzurermDnsPtrRecordDataSourceTimeoutsBlock Timeouts { get; set; } = new();
