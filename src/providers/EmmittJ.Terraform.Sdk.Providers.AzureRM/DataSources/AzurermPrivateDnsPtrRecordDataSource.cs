...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsPtrRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermPrivateDnsPtrRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermPrivateDnsPtrRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
