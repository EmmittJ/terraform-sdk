...
/// Nesting mode: single
/// </summary>
public class AzurermDatabaseMigrationServiceDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDatabaseMigrationServiceDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDatabaseMigrationServiceDataSourceTimeoutsBlock>? Timeouts { get; set; }
