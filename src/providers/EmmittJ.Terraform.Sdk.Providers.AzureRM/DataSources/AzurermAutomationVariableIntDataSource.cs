...
/// Nesting mode: single
/// </summary>
public partial class AzurermAutomationVariableIntDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermAutomationVariableIntDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermAutomationVariableIntDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> Value { get; }
