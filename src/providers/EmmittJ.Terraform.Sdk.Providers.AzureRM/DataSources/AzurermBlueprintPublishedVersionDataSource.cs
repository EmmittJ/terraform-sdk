...
public partial class AzurermBlueprintPublishedVersionDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> BlueprintName { get; set; }
    ...
    public partial TerraformBlock<AzurermBlueprintPublishedVersionDataSourceTimeoutsBlock>? Timeouts { get; set; }
