...
/// Nesting mode: single
/// </summary>
public partial class AzurermManagedRedisDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermManagedRedisDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermManagedRedisDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformList<object> CustomerManagedKey { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DefaultDatabase { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> HighAvailabilityEnabled { get; }
