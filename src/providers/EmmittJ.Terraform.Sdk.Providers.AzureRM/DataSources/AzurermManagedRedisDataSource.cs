...
public partial class AzurermManagedRedisDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> CustomerManagedKey { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> DefaultDatabase { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> HighAvailabilityEnabled { get; }
