...
/// Nesting mode: single
/// </summary>
public partial class AzurermDatabaseMigrationProjectDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDatabaseMigrationProjectDataSource : TerraformDataSource
{
    ...
    public AzurermDatabaseMigrationProjectDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SourcePlatform { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TargetPlatform { get; }
