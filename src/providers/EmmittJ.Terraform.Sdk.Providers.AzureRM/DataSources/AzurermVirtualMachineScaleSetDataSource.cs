...
/// Nesting mode: single
/// </summary>
public class AzurermVirtualMachineScaleSetDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermVirtualMachineScaleSetDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermVirtualMachineScaleSetDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
