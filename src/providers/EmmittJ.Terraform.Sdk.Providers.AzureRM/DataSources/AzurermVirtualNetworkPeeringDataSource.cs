...
public partial class AzurermVirtualNetworkPeeringDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermVirtualNetworkPeeringDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<bool> AllowForwardedTraffic { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AllowGatewayTransit { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AllowVirtualNetworkAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> OnlyIpv6PeeringEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> PeerCompleteVirtualNetworksEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> UseRemoteGateways { get; }
