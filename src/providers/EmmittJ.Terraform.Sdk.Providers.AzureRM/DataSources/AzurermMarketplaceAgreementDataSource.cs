...
/// Nesting mode: single
/// </summary>
public partial class AzurermMarketplaceAgreementDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermMarketplaceAgreementDataSource : TerraformDataSource
{
    ...
    public AzurermMarketplaceAgreementDataSourceTimeoutsBlock Timeouts { get; set; } = new();
