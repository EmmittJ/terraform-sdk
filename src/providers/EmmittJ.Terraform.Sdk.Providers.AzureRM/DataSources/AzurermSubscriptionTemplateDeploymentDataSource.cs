...
/// Nesting mode: single
/// </summary>
public class AzurermSubscriptionTemplateDeploymentDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermSubscriptionTemplateDeploymentDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermSubscriptionTemplateDeploymentDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
