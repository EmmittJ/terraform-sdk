...
/// Nesting mode: single
/// </summary>
public partial class AzurermAppServiceDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermAppServiceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> AppServicePlanId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> ClientCertEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> ConnectionString { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> SourceControl { get; }
