...
/// Nesting mode: single
/// </summary>
public partial class AzurermPolicyDefinitionDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermPolicyDefinitionDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermPolicyDefinitionDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PolicyRule { get; }
