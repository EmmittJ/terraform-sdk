...
/// Nesting mode: single
/// </summary>
public class AzurermTrafficManagerGeographicalLocationDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermTrafficManagerGeographicalLocationDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermTrafficManagerGeographicalLocationDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
