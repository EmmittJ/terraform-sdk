...
public class AzurermMobileNetworkSliceDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> SingleNetworkSliceSelectionAssistanceInformation
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "single_network_slice_selection_assistance_information").ResolveNodes(ctx));
    }
