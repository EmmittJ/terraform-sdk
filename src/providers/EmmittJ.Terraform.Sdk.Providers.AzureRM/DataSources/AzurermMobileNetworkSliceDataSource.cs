...
/// Nesting mode: single
/// </summary>
public class AzurermMobileNetworkSliceDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermMobileNetworkSliceDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermMobileNetworkSliceDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> SingleNetworkSliceSelectionAssistanceInformation => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "single_network_slice_selection_assistance_information");
