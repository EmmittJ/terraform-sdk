...
/// Nesting mode: single
/// </summary>
public partial class AzurermMobileNetworkSliceDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermMobileNetworkSliceDataSource : TerraformDataSource
{
    ...
    public AzurermMobileNetworkSliceDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SingleNetworkSliceSelectionAssistanceInformation { get; }
