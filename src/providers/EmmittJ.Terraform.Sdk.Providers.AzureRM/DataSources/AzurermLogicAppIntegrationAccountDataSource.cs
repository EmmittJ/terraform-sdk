...
/// Nesting mode: single
/// </summary>
public class AzurermLogicAppIntegrationAccountDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermLogicAppIntegrationAccountDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermLogicAppIntegrationAccountDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
