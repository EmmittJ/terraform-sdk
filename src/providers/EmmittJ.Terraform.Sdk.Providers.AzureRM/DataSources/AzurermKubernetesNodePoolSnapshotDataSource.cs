...
/// Nesting mode: single
/// </summary>
public partial class AzurermKubernetesNodePoolSnapshotDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermKubernetesNodePoolSnapshotDataSource : TerraformDataSource
{
    ...
    public AzurermKubernetesNodePoolSnapshotDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<string> SourceNodePoolId { get; }
