...
/// Nesting mode: single
/// </summary>
public class AzurermKubernetesNodePoolSnapshotDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermKubernetesNodePoolSnapshotDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> SourceNodePoolId => new TerraformReference(this, "source_node_pool_id");
