...
public partial class AzurermNginxCertificateDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermNginxCertificateDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<string> CertificateVirtualPath { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyVaultSecretCreationDate { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyVaultSecretId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyVaultSecretVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyVirtualPath { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Sha1Thumbprint { get; }
