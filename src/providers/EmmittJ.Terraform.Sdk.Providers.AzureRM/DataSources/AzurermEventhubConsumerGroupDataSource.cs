...
/// Nesting mode: single
/// </summary>
public partial class AzurermEventhubConsumerGroupDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermEventhubConsumerGroupDataSource : TerraformDataSource
{
    ...
    public AzurermEventhubConsumerGroupDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<string> UserMetadata { get; }
