...
public class AzurermNotificationHubDataSource : TerraformDataSource
{
    ...
    public AzurermNotificationHubDataSourceTimeoutsBlock Timeouts { get; set; } = new();

    /// <summary>
    /// The apns_credential attribute.
    /// </summary>
    [TerraformArgument("apns_credential")]
    public TerraformList<object> ApnsCredential
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "apns_credential").ResolveNodes(ctx));
    }
    ...
    public TerraformList<object> GcmCredential
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "gcm_credential").ResolveNodes(ctx));
    }
