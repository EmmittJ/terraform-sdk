...
public partial class AzurermNotificationHubDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNotificationHubDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformList<object> ApnsCredential { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> GcmCredential { get; }
