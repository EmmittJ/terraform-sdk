...
/// Nesting mode: single
/// </summary>
public class AzurermManagedApplicationDefinitionDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermManagedApplicationDefinitionDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermManagedApplicationDefinitionDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
