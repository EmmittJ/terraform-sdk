...
public partial class AzurermStreamAnalyticsJobDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermStreamAnalyticsJobDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<string> CompatibilityLevel { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DataLocale { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> EventsLateArrivalMaxDelayInSeconds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> EventsOutOfOrderMaxDelayInSeconds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EventsOutOfOrderPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> OutputErrorPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> StartMode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> StreamingUnits { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TransformationQuery { get; }
