...
public partial class AzurermDataShareDatasetKustoDatabaseDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermDataShareDatasetKustoDatabaseDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KustoDatabaseId { get; }
