...
public partial class AzurermVirtualDesktopApplicationGroupDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermVirtualDesktopApplicationGroupDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> HostPoolId { get; }
