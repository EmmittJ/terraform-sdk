...
public partial class AzurermMobileNetworkPacketCoreControlPlaneDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermMobileNetworkPacketCoreControlPlaneDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<string> ControlPlaneAccessIpv4Address { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ControlPlaneAccessIpv4Gateway { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ControlPlaneAccessIpv4Subnet { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ControlPlaneAccessName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CoreNetworkTechnology { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> InteroperabilitySettingsJson { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> LocalDiagnosticsAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Platform { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> SiteIds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SoftwareVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> UserEquipmentMtuInBytes { get; }
