...
/// Nesting mode: single
/// </summary>
public class AzurermDnsCaaRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public class AzurermDnsCaaRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsCaaRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
