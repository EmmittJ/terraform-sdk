...
public partial class AzurermDataShareDatasetKustoClusterDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermDataShareDatasetKustoClusterDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KustoClusterId { get; }
