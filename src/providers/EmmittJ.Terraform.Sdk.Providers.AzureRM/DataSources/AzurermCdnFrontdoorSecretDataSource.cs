...
public class AzurermCdnFrontdoorSecretDataSource : TerraformDataSource
{
    ...
    public AzurermCdnFrontdoorSecretDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public TerraformList<object> Secret
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "secret").ResolveNodes(ctx));
    }
