...
public partial class AzurermEventgridDomainDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermEventgridDomainDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> InputMappingDefaultValues { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> InputMappingFields { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> InputSchema { get; }
