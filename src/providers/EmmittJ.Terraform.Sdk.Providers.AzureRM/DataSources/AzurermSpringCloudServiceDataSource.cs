...
public class AzurermSpringCloudServiceDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> ConfigServerGitSetting
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "config_server_git_setting").ResolveNodes(ctx));
    }
