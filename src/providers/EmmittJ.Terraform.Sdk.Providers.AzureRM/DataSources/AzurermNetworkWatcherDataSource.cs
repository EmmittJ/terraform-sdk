...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkWatcherDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermNetworkWatcherDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermNetworkWatcherDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
