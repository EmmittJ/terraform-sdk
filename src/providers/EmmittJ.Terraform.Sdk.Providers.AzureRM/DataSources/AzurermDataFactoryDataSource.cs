...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDataFactoryDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> GithubConfiguration => new TerraformReference(this, "github_configuration");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> VstsConfiguration => new TerraformReference(this, "vsts_configuration");
