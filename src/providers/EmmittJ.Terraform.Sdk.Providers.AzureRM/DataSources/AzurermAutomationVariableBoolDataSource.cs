...
/// Nesting mode: single
/// </summary>
public partial class AzurermAutomationVariableBoolDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermAutomationVariableBoolDataSource : TerraformDataSource
{
    ...
    public AzurermAutomationVariableBoolDataSourceTimeoutsBlock Timeouts { get; set; } = new();
