...
/// Nesting mode: single
/// </summary>
public partial class AzurermStorageQueueDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermStorageQueueDataSource : TerraformDataSource
{
    ...
    public AzurermStorageQueueDataSourceTimeoutsBlock Timeouts { get; set; } = new();
