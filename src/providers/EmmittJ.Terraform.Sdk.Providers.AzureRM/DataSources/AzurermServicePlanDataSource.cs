...
/// Nesting mode: single
/// </summary>
public partial class AzurermServicePlanDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermServicePlanDataSource : TerraformDataSource
{
    ...
    public AzurermServicePlanDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> PerSiteScalingEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> WorkerCount { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ZoneBalancingEnabled { get; }
