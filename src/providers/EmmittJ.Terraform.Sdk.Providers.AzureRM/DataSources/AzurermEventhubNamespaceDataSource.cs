...
/// Nesting mode: single
/// </summary>
public partial class AzurermEventhubNamespaceDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermEventhubNamespaceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<bool> AutoInflateEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> DedicatedClusterId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> KafkaEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> MaximumThroughputUnits { get; }
