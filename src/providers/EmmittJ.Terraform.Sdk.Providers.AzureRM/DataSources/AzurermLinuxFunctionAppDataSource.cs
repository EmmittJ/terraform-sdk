...
/// Nesting mode: single
/// </summary>
public partial class AzurermLinuxFunctionAppDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermLinuxFunctionAppDataSource : TerraformDataSource
{
    ...
    public AzurermLinuxFunctionAppDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Availability { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> BuiltinLoggingEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ContentShareForceDisabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> DailyMemoryTimeQuota { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FunctionsExtensionVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> StorageKeyVaultSecretId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> StorageUsesManagedIdentity { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Usage { get; }
