...
/// Nesting mode: single
/// </summary>
public class AzurermLinuxFunctionAppDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermLinuxFunctionAppDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermLinuxFunctionAppDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
