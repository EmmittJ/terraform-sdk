...
/// Nesting mode: single
/// </summary>
public partial class AzurermMssqlFailoverGroupDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermMssqlFailoverGroupDataSource : TerraformDataSource
{
    ...
    public TerraformSet<string> Databases { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> PartnerServer { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> ReadWriteEndpointFailoverPolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> ReadonlyEndpointFailoverPolicyEnabled { get; }
