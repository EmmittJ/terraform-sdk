...
/// Nesting mode: single
/// </summary>
public partial class AzurermBatchAccountDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermBatchAccountDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> KeyVaultReference { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> PoolAllocationMode { get; }
