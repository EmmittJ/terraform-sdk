...
public partial class AzurermAppServiceEnvironmentV3DataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermAppServiceEnvironmentV3DataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<bool> AllowNewPrivateEndpointConnections { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ClusterSetting { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> DedicatedHostCount { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> InternalLoadBalancingMode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> RemoteDebuggingEnabled { get; }
