...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsResolverInboundEndpointDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermPrivateDnsResolverInboundEndpointDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermPrivateDnsResolverInboundEndpointDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<List<TerraformProperty<object>>> IpConfigurations => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "ip_configurations");
