...
/// Nesting mode: single
/// </summary>
public partial class AzurermExtendedLocationsDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermExtendedLocationsDataSource : TerraformDataSource
{
    ...
    public AzurermExtendedLocationsDataSourceTimeoutsBlock Timeouts { get; set; } = new();
