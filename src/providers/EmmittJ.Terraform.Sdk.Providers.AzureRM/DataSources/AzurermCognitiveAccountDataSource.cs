...
/// Nesting mode: single
/// </summary>
public partial class AzurermCognitiveAccountDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermCognitiveAccountDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermCognitiveAccountDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> QnaRuntimeEndpoint { get; }
