...
/// Nesting mode: single
/// </summary>
public class AzurermCognitiveAccountDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermCognitiveAccountDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> QnaRuntimeEndpoint => new TerraformReference(this, "qna_runtime_endpoint");
