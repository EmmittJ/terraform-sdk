...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsResolverDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermPrivateDnsResolverDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermPrivateDnsResolverDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
