...
/// Nesting mode: single
/// </summary>
public partial class AzurermNginxApiKeyDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermNginxApiKeyDataSource : TerraformDataSource
{
    ...
    public AzurermNginxApiKeyDataSourceTimeoutsBlock Timeouts { get; set; } = new();
