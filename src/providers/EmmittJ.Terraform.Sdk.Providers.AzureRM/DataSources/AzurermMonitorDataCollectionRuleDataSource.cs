...
public class AzurermMonitorDataCollectionRuleDataSource : TerraformDataSource
{
    ...
    public TerraformList<object> DataFlow
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "data_flow").ResolveNodes(ctx));
    }
    ...
    public TerraformList<object> DataSources
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "data_sources").ResolveNodes(ctx));
    }
    ...
    public TerraformList<object> Destinations
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "destinations").ResolveNodes(ctx));
    }
    ...
    public TerraformList<object> StreamDeclaration
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "stream_declaration").ResolveNodes(ctx));
    }
