...
public partial class AzurermVirtualNetworkDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermVirtualNetworkDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformList<string> AddressSpace { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> Subnets { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformMap<string> VnetPeerings { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> VnetPeeringsAddresses { get; }
