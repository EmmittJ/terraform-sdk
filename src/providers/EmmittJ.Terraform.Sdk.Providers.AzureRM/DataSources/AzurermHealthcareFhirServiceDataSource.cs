...
public partial class AzurermHealthcareFhirServiceDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermHealthcareFhirServiceDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformList<string> AccessPolicyObjectIds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ConfigurationExportStorageAccountName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> ContainerRegistryLoginServerUrl { get; }
