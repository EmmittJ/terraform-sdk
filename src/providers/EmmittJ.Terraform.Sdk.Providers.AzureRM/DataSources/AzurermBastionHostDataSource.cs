...
public partial class AzurermBastionHostDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermBastionHostDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<bool> CopyPasteEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> FileCopyEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> IpConnectEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> ScaleUnits { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> SessionRecordingEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ShareableLinkEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> TunnelingEnabled { get; }
