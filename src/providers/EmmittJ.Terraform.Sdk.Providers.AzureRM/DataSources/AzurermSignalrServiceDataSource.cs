...
/// Nesting mode: single
/// </summary>
public partial class AzurermSignalrServiceDataSourceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
/// </summary>
public partial class AzurermSignalrServiceDataSource : TerraformDataSource
{
    ...
    public partial TerraformBlock<AzurermSignalrServiceDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> ServerlessConnectionTimeoutInSeconds { get; }
