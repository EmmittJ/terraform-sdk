...
public partial class AzurermSignalrServiceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<bool> AadAuthEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ServerlessConnectionTimeoutInSeconds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> TlsClientCertEnabled { get; }
