...
/// Nesting mode: single
/// </summary>
public class AzurermDataboxEdgeDeviceDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDataboxEdgeDeviceDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDataboxEdgeDeviceDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<List<TerraformProperty<object>>> DeviceProperties => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "device_properties");
