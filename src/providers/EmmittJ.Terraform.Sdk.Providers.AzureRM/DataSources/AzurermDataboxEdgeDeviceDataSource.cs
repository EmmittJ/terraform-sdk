...
public class AzurermDataboxEdgeDeviceDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformArgument("device_properties")]
    public TerraformList<object> DeviceProperties
    {
        get => TerraformList<object>.Lazy(ctx => new TerraformReference<TerraformList<object>>(this, "device_properties").ResolveNodes(ctx));
    }
