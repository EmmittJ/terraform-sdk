...
/// Nesting mode: single
/// </summary>
public class AzurermDnsCnameRecordDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AzurermDnsCnameRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsCnameRecordDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
