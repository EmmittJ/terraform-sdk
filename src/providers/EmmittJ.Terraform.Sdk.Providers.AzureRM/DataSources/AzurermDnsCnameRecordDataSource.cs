...
public partial class AzurermDnsCnameRecordDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AzurermDnsCnameRecordDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> Record { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> TargetResourceId { get; }
