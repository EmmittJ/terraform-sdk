...
/// Nesting mode: single
/// </summary>
public partial class AzurermDnsCnameRecordDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzurermDnsCnameRecordDataSource : TerraformDataSource
{
    ...
    public AzurermDnsCnameRecordDataSourceTimeoutsBlock Timeouts { get; set; } = new();
