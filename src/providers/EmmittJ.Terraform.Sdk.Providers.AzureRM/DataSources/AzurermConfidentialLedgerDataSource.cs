...
public partial class AzurermConfidentialLedgerDataSource : TerraformDataSource
{
    ...
    public partial TerraformList<object> AzureadBasedServicePrincipal { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CertificateBasedSecurityPrincipal { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LedgerType { get; }
