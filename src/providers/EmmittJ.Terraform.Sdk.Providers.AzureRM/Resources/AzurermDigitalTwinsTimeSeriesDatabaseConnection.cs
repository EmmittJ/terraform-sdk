...
public partial class AzurermDigitalTwinsTimeSeriesDatabaseConnection : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> EventhubNamespaceEndpointUri { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> KustoClusterUri { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? KustoTableName { get; set; }
    ...
    public partial TerraformBlock<AzurermDigitalTwinsTimeSeriesDatabaseConnectionTimeoutsBlock>? Timeouts { get; set; }
