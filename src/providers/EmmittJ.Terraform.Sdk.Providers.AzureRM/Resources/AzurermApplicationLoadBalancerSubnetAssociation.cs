...
/// Nesting mode: single
/// </summary>
public class AzurermApplicationLoadBalancerSubnetAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApplicationLoadBalancerSubnetAssociation : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> ApplicationLoadBalancerId { get; set; }
    ...
    public TerraformBlock<AzurermApplicationLoadBalancerSubnetAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
