...
/// Nesting mode: single
/// </summary>
public class AzurermSiteRecoveryProtectionContainerTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSiteRecoveryProtectionContainer : TerraformResource
{
    ...
    public TerraformBlock<AzurermSiteRecoveryProtectionContainerTimeoutsBlock>? Timeouts { get; set; } = new();
