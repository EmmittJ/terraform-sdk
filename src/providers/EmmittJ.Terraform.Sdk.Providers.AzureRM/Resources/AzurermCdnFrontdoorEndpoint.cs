...
/// Nesting mode: single
/// </summary>
public class AzurermCdnFrontdoorEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCdnFrontdoorEndpoint : TerraformResource
{
    ...
    public TerraformBlock<AzurermCdnFrontdoorEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
