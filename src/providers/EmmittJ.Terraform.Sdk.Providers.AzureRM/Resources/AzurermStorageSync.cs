...
public class AzurermStorageSync : TerraformResource
{
    ...
    {
        SetOutput("registered_servers");
        SetOutput("id");
        SetOutput("incoming_traffic_policy");
        SetOutput("location");
        SetOutput("name");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("incoming_traffic_policy");
        set => SetProperty("incoming_traffic_policy", value);
    }
