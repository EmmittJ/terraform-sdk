...
public class AzurermDataFactoryDatasetMysql : TerraformResource
{
    ...
    /// Nesting mode: list
    /// </summary>
    public List<AzurermDataFactoryDatasetMysqlSchemaColumnBlock>? SchemaColumn
    {
        get => GetProperty<List<AzurermDataFactoryDatasetMysqlSchemaColumnBlock>>("schema_column");
    ...
    {
        get => GetProperty<AzurermDataFactoryDatasetMysqlTimeoutsBlock>("timeouts");
