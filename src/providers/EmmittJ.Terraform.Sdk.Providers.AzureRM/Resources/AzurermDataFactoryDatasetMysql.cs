...
public partial class AzurermDataFactoryDatasetMysql : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetMysqlSchemaColumnBlock>>? SchemaColumn { get; set; }
    ...
    public TerraformBlock<AzurermDataFactoryDatasetMysqlTimeoutsBlock>? Timeouts { get; set; }
