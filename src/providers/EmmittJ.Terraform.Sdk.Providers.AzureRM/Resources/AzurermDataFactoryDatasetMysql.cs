...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetMysqlSchemaColumnBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetMysqlTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryDatasetMysql : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetMysqlSchemaColumnBlock>>? SchemaColumn { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryDatasetMysqlTimeoutsBlock>? Timeouts { get; set; } = new();
