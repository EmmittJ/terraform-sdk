...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementGlobalSchemaTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementGlobalSchema : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementGlobalSchemaTimeoutsBlock>? Timeouts { get; set; } = new();
