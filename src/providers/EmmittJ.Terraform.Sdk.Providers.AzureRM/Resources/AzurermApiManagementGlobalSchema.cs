...
/// Nesting mode: single
/// </summary>
public partial class AzurermApiManagementGlobalSchemaTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermApiManagementGlobalSchema : TerraformResource
{
    ...
    public AzurermApiManagementGlobalSchemaTimeoutsBlock Timeouts { get; set; } = new();
