...
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbTableAutoscaleSettingsBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbTableTimeoutsBlock
{
    /// <summary>
...
public class AzurermCosmosdbTable : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermCosmosdbTableAutoscaleSettingsBlock>>? AutoscaleSettings { get; set; }
    ...
    public TerraformBlock<AzurermCosmosdbTableTimeoutsBlock>? Timeouts { get; set; }
