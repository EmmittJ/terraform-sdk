...
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbTableAutoscaleSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbTableTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbTable : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermCosmosdbTableAutoscaleSettingsBlock>>? AutoscaleSettings { get; set; } = new();
    ...
    public TerraformBlock<AzurermCosmosdbTableTimeoutsBlock>? Timeouts { get; set; } = new();
