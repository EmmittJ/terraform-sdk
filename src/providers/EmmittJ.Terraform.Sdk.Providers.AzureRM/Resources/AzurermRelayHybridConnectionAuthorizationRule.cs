...
/// Nesting mode: single
/// </summary>
public partial class AzurermRelayHybridConnectionAuthorizationRuleTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermRelayHybridConnectionAuthorizationRule : TerraformResource
{
    public AzurermRelayHybridConnectionAuthorizationRule(string name) : base("azurerm_relay_hybrid_connection_authorization_rule", name)
    {
    }
    ...
    [TerraformProperty("hybrid_connection_name")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> HybridConnectionName { get; set; }
    ...
    public partial TerraformBlock<AzurermRelayHybridConnectionAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; }
