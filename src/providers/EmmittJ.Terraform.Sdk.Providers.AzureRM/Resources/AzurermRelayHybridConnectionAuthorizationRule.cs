...
public partial class AzurermRelayHybridConnectionAuthorizationRule : TerraformResource
{
    ...
    public required TerraformValue<string> HybridConnectionName { get; set; }
    ...
    public TerraformBlock<AzurermRelayHybridConnectionAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; }
