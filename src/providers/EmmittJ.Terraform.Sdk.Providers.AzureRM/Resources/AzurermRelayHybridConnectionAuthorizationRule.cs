...
/// Nesting mode: single
/// </summary>
public class AzurermRelayHybridConnectionAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRelayHybridConnectionAuthorizationRule : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> HybridConnectionName { get; set; }
    ...
    public TerraformBlock<AzurermRelayHybridConnectionAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
