...
/// Nesting mode: single
/// </summary>
public class AzurermMysqlFlexibleServerFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMysqlFlexibleServerFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermMysqlFlexibleServerFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
