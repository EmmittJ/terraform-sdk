...
/// </summary>
public partial class AzurermCosmosdbCassandraKeyspace(string name) : TerraformResource("azurerm_cosmosdb_cassandra_keyspace", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermCosmosdbCassandraKeyspaceTimeoutsBlock>("timeouts");
