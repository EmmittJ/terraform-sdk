...
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbCassandraKeyspaceAutoscaleSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbCassandraKeyspaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbCassandraKeyspace : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermCosmosdbCassandraKeyspaceAutoscaleSettingsBlock>>? AutoscaleSettings { get; set; } = new();
    ...
    public TerraformBlock<AzurermCosmosdbCassandraKeyspaceTimeoutsBlock>? Timeouts { get; set; } = new();
