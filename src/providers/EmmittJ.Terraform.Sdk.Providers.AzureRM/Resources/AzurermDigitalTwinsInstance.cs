...
/// Nesting mode: list
/// </summary>
public class AzurermDigitalTwinsInstanceIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDigitalTwinsInstanceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDigitalTwinsInstance : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDigitalTwinsInstanceIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermDigitalTwinsInstanceTimeoutsBlock>? Timeouts { get; set; } = new();
