...
/// Nesting mode: set
/// </summary>
public class AzurermPrivateDnsMxRecordRecordBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<double>> Preference { get; set; }
...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsMxRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsMxRecord : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AzurermPrivateDnsMxRecordRecordBlock>>? Record { get; set; } = new();
    ...
    public TerraformBlock<AzurermPrivateDnsMxRecordTimeoutsBlock>? Timeouts { get; set; } = new();
