...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationConnectionServicePrincipalTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationConnectionServicePrincipal : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> CertificateThumbprint { get; set; }
    ...
    public TerraformBlock<AzurermAutomationConnectionServicePrincipalTimeoutsBlock>? Timeouts { get; set; } = new();
