...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelAlertRuleMachineLearningBehaviorAnalytics : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> AlertRuleTemplateGuid { get; set; }
    ...
    public TerraformBlock<AzurermSentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsBlock>? Timeouts { get; set; } = new();
