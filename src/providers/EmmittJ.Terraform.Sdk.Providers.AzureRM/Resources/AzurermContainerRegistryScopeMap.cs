...
/// Nesting mode: single
/// </summary>
public class AzurermContainerRegistryScopeMapTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermContainerRegistryScopeMap : TerraformResource
{
    ...
    public TerraformBlock<AzurermContainerRegistryScopeMapTimeoutsBlock>? Timeouts { get; set; } = new();
