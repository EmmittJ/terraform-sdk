...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlFlexibleServerFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlFlexibleServerFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlFlexibleServerFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
