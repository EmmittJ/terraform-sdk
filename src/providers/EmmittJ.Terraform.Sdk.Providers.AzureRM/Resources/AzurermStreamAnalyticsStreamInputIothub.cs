...
/// Nesting mode: list
/// </summary>
public class AzurermStreamAnalyticsStreamInputIothubSerializationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsStreamInputIothubTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsStreamInputIothub : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> IothubNamespace { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SharedAccessPolicyKey { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsStreamInputIothubSerializationBlock>>? Serialization { get; set; } = new();
    ...
    public TerraformBlock<AzurermStreamAnalyticsStreamInputIothubTimeoutsBlock>? Timeouts { get; set; } = new();
