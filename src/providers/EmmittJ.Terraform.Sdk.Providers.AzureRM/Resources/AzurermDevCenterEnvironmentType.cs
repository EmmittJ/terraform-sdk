...
/// Nesting mode: single
/// </summary>
public class AzurermDevCenterEnvironmentTypeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDevCenterEnvironmentType : TerraformResource
{
    ...
    public TerraformBlock<AzurermDevCenterEnvironmentTypeTimeoutsBlock>? Timeouts { get; set; } = new();
