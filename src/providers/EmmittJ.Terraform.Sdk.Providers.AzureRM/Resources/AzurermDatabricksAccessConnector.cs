...
/// </summary>
public partial class AzurermDatabricksAccessConnector(string name) : TerraformResource("azurerm_databricks_access_connector", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDatabricksAccessConnectorTimeoutsBlock>("timeouts");
