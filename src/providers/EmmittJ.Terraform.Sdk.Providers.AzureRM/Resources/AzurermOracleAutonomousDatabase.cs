...
public partial class AzurermOracleAutonomousDatabaseLongTermBackupScheduleBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RepeatCadence { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TimeOfBackup { get; set; }
...
public partial class AzurermOracleAutonomousDatabase : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DbVersion { get; set; }
