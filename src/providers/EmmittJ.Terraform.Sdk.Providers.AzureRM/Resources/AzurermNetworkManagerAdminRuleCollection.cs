...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerAdminRuleCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerAdminRuleCollection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SecurityAdminConfigurationId { get; set; }
    ...
    public TerraformBlock<AzurermNetworkManagerAdminRuleCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
