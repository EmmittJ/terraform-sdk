...
public partial class AzurermLoadTest : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermLoadTestEncryptionBlock>>? Encryption { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLoadTestIdentityBlock>>? Identity { get; set; }
    ...
    public TerraformBlock<AzurermLoadTestTimeoutsBlock>? Timeouts { get; set; }

    /// <summary>
    /// The data_plane_uri attribute.
    /// </summary>
    [TerraformProperty("data_plane_uri")]
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> DataPlaneUri { get; }
