...
/// Nesting mode: single
/// </summary>
public class AzurermCognitiveAccountRaiBlocklistTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCognitiveAccountRaiBlocklist : TerraformResource
{
    ...
    public TerraformBlock<AzurermCognitiveAccountRaiBlocklistTimeoutsBlock>? Timeouts { get; set; } = new();
