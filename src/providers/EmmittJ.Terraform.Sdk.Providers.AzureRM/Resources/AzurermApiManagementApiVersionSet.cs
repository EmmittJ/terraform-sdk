...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiVersionSetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiVersionSet : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? VersionHeaderName { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? VersionQueryName { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> VersioningScheme { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementApiVersionSetTimeoutsBlock>? Timeouts { get; set; } = new();
