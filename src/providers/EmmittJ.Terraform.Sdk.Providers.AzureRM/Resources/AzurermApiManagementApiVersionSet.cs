...
/// Nesting mode: single
/// </summary>
public partial class AzurermApiManagementApiVersionSetTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermApiManagementApiVersionSet : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? VersionHeaderName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? VersionQueryName { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VersioningScheme { get; set; }
    ...
    public partial TerraformBlock<AzurermApiManagementApiVersionSetTimeoutsBlock>? Timeouts { get; set; }
