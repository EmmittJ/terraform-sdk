...
public partial class AzurermKeyVaultAccessPolicy : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? CertificatePermissions { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? KeyPermissions { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? SecretPermissions { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? StoragePermissions { get; set; }
    ...
    public partial TerraformBlock<AzurermKeyVaultAccessPolicyTimeoutsBlock>? Timeouts { get; set; }
