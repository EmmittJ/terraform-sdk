...
/// Nesting mode: single
/// </summary>
public class AzurermLbNatRuleTimeoutsBlock
{
    /// <summary>
...
public class AzurermLbNatRule : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? BackendAddressPoolId { get; set; }
    ...
    public TerraformValue<bool> EnableFloatingIp { get; set; } = default!;
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<bool> FloatingIpEnabled { get; set; } = default!;
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<double>? FrontendPort { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<double>? FrontendPortEnd { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<double>? FrontendPortStart { get; set; }
    ...
    public TerraformBlock<AzurermLbNatRuleTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> BackendIpConfigurationId => new TerraformReference(this, "backend_ip_configuration_id");
