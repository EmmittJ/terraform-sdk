...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementProductPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementProductPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementProductPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
