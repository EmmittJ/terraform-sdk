...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementOpenidConnectProviderTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementOpenidConnectProvider : TerraformResource
{
    ...
    [TerraformPropertyName("metadata_endpoint")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MetadataEndpoint { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementOpenidConnectProviderTimeoutsBlock>? Timeouts { get; set; } = new();
