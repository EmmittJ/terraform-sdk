...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlServerKeyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlServerKey : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlServerKeyTimeoutsBlock>? Timeouts { get; set; } = new();
