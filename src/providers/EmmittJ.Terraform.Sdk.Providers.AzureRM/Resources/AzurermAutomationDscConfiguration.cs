...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationDscConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationDscConfiguration : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? LogVerbose { get; set; }
    ...
    public TerraformBlock<AzurermAutomationDscConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
