...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementApiPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
