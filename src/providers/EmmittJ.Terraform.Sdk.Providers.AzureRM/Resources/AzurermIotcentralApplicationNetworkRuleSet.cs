...
/// Nesting mode: list
/// </summary>
public class AzurermIotcentralApplicationNetworkRuleSetIpRuleBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermIotcentralApplicationNetworkRuleSetTimeoutsBlock
{
    /// <summary>
...
public class AzurermIotcentralApplicationNetworkRuleSet : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<bool>? ApplyToDevice { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermIotcentralApplicationNetworkRuleSetIpRuleBlock>>? IpRule { get; set; }
    ...
    public TerraformBlock<AzurermIotcentralApplicationNetworkRuleSetTimeoutsBlock>? Timeouts { get; set; }
