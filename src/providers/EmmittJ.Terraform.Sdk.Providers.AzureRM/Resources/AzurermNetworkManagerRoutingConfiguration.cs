...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerRoutingConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerRoutingConfiguration : TerraformResource
{
    ...
    public TerraformBlock<AzurermNetworkManagerRoutingConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
