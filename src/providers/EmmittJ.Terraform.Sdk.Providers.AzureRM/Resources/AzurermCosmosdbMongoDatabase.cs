...
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbMongoDatabaseAutoscaleSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbMongoDatabaseTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbMongoDatabase : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermCosmosdbMongoDatabaseAutoscaleSettingsBlock>>? AutoscaleSettings { get; set; } = new();
    ...
    public TerraformBlock<AzurermCosmosdbMongoDatabaseTimeoutsBlock>? Timeouts { get; set; } = new();
