...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryLinkedServiceSnowflakeKeyVaultPasswordBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceSnowflakeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceSnowflake : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryLinkedServiceSnowflakeKeyVaultPasswordBlock>>? KeyVaultPassword { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceSnowflakeTimeoutsBlock>? Timeouts { get; set; } = new();
