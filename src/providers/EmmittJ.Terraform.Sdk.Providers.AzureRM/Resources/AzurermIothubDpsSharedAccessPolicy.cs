...
/// Nesting mode: single
/// </summary>
public class AzurermIothubDpsSharedAccessPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubDpsSharedAccessPolicy : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EnrollmentRead { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? EnrollmentWrite { get; set; }
    ...
    public required TerraformProperty<TerraformProperty<string>> IothubDpsName { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? RegistrationRead { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? RegistrationWrite { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? ServiceConfig { get; set; }
    ...
    public TerraformBlock<AzurermIothubDpsSharedAccessPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
