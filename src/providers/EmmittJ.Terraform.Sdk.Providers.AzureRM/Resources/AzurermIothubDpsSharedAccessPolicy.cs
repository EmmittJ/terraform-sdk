...
/// Nesting mode: single
/// </summary>
public partial class AzurermIothubDpsSharedAccessPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermIothubDpsSharedAccessPolicy : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("enrollment_read")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnrollmentRead { get; set; }

    /// <summary>
    /// The enrollment_write attribute.
    /// </summary>
    [TerraformProperty("enrollment_write")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnrollmentWrite { get; set; }
    ...
    /// </summary>
    [TerraformProperty("registration_read")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RegistrationRead { get; set; }

    /// <summary>
    /// The registration_write attribute.
    /// </summary>
    [TerraformProperty("registration_write")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RegistrationWrite { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ServiceConfig { get; set; }
    ...
    public partial TerraformBlock<AzurermIothubDpsSharedAccessPolicyTimeoutsBlock>? Timeouts { get; set; }
