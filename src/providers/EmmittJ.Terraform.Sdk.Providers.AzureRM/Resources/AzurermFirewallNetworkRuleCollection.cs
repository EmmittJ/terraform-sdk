...
/// Nesting mode: list
/// </summary>
public class AzurermFirewallNetworkRuleCollectionRuleBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? DestinationFqdns { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? DestinationIpGroups { get; set; }
...
/// Nesting mode: single
/// </summary>
public class AzurermFirewallNetworkRuleCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermFirewallNetworkRuleCollection : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermFirewallNetworkRuleCollectionRuleBlock>>? Rule { get; set; } = new();
    ...
    public TerraformBlock<AzurermFirewallNetworkRuleCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
