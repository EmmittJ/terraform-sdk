...
/// Nesting mode: single
/// </summary>
public class AzurermVirtualDesktopApplicationGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermVirtualDesktopApplicationGroup : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("default_desktop_display_name")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? DefaultDesktopDisplayName { get; set; }
    ...
    public TerraformBlock<AzurermVirtualDesktopApplicationGroupTimeoutsBlock>? Timeouts { get; set; } = new();
