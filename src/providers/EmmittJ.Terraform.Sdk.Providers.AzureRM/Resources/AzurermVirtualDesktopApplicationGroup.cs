...
/// Nesting mode: single
/// </summary>
public partial class AzurermVirtualDesktopApplicationGroupTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermVirtualDesktopApplicationGroup : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? DefaultDesktopDisplayName { get; set; }
    ...
    public TerraformBlock<AzurermVirtualDesktopApplicationGroupTimeoutsBlock>? Timeouts { get; set; }
