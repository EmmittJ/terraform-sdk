...
/// Nesting mode: single
/// </summary>
public partial class AzurermVirtualDesktopApplicationGroupTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermVirtualDesktopApplicationGroup : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("default_desktop_display_name")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DefaultDesktopDisplayName { get; set; }
    ...
    public AzurermVirtualDesktopApplicationGroupTimeoutsBlock Timeouts { get; set; } = new();
