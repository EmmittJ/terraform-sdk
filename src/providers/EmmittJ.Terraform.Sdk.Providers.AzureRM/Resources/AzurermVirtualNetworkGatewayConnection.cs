...
public partial class AzurermVirtualNetworkGatewayConnectionIpsecPolicyBlock : TerraformBlockBase
{
    ...
    public TerraformValue<double> SaDatasize { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<double> SaLifetime { get; set; }
...
public partial class AzurermVirtualNetworkGatewayConnection : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> ConnectionProtocol { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> ExpressRouteGatewayBypass { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> UsePolicyBasedTrafficSelectors { get; set; }
