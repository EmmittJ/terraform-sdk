...
/// Nesting mode: single
/// </summary>
public partial class AzurermVirtualNetworkPeeringTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermVirtualNetworkPeering : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? LocalSubnetNames { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? OnlyIpv6PeeringEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? PeerCompleteVirtualNetworksEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? RemoteSubnetNames { get; set; }
    ...
    public AzurermVirtualNetworkPeeringTimeoutsBlock Timeouts { get; set; } = new();
