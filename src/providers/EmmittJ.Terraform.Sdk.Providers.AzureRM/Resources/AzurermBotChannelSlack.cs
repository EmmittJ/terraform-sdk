...
/// Nesting mode: single
/// </summary>
public partial class AzurermBotChannelSlackTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermBotChannelSlack : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? LandingPageUrl { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SigningSecret { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VerificationToken { get; set; }
    ...
    public AzurermBotChannelSlackTimeoutsBlock Timeouts { get; set; } = new();
