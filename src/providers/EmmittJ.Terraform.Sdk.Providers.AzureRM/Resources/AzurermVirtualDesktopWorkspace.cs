...
/// Nesting mode: single
/// </summary>
public class AzurermVirtualDesktopWorkspaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermVirtualDesktopWorkspace : TerraformResource
{
    ...
    public TerraformBlock<AzurermVirtualDesktopWorkspaceTimeoutsBlock>? Timeouts { get; set; } = new();
