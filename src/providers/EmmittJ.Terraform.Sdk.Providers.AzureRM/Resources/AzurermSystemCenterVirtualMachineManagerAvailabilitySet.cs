...
/// Nesting mode: single
/// </summary>
public class AzurermSystemCenterVirtualMachineManagerAvailabilitySetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSystemCenterVirtualMachineManagerAvailabilitySet : TerraformResource
{
    ...
    public TerraformBlock<AzurermSystemCenterVirtualMachineManagerAvailabilitySetTimeoutsBlock>? Timeouts { get; set; } = new();
