...
/// Nesting mode: single
/// </summary>
public class AzurermRestorePointCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRestorePointCollection : TerraformResource
{
    ...
    public TerraformBlock<AzurermRestorePointCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
