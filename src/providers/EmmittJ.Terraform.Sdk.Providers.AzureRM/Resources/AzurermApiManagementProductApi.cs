...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementProductApiTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementProductApi : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementProductApiTimeoutsBlock>? Timeouts { get; set; } = new();
