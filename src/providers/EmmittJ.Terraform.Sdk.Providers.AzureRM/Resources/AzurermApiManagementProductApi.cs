...
/// Nesting mode: single
/// </summary>
public partial class AzurermApiManagementProductApiTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermApiManagementProductApi : TerraformResource
{
    ...
    public AzurermApiManagementProductApiTimeoutsBlock Timeouts { get; set; } = new();
