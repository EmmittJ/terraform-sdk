...
/// </summary>
public partial class AzurermRelayNamespace(string name) : TerraformResource("azurerm_relay_namespace", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    /// </summary>
    public TerraformValue<string> MetricId
    {
        get => new TerraformReference<string>(this, "metric_id");
    }
    ...
    /// </summary>
    public AzurermRelayNamespaceTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermRelayNamespaceTimeoutsBlock>("timeouts");
