...
/// Nesting mode: single
/// </summary>
public class AzurermRelayNamespaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRelayNamespace : TerraformResource
{
    ...
    public TerraformBlock<AzurermRelayNamespaceTimeoutsBlock>? Timeouts { get; set; } = new();

    /// <summary>
    /// The metric_id attribute.
    /// </summary>
    [TerraformPropertyName("metric_id")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> MetricId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "metric_id");
