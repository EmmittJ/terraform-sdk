...
/// Nesting mode: single
/// </summary>
public class AzurermIothubFallbackRouteTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubFallbackRoute : TerraformResource
{
    ...
    public TerraformBlock<AzurermIothubFallbackRouteTimeoutsBlock>? Timeouts { get; set; } = new();
