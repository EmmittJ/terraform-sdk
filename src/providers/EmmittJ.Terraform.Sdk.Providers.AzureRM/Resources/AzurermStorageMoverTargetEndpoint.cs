...
/// Nesting mode: single
/// </summary>
public class AzurermStorageMoverTargetEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStorageMoverTargetEndpoint : TerraformResource
{
    ...
    public TerraformBlock<AzurermStorageMoverTargetEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
