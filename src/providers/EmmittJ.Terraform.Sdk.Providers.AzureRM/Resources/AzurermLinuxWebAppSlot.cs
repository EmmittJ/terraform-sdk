...
public class AzurermLinuxWebAppSlot : TerraformResource
{
    ...
    public List<AzurermLinuxWebAppSlotAuthSettingsBlock>? AuthSettings
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotAuthSettingsBlock>>("auth_settings");
    ...
    public List<AzurermLinuxWebAppSlotAuthSettingsV2Block>? AuthSettingsV2
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotAuthSettingsV2Block>>("auth_settings_v2");
    ...
    public List<AzurermLinuxWebAppSlotBackupBlock>? Backup
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotBackupBlock>>("backup");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxWebAppSlotConnectionStringBlock>? ConnectionString
    {
        get => GetProperty<HashSet<AzurermLinuxWebAppSlotConnectionStringBlock>>("connection_string");
    ...
    public List<AzurermLinuxWebAppSlotIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotIdentityBlock>>("identity");
    ...
    public List<AzurermLinuxWebAppSlotLogsBlock>? Logs
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotLogsBlock>>("logs");
    ...
    public List<AzurermLinuxWebAppSlotSiteConfigBlock>? SiteConfig
    {
        get => GetProperty<List<AzurermLinuxWebAppSlotSiteConfigBlock>>("site_config");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxWebAppSlotStorageAccountBlock>? StorageAccount
    {
        get => GetProperty<HashSet<AzurermLinuxWebAppSlotStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermLinuxWebAppSlotTimeoutsBlock>("timeouts");
