...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotAuthSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotAuthSettingsV2Block : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotBackupBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermLinuxWebAppSlotConnectionStringBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotLogsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxWebAppSlotSiteConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermLinuxWebAppSlotStorageAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermLinuxWebAppSlotTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermLinuxWebAppSlot : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotAuthSettingsBlock>>? AuthSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotAuthSettingsV2Block>>? AuthSettingsV2 { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotBackupBlock>>? Backup { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxWebAppSlotConnectionStringBlock>>? ConnectionString { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotLogsBlock>>? Logs { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxWebAppSlotSiteConfigBlock>>? SiteConfig { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxWebAppSlotStorageAccountBlock>>? StorageAccount { get; set; } = new();
    ...
    public TerraformBlock<AzurermLinuxWebAppSlotTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>> AppMetadata => new TerraformReferenceProperty<Dictionary<string, TerraformProperty<string>>>(ResourceAddress, "app_metadata");
