...
/// Nesting mode: single
/// </summary>
public partial class AzurermMssqlServerMicrosoftSupportAuditingPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermMssqlServerMicrosoftSupportAuditingPolicy : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? BlobStorageEndpoint { get; set; }
    ...
    public TerraformBlock<AzurermMssqlServerMicrosoftSupportAuditingPolicyTimeoutsBlock>? Timeouts { get; set; }
