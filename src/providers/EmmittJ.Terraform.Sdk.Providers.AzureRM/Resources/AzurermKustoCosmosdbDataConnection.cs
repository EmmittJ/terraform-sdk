...
public partial class AzurermKustoCosmosdbDataConnection : TerraformResource
{
    ...
    public required partial TerraformValue<string> CosmosdbContainerId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> KustoDatabaseId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ManagedIdentityId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RetrievalStartDate { get; set; }
    ...
    public partial TerraformBlock<AzurermKustoCosmosdbDataConnectionTimeoutsBlock>? Timeouts { get; set; }
