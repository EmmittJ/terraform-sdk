...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsManagedPrivateEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsManagedPrivateEndpoint : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> StreamAnalyticsClusterName { get; set; }
    ...
    public TerraformBlock<AzurermStreamAnalyticsManagedPrivateEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
