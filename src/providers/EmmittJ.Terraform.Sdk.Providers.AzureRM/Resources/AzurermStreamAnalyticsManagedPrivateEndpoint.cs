...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsManagedPrivateEndpointTimeoutsBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsManagedPrivateEndpoint : TerraformResource
{
    ...
    [TerraformPropertyName("stream_analytics_cluster_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> StreamAnalyticsClusterName { get; set; }
    ...
    public TerraformBlock<AzurermStreamAnalyticsManagedPrivateEndpointTimeoutsBlock>? Timeouts { get; set; }
