...
/// </summary>
public partial class AzurermNetworkFunctionAzureTrafficCollector(string name) : TerraformResource("azurerm_network_function_azure_traffic_collector", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermNetworkFunctionAzureTrafficCollectorTimeoutsBlock>("timeouts");
