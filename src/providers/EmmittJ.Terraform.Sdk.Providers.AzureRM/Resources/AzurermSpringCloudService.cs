...
public partial class AzurermSpringCloudServiceNetworkBlock : TerraformBlockBase
{
    ...
    public TerraformValue<string> AppNetworkResourceGroup { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> ServiceRuntimeNetworkResourceGroup { get; set; }
...
public partial class AzurermSpringCloudService : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ServiceRegistryId { get; }
