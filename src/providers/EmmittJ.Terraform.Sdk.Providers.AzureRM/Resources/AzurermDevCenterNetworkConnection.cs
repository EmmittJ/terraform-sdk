...
/// Nesting mode: single
/// </summary>
public partial class AzurermDevCenterNetworkConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermDevCenterNetworkConnection : TerraformResource
{
    ...
    public required partial TerraformValue<string> DomainJoinType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DomainPassword { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DomainUsername { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? OrganizationUnit { get; set; }
    ...
    public AzurermDevCenterNetworkConnectionTimeoutsBlock Timeouts { get; set; } = new();
