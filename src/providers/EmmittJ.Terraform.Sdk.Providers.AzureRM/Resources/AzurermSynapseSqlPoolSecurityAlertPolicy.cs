...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseSqlPoolSecurityAlertPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseSqlPoolSecurityAlertPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseSqlPoolSecurityAlertPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
