...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiTagTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiTag : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementApiTagTimeoutsBlock>? Timeouts { get; set; } = new();
