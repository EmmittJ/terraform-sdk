...
/// Nesting mode: single
/// </summary>
public class AzurermLogicAppIntegrationAccountSchemaTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermLogicAppIntegrationAccountSchema : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("file_name")]
    // Optional argument - user may or may not set a value
    ...
    public TerraformBlock<AzurermLogicAppIntegrationAccountSchemaTimeoutsBlock>? Timeouts { get; set; } = new();
