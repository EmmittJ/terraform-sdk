...
/// Nesting mode: list
/// </summary>
public class AzurermApiManagementStandaloneGatewaySkuBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementStandaloneGatewayTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementStandaloneGateway : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? BackendSubnetId { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermApiManagementStandaloneGatewaySkuBlock>>? Sku { get; set; } = new();
    ...
    public TerraformBlock<AzurermApiManagementStandaloneGatewayTimeoutsBlock>? Timeouts { get; set; } = new();
