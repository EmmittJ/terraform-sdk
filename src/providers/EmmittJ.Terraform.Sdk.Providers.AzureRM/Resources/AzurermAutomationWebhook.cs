...
public partial class AzurermAutomationWebhook : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ExpiryTime { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RunOnWorkerGroup { get; set; }
    ...
    public partial TerraformBlock<AzurermAutomationWebhookTimeoutsBlock>? Timeouts { get; set; }
