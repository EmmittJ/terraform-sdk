...
public partial class AzurermStorageBlob : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EncryptionScope { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourceContent { get; set; }
    ...
    public partial TerraformBlock<AzurermStorageBlobTimeoutsBlock>? Timeouts { get; set; }
