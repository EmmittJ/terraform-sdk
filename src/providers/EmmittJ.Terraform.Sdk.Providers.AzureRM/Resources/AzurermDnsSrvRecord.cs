...
/// Nesting mode: set
/// </summary>
public partial class AzurermDnsSrvRecordRecordBlock() : TerraformBlock("record")
{
    /// <summary>
    /// The port attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AzurermDnsSrvRecordTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermDnsSrvRecord : TerraformResource
{
    ...
    public required TerraformSet<AzurermDnsSrvRecordRecordBlock> Record { get; set; } = new();
    ...
    public AzurermDnsSrvRecordTimeoutsBlock Timeouts { get; set; } = new();
