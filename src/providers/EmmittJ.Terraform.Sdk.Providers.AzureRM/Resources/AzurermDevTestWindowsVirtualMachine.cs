...
/// Nesting mode: list
/// </summary>
public class AzurermDevTestWindowsVirtualMachineGalleryImageReferenceBlock : ITerraformBlock
{
    /// <summary>
    /// The offer attribute.
    /// </summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermDevTestWindowsVirtualMachineInboundNatRuleBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDevTestWindowsVirtualMachineTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDevTestWindowsVirtualMachine : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDevTestWindowsVirtualMachineGalleryImageReferenceBlock>>? GalleryImageReference { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermDevTestWindowsVirtualMachineInboundNatRuleBlock>>? InboundNatRule { get; set; } = new();
    ...
    public TerraformBlock<AzurermDevTestWindowsVirtualMachineTimeoutsBlock>? Timeouts { get; set; } = new();
