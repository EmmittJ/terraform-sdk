...
/// Nesting mode: single
/// </summary>
public class AzurermBatchJobTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermBatchJob : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> BatchPoolId { get; set; }
    ...
    public TerraformBlock<AzurermBatchJobTimeoutsBlock>? Timeouts { get; set; } = new();
