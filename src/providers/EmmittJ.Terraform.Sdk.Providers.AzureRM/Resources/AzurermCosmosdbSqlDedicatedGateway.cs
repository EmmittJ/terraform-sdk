...
public partial class AzurermCosmosdbSqlDedicatedGateway : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> InstanceSize { get; set; }
    ...
    public partial TerraformBlock<AzurermCosmosdbSqlDedicatedGatewayTimeoutsBlock>? Timeouts { get; set; }
