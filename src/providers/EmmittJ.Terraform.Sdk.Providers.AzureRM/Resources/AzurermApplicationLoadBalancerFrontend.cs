...
/// Nesting mode: single
/// </summary>
public class AzurermApplicationLoadBalancerFrontendTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApplicationLoadBalancerFrontend : TerraformResource
{
    ...
    public TerraformBlock<AzurermApplicationLoadBalancerFrontendTimeoutsBlock>? Timeouts { get; set; } = new();
