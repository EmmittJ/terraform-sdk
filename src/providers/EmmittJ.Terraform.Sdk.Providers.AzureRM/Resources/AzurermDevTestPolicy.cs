...
/// Nesting mode: single
/// </summary>
public partial class AzurermDevTestPolicyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermDevTestPolicy : TerraformResource
{
    ...
    public required partial TerraformValue<string> EvaluatorType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FactData { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PolicySetName { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Threshold { get; set; }
