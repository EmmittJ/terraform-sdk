...
/// Nesting mode: single
/// </summary>
public class AzurermMaintenanceAssignmentVirtualMachineTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMaintenanceAssignmentVirtualMachine : TerraformResource
{
    ...
    public TerraformBlock<AzurermMaintenanceAssignmentVirtualMachineTimeoutsBlock>? Timeouts { get; set; } = new();
