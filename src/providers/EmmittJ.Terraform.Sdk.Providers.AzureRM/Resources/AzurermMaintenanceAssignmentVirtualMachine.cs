...
/// <summary>
/// Block type for timeouts in AzurermMaintenanceAssignmentVirtualMachine.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_maintenance_assignment_virtual_machine Terraform resource.
/// Manages a azurerm_maintenance_assignment_virtual_machine resource.
/// </summary>
public partial class AzurermMaintenanceAssignmentVirtualMachine(string name) : TerraformResource("azurerm_maintenance_assignment_virtual_machine", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermMaintenanceAssignmentVirtualMachineTimeoutsBlock>("timeouts");
