...
/// Nesting mode: single
/// </summary>
public class AzurermUserAssignedIdentityTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermUserAssignedIdentity : TerraformResource
{
    ...
    public TerraformBlock<AzurermUserAssignedIdentityTimeoutsBlock>? Timeouts { get; set; } = new();
