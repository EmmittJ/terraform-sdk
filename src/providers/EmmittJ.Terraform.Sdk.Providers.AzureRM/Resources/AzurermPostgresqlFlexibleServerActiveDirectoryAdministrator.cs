...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlFlexibleServerActiveDirectoryAdministratorTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlFlexibleServerActiveDirectoryAdministrator : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> PrincipalName { get; set; }
    ...
    public TerraformBlock<AzurermPostgresqlFlexibleServerActiveDirectoryAdministratorTimeoutsBlock>? Timeouts { get; set; } = new();
