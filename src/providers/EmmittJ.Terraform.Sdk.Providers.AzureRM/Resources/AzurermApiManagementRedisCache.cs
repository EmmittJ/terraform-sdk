...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementRedisCacheTimeoutsBlock
{
    /// <summary>
...
public class AzurermApiManagementRedisCache : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("cache_location")]
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? CacheLocation { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? RedisCacheId { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementRedisCacheTimeoutsBlock>? Timeouts { get; set; }
