...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerIpamPoolTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerIpamPool : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ParentPoolName { get; set; }
    ...
    public TerraformBlock<AzurermNetworkManagerIpamPoolTimeoutsBlock>? Timeouts { get; set; } = new();
