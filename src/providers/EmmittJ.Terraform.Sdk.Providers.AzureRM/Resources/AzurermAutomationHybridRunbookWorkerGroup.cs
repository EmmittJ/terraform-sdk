...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationHybridRunbookWorkerGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationHybridRunbookWorkerGroup : TerraformResource
{
    ...
    public TerraformBlock<AzurermAutomationHybridRunbookWorkerGroupTimeoutsBlock>? Timeouts { get; set; } = new();
