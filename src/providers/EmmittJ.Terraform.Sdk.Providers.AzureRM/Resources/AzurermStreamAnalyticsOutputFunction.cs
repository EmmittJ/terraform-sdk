...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsOutputFunctionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsOutputFunction : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? BatchMaxCount { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? BatchMaxInBytes { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> FunctionApp { get; set; }
    ...
    public TerraformBlock<AzurermStreamAnalyticsOutputFunctionTimeoutsBlock>? Timeouts { get; set; } = new();
