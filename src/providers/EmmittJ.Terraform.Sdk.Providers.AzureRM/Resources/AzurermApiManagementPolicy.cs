...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
