...
/// Nesting mode: single
/// </summary>
public class AzurermMssqlServerExtendedAuditingPolicyTimeoutsBlock
{
    /// <summary>
...
public class AzurermMssqlServerExtendedAuditingPolicy : TerraformResource
{
    ...
    public TerraformList<string> AuditActionsAndGroups { get; set; } = default!;
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? PredicateExpression { get; set; }
    ...
    public TerraformBlock<AzurermMssqlServerExtendedAuditingPolicyTimeoutsBlock>? Timeouts { get; set; }
