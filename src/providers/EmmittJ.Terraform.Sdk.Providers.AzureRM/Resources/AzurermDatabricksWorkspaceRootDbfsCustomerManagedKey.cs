...
/// Nesting mode: single
/// </summary>
public class AzurermDatabricksWorkspaceRootDbfsCustomerManagedKeyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDatabricksWorkspaceRootDbfsCustomerManagedKey : TerraformResource
{
    ...
    public TerraformBlock<AzurermDatabricksWorkspaceRootDbfsCustomerManagedKeyTimeoutsBlock>? Timeouts { get; set; } = new();
