...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlActiveDirectoryAdministratorTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlActiveDirectoryAdministrator : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlActiveDirectoryAdministratorTimeoutsBlock>? Timeouts { get; set; } = new();
