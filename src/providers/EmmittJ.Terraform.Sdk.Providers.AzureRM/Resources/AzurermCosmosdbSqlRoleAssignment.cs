...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbSqlRoleAssignmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbSqlRoleAssignment : TerraformResource
{
    ...
    public TerraformBlock<AzurermCosmosdbSqlRoleAssignmentTimeoutsBlock>? Timeouts { get; set; } = new();
