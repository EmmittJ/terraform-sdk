...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationConnection : TerraformResource
{
    ...
    public TerraformBlock<AzurermAutomationConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
