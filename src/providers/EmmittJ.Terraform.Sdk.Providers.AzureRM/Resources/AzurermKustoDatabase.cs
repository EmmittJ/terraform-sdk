...
/// Nesting mode: single
/// </summary>
public partial class AzurermKustoDatabaseTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermKustoDatabase : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? HotCachePeriod { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SoftDeletePeriod { get; set; }
    ...
    public partial TerraformBlock<AzurermKustoDatabaseTimeoutsBlock>? Timeouts { get; set; }
