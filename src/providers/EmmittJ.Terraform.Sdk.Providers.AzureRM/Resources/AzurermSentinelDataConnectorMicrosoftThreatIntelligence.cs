...
/// Nesting mode: single
/// </summary>
public partial class AzurermSentinelDataConnectorMicrosoftThreatIntelligenceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSentinelDataConnectorMicrosoftThreatIntelligence : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> MicrosoftEmergingThreatFeedLookbackDate { get; set; }
    ...
    public AzurermSentinelDataConnectorMicrosoftThreatIntelligenceTimeoutsBlock Timeouts { get; set; } = new();
