...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorMicrosoftThreatIntelligenceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorMicrosoftThreatIntelligence : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MicrosoftEmergingThreatFeedLookbackDate { get; set; }
    ...
    public TerraformBlock<AzurermSentinelDataConnectorMicrosoftThreatIntelligenceTimeoutsBlock>? Timeouts { get; set; } = new();
