...
/// </summary>
public class AzurermDnsCnameRecord : TerraformResource
{
    public AzurermDnsCnameRecord(string name) : base("azurerm_dns_cname_record", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AzurermDnsCnameRecordTimeoutsBlock>("timeouts");
