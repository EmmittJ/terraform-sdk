...
/// Nesting mode: single
/// </summary>
public partial class AzurermApiManagementIdentityProviderAadTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermApiManagementIdentityProviderAad : TerraformResource
{
    ...
    public AzurermApiManagementIdentityProviderAadTimeoutsBlock Timeouts { get; set; } = new();
