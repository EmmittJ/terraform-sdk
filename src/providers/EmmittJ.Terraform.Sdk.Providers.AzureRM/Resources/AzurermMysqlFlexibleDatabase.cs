...
/// Nesting mode: single
/// </summary>
public class AzurermMysqlFlexibleDatabaseTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMysqlFlexibleDatabase : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> Charset { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Collation { get; set; }
    ...
    public TerraformBlock<AzurermMysqlFlexibleDatabaseTimeoutsBlock>? Timeouts { get; set; } = new();
