...
/// Nesting mode: list
/// </summary>
public class AzurermStackHciLogicalNetworkSubnetBlock
{
    /// <summary>
    ...
    public required TerraformValue<string> IpAllocationMethod { get; set; }
...
/// Nesting mode: single
/// </summary>
public class AzurermStackHciLogicalNetworkTimeoutsBlock
{
    /// <summary>
...
public class AzurermStackHciLogicalNetwork : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> VirtualSwitchName { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermStackHciLogicalNetworkSubnetBlock>>? Subnet { get; set; }
    ...
    public TerraformBlock<AzurermStackHciLogicalNetworkTimeoutsBlock>? Timeouts { get; set; }
