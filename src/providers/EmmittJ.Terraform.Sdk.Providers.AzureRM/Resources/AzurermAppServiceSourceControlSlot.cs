...
/// Nesting mode: list
/// </summary>
public partial class AzurermAppServiceSourceControlSlotGithubActionConfigurationBlock() : TerraformBlock("github_action_configuration")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class AzurermAppServiceSourceControlSlotTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermAppServiceSourceControlSlot : TerraformResource
{
    ...
    public TerraformList<AzurermAppServiceSourceControlSlotGithubActionConfigurationBlock> GithubActionConfiguration { get; set; } = new();
    ...
    public AzurermAppServiceSourceControlSlotTimeoutsBlock Timeouts { get; set; } = new();
