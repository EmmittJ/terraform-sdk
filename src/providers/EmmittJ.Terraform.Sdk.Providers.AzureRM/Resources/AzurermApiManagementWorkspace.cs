...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementWorkspaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementWorkspace : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementWorkspaceTimeoutsBlock>? Timeouts { get; set; } = new();
