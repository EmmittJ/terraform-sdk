...
public partial class AzurermAutomationJobSchedule : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> JobScheduleId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RunOn { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ScheduleName { get; set; }
    ...
    public partial TerraformBlock<AzurermAutomationJobScheduleTimeoutsBlock>? Timeouts { get; set; }
