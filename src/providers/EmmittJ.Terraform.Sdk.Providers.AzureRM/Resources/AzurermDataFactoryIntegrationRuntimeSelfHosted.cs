...
public partial class AzurermDataFactoryIntegrationRuntimeSelfHosted : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SelfContainedInteractiveAuthoringEnabled { get; set; }
    ...
    public partial TerraformValue<string> PrimaryAuthorizationKey { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SecondaryAuthorizationKey { get; }
