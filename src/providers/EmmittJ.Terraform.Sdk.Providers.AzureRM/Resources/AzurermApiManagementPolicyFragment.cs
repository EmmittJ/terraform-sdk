...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementPolicyFragmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementPolicyFragment : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementPolicyFragmentTimeoutsBlock>? Timeouts { get; set; } = new();
