...
/// Nesting mode: list
/// </summary>
public class AzurermSpringCloudConnectionAuthenticationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermSpringCloudConnectionSecretStoreBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSpringCloudConnection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SpringCloudId { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermSpringCloudConnectionAuthenticationBlock>>? Authentication { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermSpringCloudConnectionSecretStoreBlock>>? SecretStore { get; set; } = new();
    ...
    public TerraformBlock<AzurermSpringCloudConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
