...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsAaaaRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsAaaaRecord : TerraformResource
{
    ...
    public TerraformBlock<AzurermPrivateDnsAaaaRecordTimeoutsBlock>? Timeouts { get; set; } = new();
