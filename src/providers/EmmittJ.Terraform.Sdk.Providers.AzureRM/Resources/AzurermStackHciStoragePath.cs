...
/// Nesting mode: single
/// </summary>
public class AzurermStackHciStoragePathTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStackHciStoragePath : TerraformResource
{
    ...
    public TerraformBlock<AzurermStackHciStoragePathTimeoutsBlock>? Timeouts { get; set; } = new();
