...
/// Nesting mode: single
/// </summary>
public partial class AzurermStackHciStoragePathTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermStackHciStoragePath : TerraformResource
{
    ...
    public AzurermStackHciStoragePathTimeoutsBlock Timeouts { get; set; } = new();
