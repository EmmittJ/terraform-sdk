...
/// Nesting mode: list
/// </summary>
public class AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaDestinationNatBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaDnsSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaNetworkProfileBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPaloAltoNextGenerationFirewallVirtualHubPanorama : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaDestinationNatBlock>>? DestinationNat { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaDnsSettingsBlock>>? DnsSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaNetworkProfileBlock>>? NetworkProfile { get; set; } = new();
    ...
    public TerraformBlock<AzurermPaloAltoNextGenerationFirewallVirtualHubPanoramaTimeoutsBlock>? Timeouts { get; set; } = new();
