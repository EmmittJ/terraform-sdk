...
/// Nesting mode: list
/// </summary>
public class AzurermStreamAnalyticsOutputBlobSerializationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsOutputBlobTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsOutputBlob : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? BatchMaxWaitTime { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? BatchMinRows { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? BlobWriteMode { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsOutputBlobSerializationBlock>>? Serialization { get; set; } = new();
    ...
    public TerraformBlock<AzurermStreamAnalyticsOutputBlobTimeoutsBlock>? Timeouts { get; set; } = new();
