...
public partial class AzurermBotChannelMsTeams : TerraformResource
{
    ...
    public partial TerraformValue<bool> CallingEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> CallingWebHook { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DeploymentEnvironment { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> EnableCalling { get; set; }
    ...
    public partial TerraformBlock<AzurermBotChannelMsTeamsTimeoutsBlock>? Timeouts { get; set; }
