...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryLinkedServiceSqlServerKeyVaultConnectionStringBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryLinkedServiceSqlServerKeyVaultPasswordBlock : ITerraformBlock
{
    /// <summary>
    /// The linked_service_name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceSqlServerTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceSqlServer : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryLinkedServiceSqlServerKeyVaultConnectionStringBlock>>? KeyVaultConnectionString { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryLinkedServiceSqlServerKeyVaultPasswordBlock>>? KeyVaultPassword { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceSqlServerTimeoutsBlock>? Timeouts { get; set; } = new();
