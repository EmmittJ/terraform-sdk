...
public class AzurermArcResourceBridgeAppliance : TerraformResource
{
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("distro");
        set => SetProperty("distro", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("infrastructure_provider");
        set => SetProperty("infrastructure_provider", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("public_key_base64");
        set => SetProperty("public_key_base64", value);
    }
