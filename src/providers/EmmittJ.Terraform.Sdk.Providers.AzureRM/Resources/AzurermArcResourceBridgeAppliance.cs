...
/// Nesting mode: list
/// </summary>
public class AzurermArcResourceBridgeApplianceIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermArcResourceBridgeApplianceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermArcResourceBridgeAppliance : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Distro { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> InfrastructureProvider { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? PublicKeyBase64 { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermArcResourceBridgeApplianceIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermArcResourceBridgeApplianceTimeoutsBlock>? Timeouts { get; set; } = new();
