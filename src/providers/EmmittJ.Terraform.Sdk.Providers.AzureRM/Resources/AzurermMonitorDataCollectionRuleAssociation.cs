...
/// Nesting mode: single
/// </summary>
public class AzurermMonitorDataCollectionRuleAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMonitorDataCollectionRuleAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermMonitorDataCollectionRuleAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
