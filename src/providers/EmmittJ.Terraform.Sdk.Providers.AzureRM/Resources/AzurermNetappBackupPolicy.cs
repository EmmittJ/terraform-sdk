...
/// Nesting mode: single
/// </summary>
public partial class AzurermNetappBackupPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermNetappBackupPolicy : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<double>? DailyBackupsToKeep { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<double>? MonthlyBackupsToKeep { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<double>? WeeklyBackupsToKeep { get; set; }
    ...
    public TerraformBlock<AzurermNetappBackupPolicyTimeoutsBlock>? Timeouts { get; set; }
