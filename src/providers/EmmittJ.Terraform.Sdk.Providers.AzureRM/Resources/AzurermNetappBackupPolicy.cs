...
/// Nesting mode: single
/// </summary>
public class AzurermNetappBackupPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetappBackupPolicy : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? DailyBackupsToKeep { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? MonthlyBackupsToKeep { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? WeeklyBackupsToKeep { get; set; }
    ...
    public TerraformBlock<AzurermNetappBackupPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
