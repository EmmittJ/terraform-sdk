...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSlotAuthSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSlotAuthSettingsV2Block : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSlotBackupBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermWindowsFunctionAppSlotConnectionStringBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSlotIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSlotSiteConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermWindowsFunctionAppSlotStorageAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermWindowsFunctionAppSlotTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermWindowsFunctionAppSlot : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSlotAuthSettingsBlock>>? AuthSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSlotAuthSettingsV2Block>>? AuthSettingsV2 { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSlotBackupBlock>>? Backup { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermWindowsFunctionAppSlotConnectionStringBlock>>? ConnectionString { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSlotIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSlotSiteConfigBlock>>? SiteConfig { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermWindowsFunctionAppSlotStorageAccountBlock>>? StorageAccount { get; set; } = new();
    ...
    public TerraformBlock<AzurermWindowsFunctionAppSlotTimeoutsBlock>? Timeouts { get; set; } = new();
