...
/// Nesting mode: list
/// </summary>
public class AzurermSpringCloudBuildDeploymentQuotaBlock
{
    /// <summary>
    /// The cpu attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudBuildDeploymentTimeoutsBlock
{
    /// <summary>
...
public class AzurermSpringCloudBuildDeployment : TerraformResource
{
    ...
    public required TerraformValue<string> BuildResultId { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermSpringCloudBuildDeploymentQuotaBlock>>? Quota { get; set; }
    ...
    public TerraformBlock<AzurermSpringCloudBuildDeploymentTimeoutsBlock>? Timeouts { get; set; }
