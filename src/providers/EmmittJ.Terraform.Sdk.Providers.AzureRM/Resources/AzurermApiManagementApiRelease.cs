...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiReleaseTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiRelease : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementApiReleaseTimeoutsBlock>? Timeouts { get; set; } = new();
