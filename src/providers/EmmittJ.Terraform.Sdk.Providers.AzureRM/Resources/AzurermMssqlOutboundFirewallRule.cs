...
/// Nesting mode: single
/// </summary>
public class AzurermMssqlOutboundFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMssqlOutboundFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermMssqlOutboundFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
