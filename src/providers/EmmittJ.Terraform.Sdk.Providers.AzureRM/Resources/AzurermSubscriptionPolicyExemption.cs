...
/// Nesting mode: single
/// </summary>
public class AzurermSubscriptionPolicyExemptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSubscriptionPolicyExemption : TerraformResource
{
    ...
    public TerraformBlock<AzurermSubscriptionPolicyExemptionTimeoutsBlock>? Timeouts { get; set; } = new();
