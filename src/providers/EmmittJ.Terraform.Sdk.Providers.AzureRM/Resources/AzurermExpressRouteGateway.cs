...
/// Nesting mode: single
/// </summary>
public class AzurermExpressRouteGatewayTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermExpressRouteGateway : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("allow_non_virtual_wan_traffic")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AllowNonVirtualWanTraffic { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<double>> ScaleUnits { get; set; }
    ...
    public TerraformBlock<AzurermExpressRouteGatewayTimeoutsBlock>? Timeouts { get; set; } = new();
