...
/// </summary>
public partial class AzurermMssqlFirewallRule(string name) : TerraformResource("azurerm_mssql_firewall_rule", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermMssqlFirewallRuleTimeoutsBlock>("timeouts");
