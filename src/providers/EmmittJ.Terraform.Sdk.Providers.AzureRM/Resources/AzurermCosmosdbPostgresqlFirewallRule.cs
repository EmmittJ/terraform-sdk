...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbPostgresqlFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbPostgresqlFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermCosmosdbPostgresqlFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
