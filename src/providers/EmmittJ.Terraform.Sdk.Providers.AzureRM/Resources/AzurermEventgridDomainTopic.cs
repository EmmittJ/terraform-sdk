...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridDomainTopicTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventgridDomainTopic : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventgridDomainTopicTimeoutsBlock>? Timeouts { get; set; } = new();
