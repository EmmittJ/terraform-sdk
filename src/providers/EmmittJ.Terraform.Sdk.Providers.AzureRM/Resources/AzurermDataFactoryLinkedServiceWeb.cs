...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceWebTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceWeb : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceWebTimeoutsBlock>? Timeouts { get; set; } = new();
