...
/// Nesting mode: single
/// </summary>
public partial class AzurermContainerAppEnvironmentCertificateTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermContainerAppEnvironmentCertificate : TerraformResource
{
    ...
    public required partial TerraformValue<string> CertificateBlobBase64 { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> CertificatePassword { get; set; }
    ...
    public AzurermContainerAppEnvironmentCertificateTimeoutsBlock Timeouts { get; set; } = new();
