...
/// Nesting mode: single
/// </summary>
public class AzurermManagementGroupPolicyExemptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermManagementGroupPolicyExemption : TerraformResource
{
    ...
    public TerraformBlock<AzurermManagementGroupPolicyExemptionTimeoutsBlock>? Timeouts { get; set; } = new();
