...
public partial class AzurermKustoAttachedDatabaseConfigurationSharingBlock : TerraformBlockBase
{
    ...
    public partial TerraformSet<string>? ExternalTablesToExclude { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? ExternalTablesToInclude { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? MaterializedViewsToExclude { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? MaterializedViewsToInclude { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? TablesToExclude { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? TablesToInclude { get; set; }
...
public partial class AzurermKustoAttachedDatabaseConfiguration : TerraformResource
{
    ...
    public partial TerraformValue<string> ClusterId { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ClusterResourceId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DefaultPrincipalModificationKind { get; set; }
    ...
    public partial TerraformList<string> AttachedDatabaseNames { get; }
