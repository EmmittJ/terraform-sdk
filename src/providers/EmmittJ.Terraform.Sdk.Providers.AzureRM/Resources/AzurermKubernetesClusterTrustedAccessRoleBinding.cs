...
/// Nesting mode: single
/// </summary>
public class AzurermKubernetesClusterTrustedAccessRoleBindingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermKubernetesClusterTrustedAccessRoleBinding : TerraformResource
{
    ...
    public TerraformBlock<AzurermKubernetesClusterTrustedAccessRoleBindingTimeoutsBlock>? Timeouts { get; set; } = new();
