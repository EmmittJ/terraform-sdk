...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsPtrRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsPtrRecord : TerraformResource
{
    ...
    public TerraformBlock<AzurermPrivateDnsPtrRecordTimeoutsBlock>? Timeouts { get; set; } = new();
