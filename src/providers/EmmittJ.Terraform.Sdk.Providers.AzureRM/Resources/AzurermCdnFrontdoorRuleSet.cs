...
/// Nesting mode: single
/// </summary>
public class AzurermCdnFrontdoorRuleSetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCdnFrontdoorRuleSet : TerraformResource
{
    ...
    public TerraformBlock<AzurermCdnFrontdoorRuleSetTimeoutsBlock>? Timeouts { get; set; } = new();
