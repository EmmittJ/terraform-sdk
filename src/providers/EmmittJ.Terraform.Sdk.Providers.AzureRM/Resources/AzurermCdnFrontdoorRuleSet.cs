...
/// <summary>
/// Block type for timeouts in AzurermCdnFrontdoorRuleSet.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_cdn_frontdoor_rule_set Terraform resource.
/// Manages a azurerm_cdn_frontdoor_rule_set resource.
/// </summary>
public partial class AzurermCdnFrontdoorRuleSet(string name) : TerraformResource("azurerm_cdn_frontdoor_rule_set", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermCdnFrontdoorRuleSetTimeoutsBlock>("timeouts");
