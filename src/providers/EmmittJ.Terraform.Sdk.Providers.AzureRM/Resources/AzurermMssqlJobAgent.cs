...
/// Nesting mode: list
/// </summary>
public class AzurermMssqlJobAgentIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermMssqlJobAgentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMssqlJobAgent : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermMssqlJobAgentIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermMssqlJobAgentTimeoutsBlock>? Timeouts { get; set; } = new();
