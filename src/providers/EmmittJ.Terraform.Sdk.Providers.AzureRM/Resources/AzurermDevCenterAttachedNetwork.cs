...
/// Nesting mode: single
/// </summary>
public class AzurermDevCenterAttachedNetworkTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDevCenterAttachedNetwork : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> NetworkConnectionId { get; set; }
    ...
    public TerraformBlock<AzurermDevCenterAttachedNetworkTimeoutsBlock>? Timeouts { get; set; } = new();
