...
public partial class AzurermStreamAnalyticsReferenceInputBlob : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsReferenceInputBlobSerializationBlock>>? Serialization { get; set; }
    ...
    public TerraformBlock<AzurermStreamAnalyticsReferenceInputBlobTimeoutsBlock>? Timeouts { get; set; }
