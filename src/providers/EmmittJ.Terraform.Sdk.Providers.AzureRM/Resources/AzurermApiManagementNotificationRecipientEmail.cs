...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementNotificationRecipientEmailTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementNotificationRecipientEmail : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementNotificationRecipientEmailTimeoutsBlock>? Timeouts { get; set; } = new();
