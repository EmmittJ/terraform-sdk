...
/// Nesting mode: single
/// </summary>
public class AzurermServicebusQueueAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermServicebusQueueAuthorizationRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermServicebusQueueAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
