...
public partial class AzurermAutomationModule : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermAutomationModuleModuleLinkBlock>>? ModuleLink { get; set; }
    ...
    public TerraformBlock<AzurermAutomationModuleTimeoutsBlock>? Timeouts { get; set; }
