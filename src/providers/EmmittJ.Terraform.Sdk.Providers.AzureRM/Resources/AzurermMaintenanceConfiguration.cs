...
/// Nesting mode: list
/// </summary>
public class AzurermMaintenanceConfigurationInstallPatchesBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermMaintenanceConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermMaintenanceConfigurationWindowBlock : ITerraformBlock
{
    /// <summary>
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ExpirationDateTime { get; set; }
    ...
    public required TerraformProperty<TerraformProperty<string>> StartDateTime { get; set; }
...
public class AzurermMaintenanceConfiguration : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? InGuestUserPatchMode { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermMaintenanceConfigurationInstallPatchesBlock>>? InstallPatches { get; set; } = new();
    ...
    public TerraformBlock<AzurermMaintenanceConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermMaintenanceConfigurationWindowBlock>>? Window { get; set; } = new();
