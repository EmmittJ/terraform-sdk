...
public partial class AzurermStreamAnalyticsOutputEventhub(string name) : TerraformResource("azurerm_stream_analytics_output_eventhub", name)
{
    ...
    public required AzurermStreamAnalyticsOutputEventhubSerializationBlock Serialization
    {
        get => GetRequiredArgument<AzurermStreamAnalyticsOutputEventhubSerializationBlock>("serialization");
