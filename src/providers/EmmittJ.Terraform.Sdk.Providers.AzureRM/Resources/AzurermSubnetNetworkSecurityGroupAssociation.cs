...
/// Nesting mode: single
/// </summary>
public class AzurermSubnetNetworkSecurityGroupAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSubnetNetworkSecurityGroupAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermSubnetNetworkSecurityGroupAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
