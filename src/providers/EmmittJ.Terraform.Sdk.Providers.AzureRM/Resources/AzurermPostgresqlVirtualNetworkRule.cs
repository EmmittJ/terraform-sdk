...
public partial class AzurermPostgresqlVirtualNetworkRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlVirtualNetworkRuleTimeoutsBlock>? Timeouts { get; set; }
