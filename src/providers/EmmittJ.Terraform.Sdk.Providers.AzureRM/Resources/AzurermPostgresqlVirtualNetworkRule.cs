...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlVirtualNetworkRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlVirtualNetworkRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlVirtualNetworkRuleTimeoutsBlock>? Timeouts { get; set; } = new();
