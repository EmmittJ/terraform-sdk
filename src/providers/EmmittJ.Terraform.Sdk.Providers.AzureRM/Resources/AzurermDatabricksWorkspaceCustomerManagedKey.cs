...
/// Nesting mode: single
/// </summary>
public class AzurermDatabricksWorkspaceCustomerManagedKeyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDatabricksWorkspaceCustomerManagedKey : TerraformResource
{
    ...
    public TerraformBlock<AzurermDatabricksWorkspaceCustomerManagedKeyTimeoutsBlock>? Timeouts { get; set; } = new();
