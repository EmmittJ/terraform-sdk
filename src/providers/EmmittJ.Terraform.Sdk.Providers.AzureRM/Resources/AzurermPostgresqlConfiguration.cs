...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlConfiguration : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
