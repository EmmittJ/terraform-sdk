...
/// Nesting mode: list
/// </summary>
public class AzurermBillingAccountCostManagementExportExportDataOptionsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermBillingAccountCostManagementExportExportDataStorageLocationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermBillingAccountCostManagementExportTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermBillingAccountCostManagementExport : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermBillingAccountCostManagementExportExportDataOptionsBlock>>? ExportDataOptions { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermBillingAccountCostManagementExportExportDataStorageLocationBlock>>? ExportDataStorageLocation { get; set; } = new();
    ...
    public TerraformBlock<AzurermBillingAccountCostManagementExportTimeoutsBlock>? Timeouts { get; set; } = new();
