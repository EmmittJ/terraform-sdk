...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerSubscriptionConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerSubscriptionConnection : TerraformResource
{
    ...
    public TerraformBlock<AzurermNetworkManagerSubscriptionConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
