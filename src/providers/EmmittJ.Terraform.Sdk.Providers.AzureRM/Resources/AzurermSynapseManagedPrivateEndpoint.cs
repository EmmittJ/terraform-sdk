...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseManagedPrivateEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseManagedPrivateEndpoint : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseManagedPrivateEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
