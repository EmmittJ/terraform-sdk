...
/// Nesting mode: single
/// </summary>
public class AzurermBatchApplicationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermBatchApplication : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AllowUpdates { get; set; }
    ...
    public TerraformBlock<AzurermBatchApplicationTimeoutsBlock>? Timeouts { get; set; } = new();
