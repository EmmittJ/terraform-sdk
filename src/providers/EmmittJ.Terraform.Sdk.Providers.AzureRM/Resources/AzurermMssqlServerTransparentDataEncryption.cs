...
/// Nesting mode: single
/// </summary>
public class AzurermMssqlServerTransparentDataEncryptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMssqlServerTransparentDataEncryption : TerraformResource
{
    ...
    public TerraformBlock<AzurermMssqlServerTransparentDataEncryptionTimeoutsBlock>? Timeouts { get; set; } = new();
