...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorOffice365ProjectTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class AzurermSentinelDataConnectorOffice365Project : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorOffice365ProjectTimeoutsBlock>? Timeouts { get; set; } = new();
