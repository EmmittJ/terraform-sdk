...
/// Nesting mode: single
/// </summary>
public class AzurermDevCenterGalleryTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDevCenterGallery : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SharedGalleryId { get; set; }
    ...
    public TerraformBlock<AzurermDevCenterGalleryTimeoutsBlock>? Timeouts { get; set; } = new();
