...
/// Nesting mode: single
/// </summary>
public partial class AzurermDevCenterGalleryTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermDevCenterGallery : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> SharedGalleryId { get; set; }
    ...
    public TerraformBlock<AzurermDevCenterGalleryTimeoutsBlock>? Timeouts { get; set; }
