...
/// Nesting mode: single
/// </summary>
public partial class AzurermLogAnalyticsWorkspaceTableTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermLogAnalyticsWorkspaceTable : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Plan { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? TotalRetentionInDays { get; set; }
    ...
    public AzurermLogAnalyticsWorkspaceTableTimeoutsBlock Timeouts { get; set; } = new();
