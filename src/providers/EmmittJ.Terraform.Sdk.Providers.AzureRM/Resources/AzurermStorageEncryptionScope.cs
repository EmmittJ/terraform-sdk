...
/// Nesting mode: single
/// </summary>
public class AzurermStorageEncryptionScopeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStorageEncryptionScope : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? InfrastructureEncryptionRequired { get; set; }
    ...
    public TerraformBlock<AzurermStorageEncryptionScopeTimeoutsBlock>? Timeouts { get; set; } = new();
