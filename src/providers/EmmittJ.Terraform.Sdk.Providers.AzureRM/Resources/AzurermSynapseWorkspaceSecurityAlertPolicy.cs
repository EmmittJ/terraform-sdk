...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseWorkspaceSecurityAlertPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseWorkspaceSecurityAlertPolicy : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> PolicyState { get; set; }
    ...
    public TerraformBlock<AzurermSynapseWorkspaceSecurityAlertPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
