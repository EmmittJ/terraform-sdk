...
/// Nesting mode: single
/// </summary>
public class AzurermDedicatedHostGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDedicatedHostGroup : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AutomaticPlacementEnabled { get; set; }
    ...
    public TerraformBlock<AzurermDedicatedHostGroupTimeoutsBlock>? Timeouts { get; set; } = new();
