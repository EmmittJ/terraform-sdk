...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationConnectionClassicCertificateTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationConnectionClassicCertificate : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> CertificateAssetName { get; set; }
    ...
    public TerraformBlock<AzurermAutomationConnectionClassicCertificateTimeoutsBlock>? Timeouts { get; set; } = new();
