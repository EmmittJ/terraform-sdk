...
public partial class AzurermNginxApiKey : TerraformResource
{
    ...
    public required partial TerraformValue<string> EndDateTime { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SecretText { get; set; }
    ...
    public partial TerraformBlock<AzurermNginxApiKeyTimeoutsBlock>? Timeouts { get; set; }
