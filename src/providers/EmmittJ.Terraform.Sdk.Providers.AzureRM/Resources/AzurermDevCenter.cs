...
public class AzurermDevCenter : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("location");
        SetOutput("name");
        SetOutput("project_catalog_item_sync_enabled");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<bool>>("project_catalog_item_sync_enabled");
        set => SetProperty("project_catalog_item_sync_enabled", value);
    }
    ...
    public List<AzurermDevCenterIdentityBlock>? Identity
    {
    ...
    /// Nesting mode: single
    /// </summary>
    public AzurermDevCenterTimeoutsBlock? Timeouts
    {
