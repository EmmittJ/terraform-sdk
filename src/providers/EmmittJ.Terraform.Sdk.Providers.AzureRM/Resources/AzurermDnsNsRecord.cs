...
/// Nesting mode: single
/// </summary>
public class AzurermDnsNsRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDnsNsRecord : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformProperty<List<TerraformProperty<string>>>? Records { get; set; }
    ...
    public TerraformBlock<AzurermDnsNsRecordTimeoutsBlock>? Timeouts { get; set; } = new();
