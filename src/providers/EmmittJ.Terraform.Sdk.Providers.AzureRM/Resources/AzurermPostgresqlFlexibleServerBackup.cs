...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlFlexibleServerBackupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlFlexibleServerBackup : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlFlexibleServerBackupTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<TerraformProperty<string>> CompletedTime => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "completed_time");
