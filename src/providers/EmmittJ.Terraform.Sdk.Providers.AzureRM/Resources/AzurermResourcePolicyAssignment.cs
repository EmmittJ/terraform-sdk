...
/// Nesting mode: list
/// </summary>
public class AzurermResourcePolicyAssignmentIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermResourcePolicyAssignmentNonComplianceMessageBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermResourcePolicyAssignmentOverridesBlock : ITerraformBlock
{
    /// <summary>
    /// The value attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermResourcePolicyAssignmentResourceSelectorsBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermResourcePolicyAssignmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermResourcePolicyAssignment : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermResourcePolicyAssignmentIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermResourcePolicyAssignmentNonComplianceMessageBlock>>? NonComplianceMessage { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermResourcePolicyAssignmentOverridesBlock>>? Overrides { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermResourcePolicyAssignmentResourceSelectorsBlock>>? ResourceSelectors { get; set; } = new();
    ...
    public TerraformBlock<AzurermResourcePolicyAssignmentTimeoutsBlock>? Timeouts { get; set; } = new();
