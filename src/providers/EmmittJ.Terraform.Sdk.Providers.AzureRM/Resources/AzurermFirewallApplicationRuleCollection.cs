...
/// Nesting mode: list
/// </summary>
public partial class AzurermFirewallApplicationRuleCollectionRuleBlock() : TerraformBlock("rule")
{
    /// <summary>
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? FqdnTags { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? TargetFqdns { get; set; }
...
/// Nesting mode: single
/// </summary>
public partial class AzurermFirewallApplicationRuleCollectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
