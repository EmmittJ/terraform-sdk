...
/// Nesting mode: list
/// </summary>
public partial class AzurermFirewallApplicationRuleCollectionRuleBlock : TerraformBlockBase
{
    /// <summary>
    ...
    /// </summary>
    [TerraformProperty("fqdn_tags")]
    // Optional argument - source generator will implement get/set
    public TerraformList<string>? FqdnTags { get; set; }
    ...
    /// </summary>
    [TerraformProperty("target_fqdns")]
    // Optional argument - source generator will implement get/set
    public TerraformList<string>? TargetFqdns { get; set; }
...
/// Nesting mode: single
/// </summary>
public partial class AzurermFirewallApplicationRuleCollectionTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermFirewallApplicationRuleCollection : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermFirewallApplicationRuleCollectionRuleBlock>>? Rule { get; set; }
    ...
    public TerraformBlock<AzurermFirewallApplicationRuleCollectionTimeoutsBlock>? Timeouts { get; set; }
