...
/// Nesting mode: list
/// </summary>
public class AzurermFirewallApplicationRuleCollectionRuleBlock : ITerraformBlock
{
    /// <summary>
    ...
    /// </summary>
    [TerraformPropertyName("fqdn_tags")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? FqdnTags { get; set; }
    ...
    /// </summary>
    [TerraformPropertyName("target_fqdns")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? TargetFqdns { get; set; }
...
/// Nesting mode: single
/// </summary>
public class AzurermFirewallApplicationRuleCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermFirewallApplicationRuleCollection : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermFirewallApplicationRuleCollectionRuleBlock>>? Rule { get; set; } = new();
    ...
    public TerraformBlock<AzurermFirewallApplicationRuleCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
