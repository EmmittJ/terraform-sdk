...
/// <summary>
/// Block type for timeouts in AzurermIothubEndpointServicebusQueue.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_iothub_endpoint_servicebus_queue Terraform resource.
/// Manages a azurerm_iothub_endpoint_servicebus_queue resource.
/// </summary>
public partial class AzurermIothubEndpointServicebusQueue(string name) : TerraformResource("azurerm_iothub_endpoint_servicebus_queue", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermIothubEndpointServicebusQueueTimeoutsBlock>("timeouts");
