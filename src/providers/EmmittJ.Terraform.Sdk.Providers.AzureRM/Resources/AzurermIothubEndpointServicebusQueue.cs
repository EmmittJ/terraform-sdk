...
/// Nesting mode: single
/// </summary>
public class AzurermIothubEndpointServicebusQueueTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubEndpointServicebusQueue : TerraformResource
{
    ...
    public TerraformBlock<AzurermIothubEndpointServicebusQueueTimeoutsBlock>? Timeouts { get; set; } = new();
