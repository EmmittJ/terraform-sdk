...
public class AzurermDigitalTwinsEndpointServicebus : TerraformResource
{
    ...
    [TerraformArgument("servicebus_primary_connection_string")]
    ...
    [TerraformArgument("servicebus_secondary_connection_string")]
    ...
    public AzurermDigitalTwinsEndpointServicebusTimeoutsBlock Timeouts { get; set; } = new();
