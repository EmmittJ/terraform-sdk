...
/// Nesting mode: single
/// </summary>
public class AzurermEventhubConsumerGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventhubConsumerGroup : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventhubConsumerGroupTimeoutsBlock>? Timeouts { get; set; } = new();
