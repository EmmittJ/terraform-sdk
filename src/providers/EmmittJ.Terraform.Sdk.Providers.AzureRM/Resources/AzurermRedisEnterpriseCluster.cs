...
/// Nesting mode: single
/// </summary>
public class AzurermRedisEnterpriseClusterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRedisEnterpriseCluster : TerraformResource
{
    ...
    public TerraformBlock<AzurermRedisEnterpriseClusterTimeoutsBlock>? Timeouts { get; set; } = new();
