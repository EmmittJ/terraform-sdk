...
/// Nesting mode: single
/// </summary>
public partial class AzurermIothubEndpointStorageContainerTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermIothubEndpointStorageContainer : TerraformResource
{
    ...
    public AzurermIothubEndpointStorageContainerTimeoutsBlock Timeouts { get; set; } = new();
