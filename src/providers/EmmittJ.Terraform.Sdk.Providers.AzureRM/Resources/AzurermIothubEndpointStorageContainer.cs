...
/// Nesting mode: single
/// </summary>
public partial class AzurermIothubEndpointStorageContainerTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermIothubEndpointStorageContainer : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("batch_frequency_in_seconds")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? BatchFrequencyInSeconds { get; set; }
    ...
    /// </summary>
    [TerraformProperty("file_name_format")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FileNameFormat { get; set; }
    ...
    /// </summary>
    [TerraformProperty("max_chunk_size_in_bytes")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxChunkSizeInBytes { get; set; }
    ...
    public partial TerraformBlock<AzurermIothubEndpointStorageContainerTimeoutsBlock>? Timeouts { get; set; }
