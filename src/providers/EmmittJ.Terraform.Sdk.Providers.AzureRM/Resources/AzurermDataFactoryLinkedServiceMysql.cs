...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceMysqlTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceMysql : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceMysqlTimeoutsBlock>? Timeouts { get; set; } = new();
