...
/// Nesting mode: single
/// </summary>
public class AzurermMysqlFlexibleServerConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMysqlFlexibleServerConfiguration : TerraformResource
{
    ...
    public TerraformBlock<AzurermMysqlFlexibleServerConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
