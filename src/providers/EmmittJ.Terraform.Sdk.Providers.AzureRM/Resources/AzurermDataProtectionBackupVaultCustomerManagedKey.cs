...
/// Nesting mode: single
/// </summary>
public class AzurermDataProtectionBackupVaultCustomerManagedKeyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataProtectionBackupVaultCustomerManagedKey : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> DataProtectionBackupVaultId { get; set; }
    ...
    public TerraformBlock<AzurermDataProtectionBackupVaultCustomerManagedKeyTimeoutsBlock>? Timeouts { get; set; } = new();
