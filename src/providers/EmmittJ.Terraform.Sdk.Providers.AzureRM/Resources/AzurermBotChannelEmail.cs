...
public class AzurermBotChannelEmail : TerraformResource
{
    ...
    /// </summary>
    [TerraformArgument("email_password")]
    public TerraformValue<string>? EmailPassword
    {
        get => new TerraformReference<string>(this, "email_password");
    ...
    /// </summary>
    [TerraformArgument("magic_code")]
    public TerraformValue<string>? MagicCode
    {
        get => new TerraformReference<string>(this, "magic_code");
