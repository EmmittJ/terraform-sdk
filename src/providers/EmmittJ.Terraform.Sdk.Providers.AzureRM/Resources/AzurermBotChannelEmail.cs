...
/// Nesting mode: single
/// </summary>
public partial class AzurermBotChannelEmailTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermBotChannelEmail : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EmailPassword { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MagicCode { get; set; }
    ...
    public AzurermBotChannelEmailTimeoutsBlock Timeouts { get; set; } = new();
