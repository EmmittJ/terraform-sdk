...
/// Nesting mode: single
/// </summary>
public partial class AzurermNetworkManagerDeploymentTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermNetworkManagerDeployment : TerraformResource
{
    ...
    public partial TerraformList<string>? ConfigurationIds { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ScopeAccess { get; set; }
    ...
    public AzurermNetworkManagerDeploymentTimeoutsBlock Timeouts { get; set; } = new();
