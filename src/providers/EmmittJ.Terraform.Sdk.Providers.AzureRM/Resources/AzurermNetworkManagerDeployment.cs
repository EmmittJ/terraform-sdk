...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerDeploymentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerDeployment : TerraformResource
{
    ...
    public TerraformProperty<List<TerraformProperty<string>>>? ConfigurationIds { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ScopeAccess { get; set; }
    ...
    public TerraformBlock<AzurermNetworkManagerDeploymentTimeoutsBlock>? Timeouts { get; set; } = new();
