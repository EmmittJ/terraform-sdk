...
/// Nesting mode: single
/// </summary>
public partial class AzurermSpringCloudApiPortalCustomDomainTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSpringCloudApiPortalCustomDomain : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SpringCloudApiPortalId { get; set; }
    ...
    public AzurermSpringCloudApiPortalCustomDomainTimeoutsBlock Timeouts { get; set; } = new();
