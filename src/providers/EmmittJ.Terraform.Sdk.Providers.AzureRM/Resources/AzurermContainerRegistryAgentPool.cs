...
/// Nesting mode: single
/// </summary>
public class AzurermContainerRegistryAgentPoolTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermContainerRegistryAgentPool : TerraformResource
{
    ...
    public TerraformBlock<AzurermContainerRegistryAgentPoolTimeoutsBlock>? Timeouts { get; set; } = new();
