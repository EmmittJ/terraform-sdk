...
/// Nesting mode: single
/// </summary>
public class AzurermOracleAutonomousDatabaseBackupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermOracleAutonomousDatabaseBackup : TerraformResource
{
    ...
    public TerraformBlock<AzurermOracleAutonomousDatabaseBackupTimeoutsBlock>? Timeouts { get; set; } = new();
