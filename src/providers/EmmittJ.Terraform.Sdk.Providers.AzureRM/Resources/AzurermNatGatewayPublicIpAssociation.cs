...
/// Nesting mode: single
/// </summary>
public class AzurermNatGatewayPublicIpAssociationTimeoutsBlock
{
    /// <summary>
...
public class AzurermNatGatewayPublicIpAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermNatGatewayPublicIpAssociationTimeoutsBlock>? Timeouts { get; set; }
