...
/// Nesting mode: single
/// </summary>
public class AzurermKustoEventhubDataConnectionTimeoutsBlock
{
    /// <summary>
...
public class AzurermKustoEventhubDataConnection : TerraformResource
{
    ...
    public TerraformList<string> EventSystemProperties { get; set; } = default!;
    ...
    public TerraformBlock<AzurermKustoEventhubDataConnectionTimeoutsBlock>? Timeouts { get; set; }
