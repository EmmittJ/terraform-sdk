...
/// Nesting mode: single
/// </summary>
public class AzurermSubscriptionPolicyRemediationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSubscriptionPolicyRemediation : TerraformResource
{
    ...
    public TerraformBlock<AzurermSubscriptionPolicyRemediationTimeoutsBlock>? Timeouts { get; set; } = new();
