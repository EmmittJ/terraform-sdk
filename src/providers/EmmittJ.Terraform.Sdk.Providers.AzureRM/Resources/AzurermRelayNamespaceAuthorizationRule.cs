...
/// Nesting mode: single
/// </summary>
public class AzurermRelayNamespaceAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRelayNamespaceAuthorizationRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermRelayNamespaceAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
