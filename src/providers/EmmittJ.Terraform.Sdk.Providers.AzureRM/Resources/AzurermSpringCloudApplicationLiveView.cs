...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudApplicationLiveViewTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSpringCloudApplicationLiveView : TerraformResource
{
    ...
    public TerraformBlock<AzurermSpringCloudApplicationLiveViewTimeoutsBlock>? Timeouts { get; set; } = new();
