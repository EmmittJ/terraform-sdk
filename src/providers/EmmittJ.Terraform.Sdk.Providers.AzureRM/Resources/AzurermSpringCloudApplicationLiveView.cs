...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudApplicationLiveViewTimeoutsBlock
{
    /// <summary>
...
public class AzurermSpringCloudApplicationLiveView : TerraformResource
{
    ...
    public TerraformBlock<AzurermSpringCloudApplicationLiveViewTimeoutsBlock>? Timeouts { get; set; }
