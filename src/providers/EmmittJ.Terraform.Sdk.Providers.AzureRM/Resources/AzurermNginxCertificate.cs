...
/// Nesting mode: single
/// </summary>
public class AzurermNginxCertificateTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNginxCertificate : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> CertificateVirtualPath { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> KeyVirtualPath { get; set; }
    ...
    public TerraformBlock<AzurermNginxCertificateTimeoutsBlock>? Timeouts { get; set; } = new();
