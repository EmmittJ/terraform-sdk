...
/// Nesting mode: list
/// </summary>
public class AzurermResourceGroupCostManagementViewDatasetBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermResourceGroupCostManagementViewKpiBlock : ITerraformBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermResourceGroupCostManagementViewPivotBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermResourceGroupCostManagementViewTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermResourceGroupCostManagementView : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermResourceGroupCostManagementViewDatasetBlock>>? Dataset { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermResourceGroupCostManagementViewKpiBlock>>? Kpi { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermResourceGroupCostManagementViewPivotBlock>>? Pivot { get; set; } = new();
    ...
    public TerraformBlock<AzurermResourceGroupCostManagementViewTimeoutsBlock>? Timeouts { get; set; } = new();
