...
/// Nesting mode: single
/// </summary>
public class AzurermResourceGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermResourceGroup : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ManagedBy { get; set; }
    ...
    public TerraformBlock<AzurermResourceGroupTimeoutsBlock>? Timeouts { get; set; } = new();
