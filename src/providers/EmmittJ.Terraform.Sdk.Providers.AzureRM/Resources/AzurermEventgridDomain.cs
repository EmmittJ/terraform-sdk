...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridDomainIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridDomainInputMappingDefaultValuesBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridDomainInputMappingFieldsBlock : ITerraformBlock
{
    /// <summary>
    /// The data_version attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridDomainTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventgridDomain : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AutoCreateTopicWithFirstSubscription { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? AutoDeleteTopicWithLastSubscription { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermEventgridDomainIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermEventgridDomainInputMappingDefaultValuesBlock>>? InputMappingDefaultValues { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermEventgridDomainInputMappingFieldsBlock>>? InputMappingFields { get; set; } = new();
    ...
    public TerraformBlock<AzurermEventgridDomainTimeoutsBlock>? Timeouts { get; set; } = new();
