...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorThreatIntelligenceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorThreatIntelligence : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorThreatIntelligenceTimeoutsBlock>? Timeouts { get; set; } = new();
