...
/// Nesting mode: single
/// </summary>
public class AzurermRedisFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermRedisFirewallRule : TerraformResource
{
    ...
    [TerraformPropertyName("end_ip")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> EndIp { get; set; }
    ...
    [TerraformPropertyName("redis_cache_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> RedisCacheName { get; set; }
    ...
    [TerraformPropertyName("start_ip")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> StartIp { get; set; }
    ...
    public TerraformBlock<AzurermRedisFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
