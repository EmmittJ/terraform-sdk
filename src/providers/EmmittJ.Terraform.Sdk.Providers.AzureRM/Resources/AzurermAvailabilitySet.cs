...
/// Nesting mode: single
/// </summary>
public partial class AzurermAvailabilitySetTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermAvailabilitySet : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<double>? PlatformUpdateDomainCount { get; set; }
    ...
    public TerraformBlock<AzurermAvailabilitySetTimeoutsBlock>? Timeouts { get; set; }
