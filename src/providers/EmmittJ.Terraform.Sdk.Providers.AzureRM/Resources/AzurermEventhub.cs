...
public partial class AzurermEventhubCaptureDescriptionBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? SizeLimitInBytes { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SkipEmptyArchives { get; set; }
...
public partial class AzurermEventhubRetentionDescriptionBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> CleanupPolicy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? RetentionTimeInHours { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? TombstoneRetentionTimeInHours { get; set; }
...
public partial class AzurermEventhub : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> MessageRetention { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> PartitionCount { get; set; }
    ...
    public partial TerraformSet<string> PartitionIds { get; }
