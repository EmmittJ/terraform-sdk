...
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbGremlinDatabaseAutoscaleSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbGremlinDatabaseTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbGremlinDatabase : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermCosmosdbGremlinDatabaseAutoscaleSettingsBlock>>? AutoscaleSettings { get; set; } = new();
    ...
    public TerraformBlock<AzurermCosmosdbGremlinDatabaseTimeoutsBlock>? Timeouts { get; set; } = new();
