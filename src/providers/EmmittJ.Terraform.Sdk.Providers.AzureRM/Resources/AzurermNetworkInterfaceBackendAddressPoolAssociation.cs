...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkInterfaceBackendAddressPoolAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkInterfaceBackendAddressPoolAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermNetworkInterfaceBackendAddressPoolAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
