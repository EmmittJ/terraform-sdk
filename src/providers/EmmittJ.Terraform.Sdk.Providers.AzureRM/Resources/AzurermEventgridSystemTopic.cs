...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridSystemTopicIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridSystemTopicTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventgridSystemTopic : TerraformResource
{
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> SourceArmResourceId { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "source_arm_resource_id");
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> SourceResourceId { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "source_resource_id");
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> TopicType { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermEventgridSystemTopicIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermEventgridSystemTopicTimeoutsBlock>? Timeouts { get; set; } = new();
