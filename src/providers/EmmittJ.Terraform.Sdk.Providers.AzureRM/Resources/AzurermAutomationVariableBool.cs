...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationVariableBoolTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationVariableBool : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? Value { get; set; }
    ...
    public TerraformBlock<AzurermAutomationVariableBoolTimeoutsBlock>? Timeouts { get; set; } = new();
