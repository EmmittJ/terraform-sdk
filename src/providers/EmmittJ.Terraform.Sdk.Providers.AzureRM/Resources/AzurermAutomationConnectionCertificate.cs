...
/// <summary>
/// Represents a azurerm_automation_connection_certificate Terraform resource.
/// Manages a azurerm_automation_connection_certificate resource.
/// </summary>
public partial class AzurermAutomationConnectionCertificate(string name) : TerraformResource("azurerm_automation_connection_certificate", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "automation_certificate_name");
    ...
    {
        get => GetArgument<AzurermAutomationConnectionCertificateTimeoutsBlock>("timeouts");
