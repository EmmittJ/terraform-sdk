...
public class AzurermAutomationConnectionCertificate : TerraformResource
{
    ...
    {
        get => GetRequiredProperty<TerraformProperty<string>>("automation_certificate_name");
    ...
    {
        get => GetProperty<AzurermAutomationConnectionCertificateTimeoutsBlock>("timeouts");
