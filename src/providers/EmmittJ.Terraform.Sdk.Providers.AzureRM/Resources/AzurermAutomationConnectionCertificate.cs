...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationConnectionCertificateTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationConnectionCertificate : TerraformResource
{
    ...
    [TerraformPropertyName("automation_certificate_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> AutomationCertificateName { get; set; }
    ...
    public TerraformBlock<AzurermAutomationConnectionCertificateTimeoutsBlock>? Timeouts { get; set; } = new();
