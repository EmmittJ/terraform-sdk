...
/// Nesting mode: list
/// </summary>
public partial class AzurermDiskEncryptionSetIdentityBlock() : TerraformBlock("identity")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class AzurermDiskEncryptionSetTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermDiskEncryptionSet : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AutoKeyRotationEnabled { get; set; }
