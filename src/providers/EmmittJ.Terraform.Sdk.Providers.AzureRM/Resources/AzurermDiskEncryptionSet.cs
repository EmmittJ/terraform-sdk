...
/// Nesting mode: list
/// </summary>
public partial class AzurermDiskEncryptionSetIdentityBlock : TerraformBlockBase
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class AzurermDiskEncryptionSetTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermDiskEncryptionSet : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<bool>? AutoKeyRotationEnabled { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermDiskEncryptionSetIdentityBlock>>? Identity { get; set; }
    ...
    public TerraformBlock<AzurermDiskEncryptionSetTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> KeyVaultKeyUrl { get; }
