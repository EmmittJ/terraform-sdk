...
/// Nesting mode: single
/// </summary>
public class AzurermIothubConsumerGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubConsumerGroup : TerraformResource
{
    ...
    [TerraformPropertyName("eventhub_endpoint_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> EventhubEndpointName { get; set; }
    ...
    public TerraformBlock<AzurermIothubConsumerGroupTimeoutsBlock>? Timeouts { get; set; } = new();
