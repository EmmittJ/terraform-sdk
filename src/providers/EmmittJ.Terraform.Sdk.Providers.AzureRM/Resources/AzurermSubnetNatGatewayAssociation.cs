...
/// Nesting mode: single
/// </summary>
public class AzurermSubnetNatGatewayAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSubnetNatGatewayAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermSubnetNatGatewayAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
