...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlTimeoutsBlock
{
    /// <summary>
...
public class AzurermDataFactoryDatasetPostgresql : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock>>? SchemaColumn { get; set; }
    ...
    public TerraformBlock<AzurermDataFactoryDatasetPostgresqlTimeoutsBlock>? Timeouts { get; set; }
