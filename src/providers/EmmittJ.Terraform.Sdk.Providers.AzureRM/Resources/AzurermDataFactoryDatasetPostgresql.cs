...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryDatasetPostgresql : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock>>? SchemaColumn { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryDatasetPostgresqlTimeoutsBlock>? Timeouts { get; set; } = new();
