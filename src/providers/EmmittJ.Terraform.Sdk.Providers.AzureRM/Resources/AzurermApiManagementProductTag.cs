...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementProductTagTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementProductTag : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ApiManagementProductId { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementProductTagTimeoutsBlock>? Timeouts { get; set; } = new();
