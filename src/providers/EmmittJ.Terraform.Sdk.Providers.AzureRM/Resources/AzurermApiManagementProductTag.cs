...
/// <summary>
/// Represents a azurerm_api_management_product_tag Terraform resource.
/// Manages a azurerm_api_management_product_tag resource.
/// </summary>
public partial class AzurermApiManagementProductTag(string name) : TerraformResource("azurerm_api_management_product_tag", name)
{
    /// <summary>
    ...
    {
        get => new TerraformReference<string>(this, "api_management_product_id");
    ...
    {
        get => GetArgument<AzurermApiManagementProductTagTimeoutsBlock>("timeouts");
