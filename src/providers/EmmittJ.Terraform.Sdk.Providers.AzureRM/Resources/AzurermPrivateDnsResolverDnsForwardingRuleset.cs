...
public class AzurermPrivateDnsResolverDnsForwardingRuleset : TerraformResource
{
    ...
    {
        get => GetRequiredOutput<List<TerraformProperty<string>>>("private_dns_resolver_outbound_endpoint_ids");
        set => SetProperty("private_dns_resolver_outbound_endpoint_ids", value);
    }
