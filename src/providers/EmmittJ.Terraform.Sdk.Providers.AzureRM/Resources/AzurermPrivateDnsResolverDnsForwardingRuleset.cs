...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsResolverDnsForwardingRulesetTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsResolverDnsForwardingRuleset : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformProperty<List<TerraformProperty<string>>>? PrivateDnsResolverOutboundEndpointIds { get; set; }
    ...
    public TerraformBlock<AzurermPrivateDnsResolverDnsForwardingRulesetTimeoutsBlock>? Timeouts { get; set; } = new();
