...
public class AzurermPrivateDnsResolverDnsForwardingRuleset : TerraformResource
{
    ...
    public List<TerraformProperty<string>>? PrivateDnsResolverOutboundEndpointIds
    {
        get => GetProperty<List<TerraformProperty<string>>>("private_dns_resolver_outbound_endpoint_ids");
    ...
    {
        get => GetProperty<AzurermPrivateDnsResolverDnsForwardingRulesetTimeoutsBlock>("timeouts");
