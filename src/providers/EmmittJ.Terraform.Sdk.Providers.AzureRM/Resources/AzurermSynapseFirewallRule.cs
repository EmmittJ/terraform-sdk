...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
