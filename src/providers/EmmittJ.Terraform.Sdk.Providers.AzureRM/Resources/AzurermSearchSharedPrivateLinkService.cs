...
/// </summary>
public partial class AzurermSearchSharedPrivateLinkService : TerraformResource
{
    ...
    [TerraformProperty("search_service_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SearchServiceId { get; set; }
