...
/// Nesting mode: list
/// </summary>
public class AzurermConsumptionBudgetResourceGroupFilterBlock
{
}
...
/// Nesting mode: set
/// </summary>
public class AzurermConsumptionBudgetResourceGroupNotificationBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermConsumptionBudgetResourceGroupTimePeriodBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermConsumptionBudgetResourceGroupTimeoutsBlock
{
    /// <summary>
