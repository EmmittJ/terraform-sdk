...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerNetworkGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerNetworkGroup : TerraformResource
{
    ...
    public TerraformBlock<AzurermNetworkManagerNetworkGroupTimeoutsBlock>? Timeouts { get; set; } = new();
