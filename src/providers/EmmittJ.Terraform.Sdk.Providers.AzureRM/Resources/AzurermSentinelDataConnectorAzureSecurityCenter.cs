...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorAzureSecurityCenterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class AzurermSentinelDataConnectorAzureSecurityCenter : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorAzureSecurityCenterTimeoutsBlock>? Timeouts { get; set; } = new();
