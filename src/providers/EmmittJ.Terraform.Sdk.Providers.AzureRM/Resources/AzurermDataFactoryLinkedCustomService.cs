...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryLinkedCustomServiceIntegrationRuntimeBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedCustomServiceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedCustomService : TerraformResource
{
    ...
    [TerraformPropertyName("integration_runtime")]
    public TerraformList<TerraformBlock<AzurermDataFactoryLinkedCustomServiceIntegrationRuntimeBlock>>? IntegrationRuntime { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryLinkedCustomServiceTimeoutsBlock>? Timeouts { get; set; } = new();
