...
/// Nesting mode: single
/// </summary>
public class AzurermPortalTenantConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPortalTenantConfiguration : TerraformResource
{
    ...
    [TerraformPropertyName("private_markdown_storage_enforced")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<bool>> PrivateMarkdownStorageEnforced { get; set; }
    ...
    public TerraformBlock<AzurermPortalTenantConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
