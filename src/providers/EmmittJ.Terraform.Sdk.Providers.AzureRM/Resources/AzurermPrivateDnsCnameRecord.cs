...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsCnameRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsCnameRecord : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Record { get; set; }
    ...
    public TerraformBlock<AzurermPrivateDnsCnameRecordTimeoutsBlock>? Timeouts { get; set; } = new();
