...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridPartnerRegistrationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventgridPartnerRegistration : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventgridPartnerRegistrationTimeoutsBlock>? Timeouts { get; set; } = new();
