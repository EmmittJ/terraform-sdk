...
public partial class AzurermActiveDirectoryDomainServiceNotificationsBlock() : TerraformBlock("notifications")
{
    ...
    public partial TerraformSet<string>? AdditionalRecipients { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? NotifyDcAdmins { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? NotifyGlobalAdmins { get; set; }
...
public partial class AzurermActiveDirectoryDomainServiceSecureLdapBlock() : TerraformBlock("secure_ldap")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ExternalAccessEnabled { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PfxCertificate { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PfxCertificatePassword { get; set; }
...
public partial class AzurermActiveDirectoryDomainServiceSecurityBlock() : TerraformBlock("security")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? KerberosArmoringEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? KerberosRc4EncryptionEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? NtlmV1Enabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SyncKerberosPasswords { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SyncNtlmPasswords { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SyncOnPremPasswords { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? TlsV1Enabled { get; set; }
...
public partial class AzurermActiveDirectoryDomainService : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DomainConfigurationType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? FilteredSyncEnabled { get; set; }
