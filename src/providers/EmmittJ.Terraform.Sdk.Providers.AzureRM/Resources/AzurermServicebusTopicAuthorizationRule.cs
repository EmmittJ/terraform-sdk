...
/// Nesting mode: single
/// </summary>
public class AzurermServicebusTopicAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermServicebusTopicAuthorizationRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermServicebusTopicAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
