...
/// Nesting mode: single
/// </summary>
public class AzurermIothubEndpointServicebusTopicTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubEndpointServicebusTopic : TerraformResource
{
    ...
    public TerraformBlock<AzurermIothubEndpointServicebusTopicTimeoutsBlock>? Timeouts { get; set; } = new();
