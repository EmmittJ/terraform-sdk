...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelAlertRuleThreatIntelligenceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelAlertRuleThreatIntelligence : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelAlertRuleThreatIntelligenceTimeoutsBlock>? Timeouts { get; set; } = new();
