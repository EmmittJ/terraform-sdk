...
/// Nesting mode: single
/// </summary>
public class AzurermExpressRoutePortAuthorizationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermExpressRoutePortAuthorization : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> ExpressRoutePortName { get; set; }
    ...
    public TerraformBlock<AzurermExpressRoutePortAuthorizationTimeoutsBlock>? Timeouts { get; set; } = new();
