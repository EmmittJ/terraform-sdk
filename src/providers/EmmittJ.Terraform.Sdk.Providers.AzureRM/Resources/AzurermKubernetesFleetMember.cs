...
/// Nesting mode: single
/// </summary>
public partial class AzurermKubernetesFleetMemberTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermKubernetesFleetMember : TerraformResource
{
    ...
    [TerraformProperty("kubernetes_fleet_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> KubernetesFleetId { get; set; }
    ...
    public partial TerraformBlock<AzurermKubernetesFleetMemberTimeoutsBlock>? Timeouts { get; set; }
