...
/// Nesting mode: list
/// </summary>
public class AzurermFunctionAppConnectionAuthenticationBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermFunctionAppConnectionSecretStoreBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermFunctionAppConnectionTimeoutsBlock
{
    /// <summary>
