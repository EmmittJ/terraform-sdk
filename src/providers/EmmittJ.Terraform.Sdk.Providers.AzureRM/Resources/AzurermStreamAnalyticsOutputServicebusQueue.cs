...
/// Nesting mode: list
/// </summary>
public class AzurermStreamAnalyticsOutputServicebusQueueSerializationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsOutputServicebusQueueTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsOutputServicebusQueue : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsOutputServicebusQueueSerializationBlock>>? Serialization { get; set; } = new();
    ...
    public TerraformBlock<AzurermStreamAnalyticsOutputServicebusQueueTimeoutsBlock>? Timeouts { get; set; } = new();
