...
public partial class AzurermSentinelAutomationRuleActionIncidentBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? Classification { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ClassificationComment { get; set; }
...
public partial class AzurermSentinelAutomationRule : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ConditionJson { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Expiration { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TriggersOn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TriggersWhen { get; set; }
