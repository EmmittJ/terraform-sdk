...
/// Nesting mode: single
/// </summary>
public partial class AzurermDataProtectionBackupInstanceBlobStorageTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermDataProtectionBackupInstanceBlobStorage : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("storage_account_container_names")]
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? StorageAccountContainerNames { get; set; }
    ...
    public partial TerraformBlock<AzurermDataProtectionBackupInstanceBlobStorageTimeoutsBlock>? Timeouts { get; set; }
