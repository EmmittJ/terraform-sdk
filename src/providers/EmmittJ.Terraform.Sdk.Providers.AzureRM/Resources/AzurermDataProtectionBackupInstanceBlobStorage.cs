...
public partial class AzurermDataProtectionBackupInstanceBlobStorage : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformList<string>? StorageAccountContainerNames { get; set; }
    ...
    public TerraformBlock<AzurermDataProtectionBackupInstanceBlobStorageTimeoutsBlock>? Timeouts { get; set; }
