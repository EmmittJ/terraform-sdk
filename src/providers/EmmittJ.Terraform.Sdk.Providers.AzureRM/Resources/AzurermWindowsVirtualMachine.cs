...
public class AzurermWindowsVirtualMachineAdditionalUnattendContentBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredProperty<TerraformProperty<string>>("setting");
...
public class AzurermWindowsVirtualMachine : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformProperty<bool>>("automatic_updates_enabled");
    ...
    {
        get => GetProperty<TerraformProperty<bool>>("hotpatching_enabled");
