...
public partial class AzurermWindowsVirtualMachineAdditionalUnattendContentBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Setting { get; set; }
...
public partial class AzurermWindowsVirtualMachineWinrmListenerBlock : TerraformBlockBase
{
    ...
    /// </summary>
    [TerraformProperty("certificate_url")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CertificateUrl { get; set; }
...
public partial class AzurermWindowsVirtualMachine : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("automatic_updates_enabled")]
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> AutomaticUpdatesEnabled { get; set; }
    ...
    /// </summary>
    [TerraformProperty("hotpatching_enabled")]
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> HotpatchingEnabled { get; set; }
