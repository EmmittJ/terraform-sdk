...
public class AzurermMonitorPrivateLinkScopedService : TerraformResource
{
    ...
    [TerraformArgument("linked_resource_id")]
    public required TerraformValue<string> LinkedResourceId
    {
        get => new TerraformReference<string>(this, "linked_resource_id");
    ...
    public AzurermMonitorPrivateLinkScopedServiceTimeoutsBlock Timeouts { get; set; } = new();
