...
/// Nesting mode: single
/// </summary>
public class AzurermMonitorPrivateLinkScopedServiceTimeoutsBlock
{
    /// <summary>
...
public class AzurermMonitorPrivateLinkScopedService : TerraformResource
{
    ...
    [TerraformPropertyName("linked_resource_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> LinkedResourceId { get; set; }
    ...
    public TerraformBlock<AzurermMonitorPrivateLinkScopedServiceTimeoutsBlock>? Timeouts { get; set; }
