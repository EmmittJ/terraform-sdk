...
public class AzurermCdnFrontdoorFirewallPolicy : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("request_body_check_enabled");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<double>>("captcha_cookie_expiration_in_minutes");
        set => SetProperty("captcha_cookie_expiration_in_minutes", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<double>>("js_challenge_cookie_expiration_in_minutes");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<bool>>("request_body_check_enabled");
        set => SetProperty("request_body_check_enabled", value);
    }
    ...
    {
        set => SetProperty("log_scrubbing", value);
    }
