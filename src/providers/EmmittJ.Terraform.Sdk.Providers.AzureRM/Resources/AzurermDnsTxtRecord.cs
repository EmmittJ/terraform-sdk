...
/// Nesting mode: set
/// </summary>
public class AzurermDnsTxtRecordRecordBlock : ITerraformBlock
{
    /// <summary>
    /// The value attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDnsTxtRecordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDnsTxtRecord : TerraformResource
{
    public AzurermDnsTxtRecord(string name) : base("azurerm_dns_txt_record", name)
    {
    }
    ...
    public TerraformSet<TerraformBlock<AzurermDnsTxtRecordRecordBlock>>? Record { get; set; } = new();
    ...
    public TerraformBlock<AzurermDnsTxtRecordTimeoutsBlock>? Timeouts { get; set; } = new();
