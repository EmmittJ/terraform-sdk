...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationVariableIntTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationVariableInt : TerraformResource
{
    ...
    public TerraformBlock<AzurermAutomationVariableIntTimeoutsBlock>? Timeouts { get; set; } = new();
