...
/// Nesting mode: list
/// </summary>
public class AzurermIothubDeviceUpdateAccountIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermIothubDeviceUpdateAccountTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIothubDeviceUpdateAccount : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermIothubDeviceUpdateAccountIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermIothubDeviceUpdateAccountTimeoutsBlock>? Timeouts { get; set; } = new();
