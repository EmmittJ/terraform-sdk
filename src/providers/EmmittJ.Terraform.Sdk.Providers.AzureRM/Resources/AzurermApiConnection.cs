...
/// Nesting mode: single
/// </summary>
public class AzurermApiConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiConnection : TerraformResource
{
    ...
    [TerraformPropertyName("managed_api_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ManagedApiId { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>>? ParameterValues { get; set; }
    ...
    public TerraformBlock<AzurermApiConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
