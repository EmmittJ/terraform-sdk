...
public class AzurermConsumptionBudgetSubscription : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermConsumptionBudgetSubscriptionFilterBlock>>("filter");
    ...
    {
        get => GetProperty<HashSet<AzurermConsumptionBudgetSubscriptionNotificationBlock>>("notification");
    ...
    {
        get => GetProperty<List<AzurermConsumptionBudgetSubscriptionTimePeriodBlock>>("time_period");
    ...
    {
        get => GetProperty<AzurermConsumptionBudgetSubscriptionTimeoutsBlock>("timeouts");
