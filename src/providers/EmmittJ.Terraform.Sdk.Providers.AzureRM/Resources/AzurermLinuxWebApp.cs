...
public class AzurermLinuxWebApp : TerraformResource
{
    ...
    public List<AzurermLinuxWebAppAuthSettingsBlock>? AuthSettings
    {
        get => GetProperty<List<AzurermLinuxWebAppAuthSettingsBlock>>("auth_settings");
    ...
    public List<AzurermLinuxWebAppAuthSettingsV2Block>? AuthSettingsV2
    {
        get => GetProperty<List<AzurermLinuxWebAppAuthSettingsV2Block>>("auth_settings_v2");
    ...
    public List<AzurermLinuxWebAppBackupBlock>? Backup
    {
        get => GetProperty<List<AzurermLinuxWebAppBackupBlock>>("backup");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxWebAppConnectionStringBlock>? ConnectionString
    {
        get => GetProperty<HashSet<AzurermLinuxWebAppConnectionStringBlock>>("connection_string");
    ...
    public List<AzurermLinuxWebAppIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermLinuxWebAppIdentityBlock>>("identity");
    ...
    public List<AzurermLinuxWebAppLogsBlock>? Logs
    {
        get => GetProperty<List<AzurermLinuxWebAppLogsBlock>>("logs");
    ...
    public List<AzurermLinuxWebAppSiteConfigBlock>? SiteConfig
    {
        get => GetProperty<List<AzurermLinuxWebAppSiteConfigBlock>>("site_config");
    ...
    public List<AzurermLinuxWebAppStickySettingsBlock>? StickySettings
    {
        get => GetProperty<List<AzurermLinuxWebAppStickySettingsBlock>>("sticky_settings");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxWebAppStorageAccountBlock>? StorageAccount
    {
        get => GetProperty<HashSet<AzurermLinuxWebAppStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermLinuxWebAppTimeoutsBlock>("timeouts");
