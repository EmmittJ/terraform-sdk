...
/// Nesting mode: single
/// </summary>
public class AzurermSecurityCenterWorkspaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSecurityCenterWorkspace : TerraformResource
{
    ...
    public TerraformBlock<AzurermSecurityCenterWorkspaceTimeoutsBlock>? Timeouts { get; set; } = new();
