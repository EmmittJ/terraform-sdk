...
/// Nesting mode: single
/// </summary>
public class AzurermApplicationLoadBalancerSecurityPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApplicationLoadBalancerSecurityPolicy : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> WebApplicationFirewallPolicyId { get; set; }
    ...
    public TerraformBlock<AzurermApplicationLoadBalancerSecurityPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
