...
/// Nesting mode: single
/// </summary>
public partial class AzurermApplicationLoadBalancerSecurityPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermApplicationLoadBalancerSecurityPolicy : TerraformResource
{
    ...
    [TerraformProperty("web_application_firewall_policy_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> WebApplicationFirewallPolicyId { get; set; }
    ...
    public partial TerraformBlock<AzurermApplicationLoadBalancerSecurityPolicyTimeoutsBlock>? Timeouts { get; set; }
