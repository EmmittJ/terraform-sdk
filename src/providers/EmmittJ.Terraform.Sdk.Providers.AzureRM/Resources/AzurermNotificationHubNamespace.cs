...
/// Nesting mode: single
/// </summary>
public partial class AzurermNotificationHubNamespaceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermNotificationHubNamespace : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> NamespaceType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ReplicationRegion { get; set; }
    ...
    public AzurermNotificationHubNamespaceTimeoutsBlock Timeouts { get; set; } = new();
