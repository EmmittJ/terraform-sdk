...
public partial class AzurermRecoveryServicesVaultEncryptionBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<bool> InfrastructureEncryptionEnabled { get; set; }
    ...
    public partial TerraformValue<bool>? UseSystemAssignedIdentity { get; set; }
...
public partial class AzurermRecoveryServicesVaultMonitoringBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AlertsForAllJobFailuresEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AlertsForCriticalOperationFailuresEnabled { get; set; }
...
public partial class AzurermRecoveryServicesVault : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ClassicVmwareReplicationEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SoftDeleteEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? StorageModeType { get; set; }
