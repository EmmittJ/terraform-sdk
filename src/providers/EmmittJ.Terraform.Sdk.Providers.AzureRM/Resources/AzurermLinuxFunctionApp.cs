...
public partial class AzurermLinuxFunctionApp : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppAuthSettingsBlock>>? AuthSettings { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppAuthSettingsV2Block>>? AuthSettingsV2 { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppBackupBlock>>? Backup { get; set; }
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxFunctionAppConnectionStringBlock>>? ConnectionString { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppIdentityBlock>>? Identity { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppSiteConfigBlock>>? SiteConfig { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppStickySettingsBlock>>? StickySettings { get; set; }
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxFunctionAppStorageAccountBlock>>? StorageAccount { get; set; }
    ...
    public TerraformBlock<AzurermLinuxFunctionAppTimeoutsBlock>? Timeouts { get; set; }
