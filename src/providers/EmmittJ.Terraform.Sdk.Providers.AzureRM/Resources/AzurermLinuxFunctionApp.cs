...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppAuthSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppAuthSettingsV2Block : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppBackupBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermLinuxFunctionAppConnectionStringBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppSiteConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermLinuxFunctionAppStickySettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermLinuxFunctionAppStorageAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermLinuxFunctionAppTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermLinuxFunctionApp : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppAuthSettingsBlock>>? AuthSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppAuthSettingsV2Block>>? AuthSettingsV2 { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppBackupBlock>>? Backup { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxFunctionAppConnectionStringBlock>>? ConnectionString { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppSiteConfigBlock>>? SiteConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermLinuxFunctionAppStickySettingsBlock>>? StickySettings { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermLinuxFunctionAppStorageAccountBlock>>? StorageAccount { get; set; } = new();
    ...
    public TerraformBlock<AzurermLinuxFunctionAppTimeoutsBlock>? Timeouts { get; set; } = new();
