...
/// Nesting mode: list
/// </summary>
public class AzurermFrontdoorRulesEngineRuleBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermFrontdoorRulesEngineTimeoutsBlock
{
    /// <summary>
...
public class AzurermFrontdoorRulesEngine : TerraformResource
{
    ...
    [TerraformPropertyName("frontdoor_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> FrontdoorName { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermFrontdoorRulesEngineRuleBlock>>? Rule { get; set; }
    ...
    public TerraformBlock<AzurermFrontdoorRulesEngineTimeoutsBlock>? Timeouts { get; set; }
