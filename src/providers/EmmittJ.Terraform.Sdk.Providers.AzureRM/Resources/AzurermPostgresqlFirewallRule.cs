...
/// Nesting mode: single
/// </summary>
public class AzurermPostgresqlFirewallRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPostgresqlFirewallRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermPostgresqlFirewallRuleTimeoutsBlock>? Timeouts { get; set; } = new();
