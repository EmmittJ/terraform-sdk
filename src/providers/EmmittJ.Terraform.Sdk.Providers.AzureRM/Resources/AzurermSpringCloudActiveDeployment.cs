...
public partial class AzurermSpringCloudActiveDeployment : TerraformResource
{
    ...
    public required partial TerraformValue<string> DeploymentName { get; set; }
    ...
    public partial TerraformBlock<AzurermSpringCloudActiveDeploymentTimeoutsBlock>? Timeouts { get; set; }
