...
public class AzurermPrivateDnsTxtRecord : TerraformResource
{
    ...
    public HashSet<AzurermPrivateDnsTxtRecordRecordBlock>? Record
    {
        get => GetProperty<HashSet<AzurermPrivateDnsTxtRecordRecordBlock>>("record");
    ...
    {
        get => GetProperty<AzurermPrivateDnsTxtRecordTimeoutsBlock>("timeouts");
