...
/// Nesting mode: set
/// </summary>
public class AzurermPrivateDnsTxtRecordRecordBlock
{
    /// <summary>
    /// The value attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsTxtRecordTimeoutsBlock
{
    /// <summary>
...
public class AzurermPrivateDnsTxtRecord : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AzurermPrivateDnsTxtRecordRecordBlock>>? Record { get; set; }
    ...
    public TerraformBlock<AzurermPrivateDnsTxtRecordTimeoutsBlock>? Timeouts { get; set; }
