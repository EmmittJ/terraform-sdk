...
/// Nesting mode: list
/// </summary>
public class AzurermStreamAnalyticsStreamInputEventhubV2SerializationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsStreamInputEventhubV2TimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsStreamInputEventhubV2 : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsStreamInputEventhubV2SerializationBlock>>? Serialization { get; set; } = new();
    ...
    public TerraformBlock<AzurermStreamAnalyticsStreamInputEventhubV2TimeoutsBlock>? Timeouts { get; set; } = new();
