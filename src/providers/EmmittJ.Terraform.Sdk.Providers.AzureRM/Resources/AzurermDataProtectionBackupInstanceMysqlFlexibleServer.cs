...
/// Nesting mode: single
/// </summary>
public partial class AzurermDataProtectionBackupInstanceMysqlFlexibleServerTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermDataProtectionBackupInstanceMysqlFlexibleServer : TerraformResource
{
    ...
    public AzurermDataProtectionBackupInstanceMysqlFlexibleServerTimeoutsBlock Timeouts { get; set; } = new();
