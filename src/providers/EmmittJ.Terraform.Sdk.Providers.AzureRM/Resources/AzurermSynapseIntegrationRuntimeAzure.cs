...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseIntegrationRuntimeAzureTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseIntegrationRuntimeAzure : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseIntegrationRuntimeAzureTimeoutsBlock>? Timeouts { get; set; } = new();
