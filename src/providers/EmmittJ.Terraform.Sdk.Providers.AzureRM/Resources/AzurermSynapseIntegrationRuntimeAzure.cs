...
/// Nesting mode: single
/// </summary>
public partial class AzurermSynapseIntegrationRuntimeAzureTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSynapseIntegrationRuntimeAzure : TerraformResource
{
    ...
    public AzurermSynapseIntegrationRuntimeAzureTimeoutsBlock Timeouts { get; set; } = new();
