...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridTopicIdentityBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridTopicInputMappingDefaultValuesBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermEventgridTopicInputMappingFieldsBlock
{
    /// <summary>
    /// The data_version attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermEventgridTopicTimeoutsBlock
{
    /// <summary>
