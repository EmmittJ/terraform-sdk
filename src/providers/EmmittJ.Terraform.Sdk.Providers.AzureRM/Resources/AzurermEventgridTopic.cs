...
public class AzurermEventgridTopic : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermEventgridTopicIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<List<AzurermEventgridTopicInputMappingDefaultValuesBlock>>("input_mapping_default_values");
    ...
    {
        get => GetProperty<List<AzurermEventgridTopicInputMappingFieldsBlock>>("input_mapping_fields");
    ...
    {
        get => GetProperty<AzurermEventgridTopicTimeoutsBlock>("timeouts");
