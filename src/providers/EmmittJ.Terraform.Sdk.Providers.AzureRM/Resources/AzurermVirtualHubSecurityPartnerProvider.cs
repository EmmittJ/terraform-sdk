...
/// Nesting mode: single
/// </summary>
public class AzurermVirtualHubSecurityPartnerProviderTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermVirtualHubSecurityPartnerProvider : TerraformResource
{
    ...
    [TerraformPropertyName("security_provider_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SecurityProviderName { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? VirtualHubId { get; set; }
    ...
    public TerraformBlock<AzurermVirtualHubSecurityPartnerProviderTimeoutsBlock>? Timeouts { get; set; } = new();
