...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseSqlPoolExtendedAuditingPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseSqlPoolExtendedAuditingPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseSqlPoolExtendedAuditingPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
