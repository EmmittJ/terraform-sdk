...
/// Nesting mode: single
/// </summary>
public class AzurermAdvancedThreatProtectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAdvancedThreatProtection : TerraformResource
{
    ...
    public TerraformBlock<AzurermAdvancedThreatProtectionTimeoutsBlock>? Timeouts { get; set; } = new();
