...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorAzureAdvancedThreatProtectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorAzureAdvancedThreatProtection : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorAzureAdvancedThreatProtectionTimeoutsBlock>? Timeouts { get; set; } = new();
