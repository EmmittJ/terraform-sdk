...
/// Nesting mode: single
/// </summary>
public class AzurermHealthcareWorkspaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermHealthcareWorkspace : TerraformResource
{
    ...
    public TerraformBlock<AzurermHealthcareWorkspaceTimeoutsBlock>? Timeouts { get; set; } = new();
