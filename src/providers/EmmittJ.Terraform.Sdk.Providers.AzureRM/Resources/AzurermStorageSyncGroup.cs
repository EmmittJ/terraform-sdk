...
/// Nesting mode: single
/// </summary>
public partial class AzurermStorageSyncGroupTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermStorageSyncGroup : TerraformResource
{
    ...
    public AzurermStorageSyncGroupTimeoutsBlock Timeouts { get; set; } = new();
