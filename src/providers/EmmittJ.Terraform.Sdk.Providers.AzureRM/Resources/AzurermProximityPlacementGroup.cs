...
/// Nesting mode: single
/// </summary>
public class AzurermProximityPlacementGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermProximityPlacementGroup : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("allowed_vm_sizes")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<HashSet<TerraformProperty<string>>>? AllowedVmSizes { get; set; }
    ...
    public TerraformBlock<AzurermProximityPlacementGroupTimeoutsBlock>? Timeouts { get; set; } = new();
