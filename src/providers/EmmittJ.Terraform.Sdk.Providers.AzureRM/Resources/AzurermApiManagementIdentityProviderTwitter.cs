...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementIdentityProviderTwitterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementIdentityProviderTwitter : TerraformResource
{
    ...
    [TerraformPropertyName("api_secret_key")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ApiSecretKey { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementIdentityProviderTwitterTimeoutsBlock>? Timeouts { get; set; } = new();
