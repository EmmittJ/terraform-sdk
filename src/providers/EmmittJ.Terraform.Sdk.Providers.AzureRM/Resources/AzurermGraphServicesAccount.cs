...
/// Nesting mode: single
/// </summary>
public class AzurermGraphServicesAccountTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermGraphServicesAccount : TerraformResource
{
    ...
    public TerraformBlock<AzurermGraphServicesAccountTimeoutsBlock>? Timeouts { get; set; } = new();
