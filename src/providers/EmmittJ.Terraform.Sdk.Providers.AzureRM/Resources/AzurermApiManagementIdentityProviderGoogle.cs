...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementIdentityProviderGoogleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementIdentityProviderGoogle : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementIdentityProviderGoogleTimeoutsBlock>? Timeouts { get; set; } = new();
