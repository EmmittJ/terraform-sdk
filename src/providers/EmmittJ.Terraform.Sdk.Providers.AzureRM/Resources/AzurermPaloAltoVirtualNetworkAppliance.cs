...
/// Nesting mode: single
/// </summary>
public class AzurermPaloAltoVirtualNetworkApplianceTimeoutsBlock
{
    /// <summary>
...
public class AzurermPaloAltoVirtualNetworkAppliance : TerraformResource
{
    ...
    public TerraformBlock<AzurermPaloAltoVirtualNetworkApplianceTimeoutsBlock>? Timeouts { get; set; }
