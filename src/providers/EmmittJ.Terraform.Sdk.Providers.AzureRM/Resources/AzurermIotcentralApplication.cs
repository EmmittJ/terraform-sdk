...
/// Nesting mode: list
/// </summary>
public class AzurermIotcentralApplicationIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermIotcentralApplicationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermIotcentralApplication : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SubDomain { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? Template { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermIotcentralApplicationIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermIotcentralApplicationTimeoutsBlock>? Timeouts { get; set; } = new();
