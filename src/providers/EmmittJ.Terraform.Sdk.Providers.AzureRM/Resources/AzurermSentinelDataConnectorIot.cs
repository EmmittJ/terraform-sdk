...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorIotTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorIot : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorIotTimeoutsBlock>? Timeouts { get; set; } = new();
