...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudAppMysqlAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSpringCloudAppMysqlAssociation : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MysqlServerId { get; set; }
    ...
    public TerraformBlock<AzurermSpringCloudAppMysqlAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
