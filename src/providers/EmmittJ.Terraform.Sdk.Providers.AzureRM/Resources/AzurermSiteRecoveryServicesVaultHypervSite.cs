...
/// Nesting mode: single
/// </summary>
public partial class AzurermSiteRecoveryServicesVaultHypervSiteTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSiteRecoveryServicesVaultHypervSite : TerraformResource
{
    ...
    public AzurermSiteRecoveryServicesVaultHypervSiteTimeoutsBlock Timeouts { get; set; } = new();
