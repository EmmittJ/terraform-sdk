...
/// Nesting mode: single
/// </summary>
public class AzurermSiteRecoveryServicesVaultHypervSiteTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSiteRecoveryServicesVaultHypervSite : TerraformResource
{
    ...
    public TerraformBlock<AzurermSiteRecoveryServicesVaultHypervSiteTimeoutsBlock>? Timeouts { get; set; } = new();
