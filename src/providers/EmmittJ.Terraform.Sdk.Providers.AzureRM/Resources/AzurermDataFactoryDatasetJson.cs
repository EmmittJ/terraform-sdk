...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetJsonAzureBlobStorageLocationBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetJsonHttpServerLocationBlock
{
    /// <summary>
    /// The dynamic_filename_enabled attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetJsonSchemaColumnBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetJsonTimeoutsBlock
{
    /// <summary>
