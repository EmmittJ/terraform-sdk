...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementIdentityProviderFacebookTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementIdentityProviderFacebook : TerraformResource
{
    ...
    [TerraformPropertyName("app_secret")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> AppSecret { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementIdentityProviderFacebookTimeoutsBlock>? Timeouts { get; set; } = new();
