...
/// Nesting mode: single
/// </summary>
public class AzurermEventhubNamespaceAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventhubNamespaceAuthorizationRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventhubNamespaceAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
