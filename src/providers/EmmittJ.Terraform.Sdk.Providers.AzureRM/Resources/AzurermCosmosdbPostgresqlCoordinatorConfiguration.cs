...
/// </summary>
public partial class AzurermCosmosdbPostgresqlCoordinatorConfiguration(string name) : TerraformResource("azurerm_cosmosdb_postgresql_coordinator_configuration", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermCosmosdbPostgresqlCoordinatorConfigurationTimeoutsBlock>("timeouts");
