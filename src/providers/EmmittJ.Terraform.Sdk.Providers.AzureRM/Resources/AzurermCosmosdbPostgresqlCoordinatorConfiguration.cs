...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbPostgresqlCoordinatorConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbPostgresqlCoordinatorConfiguration : TerraformResource
{
    ...
    public TerraformBlock<AzurermCosmosdbPostgresqlCoordinatorConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
