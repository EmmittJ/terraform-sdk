...
/// Nesting mode: single
/// </summary>
public class AzurermSynapseWorkspaceSqlAadAdminTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSynapseWorkspaceSqlAadAdmin : TerraformResource
{
    ...
    public TerraformBlock<AzurermSynapseWorkspaceSqlAadAdminTimeoutsBlock>? Timeouts { get; set; } = new();
