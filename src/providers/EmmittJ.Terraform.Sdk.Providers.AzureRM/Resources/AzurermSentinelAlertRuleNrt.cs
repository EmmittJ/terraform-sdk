...
/// Nesting mode: list
/// </summary>
public class AzurermSentinelAlertRuleNrtAlertDetailsOverrideBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermSentinelAlertRuleNrtEntityMappingBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermSentinelAlertRuleNrtEventGroupingBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermSentinelAlertRuleNrtIncidentBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermSentinelAlertRuleNrtSentinelEntityMappingBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelAlertRuleNrtTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelAlertRuleNrt : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermSentinelAlertRuleNrtAlertDetailsOverrideBlock>>? AlertDetailsOverride { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermSentinelAlertRuleNrtEntityMappingBlock>>? EntityMapping { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermSentinelAlertRuleNrtEventGroupingBlock>>? EventGrouping { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermSentinelAlertRuleNrtIncidentBlock>>? Incident { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermSentinelAlertRuleNrtSentinelEntityMappingBlock>>? SentinelEntityMapping { get; set; } = new();
    ...
    public TerraformBlock<AzurermSentinelAlertRuleNrtTimeoutsBlock>? Timeouts { get; set; } = new();
