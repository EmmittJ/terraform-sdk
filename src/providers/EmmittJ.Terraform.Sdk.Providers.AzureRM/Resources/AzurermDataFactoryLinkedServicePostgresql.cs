...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServicePostgresqlTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServicePostgresql : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServicePostgresqlTimeoutsBlock>? Timeouts { get; set; } = new();
