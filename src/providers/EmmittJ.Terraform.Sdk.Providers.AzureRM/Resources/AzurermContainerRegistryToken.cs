...
/// Nesting mode: single
/// </summary>
public partial class AzurermContainerRegistryTokenTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermContainerRegistryToken : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> ScopeMapId { get; set; }
    ...
    public TerraformBlock<AzurermContainerRegistryTokenTimeoutsBlock>? Timeouts { get; set; }
