...
/// Nesting mode: single
/// </summary>
public class AzurermContainerRegistryTokenTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermContainerRegistryToken : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ScopeMapId { get; set; }
    ...
    public TerraformBlock<AzurermContainerRegistryTokenTimeoutsBlock>? Timeouts { get; set; } = new();
