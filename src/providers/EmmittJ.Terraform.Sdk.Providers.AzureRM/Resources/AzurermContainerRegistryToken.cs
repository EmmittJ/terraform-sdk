...
/// Nesting mode: single
/// </summary>
public partial class AzurermContainerRegistryTokenTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermContainerRegistryToken : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ScopeMapId { get; set; }
    ...
    public AzurermContainerRegistryTokenTimeoutsBlock Timeouts { get; set; } = new();
