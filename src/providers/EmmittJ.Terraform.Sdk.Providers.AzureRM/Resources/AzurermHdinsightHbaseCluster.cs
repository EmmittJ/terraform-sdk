...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterComponentVersionBlock : ITerraformBlock
{
    /// <summary>
    /// The hbase attribute.
    /// </summary>
    ...
    public required TerraformProperty<TerraformProperty<string>> Hbase { get; set; }
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterComputeIsolationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterDiskEncryptionBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterExtensionBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterGatewayBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterMetastoresBlock : ITerraformBlock
{
}
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterMonitorBlock : ITerraformBlock
{
    /// <summary>
    /// The log_analytics_workspace_id attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterNetworkBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterPrivateLinkConfigurationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterRolesBlock : ITerraformBlock
{
}
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterSecurityProfileBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterStorageAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermHdinsightHbaseClusterStorageAccountGen2Block : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermHdinsightHbaseClusterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermHdinsightHbaseCluster : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterComponentVersionBlock>>? ComponentVersion { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterComputeIsolationBlock>>? ComputeIsolation { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterDiskEncryptionBlock>>? DiskEncryption { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterExtensionBlock>>? Extension { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterGatewayBlock>>? Gateway { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterMetastoresBlock>>? Metastores { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterMonitorBlock>>? Monitor { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterNetworkBlock>>? Network { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterPrivateLinkConfigurationBlock>>? PrivateLinkConfiguration { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterRolesBlock>>? Roles { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterSecurityProfileBlock>>? SecurityProfile { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterStorageAccountBlock>>? StorageAccount { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermHdinsightHbaseClusterStorageAccountGen2Block>>? StorageAccountGen2 { get; set; } = new();
    ...
    public TerraformBlock<AzurermHdinsightHbaseClusterTimeoutsBlock>? Timeouts { get; set; } = new();
