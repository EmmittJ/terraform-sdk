...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationCredentialTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAutomationCredential : TerraformResource
{
    ...
    public TerraformBlock<AzurermAutomationCredentialTimeoutsBlock>? Timeouts { get; set; } = new();
