...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbSqlFunctionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbSqlFunction : TerraformResource
{
    ...
    public TerraformBlock<AzurermCosmosdbSqlFunctionTimeoutsBlock>? Timeouts { get; set; } = new();
