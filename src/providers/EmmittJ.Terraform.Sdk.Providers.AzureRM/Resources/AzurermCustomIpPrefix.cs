...
public partial class AzurermCustomIpPrefix : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? CommissioningEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? InternetAdvertisingDisabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ParentCustomIpPrefixId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RoaValidityEndDate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? WanValidationSignedMessage { get; set; }
    ...
    public partial TerraformBlock<AzurermCustomIpPrefixTimeoutsBlock>? Timeouts { get; set; }
