...
/// Nesting mode: single
/// </summary>
public class AzurermCustomIpPrefixTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCustomIpPrefix : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? CommissioningEnabled { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? InternetAdvertisingDisabled { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ParentCustomIpPrefixId { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? RoaValidityEndDate { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? WanValidationSignedMessage { get; set; }
    ...
    public TerraformBlock<AzurermCustomIpPrefixTimeoutsBlock>? Timeouts { get; set; } = new();
