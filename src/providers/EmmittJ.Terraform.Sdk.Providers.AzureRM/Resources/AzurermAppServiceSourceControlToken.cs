...
/// Nesting mode: single
/// </summary>
public class AzurermAppServiceSourceControlTokenTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAppServiceSourceControlToken : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? TokenSecret { get; set; }
    ...
    public TerraformBlock<AzurermAppServiceSourceControlTokenTimeoutsBlock>? Timeouts { get; set; } = new();
