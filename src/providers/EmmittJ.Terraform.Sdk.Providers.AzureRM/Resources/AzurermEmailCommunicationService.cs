...
/// Nesting mode: single
/// </summary>
public class AzurermEmailCommunicationServiceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEmailCommunicationService : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> DataLocation { get; set; }
    ...
    public TerraformBlock<AzurermEmailCommunicationServiceTimeoutsBlock>? Timeouts { get; set; } = new();
