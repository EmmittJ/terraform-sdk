...
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbPostgresqlNodeConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermCosmosdbPostgresqlNodeConfiguration : TerraformResource
{
    ...
    public TerraformBlock<AzurermCosmosdbPostgresqlNodeConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
