...
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupVaultIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataProtectionBackupVaultTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataProtectionBackupVault : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> DatastoreType { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? Immutability { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Redundancy { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<double>>? RetentionDurationInDays { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? SoftDelete { get; set; }
    ...
    public TerraformList<TerraformBlock<AzurermDataProtectionBackupVaultIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataProtectionBackupVaultTimeoutsBlock>? Timeouts { get; set; } = new();
