...
public partial class AzurermVirtualMachineRestorePointCollection : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> SourceVirtualMachineId { get; set; }
    ...
    public TerraformBlock<AzurermVirtualMachineRestorePointCollectionTimeoutsBlock>? Timeouts { get; set; }
