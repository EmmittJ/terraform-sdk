...
public partial class AzurermVirtualMachineRestorePointCollection(string name) : TerraformResource("azurerm_virtual_machine_restore_point_collection", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    /// </summary>
    public AzurermVirtualMachineRestorePointCollectionTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermVirtualMachineRestorePointCollectionTimeoutsBlock>("timeouts");
