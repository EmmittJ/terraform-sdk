...
/// Nesting mode: single
/// </summary>
public class AzurermVirtualMachineRestorePointCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermVirtualMachineRestorePointCollection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SourceVirtualMachineId { get; set; }
    ...
    public TerraformBlock<AzurermVirtualMachineRestorePointCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
