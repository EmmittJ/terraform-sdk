...
/// Nesting mode: list
/// </summary>
public class AzurermStreamAnalyticsOutputServicebusTopicSerializationBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermStreamAnalyticsOutputServicebusTopicTimeoutsBlock
{
    /// <summary>
...
public class AzurermStreamAnalyticsOutputServicebusTopic : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermStreamAnalyticsOutputServicebusTopicSerializationBlock>>? Serialization { get; set; }
    ...
    public TerraformBlock<AzurermStreamAnalyticsOutputServicebusTopicTimeoutsBlock>? Timeouts { get; set; }
