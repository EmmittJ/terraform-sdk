...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceCosmosdbMongoapiTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceCosmosdbMongoapi : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("server_version_is_32_or_higher")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? ServerVersionIs32OrHigher { get; set; }
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceCosmosdbMongoapiTimeoutsBlock>? Timeouts { get; set; } = new();
