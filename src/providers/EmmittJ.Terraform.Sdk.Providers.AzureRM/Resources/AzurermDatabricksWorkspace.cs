...
public partial class AzurermDatabricksWorkspaceCustomParametersBlock() : TerraformBlock("custom_parameters")
{
    ...
    public partial TerraformValue<string>? MachineLearningWorkspaceId { get; set; }
    ...
    public partial TerraformValue<string> NatGatewayName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? NoPublicIp { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PrivateSubnetName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PrivateSubnetNetworkSecurityGroupAssociationId { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> PublicIpName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PublicSubnetName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PublicSubnetNetworkSecurityGroupAssociationId { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> StorageAccountSkuName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> VnetAddressPrefix { get; set; }
...
public partial class AzurermDatabricksWorkspaceEnhancedSecurityComplianceBlock() : TerraformBlock("enhanced_security_compliance")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AutomaticClusterUpdateEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ComplianceSecurityProfileEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? ComplianceSecurityProfileStandards { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnhancedSecurityMonitoringEnabled { get; set; }
...
public partial class AzurermDatabricksWorkspace : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? AccessConnectorId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? DefaultStorageFirewallEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? LoadBalancerBackendAddressPoolId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ManagedDiskCmkKeyVaultId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ManagedDiskCmkKeyVaultKeyId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ManagedDiskCmkRotationToLatestVersionEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ManagedServicesCmkKeyVaultId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ManagedServicesCmkKeyVaultKeyId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? NetworkSecurityGroupRulesRequired { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ManagedResourceGroupId { get; }
