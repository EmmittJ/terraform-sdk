...
/// </summary>
public partial class AzurermPrivateDnsResolverOutboundEndpoint(string name) : TerraformResource("azurerm_private_dns_resolver_outbound_endpoint", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermPrivateDnsResolverOutboundEndpointTimeoutsBlock>("timeouts");
