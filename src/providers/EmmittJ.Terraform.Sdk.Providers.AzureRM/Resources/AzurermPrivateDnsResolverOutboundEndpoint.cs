...
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsResolverOutboundEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPrivateDnsResolverOutboundEndpoint : TerraformResource
{
    ...
    public TerraformBlock<AzurermPrivateDnsResolverOutboundEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
