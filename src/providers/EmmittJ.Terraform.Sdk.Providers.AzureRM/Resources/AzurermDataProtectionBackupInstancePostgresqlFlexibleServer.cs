...
/// Nesting mode: single
/// </summary>
public class AzurermDataProtectionBackupInstancePostgresqlFlexibleServerTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataProtectionBackupInstancePostgresqlFlexibleServer : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataProtectionBackupInstancePostgresqlFlexibleServerTimeoutsBlock>? Timeouts { get; set; } = new();
