...
/// Nesting mode: single
/// </summary>
public class AzurermResourceGroupPolicyExemptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermResourceGroupPolicyExemption : TerraformResource
{
    ...
    public TerraformBlock<AzurermResourceGroupPolicyExemptionTimeoutsBlock>? Timeouts { get; set; } = new();
