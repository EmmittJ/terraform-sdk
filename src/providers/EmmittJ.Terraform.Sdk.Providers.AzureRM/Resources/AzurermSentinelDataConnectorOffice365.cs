...
/// Nesting mode: single
/// </summary>
public partial class AzurermSentinelDataConnectorOffice365TimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSentinelDataConnectorOffice365 : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ExchangeEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? SharepointEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? TeamsEnabled { get; set; }
    ...
    public AzurermSentinelDataConnectorOffice365TimeoutsBlock Timeouts { get; set; } = new();
