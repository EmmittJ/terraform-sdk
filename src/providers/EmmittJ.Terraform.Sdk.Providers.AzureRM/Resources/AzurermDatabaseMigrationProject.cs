...
/// Nesting mode: single
/// </summary>
public class AzurermDatabaseMigrationProjectTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDatabaseMigrationProject : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SourcePlatform { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> TargetPlatform { get; set; }
    ...
    public TerraformBlock<AzurermDatabaseMigrationProjectTimeoutsBlock>? Timeouts { get; set; } = new();
