...
/// Nesting mode: single
/// </summary>
public partial class AzurermDatabaseMigrationProjectTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermDatabaseMigrationProject : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SourcePlatform { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TargetPlatform { get; set; }
