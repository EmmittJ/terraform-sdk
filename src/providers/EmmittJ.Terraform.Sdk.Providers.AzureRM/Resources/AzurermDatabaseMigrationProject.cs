...
public partial class AzurermDatabaseMigrationProject : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> SourcePlatform { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> TargetPlatform { get; set; }
    ...
    public TerraformBlock<AzurermDatabaseMigrationProjectTimeoutsBlock>? Timeouts { get; set; }
