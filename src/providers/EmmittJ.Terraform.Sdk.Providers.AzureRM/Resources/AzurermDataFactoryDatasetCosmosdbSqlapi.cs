...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetCosmosdbSqlapiSchemaColumnBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetCosmosdbSqlapiTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryDatasetCosmosdbSqlapi : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetCosmosdbSqlapiSchemaColumnBlock>>? SchemaColumn { get; set; } = new();
    ...
    public TerraformBlock<AzurermDataFactoryDatasetCosmosdbSqlapiTimeoutsBlock>? Timeouts { get; set; } = new();
