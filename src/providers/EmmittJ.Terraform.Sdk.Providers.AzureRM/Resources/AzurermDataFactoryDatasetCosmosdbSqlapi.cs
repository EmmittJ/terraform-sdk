...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetCosmosdbSqlapiSchemaColumnBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetCosmosdbSqlapiTimeoutsBlock
{
    /// <summary>
...
public class AzurermDataFactoryDatasetCosmosdbSqlapi : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermDataFactoryDatasetCosmosdbSqlapiSchemaColumnBlock>>? SchemaColumn { get; set; }
    ...
    public TerraformBlock<AzurermDataFactoryDatasetCosmosdbSqlapiTimeoutsBlock>? Timeouts { get; set; }
