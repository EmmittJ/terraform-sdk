...
/// Nesting mode: single
/// </summary>
public class AzurermSiteRecoveryVmwareReplicationPolicyAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSiteRecoveryVmwareReplicationPolicyAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermSiteRecoveryVmwareReplicationPolicyAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
