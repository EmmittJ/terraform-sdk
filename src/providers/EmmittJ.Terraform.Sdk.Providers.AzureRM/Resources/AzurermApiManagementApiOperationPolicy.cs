...
/// Nesting mode: single
/// </summary>
public partial class AzurermApiManagementApiOperationPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermApiManagementApiOperationPolicy : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> XmlContent { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementApiOperationPolicyTimeoutsBlock>? Timeouts { get; set; }
