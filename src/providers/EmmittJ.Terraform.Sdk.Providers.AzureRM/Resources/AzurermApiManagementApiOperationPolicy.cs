...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiOperationPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiOperationPolicy : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementApiOperationPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
