...
/// Nesting mode: list
/// </summary>
public class AzurermExtendedCustomLocationAuthenticationBlock : ITerraformBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermExtendedCustomLocationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermExtendedCustomLocation : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermExtendedCustomLocationAuthenticationBlock>>? Authentication { get; set; } = new();
    ...
    public TerraformBlock<AzurermExtendedCustomLocationTimeoutsBlock>? Timeouts { get; set; } = new();
