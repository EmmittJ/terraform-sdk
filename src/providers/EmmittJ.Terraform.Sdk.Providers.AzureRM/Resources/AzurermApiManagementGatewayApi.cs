...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementGatewayApiTimeoutsBlock
{
    /// <summary>
...
public class AzurermApiManagementGatewayApi : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> GatewayId { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementGatewayApiTimeoutsBlock>? Timeouts { get; set; }
