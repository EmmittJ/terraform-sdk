...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementProductGroupTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementProductGroup : TerraformResource
{
    ...
    public TerraformBlock<AzurermApiManagementProductGroupTimeoutsBlock>? Timeouts { get; set; } = new();
