...
/// Nesting mode: single
/// </summary>
public class AzurermPaloAltoLocalRulestackOutboundUntrustCertificateAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPaloAltoLocalRulestackOutboundUntrustCertificateAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermPaloAltoLocalRulestackOutboundUntrustCertificateAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
