...
/// Nesting mode: single
/// </summary>
public class AzurermSecurityCenterSettingTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSecurityCenterSetting : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SettingName { get; set; }
    ...
    public TerraformBlock<AzurermSecurityCenterSettingTimeoutsBlock>? Timeouts { get; set; } = new();
