...
/// Nesting mode: single
/// </summary>
public partial class AzurermSecurityCenterSettingTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSecurityCenterSetting : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SettingName { get; set; }
