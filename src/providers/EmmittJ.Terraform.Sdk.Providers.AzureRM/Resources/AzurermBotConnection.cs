...
/// Nesting mode: single
/// </summary>
public partial class AzurermBotConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermBotConnection : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Scopes { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ServiceProviderName { get; set; }
    ...
    public AzurermBotConnectionTimeoutsBlock Timeouts { get; set; } = new();
