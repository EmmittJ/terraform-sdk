...
/// Nesting mode: single
/// </summary>
public class AzurermBotConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermBotConnection : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? Scopes { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ServiceProviderName { get; set; }
    ...
    public TerraformBlock<AzurermBotConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
