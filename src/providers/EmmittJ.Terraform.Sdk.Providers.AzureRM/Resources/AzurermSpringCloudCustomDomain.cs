...
/// Nesting mode: single
/// </summary>
public class AzurermSpringCloudCustomDomainTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSpringCloudCustomDomain : TerraformResource
{
    ...
    public TerraformBlock<AzurermSpringCloudCustomDomainTimeoutsBlock>? Timeouts { get; set; } = new();
