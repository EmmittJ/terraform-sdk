...
/// Nesting mode: single
/// </summary>
public partial class AzurermEventhubAuthorizationRuleTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermEventhubAuthorizationRule : TerraformResource
{
    public AzurermEventhubAuthorizationRule(string name) : base("azurerm_eventhub_authorization_rule", name)
    {
    }
    ...
    public partial TerraformBlock<AzurermEventhubAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; }
