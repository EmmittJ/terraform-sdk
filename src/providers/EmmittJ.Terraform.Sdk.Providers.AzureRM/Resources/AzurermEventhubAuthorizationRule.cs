...
/// Nesting mode: single
/// </summary>
public class AzurermEventhubAuthorizationRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventhubAuthorizationRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventhubAuthorizationRuleTimeoutsBlock>? Timeouts { get; set; } = new();
