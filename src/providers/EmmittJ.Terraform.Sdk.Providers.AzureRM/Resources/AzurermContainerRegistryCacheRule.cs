...
public partial class AzurermContainerRegistryCacheRule : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CredentialSetId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SourceRepo { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TargetRepo { get; set; }
    ...
    public partial TerraformBlock<AzurermContainerRegistryCacheRuleTimeoutsBlock>? Timeouts { get; set; }
