...
public partial class AzurermSignalrServiceUpstreamEndpointBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public partial TerraformList<string>? CategoryPattern { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public partial TerraformList<string>? EventPattern { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public partial TerraformList<string>? HubPattern { get; set; }
...
public partial class AzurermSignalrService : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? ServerlessConnectionTimeoutInSeconds { get; set; }
