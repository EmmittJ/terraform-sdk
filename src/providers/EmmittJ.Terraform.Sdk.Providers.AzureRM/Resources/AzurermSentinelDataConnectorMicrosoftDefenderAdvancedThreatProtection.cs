...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection : TerraformResource
{
    ...
    public TerraformBlock<AzurermSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtectionTimeoutsBlock>? Timeouts { get; set; } = new();
