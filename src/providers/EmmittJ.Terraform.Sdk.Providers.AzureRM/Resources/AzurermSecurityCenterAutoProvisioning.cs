...
/// Nesting mode: single
/// </summary>
public class AzurermSecurityCenterAutoProvisioningTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSecurityCenterAutoProvisioning : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> AutoProvision { get; set; }
    ...
    public TerraformBlock<AzurermSecurityCenterAutoProvisioningTimeoutsBlock>? Timeouts { get; set; } = new();
