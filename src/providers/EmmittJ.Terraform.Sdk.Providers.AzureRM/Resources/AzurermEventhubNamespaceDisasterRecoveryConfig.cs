...
/// Nesting mode: single
/// </summary>
public class AzurermEventhubNamespaceDisasterRecoveryConfigTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermEventhubNamespaceDisasterRecoveryConfig : TerraformResource
{
    ...
    public TerraformBlock<AzurermEventhubNamespaceDisasterRecoveryConfigTimeoutsBlock>? Timeouts { get; set; } = new();
