...
public partial class AzurermMssqlManagedInstanceStartStopScheduleScheduleBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<string> StartDay { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StopDay { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StopTime { get; set; }
...
public partial class AzurermMssqlManagedInstanceStartStopSchedule : TerraformResource
{
    ...
    public partial TerraformValue<string> NextExecutionTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> NextRunAction { get; }
