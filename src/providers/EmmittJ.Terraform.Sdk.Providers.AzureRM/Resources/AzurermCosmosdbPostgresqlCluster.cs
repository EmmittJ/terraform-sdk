...
public partial class AzurermCosmosdbPostgresqlCluster : TerraformResource
{
    ...
    public TerraformValue<string> CitusVersion { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<double> NodeStorageQuotaInMb { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<double> NodeVcores { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> ShardsOnCoordinatorEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> SqlVersion { get; set; }
    ...
    public TerraformValue<string> EarliestRestoreTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> Servers { get; }
