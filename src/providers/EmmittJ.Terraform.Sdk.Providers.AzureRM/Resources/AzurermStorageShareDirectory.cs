...
/// Nesting mode: single
/// </summary>
public class AzurermStorageShareDirectoryTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermStorageShareDirectory : TerraformResource
{
    ...
    public TerraformBlock<AzurermStorageShareDirectoryTimeoutsBlock>? Timeouts { get; set; } = new();
