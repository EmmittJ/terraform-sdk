...
/// Nesting mode: single
/// </summary>
public partial class AzurermSentinelWatchlistItemTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzurermSentinelWatchlistItem : TerraformResource
{
    ...
    public required partial TerraformMap<string> Properties { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> WatchlistId { get; set; }
    ...
    public AzurermSentinelWatchlistItemTimeoutsBlock Timeouts { get; set; } = new();
