...
/// Nesting mode: single
/// </summary>
public class AzurermApiManagementApiOperationTagTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermApiManagementApiOperationTag : TerraformResource
{
    ...
    [TerraformPropertyName("api_operation_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ApiOperationId { get; set; }
    ...
    public TerraformBlock<AzurermApiManagementApiOperationTagTimeoutsBlock>? Timeouts { get; set; } = new();
