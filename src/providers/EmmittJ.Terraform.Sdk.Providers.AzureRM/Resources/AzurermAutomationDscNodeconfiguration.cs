...
/// Nesting mode: single
/// </summary>
public class AzurermAutomationDscNodeconfigurationTimeoutsBlock
{
    /// <summary>
...
public class AzurermAutomationDscNodeconfiguration : TerraformResource
{
    ...
    public TerraformValue<string> ConfigurationName => new TerraformReference(this, "configuration_name");
