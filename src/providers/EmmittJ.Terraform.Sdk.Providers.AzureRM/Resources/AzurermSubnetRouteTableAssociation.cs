...
/// Nesting mode: single
/// </summary>
public class AzurermSubnetRouteTableAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermSubnetRouteTableAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermSubnetRouteTableAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
