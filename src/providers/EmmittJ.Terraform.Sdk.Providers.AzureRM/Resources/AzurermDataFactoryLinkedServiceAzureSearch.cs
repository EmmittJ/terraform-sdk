...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceAzureSearchTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceAzureSearch : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SearchServiceKey { get; set; }
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceAzureSearchTimeoutsBlock>? Timeouts { get; set; } = new();
