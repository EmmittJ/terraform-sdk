...
/// </summary>
public partial class AzurermDataFactoryLinkedServiceAzureSearch : TerraformResource
{
    ...
    [TerraformProperty("search_service_key")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SearchServiceKey { get; set; }
