...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkManagerSecurityAdminConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermNetworkManagerSecurityAdminConfiguration : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("apply_on_network_intent_policy_based_services")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? ApplyOnNetworkIntentPolicyBasedServices { get; set; }
    ...
    public TerraformBlock<AzurermNetworkManagerSecurityAdminConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
