...
/// Nesting mode: single
/// </summary>
public partial class AzurermMonitorWorkspaceTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermMonitorWorkspace : TerraformResource
{
    ...
    public partial TerraformBlock<AzurermMonitorWorkspaceTimeoutsBlock>? Timeouts { get; set; }
    ...
    public partial TerraformValue<string> DefaultDataCollectionEndpointId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DefaultDataCollectionRuleId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> QueryEndpoint { get; }
