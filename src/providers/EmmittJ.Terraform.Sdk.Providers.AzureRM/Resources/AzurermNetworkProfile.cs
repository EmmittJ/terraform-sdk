...
public partial class AzurermNetworkProfile : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AzurermNetworkProfileContainerNetworkInterfaceBlock>>? ContainerNetworkInterface { get; set; }
    ...
    public TerraformBlock<AzurermNetworkProfileTimeoutsBlock>? Timeouts { get; set; }

    /// <summary>
    /// The container_network_interface_ids attribute.
    /// </summary>
    [TerraformProperty("container_network_interface_ids")]
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> ContainerNetworkInterfaceIds { get; }
