...
/// Nesting mode: list
/// </summary>
public class AzurermNetworkProfileContainerNetworkInterfaceBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermNetworkProfileTimeoutsBlock
{
    /// <summary>
...
public class AzurermNetworkProfile : TerraformResource
{
    ...
    public TerraformList<string> ContainerNetworkInterfaceIds => new TerraformReference(this, "container_network_interface_ids");
