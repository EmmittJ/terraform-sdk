...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppAuthSettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppAuthSettingsV2Block : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppBackupBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermWindowsFunctionAppConnectionStringBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppIdentityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppSiteConfigBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AzurermWindowsFunctionAppStickySettingsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AzurermWindowsFunctionAppStorageAccountBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermWindowsFunctionAppTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermWindowsFunctionApp : TerraformResource
{
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<bool>> HttpsOnly { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "https_only");
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppAuthSettingsBlock>>? AuthSettings { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppAuthSettingsV2Block>>? AuthSettingsV2 { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppBackupBlock>>? Backup { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermWindowsFunctionAppConnectionStringBlock>>? ConnectionString { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppIdentityBlock>>? Identity { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppSiteConfigBlock>>? SiteConfig { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AzurermWindowsFunctionAppStickySettingsBlock>>? StickySettings { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AzurermWindowsFunctionAppStorageAccountBlock>>? StorageAccount { get; set; } = new();
    ...
    public TerraformBlock<AzurermWindowsFunctionAppTimeoutsBlock>? Timeouts { get; set; } = new();
