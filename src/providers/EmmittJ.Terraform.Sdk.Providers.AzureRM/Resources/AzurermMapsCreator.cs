...
/// Nesting mode: single
/// </summary>
public class AzurermMapsCreatorTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMapsCreator : TerraformResource
{
    ...
    [TerraformPropertyName("maps_account_id")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MapsAccountId { get; set; }
    ...
    [TerraformPropertyName("storage_units")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<double>> StorageUnits { get; set; }
    ...
    public TerraformBlock<AzurermMapsCreatorTimeoutsBlock>? Timeouts { get; set; } = new();
