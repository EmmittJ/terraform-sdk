...
/// Nesting mode: single
/// </summary>
public partial class AzurermMonitorDataCollectionEndpointTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzurermMonitorDataCollectionEndpoint : TerraformResource
{
    ...
    public TerraformValue<string> ConfigurationAccessEndpoint { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> LogsIngestionEndpoint { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> MetricsIngestionEndpoint { get; }
