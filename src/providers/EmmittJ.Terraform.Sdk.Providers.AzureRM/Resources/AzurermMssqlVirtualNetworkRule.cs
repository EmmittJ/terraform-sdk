...
/// Nesting mode: single
/// </summary>
public class AzurermMssqlVirtualNetworkRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMssqlVirtualNetworkRule : TerraformResource
{
    ...
    public TerraformBlock<AzurermMssqlVirtualNetworkRuleTimeoutsBlock>? Timeouts { get; set; } = new();
