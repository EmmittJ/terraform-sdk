...
/// Nesting mode: single
/// </summary>
public partial class AzurermBotChannelAlexaTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AzurermBotChannelAlexa : TerraformResource
{
    ...
    [TerraformProperty("skill_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SkillId { get; set; }
    ...
    public partial TerraformBlock<AzurermBotChannelAlexaTimeoutsBlock>? Timeouts { get; set; }
