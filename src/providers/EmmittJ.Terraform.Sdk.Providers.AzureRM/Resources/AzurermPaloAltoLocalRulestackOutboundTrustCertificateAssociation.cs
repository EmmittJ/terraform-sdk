...
/// Nesting mode: single
/// </summary>
public class AzurermPaloAltoLocalRulestackOutboundTrustCertificateAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermPaloAltoLocalRulestackOutboundTrustCertificateAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermPaloAltoLocalRulestackOutboundTrustCertificateAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
