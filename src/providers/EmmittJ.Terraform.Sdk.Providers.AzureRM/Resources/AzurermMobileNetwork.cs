...
/// Nesting mode: single
/// </summary>
public class AzurermMobileNetworkTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermMobileNetwork : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MobileCountryCode { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MobileNetworkCode { get; set; }
    ...
    public TerraformBlock<AzurermMobileNetworkTimeoutsBlock>? Timeouts { get; set; } = new();
