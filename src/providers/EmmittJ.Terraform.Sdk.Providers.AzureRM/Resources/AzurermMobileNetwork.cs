...
/// Nesting mode: single
/// </summary>
public partial class AzurermMobileNetworkTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AzurermMobileNetwork : TerraformResource
{
    ...
    public AzurermMobileNetworkTimeoutsBlock Timeouts { get; set; } = new();
