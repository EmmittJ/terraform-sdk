...
/// Nesting mode: single
/// </summary>
public class AzurermOracleAutonomousDatabaseCloneFromDatabaseTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermOracleAutonomousDatabaseCloneFromDatabase : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? RefreshableModel { get; set; }
    ...
    public TerraformBlock<AzurermOracleAutonomousDatabaseCloneFromDatabaseTimeoutsBlock>? Timeouts { get; set; } = new();
