...
/// Nesting mode: single
/// </summary>
public class AzurermManagementGroupSubscriptionAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermManagementGroupSubscriptionAssociation : TerraformResource
{
    ...
    public TerraformBlock<AzurermManagementGroupSubscriptionAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
