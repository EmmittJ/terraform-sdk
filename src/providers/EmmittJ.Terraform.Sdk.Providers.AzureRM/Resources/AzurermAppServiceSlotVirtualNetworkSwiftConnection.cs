...
/// Nesting mode: single
/// </summary>
public class AzurermAppServiceSlotVirtualNetworkSwiftConnectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermAppServiceSlotVirtualNetworkSwiftConnection : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SlotName { get; set; }
    ...
    public TerraformBlock<AzurermAppServiceSlotVirtualNetworkSwiftConnectionTimeoutsBlock>? Timeouts { get; set; } = new();
