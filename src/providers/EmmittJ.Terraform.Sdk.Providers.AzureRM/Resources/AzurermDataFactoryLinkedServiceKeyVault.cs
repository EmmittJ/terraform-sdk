...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceKeyVaultTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceKeyVault : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceKeyVaultTimeoutsBlock>? Timeouts { get; set; } = new();
