...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryLinkedServiceKeyVaultTimeoutsBlock
{
    /// <summary>
...
public class AzurermDataFactoryLinkedServiceKeyVault : TerraformResource
{
    ...
    public TerraformBlock<AzurermDataFactoryLinkedServiceKeyVaultTimeoutsBlock>? Timeouts { get; set; }
