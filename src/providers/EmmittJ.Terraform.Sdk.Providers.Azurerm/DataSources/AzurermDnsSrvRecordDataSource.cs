...
/// <summary>
/// Block type for timeouts in AzurermDnsSrvRecordDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_dns_srv_record Terraform data source.
/// Retrieves information about a azurerm_dns_srv_record.
/// </summary>
public partial class AzurermDnsSrvRecordDataSource(string name) : TerraformDataSource("azurerm_dns_srv_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDnsSrvRecordDataSourceTimeoutsBlock>("timeouts");
