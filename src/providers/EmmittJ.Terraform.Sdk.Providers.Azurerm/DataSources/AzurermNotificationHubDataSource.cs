...
/// <summary>
/// Block type for timeouts in AzurermNotificationHubDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_notification_hub Terraform data source.
/// Retrieves information about a azurerm_notification_hub.
/// </summary>
public partial class AzurermNotificationHubDataSource(string name) : TerraformDataSource("azurerm_notification_hub", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermNotificationHubDataSourceTimeoutsBlock>("timeouts");
