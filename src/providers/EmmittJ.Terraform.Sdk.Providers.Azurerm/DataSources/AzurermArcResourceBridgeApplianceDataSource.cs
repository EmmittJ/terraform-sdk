...
/// </summary>
public partial class AzurermArcResourceBridgeApplianceDataSource(string name) : TerraformDataSource("azurerm_arc_resource_bridge_appliance", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermArcResourceBridgeApplianceDataSourceTimeoutsBlock>("timeouts");
