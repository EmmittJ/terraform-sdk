...
public partial class AzurermDashboardGrafanaDataSource(string name) : TerraformDataSource("azurerm_dashboard_grafana", name)
{
    ...
    public TerraformValue<string> GrafanaMajorVersion
        => AsReference("grafana_major_version");
    ...
    public TerraformValue<bool> ZoneRedundancyEnabled
        => AsReference("zone_redundancy_enabled");
