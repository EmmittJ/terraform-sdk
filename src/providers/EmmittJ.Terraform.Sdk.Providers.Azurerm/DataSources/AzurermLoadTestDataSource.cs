...
/// <summary>
/// Block type for timeouts in AzurermLoadTestDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_load_test Terraform data source.
/// Retrieves information about a azurerm_load_test.
/// </summary>
public partial class AzurermLoadTestDataSource(string name) : TerraformDataSource("azurerm_load_test", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermLoadTestDataSourceTimeoutsBlock>("timeouts");
