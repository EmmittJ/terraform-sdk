...
/// </summary>
public partial class AzurermStackHciStoragePathDataSource(string name) : TerraformDataSource("azurerm_stack_hci_storage_path", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformValue<string> CustomLocationId
        => AsReference("custom_location_id");
    ...
    {
        get => GetArgument<AzurermStackHciStoragePathDataSourceTimeoutsBlock>("timeouts");
