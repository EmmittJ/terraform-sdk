...
/// <summary>
/// Block type for timeouts in AzurermSiteRecoveryFabricDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_site_recovery_fabric Terraform data source.
/// Retrieves information about a azurerm_site_recovery_fabric.
/// </summary>
public partial class AzurermSiteRecoveryFabricDataSource(string name) : TerraformDataSource("azurerm_site_recovery_fabric", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermSiteRecoveryFabricDataSourceTimeoutsBlock>("timeouts");
