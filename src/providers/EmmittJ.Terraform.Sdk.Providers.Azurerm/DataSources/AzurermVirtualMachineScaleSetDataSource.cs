...
/// <summary>
/// Block type for timeouts in AzurermVirtualMachineScaleSetDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_virtual_machine_scale_set Terraform data source.
/// Retrieves information about a azurerm_virtual_machine_scale_set.
/// </summary>
public partial class AzurermVirtualMachineScaleSetDataSource(string name) : TerraformDataSource("azurerm_virtual_machine_scale_set", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermVirtualMachineScaleSetDataSourceTimeoutsBlock>("timeouts");
