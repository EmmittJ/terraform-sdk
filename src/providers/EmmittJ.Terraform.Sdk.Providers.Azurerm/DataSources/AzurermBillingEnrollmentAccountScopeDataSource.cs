...
/// <summary>
/// Block type for timeouts in AzurermBillingEnrollmentAccountScopeDataSource.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_billing_enrollment_account_scope Terraform data source.
/// Retrieves information about a azurerm_billing_enrollment_account_scope.
/// </summary>
public partial class AzurermBillingEnrollmentAccountScopeDataSource(string name) : TerraformDataSource("azurerm_billing_enrollment_account_scope", name)
{
    /// <summary>
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("enrollment_account_name");
    ...
    {
        get => GetArgument<AzurermBillingEnrollmentAccountScopeDataSourceTimeoutsBlock>("timeouts");
