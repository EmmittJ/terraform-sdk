...
/// <summary>
/// Block type for timeouts in AzurermSynapseWorkspaceSecurityAlertPolicy.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_synapse_workspace_security_alert_policy Terraform resource.
/// Manages a azurerm_synapse_workspace_security_alert_policy resource.
/// </summary>
public partial class AzurermSynapseWorkspaceSecurityAlertPolicy(string name) : TerraformResource("azurerm_synapse_workspace_security_alert_policy", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermSynapseWorkspaceSecurityAlertPolicyTimeoutsBlock>("timeouts");
