...
/// <summary>
/// Block type for timeouts in AzurermIothubEndpointEventhub.
/// Nesting mode: single
/// </summary>
public class AzurermIothubEndpointEventhubTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_iothub_endpoint_eventhub Terraform resource.
/// Manages a azurerm_iothub_endpoint_eventhub resource.
/// </summary>
public partial class AzurermIothubEndpointEventhub(string name) : TerraformResource("azurerm_iothub_endpoint_eventhub", name)
{
    /// <summary>
    ...
    /// </summary>
    public AzurermIothubEndpointEventhubTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermIothubEndpointEventhubTimeoutsBlock>("timeouts");
