...
/// <summary>
/// Block type for default_retention_rule in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServer.
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleBlock : TerraformBlock
{
    ...
    public required TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleBlockLifeCycleAttributeBlock> LifeCycleAttribute
    {
        get => GetRequiredArgument<TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleBlockLifeCycleAttributeBlock>>("life_cycle");
...
/// <summary>
/// Block type for life_cycle in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleBlock.
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleBlockLifeCycleAttributeBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for retention_rule in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServer.
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlock : TerraformBlock
{
    ...
    public required TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockCriteriaBlock> Criteria
    {
        get => GetRequiredArgument<TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockCriteriaBlock>>("criteria");
    ...
    [System.ComponentModel.DataAnnotations.Required(ErrorMessage = "LifeCycleAttribute is required")]
    [System.ComponentModel.DataAnnotations.MinLength(1, ErrorMessage = "At least 1 LifeCycleAttribute block(s) required")]
    public required TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockLifeCycleAttributeBlock> LifeCycleAttribute
    {
        get => GetRequiredArgument<TerraformList<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockLifeCycleAttributeBlock>>("life_cycle");
        set => SetArgument("life_cycle", value);
    }
...
/// <summary>
/// Block type for criteria in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlock.
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockCriteriaBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for life_cycle in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlock.
/// Nesting mode: list
/// </summary>
public class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerRetentionRuleBlockLifeCycleAttributeBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermDataProtectionBackupPolicyPostgresqlFlexibleServer.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_data_protection_backup_policy_postgresql_flexible_server Terraform resource.
/// Manages a azurerm_data_protection_backup_policy_postgresql_flexible_server resource.
/// </summary>
public partial class AzurermDataProtectionBackupPolicyPostgresqlFlexibleServer(string name) : TerraformResource("azurerm_data_protection_backup_policy_postgresql_flexible_server", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermDataProtectionBackupPolicyPostgresqlFlexibleServerTimeoutsBlock>("timeouts");
