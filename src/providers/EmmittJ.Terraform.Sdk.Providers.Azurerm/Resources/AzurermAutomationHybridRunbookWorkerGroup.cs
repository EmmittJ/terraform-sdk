...
/// </summary>
public partial class AzurermAutomationHybridRunbookWorkerGroup(string name) : TerraformResource("azurerm_automation_hybrid_runbook_worker_group", name)
{
    /// <summary>
    ...
    /// </summary>
    public AzurermAutomationHybridRunbookWorkerGroupTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermAutomationHybridRunbookWorkerGroupTimeoutsBlock>("timeouts");
