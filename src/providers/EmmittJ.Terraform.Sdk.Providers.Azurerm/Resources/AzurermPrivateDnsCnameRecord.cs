...
/// <summary>
/// Block type for timeouts in AzurermPrivateDnsCnameRecord.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_private_dns_cname_record Terraform resource.
/// Manages a azurerm_private_dns_cname_record resource.
/// </summary>
public partial class AzurermPrivateDnsCnameRecord(string name) : TerraformResource("azurerm_private_dns_cname_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public required TerraformValue<string> Record
    {
        get => GetRequiredArgument<TerraformValue<string>>("record");
    ...
    {
        get => GetArgument<AzurermPrivateDnsCnameRecordTimeoutsBlock>("timeouts");
