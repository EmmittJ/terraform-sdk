...
/// </summary>
public partial class AzurermManagementGroupPolicySetDefinition(string name) : TerraformResource("azurerm_management_group_policy_set_definition", name)
{
    /// <summary>
    /// The description attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermManagementGroupPolicySetDefinitionTimeoutsBlock>("timeouts");
