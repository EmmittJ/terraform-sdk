...
public partial class AzurermBastionHost(string name) : TerraformResource("azurerm_bastion_host", name)
{
    ...
    {
        get => GetArgument<TerraformValue<bool>>("copy_paste_enabled");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("file_copy_enabled");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("ip_connect_enabled");
    ...
    {
        get => GetArgument<TerraformValue<double>>("scale_units");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("session_recording_enabled");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("shareable_link_enabled");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("tunneling_enabled");
