...
/// </summary>
public partial class AzurermDigitalTwinsInstance(string name) : TerraformResource("azurerm_digital_twins_instance", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDigitalTwinsInstanceTimeoutsBlock>("timeouts");
