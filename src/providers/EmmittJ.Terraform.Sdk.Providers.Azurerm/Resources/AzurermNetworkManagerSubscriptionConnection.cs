...
/// <summary>
/// Block type for timeouts in AzurermNetworkManagerSubscriptionConnection.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_network_manager_subscription_connection Terraform resource.
/// Manages a azurerm_network_manager_subscription_connection resource.
/// </summary>
public partial class AzurermNetworkManagerSubscriptionConnection(string name) : TerraformResource("azurerm_network_manager_subscription_connection", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermNetworkManagerSubscriptionConnectionTimeoutsBlock>("timeouts");
