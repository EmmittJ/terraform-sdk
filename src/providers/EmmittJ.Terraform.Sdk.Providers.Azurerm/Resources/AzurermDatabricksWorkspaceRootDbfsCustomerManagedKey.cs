...
/// </summary>
public partial class AzurermDatabricksWorkspaceRootDbfsCustomerManagedKey(string name) : TerraformResource("azurerm_databricks_workspace_root_dbfs_customer_managed_key", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDatabricksWorkspaceRootDbfsCustomerManagedKeyTimeoutsBlock>("timeouts");
