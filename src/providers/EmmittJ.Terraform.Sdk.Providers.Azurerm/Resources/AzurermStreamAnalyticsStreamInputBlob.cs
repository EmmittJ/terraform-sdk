...
/// <summary>
/// Block type for serialization in AzurermStreamAnalyticsStreamInputBlob.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermStreamAnalyticsStreamInputBlob.
/// Nesting mode: single
/// </summary>
...
public partial class AzurermStreamAnalyticsStreamInputBlob(string name) : TerraformResource("azurerm_stream_analytics_stream_input_blob", name)
{
    ...
    public required TerraformList<AzurermStreamAnalyticsStreamInputBlobSerializationBlock> Serialization
    {
        get => GetRequiredArgument<TerraformList<AzurermStreamAnalyticsStreamInputBlobSerializationBlock>>("serialization");
