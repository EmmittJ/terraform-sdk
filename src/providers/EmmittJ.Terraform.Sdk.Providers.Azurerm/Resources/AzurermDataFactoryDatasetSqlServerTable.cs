...
/// <summary>
/// Block type for schema_column in AzurermDataFactoryDatasetSqlServerTable.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermDataFactoryDatasetSqlServerTable.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_data_factory_dataset_sql_server_table Terraform resource.
/// Manages a azurerm_data_factory_dataset_sql_server_table resource.
/// </summary>
public partial class AzurermDataFactoryDatasetSqlServerTable(string name) : TerraformResource("azurerm_data_factory_dataset_sql_server_table", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformList<AzurermDataFactoryDatasetSqlServerTableSchemaColumnBlock>? SchemaColumn
    {
        get => GetArgument<TerraformList<AzurermDataFactoryDatasetSqlServerTableSchemaColumnBlock>>("schema_column");
    ...
    {
        get => GetArgument<AzurermDataFactoryDatasetSqlServerTableTimeoutsBlock>("timeouts");
