...
/// <summary>
/// Block type for timeouts in AzurermBotChannelSlack.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_bot_channel_slack Terraform resource.
/// Manages a azurerm_bot_channel_slack resource.
/// </summary>
public partial class AzurermBotChannelSlack(string name) : TerraformResource("azurerm_bot_channel_slack", name)
{
    /// <summary>
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("verification_token");
    ...
    {
        get => GetArgument<AzurermBotChannelSlackTimeoutsBlock>("timeouts");
