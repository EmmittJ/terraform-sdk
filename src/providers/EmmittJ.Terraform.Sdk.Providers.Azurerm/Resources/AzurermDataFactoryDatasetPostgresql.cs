...
/// <summary>
/// Block type for schema_column in AzurermDataFactoryDatasetPostgresql.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermDataFactoryDatasetPostgresql.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_data_factory_dataset_postgresql Terraform resource.
/// Manages a azurerm_data_factory_dataset_postgresql resource.
/// </summary>
public partial class AzurermDataFactoryDatasetPostgresql(string name) : TerraformResource("azurerm_data_factory_dataset_postgresql", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermDataFactoryDatasetPostgresqlTimeoutsBlock>("timeouts");
