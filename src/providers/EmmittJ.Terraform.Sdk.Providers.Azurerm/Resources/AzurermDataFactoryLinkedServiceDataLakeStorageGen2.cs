...
/// </summary>
public partial class AzurermDataFactoryLinkedServiceDataLakeStorageGen2(string name) : TerraformResource("azurerm_data_factory_linked_service_data_lake_storage_gen2", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermDataFactoryLinkedServiceDataLakeStorageGen2TimeoutsBlock>("timeouts");
