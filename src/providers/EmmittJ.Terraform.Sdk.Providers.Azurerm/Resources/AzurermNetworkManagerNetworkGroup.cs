...
/// <summary>
/// Block type for timeouts in AzurermNetworkManagerNetworkGroup.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_network_manager_network_group Terraform resource.
/// Manages a azurerm_network_manager_network_group resource.
/// </summary>
public partial class AzurermNetworkManagerNetworkGroup(string name) : TerraformResource("azurerm_network_manager_network_group", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermNetworkManagerNetworkGroupTimeoutsBlock>("timeouts");
