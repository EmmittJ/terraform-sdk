...
/// <summary>
/// Block type for timeouts in AzurermPrivateDnsPtrRecord.
/// Nesting mode: single
/// </summary>
public class AzurermPrivateDnsPtrRecordTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_private_dns_ptr_record Terraform resource.
/// Manages a azurerm_private_dns_ptr_record resource.
/// </summary>
public partial class AzurermPrivateDnsPtrRecord(string name) : TerraformResource("azurerm_private_dns_ptr_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    /// </summary>
    public AzurermPrivateDnsPtrRecordTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermPrivateDnsPtrRecordTimeoutsBlock>("timeouts");
