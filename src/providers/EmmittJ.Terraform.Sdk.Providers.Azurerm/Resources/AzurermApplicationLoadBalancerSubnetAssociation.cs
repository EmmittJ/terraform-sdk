...
/// <summary>
/// Block type for timeouts in AzurermApplicationLoadBalancerSubnetAssociation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_application_load_balancer_subnet_association Terraform resource.
/// Manages a azurerm_application_load_balancer_subnet_association resource.
/// </summary>
public partial class AzurermApplicationLoadBalancerSubnetAssociation(string name) : TerraformResource("azurerm_application_load_balancer_subnet_association", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermApplicationLoadBalancerSubnetAssociationTimeoutsBlock>("timeouts");
