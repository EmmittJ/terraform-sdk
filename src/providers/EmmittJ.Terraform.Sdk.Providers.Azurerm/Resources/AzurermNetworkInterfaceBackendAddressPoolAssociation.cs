...
/// <summary>
/// Block type for timeouts in AzurermNetworkInterfaceBackendAddressPoolAssociation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_network_interface_backend_address_pool_association Terraform resource.
/// Manages a azurerm_network_interface_backend_address_pool_association resource.
/// </summary>
public partial class AzurermNetworkInterfaceBackendAddressPoolAssociation(string name) : TerraformResource("azurerm_network_interface_backend_address_pool_association", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermNetworkInterfaceBackendAddressPoolAssociationTimeoutsBlock>("timeouts");
