...
/// <summary>
/// Block type for timeouts in AzurermDnsCnameRecord.
/// Nesting mode: single
/// </summary>
public class AzurermDnsCnameRecordTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_dns_cname_record Terraform resource.
/// Manages a azurerm_dns_cname_record resource.
/// </summary>
public partial class AzurermDnsCnameRecord(string name) : TerraformResource("azurerm_dns_cname_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    /// </summary>
    public AzurermDnsCnameRecordTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermDnsCnameRecordTimeoutsBlock>("timeouts");
