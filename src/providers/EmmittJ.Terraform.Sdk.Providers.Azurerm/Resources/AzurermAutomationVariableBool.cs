...
/// </summary>
public partial class AzurermAutomationVariableBool(string name) : TerraformResource("azurerm_automation_variable_bool", name)
{
    /// <summary>
    ...
    /// </summary>
    public AzurermAutomationVariableBoolTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermAutomationVariableBoolTimeoutsBlock>("timeouts");
