...
/// <summary>
/// Block type for timeouts in AzurermDataFactoryLinkedServiceCosmosdbMongoapi.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_data_factory_linked_service_cosmosdb_mongoapi Terraform resource.
/// Manages a azurerm_data_factory_linked_service_cosmosdb_mongoapi resource.
/// </summary>
public partial class AzurermDataFactoryLinkedServiceCosmosdbMongoapi(string name) : TerraformResource("azurerm_data_factory_linked_service_cosmosdb_mongoapi", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<TerraformValue<bool>>("server_version_is_32_or_higher");
    ...
    {
        get => GetArgument<AzurermDataFactoryLinkedServiceCosmosdbMongoapiTimeoutsBlock>("timeouts");
