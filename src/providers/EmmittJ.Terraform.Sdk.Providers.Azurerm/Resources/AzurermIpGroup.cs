...
/// <summary>
/// Block type for timeouts in AzurermIpGroup.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_ip_group Terraform resource.
/// Manages a azurerm_ip_group resource.
/// </summary>
public partial class AzurermIpGroup(string name) : TerraformResource("azurerm_ip_group", name)
{
    /// <summary>
    /// The cidrs attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermIpGroupTimeoutsBlock>("timeouts");
