...
/// <summary>
/// Block type for timeouts in AzurermMonitorWorkspace.
/// Nesting mode: single
/// </summary>
public class AzurermMonitorWorkspaceTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_monitor_workspace Terraform resource.
/// Manages a azurerm_monitor_workspace resource.
/// </summary>
public partial class AzurermMonitorWorkspace(string name) : TerraformResource("azurerm_monitor_workspace", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermMonitorWorkspaceTimeoutsBlock>("timeouts");
