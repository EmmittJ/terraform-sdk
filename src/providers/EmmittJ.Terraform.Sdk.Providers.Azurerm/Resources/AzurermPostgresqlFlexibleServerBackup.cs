...
/// <summary>
/// Block type for timeouts in AzurermPostgresqlFlexibleServerBackup.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_postgresql_flexible_server_backup Terraform resource.
/// Manages a azurerm_postgresql_flexible_server_backup resource.
/// </summary>
public partial class AzurermPostgresqlFlexibleServerBackup(string name) : TerraformResource("azurerm_postgresql_flexible_server_backup", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermPostgresqlFlexibleServerBackupTimeoutsBlock>("timeouts");
