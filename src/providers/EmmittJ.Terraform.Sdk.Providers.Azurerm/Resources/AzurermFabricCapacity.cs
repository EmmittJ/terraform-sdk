...
/// <summary>
/// Block type for sku in AzurermFabricCapacity.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermFabricCapacity.
/// Nesting mode: single
/// </summary>
...
public partial class AzurermFabricCapacity(string name) : TerraformResource("azurerm_fabric_capacity", name)
{
    ...
    {
        get => GetArgument<TerraformSet<string>>("administration_members");
        set => SetArgument("administration_members", value);
    }
