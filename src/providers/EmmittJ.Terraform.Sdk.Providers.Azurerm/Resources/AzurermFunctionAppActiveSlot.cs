...
/// </summary>
public partial class AzurermFunctionAppActiveSlot(string name) : TerraformResource("azurerm_function_app_active_slot", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermFunctionAppActiveSlotTimeoutsBlock>("timeouts");
