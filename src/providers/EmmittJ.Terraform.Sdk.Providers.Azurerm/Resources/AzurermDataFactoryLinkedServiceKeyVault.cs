...
/// <summary>
/// Block type for timeouts in AzurermDataFactoryLinkedServiceKeyVault.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_data_factory_linked_service_key_vault Terraform resource.
/// Manages a azurerm_data_factory_linked_service_key_vault resource.
/// </summary>
public partial class AzurermDataFactoryLinkedServiceKeyVault(string name) : TerraformResource("azurerm_data_factory_linked_service_key_vault", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermDataFactoryLinkedServiceKeyVaultTimeoutsBlock>("timeouts");
