...
/// <summary>
/// Block type for timeouts in AzurermSentinelDataConnectorIot.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_sentinel_data_connector_iot Terraform resource.
/// Manages a azurerm_sentinel_data_connector_iot resource.
/// </summary>
public partial class AzurermSentinelDataConnectorIot(string name) : TerraformResource("azurerm_sentinel_data_connector_iot", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermSentinelDataConnectorIotTimeoutsBlock>("timeouts");
