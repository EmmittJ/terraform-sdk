...
/// </summary>
public partial class AzurermDataShareAccount(string name) : TerraformResource("azurerm_data_share_account", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDataShareAccountTimeoutsBlock>("timeouts");
