...
/// <summary>
/// Block type for timeouts in AzurermResourceGroupPolicyRemediation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_resource_group_policy_remediation Terraform resource.
/// Manages a azurerm_resource_group_policy_remediation resource.
/// </summary>
public partial class AzurermResourceGroupPolicyRemediation(string name) : TerraformResource("azurerm_resource_group_policy_remediation", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermResourceGroupPolicyRemediationTimeoutsBlock>("timeouts");
