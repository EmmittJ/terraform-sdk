...
/// <summary>
/// Block type for timeouts in AzurermOracleAutonomousDatabaseCloneFromBackup.
/// Nesting mode: single
/// </summary>
...
public partial class AzurermOracleAutonomousDatabaseCloneFromBackup(string name) : TerraformResource("azurerm_oracle_autonomous_database_clone_from_backup", name)
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("backup_timestamp");
    ...
    {
        get => GetArgument<TerraformValue<string>>("clone_type");
    ...
    {
        get => GetArgument<TerraformValue<double>>("data_storage_size_in_tb");
    ...
    {
        get => GetArgument<TerraformValue<string>>("database_workload");
    ...
    {
        get => GetArgument<TerraformValue<string>>("source_autonomous_database_id");
