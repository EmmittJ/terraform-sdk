...
/// <summary>
/// Block type for timeouts in AzurermCdnFrontdoorEndpoint.
/// Nesting mode: single
/// </summary>
public class AzurermCdnFrontdoorEndpointTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_cdn_frontdoor_endpoint Terraform resource.
/// Manages a azurerm_cdn_frontdoor_endpoint resource.
/// </summary>
public partial class AzurermCdnFrontdoorEndpoint(string name) : TerraformResource("azurerm_cdn_frontdoor_endpoint", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermCdnFrontdoorEndpointTimeoutsBlock>("timeouts");
