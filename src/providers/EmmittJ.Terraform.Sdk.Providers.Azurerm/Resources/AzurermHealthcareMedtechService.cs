...
/// </summary>
public partial class AzurermHealthcareMedtechService(string name) : TerraformResource("azurerm_healthcare_medtech_service", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermHealthcareMedtechServiceTimeoutsBlock>("timeouts");
