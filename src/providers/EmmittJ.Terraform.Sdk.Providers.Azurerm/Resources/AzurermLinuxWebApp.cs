...
public class AzurermLinuxWebAppSiteConfigBlockApplicationStackBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("go_version");
    ...
    {
        get => GetArgument<TerraformValue<string>>("java_server");
    ...
    {
        get => GetArgument<TerraformValue<string>>("java_server_version");
    ...
    {
        get => GetArgument<TerraformValue<string>>("ruby_version");
