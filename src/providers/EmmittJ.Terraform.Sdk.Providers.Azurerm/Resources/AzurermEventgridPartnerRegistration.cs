...
/// </summary>
public partial class AzurermEventgridPartnerRegistration(string name) : TerraformResource("azurerm_eventgrid_partner_registration", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermEventgridPartnerRegistrationTimeoutsBlock>("timeouts");
