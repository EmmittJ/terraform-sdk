...
public partial class AzurermPostgresqlVirtualNetworkRule(string name) : TerraformResource("azurerm_postgresql_virtual_network_rule", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermPostgresqlVirtualNetworkRuleTimeoutsBlock>("timeouts");
