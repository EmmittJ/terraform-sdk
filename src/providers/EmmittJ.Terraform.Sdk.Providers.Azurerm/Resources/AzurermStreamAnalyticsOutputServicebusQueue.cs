...
/// </summary>
public partial class AzurermStreamAnalyticsOutputServicebusQueue(string name) : TerraformResource("azurerm_stream_analytics_output_servicebus_queue", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<TerraformMap<string>>("system_property_columns");
    ...
    public required TerraformList<AzurermStreamAnalyticsOutputServicebusQueueSerializationBlock> Serialization
    {
        get => GetRequiredArgument<TerraformList<AzurermStreamAnalyticsOutputServicebusQueueSerializationBlock>>("serialization");
    ...
    {
        get => GetArgument<AzurermStreamAnalyticsOutputServicebusQueueTimeoutsBlock>("timeouts");
