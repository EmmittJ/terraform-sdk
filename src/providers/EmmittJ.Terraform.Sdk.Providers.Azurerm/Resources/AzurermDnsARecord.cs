...
/// <summary>
/// Block type for timeouts in AzurermDnsARecord.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_dns_a_record Terraform resource.
/// Manages a azurerm_dns_a_record resource.
/// </summary>
public partial class AzurermDnsARecord(string name) : TerraformResource("azurerm_dns_a_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDnsARecordTimeoutsBlock>("timeouts");
