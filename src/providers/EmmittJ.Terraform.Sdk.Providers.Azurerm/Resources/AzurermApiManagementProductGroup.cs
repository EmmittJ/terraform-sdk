...
/// </summary>
public partial class AzurermApiManagementProductGroup(string name) : TerraformResource("azurerm_api_management_product_group", name)
{
    /// <summary>
    ...
    /// </summary>
    public AzurermApiManagementProductGroupTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermApiManagementProductGroupTimeoutsBlock>("timeouts");
