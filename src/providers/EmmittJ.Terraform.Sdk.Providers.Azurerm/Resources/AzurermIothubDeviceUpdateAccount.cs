...
/// </summary>
public partial class AzurermIothubDeviceUpdateAccount(string name) : TerraformResource("azurerm_iothub_device_update_account", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermIothubDeviceUpdateAccountTimeoutsBlock>("timeouts");
