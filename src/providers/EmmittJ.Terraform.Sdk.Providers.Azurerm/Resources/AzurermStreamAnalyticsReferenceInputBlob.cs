...
/// <summary>
/// Block type for serialization in AzurermStreamAnalyticsReferenceInputBlob.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermStreamAnalyticsReferenceInputBlob.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_stream_analytics_reference_input_blob Terraform resource.
/// Manages a azurerm_stream_analytics_reference_input_blob resource.
/// </summary>
public partial class AzurermStreamAnalyticsReferenceInputBlob(string name) : TerraformResource("azurerm_stream_analytics_reference_input_blob", name)
{
    /// <summary>
    ...
    public required TerraformList<AzurermStreamAnalyticsReferenceInputBlobSerializationBlock> Serialization
    {
        get => GetRequiredArgument<TerraformList<AzurermStreamAnalyticsReferenceInputBlobSerializationBlock>>("serialization");
    ...
    {
        get => GetArgument<AzurermStreamAnalyticsReferenceInputBlobTimeoutsBlock>("timeouts");
