...
/// <summary>
/// Block type for autoscale_settings in AzurermCosmosdbGremlinDatabase.
/// Nesting mode: list
/// </summary>
public class AzurermCosmosdbGremlinDatabaseAutoscaleSettingsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermCosmosdbGremlinDatabase.
/// Nesting mode: single
/// </summary>
public class AzurermCosmosdbGremlinDatabaseTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_cosmosdb_gremlin_database Terraform resource.
/// Manages a azurerm_cosmosdb_gremlin_database resource.
/// </summary>
public partial class AzurermCosmosdbGremlinDatabase(string name) : TerraformResource("azurerm_cosmosdb_gremlin_database", name)
{
    /// <summary>
    ...
    /// </summary>
    public AzurermCosmosdbGremlinDatabaseTimeoutsBlock? Timeouts
    {
        get => GetArgument<AzurermCosmosdbGremlinDatabaseTimeoutsBlock>("timeouts");
