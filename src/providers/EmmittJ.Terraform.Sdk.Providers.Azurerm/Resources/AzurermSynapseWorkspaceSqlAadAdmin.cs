...
/// <summary>
/// Block type for timeouts in AzurermSynapseWorkspaceSqlAadAdmin.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_synapse_workspace_sql_aad_admin Terraform resource.
/// Manages a azurerm_synapse_workspace_sql_aad_admin resource.
/// </summary>
public partial class AzurermSynapseWorkspaceSqlAadAdmin(string name) : TerraformResource("azurerm_synapse_workspace_sql_aad_admin", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermSynapseWorkspaceSqlAadAdminTimeoutsBlock>("timeouts");
