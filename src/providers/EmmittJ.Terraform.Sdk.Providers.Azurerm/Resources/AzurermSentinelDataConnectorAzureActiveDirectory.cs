...
/// </summary>
public partial class AzurermSentinelDataConnectorAzureActiveDirectory(string name) : TerraformResource("azurerm_sentinel_data_connector_azure_active_directory", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermSentinelDataConnectorAzureActiveDirectoryTimeoutsBlock>("timeouts");
