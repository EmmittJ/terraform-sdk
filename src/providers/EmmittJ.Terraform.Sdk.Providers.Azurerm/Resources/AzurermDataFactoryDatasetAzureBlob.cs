...
/// <summary>
/// Block type for schema_column in AzurermDataFactoryDatasetAzureBlob.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermDataFactoryDatasetAzureBlob.
/// Nesting mode: single
/// </summary>
...
public partial class AzurermDataFactoryDatasetAzureBlob(string name) : TerraformResource("azurerm_data_factory_dataset_azure_blob", name)
{
    ...
    /// </summary>
    public TerraformList<AzurermDataFactoryDatasetAzureBlobSchemaColumnBlock>? SchemaColumn
    {
        get => GetArgument<TerraformList<AzurermDataFactoryDatasetAzureBlobSchemaColumnBlock>>("schema_column");
