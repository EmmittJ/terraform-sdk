...
/// </summary>
public partial class AzurermUserAssignedIdentity(string name) : TerraformResource("azurerm_user_assigned_identity", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermUserAssignedIdentityTimeoutsBlock>("timeouts");
