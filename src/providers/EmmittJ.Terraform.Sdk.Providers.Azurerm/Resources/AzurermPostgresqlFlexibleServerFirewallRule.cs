...
/// <summary>
/// Block type for timeouts in AzurermPostgresqlFlexibleServerFirewallRule.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_postgresql_flexible_server_firewall_rule Terraform resource.
/// Manages a azurerm_postgresql_flexible_server_firewall_rule resource.
/// </summary>
public partial class AzurermPostgresqlFlexibleServerFirewallRule(string name) : TerraformResource("azurerm_postgresql_flexible_server_firewall_rule", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AzurermPostgresqlFlexibleServerFirewallRuleTimeoutsBlock>("timeouts");
