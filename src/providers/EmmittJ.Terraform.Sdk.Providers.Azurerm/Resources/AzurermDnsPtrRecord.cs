...
/// <summary>
/// Block type for timeouts in AzurermDnsPtrRecord.
/// Nesting mode: single
/// </summary>
public class AzurermDnsPtrRecordTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a azurerm_dns_ptr_record Terraform resource.
/// Manages a azurerm_dns_ptr_record resource.
/// </summary>
public partial class AzurermDnsPtrRecord(string name) : TerraformResource("azurerm_dns_ptr_record", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermDnsPtrRecordTimeoutsBlock>("timeouts");
