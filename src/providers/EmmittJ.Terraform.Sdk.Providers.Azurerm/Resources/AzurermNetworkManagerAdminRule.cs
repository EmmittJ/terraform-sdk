...
/// <summary>
/// Block type for destination in AzurermNetworkManagerAdminRule.
/// Nesting mode: list
/// </summary>
public class AzurermNetworkManagerAdminRuleDestinationBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("address_prefix_type");
...
/// <summary>
/// Block type for source in AzurermNetworkManagerAdminRule.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermNetworkManagerAdminRule.
/// Nesting mode: single
/// </summary>
...
public partial class AzurermNetworkManagerAdminRule(string name) : TerraformResource("azurerm_network_manager_admin_rule", name)
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("admin_rule_collection_id");
