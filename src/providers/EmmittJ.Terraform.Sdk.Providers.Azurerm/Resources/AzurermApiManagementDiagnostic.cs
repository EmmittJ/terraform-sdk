...
public class AzurermApiManagementDiagnosticBackendRequestBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<double>>("body_bytes");
    ...
    {
        get => GetArgument<TerraformSet<string>>("headers_to_log");
...
/// </summary>
public partial class AzurermApiManagementDiagnostic(string name) : TerraformResource("azurerm_api_management_diagnostic", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<TerraformValue<string>>("operation_name_format");
    ...
    {
        get => GetArgument<AzurermApiManagementDiagnosticTimeoutsBlock>("timeouts");
