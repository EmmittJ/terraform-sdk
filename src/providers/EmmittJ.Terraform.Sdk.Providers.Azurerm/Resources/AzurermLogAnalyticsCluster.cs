...
/// <summary>
/// Block type for identity in AzurermLogAnalyticsCluster.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzurermLogAnalyticsCluster.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_log_analytics_cluster Terraform resource.
/// Manages a azurerm_log_analytics_cluster resource.
/// </summary>
public partial class AzurermLogAnalyticsCluster(string name) : TerraformResource("azurerm_log_analytics_cluster", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermLogAnalyticsClusterTimeoutsBlock>("timeouts");
