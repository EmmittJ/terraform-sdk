...
/// <summary>
/// Block type for timeouts in AzurermServicebusQueueAuthorizationRule.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azurerm_servicebus_queue_authorization_rule Terraform resource.
/// Manages a azurerm_servicebus_queue_authorization_rule resource.
/// </summary>
public partial class AzurermServicebusQueueAuthorizationRule(string name) : TerraformResource("azurerm_servicebus_queue_authorization_rule", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AzurermServicebusQueueAuthorizationRuleTimeoutsBlock>("timeouts");
