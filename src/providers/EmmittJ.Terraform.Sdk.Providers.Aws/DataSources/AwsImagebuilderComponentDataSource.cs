...
/// </summary>
public partial class AwsImagebuilderComponentDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> ChangeDescription { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Data { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> SupportedOsVersions { get; }
