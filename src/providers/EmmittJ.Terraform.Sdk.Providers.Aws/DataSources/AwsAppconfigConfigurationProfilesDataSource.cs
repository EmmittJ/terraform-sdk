...
public class AwsAppconfigConfigurationProfilesDataSource : TerraformDataSource
{
    ...
    public TerraformProperty<HashSet<TerraformProperty<string>>> ConfigurationProfileIds => new TerraformReferenceProperty<HashSet<TerraformProperty<string>>>(ResourceAddress, "configuration_profile_ids");
