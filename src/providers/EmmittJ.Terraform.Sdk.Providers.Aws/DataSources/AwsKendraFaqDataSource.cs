...
public class AwsKendraFaqDataSource : TerraformDataSource
{
    ...
    public required TerraformValue<string> FaqId { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> FileFormat => new TerraformReference(this, "file_format");
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> S3Path => new TerraformReference(this, "s3_path");
