...
/// Nesting mode: set
/// </summary>
public class AwsRoute53ResolverQueryLogConfigDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsRoute53ResolverQueryLogConfigDataSource : TerraformDataSource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? ResolverQueryLogConfigId { get; set; }
    ...
    public TerraformSet<TerraformBlock<AwsRoute53ResolverQueryLogConfigDataSourceFilterBlock>>? Filter { get; set; } = new();
