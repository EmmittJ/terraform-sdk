...
public partial class AwsDbProxyDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> Auth { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> DebugLogging { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DefaultAuthScheme { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EngineFamily { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> IdleClientTimeout { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> RequireTls { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> VpcSubnetIds { get; }
