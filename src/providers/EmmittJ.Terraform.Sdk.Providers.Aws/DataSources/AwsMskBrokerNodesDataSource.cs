...
public class AwsMskBrokerNodesDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformPropertyName("node_info_list")]
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> NodeInfoList => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "node_info_list");
