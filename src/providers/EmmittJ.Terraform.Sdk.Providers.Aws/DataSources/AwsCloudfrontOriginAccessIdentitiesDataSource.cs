...
public partial class AwsCloudfrontOriginAccessIdentitiesDataSource : TerraformDataSource
{
    ...
    public partial TerraformSet<string>? Comments { get; set; }
    ...
    public partial TerraformSet<string> IamArns { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> S3CanonicalUserIds { get; }
