...
/// <summary>
/// Represents a aws_networkfirewall_resource_policy Terraform data source.
/// Retrieves information about a aws_networkfirewall_resource_policy.
/// </summary>
public partial class AwsNetworkfirewallResourcePolicyDataSource(string name) : TerraformDataSource("aws_networkfirewall_resource_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
