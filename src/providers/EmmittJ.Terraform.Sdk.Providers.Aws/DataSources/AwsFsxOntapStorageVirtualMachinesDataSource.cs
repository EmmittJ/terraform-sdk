...
/// Nesting mode: set
/// </summary>
public class AwsFsxOntapStorageVirtualMachinesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsFsxOntapStorageVirtualMachinesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsFsxOntapStorageVirtualMachinesDataSourceFilterBlock>>? Filter { get; set; } = new();
