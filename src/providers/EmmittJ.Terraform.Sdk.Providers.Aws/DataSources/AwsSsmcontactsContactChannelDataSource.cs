...
public partial class AwsSsmcontactsContactChannelDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> ActivationStatus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ContactId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DeliveryAddress { get; }
