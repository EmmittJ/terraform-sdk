...
/// Nesting mode: set
/// </summary>
public class AwsEc2LocalGatewayDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2LocalGatewayDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2LocalGatewayDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2LocalGatewayDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2LocalGatewayDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
