...
public partial class AwsEksAddonDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> AddonVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ConfigurationValues { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> PodIdentityAssociation { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ServiceAccountRoleArn { get; }
