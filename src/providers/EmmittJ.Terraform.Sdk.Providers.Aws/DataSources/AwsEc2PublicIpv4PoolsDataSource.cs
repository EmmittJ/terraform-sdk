...
/// </summary>
public partial class AwsEc2PublicIpv4PoolsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2PublicIpv4PoolsDataSourceFilterBlock>>? Filter { get; set; }
    ...
    public TerraformList<string> PoolIds { get; }
