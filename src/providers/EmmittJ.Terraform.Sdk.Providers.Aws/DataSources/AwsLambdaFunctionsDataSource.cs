...
public partial class AwsLambdaFunctionsDataSource(string name) : TerraformDataSource("aws_lambda_functions", name)
{
    ...
    {
        get => TerraformList<string>.Lazy(ctx => new TerraformReference<TerraformList<string>>(this, "function_arns").ResolveNodes(ctx));
    }
    ...
    {
        get => TerraformList<string>.Lazy(ctx => new TerraformReference<TerraformList<string>>(this, "function_names").ResolveNodes(ctx));
    }
