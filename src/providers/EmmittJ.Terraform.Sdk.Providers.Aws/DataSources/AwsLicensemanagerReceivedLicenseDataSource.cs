...
public partial class AwsLicensemanagerReceivedLicenseDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> LicenseArn { get; set; }
    ...
    public partial TerraformValue<string> Beneficiary { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ConsumptionConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> Entitlements { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Issuer { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> LicenseMetadata { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LicenseName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ProductName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ProductSku { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ReceivedMetadata { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Validity { get; }
