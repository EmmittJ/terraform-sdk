...
public partial class AwsBackupReportPlanDataSource(string name) : TerraformDataSource("aws_backup_report_plan", name)
{
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "report_delivery_channel").ResolveNodes(ctx));
    }
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "report_setting").ResolveNodes(ctx));
    }
