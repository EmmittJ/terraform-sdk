...
public partial class AwsEmrcontainersVirtualClusterDataSource(string name) : TerraformDataSource("aws_emrcontainers_virtual_cluster", name)
{
    ...
    {
        get => new TerraformReference<string>(this, "virtual_cluster_id");
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "container_provider").ResolveNodes(ctx));
    }
