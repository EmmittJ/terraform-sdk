...
public class AwsMemorydbAclDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformPropertyName("user_names")]
    // Output-only attribute - read-only reference
    public TerraformProperty<HashSet<TerraformProperty<string>>> UserNames => new TerraformReferenceProperty<HashSet<TerraformProperty<string>>>(ResourceAddress, "user_names");
