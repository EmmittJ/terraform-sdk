...
public partial class AwsVpclatticeListenerDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> ListenerIdentifier { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ListenerId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ServiceArn { get; }
