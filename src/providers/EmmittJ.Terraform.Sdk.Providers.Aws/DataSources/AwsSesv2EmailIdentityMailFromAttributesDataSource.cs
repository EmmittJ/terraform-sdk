...
public class AwsSesv2EmailIdentityMailFromAttributesDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> BehaviorOnMxFailure => new TerraformReference(this, "behavior_on_mx_failure");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> MailFromDomain => new TerraformReference(this, "mail_from_domain");
