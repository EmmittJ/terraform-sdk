...
public partial class AwsElasticacheServerlessCacheDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<object> CacheUsageLimits { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DailySnapshotTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<object> Endpoint { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FullEngineVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<object> ReaderEndpoint { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> SubnetIds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> UserGroupId { get; }
