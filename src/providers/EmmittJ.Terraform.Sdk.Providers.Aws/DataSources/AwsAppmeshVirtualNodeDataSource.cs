...
/// <summary>
/// Retrieves information about a aws_appmesh_virtual_node.
/// </summary>
public class AwsAppmeshVirtualNodeDataSource : TerraformDataSource
{
    public AwsAppmeshVirtualNodeDataSource(string name) : base("aws_appmesh_virtual_node", name)
    {
    }
