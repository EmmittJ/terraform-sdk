...
/// <summary>
/// Represents a aws_appmesh_virtual_node Terraform data source.
/// Retrieves information about a aws_appmesh_virtual_node.
/// </summary>
public partial class AwsAppmeshVirtualNodeDataSource(string name) : TerraformDataSource("aws_appmesh_virtual_node", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
