...
/// <summary>
/// Represents a aws_appmesh_virtual_router Terraform data source.
/// Retrieves information about a aws_appmesh_virtual_router.
/// </summary>
public partial class AwsAppmeshVirtualRouterDataSource(string name) : TerraformDataSource("aws_appmesh_virtual_router", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
