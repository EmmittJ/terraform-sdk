...
public partial class AwsEc2CapacityBlockOfferingDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> EndDateRange { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> StartDateRange { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> CapacityBlockOfferingId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> UpfrontFee { get; }
