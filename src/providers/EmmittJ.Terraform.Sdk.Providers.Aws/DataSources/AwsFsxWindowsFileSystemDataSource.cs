...
public partial class AwsFsxWindowsFileSystemDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> ActiveDirectoryId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> AuditLogConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> BackupId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> CopyTagsToBackups { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> SkipFinalBackup { get; }
