...
/// Nesting mode: set
/// </summary>
public class AwsEc2ManagedPrefixListDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2ManagedPrefixListDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2ManagedPrefixListDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2ManagedPrefixListDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2ManagedPrefixListDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<HashSet<TerraformProperty<object>>> Entries => new TerraformReferenceProperty<HashSet<TerraformProperty<object>>>(ResourceAddress, "entries");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<double>> MaxEntries => new TerraformReferenceProperty<TerraformProperty<double>>(ResourceAddress, "max_entries");
