...
public partial class AwsEfsAccessPointDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> AccessPointId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PosixUser { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> RootDirectory { get; }
