...
public class AwsServiceDiscoveryServiceDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> HealthCheckConfig => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "health_check_config");
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> HealthCheckCustomConfig => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "health_check_custom_config");
