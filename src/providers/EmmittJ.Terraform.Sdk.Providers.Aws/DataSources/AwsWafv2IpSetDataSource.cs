...
public class AwsWafv2IpSetDataSource : TerraformDataSource
{
    ...
    public TerraformSet<string> Addresses => new TerraformReference(this, "addresses");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> IpAddressVersion => new TerraformReference(this, "ip_address_version");
