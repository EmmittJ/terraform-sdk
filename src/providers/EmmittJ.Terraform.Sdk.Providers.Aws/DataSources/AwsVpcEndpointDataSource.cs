...
/// Nesting mode: set
/// </summary>
public partial class AwsVpcEndpointDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcEndpointDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AwsVpcEndpointDataSource : TerraformDataSource
{
    ...
    public TerraformSet<AwsVpcEndpointDataSourceFilterBlock> Filter { get; set; } = new();
    ...
    public AwsVpcEndpointDataSourceTimeoutsBlock Timeouts { get; set; } = new();
