...
/// Nesting mode: set
/// </summary>
public class AwsSecurityGroupsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsSecurityGroupsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsSecurityGroupsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSecurityGroupsDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsSecurityGroupsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<string>>> VpcIds => new TerraformReferenceProperty<List<TerraformProperty<string>>>(ResourceAddress, "vpc_ids");
