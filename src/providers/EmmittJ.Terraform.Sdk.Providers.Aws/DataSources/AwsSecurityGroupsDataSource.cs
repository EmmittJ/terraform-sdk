...
public class AwsSecurityGroupsDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsSecurityGroupsDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsSecurityGroupsDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsSecurityGroupsDataSourceTimeoutsBlock>("timeouts");
