...
/// Nesting mode: set
/// </summary>
public class AwsSecurityGroupsDataSourceFilterBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsSecurityGroupsDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsSecurityGroupsDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformList<string> VpcIds => new TerraformReference(this, "vpc_ids");
