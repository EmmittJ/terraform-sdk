...
/// <summary>
/// Represents a aws_appmesh_route Terraform data source.
/// Retrieves information about a aws_appmesh_route.
/// </summary>
public partial class AwsAppmeshRouteDataSource(string name) : TerraformDataSource("aws_appmesh_route", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
