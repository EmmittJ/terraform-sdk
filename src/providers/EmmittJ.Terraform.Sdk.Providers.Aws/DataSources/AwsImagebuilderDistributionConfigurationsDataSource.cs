...
public class AwsImagebuilderDistributionConfigurationsDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsImagebuilderDistributionConfigurationsDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsImagebuilderDistributionConfigurationsDataSourceFilterBlock>>("filter");
