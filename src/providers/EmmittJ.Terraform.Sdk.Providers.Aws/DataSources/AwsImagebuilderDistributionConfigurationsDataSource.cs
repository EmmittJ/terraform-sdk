...
/// Nesting mode: set
/// </summary>
public class AwsImagebuilderDistributionConfigurationsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsImagebuilderDistributionConfigurationsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsImagebuilderDistributionConfigurationsDataSourceFilterBlock>>? Filter { get; set; } = new();
