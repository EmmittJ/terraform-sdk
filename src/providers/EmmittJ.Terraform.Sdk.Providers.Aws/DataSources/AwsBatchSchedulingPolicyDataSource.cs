...
public class AwsBatchSchedulingPolicyDataSource : TerraformDataSource
{
    ...
    public TerraformProperty<List<TerraformProperty<object>>> FairSharePolicy => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "fair_share_policy");
