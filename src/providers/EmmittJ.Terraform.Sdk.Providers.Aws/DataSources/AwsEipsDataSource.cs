...
public class AwsEipsDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEipsDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEipsDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEipsDataSourceTimeoutsBlock>("timeouts");
