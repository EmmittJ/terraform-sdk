...
public partial class AwsCeCostCategoryDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> DefaultValue { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> EffectiveEnd { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> EffectiveStart { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> RuleVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<object> SplitChargeRule { get; }
