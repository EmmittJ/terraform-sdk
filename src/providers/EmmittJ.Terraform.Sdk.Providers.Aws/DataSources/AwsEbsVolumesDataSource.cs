...
/// Nesting mode: set
/// </summary>
public class AwsEbsVolumesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEbsVolumesDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEbsVolumesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEbsVolumesDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEbsVolumesDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
