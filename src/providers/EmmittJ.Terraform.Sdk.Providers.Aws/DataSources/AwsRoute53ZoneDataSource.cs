...
public partial class AwsRoute53ZoneDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<bool>? PrivateZone { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LinkedServiceDescription { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LinkedServicePrincipal { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> ResourceRecordSetCount { get; }
