...
/// Nesting mode: set
/// </summary>
public partial class AwsEipDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsEipDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AwsEipDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> PublicIp { get; set; }
    ...
    public TerraformSet<AwsEipDataSourceFilterBlock> Filter { get; set; } = new();
    ...
    public AwsEipDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> IpamPoolId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> NetworkInterfaceOwnerId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PublicIpv4Pool { get; }
