...
/// Nesting mode: list
/// </summary>
public partial class AwsIdentitystoreUserDataSourceAlternateIdentifierBlock() : TerraformBlock("alternate_identifier")
{
}
...
public partial class AwsIdentitystoreUserDataSource : TerraformDataSource
{
    ...
    public TerraformList<AwsIdentitystoreUserDataSourceAlternateIdentifierBlock> AlternateIdentifier { get; set; } = new();
    ...
    public partial TerraformList<object> Addresses { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Emails { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Name { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Nickname { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PhoneNumbers { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ProfileUrl { get; }
