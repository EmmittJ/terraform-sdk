...
public partial class AwsEc2TransitGatewayMulticastDomainDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> TransitGatewayMulticastDomainId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AutoAcceptSharedAssociations { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Igmpv2Support { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Members { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> StaticSourcesSupport { get; }
