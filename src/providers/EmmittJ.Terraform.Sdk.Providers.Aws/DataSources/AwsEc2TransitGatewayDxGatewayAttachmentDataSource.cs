...
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceTimeoutsBlock>("timeouts");
