...
/// Nesting mode: set
/// </summary>
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
