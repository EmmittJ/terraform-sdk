...
/// Nesting mode: set
/// </summary>
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2TransitGatewayDxGatewayAttachmentDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceFilterBlock>>? Filter { get; set; }
    ...
    public TerraformBlock<AwsEc2TransitGatewayDxGatewayAttachmentDataSourceTimeoutsBlock>? Timeouts { get; set; }
