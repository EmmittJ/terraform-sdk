...
/// Nesting mode: set
/// </summary>
public class AwsLicensemanagerReceivedLicensesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsLicensemanagerReceivedLicensesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsLicensemanagerReceivedLicensesDataSourceFilterBlock>>? Filter { get; set; } = new();
