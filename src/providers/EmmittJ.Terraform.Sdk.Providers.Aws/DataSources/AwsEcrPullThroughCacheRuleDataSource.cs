...
public partial class AwsEcrPullThroughCacheRuleDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> CredentialArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> UpstreamRegistryUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> UpstreamRepositoryPrefix { get; }
