...
public class AwsLocationGeofenceCollectionDataSource : TerraformDataSource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> CollectionName { get; set; }
    ...
    public TerraformProperty<TerraformProperty<string>> CollectionArn => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "collection_arn");
