...
/// Nesting mode: set
/// </summary>
public class AwsLicensemanagerGrantsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsLicensemanagerGrantsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsLicensemanagerGrantsDataSourceFilterBlock>>? Filter { get; set; } = new();
