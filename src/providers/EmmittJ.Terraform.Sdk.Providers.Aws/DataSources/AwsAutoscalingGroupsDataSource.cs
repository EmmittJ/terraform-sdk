...
/// Nesting mode: set
/// </summary>
public partial class AwsAutoscalingGroupsDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public partial class AwsAutoscalingGroupsDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformList<string> Names { get; set; }
    ...
    public TerraformSet<AwsAutoscalingGroupsDataSourceFilterBlock> Filter { get; set; } = new();
