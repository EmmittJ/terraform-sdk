...
public partial class AwsIamRoleDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AssumeRolePolicy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> MaxSessionDuration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PermissionsBoundary { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> RoleLastUsed { get; }
