...
public partial class AwsQuicksightUserDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<bool> Active { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CustomPermissionsName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> UserRole { get; }
