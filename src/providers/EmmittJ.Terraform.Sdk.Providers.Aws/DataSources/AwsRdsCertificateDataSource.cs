...
public class AwsRdsCertificateDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> CertificateType => new TerraformReference(this, "certificate_type");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<bool> CustomerOverride => new TerraformReference(this, "customer_override");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> CustomerOverrideValidTill => new TerraformReference(this, "customer_override_valid_till");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ValidFrom => new TerraformReference(this, "valid_from");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ValidTill => new TerraformReference(this, "valid_till");
