...
public partial class AwsInternetGatewayDataSource(string name) : TerraformDataSource("aws_internet_gateway", name)
{
    ...
    {
        get => new TerraformReference<string>(this, "internet_gateway_id");
    ...
    {
        get => TerraformList<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformList<TerraformMap<object>>>(this, "attachments").ResolveNodes(ctx));
    }
