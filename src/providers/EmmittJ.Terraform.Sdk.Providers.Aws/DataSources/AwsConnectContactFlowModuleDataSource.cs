...
public class AwsConnectContactFlowModuleDataSource : TerraformDataSource
{
    ...
    public TerraformProperty<TerraformProperty<string>> ContactFlowModuleId { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "contact_flow_module_id");
