...
public class AwsElasticBeanstalkApplicationDataSource : TerraformDataSource
{
    ...
    public TerraformProperty<List<TerraformProperty<object>>> AppversionLifecycle => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "appversion_lifecycle");
