...
/// Nesting mode: set
/// </summary>
public partial class AwsVpcDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AwsVpcDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> Default { get; set; }
    ...
    public TerraformSet<AwsVpcDataSourceFilterBlock> Filter { get; set; } = new();
    ...
    public AwsVpcDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CidrBlockAssociations { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableDnsHostnames { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableDnsSupport { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableNetworkAddressUsageMetrics { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Ipv6CidrBlock { get; }
