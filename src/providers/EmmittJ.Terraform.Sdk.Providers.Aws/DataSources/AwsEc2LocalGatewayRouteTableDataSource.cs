...
/// Nesting mode: set
/// </summary>
public class AwsEc2LocalGatewayRouteTableDataSourceFilterBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2LocalGatewayRouteTableDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2LocalGatewayRouteTableDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> OutpostArn { get; set; } = default!;
