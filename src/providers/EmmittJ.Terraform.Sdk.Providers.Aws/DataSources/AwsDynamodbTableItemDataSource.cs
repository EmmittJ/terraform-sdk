...
public partial class AwsDynamodbTableItemDataSource : TerraformDataSource
{
    ...
    public partial TerraformMap<string>? ExpressionAttributeNames { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ProjectionExpression { get; set; }
    ...
    public partial TerraformValue<string> Item { get; }
