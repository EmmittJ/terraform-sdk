...
public class AwsCloudwatchLogGroupDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> LogGroupClass => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "log_group_class");
