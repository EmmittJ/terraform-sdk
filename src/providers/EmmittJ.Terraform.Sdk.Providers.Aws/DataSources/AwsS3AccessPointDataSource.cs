...
public partial class AwsS3AccessPointDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> BucketAccountId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DataSourceType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PublicAccessBlockConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> VpcConfiguration { get; }
