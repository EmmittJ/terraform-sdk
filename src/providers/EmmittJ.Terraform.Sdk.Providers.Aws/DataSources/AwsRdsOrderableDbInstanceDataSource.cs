...
public partial class AwsRdsOrderableDbInstanceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> AvailabilityZoneGroup { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> ReadReplicaCapable { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<string> SupportedEngineModes { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<string> SupportedNetworkTypes { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsClusters { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsEnhancedMonitoring { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsGlobalDatabases { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsIamDatabaseAuthentication { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsIops { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsKerberosAuthentication { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsMultiAz { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsPerformanceInsights { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsStorageAutoscaling { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SupportsStorageEncryption { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> OutpostCapable { get; }
