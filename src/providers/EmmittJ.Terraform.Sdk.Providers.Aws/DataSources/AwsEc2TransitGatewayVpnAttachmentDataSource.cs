...
/// Nesting mode: set
/// </summary>
public class AwsEc2TransitGatewayVpnAttachmentDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayVpnAttachmentDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2TransitGatewayVpnAttachmentDataSource : TerraformDataSource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? VpnConnectionId { get; set; }
    ...
    public TerraformSet<TerraformBlock<AwsEc2TransitGatewayVpnAttachmentDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2TransitGatewayVpnAttachmentDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
