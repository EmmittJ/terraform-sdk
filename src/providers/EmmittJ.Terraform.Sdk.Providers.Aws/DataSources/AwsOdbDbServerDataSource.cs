...
public partial class AwsOdbDbServerDataSource : TerraformDataSource
{
    ...
    public TerraformList<string> AutonomousVirtualMachineIds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> AutonomousVmClusterIds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> DbServerPatchingDetails { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ExadataInfrastructureId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> MaxDbNodeStorageInGbs { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> VmClusterIds { get; }
