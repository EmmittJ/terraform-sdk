...
/// <summary>
/// Represents a aws_s3_object Terraform data source.
/// Retrieves information about a aws_s3_object.
/// </summary>
public partial class AwsS3ObjectDataSource(string name) : TerraformDataSource("aws_s3_object", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformValue<string>? ChecksumMode
    {
        get => new TerraformReference<string>(this, "checksum_mode");
        set => SetArgument("checksum_mode", value);
    }
