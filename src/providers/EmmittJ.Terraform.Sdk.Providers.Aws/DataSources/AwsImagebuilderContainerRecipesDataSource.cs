...
/// Nesting mode: set
/// </summary>
public class AwsImagebuilderContainerRecipesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsImagebuilderContainerRecipesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsImagebuilderContainerRecipesDataSourceFilterBlock>>? Filter { get; set; } = new();
