...
public partial class AwsWorkspacesWorkspaceDataSource : TerraformDataSource
{
    ...
    public TerraformValue<string> BundleId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> RootVolumeEncryptionEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> UserVolumeEncryptionEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> VolumeEncryptionKey { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> WorkspaceProperties { get; }
