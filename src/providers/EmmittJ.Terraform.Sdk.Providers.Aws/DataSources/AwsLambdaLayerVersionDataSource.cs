...
public partial class AwsLambdaLayerVersionDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string>? CompatibleArchitecture { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CompatibleRuntime { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> CompatibleArchitectures { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> CompatibleRuntimes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LayerArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LicenseInfo { get; }
