...
/// Nesting mode: set
/// </summary>
public class AwsSecretsmanagerSecretsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsSecretsmanagerSecretsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSecretsmanagerSecretsDataSourceFilterBlock>>? Filter { get; set; } = new();
