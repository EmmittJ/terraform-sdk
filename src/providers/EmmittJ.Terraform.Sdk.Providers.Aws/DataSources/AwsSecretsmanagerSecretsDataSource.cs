...
/// </summary>
public partial class AwsSecretsmanagerSecretsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSecretsmanagerSecretsDataSourceFilterBlock>>? Filter { get; set; }
