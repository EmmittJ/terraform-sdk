...
/// </summary>
public partial class AwsAppintegrationsEventIntegrationDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> EventFilter { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EventbridgeBus { get; }
