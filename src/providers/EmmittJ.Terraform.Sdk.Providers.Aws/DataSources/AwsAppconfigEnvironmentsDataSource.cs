...
public class AwsAppconfigEnvironmentsDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformPropertyName("environment_ids")]
    // Output-only attribute - read-only reference
    public TerraformProperty<HashSet<TerraformProperty<string>>> EnvironmentIds => new TerraformReferenceProperty<HashSet<TerraformProperty<string>>>(ResourceAddress, "environment_ids");
