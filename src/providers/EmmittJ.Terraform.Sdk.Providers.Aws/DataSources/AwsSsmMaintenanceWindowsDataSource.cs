...
/// Nesting mode: set
/// </summary>
public class AwsSsmMaintenanceWindowsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsSsmMaintenanceWindowsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSsmMaintenanceWindowsDataSourceFilterBlock>>? Filter { get; set; } = new();
