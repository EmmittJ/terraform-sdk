...
/// Nesting mode: set
/// </summary>
public class AwsImagebuilderImageRecipesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsImagebuilderImageRecipesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsImagebuilderImageRecipesDataSourceFilterBlock>>? Filter { get; set; } = new();
