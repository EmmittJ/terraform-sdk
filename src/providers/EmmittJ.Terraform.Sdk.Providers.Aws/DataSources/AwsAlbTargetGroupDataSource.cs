...
/// Nesting mode: single
/// </summary>
public class AwsAlbTargetGroupDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsAlbTargetGroupDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AwsAlbTargetGroupDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
