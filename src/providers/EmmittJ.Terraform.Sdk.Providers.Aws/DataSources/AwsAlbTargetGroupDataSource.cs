...
/// <summary>
/// Block type for timeouts in AwsAlbTargetGroupDataSource.
/// Nesting mode: single
/// </summary>
public class AwsAlbTargetGroupDataSourceTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_alb_target_group Terraform data source.
/// Retrieves information about a aws_alb_target_group.
/// </summary>
public partial class AwsAlbTargetGroupDataSource(string name) : TerraformDataSource("aws_alb_target_group", name)
{
    /// <summary>
    /// The arn attribute.
    /// </summary>
    ...
    /// </summary>
    public AwsAlbTargetGroupDataSourceTimeoutsBlock? Timeouts
    {
        get => GetArgument<AwsAlbTargetGroupDataSourceTimeoutsBlock>("timeouts");
