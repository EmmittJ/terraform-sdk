...
public partial class AwsSesv2ConfigurationSetDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DeliveryOptions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ReputationOptions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SendingOptions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SuppressionOptions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> TrackingOptions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> VdmOptions { get; }
