...
public class AwsSesv2ConfigurationSetDataSource : TerraformDataSource
{
    ...
    {
        SetOutput("arn");
        SetOutput("delivery_options");
        SetOutput("reputation_options");
        SetOutput("sending_options");
        SetOutput("suppression_options");
        SetOutput("tracking_options");
        SetOutput("vdm_options");
