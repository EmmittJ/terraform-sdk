...
public partial class AwsEc2TransitGatewayAttachmentDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AssociationState { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AssociationTransitGatewayRouteTableId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ResourceOwnerId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TransitGatewayOwnerId { get; }
