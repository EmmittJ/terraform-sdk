...
public partial class AwsMqBrokerInstanceTypeOfferingsDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string>? EngineType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? HostInstanceType { get; set; }
    ...
    public partial TerraformList<object> BrokerInstanceOptions { get; }
