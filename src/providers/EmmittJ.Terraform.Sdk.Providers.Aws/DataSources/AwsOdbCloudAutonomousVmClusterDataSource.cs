...
public partial class AwsOdbCloudAutonomousVmClusterDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> AutonomousDataStoragePercentage { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> AutonomousDataStorageSizeInTbs { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> AvailableAutonomousDataStorageSizeInTbs { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> AvailableContainerDatabases { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> AvailableCpus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> CpuCoreCountPerNode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> CpuPercentage { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<string> DbServers { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ExadataStorageInTbsLowestScaledValue { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> IsMtlsEnabledVmCluster { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> MaxAcdsLowestScaledValue { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> NonProvisionableAutonomousContainerDatabases { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> OdbNodeStorageSizeInGbs { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ProvisionableAutonomousContainerDatabases { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ProvisionedAutonomousContainerDatabases { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ProvisionedCpus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ReclaimableCpus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ReservedCpus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ScanListenerPortNonTls { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> ScanListenerPortTls { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> TimeDatabaseSslCertificateExpires { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> TimeOrdsCertificateExpires { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> TotalContainerDatabases { get; }
