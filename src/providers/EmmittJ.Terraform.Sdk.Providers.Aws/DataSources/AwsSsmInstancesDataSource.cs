...
/// Nesting mode: set
/// </summary>
public class AwsSsmInstancesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsSsmInstancesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSsmInstancesDataSourceFilterBlock>>? Filter { get; set; } = new();
