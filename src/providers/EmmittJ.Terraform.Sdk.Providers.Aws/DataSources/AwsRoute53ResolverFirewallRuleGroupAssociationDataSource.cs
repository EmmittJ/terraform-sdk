...
public partial class AwsRoute53ResolverFirewallRuleGroupAssociationDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> FirewallRuleGroupAssociationId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FirewallRuleGroupId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MutationProtection { get; }
