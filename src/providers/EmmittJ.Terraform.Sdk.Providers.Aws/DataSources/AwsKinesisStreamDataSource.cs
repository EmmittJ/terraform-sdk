...
public partial class AwsKinesisStreamDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> ClosedShards { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> CreationTimestamp { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> OpenShards { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> RetentionPeriod { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> ShardLevelMetrics { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> StreamModeDetails { get; }
