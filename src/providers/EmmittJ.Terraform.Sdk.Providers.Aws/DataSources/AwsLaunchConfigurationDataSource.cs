...
public partial class AwsLaunchConfigurationDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableMonitoring { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> EphemeralBlockDevice { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PlacementTenancy { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> RootBlockDevice { get; }
