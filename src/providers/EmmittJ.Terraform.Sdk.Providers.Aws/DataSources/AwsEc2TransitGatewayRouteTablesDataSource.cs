...
/// Nesting mode: set
/// </summary>
public class AwsEc2TransitGatewayRouteTablesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayRouteTablesDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2TransitGatewayRouteTablesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2TransitGatewayRouteTablesDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2TransitGatewayRouteTablesDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
