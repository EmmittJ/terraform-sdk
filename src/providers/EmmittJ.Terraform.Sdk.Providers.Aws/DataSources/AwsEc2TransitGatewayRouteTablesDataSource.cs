...
public class AwsEc2TransitGatewayRouteTablesDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEc2TransitGatewayRouteTablesDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEc2TransitGatewayRouteTablesDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEc2TransitGatewayRouteTablesDataSourceTimeoutsBlock>("timeouts");
