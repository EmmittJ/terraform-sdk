...
/// Nesting mode: set
/// </summary>
public class AwsImagebuilderComponentsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsImagebuilderComponentsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsImagebuilderComponentsDataSourceFilterBlock>>? Filter { get; set; } = new();
