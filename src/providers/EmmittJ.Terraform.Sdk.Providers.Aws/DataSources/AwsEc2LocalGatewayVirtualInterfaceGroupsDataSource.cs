...
/// Nesting mode: set
/// </summary>
public class AwsEc2LocalGatewayVirtualInterfaceGroupsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2LocalGatewayVirtualInterfaceGroupsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2LocalGatewayVirtualInterfaceGroupsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2LocalGatewayVirtualInterfaceGroupsDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2LocalGatewayVirtualInterfaceGroupsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<string>>> LocalGatewayVirtualInterfaceIds => new TerraformReferenceProperty<List<TerraformProperty<string>>>(ResourceAddress, "local_gateway_virtual_interface_ids");
