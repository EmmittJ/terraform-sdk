...
/// Nesting mode: set
/// </summary>
public class AwsSecurityGroupDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsSecurityGroupDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsSecurityGroupDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsSecurityGroupDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsSecurityGroupDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
