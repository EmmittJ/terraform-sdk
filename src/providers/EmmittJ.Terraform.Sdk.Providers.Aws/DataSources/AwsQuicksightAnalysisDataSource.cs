...
public partial class AwsQuicksightAnalysisDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> AnalysisId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Definition { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LastPublishedTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ThemeArn { get; }
