...
public partial class AwsAccountPrimaryContactDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> AddressLine1 { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AddressLine2 { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AddressLine3 { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CountryCode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DistrictOrCounty { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FullName { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> StateOrRegion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> WebsiteUrl { get; }
