...
/// </summary>
public class AwsAppmeshGatewayRouteDataSource : TerraformDataSource
{
    public AwsAppmeshGatewayRouteDataSource(string name) : base("aws_appmesh_gateway_route", name)
    {
    }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> VirtualGatewayName { get; set; }
