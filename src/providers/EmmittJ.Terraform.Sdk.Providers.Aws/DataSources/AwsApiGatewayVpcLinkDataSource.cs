...
public class AwsApiGatewayVpcLinkDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<HashSet<TerraformProperty<string>>> TargetArns => new TerraformReferenceProperty<HashSet<TerraformProperty<string>>>(ResourceAddress, "target_arns");
