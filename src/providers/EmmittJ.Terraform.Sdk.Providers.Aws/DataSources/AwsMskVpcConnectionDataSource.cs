...
public partial class AwsMskVpcConnectionDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<string> Authentication { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> ClientSubnets { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TargetClusterArn { get; }
