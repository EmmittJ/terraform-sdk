...
public partial class AwsDirectoryServiceDirectoryDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ConnectSettings { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableSso { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> RadiusSettings { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> Size { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> VpcSettings { get; }
