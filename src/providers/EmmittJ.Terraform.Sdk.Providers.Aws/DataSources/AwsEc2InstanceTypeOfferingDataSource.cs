...
/// Nesting mode: set
/// </summary>
public class AwsEc2InstanceTypeOfferingDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2InstanceTypeOfferingDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2InstanceTypeOfferingDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2InstanceTypeOfferingDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2InstanceTypeOfferingDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
