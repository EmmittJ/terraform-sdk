...
/// Nesting mode: set
/// </summary>
public partial class AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2TransitGatewayRouteTablePropagationsDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AwsEc2TransitGatewayRouteTablePropagationsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock> Filter { get; set; } = new();
    ...
    public AwsEc2TransitGatewayRouteTablePropagationsDataSourceTimeoutsBlock Timeouts { get; set; } = new();
