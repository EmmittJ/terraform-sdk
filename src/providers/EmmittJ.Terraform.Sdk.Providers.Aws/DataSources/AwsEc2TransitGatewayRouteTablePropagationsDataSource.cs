...
/// Nesting mode: set
/// </summary>
public class AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayRouteTablePropagationsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2TransitGatewayRouteTablePropagationsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2TransitGatewayRouteTablePropagationsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
