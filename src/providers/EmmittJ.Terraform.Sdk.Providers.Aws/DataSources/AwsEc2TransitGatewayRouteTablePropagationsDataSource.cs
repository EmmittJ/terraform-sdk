...
public class AwsEc2TransitGatewayRouteTablePropagationsDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEc2TransitGatewayRouteTablePropagationsDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEc2TransitGatewayRouteTablePropagationsDataSourceTimeoutsBlock>("timeouts");
