...
public partial class AwsOutpostsAssetsDataSource : TerraformDataSource
{
    ...
    public partial TerraformSet<string>? HostIdFilter { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? StatusIdFilter { get; set; }
    ...
    public partial TerraformList<string> AssetIds { get; }
