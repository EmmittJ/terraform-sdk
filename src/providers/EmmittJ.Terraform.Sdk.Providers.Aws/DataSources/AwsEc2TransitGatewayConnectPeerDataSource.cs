...
public class AwsEc2TransitGatewayConnectPeerDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("region");
        SetOutput("tags");
        SetOutput("transit_gateway_connect_peer_id");
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("transit_gateway_connect_peer_id");
        set => SetProperty("transit_gateway_connect_peer_id", value);
    }
