...
public class AwsEc2TransitGatewayConnectDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("region");
        SetOutput("tags");
        SetOutput("transit_gateway_connect_id");
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("transit_gateway_connect_id");
        set => SetProperty("transit_gateway_connect_id", value);
    }
