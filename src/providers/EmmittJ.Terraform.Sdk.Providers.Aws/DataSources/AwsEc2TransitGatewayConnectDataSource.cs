...
public class AwsEc2TransitGatewayConnectDataSource : TerraformDataSource
{
    ...
    /// </summary>
    public TerraformProperty<string>? TransitGatewayConnectId
    {
        get => GetProperty<TerraformProperty<string>>("transit_gateway_connect_id");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsEc2TransitGatewayConnectDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsEc2TransitGatewayConnectDataSourceFilterBlock>>("filter");
    ...
    {
        get => GetProperty<AwsEc2TransitGatewayConnectDataSourceTimeoutsBlock>("timeouts");
