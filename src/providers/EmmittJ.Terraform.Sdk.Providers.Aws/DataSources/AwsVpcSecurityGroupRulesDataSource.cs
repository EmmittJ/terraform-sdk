...
/// Nesting mode: set
/// </summary>
public class AwsVpcSecurityGroupRulesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsVpcSecurityGroupRulesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsVpcSecurityGroupRulesDataSourceFilterBlock>>? Filter { get; set; } = new();
