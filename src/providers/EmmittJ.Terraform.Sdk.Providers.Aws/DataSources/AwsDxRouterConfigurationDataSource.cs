...
public partial class AwsDxRouterConfigurationDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> RouterTypeIdentifier { get; set; }
    ...
    public partial TerraformValue<string> CustomerRouterConfig { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Router { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> VirtualInterfaceName { get; }
