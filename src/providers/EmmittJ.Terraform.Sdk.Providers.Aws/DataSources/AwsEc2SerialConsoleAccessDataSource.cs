...
/// Nesting mode: single
/// </summary>
public class AwsEc2SerialConsoleAccessDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2SerialConsoleAccessDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AwsEc2SerialConsoleAccessDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
