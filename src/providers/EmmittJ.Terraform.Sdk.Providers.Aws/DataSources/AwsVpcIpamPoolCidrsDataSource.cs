...
/// </summary>
public partial class AwsVpcIpamPoolCidrsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsVpcIpamPoolCidrsDataSourceFilterBlock>>? Filter { get; set; }
    ...
    public TerraformBlock<AwsVpcIpamPoolCidrsDataSourceTimeoutsBlock>? Timeouts { get; set; }

    /// <summary>
    /// The ipam_pool_cidrs attribute.
    /// </summary>
    [TerraformProperty("ipam_pool_cidrs")]
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<object> IpamPoolCidrs { get; }
