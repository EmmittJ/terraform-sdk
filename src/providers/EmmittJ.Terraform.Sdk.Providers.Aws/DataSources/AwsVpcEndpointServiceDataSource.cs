...
public partial class AwsVpcEndpointServiceDataSource : TerraformDataSource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? ServiceRegions { get; set; }
    ...
    public partial TerraformValue<bool> AcceptanceRequired { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> PrivateDnsNames { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ServiceRegion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> SupportedIpAddressTypes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> VpcEndpointPolicySupported { get; }
