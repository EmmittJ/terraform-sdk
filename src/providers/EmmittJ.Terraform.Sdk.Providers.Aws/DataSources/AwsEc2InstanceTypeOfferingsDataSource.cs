...
/// Nesting mode: set
/// </summary>
public class AwsEc2InstanceTypeOfferingsDataSourceFilterBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2InstanceTypeOfferingsDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2InstanceTypeOfferingsDataSource : TerraformDataSource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformValue<string>? LocationType { get; set; }
    ...
    public TerraformSet<TerraformBlock<AwsEc2InstanceTypeOfferingsDataSourceFilterBlock>>? Filter { get; set; }
    ...
    public TerraformBlock<AwsEc2InstanceTypeOfferingsDataSourceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformList<string> LocationTypes => new TerraformReference(this, "location_types");
