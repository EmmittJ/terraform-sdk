...
public partial class AwsConnectInstanceDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AutoResolveBestVoicesEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ContactFlowLogsEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ContactLensEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EarlyMediaEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> IdentityManagementType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> InboundCallsEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> MultiPartyConferenceEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> OutboundCallsEnabled { get; }
