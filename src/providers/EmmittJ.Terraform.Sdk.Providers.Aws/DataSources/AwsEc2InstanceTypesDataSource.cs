...
/// Nesting mode: set
/// </summary>
public class AwsEc2InstanceTypesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2InstanceTypesDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2InstanceTypesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2InstanceTypesDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2InstanceTypesDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
