...
public partial class AwsRdsClustersDataSource(string name) : TerraformDataSource("aws_rds_clusters", name)
{
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "cluster_arns").ResolveNodes(ctx));
    }
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "cluster_identifiers").ResolveNodes(ctx));
    }
