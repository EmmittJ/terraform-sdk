...
public class AwsGlueDataCatalogEncryptionSettingsDataSource : TerraformDataSource
{
    ...
    public TerraformProperty<List<TerraformProperty<object>>> DataCatalogEncryptionSettings => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "data_catalog_encryption_settings");
