...
/// Nesting mode: set
/// </summary>
public class AwsEc2LocalGatewayRouteTablesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2LocalGatewayRouteTablesDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2LocalGatewayRouteTablesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2LocalGatewayRouteTablesDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2LocalGatewayRouteTablesDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
