...
/// Nesting mode: set
/// </summary>
public class AwsEc2LocalGatewayRouteTablesDataSourceFilterBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2LocalGatewayRouteTablesDataSourceTimeoutsBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2LocalGatewayRouteTablesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2LocalGatewayRouteTablesDataSourceFilterBlock>>? Filter { get; set; }
    ...
    public TerraformBlock<AwsEc2LocalGatewayRouteTablesDataSourceTimeoutsBlock>? Timeouts { get; set; }
