...
/// Nesting mode: set
/// </summary>
public class AwsVpcsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsVpcsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsVpcsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsVpcsDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsVpcsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
