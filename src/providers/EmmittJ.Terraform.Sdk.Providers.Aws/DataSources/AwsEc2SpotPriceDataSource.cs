...
/// Nesting mode: set
/// </summary>
public class AwsEc2SpotPriceDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEc2SpotPriceDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsEc2SpotPriceDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsEc2SpotPriceDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsEc2SpotPriceDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> SpotPriceTimestamp => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "spot_price_timestamp");
