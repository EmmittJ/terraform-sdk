...
public partial class AwsLakeformationResourceDataSource : TerraformDataSource
{
    ...
    public partial TerraformValue<bool> HybridAccessEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> WithFederation { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> WithPrivilegedAccess { get; }
