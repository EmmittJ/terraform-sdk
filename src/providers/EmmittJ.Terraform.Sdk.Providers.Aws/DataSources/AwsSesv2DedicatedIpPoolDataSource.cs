...
/// </summary>
public partial class AwsSesv2DedicatedIpPoolDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformProperty("dedicated_ips")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DedicatedIps { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ScalingMode { get; }
