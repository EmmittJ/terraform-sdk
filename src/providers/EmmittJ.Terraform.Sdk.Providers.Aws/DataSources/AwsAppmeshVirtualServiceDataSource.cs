...
/// <summary>
/// Represents a aws_appmesh_virtual_service Terraform data source.
/// Retrieves information about a aws_appmesh_virtual_service.
/// </summary>
public partial class AwsAppmeshVirtualServiceDataSource(string name) : TerraformDataSource("aws_appmesh_virtual_service", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
