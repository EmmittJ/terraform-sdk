...
public class AwsConnectQuickConnectDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> QuickConnectId { get; set; } = default!;
    ...
    // Output-only attribute - read-only reference
    public TerraformList<object> QuickConnectConfig => new TerraformReference(this, "quick_connect_config");
