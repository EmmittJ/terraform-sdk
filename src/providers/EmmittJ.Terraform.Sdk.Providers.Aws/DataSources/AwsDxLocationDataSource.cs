...
public partial class AwsDxLocationDataSource : TerraformDataSource
{
    ...
    public required partial TerraformValue<string> LocationCode { get; set; }
    ...
    public partial TerraformList<string> AvailableMacsecPortSpeeds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> AvailablePortSpeeds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> AvailableProviders { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LocationName { get; }
