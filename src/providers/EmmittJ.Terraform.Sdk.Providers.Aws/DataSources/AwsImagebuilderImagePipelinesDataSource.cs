...
public class AwsImagebuilderImagePipelinesDataSource : TerraformDataSource
{
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AwsImagebuilderImagePipelinesDataSourceFilterBlock>? Filter
    {
        get => GetProperty<HashSet<AwsImagebuilderImagePipelinesDataSourceFilterBlock>>("filter");
