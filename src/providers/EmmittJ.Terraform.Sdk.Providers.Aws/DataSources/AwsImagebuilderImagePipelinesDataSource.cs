...
/// Nesting mode: set
/// </summary>
public class AwsImagebuilderImagePipelinesDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsImagebuilderImagePipelinesDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsImagebuilderImagePipelinesDataSourceFilterBlock>>? Filter { get; set; } = new();
