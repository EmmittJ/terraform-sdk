...
/// Nesting mode: set
/// </summary>
public partial class AwsEc2HostDataSourceFilterBlock() : TerraformBlock("filter")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2HostDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AwsEc2HostDataSource : TerraformDataSource
{
    ...
    public TerraformSet<AwsEc2HostDataSourceFilterBlock> Filter { get; set; } = new();
    ...
    public AwsEc2HostDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AssetId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AutoPlacement { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> Cores { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> HostRecovery { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> InstanceFamily { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> Sockets { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> TotalVcpus { get; }
