...
/// Nesting mode: set
/// </summary>
public class AwsVpcPeeringConnectionsDataSourceFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsVpcPeeringConnectionsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsVpcPeeringConnectionsDataSource : TerraformDataSource
{
    ...
    public TerraformSet<TerraformBlock<AwsVpcPeeringConnectionsDataSourceFilterBlock>>? Filter { get; set; } = new();
    ...
    public TerraformBlock<AwsVpcPeeringConnectionsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();
