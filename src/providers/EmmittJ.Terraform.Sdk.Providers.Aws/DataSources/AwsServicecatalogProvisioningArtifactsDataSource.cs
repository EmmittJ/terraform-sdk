...
/// Nesting mode: single
/// </summary>
public class AwsServicecatalogProvisioningArtifactsDataSourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsServicecatalogProvisioningArtifactsDataSource : TerraformDataSource
{
    ...
    public TerraformBlock<AwsServicecatalogProvisioningArtifactsDataSourceTimeoutsBlock>? Timeouts { get; set; } = new();

    /// <summary>
    /// The provisioning_artifact_details attribute.
    /// </summary>
    [TerraformPropertyName("provisioning_artifact_details")]
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> ProvisioningArtifactDetails => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "provisioning_artifact_details");
