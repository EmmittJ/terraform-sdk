...
public class AwsOrganizationsOrganizationalUnitDescendantOrganizationalUnitsDataSource : TerraformDataSource
{
    ...
    /// </summary>
    [TerraformPropertyName("children")]
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> Children => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "children");
