...
public partial class AwsKmsKeyDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CustomKeyStoreId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CustomerMasterKeySpec { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DeletionDate { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyManager { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeySpec { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> KeyUsage { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> MultiRegion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> MultiRegionConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> PendingDeletionWindowInDays { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ValidTo { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> XksKeyConfiguration { get; }
