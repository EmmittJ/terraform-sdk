...
public partial class AwsLexBotDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ChildDirected { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> DetectSentiment { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> EnableModelImprovements { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> IdleSessionTtlInSeconds { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> NluIntentConfidenceThreshold { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> VoiceId { get; }
