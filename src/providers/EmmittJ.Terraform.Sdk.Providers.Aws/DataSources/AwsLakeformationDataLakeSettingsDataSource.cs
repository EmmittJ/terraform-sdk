...
public partial class AwsLakeformationDataLakeSettingsDataSource : TerraformDataSource
{
    ...
    public partial TerraformSet<string> Admins { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AllowExternalDataFiltering { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AllowFullTableExternalDataAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> AuthorizedSessionTagValueList { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CreateDatabaseDefaultPermissions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> CreateTableDefaultPermissions { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> ExternalDataFilteringAllowList { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> ReadOnlyAdmins { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> TrustedResourceOwners { get; }
