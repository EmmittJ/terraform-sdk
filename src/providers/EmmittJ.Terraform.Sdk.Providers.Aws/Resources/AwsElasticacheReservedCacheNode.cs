...
/// Nesting mode: single
/// </summary>
public partial class AwsElasticacheReservedCacheNodeTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsElasticacheReservedCacheNode : TerraformResource
{
    ...
    public AwsElasticacheReservedCacheNodeTimeoutsBlock Timeouts { get; set; } = new();
