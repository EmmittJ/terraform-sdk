...
public class AwsIotEventConfigurations : TerraformResource
{
    ...
    {
        SetOutput("event_configurations");
        SetOutput("id");
        SetOutput("region");
    }
    ...
    {
        get => GetRequiredOutput<Dictionary<string, TerraformProperty<bool>>>("event_configurations");
        set => SetProperty("event_configurations", value);
    }
