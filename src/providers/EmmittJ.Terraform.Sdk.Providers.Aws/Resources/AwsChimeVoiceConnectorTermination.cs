...
public partial class AwsChimeVoiceConnectorTermination : TerraformResource
{
    ...
    public required partial TerraformSet<string> CallingRegions { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformSet<string> CidrAllowList { get; set; }
    ...
    public partial TerraformValue<double>? CpsLimit { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DefaultPhoneNumber { get; set; }
