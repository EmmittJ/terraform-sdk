...
public partial class AwsBedrockagentcoreAgentRuntimeEndpoint : TerraformResource
{
    ...
    public required TerraformValue<string> AgentRuntimeId { get; set; }
    ...
    public TerraformValue<string> AgentRuntimeVersion { get; set; }
    ...
    public TerraformBlock<AwsBedrockagentcoreAgentRuntimeEndpointTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> AgentRuntimeEndpointArn { get; }
