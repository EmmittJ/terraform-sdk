...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentcoreAgentRuntimeEndpointTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsBedrockagentcoreAgentRuntimeEndpoint : TerraformResource
{
    ...
    public required partial TerraformValue<string> AgentRuntimeId { get; set; }
    ...
    public partial TerraformValue<string> AgentRuntimeVersion { get; set; }
    ...
    public partial TerraformBlock<AwsBedrockagentcoreAgentRuntimeEndpointTimeoutsBlock>? Timeouts { get; set; }
    ...
    /// </summary>
    [TerraformProperty("agent_runtime_endpoint_arn")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AgentRuntimeEndpointArn { get; }
