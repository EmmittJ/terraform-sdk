...
/// Nesting mode: single
/// </summary>
public partial class AwsRdsShardGroupTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsRdsShardGroup : TerraformResource
{
    ...
    public partial TerraformValue<double> ComputeRedundancy { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DbShardGroupIdentifier { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaxAcu { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> MinAcu { get; set; }
    ...
    public AwsRdsShardGroupTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DbShardGroupResourceId { get; }
