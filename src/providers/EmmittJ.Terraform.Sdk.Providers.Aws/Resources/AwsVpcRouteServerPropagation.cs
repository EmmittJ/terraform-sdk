...
/// <summary>
/// Block type for timeouts in AwsVpcRouteServerPropagation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_vpc_route_server_propagation Terraform resource.
/// Manages a aws_vpc_route_server_propagation resource.
/// </summary>
public partial class AwsVpcRouteServerPropagation(string name) : TerraformResource("aws_vpc_route_server_propagation", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsVpcRouteServerPropagationTimeoutsBlock>("timeouts");
