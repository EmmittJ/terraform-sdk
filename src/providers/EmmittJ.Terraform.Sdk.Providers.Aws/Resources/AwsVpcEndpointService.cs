...
public partial class AwsVpcEndpointService : TerraformResource
{
    ...
    public TerraformSet<string> AllowedPrincipals { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> PrivateDnsName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformSet<string> SupportedIpAddressTypes { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformSet<string> SupportedRegions { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> PrivateDnsNameConfiguration { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ServiceType { get; }
