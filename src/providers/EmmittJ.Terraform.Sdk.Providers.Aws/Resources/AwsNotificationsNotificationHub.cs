...
/// Nesting mode: single
/// </summary>
public partial class AwsNotificationsNotificationHubTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsNotificationsNotificationHub : TerraformResource
{
    ...
    public required partial TerraformValue<string> NotificationHubRegion { get; set; }
    ...
    public AwsNotificationsNotificationHubTimeoutsBlock Timeouts { get; set; } = new();
