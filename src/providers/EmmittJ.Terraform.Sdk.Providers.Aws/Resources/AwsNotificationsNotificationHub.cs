...
/// Nesting mode: single
/// </summary>
public class AwsNotificationsNotificationHubTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsNotificationsNotificationHub : TerraformResource
{
    ...
    [TerraformPropertyName("notification_hub_region")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> NotificationHubRegion { get; set; }
    ...
    public TerraformBlock<AwsNotificationsNotificationHubTimeoutsBlock>? Timeouts { get; set; } = new();
