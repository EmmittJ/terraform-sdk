...
/// Nesting mode: single
/// </summary>
public class AwsMainRouteTableAssociationTimeoutsBlock
{
    /// <summary>
...
public class AwsMainRouteTableAssociation : TerraformResource
{
    ...
    public TerraformValue<string> OriginalRouteTableId => new TerraformReference(this, "original_route_table_id");
