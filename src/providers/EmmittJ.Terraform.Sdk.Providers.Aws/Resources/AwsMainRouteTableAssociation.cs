...
/// Nesting mode: single
/// </summary>
public partial class AwsMainRouteTableAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsMainRouteTableAssociation : TerraformResource
{
    ...
    public AwsMainRouteTableAssociationTimeoutsBlock Timeouts { get; set; } = new();

    /// <summary>
    /// The original_route_table_id attribute.
    /// </summary>
    [TerraformProperty("original_route_table_id")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> OriginalRouteTableId { get; }
