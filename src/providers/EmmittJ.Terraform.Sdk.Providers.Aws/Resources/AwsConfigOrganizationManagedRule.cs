...
/// Nesting mode: single
/// </summary>
public partial class AwsConfigOrganizationManagedRuleTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsConfigOrganizationManagedRule : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RuleIdentifier { get; set; }
    ...
    public AwsConfigOrganizationManagedRuleTimeoutsBlock Timeouts { get; set; } = new();
