...
/// Nesting mode: list
/// </summary>
public class AwsAlbListenerDefaultActionBlock : ITerraformBlock
{
    /// <summary>
    /// The order attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AwsAlbListenerMutualAuthenticationBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsAlbListenerTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsAlbListener : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsAlbListenerDefaultActionBlock>>? DefaultAction { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AwsAlbListenerMutualAuthenticationBlock>>? MutualAuthentication { get; set; } = new();
    ...
    public TerraformBlock<AwsAlbListenerTimeoutsBlock>? Timeouts { get; set; } = new();
