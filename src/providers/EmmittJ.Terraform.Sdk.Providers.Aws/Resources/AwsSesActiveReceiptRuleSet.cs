...
/// <summary>
/// Represents a aws_ses_active_receipt_rule_set Terraform resource.
/// Manages a aws_ses_active_receipt_rule_set resource.
/// </summary>
public partial class AwsSesActiveReceiptRuleSet(string name) : TerraformResource("aws_ses_active_receipt_rule_set", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
