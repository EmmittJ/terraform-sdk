...
/// Nesting mode: single
/// </summary>
public class AwsServicecatalogBudgetResourceAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsServicecatalogBudgetResourceAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsServicecatalogBudgetResourceAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
