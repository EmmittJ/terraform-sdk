...
public partial class AwsDxGatewayAssociationProposal : TerraformResource
{
    ...
    public required partial TerraformValue<string> AssociatedGatewayId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DxGatewayOwnerAccountId { get; set; }
    ...
    public partial TerraformValue<string> AssociatedGatewayOwnerAccountId { get; }
