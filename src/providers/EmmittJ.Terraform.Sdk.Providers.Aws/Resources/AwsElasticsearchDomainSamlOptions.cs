...
/// Nesting mode: list
/// </summary>
public class AwsElasticsearchDomainSamlOptionsSamlOptionsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsElasticsearchDomainSamlOptionsTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsElasticsearchDomainSamlOptions : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsElasticsearchDomainSamlOptionsSamlOptionsBlock>>? SamlOptions { get; set; } = new();
    ...
    public TerraformBlock<AwsElasticsearchDomainSamlOptionsTimeoutsBlock>? Timeouts { get; set; } = new();
