...
/// Nesting mode: single
/// </summary>
public class AwsCloudfrontKeyValueStoreTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsCloudfrontKeyValueStore : TerraformResource
{
    ...
    public TerraformBlock<AwsCloudfrontKeyValueStoreTimeoutsBlock>? Timeouts { get; set; } = new();
