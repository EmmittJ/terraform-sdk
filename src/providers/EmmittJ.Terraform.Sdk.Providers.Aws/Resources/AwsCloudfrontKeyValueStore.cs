...
/// Nesting mode: single
/// </summary>
public partial class AwsCloudfrontKeyValueStoreTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsCloudfrontKeyValueStore : TerraformResource
{
    ...
    public AwsCloudfrontKeyValueStoreTimeoutsBlock Timeouts { get; set; } = new();
