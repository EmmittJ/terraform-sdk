...
/// Nesting mode: single
/// </summary>
public partial class AwsDynamodbTableReplicaTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsDynamodbTableReplica : TerraformResource
{
    ...
    public required partial TerraformValue<string> GlobalTableArn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TableClassOverride { get; set; }
    ...
    public AwsDynamodbTableReplicaTimeoutsBlock Timeouts { get; set; } = new();
