...
/// Nesting mode: single
/// </summary>
public class AwsVpcEndpointSubnetAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVpcEndpointSubnetAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsVpcEndpointSubnetAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
