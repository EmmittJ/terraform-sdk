...
/// <summary>
/// Represents a aws_alb_listener_certificate Terraform resource.
/// Manages a aws_alb_listener_certificate resource.
/// </summary>
public partial class AwsAlbListenerCertificate(string name) : TerraformResource("aws_alb_listener_certificate", name)
{
    /// <summary>
