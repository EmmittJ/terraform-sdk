...
/// Nesting mode: single
/// </summary>
public class AwsCodecatalystSourceRepositoryTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsCodecatalystSourceRepository : TerraformResource
{
    ...
    public TerraformBlock<AwsCodecatalystSourceRepositoryTimeoutsBlock>? Timeouts { get; set; } = new();
