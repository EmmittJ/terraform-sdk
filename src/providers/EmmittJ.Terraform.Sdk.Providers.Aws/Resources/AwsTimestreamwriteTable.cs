...
public partial class AwsTimestreamwriteTableMagneticStoreWritePropertiesBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<bool>? EnableMagneticStoreWrites { get; set; }
...
public partial class AwsTimestreamwriteTableRetentionPropertiesBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<double> MagneticStoreRetentionPeriodInDays { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MemoryStoreRetentionPeriodInHours { get; set; }
