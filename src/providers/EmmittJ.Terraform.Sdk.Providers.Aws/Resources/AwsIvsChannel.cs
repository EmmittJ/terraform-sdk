...
/// Nesting mode: single
/// </summary>
public partial class AwsIvsChannelTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsIvsChannel : TerraformResource
{
    ...
    public partial TerraformValue<bool> Authorized { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> LatencyMode { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> RecordingConfigurationArn { get; set; }
    ...
    public AwsIvsChannelTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> IngestEndpoint { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PlaybackUrl { get; }
