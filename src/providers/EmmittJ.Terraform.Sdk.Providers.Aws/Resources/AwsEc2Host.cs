...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2HostTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsEc2Host : TerraformResource
{
    ...
    public partial TerraformValue<string> AssetId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? AutoPlacement { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? HostRecovery { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? InstanceFamily { get; set; }
    ...
    public AwsEc2HostTimeoutsBlock Timeouts { get; set; } = new();
