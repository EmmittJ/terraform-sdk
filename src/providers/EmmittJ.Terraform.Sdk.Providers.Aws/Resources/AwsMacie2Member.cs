...
/// Nesting mode: single
/// </summary>
public partial class AwsMacie2MemberTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsMacie2Member : TerraformResource
{
    ...
    public TerraformValue<string> AdministratorAccountId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> InvitedAt { get; }
