...
public partial class AwsEfsFileSystemProtectionBlock : TerraformBlockBase
{
    ...
    public TerraformValue<string> ReplicationOverwrite { get; set; }
...
public partial class AwsEfsFileSystem : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> PerformanceMode { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> NumberOfMountTargets { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> SizeInBytes { get; }
