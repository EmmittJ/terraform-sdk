...
/// Nesting mode: single
/// </summary>
public partial class AwsTranscribeMedicalVocabularyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsTranscribeMedicalVocabulary : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VocabularyFileUri { get; set; }
    ...
    public partial TerraformBlock<AwsTranscribeMedicalVocabularyTimeoutsBlock>? Timeouts { get; set; }
