...
/// Nesting mode: single
/// </summary>
public class AwsTranscribeMedicalVocabularyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsTranscribeMedicalVocabulary : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> VocabularyFileUri { get; set; }
    ...
    public TerraformBlock<AwsTranscribeMedicalVocabularyTimeoutsBlock>? Timeouts { get; set; } = new();
