...
/// <summary>
/// Block type for timeouts in AwsTranscribeMedicalVocabulary.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_transcribe_medical_vocabulary Terraform resource.
/// Manages a aws_transcribe_medical_vocabulary resource.
/// </summary>
public partial class AwsTranscribeMedicalVocabulary(string name) : TerraformResource("aws_transcribe_medical_vocabulary", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public required TerraformValue<string> VocabularyFileUri
    {
        get => GetRequiredArgument<TerraformValue<string>>("vocabulary_file_uri");
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("vocabulary_name");
    ...
    {
        get => GetArgument<AwsTranscribeMedicalVocabularyTimeoutsBlock>("timeouts");
