...
public partial class AwsGlueSecurityConfiguration : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsGlueSecurityConfigurationEncryptionConfigurationBlock>>? EncryptionConfiguration { get; set; }
