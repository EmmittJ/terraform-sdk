...
/// Nesting mode: single
/// </summary>
public class AwsEc2ClientVpnNetworkAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsEc2ClientVpnNetworkAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsEc2ClientVpnNetworkAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
