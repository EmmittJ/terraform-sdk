...
public partial class AwsPinpointsmsvoicev2PhoneNumber : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> OptOutListName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> SelfManagedOptOutsEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> TwoWayChannelEnabled { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> MonthlyLeasingPrice { get; }
