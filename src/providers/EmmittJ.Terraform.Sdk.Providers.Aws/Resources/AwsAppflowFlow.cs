...
public partial class AwsAppflowFlowDestinationFlowConfigBlock() : TerraformBlock("destination_flow_config")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ConnectorProfileName { get; set; }
...
public partial class AwsAppflowFlowTaskBlock() : TerraformBlock("task")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DestinationField { get; set; }
    ...
    public partial TerraformList<string> SourceFields { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformMap<string>? TaskProperties { get; set; }
...
public partial class AwsAppflowFlowTriggerConfigBlock() : TerraformBlock("trigger_config")
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TriggerType { get; set; }
...
public partial class AwsAppflowFlow : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FlowStatus { get; }
