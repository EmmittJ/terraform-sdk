...
/// Nesting mode: single
/// </summary>
public class AwsQldbLedgerTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsQldbLedger : TerraformResource
{
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> KmsKey { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "kms_key");
    ...
    public required TerraformProperty<TerraformProperty<string>> PermissionsMode { get; set; }
    ...
    public TerraformBlock<AwsQldbLedgerTimeoutsBlock>? Timeouts { get; set; } = new();
