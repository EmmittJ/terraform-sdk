...
/// </summary>
public partial class AwsLightsailBucketAccessKey : TerraformResource
{
    ...
    public partial TerraformValue<string> AccessKeyId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SecretAccessKey { get; }
