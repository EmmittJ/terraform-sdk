...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcEndpointServicePrivateDnsVerificationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsVpcEndpointServicePrivateDnsVerification : TerraformResource
{
    ...
    public AwsVpcEndpointServicePrivateDnsVerificationTimeoutsBlock Timeouts { get; set; } = new();
