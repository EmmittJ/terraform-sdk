...
/// Nesting mode: list
/// </summary>
public class AwsS3BucketReplicationConfigurationRuleBlock : ITerraformBlock
{
    /// <summary>
    /// The id attribute.
    /// </summary>
...
public class AwsS3BucketReplicationConfiguration : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsS3BucketReplicationConfigurationRuleBlock>>? Rule { get; set; } = new();
