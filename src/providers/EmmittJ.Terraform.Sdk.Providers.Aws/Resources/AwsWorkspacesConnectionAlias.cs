...
/// Nesting mode: single
/// </summary>
public class AwsWorkspacesConnectionAliasTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsWorkspacesConnectionAlias : TerraformResource
{
    ...
    public TerraformBlock<AwsWorkspacesConnectionAliasTimeoutsBlock>? Timeouts { get; set; } = new();
