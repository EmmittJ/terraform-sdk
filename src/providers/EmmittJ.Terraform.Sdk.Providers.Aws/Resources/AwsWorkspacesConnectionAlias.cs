...
/// Nesting mode: single
/// </summary>
public partial class AwsWorkspacesConnectionAliasTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsWorkspacesConnectionAlias : TerraformResource
{
    ...
    public AwsWorkspacesConnectionAliasTimeoutsBlock Timeouts { get; set; } = new();
