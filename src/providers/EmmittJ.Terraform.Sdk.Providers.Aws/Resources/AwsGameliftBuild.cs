...
/// Nesting mode: list
/// </summary>
public class AwsGameliftBuildStorageLocationBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsGameliftBuild : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsGameliftBuildStorageLocationBlock>>? StorageLocation { get; set; } = new();
