...
/// <summary>
/// Block type for timeouts in AwsDxPrivateVirtualInterface.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_dx_private_virtual_interface Terraform resource.
/// Manages a aws_dx_private_virtual_interface resource.
/// </summary>
public partial class AwsDxPrivateVirtualInterface(string name) : TerraformResource("aws_dx_private_virtual_interface", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsDxPrivateVirtualInterfaceTimeoutsBlock>("timeouts");
