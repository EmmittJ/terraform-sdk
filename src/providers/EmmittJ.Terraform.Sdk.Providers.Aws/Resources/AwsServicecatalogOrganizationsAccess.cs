...
/// Nesting mode: single
/// </summary>
public class AwsServicecatalogOrganizationsAccessTimeoutsBlock : ITerraformBlock
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public class AwsServicecatalogOrganizationsAccess : TerraformResource
{
    ...
    public TerraformBlock<AwsServicecatalogOrganizationsAccessTimeoutsBlock>? Timeouts { get; set; } = new();
