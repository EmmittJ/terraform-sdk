...
/// Nesting mode: single
/// </summary>
public class AwsElasticsearchVpcEndpointTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsElasticsearchVpcEndpointVpcOptionsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsElasticsearchVpcEndpoint : TerraformResource
{
    ...
    public TerraformBlock<AwsElasticsearchVpcEndpointTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AwsElasticsearchVpcEndpointVpcOptionsBlock>>? VpcOptions { get; set; } = new();
