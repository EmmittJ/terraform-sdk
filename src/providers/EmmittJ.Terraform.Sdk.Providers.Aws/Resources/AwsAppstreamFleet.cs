...
public partial class AwsAppstreamFleetComputeCapacityBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<double>? DesiredInstances { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? DesiredSessions { get; set; }
...
public partial class AwsAppstreamFleet : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> DisconnectTimeoutInSeconds { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? IdleDisconnectTimeoutInSeconds { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxSessionsPerInstance { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> MaxUserDurationInSeconds { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> StreamView { get; set; }
