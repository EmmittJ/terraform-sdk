...
/// Nesting mode: set
/// </summary>
public class AwsWafregionalRateBasedRulePredicateBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsWafregionalRateBasedRule : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsWafregionalRateBasedRulePredicateBlock>>? Predicate { get; set; } = new();
