...
/// Nesting mode: list
/// </summary>
public class AwsLbAccessLogsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbConnectionLogsBlock : ITerraformBlock
{
    /// <summary>
    /// The bucket attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbIpamPoolsBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbMinimumLoadBalancerCapacityBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: set
/// </summary>
public class AwsLbSubnetMappingBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsLbTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsLb : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsLbAccessLogsBlock>>? AccessLogs { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AwsLbConnectionLogsBlock>>? ConnectionLogs { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AwsLbIpamPoolsBlock>>? IpamPools { get; set; } = new();
    ...
    public TerraformList<TerraformBlock<AwsLbMinimumLoadBalancerCapacityBlock>>? MinimumLoadBalancerCapacity { get; set; } = new();
    ...
    public TerraformSet<TerraformBlock<AwsLbSubnetMappingBlock>>? SubnetMapping { get; set; } = new();
    ...
    public TerraformBlock<AwsLbTimeoutsBlock>? Timeouts { get; set; } = new();
