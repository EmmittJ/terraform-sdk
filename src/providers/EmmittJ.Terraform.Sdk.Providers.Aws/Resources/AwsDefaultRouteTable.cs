...
/// Nesting mode: single
/// </summary>
public partial class AwsDefaultRouteTableTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsDefaultRouteTable : TerraformResource
{
    ...
    public required partial TerraformValue<string> DefaultRouteTableId { get; set; }
    ...
    /// </summary>
    [TerraformProperty("propagating_vgws")]
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? PropagatingVgws { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformSet<object> Route { get; set; }
    ...
    public AwsDefaultRouteTableTimeoutsBlock Timeouts { get; set; } = new();
