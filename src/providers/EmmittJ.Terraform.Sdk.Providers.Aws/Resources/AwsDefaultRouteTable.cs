...
/// Nesting mode: single
/// </summary>
public partial class AwsDefaultRouteTableTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsDefaultRouteTable : TerraformResource
{
    ...
    public required TerraformValue<string> DefaultRouteTableId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformSet<string>? PropagatingVgws { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformSet<object> Route { get; set; }
    ...
    public TerraformBlock<AwsDefaultRouteTableTimeoutsBlock>? Timeouts { get; set; }
