...
public partial class AwsDmsReplicationTask : TerraformResource
{
    ...
    public partial TerraformValue<string> CdcStartPosition { get; set; }
    ...
    public partial TerraformValue<string>? CdcStartTime { get; set; }
    ...
    public required partial TerraformValue<string> MigrationType { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ReplicationInstanceArn { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ReplicationTaskSettings { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? StartReplicationTask { get; set; }
