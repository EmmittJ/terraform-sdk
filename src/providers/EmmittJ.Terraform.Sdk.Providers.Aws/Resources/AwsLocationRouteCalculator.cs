...
/// </summary>
public partial class AwsLocationRouteCalculator : TerraformResource
{
    ...
    public required partial TerraformValue<string> CalculatorName { get; set; }
    ...
    public partial TerraformValue<string> CalculatorArn { get; }
