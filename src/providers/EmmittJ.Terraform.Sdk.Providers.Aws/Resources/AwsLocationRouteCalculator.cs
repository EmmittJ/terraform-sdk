...
/// Nesting mode: single
/// </summary>
public class AwsLocationRouteCalculatorTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsLocationRouteCalculator : TerraformResource
{
    ...
    public TerraformBlock<AwsLocationRouteCalculatorTimeoutsBlock>? Timeouts { get; set; } = new();
