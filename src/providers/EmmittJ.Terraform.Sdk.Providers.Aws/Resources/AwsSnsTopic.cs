...
public partial class AwsSnsTopic : TerraformResource
{
    ...
    public TerraformValue<string> FifoThroughputScope { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<double> SignatureVersion { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> TracingConfig { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> BeginningArchiveTime { get; }
