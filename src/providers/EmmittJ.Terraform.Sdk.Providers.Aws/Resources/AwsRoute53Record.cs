...
public partial class AwsRoute53RecordAliasBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<bool> EvaluateTargetHealth { get; set; }
...
public partial class AwsRoute53RecordCidrRoutingPolicyBlock : TerraformBlockBase
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> LocationName { get; set; }
...
public partial class AwsRoute53RecordGeolocationRoutingPolicyBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? Continent { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Subdivision { get; set; }
...
public partial class AwsRoute53RecordGeoproximityRoutingPolicyBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? Bias { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? LocalZoneGroup { get; set; }
...
public partial class AwsRoute53Record : TerraformResource
{
    ...
    public partial TerraformValue<bool> AllowOverwrite { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? MultivalueAnswerRoutingPolicy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? Records { get; set; }
