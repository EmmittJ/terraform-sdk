...
/// Nesting mode: single
/// </summary>
public partial class AwsOdbNetworkPeeringConnectionTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsOdbNetworkPeeringConnection : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> OdbNetworkArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> OdbPeeringConnectionType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> PeerNetworkArn { get; }
