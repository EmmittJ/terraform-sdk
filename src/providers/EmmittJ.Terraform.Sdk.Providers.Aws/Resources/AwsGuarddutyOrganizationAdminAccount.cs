...
/// <summary>
/// Represents a aws_guardduty_organization_admin_account Terraform resource.
/// Manages a aws_guardduty_organization_admin_account resource.
/// </summary>
public partial class AwsGuarddutyOrganizationAdminAccount(string name) : TerraformResource("aws_guardduty_organization_admin_account", name)
{
    /// <summary>
