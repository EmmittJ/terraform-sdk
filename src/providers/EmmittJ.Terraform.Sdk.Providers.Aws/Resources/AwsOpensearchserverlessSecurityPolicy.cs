...
/// </summary>
public partial class AwsOpensearchserverlessSecurityPolicy : TerraformResource
{
    public AwsOpensearchserverlessSecurityPolicy(string name) : base("aws_opensearchserverless_security_policy", name)
    {
    }
