...
public partial class AwsBackupPlanAdvancedBackupSettingBlock : TerraformBlockBase
{
    ...
    public required partial TerraformMap<string> BackupOptions { get; set; }
...
public partial class AwsBackupPlanRuleBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<double>? CompletionWindow { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnableContinuousBackup { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformMap<string>? RecoveryPointTags { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? StartWindow { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TargetVaultName { get; set; }
