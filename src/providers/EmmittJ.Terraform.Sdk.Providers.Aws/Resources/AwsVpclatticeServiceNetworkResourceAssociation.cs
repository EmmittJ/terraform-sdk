...
/// Nesting mode: single
/// </summary>
public partial class AwsVpclatticeServiceNetworkResourceAssociationTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsVpclatticeServiceNetworkResourceAssociation : TerraformResource
{
    ...
    public required TerraformValue<string> ResourceConfigurationIdentifier { get; set; }
    ...
    public TerraformBlock<AwsVpclatticeServiceNetworkResourceAssociationTimeoutsBlock>? Timeouts { get; set; }
