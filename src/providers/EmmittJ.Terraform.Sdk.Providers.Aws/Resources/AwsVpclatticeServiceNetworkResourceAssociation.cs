...
/// Nesting mode: single
/// </summary>
public class AwsVpclatticeServiceNetworkResourceAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVpclatticeServiceNetworkResourceAssociation : TerraformResource
{
    ...
    [TerraformPropertyName("resource_configuration_identifier")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> ResourceConfigurationIdentifier { get; set; }
    ...
    public TerraformBlock<AwsVpclatticeServiceNetworkResourceAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
