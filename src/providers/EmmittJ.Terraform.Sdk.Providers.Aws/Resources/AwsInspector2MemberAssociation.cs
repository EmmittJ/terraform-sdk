...
/// Nesting mode: single
/// </summary>
public class AwsInspector2MemberAssociationTimeoutsBlock
{
    /// <summary>
...
public class AwsInspector2MemberAssociation : TerraformResource
{
    ...
    public TerraformValue<string> DelegatedAdminAccountId => new TerraformReference(this, "delegated_admin_account_id");
