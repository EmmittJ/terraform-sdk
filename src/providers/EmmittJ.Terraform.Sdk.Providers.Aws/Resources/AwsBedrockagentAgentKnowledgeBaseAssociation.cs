...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentAgentKnowledgeBaseAssociationTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsBedrockagentAgentKnowledgeBaseAssociation : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> KnowledgeBaseState { get; set; }
    ...
    public TerraformBlock<AwsBedrockagentAgentKnowledgeBaseAssociationTimeoutsBlock>? Timeouts { get; set; }
