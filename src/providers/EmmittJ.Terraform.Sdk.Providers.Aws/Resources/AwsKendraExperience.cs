...
/// Nesting mode: list
/// </summary>
public class AwsKendraExperienceConfigurationBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class AwsKendraExperienceTimeoutsBlock
{
    /// <summary>
...
public class AwsKendraExperience : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformSet<object> Endpoints => new TerraformReference(this, "endpoints");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ExperienceId => new TerraformReference(this, "experience_id");
