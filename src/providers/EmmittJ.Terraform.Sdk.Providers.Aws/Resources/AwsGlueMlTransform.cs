...
/// Nesting mode: list
/// </summary>
public class AwsGlueMlTransformInputRecordTablesBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsGlueMlTransformParametersBlock
{
    /// <summary>
...
public class AwsGlueMlTransform : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<double> LabelCount => new TerraformReference(this, "label_count");
