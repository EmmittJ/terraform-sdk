...
public partial class AwsConnectQueueOutboundCallerConfigBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? OutboundCallerIdName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? OutboundCallerIdNumberId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? OutboundFlowId { get; set; }
...
public partial class AwsConnectQueue : TerraformResource
{
    ...
    public required partial TerraformValue<string> HoursOfOperationId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxContacts { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? QuickConnectIds { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> QueueId { get; }
