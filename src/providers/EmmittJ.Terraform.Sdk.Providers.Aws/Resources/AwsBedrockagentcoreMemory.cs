...
/// Nesting mode: single
/// </summary>
public class AwsBedrockagentcoreMemoryTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsBedrockagentcoreMemory : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<double>> EventExpiryDuration { get; set; }
    ...
    public TerraformBlock<AwsBedrockagentcoreMemoryTimeoutsBlock>? Timeouts { get; set; } = new();
