...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentcoreMemoryTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsBedrockagentcoreMemory : TerraformResource
{
    ...
    [TerraformProperty("event_expiry_duration")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> EventExpiryDuration { get; set; }
    ...
    public AwsBedrockagentcoreMemoryTimeoutsBlock Timeouts { get; set; } = new();
