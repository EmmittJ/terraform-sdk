...
/// Nesting mode: single
/// </summary>
public partial class AwsDatazoneEnvironmentTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public partial class AwsDatazoneEnvironmentUserParametersBlock() : TerraformBlock("user_parameters")
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public partial class AwsDatazoneEnvironment : TerraformResource
{
    ...
    public AwsDatazoneEnvironmentTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public TerraformList<AwsDatazoneEnvironmentUserParametersBlock> UserParameters { get; set; } = new();
