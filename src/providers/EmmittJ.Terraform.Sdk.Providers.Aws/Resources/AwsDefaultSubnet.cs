...
/// Nesting mode: single
/// </summary>
public partial class AwsDefaultSubnetTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsDefaultSubnet : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> PrivateDnsHostnameTypeOnLaunch { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> ExistingDefaultSubnet { get; }
