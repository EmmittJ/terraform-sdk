...
/// <summary>
/// Represents a aws_opensearchserverless_lifecycle_policy Terraform resource.
/// Manages a aws_opensearchserverless_lifecycle_policy resource.
/// </summary>
public partial class AwsOpensearchserverlessLifecyclePolicy(string name) : TerraformResource("aws_opensearchserverless_lifecycle_policy", name)
{
    /// <summary>
