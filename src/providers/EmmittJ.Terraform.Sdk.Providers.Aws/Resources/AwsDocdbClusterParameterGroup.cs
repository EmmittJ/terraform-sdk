...
/// <summary>
/// Block type for parameter in AwsDocdbClusterParameterGroup.
/// Nesting mode: set
/// </summary>
...
/// <summary>
/// Represents a aws_docdb_cluster_parameter_group Terraform resource.
/// Manages a aws_docdb_cluster_parameter_group resource.
/// </summary>
public partial class AwsDocdbClusterParameterGroup(string name) : TerraformResource("aws_docdb_cluster_parameter_group", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformSet<AwsDocdbClusterParameterGroupParameterBlock>? Parameter
    {
        get => GetArgument<TerraformSet<AwsDocdbClusterParameterGroupParameterBlock>>("parameter");
