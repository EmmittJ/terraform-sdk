...
/// Nesting mode: set
/// </summary>
public class AwsDocdbClusterParameterGroupParameterBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDocdbClusterParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsDocdbClusterParameterGroupParameterBlock>>? Parameter { get; set; } = new();
