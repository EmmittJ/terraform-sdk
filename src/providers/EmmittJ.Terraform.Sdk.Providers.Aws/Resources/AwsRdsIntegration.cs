...
/// Nesting mode: single
/// </summary>
public partial class AwsRdsIntegrationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsRdsIntegration : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("data_filter")]
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> DataFilter { get; set; }

    /// <summary>
    /// The integration_name attribute.
    /// </summary>
    [System.ComponentModel.DataAnnotations.Required(ErrorMessage = "IntegrationName is required")]
    [TerraformProperty("integration_name")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> IntegrationName { get; set; }
    ...
    public AwsRdsIntegrationTimeoutsBlock Timeouts { get; set; } = new();
