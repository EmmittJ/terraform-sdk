...
public partial class AwsRedshiftserverlessSnapshot : TerraformResource
{
    ...
    public partial TerraformSet<string> AccountsWithProvisionedRestoreAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> AccountsWithRestoreAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> NamespaceArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> OwnerAccount { get; }
