...
/// Nesting mode: single
/// </summary>
public partial class AwsDbSnapshotTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsDbSnapshot : TerraformResource
{
    ...
    public required partial TerraformValue<string> DbInstanceIdentifier { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DbSnapshotIdentifier { get; set; }
    ...
    public AwsDbSnapshotTimeoutsBlock Timeouts { get; set; } = new();
