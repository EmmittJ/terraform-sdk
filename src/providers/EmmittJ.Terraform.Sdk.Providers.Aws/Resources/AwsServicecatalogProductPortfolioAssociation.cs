...
/// Nesting mode: single
/// </summary>
public partial class AwsServicecatalogProductPortfolioAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsServicecatalogProductPortfolioAssociation : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("source_portfolio_id")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourcePortfolioId { get; set; }
    ...
    public AwsServicecatalogProductPortfolioAssociationTimeoutsBlock Timeouts { get; set; } = new();
