...
/// Nesting mode: single
/// </summary>
public class AwsServicecatalogProductPortfolioAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsServicecatalogProductPortfolioAssociation : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? SourcePortfolioId { get; set; }
    ...
    public TerraformBlock<AwsServicecatalogProductPortfolioAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
