...
/// Nesting mode: single
/// </summary>
public class AwsVpcRouteServerEndpointTimeoutsBlock
{
    /// <summary>
...
public class AwsVpcRouteServerEndpoint : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> EniAddress => new TerraformReference(this, "eni_address");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> EniId => new TerraformReference(this, "eni_id");
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> RouteServerEndpointId => new TerraformReference(this, "route_server_endpoint_id");
