...
/// Nesting mode: single
/// </summary>
public class AwsDxHostedTransitVirtualInterfaceAccepterTimeoutsBlock
{
    /// <summary>
...
public class AwsDxHostedTransitVirtualInterfaceAccepter : TerraformResource
{
    ...
    public TerraformBlock<AwsDxHostedTransitVirtualInterfaceAccepterTimeoutsBlock>? Timeouts { get; set; }
