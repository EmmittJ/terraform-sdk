...
/// Nesting mode: single
/// </summary>
public class AwsDxHostedTransitVirtualInterfaceAccepterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDxHostedTransitVirtualInterfaceAccepter : TerraformResource
{
    ...
    public TerraformBlock<AwsDxHostedTransitVirtualInterfaceAccepterTimeoutsBlock>? Timeouts { get; set; } = new();
