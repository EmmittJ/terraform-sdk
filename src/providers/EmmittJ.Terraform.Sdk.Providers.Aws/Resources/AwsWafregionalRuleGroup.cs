...
/// Nesting mode: set
/// </summary>
public class AwsWafregionalRuleGroupActivatedRuleBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsWafregionalRuleGroup : TerraformResource
{
    ...
    /// Nesting mode: set
    /// </summary>
    [TerraformPropertyName("activated_rule")]
    public TerraformSet<TerraformBlock<AwsWafregionalRuleGroupActivatedRuleBlock>>? ActivatedRule { get; set; } = new();
