...
public partial class AwsMediaConvertQueueReservationPlanSettingsBlock() : TerraformBlock("reservation_plan_settings")
{
    ...
    public required partial TerraformValue<string> Commitment { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RenewalType { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> ReservedSlots { get; set; }
...
public partial class AwsMediaConvertQueue : TerraformResource
{
    ...
    public partial TerraformValue<double> ConcurrentJobs { get; set; }
