...
/// Nesting mode: single
/// </summary>
public partial class AwsDbInstanceRoleAssociationTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsDbInstanceRoleAssociation : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> FeatureName { get; set; }
    ...
    public partial TerraformBlock<AwsDbInstanceRoleAssociationTimeoutsBlock>? Timeouts { get; set; }
