...
public partial class AwsNetworkfirewallTlsInspectionConfiguration : TerraformResource
{
    ...
    public partial TerraformList<object> EncryptionConfiguration { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> NumberOfAssociations { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TlsInspectionConfigurationId { get; }
