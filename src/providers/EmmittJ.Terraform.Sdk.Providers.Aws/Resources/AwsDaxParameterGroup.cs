...
/// Nesting mode: set
/// </summary>
public class AwsDaxParameterGroupParametersBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsDaxParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsDaxParameterGroupParametersBlock>>? Parameters { get; set; } = new();
