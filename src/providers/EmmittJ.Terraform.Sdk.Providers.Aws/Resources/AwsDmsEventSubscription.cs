...
/// Nesting mode: single
/// </summary>
public partial class AwsDmsEventSubscriptionTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsDmsEventSubscription : TerraformResource
{
    public AwsDmsEventSubscription(string name) : base("aws_dms_event_subscription", name)
    {
    }
    ...
    public required partial TerraformSet<string> EventCategories { get; set; }
    ...
    public partial TerraformBlock<AwsDmsEventSubscriptionTimeoutsBlock>? Timeouts { get; set; }
