...
public class AwsIotTopicRuleDestination : TerraformResource
{
    ...
    {
        get => GetProperty<AwsIotTopicRuleDestinationTimeoutsBlock>("timeouts");
    ...
    {
        get => GetProperty<List<AwsIotTopicRuleDestinationVpcConfigurationBlock>>("vpc_configuration");
