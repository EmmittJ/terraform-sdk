...
/// Nesting mode: list
/// </summary>
public partial class AwsAlbTargetGroupHealthCheckBlock() : TerraformBlock("health_check")
{
    /// <summary>
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Port { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class AwsAlbTargetGroupStickinessBlock() : TerraformBlock("stickiness")
{
    /// <summary>
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? CookieDuration { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CookieName { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class AwsAlbTargetGroupTargetFailoverBlock() : TerraformBlock("target_failover")
{
    /// <summary>
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> OnDeregistration { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> OnUnhealthy { get; set; }
...
/// Nesting mode: list
/// </summary>
public partial class AwsAlbTargetGroupTargetGroupHealthBlock() : TerraformBlock("target_group_health")
{
}
...
/// Nesting mode: list
/// </summary>
public partial class AwsAlbTargetGroupTargetHealthStateBlock() : TerraformBlock("target_health_state")
{
    /// <summary>
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<bool> EnableUnhealthyConnectionTermination { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? UnhealthyDrainingInterval { get; set; }
...
public partial class AwsAlbTargetGroup : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> ConnectionTermination { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DeregistrationDelay { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? LambdaMultiValueHeadersEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> LoadBalancingAlgorithmType { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> LoadBalancingCrossZoneEnabled { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> PreserveClientIp { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ProxyProtocolV2 { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? SlowStart { get; set; }
    ...
    public TerraformList<AwsAlbTargetGroupHealthCheckBlock> HealthCheck { get; set; } = new();
    ...
    public TerraformList<AwsAlbTargetGroupStickinessBlock> Stickiness { get; set; } = new();
    ...
    public TerraformList<AwsAlbTargetGroupTargetFailoverBlock> TargetFailover { get; set; } = new();
    ...
    public TerraformList<AwsAlbTargetGroupTargetGroupHealthBlock> TargetGroupHealth { get; set; } = new();
    ...
    public TerraformList<AwsAlbTargetGroupTargetHealthStateBlock> TargetHealthState { get; set; } = new();
