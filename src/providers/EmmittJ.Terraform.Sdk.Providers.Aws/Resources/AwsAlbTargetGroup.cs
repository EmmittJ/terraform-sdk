...
public class AwsAlbTargetGroup : TerraformResource
{
    ...
    {
        get => GetProperty<List<AwsAlbTargetGroupHealthCheckBlock>>("health_check");
    ...
    {
        get => GetProperty<List<AwsAlbTargetGroupStickinessBlock>>("stickiness");
    ...
    {
        get => GetProperty<List<AwsAlbTargetGroupTargetFailoverBlock>>("target_failover");
    ...
    {
        get => GetProperty<List<AwsAlbTargetGroupTargetGroupHealthBlock>>("target_group_health");
    ...
    {
        get => GetProperty<List<AwsAlbTargetGroupTargetHealthStateBlock>>("target_health_state");
