...
/// Nesting mode: single
/// </summary>
public partial class AwsNatGatewayTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsNatGateway : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ConnectivityType { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformSet<string> SecondaryAllocationIds { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> SecondaryPrivateIpAddressCount { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformSet<string> SecondaryPrivateIpAddresses { get; set; }
    ...
    public AwsNatGatewayTimeoutsBlock Timeouts { get; set; } = new();
