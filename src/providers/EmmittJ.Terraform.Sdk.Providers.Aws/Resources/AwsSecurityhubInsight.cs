...
/// Nesting mode: list
/// </summary>
public class AwsSecurityhubInsightFiltersBlock : ITerraformBlock
{
}
...
public class AwsSecurityhubInsight : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> GroupByAttribute { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsSecurityhubInsightFiltersBlock>>? Filters { get; set; } = new();
