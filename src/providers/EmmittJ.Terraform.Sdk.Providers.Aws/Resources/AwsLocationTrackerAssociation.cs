...
/// Nesting mode: single
/// </summary>
public class AwsLocationTrackerAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsLocationTrackerAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsLocationTrackerAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
