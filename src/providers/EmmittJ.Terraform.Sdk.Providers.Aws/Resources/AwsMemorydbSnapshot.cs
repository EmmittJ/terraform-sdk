...
/// Nesting mode: single
/// </summary>
public partial class AwsMemorydbSnapshotTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsMemorydbSnapshot : TerraformResource
{
    ...
    public AwsMemorydbSnapshotTimeoutsBlock Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformProperty("cluster_configuration")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ClusterConfiguration { get; }
