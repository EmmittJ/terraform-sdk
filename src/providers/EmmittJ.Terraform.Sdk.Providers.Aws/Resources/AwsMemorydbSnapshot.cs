...
/// Nesting mode: single
/// </summary>
public class AwsMemorydbSnapshotTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsMemorydbSnapshot : TerraformResource
{
    ...
    public TerraformBlock<AwsMemorydbSnapshotTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> ClusterConfiguration => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "cluster_configuration");
