...
/// Nesting mode: single
/// </summary>
public class AwsDbEventSubscriptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDbEventSubscription : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<HashSet<TerraformProperty<string>>>? EventCategories { get; set; }
    ...
    public required TerraformProperty<TerraformProperty<string>> SnsTopic { get; set; }
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<HashSet<TerraformProperty<string>>>? SourceIds { get; set; }
    ...
    public TerraformBlock<AwsDbEventSubscriptionTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> CustomerAwsId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "customer_aws_id");
