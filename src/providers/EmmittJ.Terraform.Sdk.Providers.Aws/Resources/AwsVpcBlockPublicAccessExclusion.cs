...
/// Nesting mode: single
/// </summary>
public class AwsVpcBlockPublicAccessExclusionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVpcBlockPublicAccessExclusion : TerraformResource
{
    ...
    [TerraformPropertyName("internet_gateway_exclusion_mode")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> InternetGatewayExclusionMode { get; set; }
    ...
    public TerraformBlock<AwsVpcBlockPublicAccessExclusionTimeoutsBlock>? Timeouts { get; set; } = new();
