...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcBlockPublicAccessExclusionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsVpcBlockPublicAccessExclusion : TerraformResource
{
    ...
    public AwsVpcBlockPublicAccessExclusionTimeoutsBlock Timeouts { get; set; } = new();
