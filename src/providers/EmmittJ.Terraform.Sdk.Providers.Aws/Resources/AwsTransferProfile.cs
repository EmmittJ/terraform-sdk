...
public partial class AwsTransferProfile : TerraformResource
{
    ...
    public required partial TerraformValue<string> As2Id { get; set; }
    ...
    public partial TerraformSet<string>? CertificateIds { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ProfileType { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ProfileId { get; }
