...
/// Nesting mode: list
/// </summary>
public class AwsControltowerBaselineParametersBlock : ITerraformBlock
{
    /// <summary>
    /// The key attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsControltowerBaselineTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsControltowerBaseline : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> BaselineIdentifier { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> BaselineVersion { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsControltowerBaselineParametersBlock>>? Parameters { get; set; } = new();
    ...
    public TerraformBlock<AwsControltowerBaselineTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> OperationIdentifier => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "operation_identifier");
