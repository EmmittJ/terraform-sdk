...
/// Nesting mode: single
/// </summary>
public class AwsSesDomainIdentityVerificationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsSesDomainIdentityVerification : TerraformResource
{
    ...
    public TerraformBlock<AwsSesDomainIdentityVerificationTimeoutsBlock>? Timeouts { get; set; } = new();
