...
public partial class AwsSagemakerMlflowTrackingServer : TerraformResource
{
    ...
    public required partial TerraformValue<string> ArtifactStoreUri { get; set; }
    ...
    public partial TerraformValue<bool>? AutomaticModelRegistration { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> MlflowVersion { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TrackingServerName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TrackingServerSize { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TrackingServerUrl { get; }
