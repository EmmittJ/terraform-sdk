...
/// <summary>
/// Represents a aws_ecr_repository_policy Terraform resource.
/// Manages a aws_ecr_repository_policy resource.
/// </summary>
public partial class AwsEcrRepositoryPolicy(string name) : TerraformResource("aws_ecr_repository_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
