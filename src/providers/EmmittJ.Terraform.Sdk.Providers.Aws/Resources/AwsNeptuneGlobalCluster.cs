...
/// Nesting mode: single
/// </summary>
public partial class AwsNeptuneGlobalClusterTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsNeptuneGlobalCluster : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> SourceDbClusterIdentifier { get; set; }
    ...
    public TerraformBlock<AwsNeptuneGlobalClusterTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<object> GlobalClusterMembers { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> GlobalClusterResourceId { get; }
