...
public partial class AwsAmplifyBranch : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> AssociatedResources { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<string> CustomDomains { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> DestinationBranch { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> SourceBranch { get; }
