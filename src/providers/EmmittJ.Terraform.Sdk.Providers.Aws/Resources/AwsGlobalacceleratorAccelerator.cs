...
/// <summary>
/// Block type for attributes in AwsGlobalacceleratorAccelerator.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AwsGlobalacceleratorAccelerator.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_globalaccelerator_accelerator Terraform resource.
/// Manages a aws_globalaccelerator_accelerator resource.
/// </summary>
public partial class AwsGlobalacceleratorAccelerator(string name) : TerraformResource("aws_globalaccelerator_accelerator", name)
{
    /// <summary>
    ...
    public TerraformList<AwsGlobalacceleratorAcceleratorAttributesBlock>? Attributes
    {
        get => GetArgument<TerraformList<AwsGlobalacceleratorAcceleratorAttributesBlock>>("attributes");
    ...
    {
        get => GetArgument<AwsGlobalacceleratorAcceleratorTimeoutsBlock>("timeouts");
