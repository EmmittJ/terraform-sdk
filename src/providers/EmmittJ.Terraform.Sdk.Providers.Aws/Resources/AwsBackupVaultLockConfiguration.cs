...
public partial class AwsBackupVaultLockConfiguration : TerraformResource
{
    ...
    public required partial TerraformValue<string> BackupVaultName { get; set; }
    ...
    public partial TerraformValue<double>? ChangeableForDays { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxRetentionDays { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MinRetentionDays { get; set; }
    ...
    public partial TerraformValue<string> BackupVaultArn { get; }
