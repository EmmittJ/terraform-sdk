...
/// Nesting mode: single
/// </summary>
public partial class AwsVpclatticeServiceNetworkVpcAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsVpclatticeServiceNetworkVpcAssociation : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VpcIdentifier { get; set; }
    ...
    public AwsVpclatticeServiceNetworkVpcAssociationTimeoutsBlock Timeouts { get; set; } = new();
