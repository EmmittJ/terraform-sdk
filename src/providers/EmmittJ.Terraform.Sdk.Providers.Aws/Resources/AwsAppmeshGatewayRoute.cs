...
/// Nesting mode: list
/// </summary>
public partial class AwsAppmeshGatewayRouteSpecBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsAppmeshGatewayRoute : TerraformResource
{
    ...
    [TerraformProperty("virtual_gateway_name")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VirtualGatewayName { get; set; }
    ...
    public partial TerraformList<TerraformBlock<AwsAppmeshGatewayRouteSpecBlock>>? Spec { get; set; }
