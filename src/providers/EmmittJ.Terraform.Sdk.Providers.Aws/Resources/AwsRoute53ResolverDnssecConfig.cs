...
public class AwsRoute53ResolverDnssecConfig : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("validation_status")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> ValidationStatus => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "validation_status");
