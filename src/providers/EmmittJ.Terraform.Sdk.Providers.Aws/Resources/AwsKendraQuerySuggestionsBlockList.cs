...
/// Nesting mode: list
/// </summary>
public class AwsKendraQuerySuggestionsBlockListSourceS3PathBlock : ITerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsKendraQuerySuggestionsBlockListTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsKendraQuerySuggestionsBlockList : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsKendraQuerySuggestionsBlockListSourceS3PathBlock>>? SourceS3Path { get; set; } = new();
    ...
    public TerraformBlock<AwsKendraQuerySuggestionsBlockListTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> QuerySuggestionsBlockListId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "query_suggestions_block_list_id");
