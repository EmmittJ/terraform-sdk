...
/// Nesting mode: list
/// </summary>
public partial class AwsKendraQuerySuggestionsBlockListSourceS3PathBlock : TerraformBlockBase
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsKendraQuerySuggestionsBlockListTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsKendraQuerySuggestionsBlockList : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsKendraQuerySuggestionsBlockListSourceS3PathBlock>>? SourceS3Path { get; set; }
    ...
    public TerraformBlock<AwsKendraQuerySuggestionsBlockListTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> QuerySuggestionsBlockListId { get; }
