...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcRouteServerVpcAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsVpcRouteServerVpcAssociation : TerraformResource
{
    ...
    public AwsVpcRouteServerVpcAssociationTimeoutsBlock Timeouts { get; set; } = new();
