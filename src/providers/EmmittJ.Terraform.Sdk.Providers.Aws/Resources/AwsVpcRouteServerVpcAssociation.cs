...
/// Nesting mode: single
/// </summary>
public class AwsVpcRouteServerVpcAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVpcRouteServerVpcAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsVpcRouteServerVpcAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
