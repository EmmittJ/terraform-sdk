...
/// <summary>
/// Block type for timeouts in AwsVpcRouteServerVpcAssociation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_vpc_route_server_vpc_association Terraform resource.
/// Manages a aws_vpc_route_server_vpc_association resource.
/// </summary>
public partial class AwsVpcRouteServerVpcAssociation(string name) : TerraformResource("aws_vpc_route_server_vpc_association", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsVpcRouteServerVpcAssociationTimeoutsBlock>("timeouts");
