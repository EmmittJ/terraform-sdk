...
/// Nesting mode: set
/// </summary>
public class AwsMemorydbParameterGroupParameterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsMemorydbParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsMemorydbParameterGroupParameterBlock>>? Parameter { get; set; } = new();
