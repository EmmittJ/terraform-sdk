...
public partial class AwsSecurityhubAutomationRule : TerraformResource
{
    ...
    public partial TerraformValue<bool> IsTerminal { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> RuleOrder { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> RuleStatus { get; set; }
