...
public class AwsSecurityhubAutomationRuleActionsBlockFindingFieldsUpdateBlockNoteBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("updated_by");
...
public class AwsSecurityhubAutomationRuleActionsBlockFindingFieldsUpdateBlockSeverityBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("label") ?? CreateReference("label");
...
public partial class AwsSecurityhubAutomationRule(string name) : TerraformResource("aws_securityhub_automation_rule", name)
{
    ...
    {
        get => GetArgument<TerraformValue<bool>>("is_terminal") ?? CreateReference("is_terminal");
    ...
    {
        get => GetRequiredArgument<TerraformValue<double>>("rule_order");
    ...
    {
        get => GetArgument<TerraformValue<string>>("rule_status") ?? CreateReference("rule_status");
