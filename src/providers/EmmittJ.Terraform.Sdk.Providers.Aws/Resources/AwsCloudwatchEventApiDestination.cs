...
public partial class AwsCloudwatchEventApiDestination : TerraformResource
{
    ...
    public required partial TerraformValue<string> ConnectionArn { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> InvocationEndpoint { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? InvocationRateLimitPerSecond { get; set; }
