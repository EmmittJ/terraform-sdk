...
/// <summary>
/// Block type for timeouts in AwsRouteTable.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_route_table Terraform resource.
/// Manages a aws_route_table resource.
/// </summary>
public partial class AwsRouteTable(string name) : TerraformResource("aws_route_table", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AwsRouteTableTimeoutsBlock>("timeouts");
