...
/// Nesting mode: single
/// </summary>
public partial class AwsVpclatticeResourceGatewayTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsVpclatticeResourceGateway : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("ipv4_addresses_per_eni")]
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> Ipv4AddressesPerEni { get; set; }
    ...
    public partial TerraformBlock<AwsVpclatticeResourceGatewayTimeoutsBlock>? Timeouts { get; set; }
