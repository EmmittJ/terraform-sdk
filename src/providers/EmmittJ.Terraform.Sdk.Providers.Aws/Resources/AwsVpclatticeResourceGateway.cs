...
/// <summary>
/// Block type for timeouts in AwsVpclatticeResourceGateway.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_vpclattice_resource_gateway Terraform resource.
/// Manages a aws_vpclattice_resource_gateway resource.
/// </summary>
public partial class AwsVpclatticeResourceGateway(string name) : TerraformResource("aws_vpclattice_resource_gateway", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformValue<double> Ipv4AddressesPerEni
    {
        get => GetArgument<TerraformValue<double>>("ipv4_addresses_per_eni") ?? CreateReference("ipv4_addresses_per_eni");
        set => SetArgument("ipv4_addresses_per_eni", value);
    }
    ...
    {
        get => GetArgument<AwsVpclatticeResourceGatewayTimeoutsBlock>("timeouts");
