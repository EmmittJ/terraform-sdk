...
public partial class AwsApigatewayv2IntegrationResponseParametersBlock : TerraformBlockBase
{
    ...
    public required partial TerraformMap<string> Mappings { get; set; }
...
public partial class AwsApigatewayv2IntegrationTlsConfigBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? ServerNameToVerify { get; set; }
...
public partial class AwsApigatewayv2Integration : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CredentialsArn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? IntegrationMethod { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? IntegrationSubtype { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? IntegrationUri { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PayloadFormatVersion { get; set; }
    ...
    public partial TerraformValue<string> IntegrationResponseSelectionExpression { get; }
