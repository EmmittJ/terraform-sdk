...
/// Nesting mode: single
/// </summary>
public class AwsLocationGeofenceCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsLocationGeofenceCollection : TerraformResource
{
    ...
    public TerraformBlock<AwsLocationGeofenceCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
