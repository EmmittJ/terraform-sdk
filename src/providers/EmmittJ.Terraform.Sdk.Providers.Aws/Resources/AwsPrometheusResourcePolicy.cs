...
/// Nesting mode: single
/// </summary>
public partial class AwsPrometheusResourcePolicyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsPrometheusResourcePolicy : TerraformResource
{
    ...
    public AwsPrometheusResourcePolicyTimeoutsBlock Timeouts { get; set; } = new();
