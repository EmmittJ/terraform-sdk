...
/// Nesting mode: set
/// </summary>
public class AwsWafRuleGroupActivatedRuleBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsWafRuleGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsWafRuleGroupActivatedRuleBlock>>? ActivatedRule { get; set; } = new();
