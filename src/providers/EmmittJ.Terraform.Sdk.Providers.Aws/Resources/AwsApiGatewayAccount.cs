...
public partial class AwsApiGatewayAccount : TerraformResource
{
    ...
    public partial TerraformValue<string> CloudwatchRoleArn { get; set; }
    ...
    public partial TerraformValue<string> ApiKeyVersion { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<string> Features { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ThrottleSettings { get; }
