...
/// <summary>
/// Represents a aws_codebuild_resource_policy Terraform resource.
/// Manages a aws_codebuild_resource_policy resource.
/// </summary>
public partial class AwsCodebuildResourcePolicy(string name) : TerraformResource("aws_codebuild_resource_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
