...
/// Nesting mode: single
/// </summary>
public class AwsCloudsearchDomainServiceAccessPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsCloudsearchDomainServiceAccessPolicy : TerraformResource
{
    ...
    public TerraformBlock<AwsCloudsearchDomainServiceAccessPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
