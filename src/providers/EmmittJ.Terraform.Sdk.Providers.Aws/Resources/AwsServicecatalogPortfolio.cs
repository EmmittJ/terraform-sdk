...
/// Nesting mode: single
/// </summary>
public class AwsServicecatalogPortfolioTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsServicecatalogPortfolio : TerraformResource
{
    ...
    public TerraformBlock<AwsServicecatalogPortfolioTimeoutsBlock>? Timeouts { get; set; } = new();
