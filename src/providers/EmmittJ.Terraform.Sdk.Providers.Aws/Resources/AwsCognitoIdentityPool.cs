...
public partial class AwsCognitoIdentityPoolCognitoIdentityProvidersBlock() : TerraformBlock("cognito_identity_providers")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ServerSideTokenCheck { get; set; }
...
public partial class AwsCognitoIdentityPool : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AllowClassicFlow { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AllowUnauthenticatedIdentities { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DeveloperProviderName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? OpenidConnectProviderArns { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? SamlProviderArns { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformMap<string>? SupportedLoginProviders { get; set; }
