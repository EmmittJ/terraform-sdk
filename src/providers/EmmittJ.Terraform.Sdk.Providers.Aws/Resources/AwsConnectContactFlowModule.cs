...
public class AwsConnectContactFlowModule : TerraformResource
{
    ...
    public TerraformProperty<TerraformProperty<string>>? ContentHash { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> ContactFlowModuleId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "contact_flow_module_id");
