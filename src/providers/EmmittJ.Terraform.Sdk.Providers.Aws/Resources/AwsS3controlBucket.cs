...
public class AwsS3controlBucket : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("public_access_block_enabled")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<bool>> PublicAccessBlockEnabled => new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "public_access_block_enabled");
