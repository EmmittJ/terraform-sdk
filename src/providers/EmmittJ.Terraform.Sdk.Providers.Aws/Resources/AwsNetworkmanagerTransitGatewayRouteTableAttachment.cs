...
/// Nesting mode: single
/// </summary>
public partial class AwsNetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsNetworkmanagerTransitGatewayRouteTableAttachment : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TransitGatewayRouteTableArn { get; set; }
    ...
    public AwsNetworkmanagerTransitGatewayRouteTableAttachmentTimeoutsBlock Timeouts { get; set; } = new();
