...
/// <summary>
/// Represents a aws_ec2_transit_gateway_multicast_group_member Terraform resource.
/// Manages a aws_ec2_transit_gateway_multicast_group_member resource.
/// </summary>
public partial class AwsEc2TransitGatewayMulticastGroupMember(string name) : TerraformResource("aws_ec2_transit_gateway_multicast_group_member", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<TerraformValue<string>>("group_ip_address");
