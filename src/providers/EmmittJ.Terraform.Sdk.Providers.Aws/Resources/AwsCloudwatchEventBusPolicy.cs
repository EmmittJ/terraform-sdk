...
/// <summary>
/// Represents a aws_cloudwatch_event_bus_policy Terraform resource.
/// Manages a aws_cloudwatch_event_bus_policy resource.
/// </summary>
public partial class AwsCloudwatchEventBusPolicy(string name) : TerraformResource("aws_cloudwatch_event_bus_policy", name)
{
    /// <summary>
