...
/// <summary>
/// Represents a aws_app_cookie_stickiness_policy Terraform resource.
/// Manages a aws_app_cookie_stickiness_policy resource.
/// </summary>
public partial class AwsAppCookieStickinessPolicy(string name) : TerraformResource("aws_app_cookie_stickiness_policy", name)
{
    /// <summary>
