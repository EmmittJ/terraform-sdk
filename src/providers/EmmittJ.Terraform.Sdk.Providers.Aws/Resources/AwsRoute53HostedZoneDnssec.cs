...
/// Nesting mode: single
/// </summary>
public partial class AwsRoute53HostedZoneDnssecTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsRoute53HostedZoneDnssec : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SigningStatus { get; set; }
    ...
    public AwsRoute53HostedZoneDnssecTimeoutsBlock Timeouts { get; set; } = new();
