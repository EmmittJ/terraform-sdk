...
/// <summary>
/// Block type for timeouts in AwsCodecatalystProject.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_codecatalyst_project Terraform resource.
/// Manages a aws_codecatalyst_project resource.
/// </summary>
public partial class AwsCodecatalystProject(string name) : TerraformResource("aws_codecatalyst_project", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsCodecatalystProjectTimeoutsBlock>("timeouts");
