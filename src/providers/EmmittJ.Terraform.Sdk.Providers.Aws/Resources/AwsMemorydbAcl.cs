...
/// <summary>
/// Represents a aws_memorydb_acl Terraform resource.
/// Manages a aws_memorydb_acl resource.
/// </summary>
public partial class AwsMemorydbAcl(string name) : TerraformResource("aws_memorydb_acl", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<TerraformSet<string>>("user_names");
        set => SetArgument("user_names", value);
    }
