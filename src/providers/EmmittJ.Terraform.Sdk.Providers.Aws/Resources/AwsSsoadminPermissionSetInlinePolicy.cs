...
/// Nesting mode: single
/// </summary>
public partial class AwsSsoadminPermissionSetInlinePolicyTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsSsoadminPermissionSetInlinePolicy : TerraformResource
{
    ...
    public required partial TerraformValue<string> InlinePolicy { get; set; }
    ...
    public AwsSsoadminPermissionSetInlinePolicyTimeoutsBlock Timeouts { get; set; } = new();
