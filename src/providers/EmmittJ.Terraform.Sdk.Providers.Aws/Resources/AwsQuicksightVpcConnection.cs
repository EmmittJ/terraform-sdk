...
/// Nesting mode: single
/// </summary>
public partial class AwsQuicksightVpcConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsQuicksightVpcConnection : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("dns_resolvers")]
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? DnsResolvers { get; set; }
    ...
    [TerraformProperty("vpc_connection_id")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> VpcConnectionId { get; set; }
    ...
    public AwsQuicksightVpcConnectionTimeoutsBlock Timeouts { get; set; } = new();
    ...
    /// </summary>
    [TerraformProperty("availability_status")]
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> AvailabilityStatus { get; }
