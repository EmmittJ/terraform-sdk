...
/// Nesting mode: single
/// </summary>
public partial class AwsQuicksightVpcConnectionTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsQuicksightVpcConnection : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformSet<string>? DnsResolvers { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> VpcConnectionId { get; set; }
    ...
    public TerraformBlock<AwsQuicksightVpcConnectionTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> AvailabilityStatus { get; }
