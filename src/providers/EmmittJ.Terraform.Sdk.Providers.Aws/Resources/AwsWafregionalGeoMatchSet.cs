...
/// Nesting mode: set
/// </summary>
public class AwsWafregionalGeoMatchSetGeoMatchConstraintBlock : ITerraformBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
public class AwsWafregionalGeoMatchSet : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsWafregionalGeoMatchSetGeoMatchConstraintBlock>>? GeoMatchConstraint { get; set; } = new();
