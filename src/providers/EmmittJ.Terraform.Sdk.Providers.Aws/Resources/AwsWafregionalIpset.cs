...
/// Nesting mode: set
/// </summary>
public class AwsWafregionalIpsetIpSetDescriptorBlock : ITerraformBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
public class AwsWafregionalIpset : TerraformResource
{
    ...
    /// Nesting mode: set
    /// </summary>
    [TerraformPropertyName("ip_set_descriptor")]
    public TerraformSet<TerraformBlock<AwsWafregionalIpsetIpSetDescriptorBlock>>? IpSetDescriptor { get; set; } = new();
