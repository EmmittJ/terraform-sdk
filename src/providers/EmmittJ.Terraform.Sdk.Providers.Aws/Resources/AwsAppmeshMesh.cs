...
/// Nesting mode: list
/// </summary>
public class AwsAppmeshMeshSpecBlock : ITerraformBlock
{
}
...
public class AwsAppmeshMesh : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsAppmeshMeshSpecBlock>>? Spec { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> MeshOwner => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "mesh_owner");
