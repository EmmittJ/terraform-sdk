...
/// Nesting mode: list
/// </summary>
public class AwsDevicefarmTestGridProjectVpcConfigBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDevicefarmTestGridProject : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsDevicefarmTestGridProjectVpcConfigBlock>>? VpcConfig { get; set; } = new();
