...
public partial class AwsAmplifyDomainAssociationCertificateSettingsBlock() : TerraformBlock("certificate_settings")
{
    ...
    public partial TerraformValue<string>? CustomCertificateArn { get; set; }
...
public partial class AwsAmplifyDomainAssociation : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnableAutoSubDomain { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CertificateVerificationDnsRecord { get; }
