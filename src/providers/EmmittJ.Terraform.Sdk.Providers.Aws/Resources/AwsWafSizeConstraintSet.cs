...
/// <summary>
/// Block type for size_constraints in AwsWafSizeConstraintSet.
/// Nesting mode: set
/// </summary>
public class AwsWafSizeConstraintSetSizeConstraintsBlock : TerraformBlock
{
    ...
    public required TerraformList<AwsWafSizeConstraintSetSizeConstraintsBlockFieldToMatchBlock> FieldToMatch
    {
        get => GetRequiredArgument<TerraformList<AwsWafSizeConstraintSetSizeConstraintsBlockFieldToMatchBlock>>("field_to_match");
...
/// <summary>
/// Block type for field_to_match in AwsWafSizeConstraintSetSizeConstraintsBlock.
/// Nesting mode: list
/// </summary>
public class AwsWafSizeConstraintSetSizeConstraintsBlockFieldToMatchBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_waf_size_constraint_set Terraform resource.
/// Manages a aws_waf_size_constraint_set resource.
/// </summary>
public partial class AwsWafSizeConstraintSet(string name) : TerraformResource("aws_waf_size_constraint_set", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    /// </summary>
    public TerraformSet<AwsWafSizeConstraintSetSizeConstraintsBlock>? SizeConstraints
    {
        get => GetArgument<TerraformSet<AwsWafSizeConstraintSetSizeConstraintsBlock>>("size_constraints");
