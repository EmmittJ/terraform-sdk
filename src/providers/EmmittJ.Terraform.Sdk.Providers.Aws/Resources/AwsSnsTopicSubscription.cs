...
public partial class AwsSnsTopicSubscription : TerraformResource
{
    ...
    public partial TerraformValue<double>? ConfirmationTimeoutInMinutes { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EndpointAutoConfirms { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FilterPolicy { get; set; }
    ...
    public partial TerraformValue<string> FilterPolicyScope { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? RawMessageDelivery { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ReplayPolicy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SubscriptionRoleArn { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> ConfirmationWasAuthenticated { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> PendingConfirmation { get; }
