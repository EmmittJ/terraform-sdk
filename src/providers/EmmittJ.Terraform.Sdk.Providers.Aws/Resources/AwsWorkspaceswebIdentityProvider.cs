...
public partial class AwsWorkspaceswebIdentityProvider : TerraformResource
{
    ...
    public required partial TerraformMap<string> IdentityProviderDetails { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> IdentityProviderType { get; set; }
    ...
    public partial TerraformValue<string> IdentityProviderArn { get; }
