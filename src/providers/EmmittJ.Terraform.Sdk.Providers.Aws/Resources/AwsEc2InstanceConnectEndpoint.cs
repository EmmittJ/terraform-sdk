...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2InstanceConnectEndpointTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsEc2InstanceConnectEndpoint : TerraformResource
{
    ...
    public partial TerraformValue<bool> PreserveClientIp { get; set; }
    ...
    public AwsEc2InstanceConnectEndpointTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FipsDnsName { get; }
