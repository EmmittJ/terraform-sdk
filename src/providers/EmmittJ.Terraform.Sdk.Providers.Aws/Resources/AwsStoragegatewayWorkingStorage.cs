...
/// <summary>
/// Represents a aws_storagegateway_working_storage Terraform resource.
/// Manages a aws_storagegateway_working_storage resource.
/// </summary>
public partial class AwsStoragegatewayWorkingStorage(string name) : TerraformResource("aws_storagegateway_working_storage", name)
{
    /// <summary>
