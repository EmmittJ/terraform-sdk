...
/// Nesting mode: list
/// </summary>
public class AwsGameliftAliasRoutingStrategyBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<string>>? FleetId { get; set; }
...
public class AwsGameliftAlias : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsGameliftAliasRoutingStrategyBlock>>? RoutingStrategy { get; set; } = new();
