...
public partial class AwsApprunnerCustomDomainAssociation : TerraformResource
{
    ...
    public partial TerraformValue<bool>? EnableWwwSubdomain { get; set; }
    ...
    public partial TerraformSet<object> CertificateValidationRecords { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DnsTarget { get; }
