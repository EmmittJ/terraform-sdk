...
/// Nesting mode: list
/// </summary>
public class AwsAppmeshRouteSpecBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsAppmeshRoute : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> MeshName { get; set; }
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> MeshOwner { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "mesh_owner");
    ...
    [TerraformPropertyName("virtual_router_name")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> VirtualRouterName { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsAppmeshRouteSpecBlock>>? Spec { get; set; } = new();
