...
/// Nesting mode: single
/// </summary>
public partial class AwsBackupLogicallyAirGappedVaultTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsBackupLogicallyAirGappedVault : TerraformResource
{
    ...
    public AwsBackupLogicallyAirGappedVaultTimeoutsBlock Timeouts { get; set; } = new();
