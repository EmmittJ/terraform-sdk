...
/// Nesting mode: single
/// </summary>
public partial class AwsBackupLogicallyAirGappedVaultTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsBackupLogicallyAirGappedVault : TerraformResource
{
    ...
    public required partial TerraformValue<double> MaxRetentionDays { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MinRetentionDays { get; set; }
    ...
    public partial TerraformBlock<AwsBackupLogicallyAirGappedVaultTimeoutsBlock>? Timeouts { get; set; }
