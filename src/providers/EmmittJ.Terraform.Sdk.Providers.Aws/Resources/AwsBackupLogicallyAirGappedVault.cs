...
public partial class AwsBackupLogicallyAirGappedVault : TerraformResource
{
    ...
    public required TerraformValue<double> MaxRetentionDays { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<double> MinRetentionDays { get; set; }
    ...
    public TerraformBlock<AwsBackupLogicallyAirGappedVaultTimeoutsBlock>? Timeouts { get; set; }
