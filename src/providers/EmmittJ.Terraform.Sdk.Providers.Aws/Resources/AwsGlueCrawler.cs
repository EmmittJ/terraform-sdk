...
public partial class AwsGlueCrawlerCatalogTargetBlock() : TerraformBlock("catalog_target")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DlqEventQueueArn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EventQueueArn { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public partial TerraformList<string>? Tables { get; set; }
...
public partial class AwsGlueCrawlerDeltaTargetBlock() : TerraformBlock("delta_target")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? CreateNativeDeltaTable { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformSet<string> DeltaTables { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<bool> WriteManifest { get; set; }
...
public partial class AwsGlueCrawlerDynamodbTargetBlock() : TerraformBlock("dynamodb_target")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ScanAll { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? ScanRate { get; set; }
...
public partial class AwsGlueCrawlerHudiTargetBlock() : TerraformBlock("hudi_target")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? Exclusions { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaximumTraversalDepth { get; set; }
...
public partial class AwsGlueCrawlerJdbcTargetBlock() : TerraformBlock("jdbc_target")
{
    ...
    [TerraformProperty("connection_name")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ConnectionName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? EnableAdditionalMetadata { get; set; }
...
public partial class AwsGlueCrawlerLakeFormationConfigurationBlock() : TerraformBlock("lake_formation_configuration")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? UseLakeFormationCredentials { get; set; }
...
public partial class AwsGlueCrawlerLineageConfigurationBlock() : TerraformBlock("lineage_configuration")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CrawlerLineageSettings { get; set; }
...
public partial class AwsGlueCrawlerRecrawlPolicyBlock() : TerraformBlock("recrawl_policy")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RecrawlBehavior { get; set; }
...
public partial class AwsGlueCrawlerSchemaChangePolicyBlock() : TerraformBlock("schema_change_policy")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DeleteBehavior { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? UpdateBehavior { get; set; }
...
public partial class AwsGlueCrawler : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? Classifiers { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TablePrefix { get; set; }
