...
/// <summary>
/// Block type for timeouts in AwsEipDomainName.
/// Nesting mode: single
/// </summary>
public class AwsEipDomainNameTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_eip_domain_name Terraform resource.
/// Manages a aws_eip_domain_name resource.
/// </summary>
public partial class AwsEipDomainName(string name) : TerraformResource("aws_eip_domain_name", name)
{
    /// <summary>
    ...
    /// </summary>
    public AwsEipDomainNameTimeoutsBlock? Timeouts
    {
        get => GetArgument<AwsEipDomainNameTimeoutsBlock>("timeouts");
