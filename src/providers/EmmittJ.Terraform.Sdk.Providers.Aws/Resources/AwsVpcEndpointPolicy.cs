...
/// <summary>
/// Block type for timeouts in AwsVpcEndpointPolicy.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_vpc_endpoint_policy Terraform resource.
/// Manages a aws_vpc_endpoint_policy resource.
/// </summary>
public partial class AwsVpcEndpointPolicy(string name) : TerraformResource("aws_vpc_endpoint_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AwsVpcEndpointPolicyTimeoutsBlock>("timeouts");
