...
public class AwsAppsyncDomainName : TerraformResource
{
    ...
    public TerraformProperty<TerraformProperty<string>> AppsyncDomainName => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "appsync_domain_name");
