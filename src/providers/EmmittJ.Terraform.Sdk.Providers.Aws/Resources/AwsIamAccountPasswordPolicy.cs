...
public partial class AwsIamAccountPasswordPolicy : TerraformResource
{
    ...
    public partial TerraformValue<bool>? AllowUsersToChangePassword { get; set; }
    ...
    public partial TerraformValue<bool> HardExpiry { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> MaxPasswordAge { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MinimumPasswordLength { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> PasswordReusePrevention { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> RequireLowercaseCharacters { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> RequireUppercaseCharacters { get; set; }
    ...
    public partial TerraformValue<bool> ExpirePasswords { get; }
