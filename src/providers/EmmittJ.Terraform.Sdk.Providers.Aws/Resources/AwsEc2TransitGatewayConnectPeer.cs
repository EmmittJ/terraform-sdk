...
public partial class AwsEc2TransitGatewayConnectPeer(string name) : TerraformResource("aws_ec2_transit_gateway_connect_peer", name)
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("bgp_asn") ?? CreateReference("bgp_asn");
    ...
    {
        get => GetRequiredArgument<TerraformSet<string>>("inside_cidr_blocks");
    ...
    {
        get => GetArgument<TerraformValue<string>>("transit_gateway_address") ?? CreateReference("transit_gateway_address");
