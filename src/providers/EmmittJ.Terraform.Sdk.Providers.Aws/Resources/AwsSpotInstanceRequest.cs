...
public class AwsSpotInstanceRequestNetworkInterfaceBlock : TerraformBlock
{
    ...
    public TerraformValue<double> NetworkCardIndex
        => CreateReference("network_card_index");
...
public partial class AwsSpotInstanceRequest(string name) : TerraformResource("aws_spot_instance_request", name)
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("launch_group");
    ...
    {
        get => GetArgument<TerraformValue<string>>("spot_type");
    ...
    {
        get => GetArgument<TerraformValue<string>>("valid_from") ?? CreateReference("valid_from");
    ...
    {
        get => GetArgument<TerraformValue<bool>>("wait_for_fulfillment");
    ...
    public TerraformList<TerraformMap<object>> PrimaryNetworkInterface
        => CreateReference("primary_network_interface");
