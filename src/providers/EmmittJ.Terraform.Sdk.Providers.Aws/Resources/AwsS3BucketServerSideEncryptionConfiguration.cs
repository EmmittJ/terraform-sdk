...
/// Nesting mode: set
/// </summary>
public class AwsS3BucketServerSideEncryptionConfigurationRuleBlock
{
    /// <summary>
...
public class AwsS3BucketServerSideEncryptionConfiguration : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsS3BucketServerSideEncryptionConfigurationRuleBlock>>? Rule { get; set; }
