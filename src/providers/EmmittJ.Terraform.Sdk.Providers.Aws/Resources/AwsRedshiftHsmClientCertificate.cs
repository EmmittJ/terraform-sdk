...
public class AwsRedshiftHsmClientCertificate : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> HsmClientCertificateIdentifier { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> HsmClientCertificatePublicKey => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "hsm_client_certificate_public_key");
