...
public partial class AwsVpcBlockPublicAccessOptions : TerraformResource
{
    ...
    public required TerraformValue<string> InternetGatewayBlockMode { get; set; }
    ...
    public TerraformBlock<AwsVpcBlockPublicAccessOptionsTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> AwsRegion { get; }
