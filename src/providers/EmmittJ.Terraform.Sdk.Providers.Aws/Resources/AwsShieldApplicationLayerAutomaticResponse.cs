...
/// Nesting mode: single
/// </summary>
public partial class AwsShieldApplicationLayerAutomaticResponseTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsShieldApplicationLayerAutomaticResponse : TerraformResource
{
    ...
    public AwsShieldApplicationLayerAutomaticResponseTimeoutsBlock Timeouts { get; set; } = new();
