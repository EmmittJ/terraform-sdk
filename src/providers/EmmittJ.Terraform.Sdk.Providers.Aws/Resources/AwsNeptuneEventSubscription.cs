...
/// Nesting mode: single
/// </summary>
public class AwsNeptuneEventSubscriptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsNeptuneEventSubscription : TerraformResource
{
    ...
    public TerraformBlock<AwsNeptuneEventSubscriptionTimeoutsBlock>? Timeouts { get; set; } = new();
