...
/// Nesting mode: list
/// </summary>
public class AwsMskconnectCustomPluginLocationBlock : ITerraformBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class AwsMskconnectCustomPluginTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsMskconnectCustomPlugin : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsMskconnectCustomPluginLocationBlock>>? Location { get; set; } = new();
    ...
    public TerraformBlock<AwsMskconnectCustomPluginTimeoutsBlock>? Timeouts { get; set; } = new();
