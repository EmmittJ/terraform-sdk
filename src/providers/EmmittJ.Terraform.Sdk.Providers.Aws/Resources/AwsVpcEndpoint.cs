...
public partial class AwsVpcEndpointDnsOptionsBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string> DnsRecordIpType { get; set; }
    ...
    public partial TerraformValue<bool>? PrivateDnsOnlyForInboundResolverEndpoint { get; set; }
...
public partial class AwsVpcEndpointSubnetConfigurationBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Ipv4 { get; set; }
...
public partial class AwsVpcEndpoint : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> PrivateDnsEnabled { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ResourceConfigurationArn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ServiceNetworkArn { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ServiceRegion { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? VpcEndpointType { get; set; }
