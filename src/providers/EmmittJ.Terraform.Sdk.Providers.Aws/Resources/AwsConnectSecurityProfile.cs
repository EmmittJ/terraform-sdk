...
public class AwsConnectSecurityProfile : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> SecurityProfileId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "security_profile_id");
