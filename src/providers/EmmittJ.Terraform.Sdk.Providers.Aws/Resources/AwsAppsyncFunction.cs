...
public partial class AwsAppsyncFunction : TerraformResource
{
    ...
    public partial TerraformValue<string> FunctionVersion { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RequestMappingTemplate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ResponseMappingTemplate { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FunctionId { get; }
