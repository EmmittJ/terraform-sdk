...
public partial class AwsFsxOntapStorageVirtualMachineActiveDirectoryConfigurationBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? NetbiosName { get; set; }
...
public partial class AwsFsxOntapStorageVirtualMachine : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RootVolumeSecurityStyle { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SvmAdminPassword { get; set; }
