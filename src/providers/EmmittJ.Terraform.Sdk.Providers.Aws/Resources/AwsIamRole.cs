...
public partial class AwsIamRole : TerraformResource
{
    ...
    public required partial TerraformValue<string> AssumeRolePolicy { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? ForceDetachPolicies { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? MaxSessionDuration { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? PermissionsBoundary { get; set; }
