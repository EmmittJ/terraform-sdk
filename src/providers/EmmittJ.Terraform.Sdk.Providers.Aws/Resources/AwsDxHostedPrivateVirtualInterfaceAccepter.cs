...
/// Nesting mode: single
/// </summary>
public class AwsDxHostedPrivateVirtualInterfaceAccepterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDxHostedPrivateVirtualInterfaceAccepter : TerraformResource
{
    ...
    public TerraformBlock<AwsDxHostedPrivateVirtualInterfaceAccepterTimeoutsBlock>? Timeouts { get; set; } = new();
