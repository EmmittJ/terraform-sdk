...
/// <summary>
/// Block type for timeouts in AwsDxHostedPrivateVirtualInterfaceAccepter.
/// Nesting mode: single
/// </summary>
public class AwsDxHostedPrivateVirtualInterfaceAccepterTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_dx_hosted_private_virtual_interface_accepter Terraform resource.
/// Manages a aws_dx_hosted_private_virtual_interface_accepter resource.
/// </summary>
public partial class AwsDxHostedPrivateVirtualInterfaceAccepter(string name) : TerraformResource("aws_dx_hosted_private_virtual_interface_accepter", name)
{
    /// <summary>
    ...
    /// </summary>
    public AwsDxHostedPrivateVirtualInterfaceAccepterTimeoutsBlock? Timeouts
    {
        get => GetArgument<AwsDxHostedPrivateVirtualInterfaceAccepterTimeoutsBlock>("timeouts");
