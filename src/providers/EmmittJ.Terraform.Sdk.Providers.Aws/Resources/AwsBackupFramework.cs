...
/// Nesting mode: set
/// </summary>
public class AwsBackupFrameworkControlBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsBackupFrameworkTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsBackupFramework : TerraformResource
{
    ...
    [TerraformPropertyName("control")]
    public TerraformSet<TerraformBlock<AwsBackupFrameworkControlBlock>>? Control { get; set; } = new();
    ...
    public TerraformBlock<AwsBackupFrameworkTimeoutsBlock>? Timeouts { get; set; } = new();
