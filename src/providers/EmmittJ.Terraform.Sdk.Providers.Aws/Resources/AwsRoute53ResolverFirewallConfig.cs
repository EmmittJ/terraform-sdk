...
public class AwsRoute53ResolverFirewallConfig : TerraformResource
{
    ...
    public TerraformProperty<TerraformProperty<string>> FirewallFailOpen { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "firewall_fail_open");
