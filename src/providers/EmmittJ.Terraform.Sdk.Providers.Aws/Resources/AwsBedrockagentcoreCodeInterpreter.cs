...
/// Nesting mode: list
/// </summary>
public partial class AwsBedrockagentcoreCodeInterpreterNetworkConfigurationBlock() : TerraformBlock("network_configuration")
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentcoreCodeInterpreterTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsBedrockagentcoreCodeInterpreter : TerraformResource
{
    ...
    public TerraformList<AwsBedrockagentcoreCodeInterpreterNetworkConfigurationBlock> NetworkConfiguration { get; set; } = new();
    ...
    public AwsBedrockagentcoreCodeInterpreterTimeoutsBlock Timeouts { get; set; } = new();
