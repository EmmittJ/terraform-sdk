...
/// <summary>
/// Block type for timeouts in AwsDocdbGlobalCluster.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_docdb_global_cluster Terraform resource.
/// Manages a aws_docdb_global_cluster resource.
/// </summary>
public partial class AwsDocdbGlobalCluster(string name) : TerraformResource("aws_docdb_global_cluster", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsDocdbGlobalClusterTimeoutsBlock>("timeouts");
