...
public partial class AwsNeptuneCluster : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? EnableCloudwatchLogsExports { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> NeptuneClusterParameterGroupName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? NeptuneInstanceParameterGroupName { get; set; }
