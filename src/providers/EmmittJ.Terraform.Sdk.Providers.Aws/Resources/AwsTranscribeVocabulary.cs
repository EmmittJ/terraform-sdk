...
/// Nesting mode: single
/// </summary>
public class AwsTranscribeVocabularyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsTranscribeVocabulary : TerraformResource
{
    ...
    // Optional argument - user may or may not set a value
    public TerraformProperty<List<TerraformProperty<string>>>? Phrases { get; set; }
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> VocabularyFileUri { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "vocabulary_file_uri");
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> VocabularyName { get; set; }
    ...
    public TerraformBlock<AwsTranscribeVocabularyTimeoutsBlock>? Timeouts { get; set; } = new();
