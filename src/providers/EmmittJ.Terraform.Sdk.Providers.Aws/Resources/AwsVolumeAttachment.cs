...
/// Nesting mode: single
/// </summary>
public class AwsVolumeAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVolumeAttachment : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("force_detach")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? ForceDetach { get; set; }
    ...
    /// </summary>
    [TerraformPropertyName("stop_instance_before_detaching")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<bool>>? StopInstanceBeforeDetaching { get; set; }
    ...
    public TerraformBlock<AwsVolumeAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
