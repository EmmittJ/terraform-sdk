...
public partial class AwsBedrockagentcoreApiKeyCredentialProvider : TerraformResource
{
    ...
    public partial TerraformValue<string>? ApiKey { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ApiKeyWo { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? ApiKeyWoVersion { get; set; }
    ...
    public partial TerraformList<object> ApiKeySecretArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CredentialProviderArn { get; }
