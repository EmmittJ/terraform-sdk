...
/// Nesting mode: set
/// </summary>
public class AwsElasticacheParameterGroupParameterBlock : ITerraformBlock
{
    /// <summary>
    /// The name attribute.
    /// </summary>
...
public class AwsElasticacheParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsElasticacheParameterGroupParameterBlock>>? Parameter { get; set; } = new();
