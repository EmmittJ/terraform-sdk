...
/// </summary>
public partial class AwsElasticacheParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsElasticacheParameterGroupParameterBlock>>? Parameter { get; set; }
