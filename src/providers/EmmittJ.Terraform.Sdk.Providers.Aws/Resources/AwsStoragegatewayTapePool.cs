...
public partial class AwsStoragegatewayTapePool : TerraformResource
{
    ...
    public partial TerraformValue<double>? RetentionLockTimeInDays { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RetentionLockType { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StorageClass { get; set; }
