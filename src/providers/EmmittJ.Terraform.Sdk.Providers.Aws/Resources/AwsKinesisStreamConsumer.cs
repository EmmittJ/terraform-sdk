...
/// <summary>
/// Represents a aws_kinesis_stream_consumer Terraform resource.
/// Manages a aws_kinesis_stream_consumer resource.
/// </summary>
public partial class AwsKinesisStreamConsumer(string name) : TerraformResource("aws_kinesis_stream_consumer", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
