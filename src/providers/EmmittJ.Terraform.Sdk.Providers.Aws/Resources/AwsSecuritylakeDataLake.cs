...
/// Nesting mode: list
/// </summary>
public class AwsSecuritylakeDataLakeConfigurationBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<List<TerraformProperty<object>>> EncryptionConfiguration { get; set; } = new TerraformReferenceProperty<List<TerraformProperty<object>>>("", "encryption_configuration");
...
/// Nesting mode: single
/// </summary>
public class AwsSecuritylakeDataLakeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsSecuritylakeDataLake : TerraformResource
{
    ...
    [TerraformPropertyName("meta_store_manager_role_arn")]
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> MetaStoreManagerRoleArn { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsSecuritylakeDataLakeConfigurationBlock>>? Configuration { get; set; } = new();
    ...
    public TerraformBlock<AwsSecuritylakeDataLakeTimeoutsBlock>? Timeouts { get; set; } = new();
