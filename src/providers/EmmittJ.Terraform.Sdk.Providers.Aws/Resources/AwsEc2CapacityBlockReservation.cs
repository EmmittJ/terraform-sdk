...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2CapacityBlockReservationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsEc2CapacityBlockReservation : TerraformResource
{
    ...
    public AwsEc2CapacityBlockReservationTimeoutsBlock Timeouts { get; set; } = new();
