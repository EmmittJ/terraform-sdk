...
public partial class AwsAutoscalingPolicyPredictiveScalingConfigurationBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MaxCapacityBuffer { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SchedulingBufferTime { get; set; }
...
public partial class AwsAutoscalingPolicyStepAdjustmentBlock : TerraformBlockBase
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MetricIntervalLowerBound { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MetricIntervalUpperBound { get; set; }
    ...
    public required partial TerraformValue<double> ScalingAdjustment { get; set; }
...
public partial class AwsAutoscalingPolicy : TerraformResource
{
    ...
    [TerraformProperty("scaling_adjustment")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? ScalingAdjustment { get; set; }
