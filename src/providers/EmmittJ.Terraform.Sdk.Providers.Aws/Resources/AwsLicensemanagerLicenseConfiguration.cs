...
public partial class AwsLicensemanagerLicenseConfiguration : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? LicenseCount { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? LicenseCountHardLimit { get; set; }
    ...
    public required partial TerraformValue<string> LicenseCountingType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? LicenseRules { get; set; }
