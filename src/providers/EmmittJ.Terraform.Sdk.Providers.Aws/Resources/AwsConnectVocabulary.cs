...
/// Nesting mode: single
/// </summary>
public class AwsConnectVocabularyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsConnectVocabulary : TerraformResource
{
    ...
    public TerraformBlock<AwsConnectVocabularyTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> VocabularyId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "vocabulary_id");
