...
/// Nesting mode: single
/// </summary>
public class AwsCloudcontrolapiResourceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsCloudcontrolapiResource : TerraformResource
{
    ...
    public TerraformBlock<AwsCloudcontrolapiResourceTimeoutsBlock>? Timeouts { get; set; } = new();
