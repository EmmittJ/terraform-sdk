...
/// Nesting mode: single
/// </summary>
public class AwsLexv2modelsBotVersionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsLexv2modelsBotVersion : TerraformResource
{
    ...
    public TerraformProperty<TerraformProperty<string>> BotVersion { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "bot_version");
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public TerraformProperty<Dictionary<string, TerraformProperty<object>>>? LocaleSpecification { get; set; }
    ...
    public TerraformBlock<AwsLexv2modelsBotVersionTimeoutsBlock>? Timeouts { get; set; } = new();
