...
/// Nesting mode: single
/// </summary>
public partial class AwsLexv2modelsBotVersionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsLexv2modelsBotVersion : TerraformResource
{
    ...
    public partial TerraformValue<string> BotVersion { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformMap<object> LocaleSpecification { get; set; }
    ...
    public AwsLexv2modelsBotVersionTimeoutsBlock Timeouts { get; set; } = new();
