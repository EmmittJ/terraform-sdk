...
/// Nesting mode: single
/// </summary>
public partial class AwsChatbotTeamsChannelConfigurationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsChatbotTeamsChannelConfiguration : TerraformResource
{
    ...
    public required partial TerraformValue<string> ChannelId { get; set; }
    ...
    public partial TerraformValue<string> ChannelName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> TeamName { get; set; }
    ...
    public AwsChatbotTeamsChannelConfigurationTimeoutsBlock Timeouts { get; set; } = new();
