...
/// Nesting mode: single
/// </summary>
public partial class AwsDatazoneProjectTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsDatazoneProject : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformList<object> FailureReasons { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ProjectStatus { get; }
