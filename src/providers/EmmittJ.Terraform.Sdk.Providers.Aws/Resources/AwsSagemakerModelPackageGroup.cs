...
public class AwsSagemakerModelPackageGroup : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        SetOutput("arn");
        SetOutput("id");
        SetOutput("model_package_group_description");
    ...
    /// </summary>
    public TerraformProperty<string> ModelPackageGroupDescription
    {
        get => GetRequiredOutput<TerraformProperty<string>>("model_package_group_description");
        set => SetProperty("model_package_group_description", value);
    }
