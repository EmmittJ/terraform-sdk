...
/// </summary>
public partial class AwsWorkspaceswebBrowserSettingsAssociation : TerraformResource
{
    ...
    public required partial TerraformValue<string> BrowserSettingsArn { get; set; }
