...
/// <summary>
/// Manages a aws_workspacesweb_browser_settings_association resource.
/// </summary>
public class AwsWorkspaceswebBrowserSettingsAssociation : TerraformResource
{
    public AwsWorkspaceswebBrowserSettingsAssociation(string name) : base("aws_workspacesweb_browser_settings_association", name)
    {
    }
    ...
    public required TerraformProperty<TerraformProperty<string>> BrowserSettingsArn { get; set; }
