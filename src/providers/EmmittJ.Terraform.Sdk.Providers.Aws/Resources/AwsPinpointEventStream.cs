...
/// </summary>
public partial class AwsPinpointEventStream : TerraformResource
{
    ...
    [TerraformProperty("destination_stream_arn")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DestinationStreamArn { get; set; }
