...
/// <summary>
/// Represents a aws_networkfirewall_resource_policy Terraform resource.
/// Manages a aws_networkfirewall_resource_policy resource.
/// </summary>
public partial class AwsNetworkfirewallResourcePolicy(string name) : TerraformResource("aws_networkfirewall_resource_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
