...
/// Nesting mode: list
/// </summary>
public class AwsEmrcontainersVirtualClusterContainerProviderBlock : ITerraformBlock
{
    /// <summary>
    /// The id attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEmrcontainersVirtualClusterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsEmrcontainersVirtualCluster : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsEmrcontainersVirtualClusterContainerProviderBlock>>? ContainerProvider { get; set; } = new();
    ...
    public TerraformBlock<AwsEmrcontainersVirtualClusterTimeoutsBlock>? Timeouts { get; set; } = new();
