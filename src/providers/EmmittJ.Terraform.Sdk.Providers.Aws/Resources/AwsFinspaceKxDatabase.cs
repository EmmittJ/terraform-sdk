...
/// </summary>
public class AwsFinspaceKxDatabase : TerraformResource
{
    public AwsFinspaceKxDatabase(string name) : base("aws_finspace_kx_database", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AwsFinspaceKxDatabaseTimeoutsBlock>("timeouts");
