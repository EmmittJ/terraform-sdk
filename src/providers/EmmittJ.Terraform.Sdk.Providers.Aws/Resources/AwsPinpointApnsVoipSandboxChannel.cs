...
/// <summary>
/// Represents a aws_pinpoint_apns_voip_sandbox_channel Terraform resource.
/// Manages a aws_pinpoint_apns_voip_sandbox_channel resource.
/// </summary>
public partial class AwsPinpointApnsVoipSandboxChannel(string name) : TerraformResource("aws_pinpoint_apns_voip_sandbox_channel", name)
{
    /// <summary>
