...
/// Nesting mode: single
/// </summary>
public class AwsApiGatewayRestApiPutTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsApiGatewayRestApiPut : TerraformResource
{
    ...
    public TerraformProperty<TerraformProperty<bool>> FailOnWarnings { get; set; } = new TerraformReferenceProperty<TerraformProperty<bool>>(ResourceAddress, "fail_on_warnings");
    ...
    public TerraformBlock<AwsApiGatewayRestApiPutTimeoutsBlock>? Timeouts { get; set; } = new();
