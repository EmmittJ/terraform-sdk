...
/// Nesting mode: single
/// </summary>
public class AwsComputeoptimizerEnrollmentStatusTimeoutsBlock
{
    /// <summary>
...
public class AwsComputeoptimizerEnrollmentStatus : TerraformResource
{
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<double> NumberOfMemberAccountsOptedIn => new TerraformReference(this, "number_of_member_accounts_opted_in");
