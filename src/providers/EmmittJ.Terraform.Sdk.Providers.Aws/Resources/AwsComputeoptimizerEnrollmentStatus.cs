...
/// Nesting mode: single
/// </summary>
public partial class AwsComputeoptimizerEnrollmentStatusTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsComputeoptimizerEnrollmentStatus : TerraformResource
{
    ...
    public TerraformBlock<AwsComputeoptimizerEnrollmentStatusTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<double> NumberOfMemberAccountsOptedIn { get; }
