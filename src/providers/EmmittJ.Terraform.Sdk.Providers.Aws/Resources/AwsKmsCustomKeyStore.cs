...
public partial class AwsKmsCustomKeyStoreXksProxyAuthenticationCredentialBlock() : TerraformBlock("xks_proxy_authentication_credential")
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RawSecretAccessKey { get; set; }
...
public partial class AwsKmsCustomKeyStore : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CloudHsmClusterId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> CustomKeyStoreName { get; set; }
    ...
    public partial TerraformValue<string> CustomKeyStoreType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? KeyStorePassword { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TrustAnchorCertificate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? XksProxyConnectivity { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? XksProxyUriEndpoint { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? XksProxyUriPath { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? XksProxyVpcEndpointServiceName { get; set; }
