...
/// Nesting mode: single
/// </summary>
public class AwsKmsCustomKeyStoreTimeoutsBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsKmsCustomKeyStoreXksProxyAuthenticationCredentialBlock
{
    /// <summary>
...
public class AwsKmsCustomKeyStore : TerraformResource
{
    ...
    public TerraformValue<string> CustomKeyStoreType { get; set; } = default!;
