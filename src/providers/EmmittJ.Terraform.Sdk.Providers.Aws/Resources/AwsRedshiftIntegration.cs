...
/// <summary>
/// Block type for timeouts in AwsRedshiftIntegration.
/// Nesting mode: single
/// </summary>
public class AwsRedshiftIntegrationTimeoutsBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_redshift_integration Terraform resource.
/// Manages a aws_redshift_integration resource.
/// </summary>
public partial class AwsRedshiftIntegration(string name) : TerraformResource("aws_redshift_integration", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsRedshiftIntegrationTimeoutsBlock>("timeouts");
