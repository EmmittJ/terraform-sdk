...
/// Nesting mode: list
/// </summary>
public partial class AwsVpcRouteServerPeerBgpOptionsBlock() : TerraformBlock("bgp_options")
{
    /// <summary>
    ...
    public partial TerraformValue<string> PeerLivenessDetection { get; set; }
...
/// Nesting mode: single
/// </summary>
public partial class AwsVpcRouteServerPeerTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsVpcRouteServerPeer : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RouteServerEndpointId { get; set; }
    ...
    public TerraformList<AwsVpcRouteServerPeerBgpOptionsBlock> BgpOptions { get; set; } = new();
    ...
    public AwsVpcRouteServerPeerTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EndpointEniAddress { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> EndpointEniId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> RouteServerPeerId { get; }
