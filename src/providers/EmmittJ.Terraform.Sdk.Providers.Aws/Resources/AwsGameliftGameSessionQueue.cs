...
public partial class AwsGameliftGameSessionQueuePlayerLatencyPolicyBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<double> MaximumIndividualPlayerLatencyMilliseconds { get; set; }
    ...
    public partial TerraformValue<double>? PolicyDurationSeconds { get; set; }
...
public partial class AwsGameliftGameSessionQueue : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CustomEventData { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? NotificationTarget { get; set; }
