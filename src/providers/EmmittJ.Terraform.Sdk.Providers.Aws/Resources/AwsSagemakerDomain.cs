...
public partial class AwsSagemakerDomainDefaultSpaceSettingsBlock() : TerraformBlock("default_space_settings")
{
    ...
    public required partial TerraformValue<string> ExecutionRole { get; set; }
...
public partial class AwsSagemakerDomainDefaultUserSettingsBlock() : TerraformBlock("default_user_settings")
{
    ...
    public partial TerraformValue<string> AutoMountHomeEfs { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> DefaultLandingUri { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> StudioWebPortal { get; set; }
...
public partial class AwsSagemakerDomainDomainSettingsBlock() : TerraformBlock("domain_settings")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ExecutionRoleIdentityConfig { get; set; }
...
public partial class AwsSagemakerDomainRetentionPolicyBlock() : TerraformBlock("retention_policy")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? HomeEfsFileSystem { get; set; }
...
public partial class AwsSagemakerDomain : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? AppNetworkAccessType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? AppSecurityGroupManagement { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TagPropagation { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> HomeEfsFileSystemId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SecurityGroupIdForDomainBoundary { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SingleSignOnApplicationArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SingleSignOnManagedApplicationInstanceId { get; }
