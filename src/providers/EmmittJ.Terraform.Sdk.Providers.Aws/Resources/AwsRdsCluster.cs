...
public partial class AwsRdsClusterRestoreToPointInTimeBlock() : TerraformBlock("restore_to_point_in_time")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourceClusterIdentifier { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourceClusterResourceId { get; set; }
...
public partial class AwsRdsClusterScalingConfigurationBlock() : TerraformBlock("scaling_configuration")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? AutoPause { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? SecondsBeforeTimeout { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? SecondsUntilAutoPause { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TimeoutAction { get; set; }
...
public partial class AwsRdsCluster : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? BacktrackWindow { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> CaCertificateIdentifier { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ClusterScalabilityType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DbClusterInstanceClass { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DbInstanceParameterGroupName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> DbSystemId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnableGlobalWriteForwarding { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnableHttpEndpoint { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? EnableLocalWriteForwarding { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EngineMode { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ReplicationSourceIdentifier { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourceRegion { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> CaCertificateValidTill { get; }
