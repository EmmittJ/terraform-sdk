...
/// Nesting mode: single
/// </summary>
public class AwsNatGatewayEipAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsNatGatewayEipAssociation : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> AllocationId { get; set; }
    ...
    public TerraformBlock<AwsNatGatewayEipAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
