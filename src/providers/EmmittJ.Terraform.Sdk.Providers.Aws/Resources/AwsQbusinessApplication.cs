...
public partial class AwsQbusinessApplicationAttachmentsConfigurationBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<string> AttachmentsControlMode { get; set; }
...
public partial class AwsQbusinessApplication : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> IamServiceRoleArn { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> IdentityCenterInstanceArn { get; set; }
