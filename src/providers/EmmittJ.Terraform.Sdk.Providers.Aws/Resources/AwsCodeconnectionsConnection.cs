...
/// Nesting mode: single
/// </summary>
public partial class AwsCodeconnectionsConnectionTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsCodeconnectionsConnection : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? HostArn { get; set; }
    ...
    public TerraformValue<string> ProviderType { get; set; }
    ...
    public TerraformBlock<AwsCodeconnectionsConnectionTimeoutsBlock>? Timeouts { get; set; }
