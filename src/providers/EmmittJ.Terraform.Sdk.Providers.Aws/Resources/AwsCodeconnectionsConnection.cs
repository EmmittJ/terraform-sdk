...
/// Nesting mode: single
/// </summary>
public partial class AwsCodeconnectionsConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsCodeconnectionsConnection : TerraformResource
{
    ...
    public AwsCodeconnectionsConnectionTimeoutsBlock Timeouts { get; set; } = new();
