...
/// Nesting mode: list
/// </summary>
public partial class AwsAppfabricAppAuthorizationConnectionAuthRequestBlock() : TerraformBlock("auth_request")
{
    /// <summary>
    /// The code attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public partial class AwsAppfabricAppAuthorizationConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsAppfabricAppAuthorizationConnection : TerraformResource
{
    ...
    public TerraformList<AwsAppfabricAppAuthorizationConnectionAuthRequestBlock> AuthRequest { get; set; } = new();
    ...
    public AwsAppfabricAppAuthorizationConnectionTimeoutsBlock Timeouts { get; set; } = new();
