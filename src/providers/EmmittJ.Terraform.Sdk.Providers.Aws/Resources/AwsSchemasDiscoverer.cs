...
/// <summary>
/// Represents a aws_schemas_discoverer Terraform resource.
/// Manages a aws_schemas_discoverer resource.
/// </summary>
public partial class AwsSchemasDiscoverer(string name) : TerraformResource("aws_schemas_discoverer", name)
{
    /// <summary>
