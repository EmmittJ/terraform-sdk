...
/// Nesting mode: single
/// </summary>
public class AwsVpclatticeServiceNetworkServiceAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsVpclatticeServiceNetworkServiceAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsVpclatticeServiceNetworkServiceAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
