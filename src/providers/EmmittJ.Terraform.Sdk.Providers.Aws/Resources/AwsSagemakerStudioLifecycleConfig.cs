...
public partial class AwsSagemakerStudioLifecycleConfig : TerraformResource
{
    ...
    public required partial TerraformValue<string> StudioLifecycleConfigAppType { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StudioLifecycleConfigContent { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StudioLifecycleConfigName { get; set; }
