...
public class AwsSagemakerStudioLifecycleConfig : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("id");
        SetOutput("region");
        SetOutput("studio_lifecycle_config_app_type");
        SetOutput("studio_lifecycle_config_content");
        SetOutput("studio_lifecycle_config_name");
        SetOutput("tags");
        SetOutput("tags_all");
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("studio_lifecycle_config_app_type");
        set => SetProperty("studio_lifecycle_config_app_type", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("studio_lifecycle_config_content");
        set => SetProperty("studio_lifecycle_config_content", value);
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("studio_lifecycle_config_name");
        set => SetProperty("studio_lifecycle_config_name", value);
    }
