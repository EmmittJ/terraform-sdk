...
/// Nesting mode: single
/// </summary>
public class AwsDxHostedPrivateVirtualInterfaceTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDxHostedPrivateVirtualInterface : TerraformResource
{
    ...
    public TerraformBlock<AwsDxHostedPrivateVirtualInterfaceTimeoutsBlock>? Timeouts { get; set; } = new();
