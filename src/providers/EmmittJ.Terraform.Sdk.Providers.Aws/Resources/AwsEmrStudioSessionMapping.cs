...
public partial class AwsEmrStudioSessionMapping(string name) : TerraformResource("aws_emr_studio_session_mapping", name)
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("identity_id") ?? CreateReference("identity_id");
    ...
    {
        get => GetArgument<TerraformValue<string>>("identity_name") ?? CreateReference("identity_name");
