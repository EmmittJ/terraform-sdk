...
public class AwsDynamodbResourcePolicy : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("confirm_remove_self_resource_access");
        SetOutput("policy");
        SetOutput("region");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<bool>>("confirm_remove_self_resource_access");
        set => SetProperty("confirm_remove_self_resource_access", value);
    }
