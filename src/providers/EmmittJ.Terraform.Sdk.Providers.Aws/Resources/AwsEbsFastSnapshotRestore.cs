...
/// Nesting mode: single
/// </summary>
public class AwsEbsFastSnapshotRestoreTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsEbsFastSnapshotRestore : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> SnapshotId { get; set; }
    ...
    public TerraformBlock<AwsEbsFastSnapshotRestoreTimeoutsBlock>? Timeouts { get; set; } = new();
