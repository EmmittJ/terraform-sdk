...
public class AwsRamResourceShare : TerraformResource
{
    ...
    {
        SetOutput("arn");
        SetOutput("allow_external_principals");
        SetOutput("id");
        SetOutput("name");
        SetOutput("permission_arns");
        SetOutput("region");
        SetOutput("tags");
        SetOutput("tags_all");
    }
    ...
    {
        get => GetRequiredOutput<TerraformProperty<bool>>("allow_external_principals");
        set => SetProperty("allow_external_principals", value);
    }
    ...
    {
        get => GetRequiredOutput<HashSet<TerraformProperty<string>>>("permission_arns");
        set => SetProperty("permission_arns", value);
    }
