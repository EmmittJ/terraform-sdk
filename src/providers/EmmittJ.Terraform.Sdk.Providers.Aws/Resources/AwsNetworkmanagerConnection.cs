...
/// Nesting mode: single
/// </summary>
public partial class AwsNetworkmanagerConnectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsNetworkmanagerConnection : TerraformResource
{
    ...
    public AwsNetworkmanagerConnectionTimeoutsBlock Timeouts { get; set; } = new();
