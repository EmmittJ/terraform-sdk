...
public partial class AwsMemorydbMultiRegionCluster : TerraformResource
{
    ...
    public required partial TerraformValue<string> MultiRegionClusterNameSuffix { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> MultiRegionParameterGroupName { get; set; }
    ...
    public partial TerraformBlock<AwsMemorydbMultiRegionClusterTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MultiRegionClusterName { get; }
