...
public partial class AwsEmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeBlock : TerraformBlockBase
{
    ...
    public required partial TerraformValue<double> MaxRange { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MinRange { get; set; }
...
public partial class AwsEmrBlockPublicAccessConfiguration : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<bool> BlockPublicSecurityGroupRules { get; set; }
