...
/// Nesting mode: single
/// </summary>
public class AwsEc2DefaultCreditSpecificationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsEc2DefaultCreditSpecification : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> CpuCredits { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> InstanceFamily { get; set; }
    ...
    public TerraformBlock<AwsEc2DefaultCreditSpecificationTimeoutsBlock>? Timeouts { get; set; } = new();
