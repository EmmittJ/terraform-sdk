...
/// Nesting mode: set
/// </summary>
public class AwsDbParameterGroupParameterBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class AwsDbParameterGroup : TerraformResource
{
    public AwsDbParameterGroup(string name) : base("aws_db_parameter_group", name)
    {
    }
    ...
    public TerraformSet<TerraformBlock<AwsDbParameterGroupParameterBlock>>? Parameter { get; set; } = new();
