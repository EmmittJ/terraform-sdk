...
/// Nesting mode: single
/// </summary>
public partial class AwsAppsyncSourceApiAssociationTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsAppsyncSourceApiAssociation : TerraformResource
{
    ...
    public TerraformValue<string> MergedApiArn { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> MergedApiId { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> SourceApiArn { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<object> SourceApiAssociationConfig { get; set; }
    ...
    public TerraformBlock<AwsAppsyncSourceApiAssociationTimeoutsBlock>? Timeouts { get; set; }
