...
public partial class AwsVpcEndpointConnectionNotification : TerraformResource
{
    ...
    public required partial TerraformSet<string> ConnectionEvents { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ConnectionNotificationArn { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? VpcEndpointServiceId { get; set; }
    ...
    public partial TerraformValue<string> NotificationType { get; }
