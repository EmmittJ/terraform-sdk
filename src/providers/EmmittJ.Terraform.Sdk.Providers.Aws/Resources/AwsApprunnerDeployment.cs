...
/// Nesting mode: single
/// </summary>
public class AwsApprunnerDeploymentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsApprunnerDeployment : TerraformResource
{
    ...
    public TerraformBlock<AwsApprunnerDeploymentTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> OperationId => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "operation_id");
