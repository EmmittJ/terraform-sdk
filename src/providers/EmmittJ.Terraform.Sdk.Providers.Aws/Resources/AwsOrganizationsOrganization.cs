...
public partial class AwsOrganizationsOrganization : TerraformResource
{
    ...
    public partial TerraformSet<string>? AwsServiceAccessPrincipals { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? EnabledPolicyTypes { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FeatureSet { get; set; }
