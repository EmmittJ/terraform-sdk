...
/// Nesting mode: list
/// </summary>
public class AwsDatasyncLocationFsxOpenzfsFileSystemProtocolBlock : ITerraformBlock
{
}
...
public class AwsDatasyncLocationFsxOpenzfsFileSystem : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> FsxFilesystemArn { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsDatasyncLocationFsxOpenzfsFileSystemProtocolBlock>>? Protocol { get; set; } = new();
