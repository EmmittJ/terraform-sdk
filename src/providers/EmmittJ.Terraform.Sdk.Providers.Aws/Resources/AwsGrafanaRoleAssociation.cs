...
/// Nesting mode: single
/// </summary>
public partial class AwsGrafanaRoleAssociationTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsGrafanaRoleAssociation : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? GroupIds { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? UserIds { get; set; }
    ...
    public partial TerraformBlock<AwsGrafanaRoleAssociationTimeoutsBlock>? Timeouts { get; set; }
