...
public partial class AwsCodebuildFleetComputeConfigurationBlock() : TerraformBlock("compute_configuration")
{
    ...
    public partial TerraformValue<double> Disk { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<double> Vcpu { get; set; }
...
public partial class AwsCodebuildFleetScalingConfigurationBlock() : TerraformBlock("scaling_configuration")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ScalingType { get; set; }
...
public partial class AwsCodebuildFleet : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> BaseCapacity { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> EnvironmentType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? FleetServiceRole { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> OverflowBehavior { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> Status { get; }
