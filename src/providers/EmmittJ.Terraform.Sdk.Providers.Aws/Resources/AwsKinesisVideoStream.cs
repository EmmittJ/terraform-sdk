...
/// </summary>
public partial class AwsKinesisVideoStream : TerraformResource
{
    ...
    /// </summary>
    [TerraformProperty("data_retention_in_hours")]
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? DataRetentionInHours { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MediaType { get; set; }
