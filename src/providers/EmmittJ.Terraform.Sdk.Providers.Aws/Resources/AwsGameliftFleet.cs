...
public partial class AwsGameliftFleet(string name) : TerraformResource("aws_gamelift_fleet", name)
{
    ...
    {
        get => GetArgument<TerraformList<string>>("metric_groups") ?? CreateReference("metric_groups");
