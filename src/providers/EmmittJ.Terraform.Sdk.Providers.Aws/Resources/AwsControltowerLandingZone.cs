...
public partial class AwsControltowerLandingZone : TerraformResource
{
    ...
    public required partial TerraformValue<string> ManifestJson { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> DriftStatus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LatestAvailableVersion { get; }
