...
public partial class AwsCodepipelineCustomActionTypeConfigurationPropertyBlock() : TerraformBlock("configuration_property")
{
    ...
    public required partial TerraformValue<bool> Key { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? Queryable { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<bool> Secret { get; set; }
...
public partial class AwsCodepipelineCustomActionTypeInputArtifactDetailsBlock() : TerraformBlock("input_artifact_details")
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MaximumCount { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> MinimumCount { get; set; }
...
public partial class AwsCodepipelineCustomActionTypeSettingsBlock() : TerraformBlock("settings")
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? EntityUrlTemplate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ExecutionUrlTemplate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? RevisionUrlTemplate { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ThirdPartyConfigurationUrl { get; set; }
