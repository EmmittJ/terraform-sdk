...
/// <summary>
/// Block type for timeouts in AwsDxHostedPublicVirtualInterface.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_dx_hosted_public_virtual_interface Terraform resource.
/// Manages a aws_dx_hosted_public_virtual_interface resource.
/// </summary>
public partial class AwsDxHostedPublicVirtualInterface(string name) : TerraformResource("aws_dx_hosted_public_virtual_interface", name)
{
    /// <summary>
    ...
    {
        get => GetRequiredArgument<TerraformSet<string>>("route_filter_prefixes");
    ...
    {
        get => GetArgument<AwsDxHostedPublicVirtualInterfaceTimeoutsBlock>("timeouts");
