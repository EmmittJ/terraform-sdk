...
/// Nesting mode: single
/// </summary>
public class AwsElasticsearchDomainPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsElasticsearchDomainPolicy : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> AccessPolicies { get; set; }
    ...
    public TerraformBlock<AwsElasticsearchDomainPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
