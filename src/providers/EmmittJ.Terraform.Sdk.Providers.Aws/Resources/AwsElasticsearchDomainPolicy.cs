...
/// Nesting mode: single
/// </summary>
public partial class AwsElasticsearchDomainPolicyTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
/// </summary>
public partial class AwsElasticsearchDomainPolicy : TerraformResource
{
    ...
    public required partial TerraformValue<string> AccessPolicies { get; set; }
    ...
    public partial TerraformBlock<AwsElasticsearchDomainPolicyTimeoutsBlock>? Timeouts { get; set; }
