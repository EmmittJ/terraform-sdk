...
public partial class AwsEvidentlyFeature : TerraformResource
{
    ...
    public TerraformValue<string> DefaultVariation { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformMap<string>? EntityOverrides { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> EvaluationStrategy { get; set; }
    ...
    public TerraformBlock<AwsEvidentlyFeatureTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformSet<TerraformBlock<AwsEvidentlyFeatureVariationsBlock>>? Variations { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformSet<object> EvaluationRules { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> ValueType { get; }
