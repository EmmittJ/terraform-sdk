...
/// Nesting mode: single
/// </summary>
public partial class AwsEc2TransitGatewayMulticastDomainTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsEc2TransitGatewayMulticastDomain : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? AutoAcceptSharedAssociations { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? Igmpv2Support { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? StaticSourcesSupport { get; set; }
    ...
    public AwsEc2TransitGatewayMulticastDomainTimeoutsBlock Timeouts { get; set; } = new();
