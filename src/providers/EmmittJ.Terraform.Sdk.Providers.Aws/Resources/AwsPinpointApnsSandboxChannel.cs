...
/// <summary>
/// Represents a aws_pinpoint_apns_sandbox_channel Terraform resource.
/// Manages a aws_pinpoint_apns_sandbox_channel resource.
/// </summary>
public partial class AwsPinpointApnsSandboxChannel(string name) : TerraformResource("aws_pinpoint_apns_sandbox_channel", name)
{
    /// <summary>
