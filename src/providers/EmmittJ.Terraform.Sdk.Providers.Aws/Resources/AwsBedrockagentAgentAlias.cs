...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentAgentAliasTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsBedrockagentAgentAlias : TerraformResource
{
    ...
    public required TerraformValue<string> AgentAliasName { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<object> RoutingConfiguration { get; set; }
    ...
    public TerraformBlock<AwsBedrockagentAgentAliasTimeoutsBlock>? Timeouts { get; set; }
    ...
    public TerraformValue<string> AgentAliasArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> AgentAliasId { get; }
