...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayDefaultRouteTableAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsEc2TransitGatewayDefaultRouteTableAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsEc2TransitGatewayDefaultRouteTableAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
