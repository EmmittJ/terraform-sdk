...
/// Nesting mode: single
/// </summary>
public class AwsRekognitionCollectionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsRekognitionCollection : TerraformResource
{
    ...
    public TerraformBlock<AwsRekognitionCollectionTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> FaceModelVersion => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "face_model_version");
