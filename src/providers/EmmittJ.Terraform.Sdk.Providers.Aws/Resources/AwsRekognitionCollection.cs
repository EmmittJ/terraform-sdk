...
/// Nesting mode: single
/// </summary>
public class AwsRekognitionCollectionTimeoutsBlock
{
    /// <summary>
...
public class AwsRekognitionCollection : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("face_model_version")]
    // Output-only attribute - read-only reference
    public TerraformValue<string> FaceModelVersion => new TerraformReference(this, "face_model_version");
