...
/// <summary>
/// Represents a aws_kms_replica_external_key Terraform resource.
/// Manages a aws_kms_replica_external_key resource.
/// </summary>
public partial class AwsKmsReplicaExternalKey(string name) : TerraformResource("aws_kms_replica_external_key", name)
{
    /// <summary>
