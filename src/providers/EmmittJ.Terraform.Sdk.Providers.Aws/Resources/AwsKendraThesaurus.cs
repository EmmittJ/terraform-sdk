...
/// Nesting mode: list
/// </summary>
public class AwsKendraThesaurusSourceS3PathBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsKendraThesaurusTimeoutsBlock
{
    /// <summary>
...
public class AwsKendraThesaurus : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsKendraThesaurusSourceS3PathBlock>>? SourceS3Path { get; set; }
    ...
    public TerraformBlock<AwsKendraThesaurusTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> ThesaurusId => new TerraformReference(this, "thesaurus_id");
