...
/// <summary>
/// Represents a aws_vpc_security_group_egress_rule Terraform resource.
/// Manages a aws_vpc_security_group_egress_rule resource.
/// </summary>
public partial class AwsVpcSecurityGroupEgressRule(string name) : TerraformResource("aws_vpc_security_group_egress_rule", name)
{
    /// <summary>
