...
/// <summary>
/// Represents a aws_ecr_lifecycle_policy Terraform resource.
/// Manages a aws_ecr_lifecycle_policy resource.
/// </summary>
public partial class AwsEcrLifecyclePolicy(string name) : TerraformResource("aws_ecr_lifecycle_policy", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
