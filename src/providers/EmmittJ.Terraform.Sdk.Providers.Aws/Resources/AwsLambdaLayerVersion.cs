...
public partial class AwsLambdaLayerVersion : TerraformResource
{
    ...
    public partial TerraformSet<string>? CompatibleArchitectures { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<string>? CompatibleRuntimes { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? LicenseInfo { get; set; }
