...
public class AwsSpotFleetRequestLaunchSpecificationBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("ami");
    ...
    {
        get => GetArgument<TerraformValue<string>>("iam_instance_profile_arn");
...
public partial class AwsSpotFleetRequest(string name) : TerraformResource("aws_spot_fleet_request", name)
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("iam_fleet_role");
    ...
    {
        get => GetArgument<TerraformValue<string>>("instance_interruption_behaviour");
    ...
    {
        get => GetArgument<TerraformValue<string>>("on_demand_max_total_price");
    ...
    {
        get => GetRequiredArgument<TerraformValue<double>>("target_capacity");
    ...
    {
        get => GetArgument<TerraformValue<string>>("terminate_instances_on_delete");
