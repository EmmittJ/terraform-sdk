...
/// Nesting mode: list
/// </summary>
public class AwsIvschatLoggingConfigurationDestinationConfigurationBlock : ITerraformBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class AwsIvschatLoggingConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsIvschatLoggingConfiguration : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsIvschatLoggingConfigurationDestinationConfigurationBlock>>? DestinationConfiguration { get; set; } = new();
    ...
    public TerraformBlock<AwsIvschatLoggingConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
