...
/// Nesting mode: list
/// </summary>
public class AwsIvschatLoggingConfigurationDestinationConfigurationBlock
{
}
...
/// Nesting mode: single
/// </summary>
public class AwsIvschatLoggingConfigurationTimeoutsBlock
{
    /// <summary>
...
public class AwsIvschatLoggingConfiguration : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsIvschatLoggingConfigurationDestinationConfigurationBlock>>? DestinationConfiguration { get; set; }
    ...
    public TerraformBlock<AwsIvschatLoggingConfigurationTimeoutsBlock>? Timeouts { get; set; }
