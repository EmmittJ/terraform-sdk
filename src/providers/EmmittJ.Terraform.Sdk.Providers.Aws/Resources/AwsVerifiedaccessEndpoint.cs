...
public partial class AwsVerifiedaccessEndpoint : TerraformResource
{
    ...
    public TerraformValue<string> DeviceValidationDomain { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> EndpointDomain { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> VerifiedAccessInstanceId { get; }
