...
/// <summary>
/// Block type for timeouts in AwsOpensearchVpcEndpoint.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Block type for vpc_options in AwsOpensearchVpcEndpoint.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a aws_opensearch_vpc_endpoint Terraform resource.
/// Manages a aws_opensearch_vpc_endpoint resource.
/// </summary>
public partial class AwsOpensearchVpcEndpoint(string name) : TerraformResource("aws_opensearch_vpc_endpoint", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsOpensearchVpcEndpointTimeoutsBlock>("timeouts");
    ...
    public required TerraformList<AwsOpensearchVpcEndpointVpcOptionsBlock> VpcOptions
    {
        get => GetRequiredArgument<TerraformList<AwsOpensearchVpcEndpointVpcOptionsBlock>>("vpc_options");
