...
/// Nesting mode: single
/// </summary>
public partial class AwsOpensearchserverlessCollectionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsOpensearchserverlessCollection : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> StandbyReplicas { get; set; }
    ...
    public AwsOpensearchserverlessCollectionTimeoutsBlock Timeouts { get; set; } = new();
