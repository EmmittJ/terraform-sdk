...
/// <summary>
/// Represents a aws_cloudwatch_log_destination Terraform resource.
/// Manages a aws_cloudwatch_log_destination resource.
/// </summary>
public partial class AwsCloudwatchLogDestination(string name) : TerraformResource("aws_cloudwatch_log_destination", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
