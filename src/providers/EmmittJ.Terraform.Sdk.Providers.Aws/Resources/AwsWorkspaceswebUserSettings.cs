...
public partial class AwsWorkspaceswebUserSettingsToolbarConfigurationBlock : TerraformBlockBase
{
    ...
    public partial TerraformList<string>? HiddenToolbarItems { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? MaxDisplayResolution { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ToolbarType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? VisualMode { get; set; }
...
public partial class AwsWorkspaceswebUserSettings : TerraformResource
{
    ...
    public required partial TerraformValue<string> CopyAllowed { get; set; }
    ...
    public partial TerraformValue<string> DeepLinkAllowed { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? DisconnectTimeoutInMinutes { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DownloadAllowed { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? IdleDisconnectTimeoutInMinutes { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PasteAllowed { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PrintAllowed { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> UploadAllowed { get; set; }
