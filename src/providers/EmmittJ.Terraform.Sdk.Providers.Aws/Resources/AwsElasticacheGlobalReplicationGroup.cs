...
/// Nesting mode: single
/// </summary>
public partial class AwsElasticacheGlobalReplicationGroupTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsElasticacheGlobalReplicationGroup : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> CacheNodeType { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? GlobalReplicationGroupDescription { get; set; }
    ...
    public required partial TerraformValue<string> GlobalReplicationGroupIdSuffix { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PrimaryReplicationGroupId { get; set; }
    ...
    public AwsElasticacheGlobalReplicationGroupTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AtRestEncryptionEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformSet<object> GlobalNodeGroups { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> GlobalReplicationGroupId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> TransitEncryptionEnabled { get; }
