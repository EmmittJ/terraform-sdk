...
public partial class AwsElasticacheGlobalReplicationGroup(string name) : TerraformResource("aws_elasticache_global_replication_group", name)
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("global_replication_group_id_suffix");
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("primary_replication_group_id");
