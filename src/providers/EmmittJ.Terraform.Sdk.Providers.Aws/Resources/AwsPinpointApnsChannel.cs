...
/// </summary>
public partial class AwsPinpointApnsChannel : TerraformResource
{
    public AwsPinpointApnsChannel(string name) : base("aws_pinpoint_apns_channel", name)
    {
    }
    ...
    public partial TerraformValue<string>? BundleId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? DefaultAuthenticationMethod { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TeamId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TokenKey { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TokenKeyId { get; set; }
