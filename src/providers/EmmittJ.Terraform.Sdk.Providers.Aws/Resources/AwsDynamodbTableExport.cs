...
public partial class AwsDynamodbTableExportIncrementalExportSpecificationBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string> ExportFromTime { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ExportToTime { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ExportViewType { get; set; }
...
public partial class AwsDynamodbTableExport : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ExportFormat { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ExportTime { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> ExportType { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> S3BucketOwner { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> S3SseAlgorithm { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? S3SseKmsKeyId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TableArn { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> BilledSizeInBytes { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ExportStatus { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ManifestFilesS3Key { get; }
