...
public partial class AwsRdsClusterSnapshotCopy(string name) : TerraformResource("aws_rds_cluster_snapshot_copy", name)
{
    ...
    {
        get => new TerraformReference<string>(this, "source_db_cluster_snapshot_identifier");
    ...
    {
        get => new TerraformReference<string>(this, "target_db_cluster_snapshot_identifier");
