...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockagentAgentTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AwsBedrockagentAgent : TerraformResource
{
    ...
    public TerraformValue<string> AgentCollaboration { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> Instruction { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<object> MemoryConfiguration { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformList<object> PromptOverrideConfiguration { get; set; }
    ...
    public TerraformValue<string> AgentArn { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> AgentId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> PreparedAt { get; }
