...
/// <summary>
/// Block type for health_check in AwsLbTargetGroup.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for stickiness in AwsLbTargetGroup.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for target_failover in AwsLbTargetGroup.
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetFailoverBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("on_deregistration");
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("on_unhealthy");
...
/// <summary>
/// Block type for target_group_health in AwsLbTargetGroup.
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetGroupHealthBlock : TerraformBlock
{
    ...
    public TerraformList<AwsLbTargetGroupTargetGroupHealthBlockDnsFailoverBlock>? DnsFailover
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupTargetGroupHealthBlockDnsFailoverBlock>>("dns_failover");
    ...
    public TerraformList<AwsLbTargetGroupTargetGroupHealthBlockUnhealthyStateRoutingBlock>? UnhealthyStateRouting
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupTargetGroupHealthBlockUnhealthyStateRoutingBlock>>("unhealthy_state_routing");
...
/// <summary>
/// Block type for dns_failover in AwsLbTargetGroupTargetGroupHealthBlock.
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetGroupHealthBlockDnsFailoverBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for unhealthy_state_routing in AwsLbTargetGroupTargetGroupHealthBlock.
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetGroupHealthBlockUnhealthyStateRoutingBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Block type for target_health_state in AwsLbTargetGroup.
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetHealthStateBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<bool>>("enable_unhealthy_connection_termination");
...
/// <summary>
/// Represents a aws_lb_target_group Terraform resource.
/// Manages a aws_lb_target_group resource.
/// </summary>
public partial class AwsLbTargetGroup(string name) : TerraformResource("aws_lb_target_group", name)
{
    /// <summary>
    ...
    public TerraformList<AwsLbTargetGroupHealthCheckBlock>? HealthCheck
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupHealthCheckBlock>>("health_check");
    ...
    public TerraformList<AwsLbTargetGroupStickinessBlock>? Stickiness
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupStickinessBlock>>("stickiness");
    ...
    /// </summary>
    public TerraformList<AwsLbTargetGroupTargetFailoverBlock>? TargetFailover
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupTargetFailoverBlock>>("target_failover");
    ...
    public TerraformList<AwsLbTargetGroupTargetGroupHealthBlock>? TargetGroupHealth
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupTargetGroupHealthBlock>>("target_group_health");
    ...
    /// </summary>
    public TerraformList<AwsLbTargetGroupTargetHealthStateBlock>? TargetHealthState
    {
        get => GetArgument<TerraformList<AwsLbTargetGroupTargetHealthStateBlock>>("target_health_state");
