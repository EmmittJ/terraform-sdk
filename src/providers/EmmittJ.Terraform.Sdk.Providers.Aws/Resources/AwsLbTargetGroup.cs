...
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupHealthCheckBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupStickinessBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetFailoverBlock
{
    /// <summary>
...
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetGroupHealthBlock
{
}
...
/// Nesting mode: list
/// </summary>
public class AwsLbTargetGroupTargetHealthStateBlock
{
    /// <summary>
...
public class AwsLbTargetGroup : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsLbTargetGroupHealthCheckBlock>>? HealthCheck { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsLbTargetGroupStickinessBlock>>? Stickiness { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsLbTargetGroupTargetFailoverBlock>>? TargetFailover { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsLbTargetGroupTargetGroupHealthBlock>>? TargetGroupHealth { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsLbTargetGroupTargetHealthStateBlock>>? TargetHealthState { get; set; }
