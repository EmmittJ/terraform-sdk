...
/// Nesting mode: single
/// </summary>
public class AwsNetworkfirewallFirewallTransitGatewayAttachmentAccepterTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsNetworkfirewallFirewallTransitGatewayAttachmentAccepter : TerraformResource
{
    ...
    public TerraformBlock<AwsNetworkfirewallFirewallTransitGatewayAttachmentAccepterTimeoutsBlock>? Timeouts { get; set; } = new();
