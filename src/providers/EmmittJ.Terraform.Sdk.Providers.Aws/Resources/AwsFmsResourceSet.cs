...
public class AwsFmsResourceSetResourceSetBlock : TerraformBlock
{
    ...
    {
        get => GetArgument<TerraformValue<string>>("resource_set_status") ?? CreateReference("resource_set_status");
    ...
    {
        get => GetArgument<TerraformValue<string>>("update_token") ?? CreateReference("update_token");
