...
/// Nesting mode: list
/// </summary>
public class AwsFmsResourceSetResourceSetBlock
{
    /// <summary>
    ...
    public TerraformValue<string> ResourceSetStatus { get; set; } = default!;
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> UpdateToken { get; set; } = default!;
...
/// Nesting mode: single
/// </summary>
public class AwsFmsResourceSetTimeoutsBlock
{
    /// <summary>
