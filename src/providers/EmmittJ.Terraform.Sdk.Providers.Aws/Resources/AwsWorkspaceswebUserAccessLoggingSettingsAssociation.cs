...
/// </summary>
public partial class AwsWorkspaceswebUserAccessLoggingSettingsAssociation : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> UserAccessLoggingSettingsArn { get; set; }
