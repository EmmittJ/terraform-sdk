...
public partial class AwsDxConnection : TerraformResource
{
    ...
    public required partial TerraformValue<string> Bandwidth { get; set; }
    ...
    public partial TerraformValue<bool>? RequestMacsec { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> MacsecCapable { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PortEncryptionStatus { get; }
