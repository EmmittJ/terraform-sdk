...
/// Nesting mode: single
/// </summary>
public class AwsConfigOrganizationCustomRuleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsConfigOrganizationCustomRule : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> LambdaFunctionArn { get; set; }
    ...
    public TerraformBlock<AwsConfigOrganizationCustomRuleTimeoutsBlock>? Timeouts { get; set; } = new();
