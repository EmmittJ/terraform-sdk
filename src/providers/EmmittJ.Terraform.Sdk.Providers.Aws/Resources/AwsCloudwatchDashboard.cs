...
public partial class AwsCloudwatchDashboard : TerraformResource
{
    ...
    public required partial TerraformValue<string> DashboardBody { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DashboardName { get; set; }
    ...
    public partial TerraformValue<string> DashboardArn { get; }
