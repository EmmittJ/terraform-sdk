...
/// Nesting mode: list
/// </summary>
public class AwsS3BucketMetricFilterBlock : ITerraformBlock
{
    /// <summary>
    /// The access_point attribute.
    /// </summary>
    [TerraformPropertyName("access_point")]
    // Optional argument - user may or may not set a value
    public TerraformProperty<TerraformProperty<string>>? AccessPoint { get; set; }
...
public class AwsS3BucketMetric : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsS3BucketMetricFilterBlock>>? Filter { get; set; } = new();
