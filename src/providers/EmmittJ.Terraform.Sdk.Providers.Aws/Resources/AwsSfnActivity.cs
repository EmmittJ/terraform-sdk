...
/// <summary>
/// Block type for encryption_configuration in AwsSfnActivity.
/// Nesting mode: list
/// </summary>
public class AwsSfnActivityEncryptionConfigurationBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_sfn_activity Terraform resource.
/// Manages a aws_sfn_activity resource.
/// </summary>
public partial class AwsSfnActivity(string name) : TerraformResource("aws_sfn_activity", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    public TerraformList<AwsSfnActivityEncryptionConfigurationBlock>? EncryptionConfiguration
    {
        get => GetArgument<TerraformList<AwsSfnActivityEncryptionConfigurationBlock>>("encryption_configuration");
