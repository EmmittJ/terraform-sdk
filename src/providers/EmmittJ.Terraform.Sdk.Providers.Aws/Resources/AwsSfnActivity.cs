...
/// Nesting mode: list
/// </summary>
public class AwsSfnActivityEncryptionConfigurationBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsSfnActivity : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsSfnActivityEncryptionConfigurationBlock>>? EncryptionConfiguration { get; set; } = new();
