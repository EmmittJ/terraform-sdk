...
public partial class AwsLbListener : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsLbListenerDefaultActionBlock>>? DefaultAction { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsLbListenerMutualAuthenticationBlock>>? MutualAuthentication { get; set; }
    ...
    public TerraformBlock<AwsLbListenerTimeoutsBlock>? Timeouts { get; set; }
