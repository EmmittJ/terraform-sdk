...
public partial class AwsRbinRuleExcludeResourceTagsBlock() : TerraformBlock("exclude_resource_tags")
{
    ...
    public required partial TerraformValue<string> ResourceTagKey { get; set; }
    ...
    public partial TerraformValue<string>? ResourceTagValue { get; set; }
...
public partial class AwsRbinRuleRetentionPeriodBlock() : TerraformBlock("retention_period")
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> RetentionPeriodUnit { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<double> RetentionPeriodValue { get; set; }
...
public partial class AwsRbinRule : TerraformResource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LockEndTime { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LockState { get; }
