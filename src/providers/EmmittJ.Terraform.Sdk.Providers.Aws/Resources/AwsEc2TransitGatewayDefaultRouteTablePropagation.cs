...
/// <summary>
/// Block type for timeouts in AwsEc2TransitGatewayDefaultRouteTablePropagation.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_ec2_transit_gateway_default_route_table_propagation Terraform resource.
/// Manages a aws_ec2_transit_gateway_default_route_table_propagation resource.
/// </summary>
public partial class AwsEc2TransitGatewayDefaultRouteTablePropagation(string name) : TerraformResource("aws_ec2_transit_gateway_default_route_table_propagation", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<AwsEc2TransitGatewayDefaultRouteTablePropagationTimeoutsBlock>("timeouts");
