...
/// Nesting mode: single
/// </summary>
public class AwsEc2TransitGatewayDefaultRouteTablePropagationTimeoutsBlock
{
    /// <summary>
...
public class AwsEc2TransitGatewayDefaultRouteTablePropagation : TerraformResource
{
    ...
    public TerraformBlock<AwsEc2TransitGatewayDefaultRouteTablePropagationTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - read-only reference
    public TerraformValue<string> OriginalDefaultRouteTableId => new TerraformReference(this, "original_default_route_table_id");
