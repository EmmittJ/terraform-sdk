...
public partial class AwsSesv2ContactListTopicBlock() : TerraformBlock("topic")
{
    ...
    public required partial TerraformValue<string> DefaultSubscriptionStatus { get; set; }
...
public partial class AwsSesv2ContactList : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ContactListName { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> LastUpdatedTimestamp { get; }
