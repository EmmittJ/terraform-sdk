...
public partial class AwsElasticacheServerlessCache : TerraformResource
{
    ...
    public partial TerraformValue<string> DailySnapshotTime { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> MajorEngineVersion { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformList<string>? SnapshotArnsToRestore { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? UserGroupId { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> ReaderEndpoint { get; }
