...
/// Nesting mode: single
/// </summary>
public class AwsDxGatewayTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsDxGateway : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> AmazonSideAsn { get; set; }
    ...
    public TerraformBlock<AwsDxGatewayTimeoutsBlock>? Timeouts { get; set; } = new();
