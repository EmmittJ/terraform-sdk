...
/// Nesting mode: list
/// </summary>
public partial class AwsIotThingTypePropertiesBlock() : TerraformBlock("properties")
{
    /// <summary>
    ...
    public partial TerraformSet<string> SearchableAttributes { get; set; }
...
public partial class AwsIotThingType : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? Deprecated { get; set; }
    ...
    public TerraformList<AwsIotThingTypePropertiesBlock> Properties { get; set; } = new();
