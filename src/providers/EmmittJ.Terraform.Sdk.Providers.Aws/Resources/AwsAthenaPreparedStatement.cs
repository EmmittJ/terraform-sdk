...
/// Nesting mode: single
/// </summary>
public class AwsAthenaPreparedStatementTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsAthenaPreparedStatement : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> QueryStatement { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> Workgroup { get; set; }
    ...
    public TerraformBlock<AwsAthenaPreparedStatementTimeoutsBlock>? Timeouts { get; set; } = new();
