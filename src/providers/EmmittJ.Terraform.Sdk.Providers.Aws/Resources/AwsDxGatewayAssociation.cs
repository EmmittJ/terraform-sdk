...
/// Nesting mode: single
/// </summary>
public partial class AwsDxGatewayAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsDxGatewayAssociation : TerraformResource
{
    ...
    public partial TerraformSet<string> AllowedPrefixes { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> AssociatedGatewayId { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> AssociatedGatewayOwnerAccountId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ProposalId { get; set; }
    ...
    public AwsDxGatewayAssociationTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformValue<string> AssociatedGatewayType { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DxGatewayAssociationId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> DxGatewayOwnerAccountId { get; }
