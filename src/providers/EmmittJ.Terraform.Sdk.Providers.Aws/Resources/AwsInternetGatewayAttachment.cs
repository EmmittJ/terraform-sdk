...
/// Nesting mode: single
/// </summary>
public class AwsInternetGatewayAttachmentTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsInternetGatewayAttachment : TerraformResource
{
    ...
    public required TerraformProperty<TerraformProperty<string>> InternetGatewayId { get; set; }
    ...
    public TerraformBlock<AwsInternetGatewayAttachmentTimeoutsBlock>? Timeouts { get; set; } = new();
