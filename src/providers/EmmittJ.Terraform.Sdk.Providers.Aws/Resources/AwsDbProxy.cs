...
public partial class AwsDbProxyAuthBlock : TerraformBlockBase
{
    ...
    public TerraformValue<string> ClientPasswordAuthType { get; set; }
...
public partial class AwsDbProxy : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> DefaultAuthScheme { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<double> IdleClientTimeout { get; set; }
