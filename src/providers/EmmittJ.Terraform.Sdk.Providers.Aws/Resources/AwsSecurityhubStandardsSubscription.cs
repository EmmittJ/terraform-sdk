...
/// Nesting mode: single
/// </summary>
public class AwsSecurityhubStandardsSubscriptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsSecurityhubStandardsSubscription : TerraformResource
{
    ...
    public TerraformBlock<AwsSecurityhubStandardsSubscriptionTimeoutsBlock>? Timeouts { get; set; } = new();
