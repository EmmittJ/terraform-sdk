...
/// Nesting mode: single
/// </summary>
public class AwsRoute53profilesAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsRoute53profilesAssociation : TerraformResource
{
    ...
    public TerraformBlock<AwsRoute53profilesAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
