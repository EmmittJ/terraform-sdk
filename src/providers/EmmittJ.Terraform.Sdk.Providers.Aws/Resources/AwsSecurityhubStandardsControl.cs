...
public partial class AwsSecurityhubStandardsControl : TerraformResource
{
    ...
    public required partial TerraformValue<string> ControlStatus { get; set; }
    ...
    public partial TerraformValue<string> DisabledReason { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StandardsControlArn { get; set; }
    ...
    public partial TerraformValue<string> ControlId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ControlStatusUpdatedAt { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> RelatedRequirements { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> RemediationUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SeverityRating { get; }
