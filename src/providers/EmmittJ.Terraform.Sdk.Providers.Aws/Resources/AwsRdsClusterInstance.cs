...
/// Nesting mode: single
/// </summary>
public class AwsRdsClusterInstanceTimeoutsBlock
{
    /// <summary>
...
public class AwsRdsClusterInstance : TerraformResource
{
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> DbParameterGroupName { get; set; } = default!;
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<bool> PerformanceInsightsEnabled { get; set; } = default!;
