...
public partial class AwsRdsClusterInstance : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> DbParameterGroupName { get; set; }
    ...
    public TerraformBlock<AwsRdsClusterInstanceTimeoutsBlock>? Timeouts { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<string> DbiResourceId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public TerraformValue<bool> Writer { get; }
