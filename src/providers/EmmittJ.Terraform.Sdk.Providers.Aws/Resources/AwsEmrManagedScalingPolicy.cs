...
public class AwsEmrManagedScalingPolicyComputeLimitsBlock : TerraformBlock
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<double>>("maximum_capacity_units");
    ...
    {
        get => GetArgument<TerraformValue<double>>("maximum_core_capacity_units");
    ...
    {
        get => GetArgument<TerraformValue<double>>("maximum_ondemand_capacity_units");
    ...
    {
        get => GetRequiredArgument<TerraformValue<double>>("minimum_capacity_units");
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("unit_type");
