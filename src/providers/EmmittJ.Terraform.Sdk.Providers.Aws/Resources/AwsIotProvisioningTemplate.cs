...
public partial class AwsIotProvisioningTemplatePreProvisioningHookBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? PayloadVersion { get; set; }
...
public partial class AwsIotProvisioningTemplate : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ProvisioningRoleArn { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> TemplateBody { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> DefaultVersionId { get; }
