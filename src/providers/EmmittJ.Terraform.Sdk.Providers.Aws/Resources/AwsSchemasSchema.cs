...
public class AwsSchemasSchema : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("version_created_date")]
    // Output-only attribute - read-only reference
    public TerraformProperty<TerraformProperty<string>> VersionCreatedDate => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "version_created_date");
