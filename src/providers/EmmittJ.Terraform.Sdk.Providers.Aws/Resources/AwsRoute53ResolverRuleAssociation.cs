...
/// Nesting mode: single
/// </summary>
public partial class AwsRoute53ResolverRuleAssociationTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
/// </summary>
public partial class AwsRoute53ResolverRuleAssociation : TerraformResource
{
    ...
    public required partial TerraformValue<string> ResolverRuleId { get; set; }
    ...
    public AwsRoute53ResolverRuleAssociationTimeoutsBlock Timeouts { get; set; } = new();
