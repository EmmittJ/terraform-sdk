...
public partial class AwsSsmActivation : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<double>? RegistrationLimit { get; set; }
    ...
    public partial TerraformValue<string> ActivationCode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> Expired { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<double> RegistrationCount { get; }
