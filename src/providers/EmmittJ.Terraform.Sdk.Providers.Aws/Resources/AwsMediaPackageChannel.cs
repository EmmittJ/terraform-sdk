...
public class AwsMediaPackageChannel : TerraformResource
{
    ...
    /// </summary>
    [TerraformPropertyName("hls_ingest")]
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> HlsIngest => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "hls_ingest");
