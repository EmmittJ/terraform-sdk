...
/// </summary>
public partial class AwsMskconnectWorkerConfiguration : TerraformResource
{
    ...
    [TerraformProperty("properties_file_content")]
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> PropertiesFileContent { get; set; }
    ...
    public TerraformBlock<AwsMskconnectWorkerConfigurationTimeoutsBlock>? Timeouts { get; set; }
