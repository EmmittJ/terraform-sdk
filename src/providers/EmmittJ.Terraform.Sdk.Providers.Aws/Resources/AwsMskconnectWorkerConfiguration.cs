...
/// Nesting mode: single
/// </summary>
public class AwsMskconnectWorkerConfigurationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsMskconnectWorkerConfiguration : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> PropertiesFileContent { get; set; }
    ...
    public TerraformBlock<AwsMskconnectWorkerConfigurationTimeoutsBlock>? Timeouts { get; set; } = new();
