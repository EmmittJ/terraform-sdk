...
/// Nesting mode: single
/// </summary>
public partial class AwsOpensearchserverlessVpcEndpointTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsOpensearchserverlessVpcEndpoint : TerraformResource
{
    ...
    public AwsOpensearchserverlessVpcEndpointTimeoutsBlock Timeouts { get; set; } = new();
