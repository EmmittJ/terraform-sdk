...
public partial class AwsEc2TransitGatewayPeeringAttachmentOptionsBlock : TerraformBlockBase
{
    ...
    public partial TerraformValue<string>? DynamicRouting { get; set; }
...
public partial class AwsEc2TransitGatewayPeeringAttachment : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> PeerAccountId { get; set; }
    ...
    public required partial TerraformValue<string> PeerRegion { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PeerTransitGatewayId { get; set; }
