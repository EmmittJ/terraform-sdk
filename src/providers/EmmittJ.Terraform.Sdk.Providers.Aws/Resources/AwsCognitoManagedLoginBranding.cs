...
public partial class AwsCognitoManagedLoginBrandingAssetBlock() : TerraformBlock("asset")
{
    ...
    public partial TerraformValue<string>? Bytes { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ColorMode { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> Extension { get; set; }
...
public partial class AwsCognitoManagedLoginBranding : TerraformResource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<bool> UseCognitoProvidedValues { get; set; }
    ...
    public partial TerraformValue<string> ManagedLoginBrandingId { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SettingsAll { get; }
