...
/// Nesting mode: set
/// </summary>
public class AwsEksFargateProfileSelectorBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AwsEksFargateProfileTimeoutsBlock
{
    /// <summary>
...
public class AwsEksFargateProfile : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> FargateProfileName { get; set; }
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformValue<string> PodExecutionRoleArn { get; set; }
    ...
    public TerraformSet<TerraformBlock<AwsEksFargateProfileSelectorBlock>>? Selector { get; set; }
    ...
    public TerraformBlock<AwsEksFargateProfileTimeoutsBlock>? Timeouts { get; set; }
