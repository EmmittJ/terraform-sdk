...
/// Nesting mode: set
/// </summary>
public class AwsRdsClusterParameterGroupParameterBlock : ITerraformBlock
{
    /// <summary>
...
/// </summary>
public class AwsRdsClusterParameterGroup : TerraformResource
{
    ...
    public TerraformSet<TerraformBlock<AwsRdsClusterParameterGroupParameterBlock>>? Parameter { get; set; } = new();
