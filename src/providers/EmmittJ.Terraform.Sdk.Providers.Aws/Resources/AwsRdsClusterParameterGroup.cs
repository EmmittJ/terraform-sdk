...
/// <summary>
/// Block type for parameter in AwsRdsClusterParameterGroup.
/// Nesting mode: set
/// </summary>
public class AwsRdsClusterParameterGroupParameterBlock : TerraformBlock
{
    /// <summary>
    /// Gets the block type.
    /// </summary>
...
/// <summary>
/// Represents a aws_rds_cluster_parameter_group Terraform resource.
/// Manages a aws_rds_cluster_parameter_group resource.
/// </summary>
public partial class AwsRdsClusterParameterGroup(string name) : TerraformResource("aws_rds_cluster_parameter_group", name)
{
    /// <summary>
    ...
    /// </summary>
    public TerraformSet<AwsRdsClusterParameterGroupParameterBlock>? Parameter
    {
        get => GetArgument<TerraformSet<AwsRdsClusterParameterGroupParameterBlock>>("parameter");
