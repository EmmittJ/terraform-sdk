...
public class AwsServicecatalogappregistryApplication : TerraformResource
{
    ...
    public TerraformProperty<Dictionary<string, TerraformProperty<string>>> ApplicationTag => new TerraformReferenceProperty<Dictionary<string, TerraformProperty<string>>>(ResourceAddress, "application_tag");
