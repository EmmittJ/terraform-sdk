...
/// Nesting mode: single
/// </summary>
public partial class AwsBedrockProvisionedModelThroughputTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsBedrockProvisionedModelThroughput : TerraformResource
{
    ...
    public AwsBedrockProvisionedModelThroughputTimeoutsBlock Timeouts { get; set; } = new();
