...
public partial class AwsDefaultSecurityGroup(string name) : TerraformResource("aws_default_security_group", name)
{
    ...
    {
        get => TerraformSet<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformSet<TerraformMap<object>>>(this, "egress").ResolveNodes(ctx));
    ...
    {
        get => TerraformSet<TerraformMap<object>>.Lazy(ctx => new TerraformReference<TerraformSet<TerraformMap<object>>>(this, "ingress").ResolveNodes(ctx));
    ...
    {
        get => new TerraformReference<bool>(this, "revoke_rules_on_delete");
