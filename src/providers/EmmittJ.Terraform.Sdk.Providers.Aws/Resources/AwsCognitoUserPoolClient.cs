...
/// <summary>
/// Block type for analytics_configuration in AwsCognitoUserPoolClient.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for refresh_token_rotation in AwsCognitoUserPoolClient.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for token_validity_units in AwsCognitoUserPoolClient.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Represents a aws_cognito_user_pool_client Terraform resource.
/// Manages a aws_cognito_user_pool_client resource.
/// </summary>
public partial class AwsCognitoUserPoolClient(string name) : TerraformResource("aws_cognito_user_pool_client", name)
{
    /// <summary>
    ...
    {
        get => GetArgument<TerraformValue<bool>>("generate_secret");
        set => SetArgument("generate_secret", value);
    }
    ...
    /// </summary>
    public TerraformList<AwsCognitoUserPoolClientAnalyticsConfigurationBlock>? AnalyticsConfiguration
    {
        get => GetArgument<TerraformList<AwsCognitoUserPoolClientAnalyticsConfigurationBlock>>("analytics_configuration");
    ...
    /// </summary>
    public TerraformList<AwsCognitoUserPoolClientRefreshTokenRotationBlock>? RefreshTokenRotation
    {
        get => GetArgument<TerraformList<AwsCognitoUserPoolClientRefreshTokenRotationBlock>>("refresh_token_rotation");
    ...
    /// </summary>
    public TerraformList<AwsCognitoUserPoolClientTokenValidityUnitsBlock>? TokenValidityUnits
    {
        get => GetArgument<TerraformList<AwsCognitoUserPoolClientTokenValidityUnitsBlock>>("token_validity_units");
