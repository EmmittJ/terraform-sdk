...
/// Nesting mode: single
/// </summary>
public class AwsRedshiftEventSubscriptionTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsRedshiftEventSubscription : TerraformResource
{
    ...
    public TerraformBlock<AwsRedshiftEventSubscriptionTimeoutsBlock>? Timeouts { get; set; } = new();
