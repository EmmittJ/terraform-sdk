...
/// Nesting mode: single
/// </summary>
public partial class AwsRedshiftEventSubscriptionTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsRedshiftEventSubscription : TerraformResource
{
    ...
    public AwsRedshiftEventSubscriptionTimeoutsBlock Timeouts { get; set; } = new();
