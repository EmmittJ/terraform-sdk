...
/// Nesting mode: list
/// </summary>
public class AwsLocationPlaceIndexDataSourceConfigurationBlock : ITerraformBlock
{
    /// <summary>
    ...
    public TerraformProperty<TerraformProperty<string>>? IntendedUse { get; set; }
...
public class AwsLocationPlaceIndex : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsLocationPlaceIndexDataSourceConfigurationBlock>>? DataSourceConfiguration { get; set; } = new();
