...
public partial class AwsDatasyncLocationFsxOntapFileSystem : TerraformResource
{
    ...
    [TerraformProperty("storage_virtual_machine_arn")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> StorageVirtualMachineArn { get; set; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> FsxFilesystemArn { get; }
