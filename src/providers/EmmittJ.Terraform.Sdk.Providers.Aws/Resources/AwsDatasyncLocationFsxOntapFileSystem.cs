...
public class AwsDatasyncLocationFsxOntapFileSystem : TerraformResource
{
    ...
    private void InitializeOutputs()
    {
        ...
        SetOutput("storage_virtual_machine_arn");
    ...
    {
        get => GetRequiredOutput<TerraformProperty<string>>("storage_virtual_machine_arn");
        set => SetProperty("storage_virtual_machine_arn", value);
    }
