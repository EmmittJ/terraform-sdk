...
/// Nesting mode: single
/// </summary>
public class AwsRoute53profilesResourceAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsRoute53profilesResourceAssociation : TerraformResource
{
    ...
    // Optional+Computed - defaults to reference (Terraform will compute if not set)
    public TerraformProperty<TerraformProperty<string>> ResourceProperties { get; set; } = new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "resource_properties");
    ...
    public TerraformBlock<AwsRoute53profilesResourceAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
