...
/// Nesting mode: list
/// </summary>
public class AwsFinspaceKxVolumeNas1ConfigurationBlock : ITerraformBlock
{
    /// <summary>
    /// The size attribute.
    /// </summary>
...
/// Nesting mode: single
/// </summary>
public class AwsFinspaceKxVolumeTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsFinspaceKxVolume : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsFinspaceKxVolumeNas1ConfigurationBlock>>? Nas1Configuration { get; set; } = new();
    ...
    public TerraformBlock<AwsFinspaceKxVolumeTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    // Output-only attribute - read-only reference
    public TerraformProperty<List<TerraformProperty<object>>> AttachedClusters => new TerraformReferenceProperty<List<TerraformProperty<object>>>(ResourceAddress, "attached_clusters");
