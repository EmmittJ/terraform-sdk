...
/// Nesting mode: single
/// </summary>
public class AwsOpensearchPackageAssociationTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsOpensearchPackageAssociation : TerraformResource
{
    ...
    // Required argument - user must set a value (no initializer for compile-time enforcement)
    public required TerraformProperty<TerraformProperty<string>> PackageId { get; set; }
    ...
    public TerraformBlock<AwsOpensearchPackageAssociationTimeoutsBlock>? Timeouts { get; set; } = new();
    ...
    public TerraformProperty<TerraformProperty<string>> ReferencePath => new TerraformReferenceProperty<TerraformProperty<string>>(ResourceAddress, "reference_path");
