...
/// Nesting mode: list
/// </summary>
public class AwsIotBillingGroupPropertiesBlock : ITerraformBlock
{
    /// <summary>
...
public class AwsIotBillingGroup : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsIotBillingGroupPropertiesBlock>>? Properties { get; set; } = new();
