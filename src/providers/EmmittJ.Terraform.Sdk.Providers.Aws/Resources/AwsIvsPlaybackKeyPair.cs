...
/// <summary>
/// Block type for timeouts in AwsIvsPlaybackKeyPair.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_ivs_playback_key_pair Terraform resource.
/// Manages a aws_ivs_playback_key_pair resource.
/// </summary>
public partial class AwsIvsPlaybackKeyPair(string name) : TerraformResource("aws_ivs_playback_key_pair", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AwsIvsPlaybackKeyPairTimeoutsBlock>("timeouts");
