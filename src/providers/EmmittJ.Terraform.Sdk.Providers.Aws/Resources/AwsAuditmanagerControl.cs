...
public partial class AwsAuditmanagerControlControlMappingSourcesBlock() : TerraformBlock("control_mapping_sources")
{
    ...
    public partial TerraformValue<string>? SourceDescription { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? SourceFrequency { get; set; }
    ...
    public partial TerraformList<object> SourceKeyword { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> SourceSetUpOption { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TroubleshootingText { get; set; }
...
public partial class AwsAuditmanagerControl : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ActionPlanInstructions { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? ActionPlanTitle { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? TestingInformation { get; set; }
