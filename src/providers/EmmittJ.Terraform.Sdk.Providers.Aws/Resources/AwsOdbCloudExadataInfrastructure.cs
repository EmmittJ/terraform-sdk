...
public partial class AwsOdbCloudExadataInfrastructureMaintenanceWindowBlock() : TerraformBlock("maintenance_window")
{
    ...
    public required partial TerraformValue<double> CustomActionTimeoutInMins { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<bool> IsCustomActionTimeoutEnabled { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> PatchingMode { get; set; }
...
public partial class AwsOdbCloudExadataInfrastructure : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformSet<object>? CustomerContactsToSendToOci { get; set; }
