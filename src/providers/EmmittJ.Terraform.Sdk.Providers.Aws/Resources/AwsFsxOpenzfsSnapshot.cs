...
/// <summary>
/// Block type for timeouts in AwsFsxOpenzfsSnapshot.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a aws_fsx_openzfs_snapshot Terraform resource.
/// Manages a aws_fsx_openzfs_snapshot resource.
/// </summary>
public partial class AwsFsxOpenzfsSnapshot(string name) : TerraformResource("aws_fsx_openzfs_snapshot", name)
{
    /// <summary>
    /// The id attribute.
    /// </summary>
    ...
    {
        get => GetArgument<AwsFsxOpenzfsSnapshotTimeoutsBlock>("timeouts");
