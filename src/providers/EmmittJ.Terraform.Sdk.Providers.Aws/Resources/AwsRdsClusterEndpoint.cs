...
/// </summary>
public partial class AwsRdsClusterEndpoint : TerraformResource
{
    ...
    [TerraformProperty("custom_endpoint_type")]
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> CustomEndpointType { get; set; }
