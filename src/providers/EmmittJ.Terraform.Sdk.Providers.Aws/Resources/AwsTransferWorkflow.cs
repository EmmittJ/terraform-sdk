...
/// Nesting mode: list
/// </summary>
public class AwsTransferWorkflowOnExceptionStepsBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
/// Nesting mode: list
/// </summary>
public class AwsTransferWorkflowStepsBlock
{
    /// <summary>
    /// The type attribute.
    /// </summary>
...
public class AwsTransferWorkflow : TerraformResource
{
    ...
    public TerraformList<TerraformBlock<AwsTransferWorkflowOnExceptionStepsBlock>>? OnExceptionSteps { get; set; }
    ...
    public TerraformList<TerraformBlock<AwsTransferWorkflowStepsBlock>>? Steps { get; set; }
