...
public partial class AwsLbTrustStore(string name) : TerraformResource("aws_lb_trust_store", name)
{
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("ca_certificates_bundle_s3_bucket");
    ...
    {
        get => GetRequiredArgument<TerraformValue<string>>("ca_certificates_bundle_s3_key");
