...
/// Nesting mode: single
/// </summary>
public partial class AwsLbTrustStoreTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsLbTrustStore : TerraformResource
{
    ...
    public required partial TerraformValue<string> CaCertificatesBundleS3Bucket { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> CaCertificatesBundleS3Key { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? CaCertificatesBundleS3ObjectVersion { get; set; }
    ...
    public AwsLbTrustStoreTimeoutsBlock Timeouts { get; set; } = new();
