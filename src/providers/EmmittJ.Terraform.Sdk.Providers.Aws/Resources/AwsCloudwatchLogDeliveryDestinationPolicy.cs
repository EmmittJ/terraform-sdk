...
public partial class AwsCloudwatchLogDeliveryDestinationPolicy : TerraformResource
{
    ...
    public required partial TerraformValue<string> DeliveryDestinationName { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> DeliveryDestinationPolicy { get; set; }
