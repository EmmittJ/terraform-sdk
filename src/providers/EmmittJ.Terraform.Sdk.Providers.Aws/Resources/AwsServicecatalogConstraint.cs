...
/// Nesting mode: single
/// </summary>
public partial class AwsServicecatalogConstraintTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AwsServicecatalogConstraint : TerraformResource
{
    ...
    public required partial TerraformValue<string> Parameters { get; set; }
    ...
    public AwsServicecatalogConstraintTimeoutsBlock Timeouts { get; set; } = new();
