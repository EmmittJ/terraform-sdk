...
/// <summary>
/// Block type for dynamic_membership in AzureadGroupWithoutMembers.
/// Nesting mode: list
/// </summary>
...
/// <summary>
/// Block type for timeouts in AzureadGroupWithoutMembers.
/// Nesting mode: single
/// </summary>
...
/// <summary>
/// Represents a azuread_group_without_members Terraform resource.
/// Manages a azuread_group_without_members resource.
/// </summary>
public partial class AzureadGroupWithoutMembers(string name) : TerraformResource("azuread_group_without_members", name)
{
    /// <summary>
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "administrative_unit_ids").ResolveNodes(ctx));
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "behaviors").ResolveNodes(ctx));
    ...
    {
        get => TerraformSet<string>.Lazy(ctx => new TerraformReference<TerraformSet<string>>(this, "provisioning_options").ResolveNodes(ctx));
    ...
    public TerraformList<AzureadGroupWithoutMembersDynamicMembershipBlock>? DynamicMembership
    {
        get => GetArgument<TerraformList<AzureadGroupWithoutMembersDynamicMembershipBlock>>("dynamic_membership");
    ...
    {
        get => GetArgument<AzureadGroupWithoutMembersTimeoutsBlock>("timeouts");
