...
public partial class AzureadGroupWithoutMembers : TerraformResource
{
    ...
    public TerraformValue<bool> AutoSubscribeNewMembers { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> ExternalSendersAllowed { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> HideFromAddressLists { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<bool> HideFromOutlookClients { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> OnpremisesGroupType { get; set; }
    ...
    public TerraformList<TerraformBlock<AzureadGroupWithoutMembersDynamicMembershipBlock>>? DynamicMembership { get; set; }
    ...
    public TerraformBlock<AzureadGroupWithoutMembersTimeoutsBlock>? Timeouts { get; set; }
