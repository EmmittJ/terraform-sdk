...
/// Nesting mode: single
/// </summary>
public class AzureadClaimsMappingPolicyTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzureadClaimsMappingPolicy : TerraformResource
{
    ...
    public TerraformProperty<List<TerraformProperty<string>>>? Definition { get; set; }
    ...
    public TerraformBlock<AzureadClaimsMappingPolicyTimeoutsBlock>? Timeouts { get; set; } = new();
