...
/// Nesting mode: single
/// </summary>
public partial class AzureadAccessPackageTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzureadAccessPackage : TerraformResource
{
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<bool>? Hidden { get; set; }
    ...
    public AzureadAccessPackageTimeoutsBlock Timeouts { get; set; } = new();
