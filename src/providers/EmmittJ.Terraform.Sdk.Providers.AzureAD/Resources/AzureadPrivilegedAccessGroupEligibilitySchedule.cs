...
/// Nesting mode: single
/// </summary>
public class AzureadPrivilegedAccessGroupEligibilityScheduleTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzureadPrivilegedAccessGroupEligibilitySchedule : TerraformResource
{
    ...
    public TerraformBlock<AzureadPrivilegedAccessGroupEligibilityScheduleTimeoutsBlock>? Timeouts { get; set; } = new();
