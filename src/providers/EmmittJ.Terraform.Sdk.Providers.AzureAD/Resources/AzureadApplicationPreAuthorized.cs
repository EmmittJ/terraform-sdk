...
/// Nesting mode: single
/// </summary>
public partial class AzureadApplicationPreAuthorizedTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
...
public partial class AzureadApplicationPreAuthorized : TerraformResource
{
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> AuthorizedClientId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformSet<string> PermissionIds { get; set; }
    ...
    public AzureadApplicationPreAuthorizedTimeoutsBlock Timeouts { get; set; } = new();
