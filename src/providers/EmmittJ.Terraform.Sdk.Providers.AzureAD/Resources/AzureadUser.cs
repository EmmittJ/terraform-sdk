...
/// Nesting mode: single
/// </summary>
public partial class AzureadUserTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzureadUser : TerraformResource
{
    ...
    public TerraformList<string> BusinessPhones { get; set; }
    ...
    // Optional+Computed - source generator will implement get/set
    public TerraformValue<string> OnpremisesImmutableId { get; set; }
    ...
    public TerraformValue<string> AboutMe { get; }
