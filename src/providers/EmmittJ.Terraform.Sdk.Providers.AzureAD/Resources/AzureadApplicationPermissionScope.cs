...
/// Nesting mode: single
/// </summary>
public partial class AzureadApplicationPermissionScopeTimeoutsBlock : TerraformBlockBase
{
    /// <summary>
...
public partial class AzureadApplicationPermissionScope : TerraformResource
{
    ...
    public required TerraformValue<string> AdminConsentDescription { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required TerraformValue<string> AdminConsentDisplayName { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? UserConsentDescription { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public TerraformValue<string>? UserConsentDisplayName { get; set; }
    ...
    public TerraformBlock<AzureadApplicationPermissionScopeTimeoutsBlock>? Timeouts { get; set; }
