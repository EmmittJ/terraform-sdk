...
public partial class AzureadServicePrincipalDelegatedPermissionGrant : TerraformResource
{
    ...
    public required partial TerraformSet<string> ClaimValues { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ResourceServicePrincipalObjectId { get; set; }
    ...
    // Required argument - source generator will implement get/set
    public required partial TerraformValue<string> ServicePrincipalObjectId { get; set; }
    ...
    // Optional argument - source generator will implement get/set
    public partial TerraformValue<string>? UserObjectId { get; set; }
