...
/// Nesting mode: single
/// </summary>
public class AzureadServicePrincipalPasswordTimeoutsBlock : ITerraformBlock
{
    /// <summary>
...
public class AzureadServicePrincipalPassword : TerraformResource
{
    ...
    public TerraformBlock<AzureadServicePrincipalPasswordTimeoutsBlock>? Timeouts { get; set; } = new();
