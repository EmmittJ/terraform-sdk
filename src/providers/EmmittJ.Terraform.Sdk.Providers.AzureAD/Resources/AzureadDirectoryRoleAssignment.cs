...
/// Nesting mode: single
/// </summary>
public class AzureadDirectoryRoleAssignmentTimeoutsBlock
{
    /// <summary>
...
public class AzureadDirectoryRoleAssignment : TerraformResource
{
    ...
    public TerraformValue<string> AppScopeId { get; set; } = default!;
    ...
    // Optional+Computed - use setter for literal value, or leave as computed reference
    public TerraformValue<string> DirectoryScopeId { get; set; } = default!;
