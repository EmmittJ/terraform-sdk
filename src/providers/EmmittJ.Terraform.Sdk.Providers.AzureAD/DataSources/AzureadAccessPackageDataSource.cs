...
/// Nesting mode: single
/// </summary>
public partial class AzureadAccessPackageDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzureadAccessPackageDataSource : TerraformDataSource
{
    ...
    public AzureadAccessPackageDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> Hidden { get; }
