...
public partial class AzureadServicePrincipalDataSource : TerraformDataSource
{
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> AlternativeNames { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> AppRoleAssignmentRequired { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> NotificationEmailAddresses { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PreferredSingleSignOnMode { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SamlSingleSignOn { get; }
