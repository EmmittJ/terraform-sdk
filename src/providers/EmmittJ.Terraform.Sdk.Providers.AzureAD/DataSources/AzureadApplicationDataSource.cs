...
/// Nesting mode: single
/// </summary>
public partial class AzureadApplicationDataSourceTimeoutsBlock() : TerraformBlock("timeouts")
{
    /// <summary>
    /// The read attribute.
    /// </summary>
...
public partial class AzureadApplicationDataSource : TerraformDataSource
{
    ...
    // Optional+Computed - source generator will implement get/set
    public partial TerraformValue<string> IdentifierUri { get; set; }
    ...
    public AzureadApplicationDataSourceTimeoutsBlock Timeouts { get; set; } = new();
    ...
    public partial TerraformList<object> Api { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> AppRoles { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> DeviceOnlyAuthEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> FallbackPublicClientEnabled { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> FeatureTags { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> GroupMembershipClaims { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<string> IdentifierUris { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> MarketingUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<bool> Oauth2PostResponseRequired { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> OptionalClaims { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> PrivacyStatementUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> PublicClient { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> RequiredResourceAccess { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> ServiceManagementReference { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SignInAudience { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> SinglePageApplication { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> SupportUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformValue<string> TermsOfServiceUrl { get; }
    ...
    // Output-only attribute - source generator will implement read-only get
    public partial TerraformList<object> Web { get; }
