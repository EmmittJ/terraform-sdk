...
public class AzurermKubernetesClusterNodePoolDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("kubernetes_cluster_name")?.Value;
        set => this.WithProperty("kubernetes_cluster_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
