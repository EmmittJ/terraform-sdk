...
public class AzurermDatabaseMigrationProject : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("source_platform")?.Value;
        set => this.WithProperty("source_platform", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("target_platform")?.Value;
        set => this.WithProperty("target_platform", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
