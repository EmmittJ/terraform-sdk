...
public class AzurermCosmosdbMongoDatabase : TerraformResource
{
    ...
    public List<AzurermCosmosdbMongoDatabaseAutoscaleSettingsBlock>? AutoscaleSettings
    {
        get => GetProperty<List<AzurermCosmosdbMongoDatabaseAutoscaleSettingsBlock>>("autoscale_settings");
    ...
    {
        get => GetProperty<AzurermCosmosdbMongoDatabaseTimeoutsBlock>("timeouts");
