...
public class AzurermDataFactoryLinkedServiceAzureSearch : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("search_service_key")?.Value;
        set => this.WithProperty("search_service_key", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
