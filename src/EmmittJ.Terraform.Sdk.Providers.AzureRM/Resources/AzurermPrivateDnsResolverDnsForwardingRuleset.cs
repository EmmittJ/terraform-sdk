...
public class AzurermPrivateDnsResolverDnsForwardingRuleset : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<List<string>>? PrivateDnsResolverOutboundEndpointIds
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("private_dns_resolver_outbound_endpoint_ids");
