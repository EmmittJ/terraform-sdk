...
public class AzurermStreamAnalyticsReferenceInputBlob : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermStreamAnalyticsReferenceInputBlobSerializationBlock>>("serialization");
    ...
    {
        get => GetProperty<AzurermStreamAnalyticsReferenceInputBlobTimeoutsBlock>("timeouts");
