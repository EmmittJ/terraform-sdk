...
public class AzurermAppServiceManagedCertificate : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("custom_hostname_binding_id")?.Value;
        set => this.WithProperty("custom_hostname_binding_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
