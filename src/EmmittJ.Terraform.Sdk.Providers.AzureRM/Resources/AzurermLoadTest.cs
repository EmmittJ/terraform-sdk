...
public class AzurermLoadTest : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermLoadTestEncryptionBlock>>("encryption");
    ...
    {
        get => GetProperty<List<AzurermLoadTestIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<AzurermLoadTestTimeoutsBlock>("timeouts");
