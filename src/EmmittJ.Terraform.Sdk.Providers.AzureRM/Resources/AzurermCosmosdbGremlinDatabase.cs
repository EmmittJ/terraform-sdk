...
public class AzurermCosmosdbGremlinDatabase : TerraformResource
{
    ...
    public List<AzurermCosmosdbGremlinDatabaseAutoscaleSettingsBlock>? AutoscaleSettings
    {
        get => GetProperty<List<AzurermCosmosdbGremlinDatabaseAutoscaleSettingsBlock>>("autoscale_settings");
    ...
    {
        get => GetProperty<AzurermCosmosdbGremlinDatabaseTimeoutsBlock>("timeouts");
