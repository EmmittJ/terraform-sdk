...
public class AzurermPrivateDnsMxRecordRecordBlock : TerraformBlock
{
    ...
    {
        get => GetProperty<TerraformProperty<string>>("exchange");
    ...
    {
        get => GetProperty<TerraformProperty<double>>("preference");
...
public class AzurermPrivateDnsMxRecord : TerraformResource
{
    ...
    {
        get => GetProperty<HashSet<AzurermPrivateDnsMxRecordRecordBlock>>("record");
    ...
    {
        get => GetProperty<AzurermPrivateDnsMxRecordTimeoutsBlock>("timeouts");
