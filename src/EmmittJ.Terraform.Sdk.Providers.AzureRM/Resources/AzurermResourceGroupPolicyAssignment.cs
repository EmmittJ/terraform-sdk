...
public class AzurermResourceGroupPolicyAssignment : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermResourceGroupPolicyAssignmentIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<List<AzurermResourceGroupPolicyAssignmentNonComplianceMessageBlock>>("non_compliance_message");
    ...
    {
        get => GetProperty<List<AzurermResourceGroupPolicyAssignmentOverridesBlock>>("overrides");
    ...
    {
        get => GetProperty<List<AzurermResourceGroupPolicyAssignmentResourceSelectorsBlock>>("resource_selectors");
    ...
    {
        get => GetProperty<AzurermResourceGroupPolicyAssignmentTimeoutsBlock>("timeouts");
