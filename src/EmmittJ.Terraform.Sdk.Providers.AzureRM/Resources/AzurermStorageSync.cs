...
public class AzurermStorageSync : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("incoming_traffic_policy")?.Value;
        set => this.WithProperty("incoming_traffic_policy", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
