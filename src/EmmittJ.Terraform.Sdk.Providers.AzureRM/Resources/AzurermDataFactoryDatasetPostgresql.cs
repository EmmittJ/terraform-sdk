...
/// Nesting mode: list
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock : TerraformBlock
{
    /// <summary>
...
/// Nesting mode: single
/// </summary>
public class AzurermDataFactoryDatasetPostgresqlTimeoutsBlock : TerraformBlock
{
    /// <summary>
...
/// <summary>
/// Manages a azurerm_data_factory_dataset_postgresql resource.
/// </summary>
public class AzurermDataFactoryDatasetPostgresql : TerraformResource
{
    public AzurermDataFactoryDatasetPostgresql(string name) : base("azurerm_data_factory_dataset_postgresql", name)
    {
        InitializeOutputs();
    }
    ...
    /// Nesting mode: list
    /// </summary>
    public List<AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock>? SchemaColumn
    {
        get => GetProperty<List<AzurermDataFactoryDatasetPostgresqlSchemaColumnBlock>>("schema_column");
    ...
    /// Nesting mode: single
    /// </summary>
    public AzurermDataFactoryDatasetPostgresqlTimeoutsBlock? Timeouts
    {
        get => GetProperty<AzurermDataFactoryDatasetPostgresqlTimeoutsBlock>("timeouts");
