...
public class AzurermApiManagementLogger : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("buffered")?.Value;
        set => this.WithProperty("buffered", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
