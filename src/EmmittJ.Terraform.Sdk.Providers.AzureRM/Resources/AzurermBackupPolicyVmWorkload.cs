...
public class AzurermBackupPolicyVmWorkload : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workload_type")?.Value;
        set => this.WithProperty("workload_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
