...
public class AzurermLbRule : TerraformResource
{
    ...
    /// </summary>
    public List<string>? BackendAddressPoolIds
    {
        get => GetProperty<TerraformLiteralProperty<List<string>>>("backend_address_pool_ids")?.Value;
        set => this.WithProperty("backend_address_pool_ids", value == null ? null : new TerraformLiteralProperty<List<string>>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("disable_outbound_snat")?.Value;
        set => this.WithProperty("disable_outbound_snat", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("load_distribution")?.Value;
        set => this.WithProperty("load_distribution", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("probe_id")?.Value;
        set => this.WithProperty("probe_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
