...
public class AzurermVirtualMachineRestorePointCollection : TerraformResource
{
    ...
    public required TerraformProperty<string> SourceVirtualMachineId
    {
        get => GetRequiredProperty<TerraformProperty<string>>("source_virtual_machine_id");
    ...
    {
        get => GetProperty<AzurermVirtualMachineRestorePointCollectionTimeoutsBlock>("timeouts");
