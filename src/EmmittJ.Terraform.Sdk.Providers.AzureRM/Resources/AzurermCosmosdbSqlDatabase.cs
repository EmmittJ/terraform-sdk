...
public class AzurermCosmosdbSqlDatabase : TerraformResource
{
    ...
    public List<AzurermCosmosdbSqlDatabaseAutoscaleSettingsBlock>? AutoscaleSettings
    {
        get => GetProperty<List<AzurermCosmosdbSqlDatabaseAutoscaleSettingsBlock>>("autoscale_settings");
    ...
    {
        get => GetProperty<AzurermCosmosdbSqlDatabaseTimeoutsBlock>("timeouts");
