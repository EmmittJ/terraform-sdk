...
public class AzurermDataFactoryLinkedServiceSnowflake : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermDataFactoryLinkedServiceSnowflakeKeyVaultPasswordBlock>>("key_vault_password");
    ...
    {
        get => GetProperty<AzurermDataFactoryLinkedServiceSnowflakeTimeoutsBlock>("timeouts");
