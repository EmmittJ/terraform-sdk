...
public class AzurermDataFactoryDatasetAzureBlob : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? DynamicFilenameEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("dynamic_filename_enabled");
        set => this.WithProperty("dynamic_filename_enabled", value);
    }

    /// <summary>
    /// The dynamic_path_enabled attribute.
    /// </summary>
    public TerraformLiteralProperty<bool>? DynamicPathEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("dynamic_path_enabled");
        set => this.WithProperty("dynamic_path_enabled", value);
    }
