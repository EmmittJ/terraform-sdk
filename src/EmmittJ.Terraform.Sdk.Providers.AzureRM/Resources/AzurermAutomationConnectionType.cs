...
public class AzurermAutomationConnectionType : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("is_global")?.Value;
        set => this.WithProperty("is_global", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
