...
public class AzurermLbBackendAddressPool : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("synchronous_mode")?.Value;
        set => this.WithProperty("synchronous_mode", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
