...
public class AzurermLinuxVirtualMachineScaleSet : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("disable_password_authentication")?.Value;
        set => this.WithProperty("disable_password_authentication", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
