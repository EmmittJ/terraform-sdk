...
public class AzurermLinuxFunctionApp : TerraformResource
{
    ...
    public List<AzurermLinuxFunctionAppAuthSettingsBlock>? AuthSettings
    {
        get => GetProperty<List<AzurermLinuxFunctionAppAuthSettingsBlock>>("auth_settings");
    ...
    public List<AzurermLinuxFunctionAppAuthSettingsV2Block>? AuthSettingsV2
    {
        get => GetProperty<List<AzurermLinuxFunctionAppAuthSettingsV2Block>>("auth_settings_v2");
    ...
    public List<AzurermLinuxFunctionAppBackupBlock>? Backup
    {
        get => GetProperty<List<AzurermLinuxFunctionAppBackupBlock>>("backup");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxFunctionAppConnectionStringBlock>? ConnectionString
    {
        get => GetProperty<HashSet<AzurermLinuxFunctionAppConnectionStringBlock>>("connection_string");
    ...
    public List<AzurermLinuxFunctionAppIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermLinuxFunctionAppIdentityBlock>>("identity");
    ...
    public List<AzurermLinuxFunctionAppSiteConfigBlock>? SiteConfig
    {
        get => GetProperty<List<AzurermLinuxFunctionAppSiteConfigBlock>>("site_config");
    ...
    public List<AzurermLinuxFunctionAppStickySettingsBlock>? StickySettings
    {
        get => GetProperty<List<AzurermLinuxFunctionAppStickySettingsBlock>>("sticky_settings");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermLinuxFunctionAppStorageAccountBlock>? StorageAccount
    {
        get => GetProperty<HashSet<AzurermLinuxFunctionAppStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermLinuxFunctionAppTimeoutsBlock>("timeouts");
