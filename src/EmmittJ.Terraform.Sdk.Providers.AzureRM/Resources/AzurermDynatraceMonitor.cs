...
public class AzurermDynatraceMonitor : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("marketplace_subscription")?.Value;
        set => this.WithProperty("marketplace_subscription", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
