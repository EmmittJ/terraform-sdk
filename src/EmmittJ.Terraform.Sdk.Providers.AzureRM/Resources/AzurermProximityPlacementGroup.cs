...
public class AzurermProximityPlacementGroup : TerraformResource
{
    ...
    /// </summary>
    public HashSet<TerraformProperty<string>>? AllowedVmSizes
    {
        get => GetProperty<HashSet<TerraformProperty<string>>>("allowed_vm_sizes");
    ...
    {
        get => GetProperty<AzurermProximityPlacementGroupTimeoutsBlock>("timeouts");
