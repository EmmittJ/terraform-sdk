...
public class AzurermProximityPlacementGroup : TerraformResource
{
    ...
    /// </summary>
    public HashSet<string>? AllowedVmSizes
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("allowed_vm_sizes")?.Value;
        set => this.WithProperty("allowed_vm_sizes", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
