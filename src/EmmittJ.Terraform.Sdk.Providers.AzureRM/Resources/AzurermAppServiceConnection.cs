...
public class AzurermAppServiceConnection : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermAppServiceConnectionAuthenticationBlock>>("authentication");
    ...
    {
        get => GetProperty<List<AzurermAppServiceConnectionSecretStoreBlock>>("secret_store");
    ...
    {
        get => GetProperty<AzurermAppServiceConnectionTimeoutsBlock>("timeouts");
