...
public class AzurermDataFactoryLinkedServiceCosmosdb : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("account_endpoint")?.Value;
        set => this.WithProperty("account_endpoint", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
