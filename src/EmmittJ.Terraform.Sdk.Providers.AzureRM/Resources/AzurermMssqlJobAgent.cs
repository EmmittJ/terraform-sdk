...
public class AzurermMssqlJobAgent : TerraformResource
{
    ...
    public List<AzurermMssqlJobAgentIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermMssqlJobAgentIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<AzurermMssqlJobAgentTimeoutsBlock>("timeouts");
