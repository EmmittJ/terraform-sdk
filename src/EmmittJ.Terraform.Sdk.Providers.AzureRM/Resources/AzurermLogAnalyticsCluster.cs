...
public class AzurermLogAnalyticsCluster : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("size_gb")?.Value;
        set => this.WithProperty("size_gb", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
