...
public class AzurermDataFactoryDatasetAzureSqlTable : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("linked_service_id")?.Value;
        set => this.WithProperty("linked_service_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
