...
public class AzurermPrivateDnsSrvRecord : TerraformResource
{
    ...
    public HashSet<AzurermPrivateDnsSrvRecordRecordBlock>? Record
    {
        get => GetProperty<HashSet<AzurermPrivateDnsSrvRecordRecordBlock>>("record");
    ...
    {
        get => GetProperty<AzurermPrivateDnsSrvRecordTimeoutsBlock>("timeouts");
