...
/// </summary>
public class AzurermDataFactoryLinkedServiceMysql : TerraformResource
{
    public AzurermDataFactoryLinkedServiceMysql(string name) : base("azurerm_data_factory_linked_service_mysql", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AzurermDataFactoryLinkedServiceMysqlTimeoutsBlock>("timeouts");
