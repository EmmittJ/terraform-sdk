...
public class AzurermStackHciNetworkInterface : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("mac_address")?.Value;
        set => this.WithProperty("mac_address", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
