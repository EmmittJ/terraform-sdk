...
/// </summary>
public class AzurermDataFactoryLinkedServicePostgresql : TerraformResource
{
    public AzurermDataFactoryLinkedServicePostgresql(string name) : base("azurerm_data_factory_linked_service_postgresql", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AzurermDataFactoryLinkedServicePostgresqlTimeoutsBlock>("timeouts");
