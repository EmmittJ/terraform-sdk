...
public class AzurermWindowsFunctionAppSlot : TerraformResource
{
    ...
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSlotAuthSettingsBlock>>("auth_settings");
    ...
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSlotAuthSettingsV2Block>>("auth_settings_v2");
    ...
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSlotBackupBlock>>("backup");
    ...
    {
        get => GetProperty<HashSet<AzurermWindowsFunctionAppSlotConnectionStringBlock>>("connection_string");
    ...
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSlotIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSlotSiteConfigBlock>>("site_config");
    ...
    {
        get => GetProperty<HashSet<AzurermWindowsFunctionAppSlotStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermWindowsFunctionAppSlotTimeoutsBlock>("timeouts");
