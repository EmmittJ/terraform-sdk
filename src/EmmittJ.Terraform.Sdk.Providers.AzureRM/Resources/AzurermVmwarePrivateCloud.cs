...
public class AzurermVmwarePrivateCloud : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<bool>? InternetConnectionEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("internet_connection_enabled");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? NetworkSubnetCidr
    {
        get => GetProperty<TerraformLiteralProperty<string>>("network_subnet_cidr");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? NsxtPassword
    {
        get => GetProperty<TerraformLiteralProperty<string>>("nsxt_password");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? VcenterPassword
    {
        get => GetProperty<TerraformLiteralProperty<string>>("vcenter_password");
