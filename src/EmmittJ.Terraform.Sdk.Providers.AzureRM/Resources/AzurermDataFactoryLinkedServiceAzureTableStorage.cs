...
/// </summary>
public class AzurermDataFactoryLinkedServiceAzureTableStorage : TerraformResource
{
    public AzurermDataFactoryLinkedServiceAzureTableStorage(string name) : base("azurerm_data_factory_linked_service_azure_table_storage", name)
    {
        InitializeOutputs();
    }
    ...
    {
        get => GetProperty<AzurermDataFactoryLinkedServiceAzureTableStorageTimeoutsBlock>("timeouts");
