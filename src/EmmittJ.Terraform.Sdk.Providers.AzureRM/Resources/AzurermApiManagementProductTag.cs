...
public class AzurermApiManagementProductTag : TerraformResource
{
    ...
    /// </summary>
    public string? ApiManagementProductId
    {
        get => GetProperty<TerraformLiteralProperty<string>>("api_management_product_id")?.Value;
        set => this.WithProperty("api_management_product_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
