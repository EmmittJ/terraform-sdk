...
public class AzurermWindowsFunctionApp : TerraformResource
{
    ...
    public List<AzurermWindowsFunctionAppAuthSettingsBlock>? AuthSettings
    {
        get => GetProperty<List<AzurermWindowsFunctionAppAuthSettingsBlock>>("auth_settings");
    ...
    public List<AzurermWindowsFunctionAppAuthSettingsV2Block>? AuthSettingsV2
    {
        get => GetProperty<List<AzurermWindowsFunctionAppAuthSettingsV2Block>>("auth_settings_v2");
    ...
    public List<AzurermWindowsFunctionAppBackupBlock>? Backup
    {
        get => GetProperty<List<AzurermWindowsFunctionAppBackupBlock>>("backup");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermWindowsFunctionAppConnectionStringBlock>? ConnectionString
    {
        get => GetProperty<HashSet<AzurermWindowsFunctionAppConnectionStringBlock>>("connection_string");
    ...
    public List<AzurermWindowsFunctionAppIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermWindowsFunctionAppIdentityBlock>>("identity");
    ...
    public List<AzurermWindowsFunctionAppSiteConfigBlock>? SiteConfig
    {
        get => GetProperty<List<AzurermWindowsFunctionAppSiteConfigBlock>>("site_config");
    ...
    public List<AzurermWindowsFunctionAppStickySettingsBlock>? StickySettings
    {
        get => GetProperty<List<AzurermWindowsFunctionAppStickySettingsBlock>>("sticky_settings");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermWindowsFunctionAppStorageAccountBlock>? StorageAccount
    {
        get => GetProperty<HashSet<AzurermWindowsFunctionAppStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermWindowsFunctionAppTimeoutsBlock>("timeouts");
