...
public class AzurermDigitalTwinsInstance : TerraformResource
{
    ...
    public List<AzurermDigitalTwinsInstanceIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermDigitalTwinsInstanceIdentityBlock>>("identity");
    ...
    /// Nesting mode: single
    /// </summary>
    public AzurermDigitalTwinsInstanceTimeoutsBlock? Timeouts
    {
        get => GetProperty<AzurermDigitalTwinsInstanceTimeoutsBlock>("timeouts");
