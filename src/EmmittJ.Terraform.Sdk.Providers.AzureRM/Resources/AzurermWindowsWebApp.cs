...
public class AzurermWindowsWebApp : TerraformResource
{
    ...
    public List<AzurermWindowsWebAppAuthSettingsBlock>? AuthSettings
    {
        get => GetProperty<List<AzurermWindowsWebAppAuthSettingsBlock>>("auth_settings");
    ...
    public List<AzurermWindowsWebAppAuthSettingsV2Block>? AuthSettingsV2
    {
        get => GetProperty<List<AzurermWindowsWebAppAuthSettingsV2Block>>("auth_settings_v2");
    ...
    public List<AzurermWindowsWebAppBackupBlock>? Backup
    {
        get => GetProperty<List<AzurermWindowsWebAppBackupBlock>>("backup");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermWindowsWebAppConnectionStringBlock>? ConnectionString
    {
        get => GetProperty<HashSet<AzurermWindowsWebAppConnectionStringBlock>>("connection_string");
    ...
    public List<AzurermWindowsWebAppIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermWindowsWebAppIdentityBlock>>("identity");
    ...
    public List<AzurermWindowsWebAppLogsBlock>? Logs
    {
        get => GetProperty<List<AzurermWindowsWebAppLogsBlock>>("logs");
    ...
    public List<AzurermWindowsWebAppSiteConfigBlock>? SiteConfig
    {
        get => GetProperty<List<AzurermWindowsWebAppSiteConfigBlock>>("site_config");
    ...
    public List<AzurermWindowsWebAppStickySettingsBlock>? StickySettings
    {
        get => GetProperty<List<AzurermWindowsWebAppStickySettingsBlock>>("sticky_settings");
    ...
    /// Nesting mode: set
    /// </summary>
    public HashSet<AzurermWindowsWebAppStorageAccountBlock>? StorageAccount
    {
        get => GetProperty<HashSet<AzurermWindowsWebAppStorageAccountBlock>>("storage_account");
    ...
    {
        get => GetProperty<AzurermWindowsWebAppTimeoutsBlock>("timeouts");
