...
public class AzurermDatabricksAccessConnector : TerraformResource
{
    ...
    public List<AzurermDatabricksAccessConnectorIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermDatabricksAccessConnectorIdentityBlock>>("identity");
    ...
    /// Nesting mode: single
    /// </summary>
    public AzurermDatabricksAccessConnectorTimeoutsBlock? Timeouts
    {
        get => GetProperty<AzurermDatabricksAccessConnectorTimeoutsBlock>("timeouts");
