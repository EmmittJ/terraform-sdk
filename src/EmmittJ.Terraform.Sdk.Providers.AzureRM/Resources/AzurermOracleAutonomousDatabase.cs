...
public class AzurermOracleAutonomousDatabase : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("db_version")?.Value;
        set => this.WithProperty("db_version", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("db_workload")?.Value;
        set => this.WithProperty("db_workload", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
