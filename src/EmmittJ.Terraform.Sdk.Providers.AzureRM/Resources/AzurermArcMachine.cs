...
public class AzurermArcMachine : TerraformResource
{
    ...
    public List<AzurermArcMachineIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermArcMachineIdentityBlock>>("identity");
    ...
    {
        get => GetProperty<AzurermArcMachineTimeoutsBlock>("timeouts");
