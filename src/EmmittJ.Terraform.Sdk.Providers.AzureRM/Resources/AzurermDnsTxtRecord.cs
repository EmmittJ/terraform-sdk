...
public class AzurermDnsTxtRecord : TerraformResource
{
    ...
    public HashSet<AzurermDnsTxtRecordRecordBlock>? Record
    {
        get => GetProperty<HashSet<AzurermDnsTxtRecordRecordBlock>>("record");
    ...
    {
        get => GetProperty<AzurermDnsTxtRecordTimeoutsBlock>("timeouts");
