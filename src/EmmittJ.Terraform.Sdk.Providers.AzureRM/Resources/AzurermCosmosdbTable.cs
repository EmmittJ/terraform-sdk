...
public class AzurermCosmosdbTable : TerraformResource
{
    ...
    public List<AzurermCosmosdbTableAutoscaleSettingsBlock>? AutoscaleSettings
    {
        get => GetProperty<List<AzurermCosmosdbTableAutoscaleSettingsBlock>>("autoscale_settings");
    ...
    {
        get => GetProperty<AzurermCosmosdbTableTimeoutsBlock>("timeouts");
