...
public class AzurermRelayHybridConnectionAuthorizationRule : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("hybrid_connection_name")?.Value;
        set => this.WithProperty("hybrid_connection_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
