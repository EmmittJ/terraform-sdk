...
/// Nesting mode: single
/// </summary>
public class AzurermSentinelDataConnectorAzureAdvancedThreatProtectionTimeoutsBlock : TerraformBlock
{
    /// <summary>
...
public class AzurermSentinelDataConnectorAzureAdvancedThreatProtection : TerraformResource
{
    ...
    {
        get => GetProperty<AzurermSentinelDataConnectorAzureAdvancedThreatProtectionTimeoutsBlock>("timeouts");
