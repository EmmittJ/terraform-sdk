...
public class AzurermMachineLearningWorkspaceNetworkOutboundRuleServiceTag : TerraformResource
{
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? PortRanges
    {
        get => GetProperty<TerraformLiteralProperty<string>>("port_ranges");
    ...
    /// </summary>
    public TerraformLiteralProperty<string>? ServiceTag
    {
        get => GetProperty<TerraformLiteralProperty<string>>("service_tag");
