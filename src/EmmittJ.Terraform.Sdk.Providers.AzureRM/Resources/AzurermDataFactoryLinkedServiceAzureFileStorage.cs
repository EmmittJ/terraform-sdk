...
public class AzurermDataFactoryLinkedServiceAzureFileStorage : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformProperty<string>>("file_share");
    ...
    {
        get => GetProperty<List<AzurermDataFactoryLinkedServiceAzureFileStorageKeyVaultPasswordBlock>>("key_vault_password");
    ...
    {
        get => GetProperty<AzurermDataFactoryLinkedServiceAzureFileStorageTimeoutsBlock>("timeouts");
