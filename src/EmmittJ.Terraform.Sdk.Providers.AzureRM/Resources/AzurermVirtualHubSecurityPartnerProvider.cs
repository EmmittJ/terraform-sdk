...
public class AzurermVirtualHubSecurityPartnerProvider : TerraformResource
{
    ...
    public required TerraformProperty<string> SecurityProviderName
    {
        get => GetRequiredProperty<TerraformProperty<string>>("security_provider_name");
    ...
    {
        get => GetProperty<AzurermVirtualHubSecurityPartnerProviderTimeoutsBlock>("timeouts");
