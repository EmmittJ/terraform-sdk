...
public class AzurermIothubDeviceUpdateAccount : TerraformResource
{
    ...
    public List<AzurermIothubDeviceUpdateAccountIdentityBlock>? Identity
    {
        get => GetProperty<List<AzurermIothubDeviceUpdateAccountIdentityBlock>>("identity");
    ...
    /// Nesting mode: single
    /// </summary>
    public AzurermIothubDeviceUpdateAccountTimeoutsBlock? Timeouts
    {
        get => GetProperty<AzurermIothubDeviceUpdateAccountTimeoutsBlock>("timeouts");
