...
/// <summary>
/// Tests for TerraformDynamicBlockExpression HCL serialization.
/// </summary>
public class TerraformDynamicBlockExpressionTests
{
    [Fact]
    public void ToHcl_WithBasicContent_RendersCorrectly()
    {
        ...
        var dynamicBlock = new TerraformDynamicBlockExpression(
            "ingress",
            forEachExpr,
            contentMap);
