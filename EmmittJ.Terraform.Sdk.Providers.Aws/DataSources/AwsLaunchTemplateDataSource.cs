...
public class AwsLaunchTemplateDataSource : TerraformDataSource
{
    ...
    private void InitializeOutputs()
    {
        ...
        this.DeclareOutput("elastic_gpu_specifications");
        this.DeclareOutput("elastic_inference_accelerator");
    ...
    /// <summary>
    /// The elastic_gpu_specifications attribute.
    /// </summary>
    public TerraformExpression ElasticGpuSpecifications => this["elastic_gpu_specifications"];

    /// <summary>
    /// The elastic_inference_accelerator attribute.
    /// </summary>
    public TerraformExpression ElasticInferenceAccelerator => this["elastic_inference_accelerator"];
