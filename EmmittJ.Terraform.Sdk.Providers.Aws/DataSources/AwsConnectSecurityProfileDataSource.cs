...
public class AwsConnectSecurityProfileDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("security_profile_id")?.Value;
        set => this.WithProperty("security_profile_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
