...
public class AwsDxLocationDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("location_code")?.Value;
        set => this.WithProperty("location_code", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
