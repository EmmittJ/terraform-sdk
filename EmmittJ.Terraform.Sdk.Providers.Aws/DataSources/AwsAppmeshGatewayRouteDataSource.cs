...
public class AwsAppmeshGatewayRouteDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("virtual_gateway_name")?.Value;
        set => this.WithProperty("virtual_gateway_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
