...
public class AwsAppmeshRouteDataSource : TerraformDataSource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("virtual_router_name")?.Value;
        set => this.WithProperty("virtual_router_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
