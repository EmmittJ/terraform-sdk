...
public class AwsKinesisFirehoseDeliveryStream : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("destination_id")?.Value;
        set => this.WithProperty("destination_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
