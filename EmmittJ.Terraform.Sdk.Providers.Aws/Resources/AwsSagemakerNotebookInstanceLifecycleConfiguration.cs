...
public class AwsSagemakerNotebookInstanceLifecycleConfiguration : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("on_create")?.Value;
        set => this.WithProperty("on_create", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("on_start")?.Value;
        set => this.WithProperty("on_start", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
