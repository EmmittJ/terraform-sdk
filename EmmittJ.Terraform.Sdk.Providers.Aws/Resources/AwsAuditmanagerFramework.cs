...
public class AwsAuditmanagerFramework : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("compliance_type")?.Value;
        set => this.WithProperty("compliance_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
