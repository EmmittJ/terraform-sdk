...
/// <summary>
/// Manages a aws_opsworks_java_app_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksJavaAppLayer : TerraformResource
{
    public AwsOpsworksJavaAppLayer(string name) : base("aws_opsworks_java_app_layer", name)
    {
        InitializeOutputs();
    }
    ...
    /// <summary>
    /// The app_server_version attribute.
    /// </summary>
    public string? AppServerVersion
    {
        get => GetProperty<TerraformLiteralProperty<string>>("app_server_version")?.Value;
        set => this.WithProperty("app_server_version", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    /// <summary>
    /// The jvm_type attribute.
    /// </summary>
    public string? JvmType
    {
        get => GetProperty<TerraformLiteralProperty<string>>("jvm_type")?.Value;
        set => this.WithProperty("jvm_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }

    /// <summary>
    /// The jvm_version attribute.
    /// </summary>
    public string? JvmVersion
    {
        get => GetProperty<TerraformLiteralProperty<string>>("jvm_version")?.Value;
        set => this.WithProperty("jvm_version", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
