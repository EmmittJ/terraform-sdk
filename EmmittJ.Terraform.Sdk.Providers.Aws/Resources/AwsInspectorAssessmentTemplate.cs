...
public class AwsInspectorAssessmentTemplate : TerraformResource
{
    ...
    /// </summary>
    public HashSet<string>? RulesPackageArns
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("rules_package_arns")?.Value;
        set => this.WithProperty("rules_package_arns", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
