...
public class AwsAppconfigConfigurationProfile : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("location_uri")?.Value;
        set => this.WithProperty("location_uri", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("retrieval_role_arn")?.Value;
        set => this.WithProperty("retrieval_role_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
