...
/// <summary>
/// Manages a aws_opsworks_nodejs_app_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksNodejsAppLayer : TerraformResource
{
    public AwsOpsworksNodejsAppLayer(string name) : base("aws_opsworks_nodejs_app_layer", name)
    {
        InitializeOutputs();
    }
    ...
    /// <summary>
    /// The nodejs_version attribute.
    /// </summary>
    public string? NodejsVersion
    {
        get => GetProperty<TerraformLiteralProperty<string>>("nodejs_version")?.Value;
        set => this.WithProperty("nodejs_version", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
