...
public class AwsPlacementGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("spread_level")?.Value;
        set => this.WithProperty("spread_level", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("strategy")?.Value;
        set => this.WithProperty("strategy", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
