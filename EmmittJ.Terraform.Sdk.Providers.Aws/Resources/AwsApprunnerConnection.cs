...
public class AwsApprunnerConnection : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("connection_name")?.Value;
        set => this.WithProperty("connection_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
