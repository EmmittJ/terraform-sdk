...
/// <summary>
/// Manages a aws_opsworks_php_app_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksPhpAppLayer : TerraformResource
{
    public AwsOpsworksPhpAppLayer(string name) : base("aws_opsworks_php_app_layer", name)
    {
        InitializeOutputs();
    }
