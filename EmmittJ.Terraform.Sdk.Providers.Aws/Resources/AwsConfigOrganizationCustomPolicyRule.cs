...
public class AwsConfigOrganizationCustomPolicyRule : TerraformResource
{
    ...
    /// </summary>
    public HashSet<string>? DebugLogDeliveryAccounts
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("debug_log_delivery_accounts")?.Value;
        set => this.WithProperty("debug_log_delivery_accounts", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("policy_runtime")?.Value;
        set => this.WithProperty("policy_runtime", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("policy_text")?.Value;
        set => this.WithProperty("policy_text", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    /// </summary>
    public HashSet<string>? TriggerTypes
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("trigger_types")?.Value;
        set => this.WithProperty("trigger_types", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
