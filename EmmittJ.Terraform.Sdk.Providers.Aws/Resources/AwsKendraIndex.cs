...
public class AwsKendraIndex : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("user_context_policy")?.Value;
        set => this.WithProperty("user_context_policy", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
