...
public class AwsSecretsmanagerSecret : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("force_overwrite_replica_secret")?.Value;
        set => this.WithProperty("force_overwrite_replica_secret", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
