...
/// <summary>
/// Manages a aws_opsworks_ecs_cluster_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksEcsClusterLayer : TerraformResource
{
    public AwsOpsworksEcsClusterLayer(string name) : base("aws_opsworks_ecs_cluster_layer", name)
    {
        InitializeOutputs();
    }
