...
public class AwsCodebuildProject : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("auto_retry_limit")?.Value;
        set => this.WithProperty("auto_retry_limit", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
