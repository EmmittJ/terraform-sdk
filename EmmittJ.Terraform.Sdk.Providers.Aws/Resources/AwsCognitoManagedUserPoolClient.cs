...
public class AwsCognitoManagedUserPoolClient : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("name_pattern")?.Value;
        set => this.WithProperty("name_pattern", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
