...
public class AwsStoragegatewaySmbFileShare : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("access_based_enumeration")?.Value;
        set => this.WithProperty("access_based_enumeration", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }

    /// <summary>
    /// The admin_user_list attribute.
    /// </summary>
    public HashSet<string>? AdminUserList
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("admin_user_list")?.Value;
        set => this.WithProperty("admin_user_list", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("case_sensitivity")?.Value;
        set => this.WithProperty("case_sensitivity", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    /// </summary>
    public HashSet<string>? InvalidUserList
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("invalid_user_list")?.Value;
        set => this.WithProperty("invalid_user_list", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("oplocks_enabled")?.Value;
        set => this.WithProperty("oplocks_enabled", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("smb_acl_enabled")?.Value;
        set => this.WithProperty("smb_acl_enabled", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
    ...
    /// </summary>
    public HashSet<string>? ValidUserList
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("valid_user_list")?.Value;
        set => this.WithProperty("valid_user_list", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
