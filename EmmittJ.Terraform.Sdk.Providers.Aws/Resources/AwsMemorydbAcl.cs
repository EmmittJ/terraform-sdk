...
public class AwsMemorydbAcl : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("user_names")?.Value;
        set => this.WithProperty("user_names", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
