...
public class AwsKmsExternalKey : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("key_spec")?.Value;
        set => this.WithProperty("key_spec", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
