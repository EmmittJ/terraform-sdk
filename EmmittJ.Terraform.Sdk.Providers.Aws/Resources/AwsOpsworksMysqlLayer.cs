...
/// <summary>
/// Manages a aws_opsworks_mysql_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksMysqlLayer : TerraformResource
{
    public AwsOpsworksMysqlLayer(string name) : base("aws_opsworks_mysql_layer", name)
    {
        InitializeOutputs();
    }
    ...
    /// <summary>
    /// The root_password_on_all_instances attribute.
    /// </summary>
    public bool? RootPasswordOnAllInstances
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("root_password_on_all_instances")?.Value;
        set => this.WithProperty("root_password_on_all_instances", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
