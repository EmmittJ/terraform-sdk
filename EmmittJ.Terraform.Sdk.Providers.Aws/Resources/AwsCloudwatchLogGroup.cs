...
public class AwsCloudwatchLogGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("log_group_class")?.Value;
        set => this.WithProperty("log_group_class", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
