...
public class AwsIotRoleAlias : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("credential_duration")?.Value;
        set => this.WithProperty("credential_duration", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
