...
public class AwsDmsReplicationInstance : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("dns_name_servers")?.Value;
        set => this.WithProperty("dns_name_servers", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
