...
public class AwsApiGatewayUsagePlan : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("product_code")?.Value;
        set => this.WithProperty("product_code", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
