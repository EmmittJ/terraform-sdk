...
public class AwsXrayGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("filter_expression")?.Value;
        set => this.WithProperty("filter_expression", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
