...
/// <summary>
/// Manages a aws_opsworks_memcached_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksMemcachedLayer : TerraformResource
{
    public AwsOpsworksMemcachedLayer(string name) : base("aws_opsworks_memcached_layer", name)
    {
        InitializeOutputs();
    }
    ...
    /// <summary>
    /// The allocated_memory attribute.
    /// </summary>
    public double? AllocatedMemory
    {
        get => GetProperty<TerraformLiteralProperty<double>>("allocated_memory")?.Value;
        set => this.WithProperty("allocated_memory", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
