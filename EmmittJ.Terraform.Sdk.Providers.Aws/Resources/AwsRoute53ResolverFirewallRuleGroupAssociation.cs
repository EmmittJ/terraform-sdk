...
public class AwsRoute53ResolverFirewallRuleGroupAssociation : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("mutation_protection")?.Value;
        set => this.WithProperty("mutation_protection", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
