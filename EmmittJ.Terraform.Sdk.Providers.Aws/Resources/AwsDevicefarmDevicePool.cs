...
public class AwsDevicefarmDevicePool : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("max_devices")?.Value;
        set => this.WithProperty("max_devices", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
