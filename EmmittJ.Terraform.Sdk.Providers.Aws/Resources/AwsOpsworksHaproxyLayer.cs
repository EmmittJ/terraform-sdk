...
/// <summary>
/// Manages a aws_opsworks_haproxy_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksHaproxyLayer : TerraformResource
{
    public AwsOpsworksHaproxyLayer(string name) : base("aws_opsworks_haproxy_layer", name)
    {
        InitializeOutputs();
    }
    ...
    /// <summary>
    /// The healthcheck_method attribute.
    /// </summary>
    public string? HealthcheckMethod
    {
        get => GetProperty<TerraformLiteralProperty<string>>("healthcheck_method")?.Value;
        set => this.WithProperty("healthcheck_method", value == null ? null : new TerraformLiteralProperty<string>(value));
    }

    /// <summary>
    /// The healthcheck_url attribute.
    /// </summary>
    public string? HealthcheckUrl
    {
        get => GetProperty<TerraformLiteralProperty<string>>("healthcheck_url")?.Value;
        set => this.WithProperty("healthcheck_url", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    /// <summary>
    /// The stats_enabled attribute.
    /// </summary>
    public bool? StatsEnabled
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("stats_enabled")?.Value;
        set => this.WithProperty("stats_enabled", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }

    /// <summary>
    /// The stats_password attribute.
    /// </summary>
    public string? StatsPassword
    {
        get => GetProperty<TerraformLiteralProperty<string>>("stats_password")?.Value;
        set => this.WithProperty("stats_password", value == null ? null : new TerraformLiteralProperty<string>(value));
    }

    /// <summary>
    /// The stats_url attribute.
    /// </summary>
    public string? StatsUrl
    {
        get => GetProperty<TerraformLiteralProperty<string>>("stats_url")?.Value;
        set => this.WithProperty("stats_url", value == null ? null : new TerraformLiteralProperty<string>(value));
    }

    /// <summary>
    /// The stats_user attribute.
    /// </summary>
    public string? StatsUser
    {
        get => GetProperty<TerraformLiteralProperty<string>>("stats_user")?.Value;
        set => this.WithProperty("stats_user", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
