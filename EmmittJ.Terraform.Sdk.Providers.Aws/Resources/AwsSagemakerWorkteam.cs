...
public class AwsSagemakerWorkteam : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workteam_name")?.Value;
        set => this.WithProperty("workteam_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
