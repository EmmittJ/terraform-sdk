...
public class AwsAmiFromInstance : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("snapshot_without_reboot")?.Value;
        set => this.WithProperty("snapshot_without_reboot", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("source_instance_id")?.Value;
        set => this.WithProperty("source_instance_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
