...
public class AwsSwfDomain : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("workflow_execution_retention_period_in_days")?.Value;
        set => this.WithProperty("workflow_execution_retention_period_in_days", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
