...
public class AwsCloudwatchEventBus : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("event_source_name")?.Value;
        set => this.WithProperty("event_source_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
