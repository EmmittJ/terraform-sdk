...
public class AwsSagemakerEndpoint : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("endpoint_config_name")?.Value;
        set => this.WithProperty("endpoint_config_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
