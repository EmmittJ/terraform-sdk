...
public class AwsWorkspaceswebIpAccessSettingsAssociation : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("ip_access_settings_arn")?.Value;
        set => this.WithProperty("ip_access_settings_arn", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
