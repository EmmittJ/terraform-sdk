...
public class AwsSesv2ContactList : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("contact_list_name")?.Value;
        set => this.WithProperty("contact_list_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
