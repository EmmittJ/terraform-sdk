...
public class AwsApiGatewayAccount : TerraformResource
{
    ...
    /// <summary>
    /// The reset_on_delete attribute.
    /// </summary>
    [Obsolete("This property is deprecated.")]
    public bool? ResetOnDelete
    {
        get => GetProperty<TerraformLiteralProperty<bool>>("reset_on_delete")?.Value;
        set => this.WithProperty("reset_on_delete", value == null ? null : new TerraformLiteralProperty<bool>(value.Value));
    }
