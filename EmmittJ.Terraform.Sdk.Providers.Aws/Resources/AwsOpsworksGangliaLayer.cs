...
/// <summary>
/// Manages a aws_opsworks_ganglia_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksGangliaLayer : TerraformResource
{
    public AwsOpsworksGangliaLayer(string name) : base("aws_opsworks_ganglia_layer", name)
    {
        InitializeOutputs();
    }
