...
public class AwsAppstreamImageBuilder : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("appstream_agent_version")?.Value;
        set => this.WithProperty("appstream_agent_version", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
