...
/// <summary>
/// Manages a aws_opsworks_custom_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksCustomLayer : TerraformResource
{
    public AwsOpsworksCustomLayer(string name) : base("aws_opsworks_custom_layer", name)
    {
        InitializeOutputs();
    }
