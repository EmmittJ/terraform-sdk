...
public class AwsSesv2DedicatedIpPool : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("scaling_mode")?.Value;
        set => this.WithProperty("scaling_mode", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
