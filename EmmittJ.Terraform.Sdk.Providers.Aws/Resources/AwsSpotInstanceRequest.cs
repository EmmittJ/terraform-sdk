...
public class AwsSpotInstanceRequest : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("block_duration_minutes")?.Value;
        set => this.WithProperty("block_duration_minutes", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
    ...
    /// <summary>
    /// The cpu_threads_per_core attribute.
    /// </summary>
    [Obsolete("This property is deprecated.")]
    public double? CpuThreadsPerCore
    {
        get => GetProperty<TerraformLiteralProperty<double>>("cpu_threads_per_core")?.Value;
        set => this.WithProperty("cpu_threads_per_core", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("instance_interruption_behavior")?.Value;
        set => this.WithProperty("instance_interruption_behavior", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("launch_group")?.Value;
        set => this.WithProperty("launch_group", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("spot_type")?.Value;
        set => this.WithProperty("spot_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
