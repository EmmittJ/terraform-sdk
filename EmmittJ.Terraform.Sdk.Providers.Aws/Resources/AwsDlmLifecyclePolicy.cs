...
public class AwsDlmLifecyclePolicy : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("default_policy")?.Value;
        set => this.WithProperty("default_policy", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
