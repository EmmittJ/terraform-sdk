...
public class AwsRoute53ResolverEndpoint : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("resolver_endpoint_type")?.Value;
        set => this.WithProperty("resolver_endpoint_type", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
