...
public class AwsSignerSigningProfile : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("platform_id")?.Value;
        set => this.WithProperty("platform_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<Dictionary<string, string>>>("signing_parameters")?.Value;
        set => this.WithProperty("signing_parameters", value == null ? null : new TerraformLiteralProperty<Dictionary<string, string>>(value));
    }
