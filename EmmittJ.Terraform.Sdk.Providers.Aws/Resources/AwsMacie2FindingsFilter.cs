...
public class AwsMacie2FindingsFilter : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<double>>("position")?.Value;
        set => this.WithProperty("position", value == null ? null : new TerraformLiteralProperty<double>(value.Value));
    }
