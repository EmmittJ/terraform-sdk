...
public class AwsDbEventSubscription : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("sns_topic")?.Value;
        set => this.WithProperty("sns_topic", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
