...
/// <summary>
/// Manages a aws_opsworks_static_web_layer resource.
/// </summary>
[Obsolete("This resource is deprecated.")]
public class AwsOpsworksStaticWebLayer : TerraformResource
{
    public AwsOpsworksStaticWebLayer(string name) : base("aws_opsworks_static_web_layer", name)
    {
        InitializeOutputs();
    }
