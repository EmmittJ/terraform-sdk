...
public class AwsAppintegrationsEventIntegration : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("eventbridge_bus")?.Value;
        set => this.WithProperty("eventbridge_bus", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
