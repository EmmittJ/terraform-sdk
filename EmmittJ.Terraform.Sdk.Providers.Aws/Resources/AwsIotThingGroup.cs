...
public class AwsIotThingGroup : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("parent_group_name")?.Value;
        set => this.WithProperty("parent_group_name", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
