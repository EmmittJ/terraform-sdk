...
public class AwsAppstreamStack : TerraformResource
{
    ...
    /// </summary>
    public HashSet<string>? EmbedHostDomains
    {
        get => GetProperty<TerraformLiteralProperty<HashSet<string>>>("embed_host_domains")?.Value;
        set => this.WithProperty("embed_host_domains", value == null ? null : new TerraformLiteralProperty<HashSet<string>>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("feedback_url")?.Value;
        set => this.WithProperty("feedback_url", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
