...
public class AwsBedrockGuardrail : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("blocked_input_messaging")?.Value;
        set => this.WithProperty("blocked_input_messaging", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("blocked_outputs_messaging")?.Value;
        set => this.WithProperty("blocked_outputs_messaging", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
