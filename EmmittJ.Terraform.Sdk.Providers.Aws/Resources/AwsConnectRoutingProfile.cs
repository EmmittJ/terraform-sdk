...
public class AwsConnectRoutingProfile : TerraformResource
{
    ...
    {
        get => GetProperty<TerraformLiteralProperty<string>>("default_outbound_queue_id")?.Value;
        set => this.WithProperty("default_outbound_queue_id", value == null ? null : new TerraformLiteralProperty<string>(value));
    }
